# SNMP MIB module (FOUNDRY-SN-BGP4-GROUP-MIB) expressed in pysnmp data model.
#
...
snBgp4 = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11)
)
...
snBgp4GenLocalAs = _SnBgp4GenLocalAs_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 1, 28),
    _SnBgp4GenLocalAs_Type()
)
snBgp4GenLocalAs.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snBgp4GenLocalAs.setStatus("current")
...
snBgp4GenDampenMap = _SnBgp4GenDampenMap_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 1, 47),
    _SnBgp4GenDampenMap_Type()
)
snBgp4GenDampenMap.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snBgp4GenDampenMap.setStatus("current")
_SnBgp4GenLocalAs4_Type = InetAutonomousSystemNumber
_SnBgp4GenLocalAs4_Object = MibScalar
snBgp4GenLocalAs4 = _SnBgp4GenLocalAs4_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 1, 48),
    _SnBgp4GenLocalAs4_Type()
)
snBgp4GenLocalAs4.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snBgp4GenLocalAs4.setStatus("current")
_SnBgp4GenDefaultMetric1_Type = Unsigned32
_SnBgp4GenDefaultMetric1_Object = MibScalar
snBgp4GenDefaultMetric1 = _SnBgp4GenDefaultMetric1_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 1, 49),
    _SnBgp4GenDefaultMetric1_Type()
)
snBgp4GenDefaultMetric1.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snBgp4GenDefaultMetric1.setStatus("current")
_SnBgp4GenDefaultLocalPreference1_Type = Unsigned32
_SnBgp4GenDefaultLocalPreference1_Object = MibScalar
snBgp4GenDefaultLocalPreference1 = _SnBgp4GenDefaultLocalPreference1_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 1, 50),
    _SnBgp4GenDefaultLocalPreference1_Type()
)
snBgp4GenDefaultLocalPreference1.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snBgp4GenDefaultLocalPreference1.setStatus("current")
_SnBgp4AddrFilter_ObjectIdentity = ObjectIdentity
snBgp4AddrFilter = _SnBgp4AddrFilter_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 2)
)
_SnBgp4AddrFilterTable_Object = MibTable
snBgp4AddrFilterTable = _SnBgp4AddrFilterTable_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 2, 1)
)
if mibBuilder.loadTexts:
    snBgp4AddrFilterTable.setStatus("current")
_SnBgp4AddrFilterEntry_Object = MibTableRow
snBgp4AddrFilterEntry = _SnBgp4AddrFilterEntry_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 2, 1, 1)
)
snBgp4AddrFilterEntry.setIndexNames(
    (0, "FOUNDRY-SN-BGP4-GROUP-MIB", "snBgp4AddrFilterIndex"),
)
if mibBuilder.loadTexts:
    snBgp4AddrFilterEntry.setStatus("current")
...
snBgp4NeighGenCfgTable = _SnBgp4NeighGenCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 6, 1)
)
if mibBuilder.loadTexts:
    snBgp4NeighGenCfgTable.setStatus("current")
_SnBgp4NeighGenCfgEntry_Object = MibTableRow
snBgp4NeighGenCfgEntry = _SnBgp4NeighGenCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 6, 1, 1)
)
snBgp4NeighGenCfgEntry.setIndexNames(
    (0, "FOUNDRY-SN-BGP4-GROUP-MIB", "snBgp4NeighGenCfgNeighIp"),
)
if mibBuilder.loadTexts:
    snBgp4NeighGenCfgEntry.setStatus("current")
...
if mibBuilder.loadTexts:
    snBgp4NeighGenCfgShutdown.setStatus("current")
...
snBgp4NetworkWeight = _SnBgp4NetworkWeight_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 10, 1, 1, 3),
    _SnBgp4NetworkWeight_Type()
)
snBgp4NetworkWeight.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snBgp4NetworkWeight.setStatus("current")
...
snBgp4RedisRouteMap = _SnBgp4RedisRouteMap_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 11, 1, 1, 3),
    _SnBgp4RedisRouteMap_Type()
)
snBgp4RedisRouteMap.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snBgp4RedisRouteMap.setStatus("current")
...
snBgp4RedisWeight = _SnBgp4RedisWeight_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 11, 1, 1, 4),
    _SnBgp4RedisWeight_Type()
)
snBgp4RedisWeight.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snBgp4RedisWeight.setStatus("current")
...
snBgp4RouteMapSetCommunityNum = _SnBgp4RouteMapSetCommunityNum_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 14, 1, 1, 7),
...
snBgp4RouteMapSetTag = _SnBgp4RouteMapSetTag_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 14, 1, 1, 13),
    _SnBgp4RouteMapSetTag_Type()
)
snBgp4RouteMapSetTag.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snBgp4RouteMapSetTag.setStatus("current")
...
if mibBuilder.loadTexts:
    snBgp4NeighOperStatusBgpType.setStatus("current")
...
if mibBuilder.loadTexts:
    snBgp4NeighOperStatusState.setStatus("current")
...
if mibBuilder.loadTexts:
    snBgp4NeighborSummaryState.setStatus("current")
...
snBgp4AttributeIndex = _SnBgp4AttributeIndex_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 18, 1, 1, 1),
    _SnBgp4AttributeIndex_Type()
)
snBgp4AttributeIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    snBgp4AttributeIndex.setStatus("current")
...
snBgp4AttributeMetric = _SnBgp4AttributeMetric_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 18, 1, 1, 3),
    _SnBgp4AttributeMetric_Type()
)
snBgp4AttributeMetric.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    snBgp4AttributeMetric.setStatus("current")
...
snBgp4AttributeOrigin = _SnBgp4AttributeOrigin_Object(
    (1, 3, 6, 1, 4, 1, 1991, 1, 2, 11, 18, 1, 1, 4),
    _SnBgp4AttributeOrigin_Type()
)
snBgp4AttributeOrigin.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    snBgp4AttributeOrigin.setStatus("current")
...
if mibBuilder.loadTexts:
    snBgp4NeighPrefixGroupRowStatus.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"snBgp4": snBgp4,
       ...
       "snBgp4GenLocalAs4": snBgp4GenLocalAs4,
       "snBgp4GenDefaultMetric1": snBgp4GenDefaultMetric1,
       "snBgp4GenDefaultLocalPreference1": snBgp4GenDefaultLocalPreference1,
