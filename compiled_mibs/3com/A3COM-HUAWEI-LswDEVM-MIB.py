# SNMP MIB module (A3COM-HUAWEI-LswDEVM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\3com\A3COM-HUAWEI-LswDEVM-MIB
...
hwdevMFanStatusTable = _HwdevMFanStatusTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 1)
)
if mibBuilder.loadTexts:
...
hwdevMFanStatusEntry = _HwdevMFanStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 1, 1)
)
hwdevMFanStatusEntry.setIndexNames(
    (0, "A3COM-HUAWEI-LswDEVM-MIB", "hwDevMFanNum"),
)
if mibBuilder.loadTexts:
...
hwDevMFanNum = _HwDevMFanNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 1, 1, 1),
    _HwDevMFanNum_Type()
)
...
hwDevMFanStatus = _HwDevMFanStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 1, 1, 2),
...
hwdevMPowerStatusTable = _HwdevMPowerStatusTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 2)
)
if mibBuilder.loadTexts:
...
hwdevMPowerStatusEntry = _HwdevMPowerStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 2, 1)
)
hwdevMPowerStatusEntry.setIndexNames(
    (0, "A3COM-HUAWEI-LswDEVM-MIB", "hwDevMPowerNum"),
)
if mibBuilder.loadTexts:
...
hwDevMPowerNum = _HwDevMPowerNum_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 2, 1, 1),
...
hwDevMPowerStatus = _HwDevMPowerStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 2, 1, 2),
...
hwdevMSlotEnvironmentTable = _HwdevMSlotEnvironmentTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 3)
)
if mibBuilder.loadTexts:
...
hwdevMSlotEnvironmentEntry = _HwdevMSlotEnvironmentEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 3, 1)
)
hwdevMSlotEnvironmentEntry.setIndexNames(
    ...
    (0, "A3COM-HUAWEI-LswDEVM-MIB", "hwdevMSlotEnvironmentType"),
)
if mibBuilder.loadTexts:
...
hwdevMSlotEnvironmentType = _HwdevMSlotEnvironmentType_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 3, 1, 1),
...
hwDevMSlotEnvironmentStatus = _HwDevMSlotEnvironmentStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 3, 1, 2),
...
hwDevMSlotEnvironmentValue = _HwDevMSlotEnvironmentValue_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 3, 1, 3),
...
hwDevMSlotEnvironmentUpperLimit = _HwDevMSlotEnvironmentUpperLimit_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 3, 1, 4),
...
hwDevMSlotEnvironmentLowerLimit = _HwDevMSlotEnvironmentLowerLimit_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 3, 1, 5),
...
hwLinkUpDownTrapEnable = _HwLinkUpDownTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 9),
...
hwdot1qTpFdbLearnStatus = _Hwdot1qTpFdbLearnStatus_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 10),
...
hwCfmWriteFlash = _HwCfmWriteFlash_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 11),
...
hwCfmEraseFlash = _HwCfmEraseFlash_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 12),
...
hwDevMFirstTrapTime = _HwDevMFirstTrapTime_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 2, 23, 1, 9, 1, 13),
    _HwDevMFirstTrapTime_Type()
)
hwDevMFirstTrapTime.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hwDevMFirstTrapTime.setStatus("current")
...
hwCpuEntry.setIndexNames(
    (0, "A3COM-HUAWEI-LswDEVM-MIB", "hwCpuIndex"),
)
if mibBuilder.loadTexts:
...
hwMemModuleIndex = _HwMemModuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 1, 1, 1),
...
hwMemSize = _HwMemSize_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 1, 1, 2),
    _HwMemSize_Type()
)
...
hwMemFree = _HwMemFree_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 1, 1, 3),
    _HwMemFree_Type()
)
...
hwMemRawSliceUsed = _HwMemRawSliceUsed_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 1, 1, 4),
...
hwMemLgFree = _HwMemLgFree_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 1, 1, 5),
    _HwMemLgFree_Type()
)
...
hwMemFail = _HwMemFail_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 1, 1, 6),
    _HwMemFail_Type()
)
...
hwMemFailNoMem = _HwMemFailNoMem_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 1, 1, 7),
...
hwBufTable = _HwBufTable_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 2)
)
if mibBuilder.loadTexts:
    hwBufTable.setStatus("current")
_HwBufEntry_Object = MibTableRow
hwBufEntry = _HwBufEntry_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 2, 1)
)
hwBufEntry.setIndexNames(
    (0, "A3COM-HUAWEI-LswDEVM-MIB", "hwBufModuleIndex"),
    (0, "A3COM-HUAWEI-LswDEVM-MIB", "hwBufSize"),
)
if mibBuilder.loadTexts:
...
hwBufModuleIndex = _HwBufModuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 2, 1, 1),
...
hwBufSize = _HwBufSize_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 2, 1, 2),
    _HwBufSize_Type()
)
...
hwBufCurrentTotal = _HwBufCurrentTotal_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 2, 1, 3),
...
hwBufCurrentUsed = _HwBufCurrentUsed_Object(
    (1, 3, 6, 1, 4, 1, 43, 45, 1, 6, 1, 2, 2, 1, 4),
...
mibBuilder.exportSymbols(
    ...
    **{"hwLswdevMMib": hwLswdevMMib,
       ...
       "hwDevMFirstTrapTime": hwDevMFirstTrapTime,
       "hwDevice": hwDevice,
