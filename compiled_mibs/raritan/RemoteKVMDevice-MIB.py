...
# Notes
# -----
# ASN.1 source file://mibs\raritan\RemoteKVMDevice-MIB
...
remoteKVMDeviceGet = _RemoteKVMDeviceGet_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1)
)


class _SystemUsageMemory_Type(Gauge32):
    """Custom type systemUsageMemory based on Gauge32"""
...
_SystemUsageMemory_Type.__name__ = "Gauge32"
_SystemUsageMemory_Object = MibScalar
systemUsageMemory = _SystemUsageMemory_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 1),
    _SystemUsageMemory_Type()
)
systemUsageMemory.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    systemUsageMemory.setStatus("current")


class _SystemUsageCPU_Type(Gauge32):
    """Custom type systemUsageCPU based on Gauge32"""
    subtypeSpec = Gauge32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_SystemUsageCPU_Type.__name__ = "Gauge32"
_SystemUsageCPU_Object = MibScalar
systemUsageCPU = _SystemUsageCPU_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 2),
    _SystemUsageCPU_Type()
)
systemUsageCPU.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    systemUsageCPU.setStatus("current")
_SystemPowerSupplyTable_Object = MibTable
systemPowerSupplyTable = _SystemPowerSupplyTable_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 3)
)
if mibBuilder.loadTexts:
    systemPowerSupplyTable.setStatus("current")
_SystemPowerSupplyEntry_Object = MibTableRow
systemPowerSupplyEntry = _SystemPowerSupplyEntry_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 3, 1)
)
systemPowerSupplyEntry.setIndexNames(
    (0, "RemoteKVMDevice-MIB", "systemPowerSupplyNumber"),
)
if mibBuilder.loadTexts:
    systemPowerSupplyEntry.setStatus("current")


class _SystemPowerSupplyNumber_Type(Integer32):
    """Custom type systemPowerSupplyNumber based on Integer32"""
...
_SystemPowerSupplyNumber_Type.__name__ = "Integer32"
_SystemPowerSupplyNumber_Object = MibTableColumn
systemPowerSupplyNumber = _SystemPowerSupplyNumber_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 3, 1, 1),
    _SystemPowerSupplyNumber_Type()
)
systemPowerSupplyNumber.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    systemPowerSupplyNumber.setStatus("current")
_SystemPowerSupplyPowerOn_Type = TruthValue
_SystemPowerSupplyPowerOn_Object = MibTableColumn
systemPowerSupplyPowerOn = _SystemPowerSupplyPowerOn_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 3, 1, 2),
    _SystemPowerSupplyPowerOn_Type()
)
systemPowerSupplyPowerOn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    systemPowerSupplyPowerOn.setStatus("current")
_PortDataTable_Object = MibTable
portDataTable = _PortDataTable_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 4)
)
if mibBuilder.loadTexts:
    portDataTable.setStatus("current")
_PortDataEntry_Object = MibTableRow
portDataEntry = _PortDataEntry_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 4, 1)
)
portDataEntry.setIndexNames(
    (0, "RemoteKVMDevice-MIB", "portDataIndex"),
)
if mibBuilder.loadTexts:
    portDataEntry.setStatus("current")


class _PortDataIndex_Type(Integer32):
    """Custom type portDataIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_PortDataIndex_Type.__name__ = "Integer32"
_PortDataIndex_Object = MibTableColumn
portDataIndex = _PortDataIndex_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 4, 1, 1),
    _PortDataIndex_Type()
)
portDataIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    portDataIndex.setStatus("current")


class _PortDataNumber_Type(Integer32):
    """Custom type portDataNumber based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 1024),
    )
...
_PortDataNumber_Type.__name__ = "Integer32"
_PortDataNumber_Object = MibTableColumn
portDataNumber = _PortDataNumber_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 4, 1, 2),
    _PortDataNumber_Type()
)
portDataNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    portDataNumber.setStatus("current")
_PortDataName_Type = DisplayString
_PortDataName_Object = MibTableColumn
portDataName = _PortDataName_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 4, 1, 3),
    _PortDataName_Type()
)
portDataName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    portDataName.setStatus("current")
_PortDataType_Type = DisplayString
_PortDataType_Object = MibTableColumn
portDataType = _PortDataType_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 4, 1, 4),
    _PortDataType_Type()
)
portDataType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    portDataType.setStatus("current")


class _PortDataStatus_Type(Integer32):
    """Custom type portDataStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_PortDataStatus_Type.__name__ = "Integer32"
_PortDataStatus_Object = MibTableColumn
portDataStatus = _PortDataStatus_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 4, 1, 5),
    _PortDataStatus_Type()
)
portDataStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    portDataStatus.setStatus("current")
_SystemSerialNumber_Type = DisplayString
_SystemSerialNumber_Object = MibScalar
systemSerialNumber = _SystemSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 1, 5),
...
rcpObjectName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
rcpObjectInstance.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
rcpIPAddress.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
portStatus.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
portName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
clusterID.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
ipPort.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
resetType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
interface.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
ethernetInterface.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
backupRestoreAction.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
imageType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
fileVersion.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
fileType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
outletName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
serialNumber.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
cimName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
count.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
restoredLanPort.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
remoteIpAddress.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
oldIpAddress.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
newIpAddress.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
newNetmask.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
oldNetmask.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
oldGateway.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
newGateway.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
sxAlertString.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
pduName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
certificateAuthorityName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
sysDateAndTime.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
fipsModeStatus.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
bannerChanges.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
bannerAction.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
portList.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
certificatePurpose = _CertificatePurpose_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 48),
    _CertificatePurpose_Type()
)
certificatePurpose.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    certificatePurpose.setStatus("current")


class _KeyPurpose_Type(Integer32):
    """Custom type keyPurpose based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_KeyPurpose_Type.__name__ = "Integer32"
_KeyPurpose_Object = MibScalar
keyPurpose = _KeyPurpose_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 49),
    _KeyPurpose_Type()
)
keyPurpose.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    keyPurpose.setStatus("current")
_EventDetail_Type = DisplayString
_EventDetail_Object = MibScalar
eventDetail = _EventDetail_Object(
    (1, 3, 6, 1, 4, 1, 13742, 3, 50),
    _EventDetail_Type()
)
eventDetail.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    eventDetail.setStatus("current")
...
raritanMibBasicGroup.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ...
        ("RemoteKVMDevice-MIB", "certificatePurpose"),
        ("RemoteKVMDevice-MIB", "keyPurpose"),
        ("RemoteKVMDevice-MIB", "eventDetail"))
)
if mibBuilder.loadTexts:
    raritanMibBasicGroup.setStatus("current")

raritanMibGetGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 13742, 9, 2, 3)
)
raritanMibGetGroup.setObjects(
      *(("RemoteKVMDevice-MIB", "systemUsageMemory"),
        ("RemoteKVMDevice-MIB", "systemUsageCPU"),
        ("RemoteKVMDevice-MIB", "systemPowerSupplyPowerOn"),
        ("RemoteKVMDevice-MIB", "portDataNumber"),
        ("RemoteKVMDevice-MIB", "portDataName"),
        ("RemoteKVMDevice-MIB", "portDataType"),
        ("RemoteKVMDevice-MIB", "portDataStatus"),
        ("RemoteKVMDevice-MIB", "systemSerialNumber"))
)
if mibBuilder.loadTexts:
    raritanMibGetGroup.setStatus("current")
...
dsamUpdateStarted = NotificationType(
    (1, 3, 6, 1, 4, 1, 13742, 3, 0, 62)
)
dsamUpdateStarted.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ("RemoteKVMDevice-MIB", "rcpObjectInstance"))
)
if mibBuilder.loadTexts:
    dsamUpdateStarted.setStatus(
        "current"
    )

dsamUpdateCompleted = NotificationType(
    (1, 3, 6, 1, 4, 1, 13742, 3, 0, 63)
)
dsamUpdateCompleted.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ("RemoteKVMDevice-MIB", "rcpObjectInstance"))
)
if mibBuilder.loadTexts:
    dsamUpdateCompleted.setStatus(
        "current"
    )

dsamConnected = NotificationType(
    (1, 3, 6, 1, 4, 1, 13742, 3, 0, 64)
)
dsamConnected.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ("RemoteKVMDevice-MIB", "rcpObjectInstance"),
        ("RemoteKVMDevice-MIB", "serialNumber"))
)
if mibBuilder.loadTexts:
    dsamConnected.setStatus(
        "current"
    )

dsamDisconnected = NotificationType(
    (1, 3, 6, 1, 4, 1, 13742, 3, 0, 65)
)
dsamDisconnected.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ("RemoteKVMDevice-MIB", "rcpObjectInstance"),
        ("RemoteKVMDevice-MIB", "serialNumber"))
)
if mibBuilder.loadTexts:
    dsamDisconnected.setStatus(
        "current"
    )

terminalBlockSettingsChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 13742, 3, 0, 66)
)
terminalBlockSettingsChanged.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ("RemoteKVMDevice-MIB", "rcpObjectInstance"),
        ("RemoteKVMDevice-MIB", "userName"),
        ("RemoteKVMDevice-MIB", "rcpIPAddress"))
...
if mibBuilder.loadTexts:
    terminalBlockSettingsChanged.setStatus(
        "current"
    )

localPortOutputEnabled = NotificationType(
    (1, 3, 6, 1, 4, 1, 13742, 3, 0, 67)
)
localPortOutputEnabled.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ("RemoteKVMDevice-MIB", "rcpObjectInstance"),
        ("RemoteKVMDevice-MIB", "userName"),
        ("RemoteKVMDevice-MIB", "rcpIPAddress"))
...
if mibBuilder.loadTexts:
    localPortOutputEnabled.setStatus(
        "current"
    )

localPortOutputDisabled = NotificationType(
    (1, 3, 6, 1, 4, 1, 13742, 3, 0, 68)
)
localPortOutputDisabled.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ("RemoteKVMDevice-MIB", "rcpObjectInstance"),
        ("RemoteKVMDevice-MIB", "userName"),
        ("RemoteKVMDevice-MIB", "rcpIPAddress"))
...
if mibBuilder.loadTexts:
    localPortOutputDisabled.setStatus(
        "current"
    )

userUploadedCACertificate = NotificationType(
    (1, 3, 6, 1, 4, 1, 13742, 3, 0, 69)
)
userUploadedCACertificate.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ("RemoteKVMDevice-MIB", "rcpObjectInstance"),
        ("RemoteKVMDevice-MIB", "userName"),
        ("RemoteKVMDevice-MIB", "rcpIPAddress"),
...
if mibBuilder.loadTexts:
    userUploadedCACertificate.setStatus(
        "current"
    )

userUploadedClientCertificate = NotificationType(
    (1, 3, 6, 1, 4, 1, 13742, 3, 0, 70)
)
userUploadedClientCertificate.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ("RemoteKVMDevice-MIB", "rcpObjectInstance"),
        ("RemoteKVMDevice-MIB", "userName"),
        ("RemoteKVMDevice-MIB", "rcpIPAddress"),
...
if mibBuilder.loadTexts:
    userUploadedClientCertificate.setStatus(
        "current"
    )

userUploadedClientKey = NotificationType(
    (1, 3, 6, 1, 4, 1, 13742, 3, 0, 71)
)
userUploadedClientKey.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ("RemoteKVMDevice-MIB", "rcpObjectInstance"),
        ("RemoteKVMDevice-MIB", "userName"),
        ("RemoteKVMDevice-MIB", "rcpIPAddress"),
...
if mibBuilder.loadTexts:
    userUploadedClientKey.setStatus(
        "current"
    )

userModifiedCertificateRepository = NotificationType(
    (1, 3, 6, 1, 4, 1, 13742, 3, 0, 72)
)
userModifiedCertificateRepository.setObjects(
      *(("RemoteKVMDevice-MIB", "rcpObjectName"),
        ("RemoteKVMDevice-MIB", "rcpObjectInstance"),
        ("RemoteKVMDevice-MIB", "eventDetail"))
)
if mibBuilder.loadTexts:
    userModifiedCertificateRepository.setStatus(
        "current"
    )
...
raritanMibTrapGroup.setObjects(
      *(("RemoteKVMDevice-MIB", "rebootStarted"),
        ...
        ("RemoteKVMDevice-MIB", "dsamUpdateStarted"),
        ("RemoteKVMDevice-MIB", "dsamUpdateCompleted"),
        ("RemoteKVMDevice-MIB", "dsamConnected"),
        ("RemoteKVMDevice-MIB", "dsamDisconnected"),
        ("RemoteKVMDevice-MIB", "terminalBlockSettingsChanged"),
        ("RemoteKVMDevice-MIB", "localPortOutputEnabled"),
        ("RemoteKVMDevice-MIB", "localPortOutputDisabled"),
        ("RemoteKVMDevice-MIB", "userUploadedCACertificate"),
        ("RemoteKVMDevice-MIB", "userUploadedClientCertificate"),
        ("RemoteKVMDevice-MIB", "userUploadedClientKey"),
        ("RemoteKVMDevice-MIB", "userModifiedCertificateRepository"))
)
if mibBuilder.loadTexts:
...
raritanMibCompliance.setObjects(
      *(("RemoteKVMDevice-MIB", "raritanMibBasicGroup"),
        ("RemoteKVMDevice-MIB", "raritanMibTrapGroup"),
        ("RemoteKVMDevice-MIB", "raritanMibGetGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"raritan": raritan,
       ...
       "dsamUpdateStarted": dsamUpdateStarted,
       "dsamUpdateCompleted": dsamUpdateCompleted,
       "dsamConnected": dsamConnected,
       "dsamDisconnected": dsamDisconnected,
       "terminalBlockSettingsChanged": terminalBlockSettingsChanged,
       "localPortOutputEnabled": localPortOutputEnabled,
       "localPortOutputDisabled": localPortOutputDisabled,
       "userUploadedCACertificate": userUploadedCACertificate,
       "userUploadedClientCertificate": userUploadedClientCertificate,
       "userUploadedClientKey": userUploadedClientKey,
       "userModifiedCertificateRepository": userModifiedCertificateRepository,
       "remoteKVMDeviceGet": remoteKVMDeviceGet,
       "systemUsageMemory": systemUsageMemory,
       "systemUsageCPU": systemUsageCPU,
       "systemPowerSupplyTable": systemPowerSupplyTable,
       "systemPowerSupplyEntry": systemPowerSupplyEntry,
       "systemPowerSupplyNumber": systemPowerSupplyNumber,
       "systemPowerSupplyPowerOn": systemPowerSupplyPowerOn,
       "portDataTable": portDataTable,
       "portDataEntry": portDataEntry,
       "portDataIndex": portDataIndex,
       "portDataNumber": portDataNumber,
       "portDataName": portDataName,
       "portDataType": portDataType,
       "portDataStatus": portDataStatus,
       ...
       "raritanMibGetGroup": raritanMibGetGroup}
)
