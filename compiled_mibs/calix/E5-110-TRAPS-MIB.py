# SNMP MIB module (E5-110-TRAPS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\calix\E5-110-TRAPS-MIB
...
(e5x110,) = mibBuilder.importSymbols(
    "E5-110-MIB",
    "e5x110")
...
eqptAlarmInputName = _EqptAlarmInputName_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 1, 8),
...
sysMacAntiSpoofOrig = _SysMacAntiSpoofOrig_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 1, 9),
...
sysMacAntiSpoofNew = _SysMacAntiSpoofNew_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 1, 10),
...
sysMacAntiSpoofMAC = _SysMacAntiSpoofMAC_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 1, 11),
...
sysAlarmOrigSeverity = _SysAlarmOrigSeverity_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 1, 12),
...
sysAlarmNewSeverity = _SysAlarmNewSeverity_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 1, 13),
...
sysAlarmConfId = _SysAlarmConfId_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 1, 14),
...
equipment = _Equipment_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 3)
)
_Systrap_ObjectIdentity = ObjectIdentity
systrap = _Systrap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 4)
)
_Interface_ObjectIdentity = ObjectIdentity
interface = _Interface_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 8)
)
_E5Alarm_ObjectIdentity = ObjectIdentity
e5Alarm = _E5Alarm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9)
)
_E5AlarmTable_Object = MibTable
e5AlarmTable = _E5AlarmTable_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1)
)
if mibBuilder.loadTexts:
    e5AlarmTable.setStatus("current")
_E5AlarmEntry_Object = MibTableRow
e5AlarmEntry = _E5AlarmEntry_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1)
)
e5AlarmEntry.setIndexNames(
    (0, "E5-110-TRAPS-MIB", "e5AlarmObjectClass"),
    (0, "E5-110-TRAPS-MIB", "e5AlarmObjectInstance1"),
    (0, "E5-110-TRAPS-MIB", "e5AlarmObjectInstance2"),
    (0, "E5-110-TRAPS-MIB", "e5AlarmObjectInstance3"),
    (0, "E5-110-TRAPS-MIB", "e5AlarmObjectInstance4"),
    (0, "E5-110-TRAPS-MIB", "e5AlarmObjectInstance5"),
    (0, "E5-110-TRAPS-MIB", "e5AlarmObjectInstance6"),
    (0, "E5-110-TRAPS-MIB", "e5AlarmObjectInstance7"),
...
e5AlarmObjectClass = _E5AlarmObjectClass_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 1),
...
e5AlarmObjectInstance1 = _E5AlarmObjectInstance1_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 2),
...
e5AlarmObjectInstance2 = _E5AlarmObjectInstance2_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 3),
...
e5AlarmObjectInstance3 = _E5AlarmObjectInstance3_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 4),
...
e5AlarmObjectInstance4 = _E5AlarmObjectInstance4_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 5),
...
e5AlarmObjectInstance5 = _E5AlarmObjectInstance5_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 6),
...
e5AlarmObjectInstance6 = _E5AlarmObjectInstance6_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 7),
...
e5AlarmObjectInstance7 = _E5AlarmObjectInstance7_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 8),
...
e5AlarmObjectInstance8 = _E5AlarmObjectInstance8_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 9),
...
e5AlarmType = _E5AlarmType_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 10),
    _E5AlarmType_Type()
)
...
e5AlarmSeverity = _E5AlarmSeverity_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 11),
...
e5AlarmTimeStamp = _E5AlarmTimeStamp_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 12),
...
e5AlarmServiceAffecting = _E5AlarmServiceAffecting_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 13),
...
e5AlarmLocationInfo = _E5AlarmLocationInfo_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 14),
...
e5AlarmText = _E5AlarmText_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 15),
    _E5AlarmText_Type()
)
...
e5AlarmTime = _E5AlarmTime_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 16),
    _E5AlarmTime_Type()
)
...
e5AlarmCliObject = _E5AlarmCliObject_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 17),
...
e5AlarmSecObjectClass = _E5AlarmSecObjectClass_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 18),
...
e5AlarmSecObjectInstance1 = _E5AlarmSecObjectInstance1_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 19),
...
e5AlarmSecObjectInstance2 = _E5AlarmSecObjectInstance2_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 20),
...
e5AlarmSecObjectInstance3 = _E5AlarmSecObjectInstance3_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 21),
...
e5AlarmSecObjectInstance4 = _E5AlarmSecObjectInstance4_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 22),
...
e5AlarmSecObjectInstance5 = _E5AlarmSecObjectInstance5_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 23),
...
e5AlarmSecObjectInstance6 = _E5AlarmSecObjectInstance6_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 24),
...
e5AlarmSecObjectInstance7 = _E5AlarmSecObjectInstance7_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 25),
...
e5AlarmSecObjectInstance8 = _E5AlarmSecObjectInstance8_Object(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 1, 1, 26),
...
eqptHWMonitorFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 3, 1)
)
if mibBuilder.loadTexts:
...
sysMacAntiSpoofing = NotificationType(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 4, 1)
)
sysMacAntiSpoofing.setObjects(
      *(("E5-110-TRAPS-MIB", "sysMacAntiSpoofOrig"),
        ("E5-110-TRAPS-MIB", "sysMacAntiSpoofNew"),
        ("E5-110-TRAPS-MIB", "sysMacAntiSpoofMAC"))
)
if mibBuilder.loadTexts:
...
sysAlarmCutoffEnable = NotificationType(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 4, 2)
)
if mibBuilder.loadTexts:
...
sysAlarmClearEnable = NotificationType(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 4, 3)
)
if mibBuilder.loadTexts:
...
sysLoginFailure = NotificationType(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 4, 4)
)
if mibBuilder.loadTexts:
...
sysAlarmSvrtyChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 4, 5)
)
if mibBuilder.loadTexts:
...
e5AlarmNotify = NotificationType(
    (1, 3, 6, 1, 4, 1, 6321, 1, 2, 3, 1, 12, 9, 2)
)
e5AlarmNotify.setObjects(
      *(("E5-110-TRAPS-MIB", "e5AlarmObjectClass"),
        ("E5-110-TRAPS-MIB", "e5AlarmObjectInstance1"),
        ("E5-110-TRAPS-MIB", "e5AlarmObjectInstance2"),
        ("E5-110-TRAPS-MIB", "e5AlarmObjectInstance3"),
        ("E5-110-TRAPS-MIB", "e5AlarmObjectInstance4"),
        ("E5-110-TRAPS-MIB", "e5AlarmType"),
        ("E5-110-TRAPS-MIB", "e5AlarmSeverity"),
        ("E5-110-TRAPS-MIB", "e5AlarmTimeStamp"),
        ("E5-110-TRAPS-MIB", "e5AlarmServiceAffecting"),
        ("E5-110-TRAPS-MIB", "e5AlarmText"),
        ("E5-110-TRAPS-MIB", "e5AlarmTime"))
)
if mibBuilder.loadTexts:
