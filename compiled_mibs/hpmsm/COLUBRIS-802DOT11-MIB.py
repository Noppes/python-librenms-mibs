# SNMP MIB module (COLUBRIS-802DOT11-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\hpmsm\COLUBRIS-802DOT11-MIB
...
colubris802dot11 = ModuleIdentity(
...
coDot11BSSID = _CoDot11BSSID_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 1, 1, 11),
    _CoDot11BSSID_Type()
)
coDot11BSSID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11BSSID.setStatus("current")
_CoDot11AdminMinimumDataRate_Type = ColubrisDataRate
_CoDot11AdminMinimumDataRate_Object = MibTableColumn
coDot11AdminMinimumDataRate = _CoDot11AdminMinimumDataRate_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 1, 1, 12),
    _CoDot11AdminMinimumDataRate_Type()
)
coDot11AdminMinimumDataRate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    coDot11AdminMinimumDataRate.setStatus("deprecated")
_CoDot11AdminMaximumDataRate_Type = ColubrisDataRate
_CoDot11AdminMaximumDataRate_Object = MibTableColumn
coDot11AdminMaximumDataRate = _CoDot11AdminMaximumDataRate_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 1, 1, 13),
    _CoDot11AdminMaximumDataRate_Type()
)
coDot11AdminMaximumDataRate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    coDot11AdminMaximumDataRate.setStatus("deprecated")
_CoDot11HighThroughputOptionImplemented_Type = TruthValue
_CoDot11HighThroughputOptionImplemented_Object = MibTableColumn
coDot11HighThroughputOptionImplemented = _CoDot11HighThroughputOptionImplemented_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 1, 1, 14),
    _CoDot11HighThroughputOptionImplemented_Type()
)
coDot11HighThroughputOptionImplemented.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11HighThroughputOptionImplemented.setStatus("current")
...
coDot11AuthenticationAlgorithmsEntry = _CoDot11AuthenticationAlgorithmsEntry_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 2, 1)
)
coDot11AuthenticationAlgorithmsEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "COLUBRIS-802DOT11-MIB", "coDot11AuthenticationAlgorithmsIndex"),
)
if mibBuilder.loadTexts:
...
coDot11AssociationEntry = _CoDot11AssociationEntry_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 5, 1)
)
coDot11AssociationEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "COLUBRIS-802DOT11-MIB", "coDot11AssociationIndex"),
)
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    coDot11TransmitRate.setUnits("500Kb/s")
...
_CoDot11StaHT_Type = TruthValue
_CoDot11StaHT_Object = MibTableColumn
coDot11StaHT = _CoDot11StaHT_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 5, 1, 30),
    _CoDot11StaHT_Type()
)
coDot11StaHT.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaHT.setStatus("current")
_CoDot11WDSPortTable_Object = MibTable
coDot11WDSPortTable = _CoDot11WDSPortTable_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 6)
)
if mibBuilder.loadTexts:
...
coDot11WDSPortEntry = _CoDot11WDSPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 6, 1)
)
coDot11WDSPortEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "COLUBRIS-802DOT11-MIB", "coDot11WDSPortIndex"),
)
if mibBuilder.loadTexts:
...
class _CoDot11UnauthorizedAPNotificationEnabled_Type(ColubrisNotificationEnable):
    """Custom type coDot11UnauthorizedAPNotificationEnabled based on ColubrisNotificationEnable"""
    defaultValue = 1


_CoDot11UnauthorizedAPNotificationEnabled_Type.__name__ = "ColubrisNotificationEnable"
...
class _CoDot11AssociationNotificationEnabled_Type(ColubrisNotificationEnable):
    """Custom type coDot11AssociationNotificationEnabled based on ColubrisNotificationEnable"""
    defaultValue = 2


_CoDot11AssociationNotificationEnabled_Type.__name__ = "ColubrisNotificationEnable"
...
_CoDot11StationHTTable_Object = MibTable
coDot11StationHTTable = _CoDot11StationHTTable_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15)
)
if mibBuilder.loadTexts:
    coDot11StationHTTable.setStatus("current")
_CoDot11StationHTEntry_Object = MibTableRow
coDot11StationHTEntry = _CoDot11StationHTEntry_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1)
)
if mibBuilder.loadTexts:
    coDot11StationHTEntry.setStatus("current")
_CoDot11StaTransmitMCS_Type = Unsigned32
_CoDot11StaTransmitMCS_Object = MibTableColumn
coDot11StaTransmitMCS = _CoDot11StaTransmitMCS_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 1),
    _CoDot11StaTransmitMCS_Type()
)
coDot11StaTransmitMCS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaTransmitMCS.setStatus("current")
_CoDot11StaReceiveMCS_Type = Unsigned32
_CoDot11StaReceiveMCS_Object = MibTableColumn
coDot11StaReceiveMCS = _CoDot11StaReceiveMCS_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 2),
    _CoDot11StaReceiveMCS_Type()
)
coDot11StaReceiveMCS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaReceiveMCS.setStatus("current")


class _CoDot11StaChannelWidth_Type(Integer32):
    """Custom type coDot11StaChannelWidth based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CoDot11StaChannelWidth_Type.__name__ = "Integer32"
_CoDot11StaChannelWidth_Object = MibTableColumn
coDot11StaChannelWidth = _CoDot11StaChannelWidth_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 3),
    _CoDot11StaChannelWidth_Type()
)
coDot11StaChannelWidth.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaChannelWidth.setStatus("current")
_CoDot11StaShortGI_Type = TruthValue
_CoDot11StaShortGI_Object = MibTableColumn
coDot11StaShortGI = _CoDot11StaShortGI_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 4),
    _CoDot11StaShortGI_Type()
)
coDot11StaShortGI.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaShortGI.setStatus("current")
_CoDot11StaPktsTxMCS0_Type = Counter32
_CoDot11StaPktsTxMCS0_Object = MibTableColumn
coDot11StaPktsTxMCS0 = _CoDot11StaPktsTxMCS0_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 5),
    _CoDot11StaPktsTxMCS0_Type()
)
coDot11StaPktsTxMCS0.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS0.setStatus("current")
_CoDot11StaPktsTxMCS1_Type = Counter32
_CoDot11StaPktsTxMCS1_Object = MibTableColumn
coDot11StaPktsTxMCS1 = _CoDot11StaPktsTxMCS1_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 6),
    _CoDot11StaPktsTxMCS1_Type()
)
coDot11StaPktsTxMCS1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS1.setStatus("current")
_CoDot11StaPktsTxMCS2_Type = Counter32
_CoDot11StaPktsTxMCS2_Object = MibTableColumn
coDot11StaPktsTxMCS2 = _CoDot11StaPktsTxMCS2_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 7),
    _CoDot11StaPktsTxMCS2_Type()
)
coDot11StaPktsTxMCS2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS2.setStatus("current")
_CoDot11StaPktsTxMCS3_Type = Counter32
_CoDot11StaPktsTxMCS3_Object = MibTableColumn
coDot11StaPktsTxMCS3 = _CoDot11StaPktsTxMCS3_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 8),
    _CoDot11StaPktsTxMCS3_Type()
)
coDot11StaPktsTxMCS3.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS3.setStatus("current")
_CoDot11StaPktsTxMCS4_Type = Counter32
_CoDot11StaPktsTxMCS4_Object = MibTableColumn
coDot11StaPktsTxMCS4 = _CoDot11StaPktsTxMCS4_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 9),
    _CoDot11StaPktsTxMCS4_Type()
)
coDot11StaPktsTxMCS4.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS4.setStatus("current")
_CoDot11StaPktsTxMCS5_Type = Counter32
_CoDot11StaPktsTxMCS5_Object = MibTableColumn
coDot11StaPktsTxMCS5 = _CoDot11StaPktsTxMCS5_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 10),
    _CoDot11StaPktsTxMCS5_Type()
)
coDot11StaPktsTxMCS5.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS5.setStatus("current")
_CoDot11StaPktsTxMCS6_Type = Counter32
_CoDot11StaPktsTxMCS6_Object = MibTableColumn
coDot11StaPktsTxMCS6 = _CoDot11StaPktsTxMCS6_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 11),
    _CoDot11StaPktsTxMCS6_Type()
)
coDot11StaPktsTxMCS6.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS6.setStatus("current")
_CoDot11StaPktsTxMCS7_Type = Counter32
_CoDot11StaPktsTxMCS7_Object = MibTableColumn
coDot11StaPktsTxMCS7 = _CoDot11StaPktsTxMCS7_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 12),
    _CoDot11StaPktsTxMCS7_Type()
)
coDot11StaPktsTxMCS7.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS7.setStatus("current")
_CoDot11StaPktsTxMCS8_Type = Counter32
_CoDot11StaPktsTxMCS8_Object = MibTableColumn
coDot11StaPktsTxMCS8 = _CoDot11StaPktsTxMCS8_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 13),
    _CoDot11StaPktsTxMCS8_Type()
)
coDot11StaPktsTxMCS8.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS8.setStatus("current")
_CoDot11StaPktsTxMCS9_Type = Counter32
_CoDot11StaPktsTxMCS9_Object = MibTableColumn
coDot11StaPktsTxMCS9 = _CoDot11StaPktsTxMCS9_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 14),
    _CoDot11StaPktsTxMCS9_Type()
)
coDot11StaPktsTxMCS9.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS9.setStatus("current")
_CoDot11StaPktsTxMCS10_Type = Counter32
_CoDot11StaPktsTxMCS10_Object = MibTableColumn
coDot11StaPktsTxMCS10 = _CoDot11StaPktsTxMCS10_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 15),
    _CoDot11StaPktsTxMCS10_Type()
)
coDot11StaPktsTxMCS10.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS10.setStatus("current")
_CoDot11StaPktsTxMCS11_Type = Counter32
_CoDot11StaPktsTxMCS11_Object = MibTableColumn
coDot11StaPktsTxMCS11 = _CoDot11StaPktsTxMCS11_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 16),
    _CoDot11StaPktsTxMCS11_Type()
)
coDot11StaPktsTxMCS11.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS11.setStatus("current")
_CoDot11StaPktsTxMCS12_Type = Counter32
_CoDot11StaPktsTxMCS12_Object = MibTableColumn
coDot11StaPktsTxMCS12 = _CoDot11StaPktsTxMCS12_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 17),
    _CoDot11StaPktsTxMCS12_Type()
)
coDot11StaPktsTxMCS12.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS12.setStatus("current")
_CoDot11StaPktsTxMCS13_Type = Counter32
_CoDot11StaPktsTxMCS13_Object = MibTableColumn
coDot11StaPktsTxMCS13 = _CoDot11StaPktsTxMCS13_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 18),
    _CoDot11StaPktsTxMCS13_Type()
)
coDot11StaPktsTxMCS13.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS13.setStatus("current")
_CoDot11StaPktsTxMCS14_Type = Counter32
_CoDot11StaPktsTxMCS14_Object = MibTableColumn
coDot11StaPktsTxMCS14 = _CoDot11StaPktsTxMCS14_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 19),
    _CoDot11StaPktsTxMCS14_Type()
)
coDot11StaPktsTxMCS14.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS14.setStatus("current")
_CoDot11StaPktsTxMCS15_Type = Counter32
_CoDot11StaPktsTxMCS15_Object = MibTableColumn
coDot11StaPktsTxMCS15 = _CoDot11StaPktsTxMCS15_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 20),
    _CoDot11StaPktsTxMCS15_Type()
)
coDot11StaPktsTxMCS15.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsTxMCS15.setStatus("current")
_CoDot11StaPktsRxMCS0_Type = Counter32
_CoDot11StaPktsRxMCS0_Object = MibTableColumn
coDot11StaPktsRxMCS0 = _CoDot11StaPktsRxMCS0_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 21),
    _CoDot11StaPktsRxMCS0_Type()
)
coDot11StaPktsRxMCS0.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS0.setStatus("current")
_CoDot11StaPktsRxMCS1_Type = Counter32
_CoDot11StaPktsRxMCS1_Object = MibTableColumn
coDot11StaPktsRxMCS1 = _CoDot11StaPktsRxMCS1_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 22),
    _CoDot11StaPktsRxMCS1_Type()
)
coDot11StaPktsRxMCS1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS1.setStatus("current")
_CoDot11StaPktsRxMCS2_Type = Counter32
_CoDot11StaPktsRxMCS2_Object = MibTableColumn
coDot11StaPktsRxMCS2 = _CoDot11StaPktsRxMCS2_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 23),
    _CoDot11StaPktsRxMCS2_Type()
)
coDot11StaPktsRxMCS2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS2.setStatus("current")
_CoDot11StaPktsRxMCS3_Type = Counter32
_CoDot11StaPktsRxMCS3_Object = MibTableColumn
coDot11StaPktsRxMCS3 = _CoDot11StaPktsRxMCS3_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 24),
    _CoDot11StaPktsRxMCS3_Type()
)
coDot11StaPktsRxMCS3.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS3.setStatus("current")
_CoDot11StaPktsRxMCS4_Type = Counter32
_CoDot11StaPktsRxMCS4_Object = MibTableColumn
coDot11StaPktsRxMCS4 = _CoDot11StaPktsRxMCS4_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 25),
    _CoDot11StaPktsRxMCS4_Type()
)
coDot11StaPktsRxMCS4.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS4.setStatus("current")
_CoDot11StaPktsRxMCS5_Type = Counter32
_CoDot11StaPktsRxMCS5_Object = MibTableColumn
coDot11StaPktsRxMCS5 = _CoDot11StaPktsRxMCS5_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 26),
    _CoDot11StaPktsRxMCS5_Type()
)
coDot11StaPktsRxMCS5.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS5.setStatus("current")
_CoDot11StaPktsRxMCS6_Type = Counter32
_CoDot11StaPktsRxMCS6_Object = MibTableColumn
coDot11StaPktsRxMCS6 = _CoDot11StaPktsRxMCS6_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 27),
    _CoDot11StaPktsRxMCS6_Type()
)
coDot11StaPktsRxMCS6.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS6.setStatus("current")
_CoDot11StaPktsRxMCS7_Type = Counter32
_CoDot11StaPktsRxMCS7_Object = MibTableColumn
coDot11StaPktsRxMCS7 = _CoDot11StaPktsRxMCS7_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 28),
    _CoDot11StaPktsRxMCS7_Type()
)
coDot11StaPktsRxMCS7.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS7.setStatus("current")
_CoDot11StaPktsRxMCS8_Type = Counter32
_CoDot11StaPktsRxMCS8_Object = MibTableColumn
coDot11StaPktsRxMCS8 = _CoDot11StaPktsRxMCS8_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 29),
    _CoDot11StaPktsRxMCS8_Type()
)
coDot11StaPktsRxMCS8.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS8.setStatus("current")
_CoDot11StaPktsRxMCS9_Type = Counter32
_CoDot11StaPktsRxMCS9_Object = MibTableColumn
coDot11StaPktsRxMCS9 = _CoDot11StaPktsRxMCS9_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 30),
    _CoDot11StaPktsRxMCS9_Type()
)
coDot11StaPktsRxMCS9.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS9.setStatus("current")
_CoDot11StaPktsRxMCS10_Type = Counter32
_CoDot11StaPktsRxMCS10_Object = MibTableColumn
coDot11StaPktsRxMCS10 = _CoDot11StaPktsRxMCS10_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 31),
    _CoDot11StaPktsRxMCS10_Type()
)
coDot11StaPktsRxMCS10.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS10.setStatus("current")
_CoDot11StaPktsRxMCS11_Type = Counter32
_CoDot11StaPktsRxMCS11_Object = MibTableColumn
coDot11StaPktsRxMCS11 = _CoDot11StaPktsRxMCS11_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 32),
    _CoDot11StaPktsRxMCS11_Type()
)
coDot11StaPktsRxMCS11.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS11.setStatus("current")
_CoDot11StaPktsRxMCS12_Type = Counter32
_CoDot11StaPktsRxMCS12_Object = MibTableColumn
coDot11StaPktsRxMCS12 = _CoDot11StaPktsRxMCS12_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 33),
    _CoDot11StaPktsRxMCS12_Type()
)
coDot11StaPktsRxMCS12.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS12.setStatus("current")
_CoDot11StaPktsRxMCS13_Type = Counter32
_CoDot11StaPktsRxMCS13_Object = MibTableColumn
coDot11StaPktsRxMCS13 = _CoDot11StaPktsRxMCS13_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 34),
    _CoDot11StaPktsRxMCS13_Type()
)
coDot11StaPktsRxMCS13.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS13.setStatus("current")
_CoDot11StaPktsRxMCS14_Type = Counter32
_CoDot11StaPktsRxMCS14_Object = MibTableColumn
coDot11StaPktsRxMCS14 = _CoDot11StaPktsRxMCS14_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 35),
    _CoDot11StaPktsRxMCS14_Type()
)
coDot11StaPktsRxMCS14.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS14.setStatus("current")
_CoDot11StaPktsRxMCS15_Type = Counter32
_CoDot11StaPktsRxMCS15_Object = MibTableColumn
coDot11StaPktsRxMCS15 = _CoDot11StaPktsRxMCS15_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 1, 15, 1, 36),
    _CoDot11StaPktsRxMCS15_Type()
)
coDot11StaPktsRxMCS15.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11StaPktsRxMCS15.setStatus("current")
...
coDot11RegDomainsSupportedEntry = _CoDot11RegDomainsSupportedEntry_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 5, 1)
)
coDot11RegDomainsSupportedEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "COLUBRIS-802DOT11-MIB", "coDot11RegDomainsSupportIndex"),
)
if mibBuilder.loadTexts:
...
coDot11AntennasListEntry = _CoDot11AntennasListEntry_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 6, 1)
)
coDot11AntennasListEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "COLUBRIS-802DOT11-MIB", "coDot11AntennaListIndex"),
)
if mibBuilder.loadTexts:
...
coDot11SupportedDataRatesTxEntry = _CoDot11SupportedDataRatesTxEntry_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 7, 1)
)
coDot11SupportedDataRatesTxEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "COLUBRIS-802DOT11-MIB", "coDot11SupportedDataRatesTxIndex"),
)
if mibBuilder.loadTexts:
...
coDot11SupportedDataRatesRxEntry = _CoDot11SupportedDataRatesRxEntry_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 8, 1)
)
coDot11SupportedDataRatesRxEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "COLUBRIS-802DOT11-MIB", "coDot11SupportedDataRatesRxIndex"),
)
if mibBuilder.loadTexts:
...
class _CoDot11SNRLevelNotificationEnabled_Type(ColubrisNotificationEnable):
    """Custom type coDot11SNRLevelNotificationEnabled based on ColubrisNotificationEnable"""
    defaultValue = 1


_CoDot11SNRLevelNotificationEnabled_Type.__name__ = "ColubrisNotificationEnable"
...
coDot11CountryCode = _CoDot11CountryCode_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 13),
    _CoDot11CountryCode_Type()
)
coDot11CountryCode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11CountryCode.setStatus("current")
_CoDot11PhyHTTable_Object = MibTable
coDot11PhyHTTable = _CoDot11PhyHTTable_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14)
)
if mibBuilder.loadTexts:
    coDot11PhyHTTable.setStatus("current")
_CoDot11PhyHTEntry_Object = MibTableRow
coDot11PhyHTEntry = _CoDot11PhyHTEntry_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1)
)
coDot11PhyHTEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    coDot11PhyHTEntry.setStatus("current")
_CoDot11FortyMHzOperationImplemented_Type = TruthValue
_CoDot11FortyMHzOperationImplemented_Object = MibTableColumn
coDot11FortyMHzOperationImplemented = _CoDot11FortyMHzOperationImplemented_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1, 1),
    _CoDot11FortyMHzOperationImplemented_Type()
)
coDot11FortyMHzOperationImplemented.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11FortyMHzOperationImplemented.setStatus("current")
_CoDot11FortyMHzOperationEnabled_Type = TruthValue
_CoDot11FortyMHzOperationEnabled_Object = MibTableColumn
coDot11FortyMHzOperationEnabled = _CoDot11FortyMHzOperationEnabled_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1, 2),
    _CoDot11FortyMHzOperationEnabled_Type()
)
coDot11FortyMHzOperationEnabled.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11FortyMHzOperationEnabled.setStatus("current")
_CoDot11CurrentPrimaryChannel_Type = Integer32
_CoDot11CurrentPrimaryChannel_Object = MibTableColumn
coDot11CurrentPrimaryChannel = _CoDot11CurrentPrimaryChannel_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1, 3),
    _CoDot11CurrentPrimaryChannel_Type()
)
coDot11CurrentPrimaryChannel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11CurrentPrimaryChannel.setStatus("current")
_CoDot11CurrentSecondaryChannel_Type = Integer32
_CoDot11CurrentSecondaryChannel_Object = MibTableColumn
coDot11CurrentSecondaryChannel = _CoDot11CurrentSecondaryChannel_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1, 4),
    _CoDot11CurrentSecondaryChannel_Type()
)
coDot11CurrentSecondaryChannel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11CurrentSecondaryChannel.setStatus("current")
_CoDot11GreenfieldOptionImplemented_Type = TruthValue
_CoDot11GreenfieldOptionImplemented_Object = MibTableColumn
coDot11GreenfieldOptionImplemented = _CoDot11GreenfieldOptionImplemented_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1, 5),
    _CoDot11GreenfieldOptionImplemented_Type()
)
coDot11GreenfieldOptionImplemented.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11GreenfieldOptionImplemented.setStatus("current")
_CoDot11GreenfieldOptionEnabled_Type = TruthValue
_CoDot11GreenfieldOptionEnabled_Object = MibTableColumn
coDot11GreenfieldOptionEnabled = _CoDot11GreenfieldOptionEnabled_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1, 6),
    _CoDot11GreenfieldOptionEnabled_Type()
)
coDot11GreenfieldOptionEnabled.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11GreenfieldOptionEnabled.setStatus("current")
_CoDot11ShortGIOptionInTwentyImplemented_Type = TruthValue
_CoDot11ShortGIOptionInTwentyImplemented_Object = MibTableColumn
coDot11ShortGIOptionInTwentyImplemented = _CoDot11ShortGIOptionInTwentyImplemented_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1, 7),
    _CoDot11ShortGIOptionInTwentyImplemented_Type()
)
coDot11ShortGIOptionInTwentyImplemented.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11ShortGIOptionInTwentyImplemented.setStatus("current")
_CoDot11ShortGIOptionInTwentyEnabled_Type = TruthValue
_CoDot11ShortGIOptionInTwentyEnabled_Object = MibTableColumn
coDot11ShortGIOptionInTwentyEnabled = _CoDot11ShortGIOptionInTwentyEnabled_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1, 8),
    _CoDot11ShortGIOptionInTwentyEnabled_Type()
)
coDot11ShortGIOptionInTwentyEnabled.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11ShortGIOptionInTwentyEnabled.setStatus("current")
_CoDot11ShortGIOptionInFortyImplemented_Type = TruthValue
_CoDot11ShortGIOptionInFortyImplemented_Object = MibTableColumn
coDot11ShortGIOptionInFortyImplemented = _CoDot11ShortGIOptionInFortyImplemented_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1, 9),
    _CoDot11ShortGIOptionInFortyImplemented_Type()
)
coDot11ShortGIOptionInFortyImplemented.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11ShortGIOptionInFortyImplemented.setStatus("current")
_CoDot11ShortGIOptionInFortyEnabled_Type = TruthValue
_CoDot11ShortGIOptionInFortyEnabled_Object = MibTableColumn
coDot11ShortGIOptionInFortyEnabled = _CoDot11ShortGIOptionInFortyEnabled_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1, 10),
    _CoDot11ShortGIOptionInFortyEnabled_Type()
)
coDot11ShortGIOptionInFortyEnabled.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11ShortGIOptionInFortyEnabled.setStatus("current")


class _CoDot11HighestSupportedDataRate_Type(Integer32):
    """Custom type coDot11HighestSupportedDataRate based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CoDot11HighestSupportedDataRate_Type.__name__ = "Integer32"
_CoDot11HighestSupportedDataRate_Object = MibTableColumn
coDot11HighestSupportedDataRate = _CoDot11HighestSupportedDataRate_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 3, 14, 1, 11),
    _CoDot11HighestSupportedDataRate_Type()
)
coDot11HighestSupportedDataRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    coDot11HighestSupportedDataRate.setStatus("current")
_CoDot11RSNAStatsTable_Object = MibTable
coDot11RSNAStatsTable = _CoDot11RSNAStatsTable_Object(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 4)
)
if mibBuilder.loadTexts:
...
coDot11AssociationEntry.registerAugmentions(
    ("COLUBRIS-802DOT11-MIB",
...
coDot11APBaseGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 1)
)
coDot11APBaseGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11RelayBetweenStation"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PrivacyOptionImplemented"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAOptionImplemented"),
        ("COLUBRIS-802DOT11-MIB", "coDot11BeaconPeriod"),
        ("COLUBRIS-802DOT11-MIB", "coDot11DTIMPeriod"),
        ("COLUBRIS-802DOT11-MIB", "coDot11NumberOfUsers"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AddToAssociationNotification"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyTxPowerAdminLevel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyTxPowerOperLevel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11BSSID"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AdminMinimumDataRate"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AdminMaximumDataRate"),
        ("COLUBRIS-802DOT11-MIB", "coDot11HighThroughputOptionImplemented"))
)
if mibBuilder.loadTexts:
    coDot11APBaseGroup.setStatus("deprecated")

coDot11APPrivacyGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 2)
)
coDot11APPrivacyGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11PrivacyInvoked"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ExcludeUnencrypted"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WEPICVErrorCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WEPExcludedCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WEPDefaultKeyID"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WEPDefaultKey1Value"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WEPDefaultKey2Value"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WEPDefaultKey3Value"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WEPDefaultKey4Value"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAEnabled"))
)
if mibBuilder.loadTexts:
    coDot11APPrivacyGroup.setStatus("current")

coDot11MACBaseGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 3)
)
coDot11MACBaseGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11MACAddress"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RTSThreshold"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ShortRetryLimit"),
        ("COLUBRIS-802DOT11-MIB", "coDot11LongRetryLimit"),
        ("COLUBRIS-802DOT11-MIB", "coDot11FragmentationThreshold"),
        ("COLUBRIS-802DOT11-MIB", "coDot11MaxTransmitMSDULifetime"),
        ("COLUBRIS-802DOT11-MIB", "coDot11MaxReceiveLifetime"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ManufacturerID"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ProductID"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RadioType"))
)
if mibBuilder.loadTexts:
    coDot11MACBaseGroup.setStatus("current")

coDot11MACStatisticsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 4)
)
coDot11MACStatisticsGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11RetryCount"),
...
coDot11SmtAuthenticationAlgorithmsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 5)
)
coDot11SmtAuthenticationAlgorithmsGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11AuthenticationAlgorithm"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AuthenticationAlgorithmsEnable"))
)
if mibBuilder.loadTexts:
    coDot11SmtAuthenticationAlgorithmsGroup.setStatus("current")

coDot11PhyConfigComplianceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 6)
)
coDot11PhyConfigComplianceGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11MinimumSNRLevel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CurrentSNRLevel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11Sensitivity"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyAdminStatus"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyOperStatus"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PHYType"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CurrentRegDomain"),
        ("COLUBRIS-802DOT11-MIB", "coDot11TempType"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CurrentOperFrequency"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CurrentOperPHYType"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RadioEnabled"),
        ("COLUBRIS-802DOT11-MIB", "coDot11OperatingMode"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AutoChannelEnabled"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AutoChannelInterval"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AutoPowerEnabled"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AutoPowerInterval"))
)
if mibBuilder.loadTexts:
    coDot11PhyConfigComplianceGroup.setStatus("current")

coDot11PhyConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 7)
)
coDot11PhyConfigGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11SNRLevelNotificationEnabled"),
        ("COLUBRIS-802DOT11-MIB", "coDot11SNRLevelNotificationInterval"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CountryCode"))
)
if mibBuilder.loadTexts:
    coDot11PhyConfigGroup.setStatus("current")

coDot11PhyAntennaComplianceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 8)
)
coDot11PhyAntennaComplianceGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11CurrentTxAntenna"),
        ("COLUBRIS-802DOT11-MIB", "coDot11DiversitySupport"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CurrentRxAntenna"))
)
if mibBuilder.loadTexts:
    coDot11PhyAntennaComplianceGroup.setStatus("current")

coDot11PhyDSSSComplianceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 9)
)
coDot11PhyDSSSComplianceGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11CurrentChannel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CCAModeSupported"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CurrentCCAMode"))
)
if mibBuilder.loadTexts:
    coDot11PhyDSSSComplianceGroup.setStatus("current")

coDot11PhyRegDomainsSupportGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 10)
)
coDot11PhyRegDomainsSupportGroup.setObjects(
    ("COLUBRIS-802DOT11-MIB", "coDot11RegDomainsSupportValue")
)
if mibBuilder.loadTexts:
    coDot11PhyRegDomainsSupportGroup.setStatus("current")

coDot11PhyAntennasListGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 11)
)
coDot11PhyAntennasListGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11SupportedTxAntenna"),
        ("COLUBRIS-802DOT11-MIB", "coDot11SupportedRxAntenna"),
        ("COLUBRIS-802DOT11-MIB", "coDot11DiversitySelectionRx"))
)
if mibBuilder.loadTexts:
    coDot11PhyAntennasListGroup.setStatus("current")

coDot11PhyRateGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 12)
)
coDot11PhyRateGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11SupportedDataRatesTxValue"),
        ("COLUBRIS-802DOT11-MIB", "coDot11SupportedDataRatesRxValue"))
)
if mibBuilder.loadTexts:
    coDot11PhyRateGroup.setStatus("current")

coDot11CountersGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 13)
)
coDot11CountersGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11TransmittedFragmentCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11MulticastTransmittedFrameCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11FailedCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11FrameDuplicateCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RTSSuccessCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RTSFailureCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ACKFailureCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ReceivedFragmentCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11MulticastReceivedFrameCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11FCSErrorCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WEPUndecryptableCount"),
        ("COLUBRIS-802DOT11-MIB", "coDot11TransmittedFrameCount"))
)
if mibBuilder.loadTexts:
    coDot11CountersGroup.setStatus("current")

coDot11AssociationGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 14)
)
coDot11AssociationGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11StationMACAddress"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StationConnectTime"),
        ("COLUBRIS-802DOT11-MIB", "coDot11SignalLevel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11NoiseLevel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11SNR"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate1"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate2"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate5dot5"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate6"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate9"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate11"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate12"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate18"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate24"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate36"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate48"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PktsRate54"),
        ("COLUBRIS-802DOT11-MIB", "coDot11TransmitRate"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ReceiveRate"),
        ("COLUBRIS-802DOT11-MIB", "coDot11InPkts"),
        ("COLUBRIS-802DOT11-MIB", "coDot11OutPkts"),
        ("COLUBRIS-802DOT11-MIB", "coDot11InOctets"),
        ("COLUBRIS-802DOT11-MIB", "coDot11OutOctets"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StationSSID"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StationName"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StationIPAddress"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StationVLAN"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StationLocalInterface"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaHT"))
)
if mibBuilder.loadTexts:
    coDot11AssociationGroup.setStatus("current")

coDot11AssociationConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 15)
)
coDot11AssociationConfigGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11AssociationNotificationEnabled"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AssociationNotificationInterval"))
)
if mibBuilder.loadTexts:
    coDot11AssociationConfigGroup.setStatus("current")

coDot11ScanGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 16)
)
coDot11ScanGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11ScanMacAddress"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanChannel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanSSID"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanSignalLevel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanNoiseLevel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanSNR"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanStatus"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanPHYType"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanInactivityTime"))
)
if mibBuilder.loadTexts:
    coDot11ScanGroup.setStatus("current")

coDot11ScanConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 17)
)
coDot11ScanConfigGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11ScanEnabled"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanPeriodicity"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanAuthorizedListURL"),
        ("COLUBRIS-802DOT11-MIB", "coDot11UnauthorizedAPNotificationEnabled"),
        ("COLUBRIS-802DOT11-MIB", "coDot11UnauthorizedAPNotificationInterval"))
)
if mibBuilder.loadTexts:
    coDot11ScanConfigGroup.setStatus("current")

coDot11WDSComplianceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 18)
)
coDot11WDSComplianceGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11WDSPortMacAddress"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WDSPortCurrentRate"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WDSPortSNRLevel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WDSPortTxPackets"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WDSPortTxDropped"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WDSPortTxErrors"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WDSPortRxPackets"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WDSPortRxDropped"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WDSPortRxErrors"))
)
if mibBuilder.loadTexts:
    coDot11WDSComplianceGroup.setStatus("current")

coDot11RSNBase = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 20)
)
coDot11RSNBase.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11RSNAStatsVersion"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAStatsSelectedPairwiseCipher"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAStatsTKIPICVErrors"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAStatsTKIPLocalMICFailures"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAStatsTKIPRemoteMICFailures"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAStatsTKIPCounterMeasuresInvoked"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAStatsCCMPFormatErrors"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAStatsCCMPReplays"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAStatsCCMPDecryptErrors"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAStatsTKIPReplays"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAStats4WayHandshakeFailures"))
)
if mibBuilder.loadTexts:
    coDot11RSNBase.setStatus("current")

coDot11PhyOFDMComplianceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 21)
)
coDot11PhyOFDMComplianceGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11CurrentFrequency"),
        ("COLUBRIS-802DOT11-MIB", "coDot11TIThreshold"),
        ("COLUBRIS-802DOT11-MIB", "coDot11FrequencyBandsSupported"))
)
if mibBuilder.loadTexts:
    coDot11PhyOFDMComplianceGroup.setStatus("current")

coDot11StationHTGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 22)
)
coDot11StationHTGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11StaTransmitMCS"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaReceiveMCS"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaChannelWidth"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaShortGI"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS0"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS1"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS2"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS3"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS4"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS5"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS6"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS7"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS8"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS9"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS10"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS11"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS12"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS13"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS14"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsTxMCS15"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS0"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS1"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS2"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS3"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS4"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS5"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS6"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS7"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS8"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS9"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS10"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS11"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS12"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS13"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS14"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StaPktsRxMCS15"))
)
if mibBuilder.loadTexts:
    coDot11StationHTGroup.setStatus("current")

coDot11PhyHTComplianceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 23)
)
coDot11PhyHTComplianceGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11FortyMHzOperationImplemented"),
        ("COLUBRIS-802DOT11-MIB", "coDot11FortyMHzOperationEnabled"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CurrentPrimaryChannel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CurrentSecondaryChannel"),
        ("COLUBRIS-802DOT11-MIB", "coDot11GreenfieldOptionImplemented"),
        ("COLUBRIS-802DOT11-MIB", "coDot11GreenfieldOptionEnabled"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ShortGIOptionInTwentyImplemented"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ShortGIOptionInTwentyEnabled"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ShortGIOptionInFortyImplemented"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ShortGIOptionInFortyEnabled"),
        ("COLUBRIS-802DOT11-MIB", "coDot11HighestSupportedDataRate"))
)
if mibBuilder.loadTexts:
    coDot11PhyHTComplianceGroup.setStatus("current")

coDot11APBaseGroupExt = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 24)
)
coDot11APBaseGroupExt.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11RelayBetweenStation"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PrivacyOptionImplemented"),
        ("COLUBRIS-802DOT11-MIB", "coDot11RSNAOptionImplemented"),
        ("COLUBRIS-802DOT11-MIB", "coDot11BeaconPeriod"),
...
if mibBuilder.loadTexts:
    coDot11APBaseGroupExt.setStatus("current")


# Notification objects

coDot11SNRLevelNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 5, 0, 1)
)
...
coDot11NotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 1, 19)
)
coDot11NotificationGroup.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11SNRLevelNotification"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AssociationNotification"),
        ("COLUBRIS-802DOT11-MIB", "coDot11UnauthorizedAPNotification"))
)
if mibBuilder.loadTexts:
...
coDot11Compliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 2, 1)
)
coDot11Compliance.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11APBaseGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11MACBaseGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CountersGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11SmtAuthenticationAlgorithmsGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyConfigComplianceGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyConfigGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11APPrivacyGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11MACStatisticsGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyAntennaComplianceGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyRegDomainsSupportGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyAntennasListGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyRateGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AssociationGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11AssociationConfigGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11ScanConfigGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11WDSComplianceGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11NotificationGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11StationHTGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyDSSSComplianceGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyOFDMComplianceGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyHTComplianceGroup"))
)
if mibBuilder.loadTexts:
...
coDot11RSNCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 2, 2)
)
coDot11RSNCompliance.setObjects(
    ("COLUBRIS-802DOT11-MIB", "coDot11RSNBase")
)
if mibBuilder.loadTexts:
...
coDot11ComplianceExt = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 8744, 5, 4, 6, 2, 3)
)
coDot11ComplianceExt.setObjects(
      *(("COLUBRIS-802DOT11-MIB", "coDot11APBaseGroupExt"),
        ("COLUBRIS-802DOT11-MIB", "coDot11MACBaseGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11CountersGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11SmtAuthenticationAlgorithmsGroup"),
        ("COLUBRIS-802DOT11-MIB", "coDot11PhyConfigComplianceGroup"),
...
if mibBuilder.loadTexts:
    coDot11ComplianceExt.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"WEPKeytype": WEPKeytype,
       "colubris802dot11": colubris802dot11,
       "coDot11ap": coDot11ap,
       ...
       "coDot11StationHTTable": coDot11StationHTTable,
       "coDot11StationHTEntry": coDot11StationHTEntry,
       "coDot11StaTransmitMCS": coDot11StaTransmitMCS,
       "coDot11StaReceiveMCS": coDot11StaReceiveMCS,
       "coDot11StaChannelWidth": coDot11StaChannelWidth,
       "coDot11StaShortGI": coDot11StaShortGI,
       "coDot11StaPktsTxMCS0": coDot11StaPktsTxMCS0,
       "coDot11StaPktsTxMCS1": coDot11StaPktsTxMCS1,
       "coDot11StaPktsTxMCS2": coDot11StaPktsTxMCS2,
       "coDot11StaPktsTxMCS3": coDot11StaPktsTxMCS3,
       "coDot11StaPktsTxMCS4": coDot11StaPktsTxMCS4,
       "coDot11StaPktsTxMCS5": coDot11StaPktsTxMCS5,
       "coDot11StaPktsTxMCS6": coDot11StaPktsTxMCS6,
       "coDot11StaPktsTxMCS7": coDot11StaPktsTxMCS7,
       "coDot11StaPktsTxMCS8": coDot11StaPktsTxMCS8,
       "coDot11StaPktsTxMCS9": coDot11StaPktsTxMCS9,
       "coDot11StaPktsTxMCS10": coDot11StaPktsTxMCS10,
       "coDot11StaPktsTxMCS11": coDot11StaPktsTxMCS11,
       "coDot11StaPktsTxMCS12": coDot11StaPktsTxMCS12,
       "coDot11StaPktsTxMCS13": coDot11StaPktsTxMCS13,
       "coDot11StaPktsTxMCS14": coDot11StaPktsTxMCS14,
       "coDot11StaPktsTxMCS15": coDot11StaPktsTxMCS15,
       "coDot11StaPktsRxMCS0": coDot11StaPktsRxMCS0,
       "coDot11StaPktsRxMCS1": coDot11StaPktsRxMCS1,
       "coDot11StaPktsRxMCS2": coDot11StaPktsRxMCS2,
       "coDot11StaPktsRxMCS3": coDot11StaPktsRxMCS3,
       "coDot11StaPktsRxMCS4": coDot11StaPktsRxMCS4,
       "coDot11StaPktsRxMCS5": coDot11StaPktsRxMCS5,
       "coDot11StaPktsRxMCS6": coDot11StaPktsRxMCS6,
       "coDot11StaPktsRxMCS7": coDot11StaPktsRxMCS7,
       "coDot11StaPktsRxMCS8": coDot11StaPktsRxMCS8,
       "coDot11StaPktsRxMCS9": coDot11StaPktsRxMCS9,
       "coDot11StaPktsRxMCS10": coDot11StaPktsRxMCS10,
       "coDot11StaPktsRxMCS11": coDot11StaPktsRxMCS11,
       "coDot11StaPktsRxMCS12": coDot11StaPktsRxMCS12,
       "coDot11StaPktsRxMCS13": coDot11StaPktsRxMCS13,
       "coDot11StaPktsRxMCS14": coDot11StaPktsRxMCS14,
       "coDot11StaPktsRxMCS15": coDot11StaPktsRxMCS15,
       ...
       "coDot11PhyHTTable": coDot11PhyHTTable,
       "coDot11PhyHTEntry": coDot11PhyHTEntry,
       "coDot11FortyMHzOperationImplemented": coDot11FortyMHzOperationImplemented,
       "coDot11FortyMHzOperationEnabled": coDot11FortyMHzOperationEnabled,
       "coDot11CurrentPrimaryChannel": coDot11CurrentPrimaryChannel,
       "coDot11CurrentSecondaryChannel": coDot11CurrentSecondaryChannel,
       "coDot11GreenfieldOptionImplemented": coDot11GreenfieldOptionImplemented,
       "coDot11GreenfieldOptionEnabled": coDot11GreenfieldOptionEnabled,
       ...
       "coDot11ShortGIOptionInFortyImplemented": coDot11ShortGIOptionInFortyImplemented,
