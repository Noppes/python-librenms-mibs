...
# Notes
# -----
# ASN.1 source file://mibs\audiocodes\AC-PM-Analog-MIB
...
if mibBuilder.loadTexts:
    acPMAnalogConfigurationPeriodLength.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMAnalogConfigurationResetTotalCounters.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMAnalogUtilsAttributesOffHookChannelsHighThreshold.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMAnalogUtilsAttributesOffHookChannelsLowThreshold.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMAnalogDataAcPMAnalogTimeFromStartOfInterval.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsTable.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsEntry.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsInterval.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsVal.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsAverage.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsMax.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsMin.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsVolume.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsTimeBelowLowThreshold.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsTimeBetweenThresholds.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsTimeAboveHighThreshold.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acPMOffHookChannelsFullDayAverage.setStatus("obsolete")
