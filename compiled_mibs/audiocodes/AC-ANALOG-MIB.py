...
# Notes
# -----
# ASN.1 source file://mibs\audiocodes\AC-ANALOG-MIB
...
if mibBuilder.loadTexts:
    acAnalogMiscGroundKeyDetection.setStatus("deprecated")
_AcAnalogGroundStartTable_Object = MibTable
acAnalogGroundStartTable = _AcAnalogGroundStartTable_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 1, 1, 21)
)
if mibBuilder.loadTexts:
    acAnalogGroundStartTable.setStatus("current")
_AcAnalogGroundStartEntry_Object = MibTableRow
acAnalogGroundStartEntry = _AcAnalogGroundStartEntry_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 1, 1, 21, 1)
)
acAnalogGroundStartEntry.setIndexNames(
    (0, "AC-ANALOG-MIB", "acAnalogGroundStartPort"),
)
if mibBuilder.loadTexts:
    acAnalogGroundStartEntry.setStatus("current")


class _AcAnalogGroundStartPort_Type(Unsigned32):
    """Custom type acAnalogGroundStartPort based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AcAnalogGroundStartPort_Type.__name__ = "Unsigned32"
_AcAnalogGroundStartPort_Object = MibTableColumn
acAnalogGroundStartPort = _AcAnalogGroundStartPort_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 1, 1, 21, 1, 1),
    _AcAnalogGroundStartPort_Type()
)
acAnalogGroundStartPort.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    acAnalogGroundStartPort.setStatus("current")


class _AcAnalogGroundStartEnable_Type(Integer32):
    """Custom type acAnalogGroundStartEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AcAnalogGroundStartEnable_Type.__name__ = "Integer32"
_AcAnalogGroundStartEnable_Object = MibTableColumn
acAnalogGroundStartEnable = _AcAnalogGroundStartEnable_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 1, 1, 21, 1, 2),
    _AcAnalogGroundStartEnable_Type()
)
acAnalogGroundStartEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogGroundStartEnable.setStatus("current")
...
class _AcAnalogFxoDefaultLinePolarityState_Type(Integer32):
    """Custom type acAnalogFxoDefaultLinePolarityState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AcAnalogFxoDefaultLinePolarityState_Type.__name__ = "Integer32"
_AcAnalogFxoDefaultLinePolarityState_Object = MibScalar
acAnalogFxoDefaultLinePolarityState = _AcAnalogFxoDefaultLinePolarityState_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 2, 1, 4),
    _AcAnalogFxoDefaultLinePolarityState_Type()
)
acAnalogFxoDefaultLinePolarityState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogFxoDefaultLinePolarityState.setStatus("current")


class _AcAnalogFxoTxGainControl_Type(Integer32):
    """Custom type acAnalogFxoTxGainControl based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-15, 12),
    )


_AcAnalogFxoTxGainControl_Type.__name__ = "Integer32"
_AcAnalogFxoTxGainControl_Object = MibScalar
acAnalogFxoTxGainControl = _AcAnalogFxoTxGainControl_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 2, 1, 5),
    _AcAnalogFxoTxGainControl_Type()
)
acAnalogFxoTxGainControl.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogFxoTxGainControl.setStatus("current")


class _AcAnalogFxoRxGainControl_Type(Integer32):
    """Custom type acAnalogFxoRxGainControl based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(-15, 12),
    )
...
_AcAnalogFxoRxGainControl_Type.__name__ = "Integer32"
_AcAnalogFxoRxGainControl_Object = MibScalar
acAnalogFxoRxGainControl = _AcAnalogFxoRxGainControl_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 2, 1, 6),
    _AcAnalogFxoRxGainControl_Type()
)
acAnalogFxoRxGainControl.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogFxoRxGainControl.setStatus("current")
...
acAnalogEMConfig = _AcAnalogEMConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 4)
)
_AcAnalogEM_ObjectIdentity = ObjectIdentity
acAnalogEM = _AcAnalogEM_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 4, 1)
)


class _AcAnalogEMVoiceType_Type(Integer32):
    """Custom type acAnalogEMVoiceType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AcAnalogEMVoiceType_Type.__name__ = "Integer32"
_AcAnalogEMVoiceType_Object = MibScalar
acAnalogEMVoiceType = _AcAnalogEMVoiceType_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 4, 1, 1),
    _AcAnalogEMVoiceType_Type()
)
acAnalogEMVoiceType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogEMVoiceType.setStatus("current")


class _AcAnalogEMInterfaceType_Type(Integer32):
    """Custom type acAnalogEMInterfaceType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AcAnalogEMInterfaceType_Type.__name__ = "Integer32"
_AcAnalogEMInterfaceType_Object = MibScalar
acAnalogEMInterfaceType = _AcAnalogEMInterfaceType_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 4, 1, 2),
    _AcAnalogEMInterfaceType_Type()
)
acAnalogEMInterfaceType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogEMInterfaceType.setStatus("current")


class _AcAnalogEMSignalingType_Type(Unsigned32):
    """Custom type acAnalogEMSignalingType based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AcAnalogEMSignalingType_Type.__name__ = "Unsigned32"
_AcAnalogEMSignalingType_Object = MibScalar
acAnalogEMSignalingType = _AcAnalogEMSignalingType_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 4, 1, 3),
    _AcAnalogEMSignalingType_Type()
)
acAnalogEMSignalingType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogEMSignalingType.setStatus("current")


class _AcAnalogEMPortRXGain_Type(Integer32):
    """Custom type acAnalogEMPortRXGain based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AcAnalogEMPortRXGain_Type.__name__ = "Integer32"
_AcAnalogEMPortRXGain_Object = MibScalar
acAnalogEMPortRXGain = _AcAnalogEMPortRXGain_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 4, 1, 4),
    _AcAnalogEMPortRXGain_Type()
)
acAnalogEMPortRXGain.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogEMPortRXGain.setStatus("current")


class _AcAnalogEMPortTXGain_Type(Integer32):
    """Custom type acAnalogEMPortTXGain based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AcAnalogEMPortTXGain_Type.__name__ = "Integer32"
_AcAnalogEMPortTXGain_Object = MibScalar
acAnalogEMPortTXGain = _AcAnalogEMPortTXGain_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 4, 1, 5),
    _AcAnalogEMPortTXGain_Type()
)
acAnalogEMPortTXGain.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogEMPortTXGain.setStatus("current")


class _AcAnalogEMCountryCoefficients_Type(Integer32):
    """Custom type acAnalogEMCountryCoefficients based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AcAnalogEMCountryCoefficients_Type.__name__ = "Integer32"
_AcAnalogEMCountryCoefficients_Object = MibScalar
acAnalogEMCountryCoefficients = _AcAnalogEMCountryCoefficients_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 4, 1, 6),
    _AcAnalogEMCountryCoefficients_Type()
)
acAnalogEMCountryCoefficients.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogEMCountryCoefficients.setStatus("current")


class _AcAnalogEMHookDebounceTiming_Type(Unsigned32):
    """Custom type acAnalogEMHookDebounceTiming based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AcAnalogEMHookDebounceTiming_Type.__name__ = "Unsigned32"
_AcAnalogEMHookDebounceTiming_Object = MibScalar
acAnalogEMHookDebounceTiming = _AcAnalogEMHookDebounceTiming_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 4, 1, 7),
    _AcAnalogEMHookDebounceTiming_Type()
)
acAnalogEMHookDebounceTiming.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogEMHookDebounceTiming.setStatus("current")


class _AcAnalogEMOffHookGlareEnable_Type(Integer32):
    """Custom type acAnalogEMOffHookGlareEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_AcAnalogEMOffHookGlareEnable_Type.__name__ = "Integer32"
_AcAnalogEMOffHookGlareEnable_Object = MibScalar
acAnalogEMOffHookGlareEnable = _AcAnalogEMOffHookGlareEnable_Object(
    (1, 3, 6, 1, 4, 1, 5003, 9, 10, 8, 1, 4, 1, 8),
    _AcAnalogEMOffHookGlareEnable_Type()
)
acAnalogEMOffHookGlareEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    acAnalogEMOffHookGlareEnable.setStatus("current")
...
if mibBuilder.loadTexts:
    acAnalogFxsLineTestLineCurrentReading.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acAnalogFxsLineTestLineVoltageReading.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acAnalogFxsLineTestAnalogVoltageReading.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acAnalogFxsLineTestRingVoltageReading.setStatus("obsolete")
...
if mibBuilder.loadTexts:
    acAnalogFxsLineTestLongLineCurrentReading.setStatus("obsolete")
...
mibBuilder.exportSymbols(
    ...
    **{"acAnalog": acAnalog,
       ...
       "acAnalogGroundStartTable": acAnalogGroundStartTable,
       "acAnalogGroundStartEntry": acAnalogGroundStartEntry,
       "acAnalogGroundStartPort": acAnalogGroundStartPort,
       "acAnalogGroundStartEnable": acAnalogGroundStartEnable,
       ...
       "acAnalogFxoDefaultLinePolarityState": acAnalogFxoDefaultLinePolarityState,
       "acAnalogFxoTxGainControl": acAnalogFxoTxGainControl,
       "acAnalogFxoRxGainControl": acAnalogFxoRxGainControl,
       ...
       "acAnalogEMConfig": acAnalogEMConfig,
       "acAnalogEM": acAnalogEM,
       "acAnalogEMVoiceType": acAnalogEMVoiceType,
       "acAnalogEMInterfaceType": acAnalogEMInterfaceType,
       "acAnalogEMSignalingType": acAnalogEMSignalingType,
       "acAnalogEMPortRXGain": acAnalogEMPortRXGain,
       "acAnalogEMPortTXGain": acAnalogEMPortTXGain,
       "acAnalogEMCountryCoefficients": acAnalogEMCountryCoefficients,
       "acAnalogEMHookDebounceTiming": acAnalogEMHookDebounceTiming,
       "acAnalogEMOffHookGlareEnable": acAnalogEMOffHookGlareEnable,
