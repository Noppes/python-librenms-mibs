# SNMP MIB module (LLDP-EXT-MED-CAMBIUM-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\cambium\cnmatrix\LLDP-EXT-MED-CAMBIUM-MIB
...
lldpXMedLocMediaPolicyEntry.setIndexNames(
    ...
    (0, "LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocMediaPolicyAppType"),
)
if mibBuilder.loadTexts:
...
lldpXMedLocLocationEntry.setIndexNames(
    (0, "LLDP-MIB", "lldpLocPortNum"),
    (0, "LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocLocationSubtype"),
)
if mibBuilder.loadTexts:
...
lldpXMedRemMediaPolicyEntry.setIndexNames(
    ...
    (0, "LLDP-MIB", "lldpRemLocalPortNum"),
    (0, "LLDP-MIB", "lldpRemIndex"),
    (0, "LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemMediaPolicyAppType"),
)
if mibBuilder.loadTexts:
...
lldpXMedRemLocationEntry.setIndexNames(
    ...
    (0, "LLDP-MIB", "lldpRemLocalPortNum"),
    (0, "LLDP-MIB", "lldpRemIndex"),
    (0, "LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemLocationSubtype"),
)
if mibBuilder.loadTexts:
...
lldpXMedConfigGroup.setObjects(
      *(("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedPortCapSupported"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedPortConfigTLVsTxEnable"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedPortConfigNotifEnable"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedFastStartRepeatCount"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocXPoEDeviceType"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocDeviceClass"))
)
if mibBuilder.loadTexts:
...
lldpXMedOptMediaPolicyGroup.setObjects(
      *(("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocMediaPolicyVlanID"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocMediaPolicyPriority"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocMediaPolicyDscp"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocMediaPolicyUnknown"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocMediaPolicyTagged"))
)
if mibBuilder.loadTexts:
...
lldpXMedOptInventoryGroup.setObjects(
      *(("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocHardwareRev"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocFirmwareRev"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocSoftwareRev"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocSerialNum"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocMfgName"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocModelName"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocAssetID"))
)
if mibBuilder.loadTexts:
...
lldpXMedOptLocationGroup.setObjects(
    ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocLocationInfo")
)
if mibBuilder.loadTexts:
...
lldpXMedOptPoEPSEGroup.setObjects(
      *(("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocXPoEPSEPortPowerAv"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocXPoEPSEPortPDPriority"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocXPoEPSEPowerSource"))
)
if mibBuilder.loadTexts:
...
lldpXMedOptPoEPDGroup.setObjects(
      *(("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocXPoEPDPowerReq"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocXPoEPDPowerSource"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedLocXPoEPDPowerPriority"))
)
if mibBuilder.loadTexts:
...
lldpXMedRemSysGroup.setObjects(
      *(("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemCapSupported"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemCapCurrent"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemDeviceClass"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemMediaPolicyVlanID"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemMediaPolicyPriority"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemMediaPolicyDscp"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemMediaPolicyUnknown"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemMediaPolicyTagged"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemHardwareRev"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemFirmwareRev"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemSoftwareRev"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemSerialNum"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemMfgName"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemModelName"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemAssetID"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemLocationInfo"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemXPoEDeviceType"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemXPoEPSEPowerAv"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemXPoEPSEPowerSource"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemXPoEPSEPowerPriority"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemXPoEPDPowerReq"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemXPoEPDPowerSource"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemXPoEPDPowerPriority"))
)
if mibBuilder.loadTexts:
...
lldpXMedNotificationsGroup.setObjects(
    ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedTopologyChangeDetected")
)
if mibBuilder.loadTexts:
...
lldpXMedCompliance.setObjects(
      *(("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedConfigGroup"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedRemSysGroup"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedNotificationsGroup"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedOptMediaPolicyGroup"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedOptInventoryGroup"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedOptLocationGroup"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedOptPoEPSEGroup"),
        ("LLDP-EXT-MED-CAMBIUM-MIB", "lldpXMedOptPoEPDGroup"))
)
if mibBuilder.loadTexts:
