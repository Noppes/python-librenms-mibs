# SNMP MIB module (DELL-NETWORKING-TC) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\dell\DELL-NETWORKING-TC
...
(dellNetModules,) = mibBuilder.importSymbols(
    "DELL-NETWORKING-SMI",
    "dellNetModules")
...
dellNetTextualConventions = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6027, 4, 2)
)
if mibBuilder.loadTexts:
    dellNetTextualConventions.setRevisions(
        ("2009-04-07 12:00",
         "2008-09-16 12:00",
         "2008-09-02 12:00",
         "2007-06-28 12:00")
...
mibBuilder.exportSymbols(
    ...
    **{"DellNetChassisType": DellNetChassisType,
       "DellNetInterfaceType": DellNetInterfaceType,
       "DellNetSystemPortType": DellNetSystemPortType,
       "DellNetSystemCardType": DellNetSystemCardType,
       "DellNetCardOperStatus": DellNetCardOperStatus,
       "DellNetIfType": DellNetIfType,
       "DellNetCSeriesCardType": DellNetCSeriesCardType,
       "DellNetProcessorModuleType": DellNetProcessorModuleType,
       "DellNetSlotState": DellNetSlotState,
       "DellNetSlotID": DellNetSlotID,
       "DellNetSwDate": DellNetSwDate,
       "DellNetMfgDate": DellNetMfgDate,
       "PortList": PortList,
       "DellNetVlanID": DellNetVlanID,
       "DellNetChassisMode": DellNetChassisMode,
       "DellNetQueueID": DellNetQueueID,
       "DellNetPortPipeID": DellNetPortPipeID,
       "DellNetCycloneVersion": DellNetCycloneVersion,
       "DellNetCamPartitionType": DellNetCamPartitionType,
       "DellNetHundredthdB": DellNetHundredthdB,
       "DellNetDeviceType": DellNetDeviceType,
       "DellNetPEOperStatus": DellNetPEOperStatus,
       "dellNetTextualConventions": dellNetTextualConventions}
)
