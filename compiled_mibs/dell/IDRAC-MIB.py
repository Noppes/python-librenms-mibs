...
# Notes
# -----
# ASN.1 source file://mibs\dell\IDRAC-MIB
...
if mibBuilder.loadTexts:
    alertRacFQDN.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    powerSupplyMaximumInputVoltage.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    powerSupplyCurrentInputVoltage.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    memoryDeviceCurrentOperatingSpeed.setStatus("mandatory")
