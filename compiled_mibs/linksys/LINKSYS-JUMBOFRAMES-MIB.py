# SNMP MIB module (LINKSYS-JUMBOFRAMES-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\linksys\LINKSYS-JUMBOFRAMES-MIB
...
rlJumboFramesCurrentStatus = _RlJumboFramesCurrentStatus_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 91, 1),
...
rlJumboFramesStatusAfterReset = _RlJumboFramesStatusAfterReset_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 91, 2),
