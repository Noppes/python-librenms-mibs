# SNMP MIB module (LINKSYS-WBA-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\linksys\LINKSYS-WBA-MIB
...
rlWBAAuxiliaryTable = _RlWBAAuxiliaryTable_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 1)
)
if mibBuilder.loadTexts:
...
rlWBAAuxiliaryEntry = _RlWBAAuxiliaryEntry_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 1, 1)
)
rlWBAAuxiliaryEntry.setIndexNames(
    (0, "LINKSYS-WBA-MIB", "rlWBAIp"),
)
if mibBuilder.loadTexts:
...
rlWBAIp = _RlWBAIp_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 1, 1, 1),
    _RlWBAIp_Type()
)
...
rlWBAStatus = _RlWBAStatus_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 1, 1, 2),
    _RlWBAStatus_Type()
)
...
rlAuxFailReason = _RlAuxFailReason_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 1, 1, 3),
...
rlIsRetryFlag = _RlIsRetryFlag_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 1, 1, 4),
    _RlIsRetryFlag_Type()
)
...
rlWBAUsername = _RlWBAUsername_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 1, 1, 5),
    _RlWBAUsername_Type()
)
...
rlWBAPassword = _RlWBAPassword_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 1, 1, 6),
    _RlWBAPassword_Type()
)
...
rlWBAImageNumber = _RlWBAImageNumber_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 2, 1, 1),
...
rlWBAImageIndex = _RlWBAImageIndex_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 2, 1, 2),
...
rlWBAImageText = _RlWBAImageText_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 2, 1, 3),
...
rlWBADataNumber = _RlWBADataNumber_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 3, 1, 1),
...
rlWBADataIndex = _RlWBADataIndex_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 3, 1, 2),
...
rlWBADataText = _RlWBADataText_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 3, 1, 3),
    _RlWBADataText_Type()
)
...
rlWBAImageInfoTable = _RlWBAImageInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 4)
)
if mibBuilder.loadTexts:
...
rlWBAImageInfoEntry = _RlWBAImageInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 4, 1)
)
rlWBAImageInfoEntry.setIndexNames(
    (0, "LINKSYS-WBA-MIB", "rlWBAImageInfoNumber"),
)
if mibBuilder.loadTexts:
...
rlWBAImageInfoNumber = _RlWBAImageInfoNumber_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 4, 1, 1),
...
rlWBAImageInfoName = _RlWBAImageInfoName_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 4, 1, 2),
...
rlWBAImageInfoSize = _RlWBAImageInfoSize_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 4, 1, 3),
...
rlWBAImageClear = _RlWBAImageClear_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 5),
...
rlWBADataClear = _RlWBADataClear_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 6),
...
rlWBAImageDownloadFinishStatus = _RlWBAImageDownloadFinishStatus_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 228, 7),
