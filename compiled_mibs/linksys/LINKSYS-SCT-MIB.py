# SNMP MIB module (LINKSYS-SCT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\linksys\LINKSYS-SCT-MIB
...
rlSctCpuRateEnabled = _RlSctCpuRateEnabled_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 203, 1),
...
rlSctCpuRate = _RlSctCpuRate_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 203, 2),
    _RlSctCpuRate_Type()
)
