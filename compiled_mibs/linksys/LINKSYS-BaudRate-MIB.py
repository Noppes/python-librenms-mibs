# SNMP MIB module (LINKSYS-BaudRate-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\linksys\LINKSYS-BaudRate-MIB
...
rlRs232MibVersion = _RlRs232MibVersion_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 104, 1),
...
rlRs232AutoBaudRateStatus = _RlRs232AutoBaudRateStatus_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 104, 2),
...
rlRs232AutoBaudRateStatusAfterReset = _RlRs232AutoBaudRateStatusAfterReset_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 104, 3),
...
rlRs232BaudRate = _RlRs232BaudRate_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 104, 4),
