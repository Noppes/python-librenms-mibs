# SNMP MIB module (LINKSYS-PHY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\linksys\LINKSYS-PHY-MIB
...
rlPhyTestSetType = _RlPhyTestSetType_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 90, 1, 1, 1, 1),
...
rlPhyTestGetType = _RlPhyTestGetType_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 90, 1, 2, 1, 1),
...
rlPhyTestGetStatus = _RlPhyTestGetStatus_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 90, 1, 2, 1, 2),
...
rlPhyTestGetResult = _RlPhyTestGetResult_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 90, 1, 2, 1, 3),
...
rlPhyTestGetUnits = _RlPhyTestGetUnits_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 90, 1, 2, 1, 4),
...
rlPhyTestGetAlarm = _RlPhyTestGetAlarm_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 90, 1, 2, 1, 5),
...
rlPhyTestGetTimeStamp = _RlPhyTestGetTimeStamp_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 90, 1, 2, 1, 6),
