# SNMP MIB module (LINKSYS-BANNER-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\linksys\LINKSYS-BANNER-MIB
...
rlBannerMessageTable = _RlBannerMessageTable_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 133, 1)
)
if mibBuilder.loadTexts:
...
rlBannerMessageEntry = _RlBannerMessageEntry_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 133, 1, 1)
)
rlBannerMessageEntry.setIndexNames(
    (0, "LINKSYS-BANNER-MIB", "rlBannerMessageType"),
    (0, "LINKSYS-BANNER-MIB", "rlBannerMessageIndex"),
)
if mibBuilder.loadTexts:
...
rlBannerMessageType = _RlBannerMessageType_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 133, 1, 1, 1),
...
rlBannerMessageIndex = _RlBannerMessageIndex_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 133, 1, 1, 2),
...
rlBannerMessageText = _RlBannerMessageText_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 133, 1, 1, 3),
...
rlBannerManageTable = _RlBannerManageTable_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 133, 2)
)
if mibBuilder.loadTexts:
...
rlBannerManageEntry = _RlBannerManageEntry_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 133, 2, 1)
)
...
rlBannerManageSSH = _RlBannerManageSSH_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 133, 2, 1, 1),
...
rlBannerManageTelnet = _RlBannerManageTelnet_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 133, 2, 1, 2),
...
rlBannerManageConsole = _RlBannerManageConsole_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 133, 2, 1, 3),
...
rlBannerMessageClear = _RlBannerMessageClear_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 133, 3),
