# SNMP MIB module (LINKSYS-SpecialBpdu-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\linksys\LINKSYS-SpecialBpdu-MIB
...
rlSpecialBpduTable = _RlSpecialBpduTable_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 144, 1)
)
if mibBuilder.loadTexts:
    rlSpecialBpduTable.setStatus("current")
_RlSpecialBpduEntry_Object = MibTableRow
rlSpecialBpduEntry = _RlSpecialBpduEntry_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 144, 1, 1)
)
rlSpecialBpduEntry.setIndexNames(
    (0, "LINKSYS-SpecialBpdu-MIB", "rlSpecialBpduMacAddr"),
    (0, "LINKSYS-SpecialBpdu-MIB", "rlSpecialBpduEncap"),
    (0, "LINKSYS-SpecialBpdu-MIB", "rlSpecialBpduProtId"),
)
if mibBuilder.loadTexts:
...
rlSpecialBpduMacAddr = _RlSpecialBpduMacAddr_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 144, 1, 1, 1),
...
rlSpecialBpduEncap = _RlSpecialBpduEncap_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 144, 1, 1, 2),
...
rlSpecialBpduProtId = _RlSpecialBpduProtId_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 144, 1, 1, 3),
...
rlSpecialBpduAction = _RlSpecialBpduAction_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 144, 1, 1, 4),
...
rlSpecialBpduRowStatus = _RlSpecialBpduRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 144, 1, 1, 5),
...
rlSpecialBpduHwTable = _RlSpecialBpduHwTable_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 144, 2)
)
if mibBuilder.loadTexts:
...
rlSpecialBpduHwEntry = _RlSpecialBpduHwEntry_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 144, 2, 1)
)
...
rlSpecialBpduHwAction = _RlSpecialBpduHwAction_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 144, 2, 1, 2),
