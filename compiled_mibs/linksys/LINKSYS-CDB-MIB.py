# SNMP MIB module (LINKSYS-CDB-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\linksys\LINKSYS-CDB-MIB
...
rlStartupCDBChanged = _RlStartupCDBChanged_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 94, 1),
...
rlManualReboot = _RlManualReboot_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 94, 2),
