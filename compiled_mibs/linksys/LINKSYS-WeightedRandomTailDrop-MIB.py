# SNMP MIB module (LINKSYS-WeightedRandomTailDrop-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\linksys\LINKSYS-WeightedRandomTailDrop-MIB
...
rlWeightedRandomTailDropCurrentStatus = _RlWeightedRandomTailDropCurrentStatus_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 146, 1),
...
rlWeightedRandomTailDropStatusAfterReset = _RlWeightedRandomTailDropStatusAfterReset_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 146, 2),
...
mibBuilder.exportSymbols(
    "LINKSYS-WeightedRandomTailDrop-MIB",
