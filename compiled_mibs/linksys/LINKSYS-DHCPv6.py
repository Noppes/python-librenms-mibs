# SNMP MIB module (LINKSYS-DHCPv6) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\linksys\LINKSYS-DHCPv6
...
rlDhcpv6Common = _RlDhcpv6Common_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 214, 1)
)
...
rlDhcpv6DuidEn = _RlDhcpv6DuidEn_Object(
    (1, 3, 6, 1, 4, 1, 3955, 1000, 201, 214, 1, 1),
