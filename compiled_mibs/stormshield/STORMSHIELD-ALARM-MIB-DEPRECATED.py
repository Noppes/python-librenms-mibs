# SNMP MIB module (STORMSHIELD-ALARM-MIB-DEPRECATED) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\stormshield\STORMSHIELD-ALARM-MIB-DEPRECATED
...
snsAEntry.setIndexNames(
    (0, "STORMSHIELD-ALARM-MIB-DEPRECATED", "snsAIndex"),
)
if mibBuilder.loadTexts:
...
snsAicmpEntry.setIndexNames(
    (0, "STORMSHIELD-ALARM-MIB-DEPRECATED", "snsAicmpIndex"),
)
if mibBuilder.loadTexts:
...
snsNotification.setObjects(
      *(("STORMSHIELD-ALARM-MIB-DEPRECATED", "snsATime"),
        ("STORMSHIELD-ALARM-MIB-DEPRECATED", "snsASif"),
        ("STORMSHIELD-ALARM-MIB-DEPRECATED", "snsASaddr"),
        ("STORMSHIELD-ALARM-MIB-DEPRECATED", "snsADaddr"),
        ("STORMSHIELD-ALARM-MIB-DEPRECATED", "snsAMessage"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    "STORMSHIELD-ALARM-MIB-DEPRECATED",
    **{"snsAlarm": snsAlarm,
       "snsATable": snsATable,
       "snsAEntry": snsAEntry,
       "snsAIndex": snsAIndex,
