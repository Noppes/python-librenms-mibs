# SNMP MIB module (GWTT-SMI) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\gwd\GWTT-SMI
...
_Gwtt_ObjectIdentity = ObjectIdentity
gwtt = _Gwtt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 10072)
)
