...
# Notes
# -----
# ASN.1 source file://mibs\endace\IPFIX-MIB
...
_IpfixTransportSessionSourceAddressType_Type = InetAddressType
...
_IpfixTransportSessionDestinationAddressType_Type = InetAddressType
...
_IpfixMeteringProcessCacheInactiveTimeout_Type = Unsigned32
_IpfixMeteringProcessCacheInactiveTimeout_Object = MibTableColumn
ipfixMeteringProcessCacheInactiveTimeout = _IpfixMeteringProcessCacheInactiveTimeout_Object(
    (1, 3, 6, 1, 2, 1, 193, 1, 1, 5, 1, 4),
    _IpfixMeteringProcessCacheInactiveTimeout_Type()
)
ipfixMeteringProcessCacheInactiveTimeout.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ipfixMeteringProcessCacheInactiveTimeout.setStatus("current")
if mibBuilder.loadTexts:
    ipfixMeteringProcessCacheInactiveTimeout.setUnits("seconds")
...
ipfixExporterGroup.setObjects(
      *(("IPFIX-MIB", "ipfixExportMemberType"),
        ...
        ("IPFIX-MIB", "ipfixMeteringProcessCacheInactiveTimeout"),
...
ipfixCollectorCompliance.setObjects(
      *(("IPFIX-MIB", "ipfixCommonGroup"),
        ("IPFIX-MIB", "ipfixCommonStatsGroup"))
)
if mibBuilder.loadTexts:
...
ipfixExporterCompliance.setObjects(
      *(("IPFIX-MIB", "ipfixCommonGroup"),
        ("IPFIX-MIB", "ipfixExporterGroup"),
        ("IPFIX-MIB", "ipfixCommonStatsGroup"),
        ("IPFIX-MIB", "ipfixExporterStatsGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ipfixMIB": ipfixMIB,
       ...
       "ipfixMeteringProcessCacheInactiveTimeout": ipfixMeteringProcessCacheInactiveTimeout,
