...
# Notes
# -----
# ASN.1 source file://mibs\adic\ADIC-SANMGR-PROXY-MIB
...
(Boolean,
 RowStatus,
 componentId,
 network) = mibBuilder.importSymbols(
...
sanmgrProxy = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 3764, 1, 1, 400, 10)
)
if mibBuilder.loadTexts:
    sanmgrProxy.setRevisions(
        ("2015-09-24 00:00",)
    )
...
_PaFiller_Type = Integer32
_PaFiller_Object = MibTableColumn
paFiller = _PaFiller_Object(
    (1, 3, 6, 1, 4, 1, 3764, 1, 1, 400, 10, 10, 2, 1, 1, 10),
    _PaFiller_Type()
)
paFiller.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    paFiller.setStatus("mandatory")
