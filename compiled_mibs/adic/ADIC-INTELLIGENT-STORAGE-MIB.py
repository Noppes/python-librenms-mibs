...
# Notes
# -----
# ASN.1 source file://mibs\adic\ADIC-INTELLIGENT-STORAGE-MIB
...
intelligent = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 3764, 1, 1)
)
if mibBuilder.loadTexts:
    intelligent.setRevisions(
        ("2015-09-24 00:00",)
    )
...
class AdicVaryStatus(Integer32):
    """Custom type AdicVaryStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
class AdicPowerSupplyStatus(Integer32):
    """Custom type AdicPowerSupplyStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
class AdicTowerStatus(Integer32):
    """Custom type AdicTowerStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Quantum_ObjectIdentity = ObjectIdentity
quantum = _Quantum_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3764)
)
...
if mibBuilder.loadTexts:
    powerSupplyWattage.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    powerSupplyREDId.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    powerSupplyRatedVoltage.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    powerSupplyLocation.setStatus("mandatory")
_PowerSupplyStatus_Type = AdicPowerSupplyStatus
_PowerSupplyStatus_Object = MibTableColumn
powerSupplyStatus = _PowerSupplyStatus_Object(
    (1, 3, 6, 1, 4, 1, 3764, 1, 1, 200, 200, 10, 1, 8),
    _PowerSupplyStatus_Type()
)
powerSupplyStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    powerSupplyStatus.setStatus("mandatory")
_PowerSupplyPowerConsumption_Type = Integer32
_PowerSupplyPowerConsumption_Object = MibTableColumn
powerSupplyPowerConsumption = _PowerSupplyPowerConsumption_Object(
    (1, 3, 6, 1, 4, 1, 3764, 1, 1, 200, 200, 10, 1, 9),
    _PowerSupplyPowerConsumption_Type()
)
powerSupplyPowerConsumption.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    powerSupplyPowerConsumption.setStatus("mandatory")
...
class _CoolingFanIndex_Type(Integer32):
    """Custom type coolingFanIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 1024),
    )
...
_CoolingFanIndex_Type.__name__ = "Integer32"
...
class _TrapSequenceNumber_Type(Integer32):
    """Custom type trapSequenceNumber based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TrapSequenceNumber_Type.__name__ = "Integer32"
...
_TrapSeverity_Type = AdicTrapSeverity
...
_TrapInstance_Type = Integer32
_TrapInstance_Object = MibTableColumn
trapInstance = _TrapInstance_Object(
    (1, 3, 6, 1, 4, 1, 3764, 1, 1, 500, 10, 1, 5),
    _TrapInstance_Type()
)
trapInstance.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    trapInstance.setStatus("mandatory")
_TrapInstanceValue_Type = Integer32
_TrapInstanceValue_Object = MibTableColumn
trapInstanceValue = _TrapInstanceValue_Object(
    (1, 3, 6, 1, 4, 1, 3764, 1, 1, 500, 10, 1, 6),
    _TrapInstanceValue_Type()
)
trapInstanceValue.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    trapInstanceValue.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"AdicMibVersion": AdicMibVersion,
       ...
       "powerSupplyPowerConsumption": powerSupplyPowerConsumption,
       ...
       "trapInstanceValue": trapInstanceValue}
)
