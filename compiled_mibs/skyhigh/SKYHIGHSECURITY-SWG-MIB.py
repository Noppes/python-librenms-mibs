# SNMP MIB module (SKYHIGHSECURITY-SWG-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\skyhigh\SKYHIGHSECURITY-SWG-MIB
...
(swgGATEWAY,) = mibBuilder.importSymbols(
    "SKYHIGHSECURITY-SMI",
    "swgGATEWAY")
...
_SwgInfo_ObjectIdentity = ObjectIdentity
swgInfo = _SwgInfo_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 1)
)
...
kBuildNumber = _KBuildNumber_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 1, 10),
    _KBuildNumber_Type()
)
kBuildNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    kBuildNumber.setStatus("current")
_SwgEngineVersions_ObjectIdentity = ObjectIdentity
swgEngineVersions = _SwgEngineVersions_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 1, 20)
)
...
pTSDBVersion = _PTSDBVersion_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 1, 20, 6),
    _PTSDBVersion_Type()
)
pTSDBVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pTSDBVersion.setStatus("current")
_SwgStatistics_ObjectIdentity = ObjectIdentity
swgStatistics = _SwgStatistics_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2)
)
_SwgContent_ObjectIdentity = ObjectIdentity
swgContent = _SwgContent_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2, 1)
)
_StBadReputation_Type = Counter64
_StBadReputation_Object = MibScalar
stBadReputation = _StBadReputation_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2, 1, 1),
...
stCategoryName = _StCategoryName_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2, 1, 10, 1, 1),
...
stMemConsumed = _StMemConsumed_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2, 5, 15),
    _StMemConsumed_Type()
)
stMemConsumed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    stMemConsumed.setStatus("current")
_SwgHttp2_ObjectIdentity = ObjectIdentity
swgHttp2 = _SwgHttp2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2, 6)
)
_StHttp2Requests_Type = Counter64
_StHttp2Requests_Object = MibScalar
stHttp2Requests = _StHttp2Requests_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2, 6, 1),
    _StHttp2Requests_Type()
)
stHttp2Requests.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    stHttp2Requests.setStatus("current")
_StHttp2Traffic_Type = Counter64
_StHttp2Traffic_Object = MibScalar
stHttp2Traffic = _StHttp2Traffic_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2, 6, 2),
    _StHttp2Traffic_Type()
)
stHttp2Traffic.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    stHttp2Traffic.setStatus("current")
_StHttp2BytesFromClient_Type = Counter64
_StHttp2BytesFromClient_Object = MibScalar
stHttp2BytesFromClient = _StHttp2BytesFromClient_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2, 6, 3),
    _StHttp2BytesFromClient_Type()
)
stHttp2BytesFromClient.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    stHttp2BytesFromClient.setStatus("current")
_StHttp2BytesFromServer_Type = Counter64
_StHttp2BytesFromServer_Object = MibScalar
stHttp2BytesFromServer = _StHttp2BytesFromServer_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2, 6, 4),
    _StHttp2BytesFromServer_Type()
)
stHttp2BytesFromServer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    stHttp2BytesFromServer.setStatus("current")
_StHttp2BytesToClient_Type = Counter64
_StHttp2BytesToClient_Object = MibScalar
stHttp2BytesToClient = _StHttp2BytesToClient_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2, 6, 5),
    _StHttp2BytesToClient_Type()
)
stHttp2BytesToClient.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    stHttp2BytesToClient.setStatus("current")
_StHttp2BytesToServer_Type = Counter64
_StHttp2BytesToServer_Object = MibScalar
stHttp2BytesToServer = _StHttp2BytesToServer_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 2, 6, 6),
    _StHttp2BytesToServer_Type()
)
stHttp2BytesToServer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    stHttp2BytesToServer.setStatus("current")
_SwgTraps_ObjectIdentity = ObjectIdentity
swgTraps = _SwgTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 4)
)
_SwgTrapVariables_ObjectIdentity = ObjectIdentity
swgTrapVariables = _SwgTrapVariables_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 4, 10)
)
_NotifyOrigin_Type = Integer32
_NotifyOrigin_Object = MibScalar
notifyOrigin = _NotifyOrigin_Object(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 4, 10, 1),
    _NotifyOrigin_Type()
)
...
trSystem = NotificationType(
    (1, 3, 6, 1, 4, 1, 59732, 2, 7, 4, 1)
)
trSystem.setObjects(
      *(("SKYHIGHSECURITY-SWG-MIB", "notifyOrigin"),
        ("SKYHIGHSECURITY-SWG-MIB", "notifyOriginName"),
        ("SKYHIGHSECURITY-SWG-MIB", "notifySeverity"),
        ("SKYHIGHSECURITY-SWG-MIB", "notifyReason"),
        ("SKYHIGHSECURITY-SWG-MIB", "notifyReasonString"),
        ("SKYHIGHSECURITY-SWG-MIB", "notifyAffectedHost"),
        ("SKYHIGHSECURITY-SWG-MIB", "notifyAdditional"))
)
if mibBuilder.loadTexts:
    trSystem.setStatus(
        "current"
...
mibBuilder.exportSymbols(
    ...
    **{"swg": swg,
       ...
       "swgEngineVersions": swgEngineVersions,
       ...
       "swgMiscellaneous": swgMiscellaneous,
       "stCPULoad": stCPULoad,
       ...
       "swgHttp2": swgHttp2,
       "stHttp2Requests": stHttp2Requests,
       "stHttp2Traffic": stHttp2Traffic,
       "stHttp2BytesFromClient": stHttp2BytesFromClient,
       "stHttp2BytesFromServer": stHttp2BytesFromServer,
       "stHttp2BytesToClient": stHttp2BytesToClient,
       "stHttp2BytesToServer": stHttp2BytesToServer,
       "swgTraps": swgTraps,
       "trSystem": trSystem,
       "trApplication": trApplication,
       "trUser": trUser,
       "swgTrapVariables": swgTrapVariables,
