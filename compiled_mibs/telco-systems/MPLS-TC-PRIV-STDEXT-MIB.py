# SNMP MIB module (MPLS-TC-PRIV-STDEXT-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\telco-systems\binos\MPLS-TC-PRIV-STDEXT-MIB
...
mplsTCPrivStdExtMIB = ModuleIdentity(
    (1, 3, 6, 1, 2, 1, 10, 166, 1)
)
if mibBuilder.loadTexts:
    mplsTCPrivStdExtMIB.setRevisions(
        ("2007-12-06 00:00",
         "2004-06-03 00:00")
    )
...
mibBuilder.exportSymbols(
    ...
    **{"MplsAtmVcIdentifier": MplsAtmVcIdentifier,
       ...
       "mplsTCPrivStdExtMIB": mplsTCPrivStdExtMIB}
)
