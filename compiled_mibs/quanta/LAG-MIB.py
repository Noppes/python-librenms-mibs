# SNMP MIB module (LAG-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\quanta\LAG-MIB
...
dot3adAggGroup.setObjects(
      *(("LAG-MIB", "dot3adAggActorSystemID"),
        ("LAG-MIB", "dot3adAggActorSystemPriority"),
        ("LAG-MIB", "dot3adAggAggregateOrIndividual"),
        ("LAG-MIB", "dot3adAggActorAdminKey"),
        ("LAG-MIB", "dot3adAggMACAddress"),
        ("LAG-MIB", "dot3adAggActorOperKey"),
        ("LAG-MIB", "dot3adAggPartnerSystemID"),
        ("LAG-MIB", "dot3adAggPartnerSystemPriority"),
        ("LAG-MIB", "dot3adAggPartnerOperKey"),
        ("LAG-MIB", "dot3adAggCollectorMaxDelay"))
)
if mibBuilder.loadTexts:
...
dot3adTablesLastChangedGroup.setObjects(
    ("LAG-MIB", "dot3adTablesLastChanged")
)
if mibBuilder.loadTexts:
...
dot3adAggPortListGroup.setObjects(
    ("LAG-MIB", "dot3adAggPortListPorts")
)
if mibBuilder.loadTexts:
...
dot3adAggPortGroup.setObjects(
      *(("LAG-MIB", "dot3adAggPortActorSystemPriority"),
        ("LAG-MIB", "dot3adAggPortActorSystemID"),
        ("LAG-MIB", "dot3adAggPortActorAdminKey"),
        ("LAG-MIB", "dot3adAggPortActorOperKey"),
        ("LAG-MIB", "dot3adAggPortPartnerAdminSystemPriority"),
        ("LAG-MIB", "dot3adAggPortPartnerOperSystemPriority"),
        ("LAG-MIB", "dot3adAggPortPartnerAdminSystemID"),
        ("LAG-MIB", "dot3adAggPortPartnerOperSystemID"),
        ("LAG-MIB", "dot3adAggPortPartnerAdminKey"),
        ("LAG-MIB", "dot3adAggPortPartnerOperKey"),
        ("LAG-MIB", "dot3adAggPortSelectedAggID"),
        ("LAG-MIB", "dot3adAggPortAttachedAggID"),
        ("LAG-MIB", "dot3adAggPortActorPort"),
        ("LAG-MIB", "dot3adAggPortActorPortPriority"),
        ("LAG-MIB", "dot3adAggPortPartnerAdminPort"),
        ("LAG-MIB", "dot3adAggPortPartnerOperPort"),
        ("LAG-MIB", "dot3adAggPortPartnerAdminPortPriority"),
        ("LAG-MIB", "dot3adAggPortPartnerOperPortPriority"),
        ("LAG-MIB", "dot3adAggPortActorAdminState"),
        ("LAG-MIB", "dot3adAggPortActorOperState"),
        ("LAG-MIB", "dot3adAggPortPartnerAdminState"),
        ("LAG-MIB", "dot3adAggPortPartnerOperState"),
        ("LAG-MIB", "dot3adAggPortAggregateOrIndividual"))
)
if mibBuilder.loadTexts:
...
dot3adAggPortStatsGroup.setObjects(
      *(("LAG-MIB", "dot3adAggPortStatsLACPDUsRx"),
        ("LAG-MIB", "dot3adAggPortStatsMarkerPDUsRx"),
        ("LAG-MIB", "dot3adAggPortStatsMarkerResponsePDUsRx"),
        ("LAG-MIB", "dot3adAggPortStatsUnknownRx"),
        ("LAG-MIB", "dot3adAggPortStatsIllegalRx"),
        ("LAG-MIB", "dot3adAggPortStatsLACPDUsTx"),
        ("LAG-MIB", "dot3adAggPortStatsMarkerPDUsTx"),
...
dot3adAggPortDebugGroup.setObjects(
      *(("LAG-MIB", "dot3adAggPortDebugRxState"),
        ("LAG-MIB", "dot3adAggPortDebugLastRxTime"),
        ("LAG-MIB", "dot3adAggPortDebugMuxState"),
        ("LAG-MIB", "dot3adAggPortDebugMuxReason"),
        ("LAG-MIB", "dot3adAggPortDebugActorChurnState"),
        ("LAG-MIB", "dot3adAggPortDebugPartnerChurnState"),
        ("LAG-MIB", "dot3adAggPortDebugActorChurnCount"),
        ("LAG-MIB", "dot3adAggPortDebugPartnerChurnCount"),
        ("LAG-MIB", "dot3adAggPortDebugActorSyncTransitionCount"),
        ("LAG-MIB", "dot3adAggPortDebugPartnerSyncTransitionCount"),
        ("LAG-MIB", "dot3adAggPortDebugActorChangeCount"),
        ("LAG-MIB", "dot3adAggPortDebugPartnerChangeCount"))
)
if mibBuilder.loadTexts:
...
dot3adAggCompliance.setObjects(
      *(("LAG-MIB", "dot3adAggGroup"),
        ("LAG-MIB", "dot3adAggPortGroup"),
        ("LAG-MIB", "dot3adTablesLastChangedGroup"),
        ("LAG-MIB", "dot3adAggPortListGroup"),
        ("LAG-MIB", "dot3adAggPortStatsGroup"),
        ("LAG-MIB", "dot3adAggPortDebugGroup"))
)
if mibBuilder.loadTexts:
