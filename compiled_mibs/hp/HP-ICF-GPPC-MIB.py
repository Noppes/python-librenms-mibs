...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-GPPC-MIB
...
class _HpicfGppcPrRuleId_Type(Integer32):
    """Custom type hpicfGppcPrRuleId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_HpicfGppcPrRuleId_Type.__name__ = "Integer32"
...
hpicfGppcMIBCompliance.setObjects(
      *(("HP-ICF-GPPC-MIB", "hpicfGppcGroup"),
        ("HP-ICF-GPPC-MIB", "hpicfGppcGroup"))
)
if mibBuilder.loadTexts:
