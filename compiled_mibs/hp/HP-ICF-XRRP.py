...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-XRRP
...
_HpicfXrrpRouterId_Type.__name__ = "XrrpRouterId"
...
_HpicfXrrpStatsRcMainRouterTime_Type = TimeStamp
_HpicfXrrpStatsRcMainRouterTime_Object = MibTableColumn
hpicfXrrpStatsRcMainRouterTime = _HpicfXrrpStatsRcMainRouterTime_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 18, 3, 13, 1, 11),
    _HpicfXrrpStatsRcMainRouterTime_Type()
)
hpicfXrrpStatsRcMainRouterTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpicfXrrpStatsRcMainRouterTime.setStatus("current")
_HpicfXrrpStatsRcBecomeMain_Type = Counter32
_HpicfXrrpStatsRcBecomeMain_Object = MibTableColumn
hpicfXrrpStatsRcBecomeMain = _HpicfXrrpStatsRcBecomeMain_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 18, 3, 13, 1, 12),
    _HpicfXrrpStatsRcBecomeMain_Type()
)
hpicfXrrpStatsRcBecomeMain.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpicfXrrpStatsRcBecomeMain.setStatus("current")
...
if mibBuilder.loadTexts:
    hpicfXrrpStatsGroup.setStatus("deprecated")
...
hpicfXrrpStatsGroup1 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 18, 4, 2, 7)
)
hpicfXrrpStatsGroup1.setObjects(
      *(("HP-ICF-XRRP", "hpicfXrrpStatsXrrpMacAddress"),
        ("HP-ICF-XRRP", "hpicfXrrpStatsMacAndMask"),
        ("HP-ICF-XRRP", "hpicfXrrpStatsPktsRcvd"),
        ("HP-ICF-XRRP", "hpicfXrrpStatsNotDomainPktsReject"),
        ...
        ("HP-ICF-XRRP", "hpicfXrrpStatsRcUnknownVlanId"),
        ("HP-ICF-XRRP", "hpicfXrrpStatsRcCreateTime"),
        ("HP-ICF-XRRP", "hpicfXrrpStatsRcBecomeMain"),
        ("HP-ICF-XRRP", "hpicfXrrpStatsRcMainRouterTime"))
)
if mibBuilder.loadTexts:
    hpicfXrrpStatsGroup1.setStatus("current")
...
hpicfXrrpMIBCompliance.setObjects(
      *(("HP-ICF-XRRP", "hpicfXrrpOperGroup"),
        ("HP-ICF-XRRP", "hpicfXrrpStatsGroup"))
)
if mibBuilder.loadTexts:
...
hpicfXrrpMIBCompliance1.setObjects(
      *(("HP-ICF-XRRP", "hpicfXrrpOperGroup1"),
        ("HP-ICF-XRRP", "hpicfXrrpStatsGroup"))
)
if mibBuilder.loadTexts:
...
hpicfXrrpMIBCompliance2.setObjects(
      *(("HP-ICF-XRRP", "hpicfXrrpOperGroup1"),
        ("HP-ICF-XRRP", "hpicfXrrpOperGroup2"),
        ("HP-ICF-XRRP", "hpicfXrrpStatsGroup"),
        ("HP-ICF-XRRP", "hpicfXrrpNotificationGroup"),
        ("HP-ICF-XRRP", "hpicfXrrpTrapGroup"))
)
if mibBuilder.loadTexts:
...
hpicfXrrpMIBCompliance3 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 18, 4, 1, 4)
)
hpicfXrrpMIBCompliance3.setObjects(
      *(("HP-ICF-XRRP", "hpicfXrrpOperGroup1"),
        ("HP-ICF-XRRP", "hpicfXrrpStatsGroup1"))
)
if mibBuilder.loadTexts:
    hpicfXrrpMIBCompliance3.setStatus(
        "current"
    )

hpicfXrrpMIBCompliance4 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 18, 4, 1, 5)
)
hpicfXrrpMIBCompliance4.setObjects(
      *(("HP-ICF-XRRP", "hpicfXrrpOperGroup1"),
        ("HP-ICF-XRRP", "hpicfXrrpOperGroup2"),
        ("HP-ICF-XRRP", "hpicfXrrpStatsGroup1"),
        ("HP-ICF-XRRP", "hpicfXrrpNotificationGroup"),
...
if mibBuilder.loadTexts:
    hpicfXrrpMIBCompliance4.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"XrrpRouterId": XrrpRouterId,
       ...
       "hpicfXrrpStatsRcMainRouterTime": hpicfXrrpStatsRcMainRouterTime,
       "hpicfXrrpStatsRcBecomeMain": hpicfXrrpStatsRcBecomeMain,
       ...
       "hpicfXrrpMIBCompliance3": hpicfXrrpMIBCompliance3,
       "hpicfXrrpMIBCompliance4": hpicfXrrpMIBCompliance4,
       ...
       "hpicfXrrpStatsGroup1": hpicfXrrpStatsGroup1}
)
