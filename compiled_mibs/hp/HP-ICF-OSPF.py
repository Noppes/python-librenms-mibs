...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-OSPF
...
_HpicfOspfNbrDesignatedRouter_Type.__name__ = "IpAddress"
...
_HpicfOspfNbrBackupDesignatedRouter_Type.__name__ = "IpAddress"
...
_HpicfOspfAreaAggregateCost_Type.__name__ = "BigMetric"
...
_HpicfOspfDistributeListTable_Object = MibTable
hpicfOspfDistributeListTable = _HpicfOspfDistributeListTable_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 14, 1, 7)
)
if mibBuilder.loadTexts:
    hpicfOspfDistributeListTable.setStatus("current")
_HpicfOspfDistributeListEntry_Object = MibTableRow
hpicfOspfDistributeListEntry = _HpicfOspfDistributeListEntry_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 14, 1, 7, 1)
)
hpicfOspfDistributeListEntry.setIndexNames(
    (0, "HP-ICF-OSPF", "hpicfOspfDistributeListAddr"),
    (0, "HP-ICF-OSPF", "hpicfOspfDistributeListMask"),
)
if mibBuilder.loadTexts:
    hpicfOspfDistributeListEntry.setStatus("current")
_HpicfOspfDistributeListAddr_Type = IpAddress
_HpicfOspfDistributeListAddr_Object = MibTableColumn
hpicfOspfDistributeListAddr = _HpicfOspfDistributeListAddr_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 14, 1, 7, 1, 1),
    _HpicfOspfDistributeListAddr_Type()
)
hpicfOspfDistributeListAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hpicfOspfDistributeListAddr.setStatus("current")
_HpicfOspfDistributeListMask_Type = IpAddress
_HpicfOspfDistributeListMask_Object = MibTableColumn
hpicfOspfDistributeListMask = _HpicfOspfDistributeListMask_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 14, 1, 7, 1, 2),
    _HpicfOspfDistributeListMask_Type()
)
hpicfOspfDistributeListMask.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hpicfOspfDistributeListMask.setStatus("current")
_HpicfOspfDistributeListStatus_Type = RowStatus
_HpicfOspfDistributeListStatus_Object = MibTableColumn
hpicfOspfDistributeListStatus = _HpicfOspfDistributeListStatus_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 14, 1, 7, 1, 3),
    _HpicfOspfDistributeListStatus_Type()
)
hpicfOspfDistributeListStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpicfOspfDistributeListStatus.setStatus("current")
...
_HpicfOspfIfPassive_Type.__name__ = "TruthValue"
...
_HpicfOspfIfBfdEnbl_Type.__name__ = "TruthValue"
...
_HpicfOspfClearCounters_Type.__name__ = "TruthValue"
...
hpicfOspfDistributeListGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 14, 2, 1, 18)
)
hpicfOspfDistributeListGroup.setObjects(
    ("HP-ICF-OSPF", "hpicfOspfDistributeListStatus")
)
if mibBuilder.loadTexts:
    hpicfOspfDistributeListGroup.setStatus("current")
...
hpicfOspfCompliance.setObjects(
      *(("HP-ICF-OSPF", "hpicfOspfBaseGroup"),
        ("HP-ICF-OSPF", "hpicfOspfRedistGroup"))
)
if mibBuilder.loadTexts:
...
hpicfOspfReqCompliance.setObjects(
      *(("HP-ICF-OSPF", "hpicfOspfReqManGroup"),
        ("HP-ICF-OSPF", "hpicfOspfReqGroup"))
)
if mibBuilder.loadTexts:
...
hpicfOspfFloodCompliance.setObjects(
      *(("HP-ICF-OSPF", "hpicfOspfFloodManGroup"),
        ("HP-ICF-OSPF", "hpicfOspfFloodGroup"))
)
if mibBuilder.loadTexts:
...
hpicfOspfRetransCompliance.setObjects(
      *(("HP-ICF-OSPF", "hpicfOspfRetransManGroup"),
        ("HP-ICF-OSPF", "hpicfOspfRetransGroup"))
)
if mibBuilder.loadTexts:
...
hpicfOspfCompliance1.setObjects(
      *(("HP-ICF-OSPF", "hpicfOspfAreaLsdbGroup"),
        ("HP-ICF-OSPF", "hpicfOspfExtLsdbGroup"),
        ("HP-ICF-OSPF", "hpicfOspfDistanceGroup"),
        ("HP-ICF-OSPF", "hpicfOspfSpfTimerGroup"),
        ("HP-ICF-OSPF", "hpicfOspfStatisticGroup"),
        ("HP-ICF-OSPF", "hpicfOspfIfGroup"),
        ("HP-ICF-OSPF", "hpicfOspfAreaAggregateGroup"),
        ("HP-ICF-OSPF", "hpicfOspfNbrGroup"),
        ("HP-ICF-OSPF", "hpicfOspfLogGroup"))
)
if mibBuilder.loadTexts:
...
hpicfOspfSpfDelayCompliance.setObjects(
    ("HP-ICF-OSPF", "hpicfOspfSpfDelayGroup")
)
if mibBuilder.loadTexts:
...
hpicfOspfAreaAggregateCompliance.setObjects(
    ("HP-ICF-OSPF", "hpicfOspfAreaAggregateGroup1")
)
if mibBuilder.loadTexts:
...
hpicfOspfCompliance2.setObjects(
      *(("HP-ICF-OSPF", "hpicfOspfAreaLsdbGroup"),
        ("HP-ICF-OSPF", "hpicfOspfExtLsdbGroup"),
        ("HP-ICF-OSPF", "hpicfOspfDistanceGroup"),
        ("HP-ICF-OSPF", "hpicfOspfSpfTimerGroup"),
        ...
        ("HP-ICF-OSPF", "hpicfOspfIfGroup"),
        ("HP-ICF-OSPF", "hpicfOspfAreaAggregateGroup"),
        ("HP-ICF-OSPF", "hpicfOspfNbrGroup1"),
        ("HP-ICF-OSPF", "hpicfOspfLogGroup"))
)
if mibBuilder.loadTexts:
...
hpicfOspfCompliance3.setObjects(
      *(("HP-ICF-OSPF", "hpicfOspfAreaLsdbGroup"),
        ("HP-ICF-OSPF", "hpicfOspfExtLsdbGroup"),
        ("HP-ICF-OSPF", "hpicfOspfDistanceGroup"),
        ("HP-ICF-OSPF", "hpicfOspfSpfTimerGroup"),
        ...
        ("HP-ICF-OSPF", "hpicfOspfNbrGroup1"),
        ("HP-ICF-OSPF", "hpicfOspfLogGroup"),
        ("HP-ICF-OSPF", "hpicfOspfReferenceGroup"),
        ("HP-ICF-OSPF", "hpicfOspfMetricGroup"))
)
if mibBuilder.loadTexts:
...
hpicfOspfCompliance5 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 14, 2, 2, 11)
)
hpicfOspfCompliance5.setObjects(
      *(("HP-ICF-OSPF", "hpicfOspfBaseGroup"),
        ("HP-ICF-OSPF", "hpicfOspfRedistGroup"),
        ("HP-ICF-OSPF", "hpicfOspfDistributeListGroup"))
)
if mibBuilder.loadTexts:
    hpicfOspfCompliance5.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"HpicfOspfRouterIdTc": HpicfOspfRouterIdTc,
       ...
       "hpicfOspfDistributeListTable": hpicfOspfDistributeListTable,
       "hpicfOspfDistributeListEntry": hpicfOspfDistributeListEntry,
       "hpicfOspfDistributeListAddr": hpicfOspfDistributeListAddr,
       "hpicfOspfDistributeListMask": hpicfOspfDistributeListMask,
       "hpicfOspfDistributeListStatus": hpicfOspfDistributeListStatus,
       ...
       "hpicfOspfDistributeListGroup": hpicfOspfDistributeListGroup,
       ...
       "hpicfOspfCompliance5": hpicfOspfCompliance5,
