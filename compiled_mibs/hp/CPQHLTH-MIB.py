...
# Notes
# -----
# ASN.1 source file://mibs\hp\CPQHLTH-MIB
...
_CpqHeHWBios_ObjectIdentity = ObjectIdentity
cpqHeHWBios = _CpqHeHWBios_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 16)
)


class _CpqHeHWBiosCondition_Type(Integer32):
    """Custom type cpqHeHWBiosCondition based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHeHWBiosCondition_Type.__name__ = "Integer32"
_CpqHeHWBiosCondition_Object = MibScalar
cpqHeHWBiosCondition = _CpqHeHWBiosCondition_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 16, 1),
    _CpqHeHWBiosCondition_Type()
)
cpqHeHWBiosCondition.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeHWBiosCondition.setStatus("mandatory")
_CpqHeSysBackupBattery_ObjectIdentity = ObjectIdentity
cpqHeSysBackupBattery = _CpqHeSysBackupBattery_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17)
)


class _CpqHeSysBackupBatteryCondition_Type(Integer32):
    """Custom type cpqHeSysBackupBatteryCondition based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHeSysBackupBatteryCondition_Type.__name__ = "Integer32"
_CpqHeSysBackupBatteryCondition_Object = MibScalar
cpqHeSysBackupBatteryCondition = _CpqHeSysBackupBatteryCondition_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 1),
    _CpqHeSysBackupBatteryCondition_Type()
)
cpqHeSysBackupBatteryCondition.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBackupBatteryCondition.setStatus("mandatory")
_CpqHeSysBatteryTable_Object = MibTable
cpqHeSysBatteryTable = _CpqHeSysBatteryTable_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2)
)
if mibBuilder.loadTexts:
    cpqHeSysBatteryTable.setStatus("mandatory")
_CpqHeSysBatteryEntry_Object = MibTableRow
cpqHeSysBatteryEntry = _CpqHeSysBatteryEntry_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1)
)
cpqHeSysBatteryEntry.setIndexNames(
    (0, "CPQHLTH-MIB", "cpqHeSysBatteryChassis"),
    (0, "CPQHLTH-MIB", "cpqHeSysBatteryIndex"),
)
if mibBuilder.loadTexts:
    cpqHeSysBatteryEntry.setStatus("mandatory")


class _CpqHeSysBatteryChassis_Type(Integer32):
    """Custom type cpqHeSysBatteryChassis based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_CpqHeSysBatteryChassis_Type.__name__ = "Integer32"
_CpqHeSysBatteryChassis_Object = MibTableColumn
cpqHeSysBatteryChassis = _CpqHeSysBatteryChassis_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1, 1),
    _CpqHeSysBatteryChassis_Type()
)
cpqHeSysBatteryChassis.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBatteryChassis.setStatus("mandatory")


class _CpqHeSysBatteryIndex_Type(Integer32):
    """Custom type cpqHeSysBatteryIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CpqHeSysBatteryIndex_Type.__name__ = "Integer32"
_CpqHeSysBatteryIndex_Object = MibTableColumn
cpqHeSysBatteryIndex = _CpqHeSysBatteryIndex_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1, 2),
    _CpqHeSysBatteryIndex_Type()
)
cpqHeSysBatteryIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBatteryIndex.setStatus("mandatory")


class _CpqHeSysBatteryPresent_Type(Integer32):
    """Custom type cpqHeSysBatteryPresent based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHeSysBatteryPresent_Type.__name__ = "Integer32"
_CpqHeSysBatteryPresent_Object = MibTableColumn
cpqHeSysBatteryPresent = _CpqHeSysBatteryPresent_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1, 3),
    _CpqHeSysBatteryPresent_Type()
)
cpqHeSysBatteryPresent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBatteryPresent.setStatus("mandatory")


class _CpqHeSysBatteryCondition_Type(Integer32):
    """Custom type cpqHeSysBatteryCondition based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHeSysBatteryCondition_Type.__name__ = "Integer32"
_CpqHeSysBatteryCondition_Object = MibTableColumn
cpqHeSysBatteryCondition = _CpqHeSysBatteryCondition_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1, 4),
    _CpqHeSysBatteryCondition_Type()
)
cpqHeSysBatteryCondition.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBatteryCondition.setStatus("mandatory")


class _CpqHeSysBatteryStatus_Type(Integer32):
    """Custom type cpqHeSysBatteryStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHeSysBatteryStatus_Type.__name__ = "Integer32"
_CpqHeSysBatteryStatus_Object = MibTableColumn
cpqHeSysBatteryStatus = _CpqHeSysBatteryStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1, 5),
    _CpqHeSysBatteryStatus_Type()
)
cpqHeSysBatteryStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBatteryStatus.setStatus("mandatory")
_CpqHeSysBatteryCapacityMaximum_Type = Integer32
_CpqHeSysBatteryCapacityMaximum_Object = MibTableColumn
cpqHeSysBatteryCapacityMaximum = _CpqHeSysBatteryCapacityMaximum_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1, 6),
    _CpqHeSysBatteryCapacityMaximum_Type()
)
cpqHeSysBatteryCapacityMaximum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBatteryCapacityMaximum.setStatus("mandatory")


class _CpqHeSysBatteryProductName_Type(DisplayString):
    """Custom type cpqHeSysBatteryProductName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_CpqHeSysBatteryProductName_Type.__name__ = "DisplayString"
_CpqHeSysBatteryProductName_Object = MibTableColumn
cpqHeSysBatteryProductName = _CpqHeSysBatteryProductName_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1, 7),
    _CpqHeSysBatteryProductName_Type()
)
cpqHeSysBatteryProductName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBatteryProductName.setStatus("mandatory")


class _CpqHeSysBatteryModel_Type(DisplayString):
    """Custom type cpqHeSysBatteryModel based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 24),
    )
...
_CpqHeSysBatteryModel_Type.__name__ = "DisplayString"
_CpqHeSysBatteryModel_Object = MibTableColumn
cpqHeSysBatteryModel = _CpqHeSysBatteryModel_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1, 8),
    _CpqHeSysBatteryModel_Type()
)
cpqHeSysBatteryModel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBatteryModel.setStatus("mandatory")


class _CpqHeSysBatterySerialNumber_Type(DisplayString):
    """Custom type cpqHeSysBatterySerialNumber based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 24),
    )
...
_CpqHeSysBatterySerialNumber_Type.__name__ = "DisplayString"
_CpqHeSysBatterySerialNumber_Object = MibTableColumn
cpqHeSysBatterySerialNumber = _CpqHeSysBatterySerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1, 9),
    _CpqHeSysBatterySerialNumber_Type()
)
cpqHeSysBatterySerialNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBatterySerialNumber.setStatus("mandatory")


class _CpqHeSysBatteryFirmwareRev_Type(DisplayString):
    """Custom type cpqHeSysBatteryFirmwareRev based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 24),
    )
...
_CpqHeSysBatteryFirmwareRev_Type.__name__ = "DisplayString"
_CpqHeSysBatteryFirmwareRev_Object = MibTableColumn
cpqHeSysBatteryFirmwareRev = _CpqHeSysBatteryFirmwareRev_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1, 10),
    _CpqHeSysBatteryFirmwareRev_Type()
)
cpqHeSysBatteryFirmwareRev.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBatteryFirmwareRev.setStatus("mandatory")


class _CpqHeSysBatterySparePartNum_Type(DisplayString):
    """Custom type cpqHeSysBatterySparePartNum based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 24),
    )
...
_CpqHeSysBatterySparePartNum_Type.__name__ = "DisplayString"
_CpqHeSysBatterySparePartNum_Object = MibTableColumn
cpqHeSysBatterySparePartNum = _CpqHeSysBatterySparePartNum_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 17, 2, 1, 11),
    _CpqHeSysBatterySparePartNum_Type()
)
cpqHeSysBatterySparePartNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBatterySparePartNum.setStatus("optional")
_CpqHeSysPwrHw_ObjectIdentity = ObjectIdentity
cpqHeSysPwrHw = _CpqHeSysPwrHw_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 18)
)


class _CpqHeSysPwrAllocationOptimizeStatus_Type(Integer32):
    """Custom type cpqHeSysPwrAllocationOptimizeStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHeSysPwrAllocationOptimizeStatus_Type.__name__ = "Integer32"
_CpqHeSysPwrAllocationOptimizeStatus_Object = MibScalar
cpqHeSysPwrAllocationOptimizeStatus = _CpqHeSysPwrAllocationOptimizeStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 18, 1),
    _CpqHeSysPwrAllocationOptimizeStatus_Type()
)
cpqHeSysPwrAllocationOptimizeStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysPwrAllocationOptimizeStatus.setStatus("mandatory")
_CpqHeSysBoardFru_ObjectIdentity = ObjectIdentity
cpqHeSysBoardFru = _CpqHeSysBoardFru_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 19)
)


class _CpqHeSysBoardFruStatus_Type(OctetString):
    """Custom type cpqHeSysBoardFruStatus based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CpqHeSysBoardFruStatus_Type.__name__ = "OctetString"
_CpqHeSysBoardFruStatus_Object = MibScalar
cpqHeSysBoardFruStatus = _CpqHeSysBoardFruStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 19, 1),
    _CpqHeSysBoardFruStatus_Type()
)
cpqHeSysBoardFruStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeSysBoardFruStatus.setStatus("mandatory")
_CpqHePowerFailure_ObjectIdentity = ObjectIdentity
cpqHePowerFailure = _CpqHePowerFailure_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20)
)


class _CpqHePowerFailureSupported_Type(Integer32):
    """Custom type cpqHePowerFailureSupported based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHePowerFailureSupported_Type.__name__ = "Integer32"
_CpqHePowerFailureSupported_Object = MibScalar
cpqHePowerFailureSupported = _CpqHePowerFailureSupported_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20, 1),
    _CpqHePowerFailureSupported_Type()
)
cpqHePowerFailureSupported.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHePowerFailureSupported.setStatus("mandatory")
_CpqHePowerFailureTable_Object = MibTable
cpqHePowerFailureTable = _CpqHePowerFailureTable_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20, 2)
)
if mibBuilder.loadTexts:
    cpqHePowerFailureTable.setStatus("mandatory")
_CpqHePowerFailureTableEntry_Object = MibTableRow
cpqHePowerFailureTableEntry = _CpqHePowerFailureTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20, 2, 1)
)
cpqHePowerFailureTableEntry.setIndexNames(
    (0, "CPQHLTH-MIB", "cpqHePowerFailureIndex"),
)
if mibBuilder.loadTexts:
    cpqHePowerFailureTableEntry.setStatus("mandatory")


class _CpqHePowerFailureIndex_Type(Integer32):
    """Custom type cpqHePowerFailureIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 15),
    )
...
_CpqHePowerFailureIndex_Type.__name__ = "Integer32"
_CpqHePowerFailureIndex_Object = MibTableColumn
cpqHePowerFailureIndex = _CpqHePowerFailureIndex_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20, 2, 1, 1),
    _CpqHePowerFailureIndex_Type()
)
cpqHePowerFailureIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHePowerFailureIndex.setStatus("mandatory")


class _CpqHePowerFailureStatus_Type(Integer32):
    """Custom type cpqHePowerFailureStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHePowerFailureStatus_Type.__name__ = "Integer32"
_CpqHePowerFailureStatus_Object = MibTableColumn
cpqHePowerFailureStatus = _CpqHePowerFailureStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20, 2, 1, 2),
    _CpqHePowerFailureStatus_Type()
)
cpqHePowerFailureStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHePowerFailureStatus.setStatus("mandatory")
_CpqHePowerFailureDeviceID_Type = Integer32
_CpqHePowerFailureDeviceID_Object = MibTableColumn
cpqHePowerFailureDeviceID = _CpqHePowerFailureDeviceID_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20, 2, 1, 3),
    _CpqHePowerFailureDeviceID_Type()
)
cpqHePowerFailureDeviceID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHePowerFailureDeviceID.setStatus("mandatory")


class _CpqHePowerFailureArea_Type(Integer32):
    """Custom type cpqHePowerFailureArea based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHePowerFailureArea_Type.__name__ = "Integer32"
_CpqHePowerFailureArea_Object = MibTableColumn
cpqHePowerFailureArea = _CpqHePowerFailureArea_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20, 2, 1, 4),
    _CpqHePowerFailureArea_Type()
)
cpqHePowerFailureArea.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHePowerFailureArea.setStatus("mandatory")


class _CpqHePowerFailureDeviceBitMap_Type(Integer32):
    """Custom type cpqHePowerFailureDeviceBitMap based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CpqHePowerFailureDeviceBitMap_Type.__name__ = "Integer32"
_CpqHePowerFailureDeviceBitMap_Object = MibTableColumn
cpqHePowerFailureDeviceBitMap = _CpqHePowerFailureDeviceBitMap_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20, 2, 1, 5),
    _CpqHePowerFailureDeviceBitMap_Type()
)
cpqHePowerFailureDeviceBitMap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHePowerFailureDeviceBitMap.setStatus("mandatory")
_CpqHePowerFailureGroupString_Type = DisplayString
_CpqHePowerFailureGroupString_Object = MibTableColumn
cpqHePowerFailureGroupString = _CpqHePowerFailureGroupString_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20, 2, 1, 6),
    _CpqHePowerFailureGroupString_Type()
)
cpqHePowerFailureGroupString.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHePowerFailureGroupString.setStatus("mandatory")


class _CpqHePowerFailureRepairSteps_Type(Integer32):
    """Custom type cpqHePowerFailureRepairSteps based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHePowerFailureRepairSteps_Type.__name__ = "Integer32"
_CpqHePowerFailureRepairSteps_Object = MibTableColumn
cpqHePowerFailureRepairSteps = _CpqHePowerFailureRepairSteps_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20, 2, 1, 7),
    _CpqHePowerFailureRepairSteps_Type()
)
cpqHePowerFailureRepairSteps.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHePowerFailureRepairSteps.setStatus("mandatory")


class _CpqHePowerFailureType_Type(Integer32):
    """Custom type cpqHePowerFailureType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHePowerFailureType_Type.__name__ = "Integer32"
_CpqHePowerFailureType_Object = MibTableColumn
cpqHePowerFailureType = _CpqHePowerFailureType_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 20, 2, 1, 8),
    _CpqHePowerFailureType_Type()
)
cpqHePowerFailureType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHePowerFailureType.setStatus("mandatory")
_CpqHeInterlockFailure_ObjectIdentity = ObjectIdentity
cpqHeInterlockFailure = _CpqHeInterlockFailure_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 21)
)


class _CpqHeInterlockFailureSupported_Type(Integer32):
    """Custom type cpqHeInterlockFailureSupported based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHeInterlockFailureSupported_Type.__name__ = "Integer32"
_CpqHeInterlockFailureSupported_Object = MibScalar
cpqHeInterlockFailureSupported = _CpqHeInterlockFailureSupported_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 21, 1),
    _CpqHeInterlockFailureSupported_Type()
)
cpqHeInterlockFailureSupported.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeInterlockFailureSupported.setStatus("mandatory")
_CpqHeInterlockFailureTable_Object = MibTable
cpqHeInterlockFailureTable = _CpqHeInterlockFailureTable_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 21, 2)
)
if mibBuilder.loadTexts:
    cpqHeInterlockFailureTable.setStatus("mandatory")
_CpqHeInterlockFailureTableEntry_Object = MibTableRow
cpqHeInterlockFailureTableEntry = _CpqHeInterlockFailureTableEntry_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 21, 2, 1)
)
cpqHeInterlockFailureTableEntry.setIndexNames(
    (0, "CPQHLTH-MIB", "cpqHeInterlockFailureIndex"),
)
if mibBuilder.loadTexts:
    cpqHeInterlockFailureTableEntry.setStatus("mandatory")


class _CpqHeInterlockFailureIndex_Type(Integer32):
    """Custom type cpqHeInterlockFailureIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 16),
    )
...
_CpqHeInterlockFailureIndex_Type.__name__ = "Integer32"
_CpqHeInterlockFailureIndex_Object = MibTableColumn
cpqHeInterlockFailureIndex = _CpqHeInterlockFailureIndex_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 21, 2, 1, 1),
    _CpqHeInterlockFailureIndex_Type()
)
cpqHeInterlockFailureIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeInterlockFailureIndex.setStatus("mandatory")


class _CpqHeInterlockFailureStatus_Type(Integer32):
    """Custom type cpqHeInterlockFailureStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHeInterlockFailureStatus_Type.__name__ = "Integer32"
_CpqHeInterlockFailureStatus_Object = MibTableColumn
cpqHeInterlockFailureStatus = _CpqHeInterlockFailureStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 21, 2, 1, 2),
    _CpqHeInterlockFailureStatus_Type()
)
cpqHeInterlockFailureStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeInterlockFailureStatus.setStatus("mandatory")
_CpqHeInterlockFailureDeviceID_Type = Integer32
_CpqHeInterlockFailureDeviceID_Object = MibTableColumn
cpqHeInterlockFailureDeviceID = _CpqHeInterlockFailureDeviceID_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 21, 2, 1, 3),
    _CpqHeInterlockFailureDeviceID_Type()
)
cpqHeInterlockFailureDeviceID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeInterlockFailureDeviceID.setStatus("mandatory")


class _CpqHeInterlockFailureArea_Type(Integer32):
    """Custom type cpqHeInterlockFailureArea based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHeInterlockFailureArea_Type.__name__ = "Integer32"
_CpqHeInterlockFailureArea_Object = MibTableColumn
cpqHeInterlockFailureArea = _CpqHeInterlockFailureArea_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 21, 2, 1, 4),
    _CpqHeInterlockFailureArea_Type()
)
cpqHeInterlockFailureArea.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeInterlockFailureArea.setStatus("mandatory")
_CpqHeInterlockFailureDeviceName_Type = DisplayString
_CpqHeInterlockFailureDeviceName_Object = MibTableColumn
cpqHeInterlockFailureDeviceName = _CpqHeInterlockFailureDeviceName_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 21, 2, 1, 5),
    _CpqHeInterlockFailureDeviceName_Type()
)
cpqHeInterlockFailureDeviceName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeInterlockFailureDeviceName.setStatus("mandatory")


class _CpqHeInterlockFailureType_Type(Integer32):
    """Custom type cpqHeInterlockFailureType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqHeInterlockFailureType_Type.__name__ = "Integer32"
_CpqHeInterlockFailureType_Object = MibTableColumn
cpqHeInterlockFailureType = _CpqHeInterlockFailureType_Object(
    (1, 3, 6, 1, 4, 1, 232, 6, 2, 21, 2, 1, 6),
    _CpqHeInterlockFailureType_Type()
)
cpqHeInterlockFailureType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHeInterlockFailureType.setStatus("mandatory")
...
cpqHeSysBatteryFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 6070)
)
cpqHeSysBatteryFailed.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQHOST-MIB", "cpqHoGUIDCanonical"),
        ("CPQHLTH-MIB", "cpqHeSysBatteryChassis"),
        ("CPQHLTH-MIB", "cpqHeSysBatteryIndex"),
        ("CPQHLTH-MIB", "cpqHeSysBatteryStatus"),
        ("CPQHLTH-MIB", "cpqHeSysBatteryModel"),
        ("CPQHLTH-MIB", "cpqHeSysBatterySerialNumber"),
        ("CPQHLTH-MIB", "cpqHeSysBatterySparePartNum"))
)
if mibBuilder.loadTexts:
    cpqHeSysBatteryFailed.setStatus(
        ""
    )

cpqHeSysBatteryRemoved = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 6071)
)
cpqHeSysBatteryRemoved.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQHOST-MIB", "cpqHoGUIDCanonical"),
        ("CPQHLTH-MIB", "cpqHeSysBatteryChassis"),
...
if mibBuilder.loadTexts:
    cpqHeSysBatteryRemoved.setStatus(
        ""
    )

cpqHeSysPwrAllocationNotOptimized = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 6072)
)
cpqHeSysPwrAllocationNotOptimized.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQHOST-MIB", "cpqHoGUIDCanonical"))
)
if mibBuilder.loadTexts:
    cpqHeSysPwrAllocationNotOptimized.setStatus(
        ""
    )

cpqHeSysPwrOnDenied = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 6073)
)
cpqHeSysPwrOnDenied.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQHOST-MIB", "cpqHoGUIDCanonical"),
        ("CPQHLTH-MIB", "cpqHeSysBoardFruStatus"))
)
if mibBuilder.loadTexts:
    cpqHeSysPwrOnDenied.setStatus(
        ""
    )

cpqHePowerFailureError = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 6074)
)
cpqHePowerFailureError.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQHOST-MIB", "cpqHoGUIDCanonical"),
        ("CPQHLTH-MIB", "cpqHePowerFailureIndex"),
        ("CPQHLTH-MIB", "cpqHePowerFailureType"),
        ("CPQHLTH-MIB", "cpqHePowerFailureArea"),
        ("CPQHLTH-MIB", "cpqHePowerFailureGroupString"),
        ("CPQHLTH-MIB", "cpqHePowerFailureDeviceBitMap"),
        ("CPQHLTH-MIB", "cpqHePowerFailureRepairSteps"))
)
if mibBuilder.loadTexts:
    cpqHePowerFailureError.setStatus(
        ""
    )

cpqHeInterlockFailureError = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 6075)
)
cpqHeInterlockFailureError.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQHOST-MIB", "cpqHoGUIDCanonical"),
        ("CPQHLTH-MIB", "cpqHeInterlockFailureIndex"),
        ("CPQHLTH-MIB", "cpqHeInterlockFailureType"),
        ("CPQHLTH-MIB", "cpqHeInterlockFailureDeviceName"))
)
if mibBuilder.loadTexts:
    cpqHeInterlockFailureError.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"cpqHe2CorrectableMemoryError": cpqHe2CorrectableMemoryError,
       ...
       "cpqHeSysBatteryFailed": cpqHeSysBatteryFailed,
       "cpqHeSysBatteryRemoved": cpqHeSysBatteryRemoved,
       "cpqHeSysPwrAllocationNotOptimized": cpqHeSysPwrAllocationNotOptimized,
       "cpqHeSysPwrOnDenied": cpqHeSysPwrOnDenied,
       "cpqHePowerFailureError": cpqHePowerFailureError,
       "cpqHeInterlockFailureError": cpqHeInterlockFailureError,
       "cpqHealth": cpqHealth,
       ...
       "cpqHeHWBios": cpqHeHWBios,
       "cpqHeHWBiosCondition": cpqHeHWBiosCondition,
       "cpqHeSysBackupBattery": cpqHeSysBackupBattery,
       "cpqHeSysBackupBatteryCondition": cpqHeSysBackupBatteryCondition,
       "cpqHeSysBatteryTable": cpqHeSysBatteryTable,
       "cpqHeSysBatteryEntry": cpqHeSysBatteryEntry,
       "cpqHeSysBatteryChassis": cpqHeSysBatteryChassis,
       "cpqHeSysBatteryIndex": cpqHeSysBatteryIndex,
       "cpqHeSysBatteryPresent": cpqHeSysBatteryPresent,
       "cpqHeSysBatteryCondition": cpqHeSysBatteryCondition,
       "cpqHeSysBatteryStatus": cpqHeSysBatteryStatus,
       "cpqHeSysBatteryCapacityMaximum": cpqHeSysBatteryCapacityMaximum,
       "cpqHeSysBatteryProductName": cpqHeSysBatteryProductName,
       "cpqHeSysBatteryModel": cpqHeSysBatteryModel,
       "cpqHeSysBatterySerialNumber": cpqHeSysBatterySerialNumber,
       "cpqHeSysBatteryFirmwareRev": cpqHeSysBatteryFirmwareRev,
       "cpqHeSysBatterySparePartNum": cpqHeSysBatterySparePartNum,
       "cpqHeSysPwrHw": cpqHeSysPwrHw,
       "cpqHeSysPwrAllocationOptimizeStatus": cpqHeSysPwrAllocationOptimizeStatus,
       "cpqHeSysBoardFru": cpqHeSysBoardFru,
       "cpqHeSysBoardFruStatus": cpqHeSysBoardFruStatus,
       "cpqHePowerFailure": cpqHePowerFailure,
       "cpqHePowerFailureSupported": cpqHePowerFailureSupported,
       "cpqHePowerFailureTable": cpqHePowerFailureTable,
       "cpqHePowerFailureTableEntry": cpqHePowerFailureTableEntry,
       "cpqHePowerFailureIndex": cpqHePowerFailureIndex,
       "cpqHePowerFailureStatus": cpqHePowerFailureStatus,
       "cpqHePowerFailureDeviceID": cpqHePowerFailureDeviceID,
       "cpqHePowerFailureArea": cpqHePowerFailureArea,
       "cpqHePowerFailureDeviceBitMap": cpqHePowerFailureDeviceBitMap,
       "cpqHePowerFailureGroupString": cpqHePowerFailureGroupString,
       "cpqHePowerFailureRepairSteps": cpqHePowerFailureRepairSteps,
       "cpqHePowerFailureType": cpqHePowerFailureType,
       "cpqHeInterlockFailure": cpqHeInterlockFailure,
       "cpqHeInterlockFailureSupported": cpqHeInterlockFailureSupported,
       "cpqHeInterlockFailureTable": cpqHeInterlockFailureTable,
       "cpqHeInterlockFailureTableEntry": cpqHeInterlockFailureTableEntry,
       "cpqHeInterlockFailureIndex": cpqHeInterlockFailureIndex,
       "cpqHeInterlockFailureStatus": cpqHeInterlockFailureStatus,
       "cpqHeInterlockFailureDeviceID": cpqHeInterlockFailureDeviceID,
       "cpqHeInterlockFailureArea": cpqHeInterlockFailureArea,
       "cpqHeInterlockFailureDeviceName": cpqHeInterlockFailureDeviceName,
       "cpqHeInterlockFailureType": cpqHeInterlockFailureType,
       "cpqHeTrap": cpqHeTrap,
