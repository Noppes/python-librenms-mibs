...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-LINKTEST
...
_HpicfLinkTestIfIndex_Type.__name__ = "Integer32"
...
_HpicfLinkTestTimeout_Type.__name__ = "TimeInterval"
...
hpicfLinkTestCompliance.setObjects(
    ("HP-ICF-LINKTEST", "hpicfLinkTestGroup")
)
if mibBuilder.loadTexts:
...
hpicfLinkTestCompliance2.setObjects(
    ("HP-ICF-LINKTEST", "hpicfLinkTestGroup2")
)
if mibBuilder.loadTexts:
