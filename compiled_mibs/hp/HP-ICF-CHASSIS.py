...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-CHASSIS
...
_HpicfOpacityShieldInstalled_Type.__name__ = "TruthValue"
...
_HpicfPowerSupplyTable_Object = MibTable
hpicfPowerSupplyTable = _HpicfPowerSupplyTable_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 2, 11)
)
if mibBuilder.loadTexts:
    hpicfPowerSupplyTable.setStatus("current")
_HpicfPowerSupplyEntry_Object = MibTableRow
hpicfPowerSupplyEntry = _HpicfPowerSupplyEntry_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 2, 11, 1)
)
hpicfPowerSupplyEntry.setIndexNames(
    (0, "HP-ICF-CHASSIS", "hpicfPowerSupplySlotNum"),
)
if mibBuilder.loadTexts:
    hpicfPowerSupplyEntry.setStatus("current")


class _HpicfPowerSupplySlotNum_Type(Integer32):
    """Custom type hpicfPowerSupplySlotNum based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_HpicfPowerSupplySlotNum_Type.__name__ = "Integer32"
_HpicfPowerSupplySlotNum_Object = MibTableColumn
hpicfPowerSupplySlotNum = _HpicfPowerSupplySlotNum_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 2, 11, 1, 1),
    _HpicfPowerSupplySlotNum_Type()
)
hpicfPowerSupplySlotNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpicfPowerSupplySlotNum.setStatus("current")


class _HpicfPowerSupplyStatus_Type(Integer32):
    """Custom type hpicfPowerSupplyStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_HpicfPowerSupplyStatus_Type.__name__ = "Integer32"
_HpicfPowerSupplyStatus_Object = MibTableColumn
hpicfPowerSupplyStatus = _HpicfPowerSupplyStatus_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 2, 11, 1, 2),
    _HpicfPowerSupplyStatus_Type()
)
hpicfPowerSupplyStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpicfPowerSupplyStatus.setStatus("current")
...
hpicfPowerSupplyGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 10, 2, 3, 1, 2, 8)
)
hpicfPowerSupplyGroup.setObjects(
      *(("HP-ICF-CHASSIS", "hpicfPowerSupplySlotNum"),
        ("HP-ICF-CHASSIS", "hpicfPowerSupplyStatus"))
)
if mibBuilder.loadTexts:
    hpicfPowerSupplyGroup.setStatus("current")
...
hpicfPowerSupplyStatusTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 12, 1, 0, 6)
)
hpicfPowerSupplyStatusTrap.setObjects(
      *(("HP-ICF-CHASSIS", "hpicfPowerSupplySlotNum"),
        ("HP-ICF-CHASSIS", "hpicfPowerSupplyStatus"))
)
if mibBuilder.loadTexts:
    hpicfPowerSupplyStatusTrap.setStatus(
        "current"
    )
...
hpicfPowerSupplyNotifyGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 10, 2, 3, 1, 2, 9)
)
hpicfPowerSupplyNotifyGroup.setObjects(
    ("HP-ICF-CHASSIS", "hpicfPowerSupplyStatusTrap")
)
if mibBuilder.loadTexts:
    hpicfPowerSupplyNotifyGroup.setStatus(
        "current"
    )
...
hpicfChasAdvStkCompliance.setObjects(
      *(("HP-ICF-CHASSIS", "hpicfChassisBasicGroup"),
        ("HP-ICF-CHASSIS", "hpicfSensorGroup"),
        ("HP-ICF-CHASSIS", "hpicfSensorNotifyGroup"))
)
if mibBuilder.loadTexts:
...
hpicfChasAdvStk2Compliance.setObjects(
      *(("HP-ICF-CHASSIS", "hpicfChassisBasicGroup"),
        ("HP-ICF-CHASSIS", "hpicfChassisAddrGroup"),
        ("HP-ICF-CHASSIS", "hpicfSensorGroup"),
        ("HP-ICF-CHASSIS", "hpicfSensorNotifyGroup"))
)
if mibBuilder.loadTexts:
...
hpicfChasSensorCompliance.setObjects(
      *(("HP-ICF-CHASSIS", "hpicfSensorGroup"),
        ("HP-ICF-CHASSIS", "hpicfSensorNotifyGroup"))
)
if mibBuilder.loadTexts:
...
hpicfChasTempCompliance.setObjects(
    ("HP-ICF-CHASSIS", "hpicfChasTempGroup")
)
if mibBuilder.loadTexts:
...
hpicfOpacityShieldsCompliance.setObjects(
    ("HP-ICF-CHASSIS", "hpicfOpacityShieldsGroup")
)
if mibBuilder.loadTexts:
...
hpicfChasTempCompliance1.setObjects(
    ("HP-ICF-CHASSIS", "hpicfChasTempGroup1")
)
if mibBuilder.loadTexts:
...
hpicfChasPowerSupplyCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 10, 2, 3, 1, 1, 7)
)
hpicfChasPowerSupplyCompliance.setObjects(
      *(("HP-ICF-CHASSIS", "hpicfPowerSupplyGroup"),
        ("HP-ICF-CHASSIS", "hpicfPowerSupplyNotifyGroup"))
)
if mibBuilder.loadTexts:
    hpicfChasPowerSupplyCompliance.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hpicfChassisMib": hpicfChassisMib,
       ...
       "hpicfChasPowerSupplyCompliance": hpicfChasPowerSupplyCompliance,
       ...
       "hpicfPowerSupplyGroup": hpicfPowerSupplyGroup,
       "hpicfPowerSupplyNotifyGroup": hpicfPowerSupplyNotifyGroup,
       ...
       "hpicfPowerSupplyTable": hpicfPowerSupplyTable,
       "hpicfPowerSupplyEntry": hpicfPowerSupplyEntry,
       "hpicfPowerSupplySlotNum": hpicfPowerSupplySlotNum,
       "hpicfPowerSupplyStatus": hpicfPowerSupplyStatus,
       "hpicfSensorTrap": hpicfSensorTrap,
       "hpicfPowerSupplyStatusTrap": hpicfPowerSupplyStatusTrap}
)
