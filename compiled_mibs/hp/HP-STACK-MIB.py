...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-STACK-MIB
...
class _HpStackMemberCount_Type(Integer32):
    """Custom type hpStackMemberCount based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_HpStackMemberCount_Type.__name__ = "Integer32"
_HpStackMemberCount_Object = MibScalar
hpStackMemberCount = _HpStackMemberCount_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 69, 1, 1, 7),
    _HpStackMemberCount_Type()
)
hpStackMemberCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpStackMemberCount.setStatus("current")


class _HpStackActiveMemberCount_Type(Integer32):
    """Custom type hpStackActiveMemberCount based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 10),
    )
...
_HpStackActiveMemberCount_Type.__name__ = "Integer32"
_HpStackActiveMemberCount_Object = MibScalar
hpStackActiveMemberCount = _HpStackActiveMemberCount_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 69, 1, 1, 8),
    _HpStackActiveMemberCount_Type()
)
hpStackActiveMemberCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpStackActiveMemberCount.setStatus("current")
...
if mibBuilder.loadTexts:
    hpStackConfigScalarGroup.setStatus("deprecated")
...
hpStackConfigScalarGroup1 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 69, 2, 2, 6)
)
hpStackConfigScalarGroup1.setObjects(
      *(("HP-STACK-MIB", "hpStackId"),
        ("HP-STACK-MIB", "hpStackOperStatus"),
        ("HP-STACK-MIB", "hpStackSetStacking"),
        ("HP-STACK-MIB", "hpStackTopology"),
        ...
        ("HP-STACK-MIB", "hpStackSwitchPreferredMemberId"),
        ("HP-STACK-MIB", "hpStackSplitPolicy"),
        ("HP-STACK-MIB", "hpStackMemberCount"),
        ("HP-STACK-MIB", "hpStackActiveMemberCount"))
)
if mibBuilder.loadTexts:
    hpStackConfigScalarGroup1.setStatus("current")
...
hpStackTopoChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 69, 0, 7)
)
hpStackTopoChange.setObjects(
      *(("HP-STACK-MIB", "hpStackMemberIdForTrap"),
        ("HP-STACK-MIB", "hpStackTopology"))
)
if mibBuilder.loadTexts:
    hpStackTopoChange.setStatus(
        "current"
    )
...
hpStackNotificationsGroup1 = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 69, 2, 2, 5)
)
hpStackNotificationsGroup1.setObjects(
      *(("HP-STACK-MIB", "hpStackPortChange"),
        ("HP-STACK-MIB", "hpStackCommanderChange"),
        ("HP-STACK-MIB", "hpStackMemberChange"),
        ("HP-STACK-MIB", "hpStackMemberStatusChange"),
        ("HP-STACK-MIB", "hpStackMergeFailed"),
        ("HP-STACK-MIB", "hpStackMergeSuccess"),
        ("HP-STACK-MIB", "hpStackTopoChange"))
)
if mibBuilder.loadTexts:
    hpStackNotificationsGroup1.setStatus(
        "current"
    )
...
hpStackCompliance.setObjects(
      *(("HP-STACK-MIB", "hpStackConfigScalarGroup"),
        ("HP-STACK-MIB", "hpStackMemberGroup"),
        ("HP-STACK-MIB", "hpStackPortGroup"),
        ("HP-STACK-MIB", "hpStackNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
hpStackCompliance1 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 69, 2, 1, 2)
)
hpStackCompliance1.setObjects(
      *(("HP-STACK-MIB", "hpStackConfigScalarGroup"),
        ("HP-STACK-MIB", "hpStackMemberGroup"),
        ("HP-STACK-MIB", "hpStackPortGroup"),
        ("HP-STACK-MIB", "hpStackNotificationsGroup1"))
)
if mibBuilder.loadTexts:
    hpStackCompliance1.setStatus(
        "deprecated"
    )

hpStackCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 69, 2, 1, 3)
)
hpStackCompliance2.setObjects(
      *(("HP-STACK-MIB", "hpStackConfigScalarGroup1"),
        ("HP-STACK-MIB", "hpStackMemberGroup"),
        ("HP-STACK-MIB", "hpStackPortGroup"),
        ("HP-STACK-MIB", "hpStackNotificationsGroup1"))
)
if mibBuilder.loadTexts:
    hpStackCompliance2.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hpStackMIB": hpStackMIB,
       ...
       "hpStackTopoChange": hpStackTopoChange,
       ...
       "hpStackMemberCount": hpStackMemberCount,
       "hpStackActiveMemberCount": hpStackActiveMemberCount,
       ...
       "hpStackCompliance1": hpStackCompliance1,
       "hpStackCompliance2": hpStackCompliance2,
       ...
       "hpStackNotificationsGroup1": hpStackNotificationsGroup1,
       "hpStackConfigScalarGroup1": hpStackConfigScalarGroup1}
)
