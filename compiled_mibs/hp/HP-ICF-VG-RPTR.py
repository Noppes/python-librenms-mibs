...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-VG-RPTR
...
hpicfVgRptrPreDot12Compliance.setObjects(
      *(("HP-ICF-VG-RPTR", "hpicfVgRptrPreDot12BasicGroup"),
        ("HP-ICF-VG-RPTR", "hpicfVgRptrPreDot12MonitorGroup"))
)
if mibBuilder.loadTexts:
...
hpicfVgRptrCompliance.setObjects(
      *(("HP-ICF-VG-RPTR", "hpicfVgRptrBasicGroup"),
        ("HP-ICF-VG-RPTR", "hpicfVgRptrMonitorGroup"),
        ("HP-ICF-VG-RPTR", "hpicfVgRptrXcvrGroup"),
        ("HP-ICF-VG-RPTR", "hpicfVgRptrBasicTraps"),
        ("HP-ICF-VG-RPTR", "hpicfVgRptrRedundantUplinkGroup"),
        ("HP-ICF-VG-RPTR", "hpicfVgRptrRedundantUplinkTraps"))
)
if mibBuilder.loadTexts:
