...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-SN-IGMP-MIB
...
snIgmpStaticGroupTable = _SnIgmpStaticGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 12, 2, 6, 1, 4)
)
if mibBuilder.loadTexts:
    snIgmpStaticGroupTable.setStatus("mandatory")
_SnIgmpStaticGroupEntry_Object = MibTableRow
snIgmpStaticGroupEntry = _SnIgmpStaticGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 12, 2, 6, 1, 4, 1)
)
snIgmpStaticGroupEntry.setIndexNames(
    (0, "HP-SN-IGMP-MIB", "snIgmpStaticGroupIfIndex"),
    (0, "HP-SN-IGMP-MIB", "snIgmpStaticGroupAddress"),
)
if mibBuilder.loadTexts:
    snIgmpStaticGroupEntry.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    snIgmpStaticGroupIfIndex.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    snIgmpStaticGroupAddress.setStatus("mandatory")
...
snIgmpStaticGroupPortList = _SnIgmpStaticGroupPortList_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 12, 2, 6, 1, 4, 1, 3),
    _SnIgmpStaticGroupPortList_Type()
)
snIgmpStaticGroupPortList.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    snIgmpStaticGroupPortList.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    snIgmpStaticGroupRowStatus.setStatus("mandatory")
