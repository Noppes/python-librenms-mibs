...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-PIM
...
_HpicfPimSPTThreshold_Type.__name__ = "Integer32"
...
_HpicfPimStaticRPSetOverride_Type.__name__ = "TruthValue"
...
_HpicfPimIfLanPruneDelay_Type.__name__ = "TruthValue"
...
_HpicfPimIfGenerationID_Type.__name__ = "TruthValue"
...
_HpicfPimIfJoinPruneHoldtime_Type.__name__ = "Unsigned32"
...
_HpicfPimIfSRTTLThreshold_Type.__name__ = "Unsigned32"
...
_HpicfPimIfDRPriority_Type.__name__ = "Unsigned32"
...
_HpicfPimRemoveConfig_Type.__name__ = "TruthValue"
...
hpicfPimSparseMIBCompliance.setObjects(
      *(("HP-ICF-PIM", "hpicfPimBaseGroup"),
        ("HP-ICF-PIM", "hpicfPimStaticRPSetMappingGroup"),
        ("HP-ICF-PIM", "hpicfPimSparseIfGroup"),
        ("HP-ICF-PIM", "hpicfPimComponentGroup"),
        ("HP-ICF-PIM", "hpicfPimStaticRpfGroup"))
)
if mibBuilder.loadTexts:
...
hpicfPimDenseMIBCompliance.setObjects(
      *(("HP-ICF-PIM", "hpicfPimBaseGroup"),
        ("HP-ICF-PIM", "hpicfPimDenseIfGroup"))
)
if mibBuilder.loadTexts:
...
hpicfPimNotificationCompliance.setObjects(
    ("HP-ICF-PIM", "hpicfPimNotificationGroup")
)
if mibBuilder.loadTexts:
...
hpicfPimUcastRoutingCompliance.setObjects(
      *(("HP-ICF-PIM", "hpicfPimStaticRpfExtensionsGroup"),
        ("HP-ICF-PIM", "hpicfPimUcastRouteGroup"))
)
if mibBuilder.loadTexts:
...
hpicfPimMcastRoutingCompliance.setObjects(
    ("HP-ICF-PIM", "hpicfPimMRouteGroup")
)
if mibBuilder.loadTexts:
...
hpicfPimInterfaceInfoCompliance.setObjects(
      *(("HP-ICF-PIM", "hpicfPimNeighborGroup"),
        ("HP-ICF-PIM", "hpicfPimInterfaceExtensionsGroup"))
)
if mibBuilder.loadTexts:
...
hpicfPimProtoMessageCompliance.setObjects(
      *(("HP-ICF-PIM", "hpicfPimUnackGraftsGroup"),
        ("HP-ICF-PIM", "hpicfPimJoinPruneGroup"))
)
if mibBuilder.loadTexts:
...
hpicfPimGlobalCountersCompliance.setObjects(
    ("HP-ICF-PIM", "hpicfPimGlobalCounterGroup")
)
if mibBuilder.loadTexts:
...
hpicfPimRPSetExtensionsCompliance.setObjects(
    ("HP-ICF-PIM", "hpicfPimRPSetGroup")
)
if mibBuilder.loadTexts:
