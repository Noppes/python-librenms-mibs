...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-DOWNLOAD
...
hpicfDownloadCompliance.setObjects(
      *(("HP-ICF-DOWNLOAD", "hpicfDownloadGroup"),
        ("HP-ICF-DOWNLOAD", "hpicfDownloadLogGroup"))
)
if mibBuilder.loadTexts:
...
hpicfDownloadConfigCompliance.setObjects(
      *(("HP-ICF-DOWNLOAD", "hpicfDownloadConfigGroup"),
        ("HP-ICF-DOWNLOAD", "hpicfDownloadLogGroup"))
)
if mibBuilder.loadTexts:
...
hpicfDownloadConfigInetCompliance.setObjects(
      *(("HP-ICF-DOWNLOAD", "hpicfDownloadConfigInetGroup"),
        ("HP-ICF-DOWNLOAD", "hpicfDownloadLogGroup"))
)
if mibBuilder.loadTexts:
...
hpicfDownloadAutoTftpCompliance.setObjects(
    ("HP-ICF-DOWNLOAD", "hpicfDownloadAutoTftpGroup")
)
if mibBuilder.loadTexts:
...
hpicfDownloadConfigInetCompliance1.setObjects(
    ("HP-ICF-DOWNLOAD", "hpicfDownloadConfigOtherGroup")
)
if mibBuilder.loadTexts:
...
hpicfDownloadConfigInetCompliance2.setObjects(
    ("HP-ICF-DOWNLOAD", "hpicfDownloadConfigOtherGroup1")
)
if mibBuilder.loadTexts:
...
hpicfDownloadConfigInetCompliance3.setObjects(
    ("HP-ICF-DOWNLOAD", "hpicfDownloadConfigOtherGroup2")
)
if mibBuilder.loadTexts:
...
hpicfDownloadConfigInetCompliance4.setObjects(
    ("HP-ICF-DOWNLOAD", "hpicfDownloadConfigOtherGroup3")
)
if mibBuilder.loadTexts:
