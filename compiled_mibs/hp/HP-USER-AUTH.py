...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-USER-AUTH
...
_HpicfUsrAuthWMAeWAServerIPAddressType_Type.__name__ = "InetAddressType"
...
_HpicfUsrAuthRedirectServerClientTimeout_Type.__name__ = "Integer32"
...
_HpicfUsrAuthCacheCredTimeOut_Type.__name__ = "Integer32"
...
_HpicfUsrAuthUseLLDPData_Type.__name__ = "TruthValue"
...
class _HpicfUsrAuthStationIdFormat_Type(Integer32):
    """Custom type hpicfUsrAuthStationIdFormat based on Integer32"""
    defaultValue = 1
...
_HpicfUsrAuthStationIdFormat_Type.__name__ = "Integer32"
_HpicfUsrAuthStationIdFormat_Object = MibScalar
hpicfUsrAuthStationIdFormat = _HpicfUsrAuthStationIdFormat_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 1, 32),
    _HpicfUsrAuthStationIdFormat_Type()
)
hpicfUsrAuthStationIdFormat.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfUsrAuthStationIdFormat.setStatus("current")
...
_HpicfUsrAuthLLDPBypassAdminStatus_Type.__name__ = "TruthValue"
...
_HpicfUsrAuthOrderPortEntry_Object = MibTableRow
hpicfUsrAuthOrderPortEntry = _HpicfUsrAuthOrderPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 2, 1, 2)
)
hpicfUsrAuthOrderPortEntry.setIndexNames(
    (0, "HP-USER-AUTH", "hpicfUsrAuthPortNumber"),
)
if mibBuilder.loadTexts:
    hpicfUsrAuthOrderPortEntry.setStatus("current")


class _HpicfUsrAuthOrderFirst_Type(Integer32):
    """Custom type hpicfUsrAuthOrderFirst based on Integer32"""
    defaultValue = 0
...
_HpicfUsrAuthOrderFirst_Type.__name__ = "Integer32"
_HpicfUsrAuthOrderFirst_Object = MibTableColumn
hpicfUsrAuthOrderFirst = _HpicfUsrAuthOrderFirst_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 2, 1, 2, 1),
    _HpicfUsrAuthOrderFirst_Type()
)
hpicfUsrAuthOrderFirst.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfUsrAuthOrderFirst.setStatus("current")


class _HpicfUsrAuthOrderSecond_Type(Integer32):
    """Custom type hpicfUsrAuthOrderSecond based on Integer32"""
    defaultValue = 0
...
_HpicfUsrAuthOrderSecond_Type.__name__ = "Integer32"
_HpicfUsrAuthOrderSecond_Object = MibTableColumn
hpicfUsrAuthOrderSecond = _HpicfUsrAuthOrderSecond_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 2, 1, 2, 2),
    _HpicfUsrAuthOrderSecond_Type()
)
hpicfUsrAuthOrderSecond.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfUsrAuthOrderSecond.setStatus("current")


class _HpicfUsrAuthOrderLmaFallback_Type(TruthValue):
    """Custom type hpicfUsrAuthOrderLmaFallback based on TruthValue"""
    defaultValue = 2


_HpicfUsrAuthOrderLmaFallback_Type.__name__ = "TruthValue"
_HpicfUsrAuthOrderLmaFallback_Object = MibTableColumn
hpicfUsrAuthOrderLmaFallback = _HpicfUsrAuthOrderLmaFallback_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 2, 1, 2, 3),
    _HpicfUsrAuthOrderLmaFallback_Type()
)
hpicfUsrAuthOrderLmaFallback.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfUsrAuthOrderLmaFallback.setStatus("current")


class _HpicfUsrAuthPriorityFirst_Type(Integer32):
    """Custom type hpicfUsrAuthPriorityFirst based on Integer32"""
    defaultValue = 0
...
_HpicfUsrAuthPriorityFirst_Type.__name__ = "Integer32"
_HpicfUsrAuthPriorityFirst_Object = MibTableColumn
hpicfUsrAuthPriorityFirst = _HpicfUsrAuthPriorityFirst_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 2, 1, 2, 4),
    _HpicfUsrAuthPriorityFirst_Type()
)
hpicfUsrAuthPriorityFirst.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfUsrAuthPriorityFirst.setStatus("current")


class _HpicfUsrAuthPrioritySecond_Type(Integer32):
    """Custom type hpicfUsrAuthPrioritySecond based on Integer32"""
    defaultValue = 0
...
_HpicfUsrAuthPrioritySecond_Type.__name__ = "Integer32"
_HpicfUsrAuthPrioritySecond_Object = MibTableColumn
hpicfUsrAuthPrioritySecond = _HpicfUsrAuthPrioritySecond_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 2, 1, 2, 5),
    _HpicfUsrAuthPrioritySecond_Type()
)
hpicfUsrAuthPrioritySecond.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfUsrAuthPrioritySecond.setStatus("current")
_HpicfUsrAuthBypassPortTable_Object = MibTable
hpicfUsrAuthBypassPortTable = _HpicfUsrAuthBypassPortTable_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 2, 2)
)
if mibBuilder.loadTexts:
    hpicfUsrAuthBypassPortTable.setStatus("current")
_HpicfUsrAuthBypassPortEntry_Object = MibTableRow
hpicfUsrAuthBypassPortEntry = _HpicfUsrAuthBypassPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 2, 2, 1)
)
hpicfUsrAuthBypassPortEntry.setIndexNames(
    (0, "HP-USER-AUTH", "hpicfUsrAuthPortNumber"),
)
if mibBuilder.loadTexts:
    hpicfUsrAuthBypassPortEntry.setStatus("current")


class _HpicfUsrAuthBypassAdminStatus_Type(TruthValue):
    """Custom type hpicfUsrAuthBypassAdminStatus based on TruthValue"""
    defaultValue = 2


_HpicfUsrAuthBypassAdminStatus_Type.__name__ = "TruthValue"
_HpicfUsrAuthBypassAdminStatus_Object = MibTableColumn
hpicfUsrAuthBypassAdminStatus = _HpicfUsrAuthBypassAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 2, 2, 1, 1),
    _HpicfUsrAuthBypassAdminStatus_Type()
)
hpicfUsrAuthBypassAdminStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfUsrAuthBypassAdminStatus.setStatus("current")


class _HpicfUsrAuthDeviceIdentityName_Type(OctetString):
    """Custom type hpicfUsrAuthDeviceIdentityName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_HpicfUsrAuthDeviceIdentityName_Type.__name__ = "OctetString"
_HpicfUsrAuthDeviceIdentityName_Object = MibTableColumn
hpicfUsrAuthDeviceIdentityName = _HpicfUsrAuthDeviceIdentityName_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 2, 2, 1, 2),
    _HpicfUsrAuthDeviceIdentityName_Type()
)
hpicfUsrAuthDeviceIdentityName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfUsrAuthDeviceIdentityName.setStatus("current")
...
_HpicfUsrAuthMacPin_Type.__name__ = "TruthValue"
...
_HpicfMacAuthRetainUnauthClients_Type.__name__ = "TruthValue"
...
class _HpicfMacAuthRadiusServer_Type(OctetString):
    """Custom type hpicfMacAuthRadiusServer based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_HpicfMacAuthRadiusServer_Type.__name__ = "OctetString"
_HpicfMacAuthRadiusServer_Object = MibTableColumn
hpicfMacAuthRadiusServer = _HpicfMacAuthRadiusServer_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 4, 1, 1, 15),
    _HpicfMacAuthRadiusServer_Type()
)
hpicfMacAuthRadiusServer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfMacAuthRadiusServer.setStatus("current")


class _HpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy_Type(TruthValue):
    """Custom type hpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy based on TruthValue"""
    defaultValue = 2


_HpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy_Type.__name__ = "TruthValue"
_HpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy_Object = MibTableColumn
hpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy = _HpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 4, 1, 1, 16),
    _HpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy_Type()
)
hpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy.setStatus("current")
...
_HpicfUsrAuthMacAuthSessionUsrNumberCnt_Type.__name__ = "Counter32"
...
_HpicfUsrAuthLastLoginDeleteAll_Type.__name__ = "TruthValue"
...
_HpicfUsrAuthCaptivePortalConfigEnabled_Type.__name__ = "TruthValue"
...
if mibBuilder.loadTexts:
    hpicfUsrAuthSystemGroup.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    hpicfUsrAuthPortsGroup2.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    hpicfUsrAuthMacAuthConfigGroup3.setStatus("deprecated")

hpicfUsrAuthPortsGroup3 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 2, 23)
)
hpicfUsrAuthPortsGroup3.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthPortNumber"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthAdminStatus"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthAdminStatus"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortReauthenticate"),
...
if mibBuilder.loadTexts:
    hpicfUsrAuthPortsGroup3.setStatus("current")

hpicfUsrAuthMacAuthConfigGroup4 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 2, 24)
)
hpicfUsrAuthMacAuthConfigGroup4.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthMacAuthClientLimit"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthClientMoves"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthQuietPeriod"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthServerTimeout"),
        ...
        ("HP-USER-AUTH", "hpicfUsrAuthMacPin"),
        ("HP-USER-AUTH", "hpicfMacAuthRetainUnauthClients"),
        ("HP-USER-AUTH", "hpicfMacAuthRadiusServer"))
)
if mibBuilder.loadTexts:
    hpicfUsrAuthMacAuthConfigGroup4.setStatus("deprecated")

hpicfUsrAuthBypassPortsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 2, 25)
)
hpicfUsrAuthBypassPortsGroup.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthBypassAdminStatus"),
        ("HP-USER-AUTH", "hpicfUsrAuthDeviceIdentityName"))
)
if mibBuilder.loadTexts:
    hpicfUsrAuthBypassPortsGroup.setStatus("current")

hpicfUsrAuthOrderPortsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 2, 26)
)
hpicfUsrAuthOrderPortsGroup.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthOrderFirst"),
        ("HP-USER-AUTH", "hpicfUsrAuthOrderSecond"),
        ("HP-USER-AUTH", "hpicfUsrAuthOrderLmaFallback"),
        ("HP-USER-AUTH", "hpicfUsrAuthPriorityFirst"),
        ("HP-USER-AUTH", "hpicfUsrAuthPrioritySecond"))
)
if mibBuilder.loadTexts:
    hpicfUsrAuthOrderPortsGroup.setStatus("current")

hpicfUsrAuthMacAuthConfigGroup5 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 2, 27)
)
hpicfUsrAuthMacAuthConfigGroup5.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthMacAuthClientLimit"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthClientMoves"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthQuietPeriod"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthServerTimeout"),
        ...
        ("HP-USER-AUTH", "hpicfMacAuthRetainUnauthClients"),
        ("HP-USER-AUTH", "hpicfMacAuthRadiusServer"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy"))
)
if mibBuilder.loadTexts:
    hpicfUsrAuthMacAuthConfigGroup5.setStatus("current")

hpicfUsrAuthSystemGroup1 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 2, 28)
)
hpicfUsrAuthSystemGroup1.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthWebAuthDhcpBaseAddress"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthDhcpMask"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthDhcpLease"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthAddrFormat"),
        ...
        ("HP-USER-AUTH", "hpicfUsrAuthCacheCredTimeOut"),
        ("HP-USER-AUTH", "hpicfUsrAuthUseLLDPData"),
        ("HP-USER-AUTH", "hpicfUsrAuthStationIdFormat"))
)
if mibBuilder.loadTexts:
    hpicfUsrAuthSystemGroup1.setStatus("current")
...
hpicfUsrAuthCompliance.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthConfigGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup"),
...
hpicfUsrAuthCompliance1.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthConfigGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup"))
)
if mibBuilder.loadTexts:
...
hpicfUsrAuthCompliance2.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthConfigGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup2"))
)
if mibBuilder.loadTexts:
...
hpicfUsrAuthCompliance3.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthRedirectServerGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWMAeWAServerGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthClientReauthenticateGroup"))
)
if mibBuilder.loadTexts:
...
hpicfUsrAuthCompliance4.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthMacGroup"),
        ("HP-USER-AUTH", "hpicfNotifcationConfigDataGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthNotificationGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthAccessDeniedGroup"))
)
if mibBuilder.loadTexts:
...
hpicfUsrAuthCompliance5.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup1"))
)
if mibBuilder.loadTexts:
...
hpicfUsrAuthCompliance6.setObjects(
    ("HP-USER-AUTH", "hpicfUsrAuthMacAuthUsrNumberGroup")
)
if mibBuilder.loadTexts:
...
hpicfUsrAuthCompliance7.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacGroup"),
        ...
        ("HP-USER-AUTH", "hpicfUsrAuthRedirectServerGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWMAeWAServerGroup"),
        ("HP-USER-AUTH", "hpicfNotificationConfigDataGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthLastLoginGroup"))
)
if mibBuilder.loadTexts:
...
hpicfUsrAuthCompliance8.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthConfigGroup1"),
...
hpicfUsrAuthCompliance9.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacGroup"),
        ...
        ("HP-USER-AUTH", "hpicfNotificationConfigDataGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthLastLoginGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthCaptivePortalGroup"))
)
if mibBuilder.loadTexts:
...
hpicfUsrAuthCompliance10.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacGroup"),
        ...
        ("HP-USER-AUTH", "hpicfUsrAuthLastLoginGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthCaptivePortalGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthCaptivePortalProfileGroup"))
)
if mibBuilder.loadTexts:
...
hpicfUsrAuthCompliance11.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthConfigGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup2"))
)
if mibBuilder.loadTexts:
...
hpicfUsrAuthCompliance12.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthConfigGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup2"))
...
hpicfUsrAuthCompliance13.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthMacGroup1"),
        ("HP-USER-AUTH", "hpicfNotifcationConfigDataGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthNotificationGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthAccessDeniedGroup"))
)
...
hpicfUsrAuthCompliance14.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacGroup1"),
...
hpicfUsrAuthCompliance15.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthConfigGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup3"))
)
if mibBuilder.loadTexts:
...
hpicfUsrAuthCompliance16.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup3"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacGroup1"),
...
hpicfUsrAuthCompliance17 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 4, 18)
)
hpicfUsrAuthCompliance17.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup3"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthConfigGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup3"))
...
if mibBuilder.loadTexts:
    hpicfUsrAuthCompliance17.setStatus(
        "deprecated"
    )

hpicfUsrAuthCompliance18 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 4, 19)
)
hpicfUsrAuthCompliance18.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup4"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthConfigGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup1"),
...
if mibBuilder.loadTexts:
    hpicfUsrAuthCompliance18.setStatus(
        "deprecated"
    )

hpicfUsrAuthCompliance19 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 4, 20)
)
hpicfUsrAuthCompliance19.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup3"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup2"),
...
if mibBuilder.loadTexts:
    hpicfUsrAuthCompliance19.setStatus(
        "deprecated"
    )

hpicfUsrAuthCompliance20 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 4, 21)
)
hpicfUsrAuthCompliance20.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup3"),
        ("HP-USER-AUTH", "hpicfUsrAuthBypassPortsGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthConfigGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup4"))
...
if mibBuilder.loadTexts:
    hpicfUsrAuthCompliance20.setStatus(
        "deprecated"
    )

hpicfUsrAuthCompliance21 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 4, 22)
)
hpicfUsrAuthCompliance21.setObjects(
    ("HP-USER-AUTH", "hpicfUsrAuthOrderPortsGroup")
)
if mibBuilder.loadTexts:
    hpicfUsrAuthCompliance21.setStatus(
        "current"
    )

hpicfUsrAuthCompliance22 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 4, 23)
)
hpicfUsrAuthCompliance22.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup5"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthConfigGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup1"),
...
if mibBuilder.loadTexts:
    hpicfUsrAuthCompliance22.setStatus(
        "deprecated"
    )

hpicfUsrAuthCompliance23 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 4, 24)
)
hpicfUsrAuthCompliance23.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup3"),
        ("HP-USER-AUTH", "hpicfUsrAuthBypassPortsGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup2"),
...
if mibBuilder.loadTexts:
    hpicfUsrAuthCompliance23.setStatus(
        "deprecated"
    )

hpicfUsrAuthCompliance24 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 4, 25)
)
hpicfUsrAuthCompliance24.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup2"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthConfigGroup5"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthMacAuthSessionStatsGroup1"),
...
if mibBuilder.loadTexts:
    hpicfUsrAuthCompliance24.setStatus(
        "current"
    )

hpicfUsrAuthCompliance25 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 19, 7, 4, 26)
)
hpicfUsrAuthCompliance25.setObjects(
      *(("HP-USER-AUTH", "hpicfUsrAuthSystemGroup1"),
        ("HP-USER-AUTH", "hpicfUsrAuthPortsGroup3"),
        ("HP-USER-AUTH", "hpicfUsrAuthBypassPortsGroup"),
        ("HP-USER-AUTH", "hpicfUsrAuthWebAuthSessionStatsGroup2"),
...
if mibBuilder.loadTexts:
    hpicfUsrAuthCompliance25.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hpicfUsrAuthMIB": hpicfUsrAuthMIB,
       ...
       "hpicfUsrAuthStationIdFormat": hpicfUsrAuthStationIdFormat,
       ...
       "hpicfUsrAuthOrderPortEntry": hpicfUsrAuthOrderPortEntry,
       "hpicfUsrAuthOrderFirst": hpicfUsrAuthOrderFirst,
       "hpicfUsrAuthOrderSecond": hpicfUsrAuthOrderSecond,
       "hpicfUsrAuthOrderLmaFallback": hpicfUsrAuthOrderLmaFallback,
       "hpicfUsrAuthPriorityFirst": hpicfUsrAuthPriorityFirst,
       "hpicfUsrAuthPrioritySecond": hpicfUsrAuthPrioritySecond,
       "hpicfUsrAuthBypassPortTable": hpicfUsrAuthBypassPortTable,
       "hpicfUsrAuthBypassPortEntry": hpicfUsrAuthBypassPortEntry,
       "hpicfUsrAuthBypassAdminStatus": hpicfUsrAuthBypassAdminStatus,
       "hpicfUsrAuthDeviceIdentityName": hpicfUsrAuthDeviceIdentityName,
       ...
       "hpicfMacAuthRadiusServer": hpicfMacAuthRadiusServer,
       "hpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy": hpicfUsrAuthMacAuthUnauthVidLLDPNwkPolicy,
       ...
       "hpicfUsrAuthPortsGroup3": hpicfUsrAuthPortsGroup3,
       "hpicfUsrAuthMacAuthConfigGroup4": hpicfUsrAuthMacAuthConfigGroup4,
       "hpicfUsrAuthBypassPortsGroup": hpicfUsrAuthBypassPortsGroup,
       "hpicfUsrAuthOrderPortsGroup": hpicfUsrAuthOrderPortsGroup,
       "hpicfUsrAuthMacAuthConfigGroup5": hpicfUsrAuthMacAuthConfigGroup5,
       "hpicfUsrAuthSystemGroup1": hpicfUsrAuthSystemGroup1,
       ...
       "hpicfUsrAuthCompliance17": hpicfUsrAuthCompliance17,
       "hpicfUsrAuthCompliance18": hpicfUsrAuthCompliance18,
       "hpicfUsrAuthCompliance19": hpicfUsrAuthCompliance19,
       "hpicfUsrAuthCompliance20": hpicfUsrAuthCompliance20,
       "hpicfUsrAuthCompliance21": hpicfUsrAuthCompliance21,
       "hpicfUsrAuthCompliance22": hpicfUsrAuthCompliance22,
       "hpicfUsrAuthCompliance23": hpicfUsrAuthCompliance23,
       "hpicfUsrAuthCompliance24": hpicfUsrAuthCompliance24,
       "hpicfUsrAuthCompliance25": hpicfUsrAuthCompliance25,
