...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ENTITY-MIB
...
hpEntityCompliance.setObjects(
      *(("HP-ENTITY-MIB", "hpEntityPhysicalGroup"),
        ("HP-ENTITY-MIB", "hpEntityLogicalGroup"),
        ("HP-ENTITY-MIB", "hpEntityMappingGroup"),
        ("HP-ENTITY-MIB", "hpEntityGeneralGroup"),
        ("HP-ENTITY-MIB", "hpEntityNotificationsGroup"))
)
if mibBuilder.loadTexts:
