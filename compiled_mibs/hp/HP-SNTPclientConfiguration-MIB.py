...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-SNTPclientConfiguration-MIB
...
_HpSntpInetServerIsOobm_Type.__name__ = "TruthValue"
...
hpSntpConfigCompliance.setObjects(
      *(("HP-SNTPclientConfiguration-MIB", "hpSntpConfigGroup"),
        ("HP-SNTPclientConfiguration-MIB", "hpSntpServerConfigGroup"),
        ("HP-SNTPclientConfiguration-MIB", "hpTimeSyncMethodGroup"))
)
if mibBuilder.loadTexts:
...
hpSntpInetConfigCompliance.setObjects(
      *(("HP-SNTPclientConfiguration-MIB", "hpSntpConfigGroup"),
        ("HP-SNTPclientConfiguration-MIB", "hpSntpInetServerConfigGroup"),
        ("HP-SNTPclientConfiguration-MIB", "hpTimeSyncMethodGroup"))
)
if mibBuilder.loadTexts:
...
hpSntpAuthenticationConfigCompliance.setObjects(
      *(("HP-SNTPclientConfiguration-MIB", "hpSntpInetServerConfigGroup"),
        ("HP-SNTPclientConfiguration-MIB", "hpSntpAuthenticationKeyIdConfigGroup"))
)
if mibBuilder.loadTexts:
...
hpSntpInetConfigComplianceOobm.setObjects(
    ("HP-SNTPclientConfiguration-MIB", "hpSntpInetServerOobmGroup")
)
if mibBuilder.loadTexts:
...
hpSntpAuthenticationConfigCompliance1.setObjects(
      *(("HP-SNTPclientConfiguration-MIB", "hpSntpInetServerConfigGroup"),
        ("HP-SNTPclientConfiguration-MIB", "hpSntpAuthenticationKeyIdConfigGroup1"))
)
if mibBuilder.loadTexts:
...
hpSntpBroadcastServerCompliance.setObjects(
    ("HP-SNTPclientConfiguration-MIB", "hpSntpBroadcastServerGroup")
)
if mibBuilder.loadTexts:
