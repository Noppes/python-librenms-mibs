...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-INST-MON
...
_HpicfInstMonLogEnable_Type.__name__ = "TruthValue"
...
_HpicfInstMonTrapEnable_Type.__name__ = "TruthValue"
...
_HpicfInstConfig_Type.__name__ = "TruthValue"
...
hpicfInstMonBaseCompliance.setObjects(
    ("HP-ICF-INST-MON", "hpicfInstMonBaseGroup")
)
if mibBuilder.loadTexts:
...
hpicfInstConfigCompliance.setObjects(
    ("HP-ICF-INST-MON", "hpicfInstConfigGroup")
)
if mibBuilder.loadTexts:
...
hpicfInstMonNotifyCompliance.setObjects(
    ("HP-ICF-INST-MON", "hpicfInstMonNotifyGroup")
)
if mibBuilder.loadTexts:
