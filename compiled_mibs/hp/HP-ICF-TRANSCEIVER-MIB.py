...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-TRANSCEIVER-MIB
...
hpicfXcvrCompliance.setObjects(
    ("HP-ICF-TRANSCEIVER-MIB", "hpicfXcvrInfoGroup")
)
if mibBuilder.loadTexts:
...
hpicfXcvrCompliance1.setObjects(
    ("HP-ICF-TRANSCEIVER-MIB", "hpicfXcvrInfoGroup1")
)
if mibBuilder.loadTexts:
...
hpicfXcvrCompliance2.setObjects(
    ("HP-ICF-TRANSCEIVER-MIB", "hpicfXcvrInfoGroup2")
)
if mibBuilder.loadTexts:
...
hpicfXcvrChannelCompliance.setObjects(
    ("HP-ICF-TRANSCEIVER-MIB", "hpicfXcvrChannelInfoGroup")
)
if mibBuilder.loadTexts:
