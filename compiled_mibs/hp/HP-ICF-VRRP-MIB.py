...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-VRRP-MIB
...
_HpicfVrrpAdminStatus_Type.__name__ = "TruthValue"
...
_HpicfVrrpVrMasterPreempt_Type.__name__ = "TruthValue"
...
_HpicfVrrpVrTransferControl_Type.__name__ = "TruthValue"
...
_HpicfVrrpVrRespondToPing_Type.__name__ = "TruthValue"
...
class _HpicfVrrpVrMainPreempt_Type(TruthValue):
    """Custom type hpicfVrrpVrMainPreempt based on TruthValue"""
    defaultValue = 2


_HpicfVrrpVrMainPreempt_Type.__name__ = "TruthValue"
_HpicfVrrpVrMainPreempt_Object = MibTableColumn
hpicfVrrpVrMainPreempt = _HpicfVrrpVrMainPreempt_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 31, 1, 2, 1, 7),
    _HpicfVrrpVrMainPreempt_Type()
)
hpicfVrrpVrMainPreempt.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpicfVrrpVrMainPreempt.setStatus("current")
...
_HpicfVrrpAssoIpMask_Type.__name__ = "IpAddress"
...
_HpicfVrrpStatsNearFailovers_Type.__name__ = "Counter32"
...
_HpicfVrrpRespondToPing_Type.__name__ = "TruthValue"
...
_HpicfVrrpRemoveConfig_Type.__name__ = "TruthValue"
...
_HpicfVrrpNonstop_Type.__name__ = "TruthValue"
...
if mibBuilder.loadTexts:
    hpicfVrrpOperGroup1.setStatus("deprecated")
...
hpicfVrrpOperGroup2 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 31, 2, 2, 9)
)
hpicfVrrpOperGroup2.setObjects(
      *(("HP-ICF-VRRP-MIB", "hpicfVrrpVrMode"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpVrMasterPreempt"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpVrTransferControl"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpVrPreemptDelayTime"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpAssoIpMask"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpVrMainPreempt"))
)
if mibBuilder.loadTexts:
    hpicfVrrpOperGroup2.setStatus("current")
...
hpicfVrrpMIBCompliance.setObjects(
      *(("HP-ICF-VRRP-MIB", "hpicfVrrpOperGroup"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpOperGroup"))
)
if mibBuilder.loadTexts:
...
hpicfVrrpMIBCompliance1.setObjects(
      *(("HP-ICF-VRRP-MIB", "hpicfVrrpOperGroup"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpTrackGroup"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpOperGroup"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpTrackGroup"))
)
if mibBuilder.loadTexts:
...
hpicfVrrpMIBCompliance2.setObjects(
      *(("HP-ICF-VRRP-MIB", "hpicfVrrpVrPingGroup"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpVrPingGroup"))
)
if mibBuilder.loadTexts:
...
hpicfVrrpMIBCompliance3.setObjects(
      *(("HP-ICF-VRRP-MIB", "hpicfVrrpNonstopGroup"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpNonstopGroup"))
)
if mibBuilder.loadTexts:
...
hpicfVrrpMIBCompliance4.setObjects(
    ("HP-ICF-VRRP-MIB", "hpicfVrrpOperationsGroup")
)
if mibBuilder.loadTexts:
...
hpicfVrrpMIBCompliance5.setObjects(
      *(("HP-ICF-VRRP-MIB", "hpicfVrrpOperGroup"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpTrackGroup1"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpOperGroup"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpTrackGroup1"))
)
if mibBuilder.loadTexts:
...
hpicfVrrpMIBCompliance6.setObjects(
      *(("HP-ICF-VRRP-MIB", "hpicfVrrpOperGroup1"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpTrackGroup1"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpOperGroup1"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpTrackGroup1"))
)
...
hpicfVrrpMIBCompliance7.setObjects(
    ("HP-ICF-VRRP-MIB", "hpicfVrrpOperationsGroup1")
)
if mibBuilder.loadTexts:
...
hpicfVrrpMIBCompliance8 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 31, 2, 1, 9)
)
hpicfVrrpMIBCompliance8.setObjects(
      *(("HP-ICF-VRRP-MIB", "hpicfVrrpOperGroup2"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpTrackGroup1"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpOperGroup2"),
        ("HP-ICF-VRRP-MIB", "hpicfVrrpTrackGroup1"))
)
if mibBuilder.loadTexts:
    hpicfVrrpMIBCompliance8.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hpicfVrrpMIB": hpicfVrrpMIB,
       ...
       "hpicfVrrpVrMainPreempt": hpicfVrrpVrMainPreempt,
       ...
       "hpicfVrrpMIBCompliance8": hpicfVrrpMIBCompliance8,
       ...
       "hpicfVrrpOperGroup2": hpicfVrrpOperGroup2}
)
