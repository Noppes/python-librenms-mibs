...
# Notes
# -----
# ASN.1 source file://mibs\hp\ICF-VG-RPTR
...
icfVgRptrPreStdCompliance.setObjects(
      *(("ICF-VG-RPTR", "icfVgRptrBasicGroup"),
        ("ICF-VG-RPTR", "icfVgRptrPreStdMonitorGroup"),
        ("ICF-VG-RPTR", "icfVgRptrPreStdAddrTrackGroup"),
        ("ICF-VG-RPTR", "icfVgRptrNotificationsGroup"))
)
if mibBuilder.loadTexts:
...
icfVgRptrCompliance.setObjects(
      *(("ICF-VG-RPTR", "icfVgRptrBasicGroup"),
        ("ICF-VG-RPTR", "icfVgRptrMonitorGroup"),
        ("ICF-VG-RPTR", "icfVgRptrAddrTrackGroup"),
        ("ICF-VG-RPTR", "icfVgRptrNotificationsGroup"))
)
if mibBuilder.loadTexts:
