...
# Notes
# -----
# ASN.1 source file://mibs\hp\CPQIDA-MIB
...
class _CpqDaCntlrOperatingMode_Type(Integer32):
    """Custom type cpqDaCntlrOperatingMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqDaCntlrOperatingMode_Type.__name__ = "Integer32"
_CpqDaCntlrOperatingMode_Object = MibTableColumn
cpqDaCntlrOperatingMode = _CpqDaCntlrOperatingMode_Object(
    (1, 3, 6, 1, 4, 1, 232, 3, 2, 2, 1, 1, 43),
    _CpqDaCntlrOperatingMode_Type()
)
cpqDaCntlrOperatingMode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqDaCntlrOperatingMode.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"cpqDa2LogDrvStatusChange": cpqDa2LogDrvStatusChange,
       ...
       "cpqDaCntlrOperatingMode": cpqDaCntlrOperatingMode,
