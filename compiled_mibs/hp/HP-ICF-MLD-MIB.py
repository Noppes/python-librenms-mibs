...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-MLD-MIB
...
_HpicfMldControlUnknownMulticast_Type.__name__ = "TruthValue"
...
_HpicfMldIfEntryQuerierFeature_Type.__name__ = "TruthValue"
...
_HpicfMldIfEntrySnoopingFeature_Type.__name__ = "TruthValue"
...
_HpicfMldIfEntryStrictVersionMode_Type.__name__ = "TruthValue"
...
_HpicfMldCacheSelf_Type.__name__ = "TruthValue"
...
_HpicfMldReload_Type.__name__ = "TruthValue"
...
class _HpicfMldSendRouterAlertOption_Type(Integer32):
    """Custom type hpicfMldSendRouterAlertOption based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_HpicfMldSendRouterAlertOption_Type.__name__ = "Integer32"
_HpicfMldSendRouterAlertOption_Object = MibScalar
hpicfMldSendRouterAlertOption = _HpicfMldSendRouterAlertOption_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 48, 1, 1, 16),
    _HpicfMldSendRouterAlertOption_Type()
)
hpicfMldSendRouterAlertOption.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfMldSendRouterAlertOption.setStatus("current")
_HpicfMldMcastGrpLinkLocalJoinCnt_Type = Integer32
_HpicfMldMcastGrpLinkLocalJoinCnt_Object = MibScalar
hpicfMldMcastGrpLinkLocalJoinCnt = _HpicfMldMcastGrpLinkLocalJoinCnt_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 48, 1, 1, 17),
    _HpicfMldMcastGrpLinkLocalJoinCnt_Type()
)
hpicfMldMcastGrpLinkLocalJoinCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hpicfMldMcastGrpLinkLocalJoinCnt.setStatus("current")
...
if mibBuilder.loadTexts:
    hpicfMldBaseGroup.setStatus("deprecated")
...
if mibBuilder.loadTexts:
    hpicfMldBaseGroupV2.setStatus("deprecated")
...
hpicfMldBaseGroupV3 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 48, 2, 1, 14)
)
hpicfMldBaseGroupV3.setObjects(
      *(("HP-ICF-MLD-MIB", "hpicfMldControlUnknownMulticast"),
        ("HP-ICF-MLD-MIB", "hpicfMldConfigForcedLeaveInterval"),
        ("HP-ICF-MLD-MIB", "hpicfMldEnabledCount"),
        ("HP-ICF-MLD-MIB", "hpicfMldMcastGroupJoinsCount"),
        ...
        ("HP-ICF-MLD-MIB", "hpicfMldMcastIncludeGroupJoinsCount"),
        ("HP-ICF-MLD-MIB", "hpicfMldMcastPortFastLearn"),
        ("HP-ICF-MLD-MIB", "hpicfMldSendRouterAlertOption"))
)
if mibBuilder.loadTexts:
    hpicfMldBaseGroupV3.setStatus("deprecated")

hpicfMldBaseGroupV4 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 48, 2, 1, 15)
)
hpicfMldBaseGroupV4.setObjects(
      *(("HP-ICF-MLD-MIB", "hpicfMldControlUnknownMulticast"),
        ("HP-ICF-MLD-MIB", "hpicfMldConfigForcedLeaveInterval"),
        ("HP-ICF-MLD-MIB", "hpicfMldEnabledCount"),
        ("HP-ICF-MLD-MIB", "hpicfMldMcastGroupJoinsCount"),
        ...
        ("HP-ICF-MLD-MIB", "hpicfMldMcastPortFastLearn"),
        ("HP-ICF-MLD-MIB", "hpicfMldSendRouterAlertOption"),
        ("HP-ICF-MLD-MIB", "hpicfMldMcastGrpLinkLocalJoinCnt"))
)
if mibBuilder.loadTexts:
    hpicfMldBaseGroupV4.setStatus("current")
...
hpicfMldMIBCompliance.setObjects(
      *(("HP-ICF-MLD-MIB", "hpicfMldBaseGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldIfGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldCacheGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldPortGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldFilteredGroupPortCacheGroup"))
)
if mibBuilder.loadTexts:
...
hpicfMldMIBComplianceV2.setObjects(
      *(("HP-ICF-MLD-MIB", "hpicfMldBaseGroupV2"),
        ("HP-ICF-MLD-MIB", "hpicfMldIfGroupV2"),
        ("HP-ICF-MLD-MIB", "hpicfMldCacheGroupV2"),
        ("HP-ICF-MLD-MIB", "hpicfMldPortGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldFilteredGroupPortCacheGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldSrcListGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldPortSrcGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldGroupPortCacheGroup"))
)
if mibBuilder.loadTexts:
...
hpicfMldMIBComplianceV3.setObjects(
      *(("HP-ICF-MLD-MIB", "hpicfMldBaseGroupV2"),
        ("HP-ICF-MLD-MIB", "hpicfMldIfGroupV3"),
        ("HP-ICF-MLD-MIB", "hpicfMldCacheGroupV2"),
        ("HP-ICF-MLD-MIB", "hpicfMldPortGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldFilteredGroupPortCacheGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldSrcListGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldPortSrcGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldGroupPortCacheGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldReloadModeGroup"))
)
if mibBuilder.loadTexts:
...
hpicfMldMIBComplianceV4 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 48, 2, 2, 4)
)
hpicfMldMIBComplianceV4.setObjects(
      *(("HP-ICF-MLD-MIB", "hpicfMldIfGroupV3"),
        ("HP-ICF-MLD-MIB", "hpicfMldCacheGroupV2"),
        ("HP-ICF-MLD-MIB", "hpicfMldPortGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldFilteredGroupPortCacheGroup"),
        ...
        ("HP-ICF-MLD-MIB", "hpicfMldGroupPortCacheGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldReloadModeGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldBaseGroupV3"))
)
if mibBuilder.loadTexts:
    hpicfMldMIBComplianceV4.setStatus(
        "deprecated"
    )

hpicfMldMIBComplianceV5 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 48, 2, 2, 5)
)
hpicfMldMIBComplianceV5.setObjects(
      *(("HP-ICF-MLD-MIB", "hpicfMldIfGroupV3"),
        ("HP-ICF-MLD-MIB", "hpicfMldCacheGroupV2"),
        ("HP-ICF-MLD-MIB", "hpicfMldPortGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldFilteredGroupPortCacheGroup"),
        ...
        ("HP-ICF-MLD-MIB", "hpicfMldGroupPortCacheGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldReloadModeGroup"),
        ("HP-ICF-MLD-MIB", "hpicfMldBaseGroupV4"))
)
if mibBuilder.loadTexts:
    hpicfMldMIBComplianceV5.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"HpicfMcastGroupTypeDefinition": HpicfMcastGroupTypeDefinition,
       ...
       "hpicfMldSendRouterAlertOption": hpicfMldSendRouterAlertOption,
       "hpicfMldMcastGrpLinkLocalJoinCnt": hpicfMldMcastGrpLinkLocalJoinCnt,
       ...
       "hpicfMldBaseGroupV3": hpicfMldBaseGroupV3,
       "hpicfMldBaseGroupV4": hpicfMldBaseGroupV4,
       ...
       "hpicfMldMIBComplianceV4": hpicfMldMIBComplianceV4,
       "hpicfMldMIBComplianceV5": hpicfMldMIBComplianceV5}
)
