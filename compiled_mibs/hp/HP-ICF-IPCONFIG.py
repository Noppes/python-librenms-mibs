...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-IPCONFIG
...
_HpicfSwitchIpAddressStatus_Type.__name__ = "IpAddressStatusTC"
...
_HpicfUdpTunnelSrcPort_Type.__name__ = "InetPortNumber"
...
_HpicfIpClientTrackerEnable_Type.__name__ = "TruthValue"
...
_HpicfIpClientTrackerTrusted_Type.__name__ = "TruthValue"
...
_HpicfIpClientTrackerUntrusted_Type.__name__ = "TruthValue"
...
class _HpicfIpClientTrackerProbeDelay_Type(Unsigned32):
    """Custom type hpicfIpClientTrackerProbeDelay based on Unsigned32"""
    defaultValue = 0
...
_HpicfIpClientTrackerProbeDelay_Type.__name__ = "Unsigned32"
_HpicfIpClientTrackerProbeDelay_Object = MibScalar
hpicfIpClientTrackerProbeDelay = _HpicfIpClientTrackerProbeDelay_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 10, 1, 3, 4),
    _HpicfIpClientTrackerProbeDelay_Type()
)
hpicfIpClientTrackerProbeDelay.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hpicfIpClientTrackerProbeDelay.setStatus("current")
...
if mibBuilder.loadTexts:
    hpicfIpClientTrackerGroup2.setStatus("deprecated")

hpicfIpClientTrackerGroup3 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 10, 2, 2, 16)
)
hpicfIpClientTrackerGroup3.setObjects(
      *(("HP-ICF-IPCONFIG", "hpicfIpClientTrackerEnable"),
        ("HP-ICF-IPCONFIG", "hpicfIpClientTrackerTrusted"),
        ("HP-ICF-IPCONFIG", "hpicfIpClientTrackerUntrusted"),
        ("HP-ICF-IPCONFIG", "hpicfIpClientTrackerProbeDelay"))
)
if mibBuilder.loadTexts:
    hpicfIpClientTrackerGroup3.setStatus("current")
...
hpicfIpConfigCompliance.setObjects(
      *(("HP-ICF-IPCONFIG", "hpicfIpAddressTableGroup"),
        ("HP-ICF-IPCONFIG", "hpicfIpv4InterfaceTableGroup"),
        ("HP-ICF-IPCONFIG", "hpicfSwitchIpAddressTableGroup"))
)
if mibBuilder.loadTexts:
...
hpicfIpConfigCompliance2.setObjects(
      *(("HP-ICF-IPCONFIG", "hpicfIpAddressTableGroup"),
        ("HP-ICF-IPCONFIG", "hpicfIpv4InterfaceTableGroup"),
        ("HP-ICF-IPCONFIG", "hpicfSwitchIpAddressTableGroup"),
        ("HP-ICF-IPCONFIG", "hpicfUdpTunnelTableGroup"))
)
if mibBuilder.loadTexts:
...
hpicfIpConfigCompliance4.setObjects(
      *(("HP-ICF-IPCONFIG", "hpicfIpAddressTableGroup"),
        ("HP-ICF-IPCONFIG", "hpicfIpv4InterfaceTableGroup2"),
        ("HP-ICF-IPCONFIG", "hpicfSwitchIpAddressTableGroup"),
        ("HP-ICF-IPCONFIG", "hpicfIpv6InterfaceTableGroup"),
        ("HP-ICF-IPCONFIG", "hpicfUdpTunnelTableGroup"))
)
if mibBuilder.loadTexts:
...
hpicfIpConfigCompliance5.setObjects(
      *(("HP-ICF-IPCONFIG", "hpicfIpv6DadAttemptsGroup"),
        ("HP-ICF-IPCONFIG", "hpicfIpv6NDGroup"))
)
if mibBuilder.loadTexts:
...
hpicfIpConfigCompliance6.setObjects(
    ("HP-ICF-IPCONFIG", "hpicfIpv6IcmpGroup")
)
if mibBuilder.loadTexts:
...
hpicfIpConfigCompliance7.setObjects(
    ("HP-ICF-IPCONFIG", "hpicfIpNetToPhysicalTableGroup")
)
if mibBuilder.loadTexts:
...
hpicfIpConfigCompliance8.setObjects(
    ("HP-ICF-IPCONFIG", "hpicfUdpTunnelMirrorGroup")
)
if mibBuilder.loadTexts:
...
hpicfIpConfigCompliance9.setObjects(
      *(("HP-ICF-IPCONFIG", "hpicfIpAddressTableGroup"),
        ("HP-ICF-IPCONFIG", "hpicfIpv4InterfaceTableGroup3"),
        ("HP-ICF-IPCONFIG", "hpicfSwitchIpAddressTableGroup"),
        ("HP-ICF-IPCONFIG", "hpicfIpv6InterfaceTableGroup"),
        ("HP-ICF-IPCONFIG", "hpicfUdpTunnelTableGroup"))
)
...
hpicfIpConfigCompliance10.setObjects(
    ("HP-ICF-IPCONFIG", "hpicfIpClientTrackerGroup")
)
if mibBuilder.loadTexts:
...
hpicfIpConfigCompliance11.setObjects(
    ("HP-ICF-IPCONFIG", "hpicfIpClientTrackerGroup2")
)
if mibBuilder.loadTexts:
...
hpicfIpConfigCompliance13 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 1, 10, 2, 1, 13)
)
hpicfIpConfigCompliance13.setObjects(
    ("HP-ICF-IPCONFIG", "hpicfIpClientTrackerGroup3")
)
if mibBuilder.loadTexts:
    hpicfIpConfigCompliance13.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hpicfIpConfig": hpicfIpConfig,
       ...
       "hpicfIpClientTrackerProbeDelay": hpicfIpClientTrackerProbeDelay,
       ...
       "hpicfIpConfigCompliance13": hpicfIpConfigCompliance13,
       ...
       "hpicfIpClientTrackerGroup3": hpicfIpClientTrackerGroup3,
