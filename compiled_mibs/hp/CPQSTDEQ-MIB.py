...
# Notes
# -----
# ASN.1 source file://mibs\hp\CPQSTDEQ-MIB
...
class _CpqSeCpuCondition_Type(Integer32):
    """Custom type cpqSeCpuCondition based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSeCpuCondition_Type.__name__ = "Integer32"
_CpqSeCpuCondition_Object = MibScalar
cpqSeCpuCondition = _CpqSeCpuCondition_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 2, 4),
    _CpqSeCpuCondition_Type()
)
cpqSeCpuCondition.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeCpuCondition.setStatus("mandatory")
...
class _CpqSeUSBPortStatus_Type(Integer32):
    """Custom type cpqSeUSBPortStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSeUSBPortStatus_Type.__name__ = "Integer32"
_CpqSeUSBPortStatus_Object = MibTableColumn
cpqSeUSBPortStatus = _CpqSeUSBPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 4),
    _CpqSeUSBPortStatus_Type()
)
cpqSeUSBPortStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortStatus.setStatus("mandatory")


class _CpqSeUSBPortDeviceName_Type(DisplayString):
    """Custom type cpqSeUSBPortDeviceName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqSeUSBPortDeviceName_Type.__name__ = "DisplayString"
_CpqSeUSBPortDeviceName_Object = MibTableColumn
cpqSeUSBPortDeviceName = _CpqSeUSBPortDeviceName_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 5),
    _CpqSeUSBPortDeviceName_Type()
)
cpqSeUSBPortDeviceName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceName.setStatus("optional")
_CpqSeUSBPortDeviceCapacity_Type = Integer32
_CpqSeUSBPortDeviceCapacity_Object = MibTableColumn
cpqSeUSBPortDeviceCapacity = _CpqSeUSBPortDeviceCapacity_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 6),
    _CpqSeUSBPortDeviceCapacity_Type()
)
cpqSeUSBPortDeviceCapacity.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceCapacity.setStatus("optional")


class _CpqSeUSBPortDeviceManufacturer_Type(DisplayString):
    """Custom type cpqSeUSBPortDeviceManufacturer based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqSeUSBPortDeviceManufacturer_Type.__name__ = "DisplayString"
_CpqSeUSBPortDeviceManufacturer_Object = MibTableColumn
cpqSeUSBPortDeviceManufacturer = _CpqSeUSBPortDeviceManufacturer_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 7),
    _CpqSeUSBPortDeviceManufacturer_Type()
)
cpqSeUSBPortDeviceManufacturer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceManufacturer.setStatus("optional")


class _CpqSeUSBPortDeviceModel_Type(DisplayString):
    """Custom type cpqSeUSBPortDeviceModel based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqSeUSBPortDeviceModel_Type.__name__ = "DisplayString"
_CpqSeUSBPortDeviceModel_Object = MibTableColumn
cpqSeUSBPortDeviceModel = _CpqSeUSBPortDeviceModel_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 8),
    _CpqSeUSBPortDeviceModel_Type()
)
cpqSeUSBPortDeviceModel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceModel.setStatus("optional")


class _CpqSeUSBPortDeviceFWVersion_Type(DisplayString):
    """Custom type cpqSeUSBPortDeviceFWVersion based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqSeUSBPortDeviceFWVersion_Type.__name__ = "DisplayString"
_CpqSeUSBPortDeviceFWVersion_Object = MibTableColumn
cpqSeUSBPortDeviceFWVersion = _CpqSeUSBPortDeviceFWVersion_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 9),
    _CpqSeUSBPortDeviceFWVersion_Type()
)
cpqSeUSBPortDeviceFWVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceFWVersion.setStatus("optional")


class _CpqSeUSBPortDeviceSerialNumber_Type(DisplayString):
    """Custom type cpqSeUSBPortDeviceSerialNumber based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqSeUSBPortDeviceSerialNumber_Type.__name__ = "DisplayString"
_CpqSeUSBPortDeviceSerialNumber_Object = MibTableColumn
cpqSeUSBPortDeviceSerialNumber = _CpqSeUSBPortDeviceSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 10),
    _CpqSeUSBPortDeviceSerialNumber_Type()
)
cpqSeUSBPortDeviceSerialNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceSerialNumber.setStatus("optional")


class _CpqSeUSBPortDevicePartNumber_Type(DisplayString):
    """Custom type cpqSeUSBPortDevicePartNumber based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqSeUSBPortDevicePartNumber_Type.__name__ = "DisplayString"
_CpqSeUSBPortDevicePartNumber_Object = MibTableColumn
cpqSeUSBPortDevicePartNumber = _CpqSeUSBPortDevicePartNumber_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 11),
    _CpqSeUSBPortDevicePartNumber_Type()
)
cpqSeUSBPortDevicePartNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDevicePartNumber.setStatus("optional")


class _CpqSeUSBPortDeviceCount_Type(Integer32):
    """Custom type cpqSeUSBPortDeviceCount based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CpqSeUSBPortDeviceCount_Type.__name__ = "Integer32"
_CpqSeUSBPortDeviceCount_Object = MibTableColumn
cpqSeUSBPortDeviceCount = _CpqSeUSBPortDeviceCount_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 12),
    _CpqSeUSBPortDeviceCount_Type()
)
cpqSeUSBPortDeviceCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceCount.setStatus("optional")


class _CpqSeUSBPortDeviceReadErrorCount_Type(OctetString):
    """Custom type cpqSeUSBPortDeviceReadErrorCount based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CpqSeUSBPortDeviceReadErrorCount_Type.__name__ = "OctetString"
_CpqSeUSBPortDeviceReadErrorCount_Object = MibTableColumn
cpqSeUSBPortDeviceReadErrorCount = _CpqSeUSBPortDeviceReadErrorCount_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 13),
    _CpqSeUSBPortDeviceReadErrorCount_Type()
)
cpqSeUSBPortDeviceReadErrorCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceReadErrorCount.setStatus("optional")


class _CpqSeUSBPortDeviceWriteErrorCount_Type(OctetString):
    """Custom type cpqSeUSBPortDeviceWriteErrorCount based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 2),
    )
...
_CpqSeUSBPortDeviceWriteErrorCount_Type.__name__ = "OctetString"
_CpqSeUSBPortDeviceWriteErrorCount_Object = MibTableColumn
cpqSeUSBPortDeviceWriteErrorCount = _CpqSeUSBPortDeviceWriteErrorCount_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 14),
    _CpqSeUSBPortDeviceWriteErrorCount_Type()
)
cpqSeUSBPortDeviceWriteErrorCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceWriteErrorCount.setStatus("optional")


class _CpqSeUSBPortDeviceReadThreshold_Type(OctetString):
    """Custom type cpqSeUSBPortDeviceReadThreshold based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 2),
    )
...
_CpqSeUSBPortDeviceReadThreshold_Type.__name__ = "OctetString"
_CpqSeUSBPortDeviceReadThreshold_Object = MibTableColumn
cpqSeUSBPortDeviceReadThreshold = _CpqSeUSBPortDeviceReadThreshold_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 15),
    _CpqSeUSBPortDeviceReadThreshold_Type()
)
cpqSeUSBPortDeviceReadThreshold.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceReadThreshold.setStatus("optional")


class _CpqSeUSBPortDeviceWriteThreshold_Type(OctetString):
    """Custom type cpqSeUSBPortDeviceWriteThreshold based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 2),
    )
...
_CpqSeUSBPortDeviceWriteThreshold_Type.__name__ = "OctetString"
_CpqSeUSBPortDeviceWriteThreshold_Object = MibTableColumn
cpqSeUSBPortDeviceWriteThreshold = _CpqSeUSBPortDeviceWriteThreshold_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 16),
    _CpqSeUSBPortDeviceWriteThreshold_Type()
)
cpqSeUSBPortDeviceWriteThreshold.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceWriteThreshold.setStatus("optional")


class _CpqSeUSBPortDeviceStatus_Type(Integer32):
    """Custom type cpqSeUSBPortDeviceStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSeUSBPortDeviceStatus_Type.__name__ = "Integer32"
_CpqSeUSBPortDeviceStatus_Object = MibTableColumn
cpqSeUSBPortDeviceStatus = _CpqSeUSBPortDeviceStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 17),
    _CpqSeUSBPortDeviceStatus_Type()
)
cpqSeUSBPortDeviceStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceStatus.setStatus("optional")


class _CpqSeUSBPortDeviceFeature_Type(Integer32):
    """Custom type cpqSeUSBPortDeviceFeature based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSeUSBPortDeviceFeature_Type.__name__ = "Integer32"
_CpqSeUSBPortDeviceFeature_Object = MibTableColumn
cpqSeUSBPortDeviceFeature = _CpqSeUSBPortDeviceFeature_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 18),
    _CpqSeUSBPortDeviceFeature_Type()
)
cpqSeUSBPortDeviceFeature.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceFeature.setStatus("optional")
_CpqSeUSBPortDeviceFailedSlot_Type = Integer32
_CpqSeUSBPortDeviceFailedSlot_Object = MibTableColumn
cpqSeUSBPortDeviceFailedSlot = _CpqSeUSBPortDeviceFailedSlot_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 19),
    _CpqSeUSBPortDeviceFailedSlot_Type()
)
cpqSeUSBPortDeviceFailedSlot.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceFailedSlot.setStatus("mandatory")
_CpqSeUSBPortDeviceLastSlotWithError_Type = Integer32
_CpqSeUSBPortDeviceLastSlotWithError_Object = MibTableColumn
cpqSeUSBPortDeviceLastSlotWithError = _CpqSeUSBPortDeviceLastSlotWithError_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 20),
    _CpqSeUSBPortDeviceLastSlotWithError_Type()
)
cpqSeUSBPortDeviceLastSlotWithError.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceLastSlotWithError.setStatus("mandatory")


class _CpqSeUSBPortDeviceFaultTolerance_Type(Integer32):
    """Custom type cpqSeUSBPortDeviceFaultTolerance based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSeUSBPortDeviceFaultTolerance_Type.__name__ = "Integer32"
_CpqSeUSBPortDeviceFaultTolerance_Object = MibTableColumn
cpqSeUSBPortDeviceFaultTolerance = _CpqSeUSBPortDeviceFaultTolerance_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 21),
    _CpqSeUSBPortDeviceFaultTolerance_Type()
)
cpqSeUSBPortDeviceFaultTolerance.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDeviceFaultTolerance.setStatus("optional")


class _CpqSeUSBPortDevicePresent_Type(OctetString):
    """Custom type cpqSeUSBPortDevicePresent based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 2),
    )
...
_CpqSeUSBPortDevicePresent_Type.__name__ = "OctetString"
_CpqSeUSBPortDevicePresent_Object = MibTableColumn
cpqSeUSBPortDevicePresent = _CpqSeUSBPortDevicePresent_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 15, 1, 1, 22),
    _CpqSeUSBPortDevicePresent_Type()
)
cpqSeUSBPortDevicePresent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSeUSBPortDevicePresent.setStatus("optional")
...
cpqSePCIeDisk = _CpqSePCIeDisk_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23)
)
_CpqSePCIeDiskTable_Object = MibTable
cpqSePCIeDiskTable = _CpqSePCIeDiskTable_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1)
)
if mibBuilder.loadTexts:
    cpqSePCIeDiskTable.setStatus("optional")
_CpqSePCIeDiskEntry_Object = MibTableRow
cpqSePCIeDiskEntry = _CpqSePCIeDiskEntry_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1)
)
cpqSePCIeDiskEntry.setIndexNames(
    (0, "CPQSTDEQ-MIB", "cpqSePCIeDiskPCIBusIndex"),
    (0, "CPQSTDEQ-MIB", "cpqSePCIeDiskPCIDeviceIndex"),
    (0, "CPQSTDEQ-MIB", "cpqSePCIeDiskPCIFunctionIndex"),
)
if mibBuilder.loadTexts:
    cpqSePCIeDiskEntry.setStatus("optional")


class _CpqSePCIeDiskPCIBusIndex_Type(Integer32):
    """Custom type cpqSePCIeDiskPCIBusIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_CpqSePCIeDiskPCIBusIndex_Type.__name__ = "Integer32"
_CpqSePCIeDiskPCIBusIndex_Object = MibTableColumn
cpqSePCIeDiskPCIBusIndex = _CpqSePCIeDiskPCIBusIndex_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 1),
    _CpqSePCIeDiskPCIBusIndex_Type()
)
cpqSePCIeDiskPCIBusIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskPCIBusIndex.setStatus("optional")


class _CpqSePCIeDiskPCIDeviceIndex_Type(Integer32):
    """Custom type cpqSePCIeDiskPCIDeviceIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_CpqSePCIeDiskPCIDeviceIndex_Type.__name__ = "Integer32"
_CpqSePCIeDiskPCIDeviceIndex_Object = MibTableColumn
cpqSePCIeDiskPCIDeviceIndex = _CpqSePCIeDiskPCIDeviceIndex_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 2),
    _CpqSePCIeDiskPCIDeviceIndex_Type()
)
cpqSePCIeDiskPCIDeviceIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskPCIDeviceIndex.setStatus("optional")


class _CpqSePCIeDiskPCIFunctionIndex_Type(Integer32):
    """Custom type cpqSePCIeDiskPCIFunctionIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_CpqSePCIeDiskPCIFunctionIndex_Type.__name__ = "Integer32"
_CpqSePCIeDiskPCIFunctionIndex_Object = MibTableColumn
cpqSePCIeDiskPCIFunctionIndex = _CpqSePCIeDiskPCIFunctionIndex_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 3),
    _CpqSePCIeDiskPCIFunctionIndex_Type()
)
cpqSePCIeDiskPCIFunctionIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskPCIFunctionIndex.setStatus("optional")


class _CpqSePCIeDiskModel_Type(DisplayString):
    """Custom type cpqSePCIeDiskModel based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqSePCIeDiskModel_Type.__name__ = "DisplayString"
_CpqSePCIeDiskModel_Object = MibTableColumn
cpqSePCIeDiskModel = _CpqSePCIeDiskModel_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 4),
    _CpqSePCIeDiskModel_Type()
)
cpqSePCIeDiskModel.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskModel.setStatus("optional")


class _CpqSePCIeDiskFwRev_Type(DisplayString):
    """Custom type cpqSePCIeDiskFwRev based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqSePCIeDiskFwRev_Type.__name__ = "DisplayString"
_CpqSePCIeDiskFwRev_Object = MibTableColumn
cpqSePCIeDiskFwRev = _CpqSePCIeDiskFwRev_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 5),
    _CpqSePCIeDiskFwRev_Type()
)
cpqSePCIeDiskFwRev.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskFwRev.setStatus("optional")


class _CpqSePCIeDiskSerialNumber_Type(DisplayString):
    """Custom type cpqSePCIeDiskSerialNumber based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqSePCIeDiskSerialNumber_Type.__name__ = "DisplayString"
_CpqSePCIeDiskSerialNumber_Object = MibTableColumn
cpqSePCIeDiskSerialNumber = _CpqSePCIeDiskSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 6),
    _CpqSePCIeDiskSerialNumber_Type()
)
cpqSePCIeDiskSerialNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskSerialNumber.setStatus("optional")
_CpqSePCIeDiskCapacityMB_Type = Gauge32
_CpqSePCIeDiskCapacityMB_Object = MibTableColumn
cpqSePCIeDiskCapacityMB = _CpqSePCIeDiskCapacityMB_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 7),
    _CpqSePCIeDiskCapacityMB_Type()
)
cpqSePCIeDiskCapacityMB.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskCapacityMB.setStatus("optional")


class _CpqSePCIeDiskCondition_Type(Integer32):
    """Custom type cpqSePCIeDiskCondition based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSePCIeDiskCondition_Type.__name__ = "Integer32"
_CpqSePCIeDiskCondition_Object = MibTableColumn
cpqSePCIeDiskCondition = _CpqSePCIeDiskCondition_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 8),
    _CpqSePCIeDiskCondition_Type()
)
cpqSePCIeDiskCondition.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskCondition.setStatus("optional")
_CpqSePCIeDiskCurrentTemperature_Type = Integer32
_CpqSePCIeDiskCurrentTemperature_Object = MibTableColumn
cpqSePCIeDiskCurrentTemperature = _CpqSePCIeDiskCurrentTemperature_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 9),
    _CpqSePCIeDiskCurrentTemperature_Type()
)
cpqSePCIeDiskCurrentTemperature.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskCurrentTemperature.setStatus("optional")
_CpqSePCIeDiskThresholdTemperature_Type = Integer32
_CpqSePCIeDiskThresholdTemperature_Object = MibTableColumn
cpqSePCIeDiskThresholdTemperature = _CpqSePCIeDiskThresholdTemperature_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 10),
    _CpqSePCIeDiskThresholdTemperature_Type()
)
cpqSePCIeDiskThresholdTemperature.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskThresholdTemperature.setStatus("optional")


class _CpqSePCIeDiskHwLocation_Type(DisplayString):
    """Custom type cpqSePCIeDiskHwLocation based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqSePCIeDiskHwLocation_Type.__name__ = "DisplayString"
_CpqSePCIeDiskHwLocation_Object = MibTableColumn
cpqSePCIeDiskHwLocation = _CpqSePCIeDiskHwLocation_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 11),
    _CpqSePCIeDiskHwLocation_Type()
)
cpqSePCIeDiskHwLocation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskHwLocation.setStatus("optional")


class _CpqSePCIeDiskOsName_Type(DisplayString):
    """Custom type cpqSePCIeDiskOsName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqSePCIeDiskOsName_Type.__name__ = "DisplayString"
_CpqSePCIeDiskOsName_Object = MibTableColumn
cpqSePCIeDiskOsName = _CpqSePCIeDiskOsName_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 12),
    _CpqSePCIeDiskOsName_Type()
)
cpqSePCIeDiskOsName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskOsName.setStatus("optional")


class _CpqSePCIeDiskWearStatus_Type(Integer32):
    """Custom type cpqSePCIeDiskWearStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSePCIeDiskWearStatus_Type.__name__ = "Integer32"
_CpqSePCIeDiskWearStatus_Object = MibTableColumn
cpqSePCIeDiskWearStatus = _CpqSePCIeDiskWearStatus_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 13),
    _CpqSePCIeDiskWearStatus_Type()
)
cpqSePCIeDiskWearStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskWearStatus.setStatus("optional")
_CpqSePCIeDiskPowerOnHours_Type = Counter32
_CpqSePCIeDiskPowerOnHours_Object = MibTableColumn
cpqSePCIeDiskPowerOnHours = _CpqSePCIeDiskPowerOnHours_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 14),
    _CpqSePCIeDiskPowerOnHours_Type()
)
cpqSePCIeDiskPowerOnHours.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskPowerOnHours.setStatus("optional")
_CpqSePCIeDiskPercntEndrnceUsed_Type = Gauge32
_CpqSePCIeDiskPercntEndrnceUsed_Object = MibTableColumn
cpqSePCIeDiskPercntEndrnceUsed = _CpqSePCIeDiskPercntEndrnceUsed_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 1, 1, 15),
    _CpqSePCIeDiskPercntEndrnceUsed_Type()
)
cpqSePCIeDiskPercntEndrnceUsed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskPercntEndrnceUsed.setStatus("optional")


class _CpqSePCIeDiskTableCondition_Type(Integer32):
    """Custom type cpqSePCIeDiskTableCondition based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSePCIeDiskTableCondition_Type.__name__ = "Integer32"
_CpqSePCIeDiskTableCondition_Object = MibScalar
cpqSePCIeDiskTableCondition = _CpqSePCIeDiskTableCondition_Object(
    (1, 3, 6, 1, 4, 1, 232, 1, 2, 23, 2),
    _CpqSePCIeDiskTableCondition_Type()
)
cpqSePCIeDiskTableCondition.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSePCIeDiskTableCondition.setStatus("optional")
...
cpqSeUSBStorageDeviceAttached.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortIndex"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceName"))
)
if mibBuilder.loadTexts:
...
cpqSeUSBStorageDeviceReadErrorOccurred = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1010)
)
cpqSeUSBStorageDeviceReadErrorOccurred.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortIndex"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceName"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceModel"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceFWVersion"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceSerialNumber"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDevicePartNumber"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceReadErrorCount"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceReadThreshold"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceLastSlotWithError"))
)
if mibBuilder.loadTexts:
    cpqSeUSBStorageDeviceReadErrorOccurred.setStatus(
        ""
    )

cpqSeUSBStorageDeviceWriteErrorOccurred = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1011)
)
cpqSeUSBStorageDeviceWriteErrorOccurred.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortIndex"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceName"),
        ...
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceSerialNumber"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDevicePartNumber"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceWriteErrorCount"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceWriteThreshold"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceLastSlotWithError"))
)
if mibBuilder.loadTexts:
    cpqSeUSBStorageDeviceWriteErrorOccurred.setStatus(
        ""
    )

cpqSeUSBStorageDeviceRedundancyLost = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1012)
)
cpqSeUSBStorageDeviceRedundancyLost.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortIndex"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceName"),
        ...
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceSerialNumber"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDevicePartNumber"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceFailedSlot"))
)
if mibBuilder.loadTexts:
    cpqSeUSBStorageDeviceRedundancyLost.setStatus(
        ""
    )

cpqSeUSBStorageDeviceRedundancyRestored = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1013)
)
cpqSeUSBStorageDeviceRedundancyRestored.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortIndex"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceName"),
...
if mibBuilder.loadTexts:
    cpqSeUSBStorageDeviceRedundancyRestored.setStatus(
        ""
    )

cpqSeUSBStorageDeviceSyncFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1014)
)
cpqSeUSBStorageDeviceSyncFailed.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortIndex"),
        ("CPQSTDEQ-MIB", "cpqSeUSBPortDeviceName"),
...
if mibBuilder.loadTexts:
    cpqSeUSBStorageDeviceSyncFailed.setStatus(
        ""
    )

cpqSePCIeDiskTemperatureFailed = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1015)
)
cpqSePCIeDiskTemperatureFailed.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIBusIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIDeviceIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIFunctionIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskCurrentTemperature"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskThresholdTemperature"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskHwLocation"))
)
if mibBuilder.loadTexts:
    cpqSePCIeDiskTemperatureFailed.setStatus(
        ""
    )

cpqSePCIeDiskTemperatureOk = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1016)
)
cpqSePCIeDiskTemperatureOk.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIBusIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIDeviceIndex"),
...
if mibBuilder.loadTexts:
    cpqSePCIeDiskTemperatureOk.setStatus(
        ""
    )

cpqSePCIeDiskConditionChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1017)
)
cpqSePCIeDiskConditionChange.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIBusIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIDeviceIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIFunctionIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskCondition"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskHwLocation"))
)
if mibBuilder.loadTexts:
    cpqSePCIeDiskConditionChange.setStatus(
        ""
    )

cpqSePCIeDiskWearStatusChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1018)
)
cpqSePCIeDiskWearStatusChange.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIBusIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIDeviceIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskPCIFunctionIndex"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskWearStatus"),
        ("CPQSTDEQ-MIB", "cpqSePCIeDiskHwLocation"))
)
if mibBuilder.loadTexts:
    cpqSePCIeDiskWearStatusChange.setStatus(
        ""
    )

cpqSePciDeviceAddedOrPoweredOn = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1019)
)
cpqSePciDeviceAddedOrPoweredOn.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSePciFunctBusNumberIndex"),
        ("CPQSTDEQ-MIB", "cpqSePciFunctDeviceNumberIndex"),
        ("CPQSTDEQ-MIB", "cpqSePciFunctIndex"))
)
if mibBuilder.loadTexts:
    cpqSePciDeviceAddedOrPoweredOn.setStatus(
        ""
    )

cpqSePciDeviceRemovedOrPoweredOff = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 1020)
)
cpqSePciDeviceRemovedOrPoweredOff.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQSTDEQ-MIB", "cpqSePciFunctBusNumberIndex"),
        ("CPQSTDEQ-MIB", "cpqSePciFunctDeviceNumberIndex"),
...
if mibBuilder.loadTexts:
    cpqSePciDeviceRemovedOrPoweredOff.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TruthValue": TruthValue,
       ...
       "cpqSeUSBStorageDeviceReadErrorOccurred": cpqSeUSBStorageDeviceReadErrorOccurred,
       "cpqSeUSBStorageDeviceWriteErrorOccurred": cpqSeUSBStorageDeviceWriteErrorOccurred,
       "cpqSeUSBStorageDeviceRedundancyLost": cpqSeUSBStorageDeviceRedundancyLost,
       "cpqSeUSBStorageDeviceRedundancyRestored": cpqSeUSBStorageDeviceRedundancyRestored,
       "cpqSeUSBStorageDeviceSyncFailed": cpqSeUSBStorageDeviceSyncFailed,
       "cpqSePCIeDiskTemperatureFailed": cpqSePCIeDiskTemperatureFailed,
       "cpqSePCIeDiskTemperatureOk": cpqSePCIeDiskTemperatureOk,
       "cpqSePCIeDiskConditionChange": cpqSePCIeDiskConditionChange,
       "cpqSePCIeDiskWearStatusChange": cpqSePCIeDiskWearStatusChange,
       "cpqSePciDeviceAddedOrPoweredOn": cpqSePciDeviceAddedOrPoweredOn,
       "cpqSePciDeviceRemovedOrPoweredOff": cpqSePciDeviceRemovedOrPoweredOff,
       ...
       "cpqSeCpuCondition": cpqSeCpuCondition,
       ...
       "cpqSeUSBPortStatus": cpqSeUSBPortStatus,
       "cpqSeUSBPortDeviceName": cpqSeUSBPortDeviceName,
       "cpqSeUSBPortDeviceCapacity": cpqSeUSBPortDeviceCapacity,
       "cpqSeUSBPortDeviceManufacturer": cpqSeUSBPortDeviceManufacturer,
       "cpqSeUSBPortDeviceModel": cpqSeUSBPortDeviceModel,
       "cpqSeUSBPortDeviceFWVersion": cpqSeUSBPortDeviceFWVersion,
       "cpqSeUSBPortDeviceSerialNumber": cpqSeUSBPortDeviceSerialNumber,
       "cpqSeUSBPortDevicePartNumber": cpqSeUSBPortDevicePartNumber,
       "cpqSeUSBPortDeviceCount": cpqSeUSBPortDeviceCount,
       "cpqSeUSBPortDeviceReadErrorCount": cpqSeUSBPortDeviceReadErrorCount,
       "cpqSeUSBPortDeviceWriteErrorCount": cpqSeUSBPortDeviceWriteErrorCount,
       "cpqSeUSBPortDeviceReadThreshold": cpqSeUSBPortDeviceReadThreshold,
       "cpqSeUSBPortDeviceWriteThreshold": cpqSeUSBPortDeviceWriteThreshold,
       "cpqSeUSBPortDeviceStatus": cpqSeUSBPortDeviceStatus,
       "cpqSeUSBPortDeviceFeature": cpqSeUSBPortDeviceFeature,
       "cpqSeUSBPortDeviceFailedSlot": cpqSeUSBPortDeviceFailedSlot,
       "cpqSeUSBPortDeviceLastSlotWithError": cpqSeUSBPortDeviceLastSlotWithError,
       "cpqSeUSBPortDeviceFaultTolerance": cpqSeUSBPortDeviceFaultTolerance,
       "cpqSeUSBPortDevicePresent": cpqSeUSBPortDevicePresent,
       "cpqSeCell": cpqSeCell,
       ...
       "cpqSePCIeDisk": cpqSePCIeDisk,
       "cpqSePCIeDiskTable": cpqSePCIeDiskTable,
       "cpqSePCIeDiskEntry": cpqSePCIeDiskEntry,
       "cpqSePCIeDiskPCIBusIndex": cpqSePCIeDiskPCIBusIndex,
       "cpqSePCIeDiskPCIDeviceIndex": cpqSePCIeDiskPCIDeviceIndex,
       "cpqSePCIeDiskPCIFunctionIndex": cpqSePCIeDiskPCIFunctionIndex,
       "cpqSePCIeDiskModel": cpqSePCIeDiskModel,
       "cpqSePCIeDiskFwRev": cpqSePCIeDiskFwRev,
       "cpqSePCIeDiskSerialNumber": cpqSePCIeDiskSerialNumber,
       "cpqSePCIeDiskCapacityMB": cpqSePCIeDiskCapacityMB,
       "cpqSePCIeDiskCondition": cpqSePCIeDiskCondition,
       "cpqSePCIeDiskCurrentTemperature": cpqSePCIeDiskCurrentTemperature,
       "cpqSePCIeDiskThresholdTemperature": cpqSePCIeDiskThresholdTemperature,
       "cpqSePCIeDiskHwLocation": cpqSePCIeDiskHwLocation,
       "cpqSePCIeDiskOsName": cpqSePCIeDiskOsName,
       "cpqSePCIeDiskWearStatus": cpqSePCIeDiskWearStatus,
       "cpqSePCIeDiskPowerOnHours": cpqSePCIeDiskPowerOnHours,
       "cpqSePCIeDiskPercntEndrnceUsed": cpqSePCIeDiskPercntEndrnceUsed,
       "cpqSePCIeDiskTableCondition": cpqSePCIeDiskTableCondition}
)
