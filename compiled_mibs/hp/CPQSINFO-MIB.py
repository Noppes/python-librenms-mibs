...
# Notes
# -----
# ASN.1 source file://mibs\hp\CPQSINFO-MIB
...
class _CpqSiVirtualSerialPortControl_Type(Integer32):
    """Custom type cpqSiVirtualSerialPortControl based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_CpqSiVirtualSerialPortControl_Type.__name__ = "Integer32"
_CpqSiVirtualSerialPortControl_Object = MibScalar
cpqSiVirtualSerialPortControl = _CpqSiVirtualSerialPortControl_Object(
    (1, 3, 6, 1, 4, 1, 232, 2, 2, 3, 15),
    _CpqSiVirtualSerialPortControl_Type()
)
cpqSiVirtualSerialPortControl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSiVirtualSerialPortControl.setStatus("mandatory")
...
class _CpqSiTrustedModuleType_Type(Integer32):
    """Custom type cpqSiTrustedModuleType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_CpqSiTrustedModuleType_Type.__name__ = "Integer32"
_CpqSiTrustedModuleType_Object = MibScalar
cpqSiTrustedModuleType = _CpqSiTrustedModuleType_Object(
    (1, 3, 6, 1, 4, 1, 232, 2, 2, 4, 25),
    _CpqSiTrustedModuleType_Type()
)
cpqSiTrustedModuleType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSiTrustedModuleType.setStatus("optional")
...
cpqSiRackEnclosureMgrMatrix = _CpqSiRackEnclosureMgrMatrix_Object(
    (1, 3, 6, 1, 4, 1, 232, 2, 2, 13, 1, 1, 12),
    _CpqSiRackEnclosureMgrMatrix_Type()
)
cpqSiRackEnclosureMgrMatrix.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSiRackEnclosureMgrMatrix.setStatus("mandatory")
_CpqSiRackEnclosureMgrMatrixID_Type = DisplayString
_CpqSiRackEnclosureMgrMatrixID_Object = MibTableColumn
cpqSiRackEnclosureMgrMatrixID = _CpqSiRackEnclosureMgrMatrixID_Object(
    (1, 3, 6, 1, 4, 1, 232, 2, 2, 13, 1, 1, 13),
    _CpqSiRackEnclosureMgrMatrixID_Type()
)
cpqSiRackEnclosureMgrMatrixID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqSiRackEnclosureMgrMatrixID.setStatus("optional")
...
mibBuilder.exportSymbols(
    ...
    **{"cpqSiHoodRemoved": cpqSiHoodRemoved,
       ...
       "cpqSiVirtualSerialPortControl": cpqSiVirtualSerialPortControl,
       ...
       "cpqSiTrustedModuleType": cpqSiTrustedModuleType,
       ...
       "cpqSiRackEnclosureMgrMatrix": cpqSiRackEnclosureMgrMatrix,
       "cpqSiRackEnclosureMgrMatrixID": cpqSiRackEnclosureMgrMatrixID,
