...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-OID
...
_ArubaSwitchR0M67A_ObjectIdentity = ObjectIdentity
arubaSwitchR0M67A = _ArubaSwitchR0M67A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 28)
)
if mibBuilder.loadTexts:
    arubaSwitchR0M67A.setStatus("current")
_ArubaModuleR0M67A_ObjectIdentity = ObjectIdentity
arubaModuleR0M67A = _ArubaModuleR0M67A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 28, 1)
)
if mibBuilder.loadTexts:
    arubaModuleR0M67A.setStatus("current")
_ArubaSwitchR0M68A_ObjectIdentity = ObjectIdentity
arubaSwitchR0M68A = _ArubaSwitchR0M68A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 29)
)
if mibBuilder.loadTexts:
    arubaSwitchR0M68A.setStatus("current")
_ArubaModuleR0M68A_ObjectIdentity = ObjectIdentity
arubaModuleR0M68A = _ArubaModuleR0M68A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 29, 1)
)
if mibBuilder.loadTexts:
    arubaModuleR0M68A.setStatus("current")
_ArubaSwitchJL693A_ObjectIdentity = ObjectIdentity
arubaSwitchJL693A = _ArubaSwitchJL693A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 35)
)
if mibBuilder.loadTexts:
    arubaSwitchJL693A.setStatus("current")
_ArubaModuleJL693A_ObjectIdentity = ObjectIdentity
arubaModuleJL693A = _ArubaModuleJL693A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 35, 1)
)
if mibBuilder.loadTexts:
    arubaModuleJL693A.setStatus("current")
_ArubaSwitchJL692A_ObjectIdentity = ObjectIdentity
arubaSwitchJL692A = _ArubaSwitchJL692A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 272)
)
if mibBuilder.loadTexts:
    arubaSwitchJL692A.setStatus("current")
_ArubaModuleJL692A_ObjectIdentity = ObjectIdentity
arubaModuleJL692A = _ArubaModuleJL692A_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 3, 7, 11, 181, 272, 1)
)
if mibBuilder.loadTexts:
    arubaModuleJL692A.setStatus("current")
...
_HpicfNDSnooping_ObjectIdentity = ObjectIdentity
hpicfNDSnooping = _HpicfNDSnooping_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 118)
)
...
_HpicfPortScanDetectMIB_ObjectIdentity = ObjectIdentity
hpicfPortScanDetectMIB = _HpicfPortScanDetectMIB_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 123)
)
...
_HpicfDeviceFingerPrintMIB_ObjectIdentity = ObjectIdentity
hpicfDeviceFingerPrintMIB = _HpicfDeviceFingerPrintMIB_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 138)
)
_HpicfSnmpUsm_ObjectIdentity = ObjectIdentity
hpicfSnmpUsm = _HpicfSnmpUsm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 143)
)
...
mibBuilder.exportSymbols(
    ...
    **{"hp": hp,
       ...
       "arubaSwitchR0M67A": arubaSwitchR0M67A,
       "arubaModuleR0M67A": arubaModuleR0M67A,
       "arubaSwitchR0M68A": arubaSwitchR0M68A,
       "arubaModuleR0M68A": arubaModuleR0M68A,
       "arubaSwitchJL693A": arubaSwitchJL693A,
       "arubaModuleJL693A": arubaModuleJL693A,
       "arubaSwitchJL692A": arubaSwitchJL692A,
       "arubaModuleJL692A": arubaModuleJL692A,
