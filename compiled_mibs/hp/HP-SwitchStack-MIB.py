...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-SwitchStack-MIB
...
hpSwitchVirtualStackMibCompliance.setObjects(
      *(("HP-SwitchStack-MIB", "hpSwitchStackConfigGroup"),
        ("HP-SwitchStack-MIB", "hpSwitchStackStatsGroup"),
        ("HP-SwitchStack-MIB", "hpSwitchDiscoverConfigGroup"),
        ("HP-SwitchStack-MIB", "hpDiscoverStatsGroup"))
)
if mibBuilder.loadTexts:
...
hpSwitchVirtualStackMibCompliance1.setObjects(
      *(("HP-SwitchStack-MIB", "hpSwitchStackConfigGroup1"),
        ("HP-SwitchStack-MIB", "hpSwitchStackStatsGroup"),
        ("HP-SwitchStack-MIB", "hpSwitchDiscoverConfigGroup"),
        ("HP-SwitchStack-MIB", "hpDiscoverStatsGroup"))
)
