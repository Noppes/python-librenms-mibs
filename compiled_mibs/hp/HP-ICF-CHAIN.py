...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-CHAIN
...
hpicfChainingCompliance.setObjects(
      *(("HP-ICF-CHAIN", "hpicfChainingGroup"),
        ("HP-ICF-CHAIN", "hpicfChainTrapGroup"))
)
if mibBuilder.loadTexts:
...
hpicfChainingCompliance2.setObjects(
      *(("HP-ICF-CHAIN", "hpicfChainingGroup"),
        ("HP-ICF-CHAIN", "hpicfChainNotifyGroup"))
)
if mibBuilder.loadTexts:
