...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-UDP-FORWARD
...
hpicfUdpFwdCompliance.setObjects(
      *(("HP-ICF-UDP-FORWARD", "hpicfUdpFwdCfgGroup"),
        ("HP-ICF-UDP-FORWARD", "hpicfUdpFwdServerTableGroup"),
        ("HP-ICF-UDP-FORWARD", "hpicfUdpFwdCfgGroup"),
        ("HP-ICF-UDP-FORWARD", "hpicfUdpFwdServerTableGroup"))
)
if mibBuilder.loadTexts:
...
hpicfUdpFwdStatCompliance.setObjects(
      *(("HP-ICF-UDP-FORWARD", "hpicfUdpFwdDhcpRelayStatsGroup"),
        ("HP-ICF-UDP-FORWARD", "hpicfUdpFwdDhcpRelayStatsGroup"))
)
if mibBuilder.loadTexts:
...
hpicfUdpFwdDhcpRelayCfgCompliance.setObjects(
      *(("HP-ICF-UDP-FORWARD", "hpicfUdpFwdDhcpRelayCfgGroup"),
        ("HP-ICF-UDP-FORWARD", "hpicfUdpFwdDhcpRelayCfgGroup"))
)
if mibBuilder.loadTexts:
