...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-ARP-PROTECT
...
hpicfArpProtectCompliance.setObjects(
      *(("HP-ICF-ARP-PROTECT", "hpicfArpProtectBaseGroup"),
        ("HP-ICF-ARP-PROTECT", "hpicfArpProtectionNotifications"))
)
if mibBuilder.loadTexts:
