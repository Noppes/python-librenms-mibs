...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-AUTZ-MIB
...
_HpSwitchAutzUserRoleEnabled_Type.__name__ = "TruthValue"
...
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleTaggedVlanId.setStatus("deprecated")
...
hpSwitchAutzUserRoleTunneledNodeServerDownloadableRole = _HpSwitchAutzUserRoleTunneledNodeServerDownloadableRole_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 3, 1, 13),
    _HpSwitchAutzUserRoleTunneledNodeServerDownloadableRole_Type()
)
hpSwitchAutzUserRoleTunneledNodeServerDownloadableRole.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleTunneledNodeServerDownloadableRole.setStatus("current")


class _HpSwitchAutzUserRoleLogOffPeriod_Type(Integer32):
    """Custom type hpSwitchAutzUserRoleLogOffPeriod based on Integer32"""
    defaultValue = 300
...
_HpSwitchAutzUserRoleLogOffPeriod_Type.__name__ = "Integer32"
_HpSwitchAutzUserRoleLogOffPeriod_Object = MibTableColumn
hpSwitchAutzUserRoleLogOffPeriod = _HpSwitchAutzUserRoleLogOffPeriod_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 3, 1, 14),
    _HpSwitchAutzUserRoleLogOffPeriod_Type()
)
hpSwitchAutzUserRoleLogOffPeriod.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleLogOffPeriod.setStatus("current")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleLogOffPeriod.setUnits("seconds")


class _HpSwitchAutzUserRoleCachedReauthPeriod_Type(Unsigned32):
    """Custom type hpSwitchAutzUserRoleCachedReauthPeriod based on Unsigned32"""
...
_HpSwitchAutzUserRoleCachedReauthPeriod_Type.__name__ = "Unsigned32"
_HpSwitchAutzUserRoleCachedReauthPeriod_Object = MibTableColumn
hpSwitchAutzUserRoleCachedReauthPeriod = _HpSwitchAutzUserRoleCachedReauthPeriod_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 3, 1, 15),
    _HpSwitchAutzUserRoleCachedReauthPeriod_Type()
)
hpSwitchAutzUserRoleCachedReauthPeriod.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleCachedReauthPeriod.setStatus("current")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleCachedReauthPeriod.setUnits("seconds")
_HpSwitchAutzUserRoleTaggedVlanList_Type = VidList
_HpSwitchAutzUserRoleTaggedVlanList_Object = MibTableColumn
hpSwitchAutzUserRoleTaggedVlanList = _HpSwitchAutzUserRoleTaggedVlanList_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 3, 1, 16),
    _HpSwitchAutzUserRoleTaggedVlanList_Type()
)
hpSwitchAutzUserRoleTaggedVlanList.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleTaggedVlanList.setStatus("current")
...
_HpSwitchAutzUserRoleDownloadedEnabled_Type.__name__ = "TruthValue"
...
hpSwitchAutzUserRoleSubTable = _HpSwitchAutzUserRoleSubTable_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 5)
)
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleSubTable.setStatus("current")
_HpSwitchAutzUserRoleSubEntry_Object = MibTableRow
hpSwitchAutzUserRoleSubEntry = _HpSwitchAutzUserRoleSubEntry_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 5, 1)
)
hpSwitchAutzUserRoleSubEntry.setIndexNames(
    (0, "HP-AUTZ-MIB", "hpSwitchAutzUserRoleName"),
    (0, "HP-AUTZ-MIB", "hpSwitchAutzUserRoleSubType"),
)
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleSubEntry.setStatus("current")


class _HpSwitchAutzUserRoleSubType_Type(Integer32):
    """Custom type hpSwitchAutzUserRoleSubType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            1
...
_HpSwitchAutzUserRoleSubType_Type.__name__ = "Integer32"
_HpSwitchAutzUserRoleSubType_Object = MibTableColumn
hpSwitchAutzUserRoleSubType = _HpSwitchAutzUserRoleSubType_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 5, 1, 1),
    _HpSwitchAutzUserRoleSubType_Type()
)
hpSwitchAutzUserRoleSubType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleSubType.setStatus("current")


class _HpSwitchAutzUserRoleAdminEdgePort_Type(TruthValue):
    """Custom type hpSwitchAutzUserRoleAdminEdgePort based on TruthValue"""
    defaultValue = 2


_HpSwitchAutzUserRoleAdminEdgePort_Type.__name__ = "TruthValue"
_HpSwitchAutzUserRoleAdminEdgePort_Object = MibTableColumn
hpSwitchAutzUserRoleAdminEdgePort = _HpSwitchAutzUserRoleAdminEdgePort_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 5, 1, 2),
    _HpSwitchAutzUserRoleAdminEdgePort_Type()
)
hpSwitchAutzUserRoleAdminEdgePort.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleAdminEdgePort.setStatus("current")


class _HpSwitchAutzUserRolePoePriority_Type(Integer32):
    """Custom type hpSwitchAutzUserRolePoePriority based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_HpSwitchAutzUserRolePoePriority_Type.__name__ = "Integer32"
_HpSwitchAutzUserRolePoePriority_Object = MibTableColumn
hpSwitchAutzUserRolePoePriority = _HpSwitchAutzUserRolePoePriority_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 5, 1, 3),
    _HpSwitchAutzUserRolePoePriority_Type()
)
hpSwitchAutzUserRolePoePriority.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRolePoePriority.setStatus("current")


class _HpSwitchAutzUserRolePoeAllocBy_Type(Integer32):
    """Custom type hpSwitchAutzUserRolePoeAllocBy based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_HpSwitchAutzUserRolePoeAllocBy_Type.__name__ = "Integer32"
_HpSwitchAutzUserRolePoeAllocBy_Object = MibTableColumn
hpSwitchAutzUserRolePoeAllocBy = _HpSwitchAutzUserRolePoeAllocBy_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 5, 1, 4),
    _HpSwitchAutzUserRolePoeAllocBy_Type()
)
hpSwitchAutzUserRolePoeAllocBy.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRolePoeAllocBy.setStatus("current")
_HpSwitchAutzUserRoleSubTypeRowStatus_Type = RowStatus
_HpSwitchAutzUserRoleSubTypeRowStatus_Object = MibTableColumn
hpSwitchAutzUserRoleSubTypeRowStatus = _HpSwitchAutzUserRoleSubTypeRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 5, 1, 5),
    _HpSwitchAutzUserRoleSubTypeRowStatus_Type()
)
hpSwitchAutzUserRoleSubTypeRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleSubTypeRowStatus.setStatus("current")


class _HpSwitchAutzUserRolePortMode_Type(TruthValue):
    """Custom type hpSwitchAutzUserRolePortMode based on TruthValue"""
    defaultValue = 2


_HpSwitchAutzUserRolePortMode_Type.__name__ = "TruthValue"
_HpSwitchAutzUserRolePortMode_Object = MibTableColumn
hpSwitchAutzUserRolePortMode = _HpSwitchAutzUserRolePortMode_Object(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 1, 5, 5, 1, 7),
    _HpSwitchAutzUserRolePortMode_Type()
)
hpSwitchAutzUserRolePortMode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hpSwitchAutzUserRolePortMode.setStatus("current")
...
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleGroup3.setStatus("deprecated")

hpSwitchAutzUserRoleGroup4 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 2, 2, 10)
)
hpSwitchAutzUserRoleGroup4.setObjects(
      *(("HP-AUTZ-MIB", "hpSwitchAutzUserRoleEnabled"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleInitialRoleName"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleRowStatus"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleType"),
        ...
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleTaggedVlanName"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleDownloadedEnabled"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleTunneledNodeServerDownloadableRole"))
)
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleGroup4.setStatus("deprecated")

hpSwitchAutzUserRoleGroup5 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 2, 2, 13)
)
hpSwitchAutzUserRoleGroup5.setObjects(
      *(("HP-AUTZ-MIB", "hpSwitchAutzUserRoleEnabled"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleInitialRoleName"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleRowStatus"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleType"),
        ...
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleDownloadedEnabled"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleTunneledNodeServerDownloadableRole"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleLogOffPeriod"))
)
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleGroup5.setStatus("deprecated")

hpSwitchAutzUserRoleGroup6 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 2, 2, 14)
)
hpSwitchAutzUserRoleGroup6.setObjects(
      *(("HP-AUTZ-MIB", "hpSwitchAutzUserRoleEnabled"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleInitialRoleName"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleRowStatus"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleType"),
        ...
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRolePoePriority"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleCachedReauthPeriod"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRolePoeAllocBy"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleTaggedVlanList"),
        ("HP-AUTZ-MIB", "hpSwitchAutzUserRolePortMode"))
)
if mibBuilder.loadTexts:
    hpSwitchAutzUserRoleGroup6.setStatus("current")
...
hpSwitchAuthorizationMIBCompliance.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAuthorizationConfigGroup")
)
if mibBuilder.loadTexts:
...
hpSwitchLocalMgmtPrivGrpMIBCompliance.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAutzLocalMgmtPrivGroup")
)
if mibBuilder.loadTexts:
...
hpSwitchLocalMgmtPrivGrpMIBCompliance1.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAutzLocalMgmtPrivGroup1")
)
if mibBuilder.loadTexts:
...
hpSwitchAuthorizationObjectsGrpMIBCompliance.setObjects(
    ("HP-AUTZ-MIB", "hpicfSwitchAuthorizationObjectsGroup")
)
if mibBuilder.loadTexts:
...
hpSwitchAuthorizationNotificationGrpMIBCompliance.setObjects(
    ("HP-AUTZ-MIB", "hpicfSwitchAuthorizationNotificationGroup")
)
if mibBuilder.loadTexts:
...
hpSwitchAutzRoleGrpCompliance.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleGroup")
)
if mibBuilder.loadTexts:
...
hpSwitchAutzRoleGrpCompliance1.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleGroup1")
)
if mibBuilder.loadTexts:
...
hpSwitchAutzRoleGrpCompliance2.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleGroup2")
)
if mibBuilder.loadTexts:
...
hpSwitchAutzRoleGrpCompliance3.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleGroup3")
)
if mibBuilder.loadTexts:
...
hpSwitchAutzRoleGrpCompliance4 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 2, 1, 10)
)
hpSwitchAutzRoleGrpCompliance4.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleGroup4")
)
if mibBuilder.loadTexts:
    hpSwitchAutzRoleGrpCompliance4.setStatus(
        "deprecated"
    )

hpSwitchLocalMgmtPrivGrpMIBCompliance2 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 2, 1, 11)
)
hpSwitchLocalMgmtPrivGrpMIBCompliance2.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAutzLocalMgmtPrivGroup")
)
if mibBuilder.loadTexts:
    hpSwitchLocalMgmtPrivGrpMIBCompliance2.setStatus(
        "current"
    )

hpSwitchLocalMgmtPrivGrpMIBCompliance3 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 2, 1, 12)
)
hpSwitchLocalMgmtPrivGrpMIBCompliance3.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAutzLocalMgmtPrivGroup1")
)
if mibBuilder.loadTexts:
    hpSwitchLocalMgmtPrivGrpMIBCompliance3.setStatus(
        "current"
    )

hpSwitchAutzRoleGrpCompliance5 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 2, 1, 13)
)
hpSwitchAutzRoleGrpCompliance5.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleGroup5")
)
if mibBuilder.loadTexts:
    hpSwitchAutzRoleGrpCompliance5.setStatus(
        "deprecated"
    )

hpSwitchAutzRoleGrpCompliance6 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 11, 2, 14, 11, 5, 1, 32, 2, 1, 14)
)
hpSwitchAutzRoleGrpCompliance6.setObjects(
    ("HP-AUTZ-MIB", "hpSwitchAutzUserRoleGroup6")
)
if mibBuilder.loadTexts:
    hpSwitchAutzRoleGrpCompliance6.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"HpAutzUserRoleName": HpAutzUserRoleName,
       ...
       "hpSwitchAutzUserRoleTunneledNodeServerDownloadableRole": hpSwitchAutzUserRoleTunneledNodeServerDownloadableRole,
       "hpSwitchAutzUserRoleLogOffPeriod": hpSwitchAutzUserRoleLogOffPeriod,
       "hpSwitchAutzUserRoleCachedReauthPeriod": hpSwitchAutzUserRoleCachedReauthPeriod,
       "hpSwitchAutzUserRoleTaggedVlanList": hpSwitchAutzUserRoleTaggedVlanList,
       "hpSwitchAutzUserRoleDownloadedEnabled": hpSwitchAutzUserRoleDownloadedEnabled,
       "hpSwitchAutzUserRoleSubTable": hpSwitchAutzUserRoleSubTable,
       "hpSwitchAutzUserRoleSubEntry": hpSwitchAutzUserRoleSubEntry,
       "hpSwitchAutzUserRoleSubType": hpSwitchAutzUserRoleSubType,
       "hpSwitchAutzUserRoleAdminEdgePort": hpSwitchAutzUserRoleAdminEdgePort,
       "hpSwitchAutzUserRolePoePriority": hpSwitchAutzUserRolePoePriority,
       "hpSwitchAutzUserRolePoeAllocBy": hpSwitchAutzUserRolePoeAllocBy,
       "hpSwitchAutzUserRoleSubTypeRowStatus": hpSwitchAutzUserRoleSubTypeRowStatus,
       "hpSwitchAutzUserRolePortMode": hpSwitchAutzUserRolePortMode,
       ...
       "hpSwitchAutzRoleGrpCompliance4": hpSwitchAutzRoleGrpCompliance4,
       "hpSwitchLocalMgmtPrivGrpMIBCompliance2": hpSwitchLocalMgmtPrivGrpMIBCompliance2,
       "hpSwitchLocalMgmtPrivGrpMIBCompliance3": hpSwitchLocalMgmtPrivGrpMIBCompliance3,
       "hpSwitchAutzRoleGrpCompliance5": hpSwitchAutzRoleGrpCompliance5,
       "hpSwitchAutzRoleGrpCompliance6": hpSwitchAutzRoleGrpCompliance6,
       ...
       "hpSwitchAutzUserRoleGroup4": hpSwitchAutzUserRoleGroup4,
       "hpSwitchAutzUserRoleGroup5": hpSwitchAutzUserRoleGroup5,
       "hpSwitchAutzUserRoleGroup6": hpSwitchAutzUserRoleGroup6}
)
