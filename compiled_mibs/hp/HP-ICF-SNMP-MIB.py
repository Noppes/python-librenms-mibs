...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-SNMP-MIB
...
hpicfSnmpCompliance.setObjects(
      *(("HP-ICF-SNMP-MIB", "hpicfSnmpResponseSourceAddrTableCompliancesGroup"),
        ("HP-ICF-SNMP-MIB", "hpicfSnmpTrapSourceAddrTableCompliancesGroup"),
        ("HP-ICF-SNMP-MIB", "hpicfSnmpResponseSourceAddrTableGroup"),
        ("HP-ICF-SNMP-MIB", "hpicfSnmpTrapSourceAddrTableGroup"))
)
if mibBuilder.loadTexts:
...
hpicfSnmpCompliance1.setObjects(
      *(("HP-ICF-SNMP-MIB", "hpicfSnmpNotifyObjectGroup"),
        ("HP-ICF-SNMP-MIB", "hpicfSnmpNotificationGroup"))
)
if mibBuilder.loadTexts:
