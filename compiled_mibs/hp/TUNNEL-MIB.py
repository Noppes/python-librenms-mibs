...
# Notes
# -----
# ASN.1 source file://mibs\TUNNEL-MIB
...
tunnelMIBCompliance.setObjects(
    ("TUNNEL-MIB", "tunnelMIBBasicGroup")
)
if mibBuilder.loadTexts:
...
tunnelMIBInetFullCompliance.setObjects(
    ("TUNNEL-MIB", "tunnelMIBInetGroup")
)
if mibBuilder.loadTexts:
...
tunnelMIBInetReadOnlyCompliance.setObjects(
    ("TUNNEL-MIB", "tunnelMIBInetGroup")
)
if mibBuilder.loadTexts:
