...
# Notes
# -----
# ASN.1 source file://mibs\IPV6-MLD-MIB
...
_MldInterfaceQueryInterval_Type.__name__ = "Unsigned32"
...
_MldInterfaceVersion_Type.__name__ = "Unsigned32"
...
class _MldInterfaceQueryMaxRespDelay_Type(Unsigned32):
    """Custom type mldInterfaceQueryMaxRespDelay based on Unsigned32"""
    defaultValue = 10


_MldInterfaceQueryMaxRespDelay_Type.__name__ = "Unsigned32"
_MldInterfaceQueryMaxRespDelay_Object = MibTableColumn
mldInterfaceQueryMaxRespDelay = _MldInterfaceQueryMaxRespDelay_Object(
    (1, 3, 6, 1, 2, 1, 91, 1, 1, 1, 6),
    _MldInterfaceQueryMaxRespDelay_Type()
)
mldInterfaceQueryMaxRespDelay.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    mldInterfaceQueryMaxRespDelay.setStatus("current")
if mibBuilder.loadTexts:
    mldInterfaceQueryMaxRespDelay.setUnits("seconds")
...
_MldInterfaceRobustness_Type.__name__ = "Unsigned32"
...
_MldInterfaceLastListenQueryIntvl_Type.__name__ = "Unsigned32"
...
_MldInterfaceProxyIfIndex_Type.__name__ = "InterfaceIndexOrZero"
...
_MldCacheSelf_Type.__name__ = "TruthValue"
...
mldRouterMIBGroup.setObjects(
      *(("IPV6-MLD-MIB", "mldCacheUpTime"),
        ...
        ("IPV6-MLD-MIB", "mldInterfaceQueryMaxRespDelay"),
...
mldHostMIBCompliance.setObjects(
      *(("IPV6-MLD-MIB", "mldBaseMIBGroup"),
        ("IPV6-MLD-MIB", "mldHostMIBGroup"))
)
if mibBuilder.loadTexts:
...
mldRouterMIBCompliance.setObjects(
      *(("IPV6-MLD-MIB", "mldBaseMIBGroup"),
        ("IPV6-MLD-MIB", "mldRouterMIBGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"mldMIB": mldMIB,
       ...
       "mldInterfaceQueryMaxRespDelay": mldInterfaceQueryMaxRespDelay,
