...
# Notes
# -----
# ASN.1 source file://mibs\hp\CPQHOST-MIB
...
class _CpqHoSystemName_Type(DisplayString):
    """Custom type cpqHoSystemName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqHoSystemName_Type.__name__ = "DisplayString"
_CpqHoSystemName_Object = MibScalar
cpqHoSystemName = _CpqHoSystemName_Object(
    (1, 3, 6, 1, 4, 1, 232, 11, 2, 2, 12),
    _CpqHoSystemName_Type()
)
cpqHoSystemName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHoSystemName.setStatus("mandatory")


class _CpqHosysDescr_Type(DisplayString):
    """Custom type cpqHosysDescr based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqHosysDescr_Type.__name__ = "DisplayString"
_CpqHosysDescr_Object = MibScalar
cpqHosysDescr = _CpqHosysDescr_Object(
    (1, 3, 6, 1, 4, 1, 232, 11, 2, 2, 13),
    _CpqHosysDescr_Type()
)
cpqHosysDescr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHosysDescr.setStatus("optional")
...
class _CpqHoFileSysShortDesc_Type(DisplayString):
    """Custom type cpqHoFileSysShortDesc based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_CpqHoFileSysShortDesc_Type.__name__ = "DisplayString"
_CpqHoFileSysShortDesc_Object = MibTableColumn
cpqHoFileSysShortDesc = _CpqHoFileSysShortDesc_Object(
    (1, 3, 6, 1, 4, 1, 232, 11, 2, 4, 1, 1, 9),
    _CpqHoFileSysShortDesc_Type()
)
cpqHoFileSysShortDesc.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHoFileSysShortDesc.setStatus("mandatory")
...
class _CpqHoMibHealthStatusArray_Type(OctetString):
    """Custom type cpqHoMibHealthStatusArray based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_CpqHoMibHealthStatusArray_Type.__name__ = "OctetString"
_CpqHoMibHealthStatusArray_Object = MibScalar
cpqHoMibHealthStatusArray = _CpqHoMibHealthStatusArray_Object(
    (1, 3, 6, 1, 4, 1, 232, 11, 2, 10, 7),
    _CpqHoMibHealthStatusArray_Type()
)
cpqHoMibHealthStatusArray.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cpqHoMibHealthStatusArray.setStatus("mandatory")
...
cpqHoMibHealthStatusArrayChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 232, 0, 11020)
)
cpqHoMibHealthStatusArrayChangeTrap.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("CPQHOST-MIB", "cpqHoTrapFlags"),
        ("CPQHOST-MIB", "cpqHoMibHealthStatusArray"))
)
if mibBuilder.loadTexts:
    cpqHoMibHealthStatusArrayChangeTrap.setStatus(
        ""
    )
...
mibBuilder.exportSymbols(
    ...
    **{"compaq": compaq,
       ...
       "cpqHoMibHealthStatusArrayChangeTrap": cpqHoMibHealthStatusArrayChangeTrap,
       "cpqHostOs": cpqHostOs,
       ...
       "cpqHoSystemName": cpqHoSystemName,
       "cpqHosysDescr": cpqHosysDescr,
       "cpqHoUtil": cpqHoUtil,
       ...
       "cpqHoFileSysShortDesc": cpqHoFileSysShortDesc,
       ...
       "cpqHoMibHealthStatusArray": cpqHoMibHealthStatusArray,
