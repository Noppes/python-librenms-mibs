...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-UDLD-MIB
...
hpicfUdldCompliance.setObjects(
      *(("HP-ICF-UDLD-MIB", "hpicfUdldPortConfigGroup"),
        ("HP-ICF-UDLD-MIB", "hpicfUdldPortStatsGroup"),
        ("HP-ICF-UDLD-MIB", "hpicfUdldNotificationGroup"),
        ("HP-ICF-UDLD-MIB", "hpicfUdldNotificationGroup"))
)
if mibBuilder.loadTexts:
...
hpicfUdldCompliance2.setObjects(
    ("HP-ICF-UDLD-MIB", "hpicfUdldStatsGroup")
)
if mibBuilder.loadTexts:
...
hpicfUdldCompliance3.setObjects(
      *(("HP-ICF-UDLD-MIB", "hpicfUdldPortConfigGroup1"),
        ("HP-ICF-UDLD-MIB", "hpicfUdldPortStatsGroup"),
        ("HP-ICF-UDLD-MIB", "hpicfUdldNotificationGroup"))
)
if mibBuilder.loadTexts:
