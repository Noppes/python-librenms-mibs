...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-RIP
...
_HpicfRipIfConfDoPoison_Type.__name__ = "TruthValue"
...
hpicfRipCompliance.setObjects(
      *(("HP-ICF-RIP", "hpicfRipBaseGroup"),
        ("HP-ICF-RIP", "hpicfRipIfGroup"),
        ("HP-ICF-RIP", "hpicfRipRedistGroup"))
)
if mibBuilder.loadTexts:
