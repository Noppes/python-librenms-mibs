...
# Notes
# -----
# ASN.1 source file://mibs\hp\HP-ICF-SECURITY
...
icfSecurCompliance.setObjects(
      *(("HP-ICF-SECURITY", "icfSnmpSecurityGroup"),
        ("HP-ICF-SECURITY", "icfSecIntruderGroup"))
)
if mibBuilder.loadTexts:
...
icfV1CommunityCompliance.setObjects(
      *(("HP-ICF-SECURITY", "icfV1CommunityGroup"),
        ("HP-ICF-SECURITY", "icfSecIntruderGroup"))
)
if mibBuilder.loadTexts:
