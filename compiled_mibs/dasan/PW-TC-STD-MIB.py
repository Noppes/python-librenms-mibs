# SNMP MIB module (PW-TC-STD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\PW-TC-STD-MIB
...
pwTcStdMIB = ModuleIdentity(
    (1, 3, 6, 1, 2, 1, 188)
)
if mibBuilder.loadTexts:
    pwTcStdMIB.setRevisions(
        ("2009-04-21 00:00",)
    )
