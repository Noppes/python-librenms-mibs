# SNMP MIB module (SLE-TC-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\dasan\SLE-TC-MIB
...
sleTcMib = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 6296, 101, 100)
)
...
mibBuilder.exportSymbols(
    "SLE-TC-MIB",
    **{"SleControlStatusType": SleControlStatusType,
       "SleControlRequestResultType": SleControlRequestResultType,
       "SlePermissionType": SlePermissionType,
       "SleTrafficType": SleTrafficType,
       "SleScopeType": SleScopeType,
       "SleOperStateType": SleOperStateType,
       "SleAdminStateType": SleAdminStateType,
       "SleCardType": SleCardType,
       "SleSystemFileIndexType": SleSystemFileIndexType,
       "sleTcMib": sleTcMib}
)
