# SNMP MIB module (COMMON-TC-4RF) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\4rf\COMMON-TC-4RF
...
fourRFCommonTCModule = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 14817, 2, 4)
)
if mibBuilder.loadTexts:
    fourRFCommonTCModule.setRevisions(
        ("2007-04-30 00:00",
         "2004-02-13 00:00")
    )
...
mibBuilder.exportSymbols(
    "COMMON-TC-4RF",
    **{"FourRFSimpleLedState": FourRFSimpleLedState,
       "FourRFTriColourLedState": FourRFTriColourLedState,
       "FourRFAlarmSeverity": FourRFAlarmSeverity,
       "FourRFAlarmPresent": FourRFAlarmPresent,
       "FourRFAlarmEnabled": FourRFAlarmEnabled,
       "FourRFAlarmStatus": FourRFAlarmStatus,
       "FourRFMHSBStatus": FourRFMHSBStatus,
       "FourRFMHSBCommand": FourRFMHSBCommand,
       "FourRFHardwareVersion": FourRFHardwareVersion,
       "FourRFSerialNumber": FourRFSerialNumber,
       ...
       "FourRFProcessResultType": FourRFProcessResultType,
       "FourRFTftpFileName": FourRFTftpFileName,
       "FourRFFileSize": FourRFFileSize,
       "FourRFFrequency": FourRFFrequency,
       "FourRFTxPower": FourRFTxPower,
       "FourRFChannelWidth": FourRFChannelWidth,
       "FourRFNetworkClockStatus": FourRFNetworkClockStatus,
       "FourRFRSSI": FourRFRSSI,
       "FourRFSNR": FourRFSNR,
       "FourRFModulationType": FourRFModulationType,
       "FourRFTemperature": FourRFTemperature,
       "FourRFErrorCounter": FourRFErrorCounter,
       "FourRFRfBand": FourRFRfBand,
       "FourRFFanStatus": FourRFFanStatus,
       "FourRFClockSource": FourRFClockSource,
       "FourRFNetworkClockSelect": FourRFNetworkClockSelect,
       "FourRFLoopback": FourRFLoopback,
       "FourRFWebUserGroup": FourRFWebUserGroup,
       "FourRFWebUserEnabled": FourRFWebUserEnabled,
       "FourRFTimeZone": FourRFTimeZone,
       "fourRFCommonTCModule": fourRFCommonTCModule}
)
