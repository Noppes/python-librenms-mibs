# SNMP MIB module (CONTEG-DATABUS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\conteg\CONTEG-DATABUS-MIB
...
(contegMgmt,) = mibBuilder.importSymbols(
    "CONTEG-SMI",
    "contegMgmt")
...
contegDatabusMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1)
)
if mibBuilder.loadTexts:
    contegDatabusMIB.setRevisions(
        ("2023-02-07 00:00",
         "2021-06-16 00:00",
         "2020-09-17 00:00")
    )
...
sdbMgmtStsDevices = _SdbMgmtStsDevices_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 1, 1),
...
sdbMgmtStsAddressableDevices = _SdbMgmtStsAddressableDevices_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 1, 2),
...
sdbMgmtStsNewDevices = _SdbMgmtStsNewDevices_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 1, 3),
...
sdbMgmtStsDuplicateDevices = _SdbMgmtStsDuplicateDevices_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 1, 4),
...
sdbMgmtStsRingState = _SdbMgmtStsRingState_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 1, 5),
...
sdbMgmtStsRingBreachIndex = _SdbMgmtStsRingBreachIndex_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 1, 6),
...
sdbMgmtCtrlScan = _SdbMgmtCtrlScan_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 2, 1),
...
sdbMgmtCtrlRenumberAllFromN = _SdbMgmtCtrlRenumberAllFromN_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 2, 2),
...
sdbMgmtCtrlRenumberZeros = _SdbMgmtCtrlRenumberZeros_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 2, 3),
...
sdbMgmtCtrlDevicesTable = _SdbMgmtCtrlDevicesTable_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 2, 4)
)
if mibBuilder.loadTexts:
...
sdbMgmtCtrlDevicesEntry = _SdbMgmtCtrlDevicesEntry_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 2, 4, 1)
)
sdbMgmtCtrlDevicesEntry.setIndexNames(
    (0, "CONTEG-DATABUS-MIB", "sdbMgmtCtrlDevIndex"),
)
if mibBuilder.loadTexts:
...
sdbMgmtCtrlDevIndex = _SdbMgmtCtrlDevIndex_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 2, 4, 1, 1),
...
sdbMgmtCtrlDevUnitAddress = _SdbMgmtCtrlDevUnitAddress_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 2, 4, 1, 2),
...
sdbMgmtCtrlDevHardwareAddress = _SdbMgmtCtrlDevHardwareAddress_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 2, 4, 1, 3),
...
sdbMgmtCtrlDevIsNew = _SdbMgmtCtrlDevIsNew_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 2, 4, 1, 4),
...
sdbMgmtCtrlDevIsDuplicate = _SdbMgmtCtrlDevIsDuplicate_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 1, 2, 4, 1, 5),
...
sdbDevIdSPDMVersion = _SdbDevIdSPDMVersion_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 1),
...
sdbDevIdFirmwareVersion = _SdbDevIdFirmwareVersion_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 2),
...
sdbDevIdBuildNumber = _SdbDevIdBuildNumber_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 3),
...
sdbDevIdSalesOrderNumber = _SdbDevIdSalesOrderNumber_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 4),
...
sdbDevIdProductId = _SdbDevIdProductId_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 5),
...
sdbDevIdSerialNumber = _SdbDevIdSerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 6),
...
sdbDevIdHardwareAddress = _SdbDevIdHardwareAddress_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 7),
...
sdbDevIdMacAddress = _SdbDevIdMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 8),
...
sdbDevIdUnitAddress = _SdbDevIdUnitAddress_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 9),
...
sdbDevIdName = _SdbDevIdName_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 10),
    _SdbDevIdName_Type()
)
...
sdbDevIdLocation = _SdbDevIdLocation_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 11),
...
sdbDevIdVanityTag = _SdbDevIdVanityTag_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 12),
...
sdbDevIdIndex = _SdbDevIdIndex_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 13),
    _SdbDevIdIndex_Type()
)
...
sdbDevIdDeviceType = _SdbDevIdDeviceType_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 14),
...
sdbDevIdLocateUnit = _SdbDevIdLocateUnit_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 15),
...
sdbDevIdConfigType = _SdbDevIdConfigType_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 1, 1, 1, 16),
...
sdbDevCfPhases = _SdbDevCfPhases_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 2, 1, 1, 1),
...
sdbDevCfOutletsTotal = _SdbDevCfOutletsTotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 2, 1, 1, 2),
...
sdbDevCfOutletsSwitched = _SdbDevCfOutletsSwitched_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 2, 1, 1, 3),
...
sdbDevCfOutletsMetered = _SdbDevCfOutletsMetered_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 2, 1, 1, 4),
...
sdbDevCfSensors = _SdbDevCfSensors_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 2, 1, 1, 5),
...
sdbDevCfMaximumLoad = _SdbDevCfMaximumLoad_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 2, 1, 1, 6),
...
sdbDevCfBranches = _SdbDevCfBranches_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 2, 1, 1, 7),
...
sdbDevCfNeutral = _SdbDevCfNeutral_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 2, 1, 1, 8),
...
sdbDevCfTempSensors = _SdbDevCfTempSensors_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 2, 1, 1, 9),
...
sdbDevCfTotals = _SdbDevCfTotals_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 2, 1, 1, 10),
...
sdbDevSsDeviceStatusCode = _SdbDevSsDeviceStatusCode_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 1),
...
sdbDevSsTemperatureAlert = _SdbDevSsTemperatureAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 2),
...
sdbDevSsInputCurrentAlert = _SdbDevSsInputCurrentAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 3),
...
sdbDevSsOutletCurrentAlert = _SdbDevSsOutletCurrentAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 4),
...
sdbDevSsInputVoltageAlert = _SdbDevSsInputVoltageAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 5),
...
sdbDevSsOutletCurrentDropAlert = _SdbDevSsOutletCurrentDropAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 6),
...
sdbDevSsInputCurrentDropAlert = _SdbDevSsInputCurrentDropAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 7),
...
sdbDevSsSensorChangeAlert = _SdbDevSsSensorChangeAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 8),
...
sdbDevSsOutletVoltageDropAlert = _SdbDevSsOutletVoltageDropAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 9),
...
sdbDevSsBranchCurrentAlert = _SdbDevSsBranchCurrentAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 10),
...
sdbDevSsBranchVoltageAlert = _SdbDevSsBranchVoltageAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 11),
...
sdbDevSsNeutralCurrentAlert = _SdbDevSsNeutralCurrentAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 12),
...
sdbDevSsResidualCurrentAlert = _SdbDevSsResidualCurrentAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 13),
...
sdbDevSsHardwareAlert = _SdbDevSsHardwareAlert_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 3, 1, 1, 14),
...
sdbDevRsReboot = _SdbDevRsReboot_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 4, 1, 1, 1),
...
sdbDevRsResetAlerts = _SdbDevRsResetAlerts_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 4, 1, 1, 2),
...
sdbDevRsZeroInputKWhSubtotal = _SdbDevRsZeroInputKWhSubtotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 4, 1, 1, 3),
...
sdbDevRsZeroOutletKWhSubtotal = _SdbDevRsZeroOutletKWhSubtotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 4, 1, 1, 4),
...
sdbDevRsResetPeaksAndDips = _SdbDevRsResetPeaksAndDips_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 4, 1, 1, 5),
...
sdbDevStAutoResetAlerts = _SdbDevStAutoResetAlerts_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 2),
...
sdbDevStExtendedNames = _SdbDevStExtendedNames_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 3),
...
sdbDevStPeakDuration = _SdbDevStPeakDuration_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 4),
...
sdbDevStFixedOutletDelay = _SdbDevStFixedOutletDelay_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 5),
...
sdbDevStPowerSaverMode = _SdbDevStPowerSaverMode_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 6),
...
sdbDevStOutletPowerUpMode = _SdbDevStOutletPowerUpMode_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 7),
...
sdbDevStMaximumTemperature = _SdbDevStMaximumTemperature_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 8),
...
sdbDevStDisplayOrientation = _SdbDevStDisplayOrientation_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 9),
...
sdbDevStLocalAlertReset = _SdbDevStLocalAlertReset_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 10),
...
sdbDevStCurrentDropDetection = _SdbDevStCurrentDropDetection_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 11),
...
sdbDevStUsbMode = _SdbDevStUsbMode_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 13),
...
sdbDevStSensorChangeAlertMode = _SdbDevStSensorChangeAlertMode_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 14),
...
sdbDevStOutletUnlockOverride = _SdbDevStOutletUnlockOverride_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 5, 1, 1, 15),
...
sdbDevInIndex = _SdbDevInIndex_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 1),
    _SdbDevInIndex_Type()
)
...
sdbDevInKWhTotal = _SdbDevInKWhTotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 2),
...
sdbDevInKWhSubtotal = _SdbDevInKWhSubtotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 3),
...
sdbDevInPowerFactor = _SdbDevInPowerFactor_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 4),
...
sdbDevInActualCurrent = _SdbDevInActualCurrent_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 5),
...
sdbDevInPeakCurrent = _SdbDevInPeakCurrent_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 6),
...
sdbDevInActualVoltage = _SdbDevInActualVoltage_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 7),
...
sdbDevInMinVoltage = _SdbDevInMinVoltage_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 8),
...
sdbDevInPowerVoltAmpere = _SdbDevInPowerVoltAmpere_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 9),
...
sdbDevInPowerWatt = _SdbDevInPowerWatt_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 10),
...
sdbDevInMaxAmps = _SdbDevInMaxAmps_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 11),
...
sdbDevInCTRatio = _SdbDevInCTRatio_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 12),
...
sdbDevInName = _SdbDevInName_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 13),
    _SdbDevInName_Type()
)
...
sdbDevInZeroKWhSubtotal = _SdbDevInZeroKWhSubtotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 6, 1, 1, 14),
...
sdbDevOutIndex = _SdbDevOutIndex_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 1, 1, 1),
...
sdbDevOutName = _SdbDevOutName_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 1, 1, 2),
    _SdbDevOutName_Type()
)
...
sdbDevOutMtIndex = _SdbDevOutMtIndex_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 2, 1, 1),
...
sdbDevOutMtKWhTotal = _SdbDevOutMtKWhTotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 2, 1, 2),
...
sdbDevOutMtKWhSubtotal = _SdbDevOutMtKWhSubtotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 2, 1, 3),
...
sdbDevOutMtPowerFactor = _SdbDevOutMtPowerFactor_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 2, 1, 4),
...
sdbDevOutMtActualCurrent = _SdbDevOutMtActualCurrent_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 2, 1, 5),
...
sdbDevOutMtPeakCurrent = _SdbDevOutMtPeakCurrent_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 2, 1, 6),
...
sdbDevOutMtActualVoltage = _SdbDevOutMtActualVoltage_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 2, 1, 7),
...
sdbDevOutMtMaxAmps = _SdbDevOutMtMaxAmps_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 2, 1, 8),
...
sdbDevOutMtCTRatio = _SdbDevOutMtCTRatio_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 2, 1, 9),
...
sdbDevOutMtPowerVoltAmpere = _SdbDevOutMtPowerVoltAmpere_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 2, 1, 10),
...
sdbDevOutMtPowerWatt = _SdbDevOutMtPowerWatt_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 2, 1, 11),
...
sdbDevOutSwIndex = _SdbDevOutSwIndex_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 3, 1, 1),
...
sdbDevOutSwCurrentState = _SdbDevOutSwCurrentState_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 3, 1, 2),
...
sdbDevOutSwScheduled = _SdbDevOutSwScheduled_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 3, 1, 3),
...
sdbDevOutSwUnlock = _SdbDevOutSwUnlock_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 3, 1, 4),
...
sdbDevOutSwIndividualOutletDelay = _SdbDevOutSwIndividualOutletDelay_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 3, 1, 5),
...
sdbDevOutSwReboot = _SdbDevOutSwReboot_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 7, 3, 1, 6),
...
sdbDevMeasuresEntry = _SdbDevMeasuresEntry_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 8, 1, 1)
)
...
sdbDevMsIntTemperature = _SdbDevMsIntTemperature_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 8, 1, 1, 1),
...
sdbDevMsExtTemperature = _SdbDevMsExtTemperature_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 8, 1, 1, 2),
...
sdbDevMsIntTemperaturePeak = _SdbDevMsIntTemperaturePeak_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 8, 1, 1, 3),
...
sdbDevMsExtTemperaturePeak = _SdbDevMsExtTemperaturePeak_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 8, 1, 1, 4),
...
sdbDevMsResidualCurrent = _SdbDevMsResidualCurrent_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 8, 1, 1, 5),
...
sdbDevMsResidualPeak = _SdbDevMsResidualPeak_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 8, 1, 1, 6),
...
sdbDevSnsIndex = _SdbDevSnsIndex_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 8, 2, 1, 1),
...
sdbDevSnsType = _SdbDevSnsType_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 8, 2, 1, 2),
    _SdbDevSnsType_Type()
)
...
sdbDevSnsValue = _SdbDevSnsValue_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 8, 2, 1, 3),
...
sdbDevSnsName = _SdbDevSnsName_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 8, 2, 1, 4),
    _SdbDevSnsName_Type()
)
...
sdbDevPerformanceEntry = _SdbDevPerformanceEntry_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 9, 1, 1)
)
sdbDevPerformanceEntry.setIndexNames(
    (0, "CONTEG-DATABUS-MIB", "sdbDevIdIndex"),
    (0, "CONTEG-DATABUS-MIB", "sdbDevPerformanceIndex"),
)
if mibBuilder.loadTexts:
...
sdbDevPerformanceIndex = _SdbDevPerformanceIndex_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 9, 1, 1, 1),
...
sdbDevPerformanceValue = _SdbDevPerformanceValue_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 9, 1, 1, 2),
...
sdbDevPerformanceMax = _SdbDevPerformanceMax_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 9, 1, 1, 3),
...
sdbDevPerformanceLimit = _SdbDevPerformanceLimit_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 9, 1, 1, 4),
...
sdbDevPerformanceName = _SdbDevPerformanceName_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 9, 1, 1, 5),
...
sdbDevPerformanceResetTable = _SdbDevPerformanceResetTable_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 9, 2)
)
if mibBuilder.loadTexts:
...
sdbDevPerformanceResetEntry = _SdbDevPerformanceResetEntry_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 9, 2, 1)
)
...
sdbDevPerformanceResetReason = _SdbDevPerformanceResetReason_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 9, 2, 1, 1),
...
sdbDevResetUptime = _SdbDevResetUptime_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 9, 2, 1, 2),
...
sdbDevBranchIndex = _SdbDevBranchIndex_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 1),
...
sdbDevBranchKWhTotal = _SdbDevBranchKWhTotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 2),
...
sdbDevBranchKWhSubtotal = _SdbDevBranchKWhSubtotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 3),
...
sdbDevBranchPowerFactor = _SdbDevBranchPowerFactor_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 4),
...
sdbDevBranchActualCurrent = _SdbDevBranchActualCurrent_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 5),
...
sdbDevBranchPeakCurrent = _SdbDevBranchPeakCurrent_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 6),
...
sdbDevBranchActualVoltage = _SdbDevBranchActualVoltage_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 7),
...
sdbDevBranchMinVoltage = _SdbDevBranchMinVoltage_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 8),
...
sdbDevBranchPowerVoltAmpere = _SdbDevBranchPowerVoltAmpere_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 9),
...
sdbDevBranchPowerWatt = _SdbDevBranchPowerWatt_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 10),
...
sdbDevBranchMaxAmps = _SdbDevBranchMaxAmps_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 11),
...
sdbDevBranchCTRatio = _SdbDevBranchCTRatio_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 12),
...
sdbDevBranchName = _SdbDevBranchName_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 13),
...
sdbDevBranchZeroKWhSubtotal = _SdbDevBranchZeroKWhSubtotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 10, 1, 1, 14),
...
sdbDevTotalsIndex = _SdbDevTotalsIndex_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 11, 1, 1, 1),
...
sdbDevTotalsKWhTotal = _SdbDevTotalsKWhTotal_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 11, 1, 1, 2),
...
sdbDevTotalsPowerFactor = _SdbDevTotalsPowerFactor_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 11, 1, 1, 3),
...
sdbDevTotalsActualCurrent = _SdbDevTotalsActualCurrent_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 11, 1, 1, 4),
...
sdbDevTotalsPeakCurrent = _SdbDevTotalsPeakCurrent_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 11, 1, 1, 5),
...
sdbDevTotalsPowerVoltAmpere = _SdbDevTotalsPowerVoltAmpere_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 11, 1, 1, 6),
...
sdbDevTotalsPowerWatt = _SdbDevTotalsPowerWatt_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 11, 1, 1, 7),
...
sdbDevTotalsNeutralCurrent = _SdbDevTotalsNeutralCurrent_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 11, 1, 1, 8),
...
sdbDevTotalsNeutralPeak = _SdbDevTotalsNeutralPeak_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 11, 1, 1, 9),
...
sdbDevTotalsNeutralMaxAmps = _SdbDevTotalsNeutralMaxAmps_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 11, 1, 1, 10),
...
sdbDevTotalsResidualMaxAmps = _SdbDevTotalsResidualMaxAmps_Object(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 1, 2, 11, 1, 1, 11),
...
sdbMIBConformance = _SdbMIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2)
)
_SdbMIBCompliances_ObjectIdentity = ObjectIdentity
sdbMIBCompliances = _SdbMIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 1)
)
_SdbMIBGroups_ObjectIdentity = ObjectIdentity
sdbMIBGroups = _SdbMIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2)
)

# Managed Objects groups

sdbMIBDevIdGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 3)
)
sdbMIBDevIdGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbDevIdSPDMVersion"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdFirmwareVersion"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdSalesOrderNumber"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdProductId"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdSerialNumber"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdHardwareAddress"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdUnitAddress"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdName"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdLocation"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdVanityTag"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdMacAddress"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdBuildNumber"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdDeviceType"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdLocateUnit"),
        ("CONTEG-DATABUS-MIB", "sdbDevIdConfigType"))
)
if mibBuilder.loadTexts:
    sdbMIBDevIdGroup.setStatus("current")

sdbMIBDevCfGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 4)
)
sdbMIBDevCfGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbDevCfPhases"),
        ("CONTEG-DATABUS-MIB", "sdbDevCfOutletsTotal"),
        ("CONTEG-DATABUS-MIB", "sdbDevCfOutletsSwitched"),
        ("CONTEG-DATABUS-MIB", "sdbDevCfOutletsMetered"),
        ("CONTEG-DATABUS-MIB", "sdbDevCfMaximumLoad"),
        ("CONTEG-DATABUS-MIB", "sdbDevCfSensors"),
        ("CONTEG-DATABUS-MIB", "sdbDevCfBranches"),
        ("CONTEG-DATABUS-MIB", "sdbDevCfNeutral"),
        ("CONTEG-DATABUS-MIB", "sdbDevCfTempSensors"),
        ("CONTEG-DATABUS-MIB", "sdbDevCfTotals"))
)
if mibBuilder.loadTexts:
    sdbMIBDevCfGroup.setStatus("current")

sdbMIBDevSsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 5)
)
sdbMIBDevSsGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbDevSsDeviceStatusCode"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsTemperatureAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsInputCurrentAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsOutletCurrentAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsInputVoltageAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsOutletCurrentDropAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsInputCurrentDropAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsSensorChangeAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsOutletVoltageDropAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsBranchCurrentAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsBranchVoltageAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsNeutralCurrentAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsResidualCurrentAlert"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsHardwareAlert"))
)
if mibBuilder.loadTexts:
    sdbMIBDevSsGroup.setStatus("current")

sdbMIBDevRsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 6)
)
sdbMIBDevRsGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbDevRsResetAlerts"),
        ("CONTEG-DATABUS-MIB", "sdbDevRsResetPeaksAndDips"),
        ("CONTEG-DATABUS-MIB", "sdbDevRsReboot"),
        ("CONTEG-DATABUS-MIB", "sdbDevRsZeroInputKWhSubtotal"),
        ("CONTEG-DATABUS-MIB", "sdbDevRsZeroOutletKWhSubtotal"))
)
if mibBuilder.loadTexts:
    sdbMIBDevRsGroup.setStatus("current")

sdbMIBDevStGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 7)
)
sdbMIBDevStGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbDevStAutoResetAlerts"),
        ("CONTEG-DATABUS-MIB", "sdbDevStExtendedNames"),
        ("CONTEG-DATABUS-MIB", "sdbDevStPeakDuration"),
        ("CONTEG-DATABUS-MIB", "sdbDevStLocalAlertReset"),
        ("CONTEG-DATABUS-MIB", "sdbDevStFixedOutletDelay"),
        ("CONTEG-DATABUS-MIB", "sdbDevStPowerSaverMode"),
        ("CONTEG-DATABUS-MIB", "sdbDevStOutletPowerUpMode"),
        ("CONTEG-DATABUS-MIB", "sdbDevStMaximumTemperature"),
        ("CONTEG-DATABUS-MIB", "sdbDevStDisplayOrientation"),
        ("CONTEG-DATABUS-MIB", "sdbDevStCurrentDropDetection"),
        ("CONTEG-DATABUS-MIB", "sdbDevStUsbMode"),
        ("CONTEG-DATABUS-MIB", "sdbDevStSensorChangeAlertMode"),
        ("CONTEG-DATABUS-MIB", "sdbDevStOutletUnlockOverride"))
)
if mibBuilder.loadTexts:
    sdbMIBDevStGroup.setStatus("current")

sdbMIBDevInGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 8)
)
sdbMIBDevInGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbDevInKWhTotal"),
        ("CONTEG-DATABUS-MIB", "sdbDevInKWhSubtotal"),
        ("CONTEG-DATABUS-MIB", "sdbDevInPowerFactor"),
        ("CONTEG-DATABUS-MIB", "sdbDevInActualCurrent"),
        ("CONTEG-DATABUS-MIB", "sdbDevInPeakCurrent"),
        ("CONTEG-DATABUS-MIB", "sdbDevInActualVoltage"),
        ("CONTEG-DATABUS-MIB", "sdbDevInMinVoltage"),
        ("CONTEG-DATABUS-MIB", "sdbDevInPowerVoltAmpere"),
        ("CONTEG-DATABUS-MIB", "sdbDevInPowerWatt"),
        ("CONTEG-DATABUS-MIB", "sdbDevInMaxAmps"),
        ("CONTEG-DATABUS-MIB", "sdbDevInCTRatio"),
        ("CONTEG-DATABUS-MIB", "sdbDevInName"),
        ("CONTEG-DATABUS-MIB", "sdbDevInZeroKWhSubtotal"))
)
if mibBuilder.loadTexts:
    sdbMIBDevInGroup.setStatus("current")

sdbMIBDevOutGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 9)
)
sdbMIBDevOutGroup.setObjects(
    ("CONTEG-DATABUS-MIB", "sdbDevOutName")
)
if mibBuilder.loadTexts:
    sdbMIBDevOutGroup.setStatus("current")

sdbMIBDevOutMtGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 10)
)
sdbMIBDevOutMtGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbDevOutMtKWhTotal"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutMtKWhSubtotal"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutMtPowerFactor"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutMtActualCurrent"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutMtPeakCurrent"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutMtActualVoltage"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutMtMaxAmps"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutMtCTRatio"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutMtPowerVoltAmpere"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutMtPowerWatt"))
)
if mibBuilder.loadTexts:
    sdbMIBDevOutMtGroup.setStatus("current")

sdbMIBDevOutSwGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 11)
)
sdbMIBDevOutSwGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbDevOutSwCurrentState"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutSwScheduled"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutSwUnlock"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutSwIndividualOutletDelay"),
        ("CONTEG-DATABUS-MIB", "sdbDevOutSwReboot"))
)
if mibBuilder.loadTexts:
    sdbMIBDevOutSwGroup.setStatus("current")

sdbMIBDevSensorGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 12)
)
sdbMIBDevSensorGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbDevSnsType"),
        ("CONTEG-DATABUS-MIB", "sdbDevSnsValue"),
        ("CONTEG-DATABUS-MIB", "sdbDevSnsName"),
        ("CONTEG-DATABUS-MIB", "sdbDevMsIntTemperature"),
        ("CONTEG-DATABUS-MIB", "sdbDevMsExtTemperature"),
        ("CONTEG-DATABUS-MIB", "sdbDevMsIntTemperaturePeak"),
        ("CONTEG-DATABUS-MIB", "sdbDevMsExtTemperaturePeak"),
        ("CONTEG-DATABUS-MIB", "sdbDevMsResidualCurrent"),
        ("CONTEG-DATABUS-MIB", "sdbDevMsResidualPeak"))
)
if mibBuilder.loadTexts:
    sdbMIBDevSensorGroup.setStatus("current")

sdbMIBMgmtStatusGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 13)
)
sdbMIBMgmtStatusGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbMgmtStsDevices"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtStsAddressableDevices"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtStsNewDevices"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtStsDuplicateDevices"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtStsRingState"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtStsRingBreachIndex"))
)
if mibBuilder.loadTexts:
    sdbMIBMgmtStatusGroup.setStatus("current")

sdbMIBMgmtControlGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 14)
)
sdbMIBMgmtControlGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbMgmtCtrlScan"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtCtrlRenumberAllFromN"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtCtrlRenumberZeros"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtCtrlDevUnitAddress"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtCtrlDevHardwareAddress"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtCtrlDevIsNew"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtCtrlDevIsDuplicate"))
)
if mibBuilder.loadTexts:
    sdbMIBMgmtControlGroup.setStatus("current")

sdbMIBDevPerformanceGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 15)
)
sdbMIBDevPerformanceGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbDevPerformanceValue"),
        ("CONTEG-DATABUS-MIB", "sdbDevPerformanceMax"),
        ("CONTEG-DATABUS-MIB", "sdbDevPerformanceLimit"),
        ("CONTEG-DATABUS-MIB", "sdbDevPerformanceName"),
        ("CONTEG-DATABUS-MIB", "sdbDevPerformanceResetReason"),
        ("CONTEG-DATABUS-MIB", "sdbDevResetUptime"))
)
if mibBuilder.loadTexts:
...
sdbMIBNotificationGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 2, 1)
)
sdbMIBNotificationGroup.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbDevSsDeviceStatusCodeChanged"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsTemperatureAlertDetected"),
        ...
        ("CONTEG-DATABUS-MIB", "sdbDevSsOutletCurrentDropAlertDetected"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsInputCurrentDropAlertDetected"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsSensorChangeAlertDetected"),
        ("CONTEG-DATABUS-MIB", "sdbMgmtStsRingStateChanged"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsOutletVoltageDropAlertDetected"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsBranchCurrentAlertDetected"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsBranchVoltageAlertDetected"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsNeutralCurrentAlertDetected"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsResidualCurrentAlertDetected"),
        ("CONTEG-DATABUS-MIB", "sdbDevSsHardwareAlertDetected"))
)
if mibBuilder.loadTexts:
...
sdbMIBCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 28402, 12, 1, 2, 1, 1)
)
sdbMIBCompliance.setObjects(
      *(("CONTEG-DATABUS-MIB", "sdbMIBNotificationGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBDevSensorGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBDevOutGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBDevOutMtGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBDevOutSwGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBDevInGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBDevStGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBDevSsGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBDevCfGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBDevIdGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBDevRsGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBMgmtStatusGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBMgmtControlGroup"),
        ("CONTEG-DATABUS-MIB", "sdbMIBDevPerformanceGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"CentiValue": CentiValue,
       ...
       "Second": Second,
       "contegDatabusMIB": contegDatabusMIB,
