...
# Notes
# -----
# ASN.1 source file://mibs\alteonos\ALTEON-CHEETAH-NETWORK-MIB
...
_OspfCurCfgVirtIntfAreaId_Type = IpAddress
...
_OspfNewCfgVirtIntfAreaId_Type = IpAddress
...
ospfNewCfgVirtIntfAreaId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
ospfNewCfgVirtIntfNbr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
ospfCurCfgHostEntry.setIndexNames(
    ...
    (0, "ALTEON-CHEETAH-NETWORK-MIB", "ospfCurCfgHostIpAddr"),
)
if mibBuilder.loadTexts:
...
ospfNewCfgHostEntry.setIndexNames(
    ...
    (0, "ALTEON-CHEETAH-NETWORK-MIB", "ospfNewCfgHostIpAddr"),
)
if mibBuilder.loadTexts:
...
ospfNewCfgHostIpAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
