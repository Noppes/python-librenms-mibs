# SNMP MIB module (NMS-QOS-PIB-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\pbn\NMS-QOS-PIB-MIB
...
(nmsPibToMib,) = mibBuilder.importSymbols(
    "NMS-SMI",
    "nmsPibToMib")
...
nmsQosPIBMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 3320, 18, 2, 1)
)
if mibBuilder.loadTexts:
    nmsQosPIBMIB.setRevisions(
        ("2003-10-16 00:00",)
    )
...
qosDevicePibIncarnationEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosDeviceIncarnationId"),
)
if mibBuilder.loadTexts:
...
qosDeviceAttributeEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosDeviceAttributeId"),
)
if mibBuilder.loadTexts:
...
qosInterfaceTypeEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosInterfaceTypeId"),
)
if mibBuilder.loadTexts:
...
qosCosToDscpEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosCosToDscpCos"),
)
if mibBuilder.loadTexts:
...
qosUnmatchedPolicyEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosUnmatchedPolicyId"),
)
if mibBuilder.loadTexts:
...
qosPolicerEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosPolicerId"),
)
if mibBuilder.loadTexts:
...
qosAggregateEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosAggregateId"),
)
if mibBuilder.loadTexts:
...
qosMacClassificationEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosMacClassificationId"),
)
if mibBuilder.loadTexts:
...
qosIpAclDefinitionEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosIpAclDefinitionId"),
)
if mibBuilder.loadTexts:
...
qosIpAclActionEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosIpAclActionId"),
)
if mibBuilder.loadTexts:
...
qosIfSchedulingPreferenceEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosIfSchedulingPreferenceId"),
)
if mibBuilder.loadTexts:
...
qosIfDropPreferenceEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosIfDropPreferenceId"),
)
if mibBuilder.loadTexts:
...
qosIfDscpAssignmentEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosIfDscpAssignmentId"),
)
if mibBuilder.loadTexts:
...
qosIfTailDropEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosIfTailDropId"),
)
if mibBuilder.loadTexts:
...
qosIfWeightsEntry.setIndexNames(
    (0, "NMS-QOS-PIB-MIB", "qosIfWeightsId"),
)
if mibBuilder.loadTexts:
...
qosDevicePibIncarnationTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosDevicePdpName"),
        ("NMS-QOS-PIB-MIB", "qosDevicePibIncarnation"),
        ("NMS-QOS-PIB-MIB", "qosDevicePibTtl"))
)
if mibBuilder.loadTexts:
...
qosDeviceAttributeTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosDevicePepDomain"),
        ("NMS-QOS-PIB-MIB", "qosDevicePrimaryPdp"),
        ("NMS-QOS-PIB-MIB", "qosDeviceSecondaryPdp"),
        ("NMS-QOS-PIB-MIB", "qosDeviceMaxMessageSize"),
        ("NMS-QOS-PIB-MIB", "qosDeviceCapabilities"))
)
if mibBuilder.loadTexts:
...
qosInterfaceTypeTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosInterfaceQueueType"),
        ("NMS-QOS-PIB-MIB", "qosInterfaceTypeRoles"),
        ("NMS-QOS-PIB-MIB", "qosInterfaceTypeCapabilities"))
)
if mibBuilder.loadTexts:
...
qosDiffServMappingTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosMarkedDscp"),
        ("NMS-QOS-PIB-MIB", "qosL2Cos"))
)
if mibBuilder.loadTexts:
...
qosCosToDscpTableGroup.setObjects(
    ("NMS-QOS-PIB-MIB", "qosCosToDscpDscp")
)
if mibBuilder.loadTexts:
...
qosUnmatchedPolicyTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosUnmatchedPolicyRole"),
        ("NMS-QOS-PIB-MIB", "qosUnmatchedPolicyDirection"),
        ("NMS-QOS-PIB-MIB", "qosUnmatchedPolicyDscp"),
        ("NMS-QOS-PIB-MIB", "qosUnmatchedPolicyDscpTrusted"),
        ("NMS-QOS-PIB-MIB", "qosUnmatchPolMicroFlowPolicerId"),
        ("NMS-QOS-PIB-MIB", "qosUnmatchedPolicyAggregateId"))
)
if mibBuilder.loadTexts:
...
qosPolicerTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosPolicerRate"),
        ("NMS-QOS-PIB-MIB", "qosPolicerNormalBurst"),
        ("NMS-QOS-PIB-MIB", "qosPolicerExcessBurst"),
        ("NMS-QOS-PIB-MIB", "qosPolicerAction"))
)
if mibBuilder.loadTexts:
...
qosAggregateTableGroup.setObjects(
    ("NMS-QOS-PIB-MIB", "qosAggregatePolicerId")
)
if mibBuilder.loadTexts:
...
qosMacClassificationTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosDstMacVlan"),
        ("NMS-QOS-PIB-MIB", "qosDstMacAddress"),
        ("NMS-QOS-PIB-MIB", "qosDstMacCos"))
)
if mibBuilder.loadTexts:
...
qosIpAceTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosIpAceDstAddr"),
        ("NMS-QOS-PIB-MIB", "qosIpAceDstAddrMask"),
        ("NMS-QOS-PIB-MIB", "qosIpAceSrcAddr"),
        ("NMS-QOS-PIB-MIB", "qosIpAceSrcAddrMask"),
        ("NMS-QOS-PIB-MIB", "qosIpAceDscpMin"),
        ("NMS-QOS-PIB-MIB", "qosIpAceDscpMax"),
        ("NMS-QOS-PIB-MIB", "qosIpAceProtocol"),
        ("NMS-QOS-PIB-MIB", "qosIpAceDstL4PortMin"),
        ("NMS-QOS-PIB-MIB", "qosIpAceDstL4PortMax"),
        ("NMS-QOS-PIB-MIB", "qosIpAceSrcL4PortMin"),
        ("NMS-QOS-PIB-MIB", "qosIpAceSrcL4PortMax"),
        ("NMS-QOS-PIB-MIB", "qosIpAcePermit"))
)
if mibBuilder.loadTexts:
...
qosIpAclDefinitionTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosIpAclId"),
        ("NMS-QOS-PIB-MIB", "qosIpAceOrder"),
        ("NMS-QOS-PIB-MIB", "qosIpAclDefAceId"))
)
if mibBuilder.loadTexts:
...
qosIpAclActionTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosIpAclActAclId"),
        ("NMS-QOS-PIB-MIB", "qosIpAclInterfaceRoles"),
        ("NMS-QOS-PIB-MIB", "qosIpAclInterfaceDirection"),
        ("NMS-QOS-PIB-MIB", "qosIpAclOrder"),
        ("NMS-QOS-PIB-MIB", "qosIpAclDscp"),
        ("NMS-QOS-PIB-MIB", "qosIpAclDscpTrusted"),
        ("NMS-QOS-PIB-MIB", "qosIpAclMicroFlowPolicerId"),
...
qosIfSchedulingPreferencesTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosIfSchedulingRoles"),
        ("NMS-QOS-PIB-MIB", "qosIfSchedulingPreference"),
        ("NMS-QOS-PIB-MIB", "qosIfSchedulingDiscipline"),
        ("NMS-QOS-PIB-MIB", "qosIfSchedulingQueueType"))
)
if mibBuilder.loadTexts:
...
qosIfDropPreferenceTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosIfDropRoles"),
        ("NMS-QOS-PIB-MIB", "qosIfDropPreference"),
        ("NMS-QOS-PIB-MIB", "qosIfDropDiscipline"))
)
if mibBuilder.loadTexts:
...
qosIfDscpAssignmentTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosIfDscpRoles"),
        ("NMS-QOS-PIB-MIB", "qosIfQueueType"),
        ("NMS-QOS-PIB-MIB", "qosIfDscp"),
        ("NMS-QOS-PIB-MIB", "qosIfQueue"),
        ("NMS-QOS-PIB-MIB", "qosIfThresholdSet"))
)
if mibBuilder.loadTexts:
...
qosIfRedTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosIfRedRoles"),
        ("NMS-QOS-PIB-MIB", "qosIfRedNumThresholdSets"),
        ("NMS-QOS-PIB-MIB", "qosIfRedThresholdSet"),
        ("NMS-QOS-PIB-MIB", "qosIfRedThresholdSetLower"),
        ("NMS-QOS-PIB-MIB", "qosIfRedThresholdSetUpper"))
)
if mibBuilder.loadTexts:
...
qosIfTailDropTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosIfTailDropRoles"),
        ("NMS-QOS-PIB-MIB", "qosIfTailDropNumThresholdSets"),
        ("NMS-QOS-PIB-MIB", "qosIfTailDropThresholdSet"),
        ("NMS-QOS-PIB-MIB", "qosIfTailDropThresholdSetValue"))
)
if mibBuilder.loadTexts:
...
qosIfWeightsTableGroup.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosIfWeightsRoles"),
        ("NMS-QOS-PIB-MIB", "qosIfWeightsNumQueues"),
        ("NMS-QOS-PIB-MIB", "qosIfWeightsQueue"),
        ("NMS-QOS-PIB-MIB", "qosIfWeightsDrainSize"),
        ("NMS-QOS-PIB-MIB", "qosIfWeightsQueueSize"))
)
if mibBuilder.loadTexts:
...
qosPIBCompliance.setObjects(
      *(("NMS-QOS-PIB-MIB", "qosDevicePibIncarnationTableGroup"),
        ("NMS-QOS-PIB-MIB", "qosDeviceAttributeTableGroup"),
        ("NMS-QOS-PIB-MIB", "qosInterfaceTypeTableGroup"))
)
if mibBuilder.loadTexts:
