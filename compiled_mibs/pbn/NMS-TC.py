# SNMP MIB module (NMS-TC) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\pbn\NMS-TC
...
(nmsModules,) = mibBuilder.importSymbols(
    "NMS-SMI",
    "nmsModules")
...
nmsTextualConventions = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 3320, 12, 1)
)
if mibBuilder.loadTexts:
    nmsTextualConventions.setRevisions(
        ("2003-10-16 00:00",)
    )
...
mibBuilder.exportSymbols(
    "NMS-TC",
    **{"NMSNetworkProtocol": NMSNetworkProtocol,
       "NMSNetworkAddress": NMSNetworkAddress,
       ...
       "NMSPort": NMSPort,
       "NMSIpProtocol": NMSIpProtocol,
       "NMSLocationClass": NMSLocationClass,
       "NMSLocationSpecifier": NMSLocationSpecifier,
       "NMSInetAddressMask": NMSInetAddressMask,
       "NMSAbsZeroBasedCounter32": NMSAbsZeroBasedCounter32,
       "NMSSnapShotAbsCounter32": NMSSnapShotAbsCounter32,
       "NMSAlarmSeverity": NMSAlarmSeverity,
       ...
       "NMSMilliSeconds": NMSMilliSeconds,
       "MicroSeconds": MicroSeconds,
       "nmsTextualConventions": nmsTextualConventions}
)
