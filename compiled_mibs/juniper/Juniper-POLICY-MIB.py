...
# Notes
# -----
# ASN.1 source file://mibs\juniper\junose\Juniper-POLICY-MIB
...
_JuniPolicyTrap_ObjectIdentity = ObjectIdentity
juniPolicyTrap = _JuniPolicyTrap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 27, 0)
)
...
_JuniPolicyTrapObject_ObjectIdentity = ObjectIdentity
juniPolicyTrapObject = _JuniPolicyTrapObject_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 27, 1, 8)
)


class _JuniPolicyResourceSlotNumber_Type(Integer32):
    """Custom type juniPolicyResourceSlotNumber based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_JuniPolicyResourceSlotNumber_Type.__name__ = "Integer32"
_JuniPolicyResourceSlotNumber_Object = MibScalar
juniPolicyResourceSlotNumber = _JuniPolicyResourceSlotNumber_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 27, 1, 8, 1),
    _JuniPolicyResourceSlotNumber_Type()
)
juniPolicyResourceSlotNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    juniPolicyResourceSlotNumber.setStatus("current")


class _JuniPolicyResourcePoolType_Type(Integer32):
    """Custom type juniPolicyResourcePoolType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_JuniPolicyResourcePoolType_Type.__name__ = "Integer32"
_JuniPolicyResourcePoolType_Object = MibScalar
juniPolicyResourcePoolType = _JuniPolicyResourcePoolType_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 27, 1, 8, 2),
    _JuniPolicyResourcePoolType_Type()
)
juniPolicyResourcePoolType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    juniPolicyResourcePoolType.setStatus("current")


class _JuniPolicyResourceDirection_Type(Integer32):
    """Custom type juniPolicyResourceDirection based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_JuniPolicyResourceDirection_Type.__name__ = "Integer32"
_JuniPolicyResourceDirection_Object = MibScalar
juniPolicyResourceDirection = _JuniPolicyResourceDirection_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 27, 1, 8, 3),
    _JuniPolicyResourceDirection_Type()
)
juniPolicyResourceDirection.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    juniPolicyResourceDirection.setStatus("current")
...
juniPolicyResourceExhaustion = NotificationType(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 27, 0, 1)
)
juniPolicyResourceExhaustion.setObjects(
      *(("Juniper-POLICY-MIB", "juniPolicyResourceSlotNumber"),
        ("Juniper-POLICY-MIB", "juniPolicyResourcePoolType"),
        ("Juniper-POLICY-MIB", "juniPolicyResourceDirection"))
)
if mibBuilder.loadTexts:
    juniPolicyResourceExhaustion.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"JuniClaclPortOperator": JuniClaclPortOperator,
       ...
       "juniPolicyTrap": juniPolicyTrap,
       "juniPolicyResourceExhaustion": juniPolicyResourceExhaustion,
       ...
       "juniPolicyTrapObject": juniPolicyTrapObject,
       "juniPolicyResourceSlotNumber": juniPolicyResourceSlotNumber,
       "juniPolicyResourcePoolType": juniPolicyResourcePoolType,
       "juniPolicyResourceDirection": juniPolicyResourceDirection,
