...
# Notes
# -----
# ASN.1 source file://mibs\juniper\junose\Juniper-REDUNDANCY-MIB
...
juniLcRedundancyStatus = _JuniLcRedundancyStatus_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 74, 1, 4)
)


class _JuniLcRedundancyActiveSlot_Type(Integer32):
    """Custom type juniLcRedundancyActiveSlot based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_JuniLcRedundancyActiveSlot_Type.__name__ = "Integer32"
_JuniLcRedundancyActiveSlot_Object = MibScalar
juniLcRedundancyActiveSlot = _JuniLcRedundancyActiveSlot_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 74, 1, 4, 1),
    _JuniLcRedundancyActiveSlot_Type()
)
juniLcRedundancyActiveSlot.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    juniLcRedundancyActiveSlot.setStatus("current")


class _JuniLcRedundancyStandbySlot_Type(Integer32):
    """Custom type juniLcRedundancyStandbySlot based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_JuniLcRedundancyStandbySlot_Type.__name__ = "Integer32"
_JuniLcRedundancyStandbySlot_Object = MibScalar
juniLcRedundancyStandbySlot = _JuniLcRedundancyStandbySlot_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 74, 1, 4, 2),
    _JuniLcRedundancyStandbySlot_Type()
)
juniLcRedundancyStandbySlot.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    juniLcRedundancyStandbySlot.setStatus("current")
_JuniLcRedundancyLastResetReason_Type = JuniLcRedundancyResetReason
_JuniLcRedundancyLastResetReason_Object = MibScalar
juniLcRedundancyLastResetReason = _JuniLcRedundancyLastResetReason_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 74, 1, 4, 3),
    _JuniLcRedundancyLastResetReason_Type()
)
juniLcRedundancyLastResetReason.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    juniLcRedundancyLastResetReason.setStatus("current")
...
juniLcRedundancyActivationType = _JuniLcRedundancyActivationType_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 74, 1, 4, 4),
    _JuniLcRedundancyActivationType_Type()
)
juniLcRedundancyActivationType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    juniLcRedundancyActivationType.setStatus("current")
_JuniLcRedundancyHaActiveTime_Type = TimeTicks
_JuniLcRedundancyHaActiveTime_Object = MibScalar
juniLcRedundancyHaActiveTime = _JuniLcRedundancyHaActiveTime_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 74, 1, 4, 5),
    _JuniLcRedundancyHaActiveTime_Type()
)
juniLcRedundancyHaActiveTime.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    juniLcRedundancyHaActiveTime.setStatus("current")
_JuniLcRedundancySwitchoverTime_Type = TimeTicks
_JuniLcRedundancySwitchoverTime_Object = MibScalar
juniLcRedundancySwitchoverTime = _JuniLcRedundancySwitchoverTime_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 74, 1, 4, 6),
    _JuniLcRedundancySwitchoverTime_Type()
)
juniLcRedundancySwitchoverTime.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    juniLcRedundancySwitchoverTime.setStatus("current")
...
juniLcRedundancySwitchoverNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 74, 0, 7)
)
juniLcRedundancySwitchoverNotification.setObjects(
      *(("Juniper-REDUNDANCY-MIB", "juniLcRedundancyActivationType"),
        ("Juniper-REDUNDANCY-MIB", "juniLcRedundancyActiveSlot"),
        ("Juniper-REDUNDANCY-MIB", "juniLcRedundancyLastResetReason"),
        ("Juniper-REDUNDANCY-MIB", "juniLcRedundancyStandbySlot"),
        ("Juniper-REDUNDANCY-MIB", "juniLcRedundancySwitchoverTime"))
)
if mibBuilder.loadTexts:
    juniLcRedundancySwitchoverNotification.setStatus(
        "current"
    )

juniLcRedundancyStateEnabledNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 74, 0, 8)
)
juniLcRedundancyStateEnabledNotification.setObjects(
      *(("Juniper-REDUNDANCY-MIB", "juniLcRedundancyActiveSlot"),
        ("Juniper-REDUNDANCY-MIB", "juniLcRedundancyStandbySlot"),
        ("Juniper-REDUNDANCY-MIB", "juniLcRedundancyHaActiveTime"))
)
if mibBuilder.loadTexts:
    juniLcRedundancyStateEnabledNotification.setStatus(
        "current"
    )

juniLcRedundancyStateDisabledNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 74, 0, 9)
)
juniLcRedundancyStateDisabledNotification.setObjects(
      *(("Juniper-REDUNDANCY-MIB", "juniLcRedundancyActiveSlot"),
        ("Juniper-REDUNDANCY-MIB", "juniLcRedundancyStandbySlot"),
        ("Juniper-REDUNDANCY-MIB", "juniLcRedundancyHaActiveTime"))
)
if mibBuilder.loadTexts:
    juniLcRedundancyStateDisabledNotification.setStatus(
        "current"
    )
...
juniRedundancyNotificationGroup.setObjects(
      *(("Juniper-REDUNDANCY-MIB", "juniRedundancyColdSwitchoverNotification"),
        ...
        ("Juniper-REDUNDANCY-MIB", "juniLcRedundancySwitchoverNotification"),
        ("Juniper-REDUNDANCY-MIB", "juniLcRedundancyStateEnabledNotification"),
...
mibBuilder.exportSymbols(
    ...
    **{"JuniRedundancyState": JuniRedundancyState,
       ...
       "JuniLcRedundancySystemActivationType": JuniLcRedundancySystemActivationType,
       "JuniLcRedundancyResetReason": JuniLcRedundancyResetReason,
       ...
       "juniLcRedundancySwitchoverNotification": juniLcRedundancySwitchoverNotification,
       "juniLcRedundancyStateEnabledNotification": juniLcRedundancyStateEnabledNotification,
       "juniLcRedundancyStateDisabledNotification": juniLcRedundancyStateDisabledNotification,
       ...
       "juniLcRedundancyStatus": juniLcRedundancyStatus,
       "juniLcRedundancyActiveSlot": juniLcRedundancyActiveSlot,
       "juniLcRedundancyStandbySlot": juniLcRedundancyStandbySlot,
       "juniLcRedundancyLastResetReason": juniLcRedundancyLastResetReason,
       "juniLcRedundancyActivationType": juniLcRedundancyActivationType,
       "juniLcRedundancyHaActiveTime": juniLcRedundancyHaActiveTime,
       "juniLcRedundancySwitchoverTime": juniLcRedundancySwitchoverTime,
