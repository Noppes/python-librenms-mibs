...
# Notes
# -----
# ASN.1 source file://mibs\juniper\junose\Juniper-PPP-MIB
...
_JuniPppGlobalConfig_ObjectIdentity = ObjectIdentity
juniPppGlobalConfig = _JuniPppGlobalConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 11, 1, 9)
)
_JuniPppPeerIpAddressOptional_Type = JuniEnable
_JuniPppPeerIpAddressOptional_Object = MibScalar
juniPppPeerIpAddressOptional = _JuniPppPeerIpAddressOptional_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 11, 1, 9, 1),
    _JuniPppPeerIpAddressOptional_Type()
)
juniPppPeerIpAddressOptional.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    juniPppPeerIpAddressOptional.setStatus("current")
_JuniPppGeneral_ObjectIdentity = ObjectIdentity
juniPppGeneral = _JuniPppGeneral_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 11, 1, 10)
)
_JuniPppInterfaceName_Type = DisplayString
_JuniPppInterfaceName_Object = MibScalar
juniPppInterfaceName = _JuniPppInterfaceName_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 11, 1, 10, 1),
    _JuniPppInterfaceName_Type()
)
juniPppInterfaceName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    juniPppInterfaceName.setStatus("current")
_JuniPppUserName_Type = DisplayString
_JuniPppUserName_Object = MibScalar
juniPppUserName = _JuniPppUserName_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 11, 1, 10, 2),
    _JuniPppUserName_Type()
)
juniPppUserName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    juniPppUserName.setStatus("current")
_JuniPppDefectiveSlotInformation_Type = DisplayString
_JuniPppDefectiveSlotInformation_Object = MibScalar
juniPppDefectiveSlotInformation = _JuniPppDefectiveSlotInformation_Object(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 11, 1, 10, 3),
    _JuniPppDefectiveSlotInformation_Type()
)
juniPppDefectiveSlotInformation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    juniPppDefectiveSlotInformation.setStatus("current")
_JuniPppTraps_ObjectIdentity = ObjectIdentity
juniPppTraps = _JuniPppTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 11, 2)
)
...
if mibBuilder.loadTexts:
    juniPppIpGroup6.setStatus("obsolete")
...
juniPppIpGroup7 = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 11, 4, 2, 40)
)
juniPppIpGroup7.setObjects(
      *(("Juniper-PPP-MIB", "juniPppIpServiceStatus"),
        ("Juniper-PPP-MIB", "juniPppIpTerminateReason"),
        ("Juniper-PPP-MIB", "juniPppIpTerminateNegFailOption"),
        ("Juniper-PPP-MIB", "juniPppIpLocalIpAddress"),
        ...
        ("Juniper-PPP-MIB", "juniPppIpConfigPromptIpcpDnsOption"),
        ("Juniper-PPP-MIB", "juniPppIpConfigIpcpLockout"),
        ("Juniper-PPP-MIB", "juniPppPeerIpAddressOptional"))
)
if mibBuilder.loadTexts:
    juniPppIpGroup7.setStatus("current")


# Notification objects

juniPppFpgaCorruptionDetection = NotificationType(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 11, 2, 1)
)
juniPppFpgaCorruptionDetection.setObjects(
      *(("Juniper-PPP-MIB", "juniPppInterfaceName"),
        ("Juniper-PPP-MIB", "juniPppUserName"),
        ("Juniper-PPP-MIB", "juniPppDefectiveSlotInformation"))
)
if mibBuilder.loadTexts:
    juniPppFpgaCorruptionDetection.setStatus(
        "current"
    )
...
juniPppCompliance17 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 4874, 2, 2, 11, 4, 1, 17)
)
juniPppCompliance17.setObjects(
      *(("Juniper-PPP-MIB", "juniPppLcpGroup8"),
        ("Juniper-PPP-MIB", "juniPppIpGroup7"),
        ("Juniper-PPP-MIB", "juniPppOsiGroup2"),
        ("Juniper-PPP-MIB", "juniPppSessionGroup2"),
        ("Juniper-PPP-MIB", "juniPppSummaryBasicGroup3"),
        ("Juniper-PPP-MIB", "juniPppIpv6Group2"),
...
mibBuilder.exportSymbols(
    ...
    **{"JuniPppAuthentication": JuniPppAuthentication,
       ...
       "juniPppGlobalConfig": juniPppGlobalConfig,
       "juniPppPeerIpAddressOptional": juniPppPeerIpAddressOptional,
       "juniPppGeneral": juniPppGeneral,
       "juniPppInterfaceName": juniPppInterfaceName,
       "juniPppUserName": juniPppUserName,
       "juniPppDefectiveSlotInformation": juniPppDefectiveSlotInformation,
       "juniPppTraps": juniPppTraps,
       "juniPppFpgaCorruptionDetection": juniPppFpgaCorruptionDetection,
       ...
       "juniPppIpGroup7": juniPppIpGroup7}
)
