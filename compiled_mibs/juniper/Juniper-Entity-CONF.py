# SNMP MIB module (Juniper-Entity-CONF) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\juniper\junose\Juniper-Entity-CONF
...
juniEntityAgent = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 13)
)
if mibBuilder.loadTexts:
    juniEntityAgent.setRevisions(
        ("2002-09-06 16:54",
         "2001-04-27 13:16")
    )
...
juniEntityAgentV1 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 13, 1)
)
if mibBuilder.loadTexts:
    juniEntityAgentV1.setProductRelease("""\
Version 1 of the logical Entity component of the JUNOSe SNMP agent.
        ...
        system releases.""")
if mibBuilder.loadTexts:
    juniEntityAgentV1.setStatus(
        "obsolete"
    )

juniEntityAgentV2 = AgentCapabilities(
    (1, 3, 6, 1, 4, 1, 4874, 5, 2, 13, 2)
)
if mibBuilder.loadTexts:
    juniEntityAgentV2.setProductRelease("""\
...
mibBuilder.exportSymbols(
    ...
    **{"juniEntityAgent": juniEntityAgent,
       "juniEntityAgentV1": juniEntityAgentV1,
       "juniEntityAgentV2": juniEntityAgentV2}
)
