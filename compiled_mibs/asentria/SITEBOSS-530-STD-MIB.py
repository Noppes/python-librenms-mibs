# SNMP MIB module (SITEBOSS-530-STD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\asentria\SITEBOSS-530-STD-MIB
...
pdNextGen = _PdNextGen_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1, 5, 4)
)
_PdnTable_Object = MibTable
pdnTable = _PdnTable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1, 5, 4, 1)
)
if mibBuilder.loadTexts:
    pdnTable.setStatus("current")
_PdnEntry_Object = MibTableRow
pdnEntry = _PdnEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1, 5, 4, 1, 1)
)
pdnEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "pdnIndexPD"),
    (0, "SITEBOSS-530-STD-MIB", "pdnIndexOutput"),
)
if mibBuilder.loadTexts:
...
esPointConfigTempEntry = _EsPointConfigTempEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 2, 1, 1)
)
esPointConfigTempEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "espcTempIndexES"),
    (0, "SITEBOSS-530-STD-MIB", "espcTempIndexPoint"),
)
if mibBuilder.loadTexts:
...
esPointConfigCCEntry = _EsPointConfigCCEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 2, 2, 1)
)
esPointConfigCCEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "espcCCIndexES"),
    (0, "SITEBOSS-530-STD-MIB", "espcCCIndexPoint"),
)
if mibBuilder.loadTexts:
...
esPointConfigHumidEntry = _EsPointConfigHumidEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 2, 3, 1)
)
esPointConfigHumidEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "espcHumidIndexES"),
    (0, "SITEBOSS-530-STD-MIB", "espcHumidIndexPoint"),
)
if mibBuilder.loadTexts:
...
esPointConfigOutputEntry = _EsPointConfigOutputEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 2, 6, 1)
)
esPointConfigOutputEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "espcOutputIndexES"),
    (0, "SITEBOSS-530-STD-MIB", "espcOutputIndexPoint"),
)
if mibBuilder.loadTexts:
...
espcOutputActiveTrapnum = _EspcOutputActiveTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 2, 6, 1, 13),
...
eth1Address = _Eth1Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 1, 1, 1, 2),
    _Eth1Address_Type()
)
...
eth1SubnetMask = _Eth1SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 1, 1, 1, 3),
...
eth1Router = _Eth1Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 1, 1, 1, 4),
    _Eth1Router_Type()
)
...
eth1MAC = _Eth1MAC_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 1, 1, 1, 6),
    _Eth1MAC_Type()
)
...
eth2Address = _Eth2Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 1, 1, 2, 2),
    _Eth2Address_Type()
)
...
eth2SubnetMask = _Eth2SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 1, 1, 2, 3),
...
eth2Router = _Eth2Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 1, 1, 2, 4),
    _Eth2Router_Type()
)
...
eth2MAC = _Eth2MAC_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 1, 1, 2, 6),
    _Eth2MAC_Type()
)
...
ftpPushPushFileEntry = _FtpPushPushFileEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 9, 8, 1)
)
ftpPushPushFileEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "ftpPushPushFileIndex"),
)
if mibBuilder.loadTexts:
...
ftpPushRemoteFileEntry = _FtpPushRemoteFileEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 9, 11, 1)
)
ftpPushRemoteFileEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "ftpPushRemoteFileIndex"),
)
if mibBuilder.loadTexts:
...
pppDialNumber = _PppDialNumber_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 10, 1, 2),
    _PppDialNumber_Type()
)
...
pppDialIdleTimeout = _PppDialIdleTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 10, 1, 5),
...
pppDialRetries = _PppDialRetries_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 10, 1, 6),
...
pppDialCDTimeout = _PppDialCDTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 10, 1, 7),
...
pppDialLoginTimeout = _PppDialLoginTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 10, 1, 8),
...
pppDialMdmInit = _PppDialMdmInit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 10, 1, 9),
...
pppDialSuggestIP = _PppDialSuggestIP_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 10, 1, 10),
...
pppDialPlainLogin = _PppDialPlainLogin_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 10, 1, 11),
...
pppHostIdleTimeout = _PppHostIdleTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 10, 2, 2),
...
pppHostLocalIP = _PppHostLocalIP_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 10, 2, 3),
...
pppHostRemoteIP = _PppHostRemoteIP_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 10, 2, 4),
...
rtsFileIndex = _RtsFileIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 13, 1, 1, 1),
    _RtsFileIndex_Type()
)
...
rtsAlarmsShowAnswer = _RtsAlarmsShowAnswer_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 13, 2, 2),
...
rtsAlarmsReqXON = _RtsAlarmsReqXON_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 13, 2, 3),
...
rtsAlarmsTimeout = _RtsAlarmsTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 13, 2, 4),
...
rtsAlarmsEmptyClose = _RtsAlarmsEmptyClose_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 13, 2, 5),
...
rtsAlarmsPushHost = _RtsAlarmsPushHost_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 13, 2, 6),
...
rtsAlarmsPushPort = _RtsAlarmsPushPort_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 13, 2, 7),
...
rtsAlarmsPushRetryTimer = _RtsAlarmsPushRetryTimer_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 13, 2, 8),
...
trapIncludeDateTime = _TrapIncludeDateTime_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 14, 1, 1),
...
trapIncludeSiteName = _TrapIncludeSiteName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 14, 1, 2),
...
trapIncludeSensorID = _TrapIncludeSensorID_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 14, 1, 3),
...
trapIncludeUDName = _TrapIncludeUDName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 14, 1, 4),
...
trapIncludeUDState = _TrapIncludeUDState_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 14, 1, 5),
...
trapIncludeSourceAddress = _TrapIncludeSourceAddress_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 14, 1, 6),
...
routeTestAddressEntry = _RouteTestAddressEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 15, 3, 1)
)
routeTestAddressEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "routeTestAddressIndex"),
)
if mibBuilder.loadTexts:
...
wirelessConnCheckInterval = _WirelessConnCheckInterval_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 16, 20, 2),
...
wirelessConnFailThreshold = _WirelessConnFailThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 16, 20, 3),
...
wirelessConnIP1 = _WirelessConnIP1_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 16, 20, 10),
...
wirelessConnIP2 = _WirelessConnIP2_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 16, 20, 11),
...
ethExpan = _EthExpan_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 20)
)
_EthExpanIp_Type = IpAddress
_EthExpanIp_Object = MibScalar
ethExpanIp = _EthExpanIp_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 20, 1),
    _EthExpanIp_Type()
)
ethExpanIp.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ethExpanIp.setStatus("current")
_EthExpanMask_Type = IpAddress
_EthExpanMask_Object = MibScalar
ethExpanMask = _EthExpanMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 20, 2),
    _EthExpanMask_Type()
)
ethExpanMask.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ethExpanMask.setStatus("current")
_EthExpanCardTable_Object = MibTable
ethExpanCardTable = _EthExpanCardTable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 20, 3)
)
if mibBuilder.loadTexts:
    ethExpanCardTable.setStatus("current")
_EthExpanCardEntry_Object = MibTableRow
ethExpanCardEntry = _EthExpanCardEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 20, 3, 1)
)
ethExpanCardEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "ethExpanCardIndex"),
)
if mibBuilder.loadTexts:
    ethExpanCardEntry.setStatus("current")


class _EthExpanCardIndex_Type(Integer32):
    """Custom type ethExpanCardIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2),
    )
...
_EthExpanCardIndex_Type.__name__ = "Integer32"
_EthExpanCardIndex_Object = MibTableColumn
ethExpanCardIndex = _EthExpanCardIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 20, 3, 1, 1),
    _EthExpanCardIndex_Type()
)
ethExpanCardIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ethExpanCardIndex.setStatus("current")
_EthExpanCardMAC_Type = DisplayString
_EthExpanCardMAC_Object = MibTableColumn
ethExpanCardMAC = _EthExpanCardMAC_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 20, 3, 1, 2),
    _EthExpanCardMAC_Type()
)
ethExpanCardMAC.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    ethExpanCardMAC.setStatus("current")
_EthExpanDHCP_ObjectIdentity = ObjectIdentity
ethExpanDHCP = _EthExpanDHCP_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 20, 6)
)
_EthExpanDHCPStartIp_Type = IpAddress
_EthExpanDHCPStartIp_Object = MibScalar
ethExpanDHCPStartIp = _EthExpanDHCPStartIp_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 20, 6, 1),
    _EthExpanDHCPStartIp_Type()
)
ethExpanDHCPStartIp.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ethExpanDHCPStartIp.setStatus("current")
_EthExpanDHCPLeaseTime_Type = Integer32
_EthExpanDHCPLeaseTime_Object = MibScalar
ethExpanDHCPLeaseTime = _EthExpanDHCPLeaseTime_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 20, 6, 2),
    _EthExpanDHCPLeaseTime_Type()
)
ethExpanDHCPLeaseTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    ethExpanDHCPLeaseTime.setStatus("current")
_Ipv6_ObjectIdentity = ObjectIdentity
ipv6 = _Ipv6_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 21)
)
_Ipv6DefaultRouter_Type = DisplayString
_Ipv6DefaultRouter_Object = MibScalar
ipv6DefaultRouter = _Ipv6DefaultRouter_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 21, 1),
...
cpeIndex = _CpeIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 4, 22, 1, 1, 1),
    _CpeIndex_Type()
)
...
modemCLIDNumberEntry = _ModemCLIDNumberEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 5, 8, 2, 1)
)
modemCLIDNumberEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "modemCLIDNumberIndex"),
)
if mibBuilder.loadTexts:
...
modemCLIDNumberIndex = _ModemCLIDNumberIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 5, 8, 2, 1, 1),
...
time = _Time_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 8)
)
_Clock_Type = DisplayString
_Clock_Object = MibScalar
clock = _Clock_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 8, 1),
    _Clock_Type()
)
...
secUserChallengeExpiration = _SecUserChallengeExpiration_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 11, 2, 1, 27),
...
evLogStoreAlarm = _EvLogStoreAlarm_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 1, 3, 2),
...
evLogMaxSize = _EvLogMaxSize_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 1, 3, 3),
    _EvLogMaxSize_Type()
)
...
evLogStoreSensor = _EvLogStoreSensor_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 1, 3, 4),
...
evLogTimeStampAlarms = _EvLogTimeStampAlarms_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 1, 3, 5),
...
evLogPrependName = _EvLogPrependName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 1, 3, 6),
...
evdFilterAction = _EvdFilterAction_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 2, 1, 2),
...
evdWildCardChar = _EvdWildCardChar_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 2, 1, 3),
...
evdFieldIndex = _EvdFieldIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 2, 3, 1, 1),
    _EvdFieldIndex_Type()
)
...
evNoData1PortEnableEntry = _EvNoData1PortEnableEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 3, 12, 1)
)
evNoData1PortEnableEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "evNoData1PortEnableIndex"),
)
if mibBuilder.loadTexts:
...
evNoData1PortEnableIndex = _EvNoData1PortEnableIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 3, 12, 1, 1),
...
evNoData2PortEnableEntry = _EvNoData2PortEnableEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 4, 12, 1)
)
evNoData2PortEnableEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "evNoData2PortEnableIndex"),
)
if mibBuilder.loadTexts:
...
evNoData2PortEnableIndex = _EvNoData2PortEnableIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 4, 12, 1, 1),
...
evShskLowIndex = _EvShskLowIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 7, 1, 1),
...
fsGenIndex = _FsGenIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 11, 1, 1, 1),
    _FsGenIndex_Type()
)
...
fsGenSysrepPackage = _FsGenSysrepPackage_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 11, 1, 1, 15),
...
fsCustomTankEntry = _FsCustomTankEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 11, 3, 1)
)
fsCustomTankEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "fsCustomTankIndexFS"),
    (0, "SITEBOSS-530-STD-MIB", "fsCustomTankIndexDatum"),
)
if mibBuilder.loadTexts:
...
fsCustomTankIndexDatum = _FsCustomTankIndexDatum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 11, 3, 1, 2),
...
fsDiscEntry = _FsDiscEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 11, 5, 1)
)
fsDiscEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "fsDiscIndex"),
)
if mibBuilder.loadTexts:
...
fsDiscNormalTrapNum = _FsDiscNormalTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 11, 5, 1, 9),
...
acpmGenIndex = _AcpmGenIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 1, 1, 1),
    _AcpmGenIndex_Type()
)
...
acpmAvgVoltageEntry = _AcpmAvgVoltageEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 2, 1)
)
acpmAvgVoltageEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "acpmAvgVoltageIndex"),
)
if mibBuilder.loadTexts:
...
acpmAvgVoltageHighTrapNum = _AcpmAvgVoltageHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 2, 1, 10),
...
acpmAvgVoltageVLowTrapNum = _AcpmAvgVoltageVLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 2, 1, 21),
...
acpmAvgCurrentEntry = _AcpmAvgCurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 3, 1)
)
acpmAvgCurrentEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "acpmAvgCurrentIndex"),
)
if mibBuilder.loadTexts:
...
acpmAvgCurrentIndex = _AcpmAvgCurrentIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 3, 1, 1),
...
acpmAvgCurrentHighTrapNum = _AcpmAvgCurrentHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 3, 1, 10),
...
acpmAvgCurrentVLowTrapNum = _AcpmAvgCurrentVLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 3, 1, 21),
...
acpmFreqIndex = _AcpmFreqIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 4, 1, 1),
    _AcpmFreqIndex_Type()
)
...
acpmFreqHighTrapNum = _AcpmFreqHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 4, 1, 10),
...
acpmTRPIndex = _AcpmTRPIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 5, 1, 1),
    _AcpmTRPIndex_Type()
)
...
acpmTRPVHighTrapNum = _AcpmTRPVHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 5, 1, 6),
...
acpmTRPHighTrapNum = _AcpmTRPHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 5, 1, 10),
...
acpmTRPLowTrapNum = _AcpmTRPLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 5, 1, 17),
...
acpmTRPVLowTrapNum = _AcpmTRPVLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 5, 1, 21),
...
acpmDisconnectEntry = _AcpmDisconnectEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 6, 1)
)
acpmDisconnectEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "acpmDisconnectIndex"),
)
if mibBuilder.loadTexts:
...
acpmDisconnectTrapNum = _AcpmDisconnectTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 6, 1, 4),
...
acpmDisconnectNormalTrapNum = _AcpmDisconnectNormalTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 6, 1, 7),
...
acpmTPFEntry = _AcpmTPFEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 12, 12, 7, 1)
)
acpmTPFEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "acpmTPFIndex"),
)
if mibBuilder.loadTexts:
...
actionCallNumberEntry = _ActionCallNumberEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 14, 1, 1)
)
actionCallNumberEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "actionCallNumberIndex"),
)
if mibBuilder.loadTexts:
...
actionCallNumberIndex = _ActionCallNumberIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 14, 1, 1, 1),
...
actionPagerIndex = _ActionPagerIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 14, 2, 1, 1),
...
actionPagerPostCalloutDelay = _ActionPagerPostCalloutDelay_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 14, 2, 1, 6),
...
actionPagerPostIDDelay = _ActionPagerPostIDDelay_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 14, 2, 1, 7),
...
actionHostIndex = _ActionHostIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 14, 6, 1, 1),
...
sysTimeNetHostTable = _SysTimeNetHostTable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 16, 1, 4, 2)
)
if mibBuilder.loadTexts:
...
sysTimeNetHostEntry = _SysTimeNetHostEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 16, 1, 4, 2, 1)
)
sysTimeNetHostEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "sysTimeNetHostIndex"),
)
if mibBuilder.loadTexts:
...
sysCRDBFileIDIndex = _SysCRDBFileIDIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 16, 10, 3, 1, 1),
...
sysCRDBFileEnforceMinEntry = _SysCRDBFileEnforceMinEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 12, 2, 16, 10, 4, 1)
)
sysCRDBFileEnforceMinEntry.setIndexNames(
    (0, "SITEBOSS-530-STD-MIB", "sysCRDBFileEnforceMinIndex"),
)
if mibBuilder.loadTexts:
...
s530StockContactClosureTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 110)
)
s530StockContactClosureTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockContactClosureTrap.setStatus(
        "current"
    )

s530StockTempTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 120)
)
s530StockTempTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockTempTrap.setStatus(
        "current"
    )

s530StockHumidityTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 130)
)
s530StockHumidityTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockHumidityTrap.setStatus(
        "current"
    )

s530StockAnalogTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 140)
)
s530StockAnalogTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockAnalogTrap.setStatus(
        "current"
    )

s530StockOutputTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 150)
)
s530StockOutputTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockOutputTrap.setStatus(
        "current"
    )

s530StockPDCurrentTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 180)
)
s530StockPDCurrentTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockPDCurrentTrap.setStatus(
        "current"
    )

s530StockPDVoltageTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 190)
)
s530StockPDVoltageTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockPDVoltageTrap.setStatus(
        "current"
    )

s530StockPDFuseTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 210)
)
s530StockPDFuseTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockPDFuseTrap.setStatus(
        "current"
    )

s530StockDbasePfullTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 501)
)
s530StockDbasePfullTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockDbasePfullTrap.setStatus(
        "current"
    )

s530StockDataAlarmTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 503)
)
s530StockDataAlarmTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockDataAlarmTrap.setStatus(
        "current"
    )

s530StockNoDataAlarmTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 505)
)
s530StockNoDataAlarmTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockNoDataAlarmTrap.setStatus(
        "current"
    )

s530StockSchedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 506)
)
s530StockSchedTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockSchedTrap.setStatus(
        "current"
    )

s530StockImmediateTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 507)
)
s530StockImmediateTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockImmediateTrap.setStatus(
        "current"
    )

s530StockCTSTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 510)
)
s530StockCTSTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530StockCTSTrap.setStatus(
        "current"
    )

s530CPEDownTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 511)
)
s530CPEDownTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530CPEDownTrap.setStatus(
        "current"
    )

s530FuelSensorDisconnectTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 515)
)
s530FuelSensorDisconnectTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530FuelSensorDisconnectTrap.setStatus(
        "current"
    )

s530FuelSensorVolumeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 519)
)
s530FuelSensorVolumeTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530FuelSensorVolumeTrap.setStatus(
        "current"
    )

s530ACPowerMonitorAvgVoltageTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 520)
)
s530ACPowerMonitorAvgVoltageTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530ACPowerMonitorAvgVoltageTrap.setStatus(
        "current"
    )

s530ACPowerMonitorAvgCurrentTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 521)
)
s530ACPowerMonitorAvgCurrentTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530ACPowerMonitorAvgCurrentTrap.setStatus(
        "current"
    )

s530ACPowerMonitorFrequencyTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 522)
)
s530ACPowerMonitorFrequencyTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530ACPowerMonitorFrequencyTrap.setStatus(
        "current"
    )

s530ACPowerMonitorTRPTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 523)
)
s530ACPowerMonitorTRPTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530ACPowerMonitorTRPTrap.setStatus(
        "current"
    )

s530ACPowerMonitorDisconnectTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 524)
)
s530ACPowerMonitorDisconnectTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530ACPowerMonitorDisconnectTrap.setStatus(
        "current"
    )

s530ACTotalPowerFactorTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 540)
)
s530ACTotalPowerFactorTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530ACTotalPowerFactorTrap.setStatus(
        "current"
    )

s530ResetTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 543)
)
s530ResetTrap.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "stockTrapString"),
        ("SITEBOSS-530-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s530ResetTrap.setStatus(
        "current"
    )

s530UserTrap1000 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1000)
)
s530UserTrap1000.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeName"),
        ("SITEBOSS-530-STD-MIB", "esIndexPoint"),
        ("SITEBOSS-530-STD-MIB", "esPointName"),
        ("SITEBOSS-530-STD-MIB", "esID"),
        ("SITEBOSS-530-STD-MIB", "clock"),
        ("SITEBOSS-530-STD-MIB", "trapIncludedValue"),
        ("SITEBOSS-530-STD-MIB", "trapIncludedString"),
        ("SITEBOSS-530-STD-MIB", "trapEventClassNumber"),
        ("SITEBOSS-530-STD-MIB", "trapEventClassName"))
)
if mibBuilder.loadTexts:
    s530UserTrap1000.setStatus(
        "current"
    )

s530UserTrap1001 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1001)
)
s530UserTrap1001.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1001.setStatus(
        "current"
    )

s530UserTrap1002 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1002)
)
s530UserTrap1002.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1002.setStatus(
        "current"
    )

s530UserTrap1003 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1003)
)
s530UserTrap1003.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1003.setStatus(
        "current"
    )

s530UserTrap1004 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1004)
)
s530UserTrap1004.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1004.setStatus(
        "current"
    )

s530UserTrap1005 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1005)
)
s530UserTrap1005.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1005.setStatus(
        "current"
    )

s530UserTrap1006 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1006)
)
s530UserTrap1006.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1006.setStatus(
        "current"
    )

s530UserTrap1007 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1007)
)
s530UserTrap1007.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1007.setStatus(
        "current"
    )

s530UserTrap1008 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1008)
)
s530UserTrap1008.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1008.setStatus(
        "current"
    )

s530UserTrap1009 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1009)
)
s530UserTrap1009.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1009.setStatus(
        "current"
    )

s530UserTrap1010 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1010)
)
s530UserTrap1010.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1010.setStatus(
        "current"
    )

s530UserTrap1011 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1011)
)
s530UserTrap1011.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1011.setStatus(
        "current"
    )

s530UserTrap1012 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1012)
)
s530UserTrap1012.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1012.setStatus(
        "current"
    )

s530UserTrap1013 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1013)
)
s530UserTrap1013.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1013.setStatus(
        "current"
    )

s530UserTrap1014 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1014)
)
s530UserTrap1014.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1014.setStatus(
        "current"
    )

s530UserTrap1015 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1015)
)
s530UserTrap1015.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1015.setStatus(
        "current"
    )

s530UserTrap1016 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1016)
)
s530UserTrap1016.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1016.setStatus(
        "current"
    )

s530UserTrap1017 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1017)
)
s530UserTrap1017.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1017.setStatus(
        "current"
    )

s530UserTrap1018 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1018)
)
s530UserTrap1018.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1018.setStatus(
        "current"
    )

s530UserTrap1019 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1019)
)
s530UserTrap1019.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1019.setStatus(
        "current"
    )

s530UserTrap1020 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1020)
)
s530UserTrap1020.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1020.setStatus(
        "current"
    )

s530UserTrap1021 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1021)
)
s530UserTrap1021.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1021.setStatus(
        "current"
    )

s530UserTrap1022 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1022)
)
s530UserTrap1022.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1022.setStatus(
        "current"
    )

s530UserTrap1023 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1023)
)
s530UserTrap1023.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1023.setStatus(
        "current"
    )

s530UserTrap1024 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1024)
)
s530UserTrap1024.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1024.setStatus(
        "current"
    )

s530UserTrap1025 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1025)
)
s530UserTrap1025.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1025.setStatus(
        "current"
    )

s530UserTrap1026 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1026)
)
s530UserTrap1026.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1026.setStatus(
        "current"
    )

s530UserTrap1027 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1027)
)
s530UserTrap1027.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1027.setStatus(
        "current"
    )

s530UserTrap1028 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1028)
)
s530UserTrap1028.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1028.setStatus(
        "current"
    )

s530UserTrap1029 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1029)
)
s530UserTrap1029.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1029.setStatus(
        "current"
    )

s530UserTrap1030 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1030)
)
s530UserTrap1030.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1030.setStatus(
        "current"
    )

s530UserTrap1031 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1031)
)
s530UserTrap1031.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1031.setStatus(
        "current"
    )

s530UserTrap1032 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1032)
)
s530UserTrap1032.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1032.setStatus(
        "current"
    )

s530UserTrap1033 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1033)
)
s530UserTrap1033.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1033.setStatus(
        "current"
    )

s530UserTrap1034 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1034)
)
s530UserTrap1034.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1034.setStatus(
        "current"
    )

s530UserTrap1035 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1035)
)
s530UserTrap1035.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1035.setStatus(
        "current"
    )

s530UserTrap1036 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1036)
)
s530UserTrap1036.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1036.setStatus(
        "current"
    )

s530UserTrap1037 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1037)
)
s530UserTrap1037.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1037.setStatus(
        "current"
    )

s530UserTrap1038 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1038)
)
s530UserTrap1038.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1038.setStatus(
        "current"
    )

s530UserTrap1039 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1039)
)
s530UserTrap1039.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1039.setStatus(
        "current"
    )

s530UserTrap1040 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1040)
)
s530UserTrap1040.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1040.setStatus(
        "current"
    )

s530UserTrap1041 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1041)
)
s530UserTrap1041.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1041.setStatus(
        "current"
    )

s530UserTrap1042 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1042)
)
s530UserTrap1042.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1042.setStatus(
        "current"
    )

s530UserTrap1043 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1043)
)
s530UserTrap1043.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1043.setStatus(
        "current"
    )

s530UserTrap1044 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1044)
)
s530UserTrap1044.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1044.setStatus(
        "current"
    )

s530UserTrap1045 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1045)
)
s530UserTrap1045.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1045.setStatus(
        "current"
    )

s530UserTrap1046 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1046)
)
s530UserTrap1046.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1046.setStatus(
        "current"
    )

s530UserTrap1047 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1047)
)
s530UserTrap1047.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1047.setStatus(
        "current"
    )

s530UserTrap1048 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1048)
)
s530UserTrap1048.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1048.setStatus(
        "current"
    )

s530UserTrap1049 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1049)
)
s530UserTrap1049.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1049.setStatus(
        "current"
    )

s530UserTrap1050 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1050)
)
s530UserTrap1050.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1050.setStatus(
        "current"
    )

s530UserTrap1051 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1051)
)
s530UserTrap1051.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1051.setStatus(
        "current"
    )

s530UserTrap1052 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1052)
)
s530UserTrap1052.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1052.setStatus(
        "current"
    )

s530UserTrap1053 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1053)
)
s530UserTrap1053.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1053.setStatus(
        "current"
    )

s530UserTrap1054 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1054)
)
s530UserTrap1054.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1054.setStatus(
        "current"
    )

s530UserTrap1055 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1055)
)
s530UserTrap1055.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1055.setStatus(
        "current"
    )

s530UserTrap1056 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1056)
)
s530UserTrap1056.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1056.setStatus(
        "current"
    )

s530UserTrap1057 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1057)
)
s530UserTrap1057.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1057.setStatus(
        "current"
    )

s530UserTrap1058 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1058)
)
s530UserTrap1058.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1058.setStatus(
        "current"
    )

s530UserTrap1059 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1059)
)
s530UserTrap1059.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1059.setStatus(
        "current"
    )

s530UserTrap1060 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1060)
)
s530UserTrap1060.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1060.setStatus(
        "current"
    )

s530UserTrap1061 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1061)
)
s530UserTrap1061.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1061.setStatus(
        "current"
    )

s530UserTrap1062 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1062)
)
s530UserTrap1062.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1062.setStatus(
        "current"
    )

s530UserTrap1063 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1063)
)
s530UserTrap1063.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1063.setStatus(
        "current"
    )

s530UserTrap1064 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1064)
)
s530UserTrap1064.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1064.setStatus(
        "current"
    )

s530UserTrap1065 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1065)
)
s530UserTrap1065.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1065.setStatus(
        "current"
    )

s530UserTrap1066 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1066)
)
s530UserTrap1066.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1066.setStatus(
        "current"
    )

s530UserTrap1067 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1067)
)
s530UserTrap1067.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1067.setStatus(
        "current"
    )

s530UserTrap1068 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1068)
)
s530UserTrap1068.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1068.setStatus(
        "current"
    )

s530UserTrap1069 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1069)
)
s530UserTrap1069.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1069.setStatus(
        "current"
    )

s530UserTrap1070 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1070)
)
s530UserTrap1070.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1070.setStatus(
        "current"
    )

s530UserTrap1071 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1071)
)
s530UserTrap1071.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1071.setStatus(
        "current"
    )

s530UserTrap1072 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1072)
)
s530UserTrap1072.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1072.setStatus(
        "current"
    )

s530UserTrap1073 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1073)
)
s530UserTrap1073.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1073.setStatus(
        "current"
    )

s530UserTrap1074 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1074)
)
s530UserTrap1074.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1074.setStatus(
        "current"
    )

s530UserTrap1075 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1075)
)
s530UserTrap1075.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1075.setStatus(
        "current"
    )

s530UserTrap1076 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1076)
)
s530UserTrap1076.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1076.setStatus(
        "current"
    )

s530UserTrap1077 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1077)
)
s530UserTrap1077.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1077.setStatus(
        "current"
    )

s530UserTrap1078 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1078)
)
s530UserTrap1078.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1078.setStatus(
        "current"
    )

s530UserTrap1079 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1079)
)
s530UserTrap1079.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1079.setStatus(
        "current"
    )

s530UserTrap1080 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1080)
)
s530UserTrap1080.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1080.setStatus(
        "current"
    )

s530UserTrap1081 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1081)
)
s530UserTrap1081.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1081.setStatus(
        "current"
    )

s530UserTrap1082 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1082)
)
s530UserTrap1082.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1082.setStatus(
        "current"
    )

s530UserTrap1083 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1083)
)
s530UserTrap1083.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1083.setStatus(
        "current"
    )

s530UserTrap1084 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1084)
)
s530UserTrap1084.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1084.setStatus(
        "current"
    )

s530UserTrap1085 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1085)
)
s530UserTrap1085.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1085.setStatus(
        "current"
    )

s530UserTrap1086 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1086)
)
s530UserTrap1086.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1086.setStatus(
        "current"
    )

s530UserTrap1087 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1087)
)
s530UserTrap1087.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1087.setStatus(
        "current"
    )

s530UserTrap1088 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1088)
)
s530UserTrap1088.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1088.setStatus(
        "current"
    )

s530UserTrap1089 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1089)
)
s530UserTrap1089.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1089.setStatus(
        "current"
    )

s530UserTrap1090 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1090)
)
s530UserTrap1090.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1090.setStatus(
        "current"
    )

s530UserTrap1091 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1091)
)
s530UserTrap1091.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1092.setStatus(
        "current"
    )

s530UserTrap1093 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1093)
)
s530UserTrap1093.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1093.setStatus(
        "current"
    )

s530UserTrap1094 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1094)
)
s530UserTrap1094.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1094.setStatus(
        "current"
    )

s530UserTrap1095 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1095)
)
s530UserTrap1095.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1095.setStatus(
        "current"
    )

s530UserTrap1096 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1096)
)
s530UserTrap1096.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1096.setStatus(
        "current"
    )

s530UserTrap1097 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1097)
)
s530UserTrap1097.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1097.setStatus(
        "current"
    )

s530UserTrap1098 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1098)
)
s530UserTrap1098.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1098.setStatus(
        "current"
    )

s530UserTrap1099 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1099)
)
s530UserTrap1099.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1099.setStatus(
        "current"
    )

s530UserTrap1100 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1100)
)
s530UserTrap1100.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1100.setStatus(
        "current"
    )

s530UserTrap1101 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1101)
)
s530UserTrap1101.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1101.setStatus(
        "current"
    )

s530UserTrap1102 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1102)
)
s530UserTrap1102.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1102.setStatus(
        "current"
    )

s530UserTrap1103 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1103)
)
s530UserTrap1103.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1103.setStatus(
        "current"
    )

s530UserTrap1104 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1104)
)
s530UserTrap1104.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1104.setStatus(
        "current"
    )

s530UserTrap1105 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1105)
)
s530UserTrap1105.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1105.setStatus(
        "current"
    )

s530UserTrap1106 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1106)
)
s530UserTrap1106.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1106.setStatus(
        "current"
    )

s530UserTrap1107 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1107)
)
s530UserTrap1107.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1107.setStatus(
        "current"
    )

s530UserTrap1108 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1108)
)
s530UserTrap1108.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1108.setStatus(
        "current"
    )

s530UserTrap1109 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1109)
)
s530UserTrap1109.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1109.setStatus(
        "current"
    )

s530UserTrap1110 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1110)
)
s530UserTrap1110.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1110.setStatus(
        "current"
    )

s530UserTrap1111 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1111)
)
s530UserTrap1111.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1111.setStatus(
        "current"
    )

s530UserTrap1112 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1112)
)
s530UserTrap1112.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1112.setStatus(
        "current"
    )

s530UserTrap1113 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1113)
)
s530UserTrap1113.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1113.setStatus(
        "current"
    )

s530UserTrap1114 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1114)
)
s530UserTrap1114.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1114.setStatus(
        "current"
    )

s530UserTrap1115 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1115)
)
s530UserTrap1115.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1115.setStatus(
        "current"
    )

s530UserTrap1116 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1116)
)
s530UserTrap1116.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1116.setStatus(
        "current"
    )

s530UserTrap1117 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1117)
)
s530UserTrap1117.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1117.setStatus(
        "current"
    )

s530UserTrap1118 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1118)
)
s530UserTrap1118.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1118.setStatus(
        "current"
    )

s530UserTrap1119 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1119)
)
s530UserTrap1119.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1119.setStatus(
        "current"
    )

s530UserTrap1120 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1120)
)
s530UserTrap1120.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1120.setStatus(
        "current"
    )

s530UserTrap1121 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1121)
)
s530UserTrap1121.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1121.setStatus(
        "current"
    )

s530UserTrap1122 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1122)
)
s530UserTrap1122.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1122.setStatus(
        "current"
    )

s530UserTrap1123 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1123)
)
s530UserTrap1123.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1123.setStatus(
        "current"
    )

s530UserTrap1124 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1124)
)
s530UserTrap1124.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1124.setStatus(
        "current"
    )

s530UserTrap1125 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1125)
)
s530UserTrap1125.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1125.setStatus(
        "current"
    )

s530UserTrap1126 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1126)
)
s530UserTrap1126.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1126.setStatus(
        "current"
    )

s530UserTrap1127 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1127)
)
s530UserTrap1127.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1127.setStatus(
        "current"
    )

s530UserTrap1128 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1128)
)
s530UserTrap1128.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1128.setStatus(
        "current"
    )

s530UserTrap1129 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1129)
)
s530UserTrap1129.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1129.setStatus(
        "current"
    )

s530UserTrap1130 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1130)
)
s530UserTrap1130.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1130.setStatus(
        "current"
    )

s530UserTrap1131 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1131)
)
s530UserTrap1131.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1131.setStatus(
        "current"
    )

s530UserTrap1132 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1132)
)
s530UserTrap1132.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1132.setStatus(
        "current"
    )

s530UserTrap1133 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1133)
)
s530UserTrap1133.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1133.setStatus(
        "current"
    )

s530UserTrap1134 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1134)
)
s530UserTrap1134.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1134.setStatus(
        "current"
    )

s530UserTrap1135 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1135)
)
s530UserTrap1135.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1135.setStatus(
        "current"
    )

s530UserTrap1136 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1136)
)
s530UserTrap1136.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1136.setStatus(
        "current"
    )

s530UserTrap1137 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1137)
)
s530UserTrap1137.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1137.setStatus(
        "current"
    )

s530UserTrap1138 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1138)
)
s530UserTrap1138.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1138.setStatus(
        "current"
    )

s530UserTrap1139 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1139)
)
s530UserTrap1139.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1139.setStatus(
        "current"
    )

s530UserTrap1140 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1140)
)
s530UserTrap1140.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1140.setStatus(
        "current"
    )

s530UserTrap1141 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1141)
)
s530UserTrap1141.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1141.setStatus(
        "current"
    )

s530UserTrap1142 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1142)
)
s530UserTrap1142.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1142.setStatus(
        "current"
    )

s530UserTrap1143 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1143)
)
s530UserTrap1143.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1143.setStatus(
        "current"
    )

s530UserTrap1144 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1144)
)
s530UserTrap1144.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1144.setStatus(
        "current"
    )

s530UserTrap1145 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1145)
)
s530UserTrap1145.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1145.setStatus(
        "current"
    )

s530UserTrap1146 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1146)
)
s530UserTrap1146.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1146.setStatus(
        "current"
    )

s530UserTrap1147 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1147)
)
s530UserTrap1147.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1147.setStatus(
        "current"
    )

s530UserTrap1148 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1148)
)
s530UserTrap1148.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1148.setStatus(
        "current"
    )

s530UserTrap1149 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1149)
)
s530UserTrap1149.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1149.setStatus(
        "current"
    )

s530UserTrap1150 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1150)
)
s530UserTrap1150.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1150.setStatus(
        "current"
    )

s530UserTrap1151 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1151)
)
s530UserTrap1151.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1151.setStatus(
        "current"
    )

s530UserTrap1152 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1152)
)
s530UserTrap1152.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1152.setStatus(
        "current"
    )

s530UserTrap1153 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1153)
)
s530UserTrap1153.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1153.setStatus(
        "current"
    )

s530UserTrap1154 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1154)
)
s530UserTrap1154.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1154.setStatus(
        "current"
    )

s530UserTrap1155 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1155)
)
s530UserTrap1155.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1155.setStatus(
        "current"
    )

s530UserTrap1156 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1156)
)
s530UserTrap1156.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1156.setStatus(
        "current"
    )

s530UserTrap1157 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1157)
)
s530UserTrap1157.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1157.setStatus(
        "current"
    )

s530UserTrap1158 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1158)
)
s530UserTrap1158.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1158.setStatus(
        "current"
    )

s530UserTrap1159 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1159)
)
s530UserTrap1159.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1159.setStatus(
        "current"
    )

s530UserTrap1160 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1160)
)
s530UserTrap1160.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1160.setStatus(
        "current"
    )

s530UserTrap1161 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1161)
)
s530UserTrap1161.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1161.setStatus(
        "current"
    )

s530UserTrap1162 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1162)
)
s530UserTrap1162.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1162.setStatus(
        "current"
    )

s530UserTrap1163 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1163)
)
s530UserTrap1163.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1163.setStatus(
        "current"
    )

s530UserTrap1164 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1164)
)
s530UserTrap1164.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1164.setStatus(
        "current"
    )

s530UserTrap1165 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1165)
)
s530UserTrap1165.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1165.setStatus(
        "current"
    )

s530UserTrap1166 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1166)
)
s530UserTrap1166.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1166.setStatus(
        "current"
    )

s530UserTrap1167 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1167)
)
s530UserTrap1167.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1167.setStatus(
        "current"
    )

s530UserTrap1168 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1168)
)
s530UserTrap1168.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1168.setStatus(
        "current"
    )

s530UserTrap1169 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1169)
)
s530UserTrap1169.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1169.setStatus(
        "current"
    )

s530UserTrap1170 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1170)
)
s530UserTrap1170.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1170.setStatus(
        "current"
    )

s530UserTrap1171 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1171)
)
s530UserTrap1171.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1171.setStatus(
        "current"
    )

s530UserTrap1172 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1172)
)
s530UserTrap1172.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1172.setStatus(
        "current"
    )

s530UserTrap1173 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1173)
)
s530UserTrap1173.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1173.setStatus(
        "current"
    )

s530UserTrap1174 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1174)
)
s530UserTrap1174.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1174.setStatus(
        "current"
    )

s530UserTrap1175 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1175)
)
s530UserTrap1175.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1175.setStatus(
        "current"
    )

s530UserTrap1176 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1176)
)
s530UserTrap1176.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1176.setStatus(
        "current"
    )

s530UserTrap1177 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1177)
)
s530UserTrap1177.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1177.setStatus(
        "current"
    )

s530UserTrap1178 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1178)
)
s530UserTrap1178.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1178.setStatus(
        "current"
    )

s530UserTrap1179 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1179)
)
s530UserTrap1179.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1179.setStatus(
        "current"
    )

s530UserTrap1180 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1180)
)
s530UserTrap1180.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1180.setStatus(
        "current"
    )

s530UserTrap1181 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1181)
)
s530UserTrap1181.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1181.setStatus(
        "current"
    )

s530UserTrap1182 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1182)
)
s530UserTrap1182.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1182.setStatus(
        "current"
    )

s530UserTrap1183 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1183)
)
s530UserTrap1183.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1183.setStatus(
        "current"
    )

s530UserTrap1184 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1184)
)
s530UserTrap1184.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1184.setStatus(
        "current"
    )

s530UserTrap1185 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1185)
)
s530UserTrap1185.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1185.setStatus(
        "current"
    )

s530UserTrap1186 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1186)
)
s530UserTrap1186.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1186.setStatus(
        "current"
    )

s530UserTrap1187 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1187)
)
s530UserTrap1187.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1187.setStatus(
        "current"
    )

s530UserTrap1188 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1188)
)
s530UserTrap1188.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1188.setStatus(
        "current"
    )

s530UserTrap1189 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1189)
)
s530UserTrap1189.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1189.setStatus(
        "current"
    )

s530UserTrap1190 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1190)
)
s530UserTrap1190.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1190.setStatus(
        "current"
    )

s530UserTrap1191 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1191)
)
s530UserTrap1191.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1191.setStatus(
        "current"
    )

s530UserTrap1192 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1192)
)
s530UserTrap1192.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1192.setStatus(
        "current"
    )

s530UserTrap1193 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1193)
)
s530UserTrap1193.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1193.setStatus(
        "current"
    )

s530UserTrap1194 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1194)
)
s530UserTrap1194.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1194.setStatus(
        "current"
    )

s530UserTrap1195 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1195)
)
s530UserTrap1195.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1195.setStatus(
        "current"
    )

s530UserTrap1196 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1196)
)
s530UserTrap1196.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1196.setStatus(
        "current"
    )

s530UserTrap1197 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1197)
)
s530UserTrap1197.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1197.setStatus(
        "current"
    )

s530UserTrap1198 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1198)
)
s530UserTrap1198.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s530UserTrap1198.setStatus(
        "current"
    )

s530UserTrap1199 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 12, 1199)
)
s530UserTrap1199.setObjects(
      *(("SITEBOSS-530-STD-MIB", "siteName"),
        ("SITEBOSS-530-STD-MIB", "esIndex"),
        ("SITEBOSS-530-STD-MIB", "esName"),
        ("SITEBOSS-530-STD-MIB", "trapEventTypeNumber"),
...
mibBuilder.exportSymbols(
    ...
    **{"s530": s530,
       ...
       "esPointClassValueStr": esPointClassValueStr,
       ...
       "ethExpan": ethExpan,
       "ethExpanIp": ethExpanIp,
       "ethExpanMask": ethExpanMask,
       "ethExpanCardTable": ethExpanCardTable,
       "ethExpanCardEntry": ethExpanCardEntry,
       "ethExpanCardIndex": ethExpanCardIndex,
       "ethExpanCardMAC": ethExpanCardMAC,
       "ethExpanDHCP": ethExpanDHCP,
       "ethExpanDHCPStartIp": ethExpanDHCPStartIp,
       "ethExpanDHCPLeaseTime": ethExpanDHCPLeaseTime,
       "ipv6": ipv6,
       ...
       "s530StockContactClosureTrap": s530StockContactClosureTrap,
       "s530StockTempTrap": s530StockTempTrap,
       "s530StockHumidityTrap": s530StockHumidityTrap,
       "s530StockAnalogTrap": s530StockAnalogTrap,
       "s530StockOutputTrap": s530StockOutputTrap,
       "s530StockPDCurrentTrap": s530StockPDCurrentTrap,
       "s530StockPDVoltageTrap": s530StockPDVoltageTrap,
       "s530StockPDFuseTrap": s530StockPDFuseTrap,
       "s530StockDbasePfullTrap": s530StockDbasePfullTrap,
       "s530StockDataAlarmTrap": s530StockDataAlarmTrap,
       "s530StockNoDataAlarmTrap": s530StockNoDataAlarmTrap,
       "s530StockSchedTrap": s530StockSchedTrap,
       "s530StockImmediateTrap": s530StockImmediateTrap,
       "s530StockCTSTrap": s530StockCTSTrap,
       "s530CPEDownTrap": s530CPEDownTrap,
       "s530FuelSensorDisconnectTrap": s530FuelSensorDisconnectTrap,
       "s530FuelSensorVolumeTrap": s530FuelSensorVolumeTrap,
       "s530ACPowerMonitorAvgVoltageTrap": s530ACPowerMonitorAvgVoltageTrap,
       "s530ACPowerMonitorAvgCurrentTrap": s530ACPowerMonitorAvgCurrentTrap,
       "s530ACPowerMonitorFrequencyTrap": s530ACPowerMonitorFrequencyTrap,
       "s530ACPowerMonitorTRPTrap": s530ACPowerMonitorTRPTrap,
       "s530ACPowerMonitorDisconnectTrap": s530ACPowerMonitorDisconnectTrap,
       "s530ACTotalPowerFactorTrap": s530ACTotalPowerFactorTrap,
       "s530ResetTrap": s530ResetTrap,
       "s530UserTrap1000": s530UserTrap1000,
       "s530UserTrap1001": s530UserTrap1001,
       "s530UserTrap1002": s530UserTrap1002,
       "s530UserTrap1003": s530UserTrap1003,
       "s530UserTrap1004": s530UserTrap1004,
       "s530UserTrap1005": s530UserTrap1005,
       "s530UserTrap1006": s530UserTrap1006,
       "s530UserTrap1007": s530UserTrap1007,
       "s530UserTrap1008": s530UserTrap1008,
       "s530UserTrap1009": s530UserTrap1009,
       "s530UserTrap1010": s530UserTrap1010,
       "s530UserTrap1011": s530UserTrap1011,
       "s530UserTrap1012": s530UserTrap1012,
       "s530UserTrap1013": s530UserTrap1013,
       "s530UserTrap1014": s530UserTrap1014,
       "s530UserTrap1015": s530UserTrap1015,
       "s530UserTrap1016": s530UserTrap1016,
       "s530UserTrap1017": s530UserTrap1017,
       "s530UserTrap1018": s530UserTrap1018,
       "s530UserTrap1019": s530UserTrap1019,
       "s530UserTrap1020": s530UserTrap1020,
       "s530UserTrap1021": s530UserTrap1021,
       "s530UserTrap1022": s530UserTrap1022,
       "s530UserTrap1023": s530UserTrap1023,
       "s530UserTrap1024": s530UserTrap1024,
       "s530UserTrap1025": s530UserTrap1025,
       "s530UserTrap1026": s530UserTrap1026,
       "s530UserTrap1027": s530UserTrap1027,
       "s530UserTrap1028": s530UserTrap1028,
       "s530UserTrap1029": s530UserTrap1029,
       "s530UserTrap1030": s530UserTrap1030,
       "s530UserTrap1031": s530UserTrap1031,
       "s530UserTrap1032": s530UserTrap1032,
       "s530UserTrap1033": s530UserTrap1033,
       "s530UserTrap1034": s530UserTrap1034,
       "s530UserTrap1035": s530UserTrap1035,
       "s530UserTrap1036": s530UserTrap1036,
       "s530UserTrap1037": s530UserTrap1037,
       "s530UserTrap1038": s530UserTrap1038,
       "s530UserTrap1039": s530UserTrap1039,
       "s530UserTrap1040": s530UserTrap1040,
       "s530UserTrap1041": s530UserTrap1041,
       "s530UserTrap1042": s530UserTrap1042,
       "s530UserTrap1043": s530UserTrap1043,
       "s530UserTrap1044": s530UserTrap1044,
       "s530UserTrap1045": s530UserTrap1045,
       "s530UserTrap1046": s530UserTrap1046,
       "s530UserTrap1047": s530UserTrap1047,
       "s530UserTrap1048": s530UserTrap1048,
       "s530UserTrap1049": s530UserTrap1049,
       "s530UserTrap1050": s530UserTrap1050,
       "s530UserTrap1051": s530UserTrap1051,
       "s530UserTrap1052": s530UserTrap1052,
       "s530UserTrap1053": s530UserTrap1053,
       "s530UserTrap1054": s530UserTrap1054,
       "s530UserTrap1055": s530UserTrap1055,
       "s530UserTrap1056": s530UserTrap1056,
       "s530UserTrap1057": s530UserTrap1057,
       "s530UserTrap1058": s530UserTrap1058,
       "s530UserTrap1059": s530UserTrap1059,
       "s530UserTrap1060": s530UserTrap1060,
       "s530UserTrap1061": s530UserTrap1061,
       "s530UserTrap1062": s530UserTrap1062,
       "s530UserTrap1063": s530UserTrap1063,
       "s530UserTrap1064": s530UserTrap1064,
       "s530UserTrap1065": s530UserTrap1065,
       "s530UserTrap1066": s530UserTrap1066,
       "s530UserTrap1067": s530UserTrap1067,
       "s530UserTrap1068": s530UserTrap1068,
       "s530UserTrap1069": s530UserTrap1069,
       "s530UserTrap1070": s530UserTrap1070,
       "s530UserTrap1071": s530UserTrap1071,
       "s530UserTrap1072": s530UserTrap1072,
       "s530UserTrap1073": s530UserTrap1073,
       "s530UserTrap1074": s530UserTrap1074,
       "s530UserTrap1075": s530UserTrap1075,
       "s530UserTrap1076": s530UserTrap1076,
       "s530UserTrap1077": s530UserTrap1077,
       "s530UserTrap1078": s530UserTrap1078,
       "s530UserTrap1079": s530UserTrap1079,
       "s530UserTrap1080": s530UserTrap1080,
       "s530UserTrap1081": s530UserTrap1081,
       "s530UserTrap1082": s530UserTrap1082,
       "s530UserTrap1083": s530UserTrap1083,
       "s530UserTrap1084": s530UserTrap1084,
       "s530UserTrap1085": s530UserTrap1085,
       "s530UserTrap1086": s530UserTrap1086,
       "s530UserTrap1087": s530UserTrap1087,
       "s530UserTrap1088": s530UserTrap1088,
       "s530UserTrap1089": s530UserTrap1089,
       "s530UserTrap1090": s530UserTrap1090,
       "s530UserTrap1091": s530UserTrap1091,
       "s530UserTrap1092": s530UserTrap1092,
       "s530UserTrap1093": s530UserTrap1093,
       "s530UserTrap1094": s530UserTrap1094,
       "s530UserTrap1095": s530UserTrap1095,
       "s530UserTrap1096": s530UserTrap1096,
       "s530UserTrap1097": s530UserTrap1097,
       "s530UserTrap1098": s530UserTrap1098,
       "s530UserTrap1099": s530UserTrap1099,
       "s530UserTrap1100": s530UserTrap1100,
       "s530UserTrap1101": s530UserTrap1101,
       "s530UserTrap1102": s530UserTrap1102,
       "s530UserTrap1103": s530UserTrap1103,
       "s530UserTrap1104": s530UserTrap1104,
       "s530UserTrap1105": s530UserTrap1105,
       "s530UserTrap1106": s530UserTrap1106,
       "s530UserTrap1107": s530UserTrap1107,
       "s530UserTrap1108": s530UserTrap1108,
       "s530UserTrap1109": s530UserTrap1109,
       "s530UserTrap1110": s530UserTrap1110,
       "s530UserTrap1111": s530UserTrap1111,
       "s530UserTrap1112": s530UserTrap1112,
       "s530UserTrap1113": s530UserTrap1113,
       "s530UserTrap1114": s530UserTrap1114,
       "s530UserTrap1115": s530UserTrap1115,
       "s530UserTrap1116": s530UserTrap1116,
       "s530UserTrap1117": s530UserTrap1117,
       "s530UserTrap1118": s530UserTrap1118,
       "s530UserTrap1119": s530UserTrap1119,
       "s530UserTrap1120": s530UserTrap1120,
       "s530UserTrap1121": s530UserTrap1121,
       "s530UserTrap1122": s530UserTrap1122,
       "s530UserTrap1123": s530UserTrap1123,
       "s530UserTrap1124": s530UserTrap1124,
       "s530UserTrap1125": s530UserTrap1125,
       "s530UserTrap1126": s530UserTrap1126,
       "s530UserTrap1127": s530UserTrap1127,
       "s530UserTrap1128": s530UserTrap1128,
       "s530UserTrap1129": s530UserTrap1129,
       "s530UserTrap1130": s530UserTrap1130,
       "s530UserTrap1131": s530UserTrap1131,
       "s530UserTrap1132": s530UserTrap1132,
       "s530UserTrap1133": s530UserTrap1133,
       "s530UserTrap1134": s530UserTrap1134,
       "s530UserTrap1135": s530UserTrap1135,
       "s530UserTrap1136": s530UserTrap1136,
       "s530UserTrap1137": s530UserTrap1137,
       "s530UserTrap1138": s530UserTrap1138,
       "s530UserTrap1139": s530UserTrap1139,
       "s530UserTrap1140": s530UserTrap1140,
       "s530UserTrap1141": s530UserTrap1141,
       "s530UserTrap1142": s530UserTrap1142,
       "s530UserTrap1143": s530UserTrap1143,
       "s530UserTrap1144": s530UserTrap1144,
       "s530UserTrap1145": s530UserTrap1145,
       "s530UserTrap1146": s530UserTrap1146,
       "s530UserTrap1147": s530UserTrap1147,
       "s530UserTrap1148": s530UserTrap1148,
       "s530UserTrap1149": s530UserTrap1149,
       "s530UserTrap1150": s530UserTrap1150,
       "s530UserTrap1151": s530UserTrap1151,
       "s530UserTrap1152": s530UserTrap1152,
       "s530UserTrap1153": s530UserTrap1153,
       "s530UserTrap1154": s530UserTrap1154,
       "s530UserTrap1155": s530UserTrap1155,
       "s530UserTrap1156": s530UserTrap1156,
       "s530UserTrap1157": s530UserTrap1157,
       "s530UserTrap1158": s530UserTrap1158,
       "s530UserTrap1159": s530UserTrap1159,
       "s530UserTrap1160": s530UserTrap1160,
       "s530UserTrap1161": s530UserTrap1161,
       "s530UserTrap1162": s530UserTrap1162,
       "s530UserTrap1163": s530UserTrap1163,
       "s530UserTrap1164": s530UserTrap1164,
       "s530UserTrap1165": s530UserTrap1165,
       "s530UserTrap1166": s530UserTrap1166,
       "s530UserTrap1167": s530UserTrap1167,
       "s530UserTrap1168": s530UserTrap1168,
       "s530UserTrap1169": s530UserTrap1169,
       "s530UserTrap1170": s530UserTrap1170,
       "s530UserTrap1171": s530UserTrap1171,
       "s530UserTrap1172": s530UserTrap1172,
       "s530UserTrap1173": s530UserTrap1173,
       "s530UserTrap1174": s530UserTrap1174,
       "s530UserTrap1175": s530UserTrap1175,
       "s530UserTrap1176": s530UserTrap1176,
       "s530UserTrap1177": s530UserTrap1177,
       "s530UserTrap1178": s530UserTrap1178,
       "s530UserTrap1179": s530UserTrap1179,
       "s530UserTrap1180": s530UserTrap1180,
       "s530UserTrap1181": s530UserTrap1181,
       "s530UserTrap1182": s530UserTrap1182,
       "s530UserTrap1183": s530UserTrap1183,
       "s530UserTrap1184": s530UserTrap1184,
       "s530UserTrap1185": s530UserTrap1185,
       "s530UserTrap1186": s530UserTrap1186,
       "s530UserTrap1187": s530UserTrap1187,
       "s530UserTrap1188": s530UserTrap1188,
       "s530UserTrap1189": s530UserTrap1189,
       "s530UserTrap1190": s530UserTrap1190,
       "s530UserTrap1191": s530UserTrap1191,
       "s530UserTrap1192": s530UserTrap1192,
       "s530UserTrap1193": s530UserTrap1193,
       "s530UserTrap1194": s530UserTrap1194,
       "s530UserTrap1195": s530UserTrap1195,
       "s530UserTrap1196": s530UserTrap1196,
       "s530UserTrap1197": s530UserTrap1197,
       "s530UserTrap1198": s530UserTrap1198,
       "s530UserTrap1199": s530UserTrap1199}
)
