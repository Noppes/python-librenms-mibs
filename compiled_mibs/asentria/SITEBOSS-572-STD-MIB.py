# SNMP MIB module (SITEBOSS-572-STD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\asentria\SITEBOSS-572-STD-MIB
...
pdNextGen = _PdNextGen_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4)
)
_PdnTable_Object = MibTable
pdnTable = _PdnTable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1)
)
if mibBuilder.loadTexts:
    pdnTable.setStatus("current")
_PdnEntry_Object = MibTableRow
pdnEntry = _PdnEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1)
)
pdnEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "pdnIndexPD"),
    (0, "SITEBOSS-572-STD-MIB", "pdnIndexOutput"),
)
if mibBuilder.loadTexts:
...
pdnIndexPD = _PdnIndexPD_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 1),
    _PdnIndexPD_Type()
)
...
pdnIndexOutput = _PdnIndexOutput_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 2),
...
pdnConfig = _PdnConfig_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 3),
    _PdnConfig_Type()
)
...
pdnMainCurrentInEventState = _PdnMainCurrentInEventState_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 4),
...
pdnMainCurrentValue = _PdnMainCurrentValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 5),
...
pdnMainCurrentValueStr = _PdnMainCurrentValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 6),
...
pdnMainCurrentDeadband = _PdnMainCurrentDeadband_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 7),
...
pdnMainCurrentVHighCurrent = _PdnMainCurrentVHighCurrent_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 8),
...
pdnMainCurrentHighCurrent = _PdnMainCurrentHighCurrent_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 9),
...
pdnMainCurrentLowCurrent = _PdnMainCurrentLowCurrent_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 10),
...
pdnMainCurrentVLowCurrent = _PdnMainCurrentVLowCurrent_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 11),
...
pdnMainVoltageInEventState = _PdnMainVoltageInEventState_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 12),
...
pdnMainVoltageValueStr = _PdnMainVoltageValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 14),
...
pdnMainVoltageDeadband = _PdnMainVoltageDeadband_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 15),
...
pdnMainVoltageVHighVoltage = _PdnMainVoltageVHighVoltage_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 16),
...
pdnMainVoltageHighVoltage = _PdnMainVoltageHighVoltage_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 17),
...
pdnMainVoltageLowVoltage = _PdnMainVoltageLowVoltage_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 18),
...
pdnMainVoltageVLowVoltage = _PdnMainVoltageVLowVoltage_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 19),
...
pdnMainPowerValue = _PdnMainPowerValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 20),
...
pdnMainPowerValueStr = _PdnMainPowerValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 21),
...
pdnOutputCurrentInEventState = _PdnOutputCurrentInEventState_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 22),
...
pdnOutputCurrentValue = _PdnOutputCurrentValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 23),
...
pdnOutputCurrentValueStr = _PdnOutputCurrentValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 24),
...
pdnOutputCurrentDeadband = _PdnOutputCurrentDeadband_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 25),
...
pdnOutputCurrentVHighCurrent = _PdnOutputCurrentVHighCurrent_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 26),
...
pdnOutputCurrentHighCurrent = _PdnOutputCurrentHighCurrent_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 27),
...
pdnOutputCurrentLowCurrent = _PdnOutputCurrentLowCurrent_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 28),
...
pdnOutputCurrentVLowCurrent = _PdnOutputCurrentVLowCurrent_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 29),
...
pdnOutputFuseInEventState = _PdnOutputFuseInEventState_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 30),
...
pdnOutputFuseValueStr = _PdnOutputFuseValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 31),
...
pdnMainCombinedStatus = _PdnMainCombinedStatus_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 32),
...
pdnOutputCombinedStatusBlock1 = _PdnOutputCombinedStatusBlock1_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 33),
...
pdnOutputCombinedStatusBlock2 = _PdnOutputCombinedStatusBlock2_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 34),
...
pdnDeviceCurrentValue = _PdnDeviceCurrentValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 35),
...
pdnDeviceCurrentValueStr = _PdnDeviceCurrentValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 4, 1, 1, 36),
...
pdSystemLowVoltShutdownEnable = _PdSystemLowVoltShutdownEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 5, 3),
    _PdSystemLowVoltShutdownEnable_Type()
)
pdSystemLowVoltShutdownEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    pdSystemLowVoltShutdownEnable.setStatus("current")
_PdSystemLowVoltShutdownLowValue_Type = Integer32
_PdSystemLowVoltShutdownLowValue_Object = MibScalar
pdSystemLowVoltShutdownLowValue = _PdSystemLowVoltShutdownLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 5, 4),
    _PdSystemLowVoltShutdownLowValue_Type()
)
pdSystemLowVoltShutdownLowValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    pdSystemLowVoltShutdownLowValue.setStatus("current")
_PdSystemLowVoltShutdownNormalValue_Type = Integer32
_PdSystemLowVoltShutdownNormalValue_Object = MibScalar
pdSystemLowVoltShutdownNormalValue = _PdSystemLowVoltShutdownNormalValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 5, 5, 5),
    _PdSystemLowVoltShutdownNormalValue_Type()
)
pdSystemLowVoltShutdownNormalValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    pdSystemLowVoltShutdownNormalValue.setStatus("current")
_FuelSensorStatus_ObjectIdentity = ObjectIdentity
fuelSensorStatus = _FuelSensorStatus_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 6)
)
_FsStatusTable_Object = MibTable
fsStatusTable = _FsStatusTable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 6, 1)
)
if mibBuilder.loadTexts:
    fsStatusTable.setStatus("current")
_FsStatusEntry_Object = MibTableRow
fsStatusEntry = _FsStatusEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 6, 1, 1)
)
fsStatusEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "fsStatusIndex"),
)
if mibBuilder.loadTexts:
...
acpmsVoltagePhaseCValueStr = _AcpmsVoltagePhaseCValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 10),
...
acpmsAvgCurrentValueStr = _AcpmsAvgCurrentValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 11),
...
acpmsAvgCurrentMinStr = _AcpmsAvgCurrentMinStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 12),
...
acpmsAvgCurrentMaxStr = _AcpmsAvgCurrentMaxStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 13),
...
acpmsAvgCurrentAvgStr = _AcpmsAvgCurrentAvgStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 14),
...
acpmsAvgCurrentInEventState = _AcpmsAvgCurrentInEventState_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 15),
...
acpmsCurrentPhaseAValueStr = _AcpmsCurrentPhaseAValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 16),
...
acpmsCurrentPhaseBValueStr = _AcpmsCurrentPhaseBValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 17),
...
acpmsCurrentPhaseCValueStr = _AcpmsCurrentPhaseCValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 18),
...
acpmsAvgFreqValueStr = _AcpmsAvgFreqValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 19),
...
acpmsAvgFreqMinStr = _AcpmsAvgFreqMinStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 20),
...
acpmsAvgFreqMaxStr = _AcpmsAvgFreqMaxStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 21),
...
acpmsAvgFreqAvgStr = _AcpmsAvgFreqAvgStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 22),
...
acpmsAvgFreqInEventState = _AcpmsAvgFreqInEventState_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 23),
...
acpmsTRPValueStr = _AcpmsTRPValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 24),
...
acpmsTRPMinStr = _AcpmsTRPMinStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 25),
...
acpmsTRPMaxStr = _AcpmsTRPMaxStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 26),
...
acpmsTRPAvgStr = _AcpmsTRPAvgStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 27),
...
acpmsTRPInEventState = _AcpmsTRPInEventState_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 28),
...
acpmsRPPhaseAValueStr = _AcpmsRPPhaseAValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 29),
...
acpmsRPPhaseBValueStr = _AcpmsRPPhaseBValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 30),
...
acpmsRPPhaseCValueStr = _AcpmsRPPhaseCValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 31),
...
acpmsCombined = _AcpmsCombined_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 32),
    _AcpmsCombined_Type()
)
...
acpmsTPFValueStr = _AcpmsTPFValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 33),
...
acpmsTPFMinStr = _AcpmsTPFMinStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 34),
...
acpmsTPFMaxStr = _AcpmsTPFMaxStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 35),
...
acpmsTPFAvgStr = _AcpmsTPFAvgStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 36),
...
acpmsTPFInEventState = _AcpmsTPFInEventState_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 37),
...
acpmsPFPhaseAValueStr = _AcpmsPFPhaseAValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 38),
...
acpmsPFPhaseBValueStr = _AcpmsPFPhaseBValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 39),
...
acpmsPFPhaseCValueStr = _AcpmsPFPhaseCValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 40),
...
acpmsTRcPValueStr = _AcpmsTRcPValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 41),
...
acpmsTRcPMinStr = _AcpmsTRcPMinStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 42),
...
acpmsTRcPMaxStr = _AcpmsTRcPMaxStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 43),
...
acpmsTRcPAvgStr = _AcpmsTRcPAvgStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 44),
...
acpmsRcPPhaseAValueStr = _AcpmsRcPPhaseAValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 45),
...
acpmsRcPPhaseBValueStr = _AcpmsRcPPhaseBValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 46),
...
acpmsRcPPhaseCValueStr = _AcpmsRcPPhaseCValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 47),
...
acpmsTAPValueStr = _AcpmsTAPValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 48),
...
acpmsTAPMinStr = _AcpmsTAPMinStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 49),
...
acpmsTAPMaxStr = _AcpmsTAPMaxStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 50),
...
acpmsTAPAvgStr = _AcpmsTAPAvgStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 51),
...
acpmsAPPhaseAValueStr = _AcpmsAPPhaseAValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 52),
...
acpmsAPPhaseBValueStr = _AcpmsAPPhaseBValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 53),
...
acpmsAPPhaseCValueStr = _AcpmsAPPhaseCValueStr_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 54),
...
acpmsTotalEnergyWh = _AcpmsTotalEnergyWh_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 55),
...
acpmsTotalEnergyVAR = _AcpmsTotalEnergyVAR_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 56),
...
acpmsTotalEnergyVA = _AcpmsTotalEnergyVA_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 8, 1, 1, 57),
...
aisgsALDModel = _AisgsALDModel_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 9, 3, 1, 10),
    _AisgsALDModel_Type()
)
...
aisgsALDAntennaModel = _AisgsALDAntennaModel_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 9, 3, 1, 11),
...
aisgsALDMinTilt = _AisgsALDMinTilt_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 9, 3, 1, 12),
...
aisgsALDMaxTilt = _AisgsALDMaxTilt_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 9, 3, 1, 13),
...
aisgsALDAISGVersion = _AisgsALDAISGVersion_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 1, 9, 3, 1, 14),
...
esNumberNoiseSensors = _EsNumberNoiseSensors_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 10),
...
esNoiseReportingMode = _EsNoiseReportingMode_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 11),
...
esNumberAirflowSensors = _EsNumberAirflowSensors_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 12),
...
esAirflowReportingMode = _EsAirflowReportingMode_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 13),
...
esNumberAnalog = _EsNumberAnalog_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 14),
...
esAnalogReportingMode = _EsAnalogReportingMode_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 15),
...
esNumberOutputs = _EsNumberOutputs_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 16),
...
esOutputReportingMode = _EsOutputReportingMode_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 17),
...
esTempCombinedStatus = _EsTempCombinedStatus_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 18),
...
esCCCombinedStatusBlock1 = _EsCCCombinedStatusBlock1_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 19),
...
esCCCombinedStatusBlock2 = _EsCCCombinedStatusBlock2_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 20),
...
esCCCombinedStatusBlock3 = _EsCCCombinedStatusBlock3_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 21),
...
esCCCombinedStatusBlock4 = _EsCCCombinedStatusBlock4_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 22),
...
esCCCombinedStatusBlock5 = _EsCCCombinedStatusBlock5_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 23),
...
esCCCombinedStatusBlock6 = _EsCCCombinedStatusBlock6_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 24),
...
esCCCombinedStatusBlock7 = _EsCCCombinedStatusBlock7_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 25),
...
esCCCombinedStatusBlock8 = _EsCCCombinedStatusBlock8_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 26),
...
esHumidCombinedStatus = _EsHumidCombinedStatus_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 27),
...
esAnalogCombinedStatusBlock1 = _EsAnalogCombinedStatusBlock1_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 28),
...
esAnalogCombinedStatusBlock2 = _EsAnalogCombinedStatusBlock2_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 29),
...
esAnalogCombinedStatusBlock3 = _EsAnalogCombinedStatusBlock3_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 30),
...
esAnalogCombinedStatusBlock4 = _EsAnalogCombinedStatusBlock4_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 31),
...
esAnalogCombinedStatusBlock5 = _EsAnalogCombinedStatusBlock5_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 32),
...
esAnalogCombinedStatusBlock6 = _EsAnalogCombinedStatusBlock6_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 33),
...
esOutputCombinedStatusBlock1 = _EsOutputCombinedStatusBlock1_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 34),
...
esOutputCombinedStatusBlock2 = _EsOutputCombinedStatusBlock2_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 1, 2, 1, 35),
...
esPointConfigTempEntry = _EsPointConfigTempEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1)
)
esPointConfigTempEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "espcTempIndexES"),
    (0, "SITEBOSS-572-STD-MIB", "espcTempIndexPoint"),
)
if mibBuilder.loadTexts:
...
espcTempHighTemp = _EspcTempHighTemp_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 10),
...
espcTempHighActions = _EspcTempHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 11),
...
espcTempHighTrapnum = _EspcTempHighTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 12),
...
espcTempHighClass = _EspcTempHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 13),
...
espcTempNormalActions = _EspcTempNormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 14),
...
espcTempNormalTrapnum = _EspcTempNormalTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 15),
...
espcTempNormalClass = _EspcTempNormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 16),
...
espcTempLowTemp = _EspcTempLowTemp_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 17),
...
espcTempLowActions = _EspcTempLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 18),
...
espcTempLowTrapnum = _EspcTempLowTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 19),
...
espcTempLowClass = _EspcTempLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 20),
...
espcTempVLowTemp = _EspcTempVLowTemp_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 21),
...
espcTempVLowActions = _EspcTempVLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 22),
...
espcTempVLowTrapnum = _EspcTempVLowTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 23),
...
espcTempVLowClass = _EspcTempVLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 1, 1, 24),
...
esPointConfigCCEntry = _EsPointConfigCCEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 2, 1)
)
esPointConfigCCEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "espcCCIndexES"),
    (0, "SITEBOSS-572-STD-MIB", "espcCCIndexPoint"),
)
if mibBuilder.loadTexts:
...
espcCCNormalActions = _EspcCCNormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 2, 1, 10),
...
espcCCNormalTrapnum = _EspcCCNormalTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 2, 1, 11),
...
espcCCNormalClass = _EspcCCNormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 2, 1, 12),
...
espcCCAlarmAlias = _EspcCCAlarmAlias_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 2, 1, 13),
...
espcCCNormalAlias = _EspcCCNormalAlias_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 2, 1, 14),
...
espcCCNormalThreshold = _EspcCCNormalThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 2, 1, 15),
...
espcCCOverrideGlobalReminder = _EspcCCOverrideGlobalReminder_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 2, 1, 16),
...
espcCCReminderInterval = _EspcCCReminderInterval_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 2, 1, 17),
...
esPointConfigHumidEntry = _EsPointConfigHumidEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1)
)
esPointConfigHumidEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "espcHumidIndexES"),
    (0, "SITEBOSS-572-STD-MIB", "espcHumidIndexPoint"),
)
if mibBuilder.loadTexts:
...
espcHumidHighActions = _EspcHumidHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 10),
...
espcHumidHighTrapnum = _EspcHumidHighTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 11),
...
espcHumidHighClass = _EspcHumidHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 12),
...
espcHumidNormalActions = _EspcHumidNormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 13),
...
espcHumidNormalTrapnum = _EspcHumidNormalTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 14),
...
espcHumidNormalClass = _EspcHumidNormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 15),
...
espcHumidLowHumid = _EspcHumidLowHumid_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 16),
...
espcHumidLowActions = _EspcHumidLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 17),
...
espcHumidLowTrapnum = _EspcHumidLowTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 18),
...
espcHumidLowClass = _EspcHumidLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 19),
...
espcHumidVLowHumid = _EspcHumidVLowHumid_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 20),
...
espcHumidVLowActions = _EspcHumidVLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 21),
...
espcHumidVLowTrapnum = _EspcHumidVLowTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 22),
...
espcHumidVLowClass = _EspcHumidVLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 3, 1, 23),
...
espcAIHighValue = _EspcAIHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 10),
...
espcAIHighActions = _EspcAIHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 11),
...
espcAIHighTrapnum = _EspcAIHighTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 12),
...
espcAIHighClass = _EspcAIHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 13),
...
espcAINormalActions = _EspcAINormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 14),
...
espcAINormalTrapnum = _EspcAINormalTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 15),
...
espcAINormalClass = _EspcAINormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 16),
...
espcAILowValue = _EspcAILowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 17),
...
espcAILowActions = _EspcAILowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 18),
...
espcAILowTrapnum = _EspcAILowTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 19),
...
espcAILowClass = _EspcAILowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 20),
...
espcAIVlowValue = _EspcAIVlowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 21),
...
espcAIVlowActions = _EspcAIVlowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 22),
...
espcAIVlowTrapnum = _EspcAIVlowTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 23),
...
espcAIVlowClass = _EspcAIVlowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 24),
...
espcAIConvUnitName = _EspcAIConvUnitName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 25),
...
espcAIConvHighValue = _EspcAIConvHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 26),
...
espcAIConvHighUnit = _EspcAIConvHighUnit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 27),
...
espcAIConvLowValue = _EspcAIConvLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 29),
...
espcAIConvLowUnit = _EspcAIConvLowUnit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 30),
...
espcAIDisplayFormat = _EspcAIDisplayFormat_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 5, 1, 32),
...
esPointConfigOutputEntry = _EsPointConfigOutputEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 6, 1)
)
esPointConfigOutputEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "espcOutputIndexES"),
    (0, "SITEBOSS-572-STD-MIB", "espcOutputIndexPoint"),
)
if mibBuilder.loadTexts:
...
espcOutputActiveAlias = _EspcOutputActiveAlias_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 6, 1, 10),
...
espcOutputActiveColor = _EspcOutputActiveColor_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 6, 1, 11),
...
espcOutputActiveActions = _EspcOutputActiveActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 6, 1, 12),
...
espcOutputActiveTrapnum = _EspcOutputActiveTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 6, 1, 13),
...
espcOutputActiveClass = _EspcOutputActiveClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 6, 1, 14),
...
espcOutputInactiveAlias = _EspcOutputInactiveAlias_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 6, 1, 20),
...
espcOutputInactiveColor = _EspcOutputInactiveColor_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 6, 1, 21),
...
espcOutputInactiveActions = _EspcOutputInactiveActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 6, 1, 22),
...
espcOutputInactiveTrapnum = _EspcOutputInactiveTrapnum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 6, 1, 23),
...
espcOutputInactiveClass = _EspcOutputInactiveClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 2, 6, 1, 24),
...
portConfigRecordTimeout = _PortConfigRecordTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 10),
...
portConfigDataType = _PortConfigDataType_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 11),
...
portConfigEtxToCRLF = _PortConfigEtxToCRLF_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 12),
...
portConfigMLREnable = _PortConfigMLREnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 13),
...
portConfigMLRStartField1Pos = _PortConfigMLRStartField1Pos_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 14),
...
portConfigMLRStartField1Text = _PortConfigMLRStartField1Text_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 15),
...
portConfigMLRStartField2Pos = _PortConfigMLRStartField2Pos_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 16),
...
portConfigMLRStartField2Text = _PortConfigMLRStartField2Text_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 17),
...
portConfigMLRNumLinesBefore = _PortConfigMLRNumLinesBefore_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 18),
...
portConfigMLREndDetection = _PortConfigMLREndDetection_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 19),
...
portConfigMLRLineCount = _PortConfigMLRLineCount_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 20),
...
portConfigMLREndField1Pos = _PortConfigMLREndField1Pos_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 21),
...
portConfigMLREndField1Text = _PortConfigMLREndField1Text_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 22),
...
portConfigMLREndField2Pos = _PortConfigMLREndField2Pos_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 23),
...
portConfigMLREndField2Text = _PortConfigMLREndField2Text_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 24),
...
portConfigMLRUseComplexRules = _PortConfigMLRUseComplexRules_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 25),
...
portConfigBufferPT = _PortConfigBufferPT_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 26),
...
portConfigId = _PortConfigId_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 27),
    _PortConfigId_Type()
)
...
portConfigMode = _PortConfigMode_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 28),
...
portConfigHsk = _PortConfigHsk_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 3, 2, 1, 29),
    _PortConfigHsk_Type()
)
...
eth1Address = _Eth1Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 2),
    _Eth1Address_Type()
)
...
eth1SubnetMask = _Eth1SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 3),
...
eth1Router = _Eth1Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 4),
    _Eth1Router_Type()
)
...
eth1VLAN1Priority = _Eth1VLAN1Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 1, 2),
...
eth1VLAN1Address = _Eth1VLAN1Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 1, 3),
...
eth1VLAN1SubnetMask = _Eth1VLAN1SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 1, 4),
...
eth1VLAN1Router = _Eth1VLAN1Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 1, 5),
...
eth1VLAN2Priority = _Eth1VLAN2Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 2, 2),
...
eth1VLAN2Address = _Eth1VLAN2Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 2, 3),
...
eth1VLAN2SubnetMask = _Eth1VLAN2SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 2, 4),
...
eth1VLAN2Router = _Eth1VLAN2Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 2, 5),
...
eth1VLAN3Priority = _Eth1VLAN3Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 3, 2),
...
eth1VLAN3Address = _Eth1VLAN3Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 3, 3),
...
eth1VLAN3SubnetMask = _Eth1VLAN3SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 3, 4),
...
eth1VLAN3Router = _Eth1VLAN3Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 3, 5),
...
eth1VLAN4Priority = _Eth1VLAN4Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 4, 2),
...
eth1VLAN4Address = _Eth1VLAN4Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 4, 3),
...
eth1VLAN4SubnetMask = _Eth1VLAN4SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 4, 4),
...
eth1VLAN4Router = _Eth1VLAN4Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 4, 5),
...
eth1VLAN5Priority = _Eth1VLAN5Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 5, 2),
...
eth1VLAN5Address = _Eth1VLAN5Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 5, 3),
...
eth1VLAN5SubnetMask = _Eth1VLAN5SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 5, 4),
...
eth1VLAN5Router = _Eth1VLAN5Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 5, 5),
...
eth1VLAN6Priority = _Eth1VLAN6Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 6, 2),
...
eth1VLAN6Address = _Eth1VLAN6Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 6, 3),
...
eth1VLAN6SubnetMask = _Eth1VLAN6SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 6, 4),
...
eth1VLAN6Router = _Eth1VLAN6Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 5, 6, 5),
...
eth1MAC = _Eth1MAC_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 6),
    _Eth1MAC_Type()
)
...
eth1IPv6Static = _Eth1IPv6Static_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 7, 2)
)
...
eth1IPv6StaticAddress = _Eth1IPv6StaticAddress_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 7, 2, 1),
...
eth1IPv6StaticRouter = _Eth1IPv6StaticRouter_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 7, 2, 2),
...
eth1IPv6Auto = _Eth1IPv6Auto_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 7, 3)
)
...
eth1IPv6AutoAddress1 = _Eth1IPv6AutoAddress1_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 7, 3, 1),
...
eth1IPv6AutoAddress2 = _Eth1IPv6AutoAddress2_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 7, 3, 2),
...
eth1IPv6AutoAddress3 = _Eth1IPv6AutoAddress3_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 7, 3, 3),
...
eth1IPv6AutoAddress4 = _Eth1IPv6AutoAddress4_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 7, 3, 4),
...
eth1IPv6LinkLocalAddress = _Eth1IPv6LinkLocalAddress_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 1, 7, 4),
...
eth2Address = _Eth2Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 2),
    _Eth2Address_Type()
)
...
eth2SubnetMask = _Eth2SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 3),
...
eth2Router = _Eth2Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 4),
    _Eth2Router_Type()
)
...
eth2VLAN1Priority = _Eth2VLAN1Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 1, 2),
...
eth2VLAN1Address = _Eth2VLAN1Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 1, 3),
...
eth2VLAN1SubnetMask = _Eth2VLAN1SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 1, 4),
...
eth2VLAN1Router = _Eth2VLAN1Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 1, 5),
...
eth2VLAN2Priority = _Eth2VLAN2Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 2, 2),
...
eth2VLAN2Address = _Eth2VLAN2Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 2, 3),
...
eth2VLAN2SubnetMask = _Eth2VLAN2SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 2, 4),
...
eth2VLAN2Router = _Eth2VLAN2Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 2, 5),
...
eth2VLAN3Priority = _Eth2VLAN3Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 3, 2),
...
eth2VLAN3Address = _Eth2VLAN3Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 3, 3),
...
eth2VLAN3SubnetMask = _Eth2VLAN3SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 3, 4),
...
eth2VLAN3Router = _Eth2VLAN3Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 3, 5),
...
eth2VLAN4Priority = _Eth2VLAN4Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 4, 2),
...
eth2VLAN4Address = _Eth2VLAN4Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 4, 3),
...
eth2VLAN4SubnetMask = _Eth2VLAN4SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 4, 4),
...
eth2VLAN4Router = _Eth2VLAN4Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 4, 5),
...
eth2VLAN5Priority = _Eth2VLAN5Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 5, 2),
...
eth2VLAN5Address = _Eth2VLAN5Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 5, 3),
...
eth2VLAN5SubnetMask = _Eth2VLAN5SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 5, 4),
...
eth2VLAN5Router = _Eth2VLAN5Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 5, 5),
...
eth2VLAN6Priority = _Eth2VLAN6Priority_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 6, 2),
...
eth2VLAN6Address = _Eth2VLAN6Address_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 6, 3),
...
eth2VLAN6SubnetMask = _Eth2VLAN6SubnetMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 6, 4),
...
eth2VLAN6Router = _Eth2VLAN6Router_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 5, 6, 5),
...
eth2MAC = _Eth2MAC_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 6),
    _Eth2MAC_Type()
)
...
eth2IPv6Static = _Eth2IPv6Static_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 7, 2)
)
...
eth2IPv6StaticAddress = _Eth2IPv6StaticAddress_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 7, 2, 1),
...
eth2IPv6StaticRouter = _Eth2IPv6StaticRouter_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 7, 2, 2),
...
eth2IPv6Auto = _Eth2IPv6Auto_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 7, 3)
)
...
eth2IPv6AutoAddress1 = _Eth2IPv6AutoAddress1_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 7, 3, 1),
...
eth2IPv6AutoAddress2 = _Eth2IPv6AutoAddress2_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 7, 3, 2),
...
eth2IPv6AutoAddress3 = _Eth2IPv6AutoAddress3_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 7, 3, 3),
...
eth2IPv6AutoAddress4 = _Eth2IPv6AutoAddress4_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 7, 3, 4),
...
eth2IPv6LinkLocalAddress = _Eth2IPv6LinkLocalAddress_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 1, 1, 2, 7, 4),
...
snmpPRequestIndex = _SnmpPRequestIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 1),
...
snmpPRequestDescription = _SnmpPRequestDescription_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 2),
...
snmpPRequestAgent = _SnmpPRequestAgent_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 3),
...
snmpPRequestReadcom = _SnmpPRequestReadcom_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 4),
...
snmpPRequestOID = _SnmpPRequestOID_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 5),
...
snmpPRequestPeriod = _SnmpPRequestPeriod_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 6),
...
snmpPRequestID = _SnmpPRequestID_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 7),
...
snmpPRequestThreshold = _SnmpPRequestThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 8),
...
snmpPRequestResultStatus = _SnmpPRequestResultStatus_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 10),
...
snmpPRequestResultValue = _SnmpPRequestResultValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 11),
...
snmpPRequestResultTime = _SnmpPRequestResultTime_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 12),
...
snmpPRequestResultType = _SnmpPRequestResultType_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 8, 9, 4, 1, 13),
...
ftpPushPushFileEntry = _FtpPushPushFileEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 9, 8, 1)
)
ftpPushPushFileEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "ftpPushPushFileIndex"),
)
if mibBuilder.loadTexts:
...
ftpPushPushFileIndex = _FtpPushPushFileIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 9, 8, 1, 1),
...
ftpPushPushFile = _FtpPushPushFile_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 9, 8, 1, 2),
...
ftpPushRemoteFileEntry = _FtpPushRemoteFileEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 9, 11, 1)
)
ftpPushRemoteFileEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "ftpPushRemoteFileIndex"),
)
if mibBuilder.loadTexts:
...
ftpPushRemoteFileIndex = _FtpPushRemoteFileIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 9, 11, 1, 1),
...
ftpPushRemoteFileName = _FtpPushRemoteFileName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 9, 11, 1, 2),
...
pppDialNumber = _PppDialNumber_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 10, 1, 2),
    _PppDialNumber_Type()
)
...
pppDialIdleTimeout = _PppDialIdleTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 10, 1, 5),
...
pppDialRetries = _PppDialRetries_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 10, 1, 6),
...
pppDialCDTimeout = _PppDialCDTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 10, 1, 7),
...
pppDialLoginTimeout = _PppDialLoginTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 10, 1, 8),
...
pppDialMdmInit = _PppDialMdmInit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 10, 1, 9),
...
pppDialSuggestIP = _PppDialSuggestIP_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 10, 1, 10),
...
pppDialPlainLogin = _PppDialPlainLogin_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 10, 1, 11),
...
pppHostIdleTimeout = _PppHostIdleTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 10, 2, 2),
...
pppHostLocalIP = _PppHostLocalIP_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 10, 2, 3),
...
pppHostRemoteIP = _PppHostRemoteIP_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 10, 2, 4),
...
ipRestrictionIndex = _IpRestrictionIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 12, 1, 1, 1, 1),
...
ipRestrictionEnable = _IpRestrictionEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 12, 1, 1, 1, 2),
...
ipRestrictionMask = _IpRestrictionMask_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 12, 1, 1, 1, 3),
...
rtsFileIndex = _RtsFileIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 1, 1, 1),
    _RtsFileIndex_Type()
)
...
rtsFileMode = _RtsFileMode_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 1, 1, 2),
    _RtsFileMode_Type()
)
...
rtsFileShowAnswer = _RtsFileShowAnswer_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 1, 1, 3),
...
rtsFileReqXON = _RtsFileReqXON_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 1, 1, 4),
    _RtsFileReqXON_Type()
)
...
rtsFileTimeout = _RtsFileTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 1, 1, 5),
...
rtsFileEmptyClose = _RtsFileEmptyClose_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 1, 1, 6),
...
rtsFilePushHost = _RtsFilePushHost_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 1, 1, 7),
...
rtsFilePushPort = _RtsFilePushPort_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 1, 1, 8),
...
rtsFilePushRetryTimer = _RtsFilePushRetryTimer_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 1, 1, 9),
...
rtsAlarmsShowAnswer = _RtsAlarmsShowAnswer_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 2, 2),
...
rtsAlarmsReqXON = _RtsAlarmsReqXON_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 2, 3),
...
rtsAlarmsTimeout = _RtsAlarmsTimeout_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 2, 4),
...
rtsAlarmsEmptyClose = _RtsAlarmsEmptyClose_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 2, 5),
...
rtsAlarmsPushHost = _RtsAlarmsPushHost_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 2, 6),
...
rtsAlarmsPushPort = _RtsAlarmsPushPort_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 2, 7),
...
rtsAlarmsPushRetryTimer = _RtsAlarmsPushRetryTimer_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 13, 2, 8),
...
trapIncludeDateTime = _TrapIncludeDateTime_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 14, 1, 1),
...
trapIncludeSiteName = _TrapIncludeSiteName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 14, 1, 2),
...
trapIncludeSensorID = _TrapIncludeSensorID_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 14, 1, 3),
...
trapIncludeUDName = _TrapIncludeUDName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 14, 1, 4),
...
trapIncludeUDState = _TrapIncludeUDState_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 14, 1, 5),
...
trapIncludeSourceAddress = _TrapIncludeSourceAddress_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 14, 1, 6),
...
routeTestAddressEntry = _RouteTestAddressEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 15, 3, 1)
)
routeTestAddressEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "routeTestAddressIndex"),
)
if mibBuilder.loadTexts:
...
routeTestAddressIndex = _RouteTestAddressIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 15, 3, 1, 1),
...
routeTestAddress = _RouteTestAddress_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 15, 3, 1, 2),
...
wirelessConnCheckInterval = _WirelessConnCheckInterval_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 16, 20, 2),
...
wirelessConnFailThreshold = _WirelessConnFailThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 16, 20, 3),
...
wirelessConnIP1 = _WirelessConnIP1_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 16, 20, 10),
...
wirelessConnIP2 = _WirelessConnIP2_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 16, 20, 11),
...
cpeIndex = _CpeIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 1),
    _CpeIndex_Type()
)
...
cpeHost = _CpeHost_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 2),
    _CpeHost_Type()
)
...
cpeName = _CpeName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 3),
    _CpeName_Type()
)
...
cpeDescription = _CpeDescription_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 4),
...
cpeKeepalive = _CpeKeepalive_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 5),
    _CpeKeepalive_Type()
)
...
cpeThreshold = _CpeThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 6),
    _CpeThreshold_Type()
)
...
cpeEventReminderInterval = _CpeEventReminderInterval_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 7),
...
cpeKeepaliveTicks = _CpeKeepaliveTicks_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 20),
...
cpePingSize = _CpePingSize_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 21),
    _CpePingSize_Type()
)
...
cpeInfoReset = _CpeInfoReset_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 30),
    _CpeInfoReset_Type()
)
...
cpeInfoNumReq = _CpeInfoNumReq_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 31),
    _CpeInfoNumReq_Type()
)
...
cpeInfoNumGoodResp = _CpeInfoNumGoodResp_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 32),
...
cpeInfoNumBadResp = _CpeInfoNumBadResp_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 33),
...
cpeInfoNumLostResp = _CpeInfoNumLostResp_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 34),
...
cpeInfoPercentLoss = _CpeInfoPercentLoss_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 35),
...
cpeInfoPercentBad = _CpeInfoPercentBad_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 4, 22, 1, 1, 36),
...
modemCLIDNumberEntry = _ModemCLIDNumberEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 5, 8, 2, 1)
)
modemCLIDNumberEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "modemCLIDNumberIndex"),
)
if mibBuilder.loadTexts:
...
modemCLIDNumberIndex = _ModemCLIDNumberIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 5, 8, 2, 1, 1),
...
modemCLIDNumber = _ModemCLIDNumber_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 5, 8, 2, 1, 2),
...
time = _Time_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 8)
)
_Clock_Type = DisplayString
_Clock_Object = MibScalar
clock = _Clock_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 8, 1),
    _Clock_Type()
)
...
secUserIndex = _SecUserIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 1),
    _SecUserIndex_Type()
)
...
secUserEnable = _SecUserEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 2),
    _SecUserEnable_Type()
)
...
secUserConnectVia = _SecUserConnectVia_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 5),
...
secUserLoginTo = _SecUserLoginTo_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 6),
...
secUserAccessFile = _SecUserAccessFile_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 7),
...
secUserPTEscapeTo = _SecUserPTEscapeTo_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 9),
...
secUserPPPType = _SecUserPPPType_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 10),
...
secUserRights = _SecUserRights_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 11),
    _SecUserRights_Type()
)
...
secUserEventsReadAccess = _SecUserEventsReadAccess_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 13),
...
secUserAuditReadAccess = _SecUserAuditReadAccess_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 14),
...
secUserEventsWriteAccess = _SecUserEventsWriteAccess_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 16),
...
secUserAuditWriteAccess = _SecUserAuditWriteAccess_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 17),
...
secUserExpiration = _SecUserExpiration_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 18),
...
secUserCallbackNumber1 = _SecUserCallbackNumber1_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 19),
...
secUserCallbackNumber2 = _SecUserCallbackNumber2_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 20),
...
secUserCallbackNumber3 = _SecUserCallbackNumber3_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 21),
...
secUserChallengeTelnetMode = _SecUserChallengeTelnetMode_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 22),
...
secUserChallengeModemMode = _SecUserChallengeModemMode_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 23),
...
secUserChallengeConsoleMode = _SecUserChallengeConsoleMode_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 24),
...
secUserChallengeTelnetSendTo = _SecUserChallengeTelnetSendTo_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 25),
...
secUserChallengeModemSendTo = _SecUserChallengeModemSendTo_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 26),
...
secUserChallengeExpiration = _SecUserChallengeExpiration_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 11, 2, 1, 27),
...
evClassNameIndex = _EvClassNameIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 1, 1, 1, 1),
...
evClassName = _EvClassName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 1, 1, 1, 2),
    _EvClassName_Type()
)
...
evLogStoreAlarm = _EvLogStoreAlarm_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 1, 3, 2),
...
evLogMaxSize = _EvLogMaxSize_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 1, 3, 3),
    _EvLogMaxSize_Type()
)
...
evLogStoreSensor = _EvLogStoreSensor_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 1, 3, 4),
...
evLogTimeStampAlarms = _EvLogTimeStampAlarms_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 1, 3, 5),
...
evLogPrependName = _EvLogPrependName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 1, 3, 6),
...
evdFilterAction = _EvdFilterAction_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 1, 2),
...
evdWildCardChar = _EvdWildCardChar_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 1, 3),
...
evdIndex = _EvdIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 1),
    _EvdIndex_Type()
)
...
evdEnable = _EvdEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 2),
    _EvdEnable_Type()
)
...
evdName = _EvdName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 3),
    _EvdName_Type()
)
...
evdEquation = _EvdEquation_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 4),
    _EvdEquation_Type()
)
...
evdThreshold = _EvdThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 5),
    _EvdThreshold_Type()
)
...
evdAutoClear = _EvdAutoClear_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 6),
    _EvdAutoClear_Type()
)
...
evdClearInterval = _EvdClearInterval_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 7),
...
evdClearTime = _EvdClearTime_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 8),
    _EvdClearTime_Type()
)
...
evdActions = _EvdActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 9),
    _EvdActions_Type()
)
...
evdClass = _EvdClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 10),
    _EvdClass_Type()
)
...
evdTrapNum = _EvdTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 11),
    _EvdTrapNum_Type()
)
...
evdMode = _EvdMode_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 2, 1, 12),
    _EvdMode_Type()
)
...
evdFieldIndex = _EvdFieldIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 3, 1, 1),
    _EvdFieldIndex_Type()
)
...
evdFieldStart = _EvdFieldStart_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 3, 1, 2),
    _EvdFieldStart_Type()
)
...
evdFieldLength = _EvdFieldLength_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 3, 1, 3),
...
evdFieldName = _EvdFieldName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 3, 1, 4),
    _EvdFieldName_Type()
)
...
evdFieldLine = _EvdFieldLine_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 3, 1, 5),
    _EvdFieldLine_Type()
)
...
evdFieldType = _EvdFieldType_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 3, 1, 6),
    _EvdFieldType_Type()
)
...
evdMacroIndex = _EvdMacroIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 4, 1, 1),
    _EvdMacroIndex_Type()
)
...
evdMacroName = _EvdMacroName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 4, 1, 2),
    _EvdMacroName_Type()
)
...
evdMacroEquation = _EvdMacroEquation_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 2, 4, 1, 3),
...
evNoData1PortEnableEntry = _EvNoData1PortEnableEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 3, 12, 1)
)
evNoData1PortEnableEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "evNoData1PortEnableIndex"),
)
if mibBuilder.loadTexts:
...
evNoData1PortEnableIndex = _EvNoData1PortEnableIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 3, 12, 1, 1),
...
evNoData1PortEnable = _EvNoData1PortEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 3, 12, 1, 2),
...
evNoData2PortEnableEntry = _EvNoData2PortEnableEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 4, 12, 1)
)
evNoData2PortEnableEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "evNoData2PortEnableIndex"),
)
if mibBuilder.loadTexts:
...
evNoData2PortEnableIndex = _EvNoData2PortEnableIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 4, 12, 1, 1),
...
evNoData2PortEnable = _EvNoData2PortEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 4, 12, 1, 2),
...
evShskLowIndex = _EvShskLowIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 7, 1, 1),
...
evShskLowEnable = _EvShskLowEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 7, 1, 2),
...
evShskLowActions = _EvShskLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 7, 1, 3),
...
evShskLowMessage = _EvShskLowMessage_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 7, 1, 4),
...
evShskLowClass = _EvShskLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 7, 1, 5),
...
evShskLowTrapNum = _EvShskLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 7, 1, 6),
...
evShskHighIndex = _EvShskHighIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 8, 1, 1),
...
evShskHighEnable = _EvShskHighEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 8, 1, 2),
...
evShskHighActions = _EvShskHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 8, 1, 3),
...
evShskHighMessage = _EvShskHighMessage_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 8, 1, 4),
...
evShskHighClass = _EvShskHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 8, 1, 5),
...
evShskHighTrapNum = _EvShskHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 8, 1, 6),
...
fsGenIndex = _FsGenIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 1),
    _FsGenIndex_Type()
)
...
fsGenName = _FsGenName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 2),
    _FsGenName_Type()
)
...
fsGenSensorType = _FsGenSensorType_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 3),
...
fsGenDistanceUnit = _FsGenDistanceUnit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 4),
...
fsGenRawValueTop = _FsGenRawValueTop_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 5),
...
fsGenTopOffset = _FsGenTopOffset_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 6),
...
fsGenRawValueBottom = _FsGenRawValueBottom_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 7),
...
fsGenBottomOffset = _FsGenBottomOffset_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 8),
...
fsGenInputES = _FsGenInputES_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 9),
    _FsGenInputES_Type()
)
...
fsGenInputPoint = _FsGenInputPoint_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 10),
...
fsGenFilterAveraging = _FsGenFilterAveraging_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 11),
...
fsGenSysrepEnable = _FsGenSysrepEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 12),
...
fsGenSysrepThreshold = _FsGenSysrepThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 13),
...
fsGenSysrepLimit = _FsGenSysrepLimit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 14),
...
fsGenSysrepPackage = _FsGenSysrepPackage_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 15),
...
fsGenSysrepType = _FsGenSysrepType_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 16),
...
fsGenEnable = _FsGenEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 1, 1, 17),
    _FsGenEnable_Type()
)
...
fsTankIndex = _FsTankIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 2, 1, 1),
    _FsTankIndex_Type()
)
...
fsTankHeight = _FsTankHeight_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 2, 1, 2),
    _FsTankHeight_Type()
)
...
fsTankDimA = _FsTankDimA_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 2, 1, 3),
    _FsTankDimA_Type()
)
...
fsTankDimB = _FsTankDimB_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 2, 1, 4),
    _FsTankDimB_Type()
)
...
fsTankVolume = _FsTankVolume_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 2, 1, 5),
    _FsTankVolume_Type()
)
...
fsTankVolumeUnit = _FsTankVolumeUnit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 2, 1, 6),
...
fsTankShape = _FsTankShape_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 2, 1, 7),
    _FsTankShape_Type()
)
...
fsCustomTankEntry = _FsCustomTankEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 3, 1)
)
fsCustomTankEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "fsCustomTankIndexFS"),
    (0, "SITEBOSS-572-STD-MIB", "fsCustomTankIndexDatum"),
)
if mibBuilder.loadTexts:
...
fsCustomTankIndexFS = _FsCustomTankIndexFS_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 3, 1, 1),
...
fsCustomTankIndexDatum = _FsCustomTankIndexDatum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 3, 1, 2),
...
fsCustomTankHeight = _FsCustomTankHeight_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 3, 1, 3),
...
fsCustomTankVolume = _FsCustomTankVolume_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 3, 1, 4),
...
fsVolumeIndex = _FsVolumeIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 1),
    _FsVolumeIndex_Type()
)
...
fsVolumeEnable = _FsVolumeEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 2),
...
fsVolumeDeadband = _FsVolumeDeadband_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 3),
...
fsVolumeVHighValue = _FsVolumeVHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 4),
...
fsVolumeVHighActions = _FsVolumeVHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 5),
...
fsVolumeVHighTrapNum = _FsVolumeVHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 6),
...
fsVolumeVHighClass = _FsVolumeVHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 7),
...
fsVolumeHighValue = _FsVolumeHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 8),
...
fsVolumeHighActions = _FsVolumeHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 9),
...
fsVolumeHighTrapNum = _FsVolumeHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 10),
...
fsVolumeHighClass = _FsVolumeHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 11),
...
fsVolumeNormalActions = _FsVolumeNormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 12),
...
fsVolumeNormalTrapNum = _FsVolumeNormalTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 13),
...
fsVolumeNormalClass = _FsVolumeNormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 14),
...
fsVolumeLowValue = _FsVolumeLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 15),
...
fsVolumeLowActions = _FsVolumeLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 16),
...
fsVolumeLowTrapNum = _FsVolumeLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 17),
...
fsVolumeLowClass = _FsVolumeLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 18),
...
fsVolumeVLowValue = _FsVolumeVLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 19),
...
fsVolumeVLowActions = _FsVolumeVLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 20),
...
fsVolumeVLowTrapNum = _FsVolumeVLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 21),
...
fsVolumeVLowClass = _FsVolumeVLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 4, 1, 22),
...
fsDiscIndex = _FsDiscIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 5, 1, 1),
    _FsDiscIndex_Type()
)
...
fsDiscEnable = _FsDiscEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 5, 1, 2),
    _FsDiscEnable_Type()
)
...
fsDiscHighValue = _FsDiscHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 5, 1, 3),
...
fsDiscLowValue = _FsDiscLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 5, 1, 4),
...
fsDiscActions = _FsDiscActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 5, 1, 5),
    _FsDiscActions_Type()
)
...
fsDiscTrapNum = _FsDiscTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 5, 1, 6),
    _FsDiscTrapNum_Type()
)
...
fsDiscClass = _FsDiscClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 5, 1, 7),
    _FsDiscClass_Type()
)
...
fsDiscNormalActions = _FsDiscNormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 5, 1, 8),
...
fsDiscNormalTrapNum = _FsDiscNormalTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 5, 1, 9),
...
fsDiscNormalClass = _FsDiscNormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 11, 5, 1, 10),
...
acpmGenIndex = _AcpmGenIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 1, 1, 1),
    _AcpmGenIndex_Type()
)
...
acpmGenDevice = _AcpmGenDevice_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 1, 1, 2),
    _AcpmGenDevice_Type()
)
...
acpmGenName = _AcpmGenName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 1, 1, 3),
    _AcpmGenName_Type()
)
...
acpmGenAddress = _AcpmGenAddress_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 1, 1, 4),
...
acpmGenPtRatio = _AcpmGenPtRatio_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 1, 1, 5),
...
acpmGenCtRatio = _AcpmGenCtRatio_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 1, 1, 6),
...
acpmGenPowerType = _AcpmGenPowerType_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 1, 1, 7),
...
acpmGenSysrepPackage = _AcpmGenSysrepPackage_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 1, 1, 8),
...
acpmGenSysrepType = _AcpmGenSysrepType_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 1, 1, 9),
...
acpmGenEnable = _AcpmGenEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 1, 1, 10),
    _AcpmGenEnable_Type()
)
...
acpmAvgVoltageEntry = _AcpmAvgVoltageEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1)
)
acpmAvgVoltageEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "acpmAvgVoltageIndex"),
)
if mibBuilder.loadTexts:
...
acpmAvgVoltageIndex = _AcpmAvgVoltageIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 1),
...
acpmAvgVoltageEnable = _AcpmAvgVoltageEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 2),
...
acpmAvgVoltageDeadband = _AcpmAvgVoltageDeadband_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 3),
...
acpmAvgVoltageVHighValue = _AcpmAvgVoltageVHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 4),
...
acpmAvgVoltageVHighActions = _AcpmAvgVoltageVHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 5),
...
acpmAvgVoltageVHighTrapNum = _AcpmAvgVoltageVHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 6),
...
acpmAvgVoltageVHighClass = _AcpmAvgVoltageVHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 7),
...
acpmAvgVoltageHighValue = _AcpmAvgVoltageHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 8),
...
acpmAvgVoltageHighActions = _AcpmAvgVoltageHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 9),
...
acpmAvgVoltageHighTrapNum = _AcpmAvgVoltageHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 10),
...
acpmAvgVoltageHighClass = _AcpmAvgVoltageHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 11),
...
acpmAvgVoltageNormalActions = _AcpmAvgVoltageNormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 12),
...
acpmAvgVoltageNormalTrapNum = _AcpmAvgVoltageNormalTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 13),
...
acpmAvgVoltageNormalClass = _AcpmAvgVoltageNormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 14),
...
acpmAvgVoltageLowValue = _AcpmAvgVoltageLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 15),
...
acpmAvgVoltageLowActions = _AcpmAvgVoltageLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 16),
...
acpmAvgVoltageLowTrapNum = _AcpmAvgVoltageLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 17),
...
acpmAvgVoltageLowClass = _AcpmAvgVoltageLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 18),
...
acpmAvgVoltageVLowValue = _AcpmAvgVoltageVLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 19),
...
acpmAvgVoltageVLowActions = _AcpmAvgVoltageVLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 20),
...
acpmAvgVoltageVLowTrapNum = _AcpmAvgVoltageVLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 21),
...
acpmAvgVoltageVLowClass = _AcpmAvgVoltageVLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 22),
...
acpmAvgVoltageSysrepEnable = _AcpmAvgVoltageSysrepEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 23),
...
acpmAvgVoltageSysrepThreshold = _AcpmAvgVoltageSysrepThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 24),
...
acpmAvgVoltageSysrepLimit = _AcpmAvgVoltageSysrepLimit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 2, 1, 25),
...
acpmAvgCurrentEntry = _AcpmAvgCurrentEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1)
)
acpmAvgCurrentEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "acpmAvgCurrentIndex"),
)
if mibBuilder.loadTexts:
...
acpmAvgCurrentIndex = _AcpmAvgCurrentIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 1),
...
acpmAvgCurrentEnable = _AcpmAvgCurrentEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 2),
...
acpmAvgCurrentDeadband = _AcpmAvgCurrentDeadband_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 3),
...
acpmAvgCurrentVHighValue = _AcpmAvgCurrentVHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 4),
...
acpmAvgCurrentVHighActions = _AcpmAvgCurrentVHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 5),
...
acpmAvgCurrentVHighTrapNum = _AcpmAvgCurrentVHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 6),
...
acpmAvgCurrentVHighClass = _AcpmAvgCurrentVHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 7),
...
acpmAvgCurrentHighValue = _AcpmAvgCurrentHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 8),
...
acpmAvgCurrentHighActions = _AcpmAvgCurrentHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 9),
...
acpmAvgCurrentHighTrapNum = _AcpmAvgCurrentHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 10),
...
acpmAvgCurrentHighClass = _AcpmAvgCurrentHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 11),
...
acpmAvgCurrentNormalActions = _AcpmAvgCurrentNormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 12),
...
acpmAvgCurrentNormalTrapNum = _AcpmAvgCurrentNormalTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 13),
...
acpmAvgCurrentNormalClass = _AcpmAvgCurrentNormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 14),
...
acpmAvgCurrentLowValue = _AcpmAvgCurrentLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 15),
...
acpmAvgCurrentLowActions = _AcpmAvgCurrentLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 16),
...
acpmAvgCurrentLowTrapNum = _AcpmAvgCurrentLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 17),
...
acpmAvgCurrentLowClass = _AcpmAvgCurrentLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 18),
...
acpmAvgCurrentVLowValue = _AcpmAvgCurrentVLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 19),
...
acpmAvgCurrentVLowActions = _AcpmAvgCurrentVLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 20),
...
acpmAvgCurrentVLowTrapNum = _AcpmAvgCurrentVLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 21),
...
acpmAvgCurrentVLowClass = _AcpmAvgCurrentVLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 22),
...
acpmAvgCurrentSysrepEnable = _AcpmAvgCurrentSysrepEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 23),
...
acpmAvgCurrentSysrepThreshold = _AcpmAvgCurrentSysrepThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 24),
...
acpmAvgCurrentSysrepLimit = _AcpmAvgCurrentSysrepLimit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 3, 1, 25),
...
acpmFreqIndex = _AcpmFreqIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 1),
    _AcpmFreqIndex_Type()
)
...
acpmFreqEnable = _AcpmFreqEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 2),
...
acpmFreqDeadband = _AcpmFreqDeadband_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 3),
...
acpmFreqVHighValue = _AcpmFreqVHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 4),
...
acpmFreqVHighActions = _AcpmFreqVHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 5),
...
acpmFreqVHighTrapNum = _AcpmFreqVHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 6),
...
acpmFreqVHighClass = _AcpmFreqVHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 7),
...
acpmFreqHighValue = _AcpmFreqHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 8),
...
acpmFreqHighActions = _AcpmFreqHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 9),
...
acpmFreqHighTrapNum = _AcpmFreqHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 10),
...
acpmFreqHighClass = _AcpmFreqHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 11),
...
acpmFreqNormalActions = _AcpmFreqNormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 12),
...
acpmFreqNormalTrapNum = _AcpmFreqNormalTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 13),
...
acpmFreqNormalClass = _AcpmFreqNormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 14),
...
acpmFreqLowValue = _AcpmFreqLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 15),
...
acpmFreqLowActions = _AcpmFreqLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 16),
...
acpmFreqLowTrapNum = _AcpmFreqLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 17),
...
acpmFreqLowClass = _AcpmFreqLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 18),
...
acpmFreqVLowValue = _AcpmFreqVLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 19),
...
acpmFreqVLowActions = _AcpmFreqVLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 20),
...
acpmFreqVLowTrapNum = _AcpmFreqVLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 21),
...
acpmFreqVLowClass = _AcpmFreqVLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 22),
...
acpmFreqSysrepEnable = _AcpmFreqSysrepEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 23),
...
acpmFreqSysrepThreshold = _AcpmFreqSysrepThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 24),
...
acpmFreqSysrepLimit = _AcpmFreqSysrepLimit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 4, 1, 25),
...
acpmTRPIndex = _AcpmTRPIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 1),
    _AcpmTRPIndex_Type()
)
...
acpmTRPEnable = _AcpmTRPEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 2),
    _AcpmTRPEnable_Type()
)
...
acpmTRPDeadband = _AcpmTRPDeadband_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 3),
...
acpmTRPVHighValue = _AcpmTRPVHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 4),
...
acpmTRPVHighActions = _AcpmTRPVHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 5),
...
acpmTRPVHighTrapNum = _AcpmTRPVHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 6),
...
acpmTRPVHighClass = _AcpmTRPVHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 7),
...
acpmTRPHighValue = _AcpmTRPHighValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 8),
...
acpmTRPHighActions = _AcpmTRPHighActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 9),
...
acpmTRPHighTrapNum = _AcpmTRPHighTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 10),
...
acpmTRPHighClass = _AcpmTRPHighClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 11),
...
acpmTRPNormalActions = _AcpmTRPNormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 12),
...
acpmTRPNormalTrapNum = _AcpmTRPNormalTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 13),
...
acpmTRPNormalClass = _AcpmTRPNormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 14),
...
acpmTRPLowValue = _AcpmTRPLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 15),
...
acpmTRPLowActions = _AcpmTRPLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 16),
...
acpmTRPLowTrapNum = _AcpmTRPLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 17),
...
acpmTRPLowClass = _AcpmTRPLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 18),
...
acpmTRPVLowValue = _AcpmTRPVLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 19),
...
acpmTRPVLowActions = _AcpmTRPVLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 20),
...
acpmTRPVLowTrapNum = _AcpmTRPVLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 21),
...
acpmTRPVLowClass = _AcpmTRPVLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 22),
...
acpmTRPSysrepEnable = _AcpmTRPSysrepEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 23),
...
acpmTRPSysrepThreshold = _AcpmTRPSysrepThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 24),
...
acpmTRPSysrepLimit = _AcpmTRPSysrepLimit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 5, 1, 25),
...
acpmDisconnectEntry = _AcpmDisconnectEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 6, 1)
)
acpmDisconnectEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "acpmDisconnectIndex"),
)
if mibBuilder.loadTexts:
...
acpmDisconnectIndex = _AcpmDisconnectIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 6, 1, 1),
...
acpmDisconnectEnable = _AcpmDisconnectEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 6, 1, 2),
...
acpmDisconnectActions = _AcpmDisconnectActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 6, 1, 3),
...
acpmDisconnectTrapNum = _AcpmDisconnectTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 6, 1, 4),
...
acpmDisconnectClass = _AcpmDisconnectClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 6, 1, 5),
...
acpmDisconnectNormalActions = _AcpmDisconnectNormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 6, 1, 6),
...
acpmDisconnectNormalTrapNum = _AcpmDisconnectNormalTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 6, 1, 7),
...
acpmDisconnectNormalClass = _AcpmDisconnectNormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 6, 1, 8),
...
acpmTPFIndex = _AcpmTPFIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 1),
    _AcpmTPFIndex_Type()
)
...
acpmTPFEnable = _AcpmTPFEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 2),
    _AcpmTPFEnable_Type()
)
...
acpmTPFDeadband = _AcpmTPFDeadband_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 3),
...
acpmTPFNormalActions = _AcpmTPFNormalActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 4),
...
acpmTPFNormalTrapNum = _AcpmTPFNormalTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 5),
...
acpmTPFNormalClass = _AcpmTPFNormalClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 6),
...
acpmTPFLowValue = _AcpmTPFLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 7),
...
acpmTPFLowActions = _AcpmTPFLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 8),
...
acpmTPFLowTrapNum = _AcpmTPFLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 9),
...
acpmTPFLowClass = _AcpmTPFLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 10),
...
acpmTPFVLowValue = _AcpmTPFVLowValue_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 11),
...
acpmTPFVLowActions = _AcpmTPFVLowActions_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 12),
...
acpmTPFVLowTrapNum = _AcpmTPFVLowTrapNum_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 13),
...
acpmTPFVLowClass = _AcpmTPFVLowClass_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 14),
...
acpmTPFSysrepEnable = _AcpmTPFSysrepEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 15),
...
acpmTPFSysrepThreshold = _AcpmTPFSysrepThreshold_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 16),
...
acpmTPFSysrepLimit = _AcpmTPFSysrepLimit_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 12, 12, 7, 1, 17),
...
actionCallNumberEntry = _ActionCallNumberEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 1, 1)
)
actionCallNumberEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "actionCallNumberIndex"),
)
if mibBuilder.loadTexts:
...
actionCallNumberIndex = _ActionCallNumberIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 1, 1, 1),
...
actionCallNumber = _ActionCallNumber_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 1, 1, 2),
...
actionPagerIndex = _ActionPagerIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 2, 1, 1),
...
actionPagerType = _ActionPagerType_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 2, 1, 2),
...
actionPagerNumber = _ActionPagerNumber_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 2, 1, 3),
...
actionPagerID = _ActionPagerID_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 2, 1, 4),
    _ActionPagerID_Type()
)
...
actionPagerMessage = _ActionPagerMessage_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 2, 1, 5),
...
actionPagerPostCalloutDelay = _ActionPagerPostCalloutDelay_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 2, 1, 6),
...
actionPagerPostIDDelay = _ActionPagerPostIDDelay_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 2, 1, 7),
...
actionHostIndex = _ActionHostIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 6, 1, 1),
...
actionHost = _ActionHost_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 6, 1, 2),
    _ActionHost_Type()
)
...
actionEmailIndex = _ActionEmailIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 7, 1, 1),
...
actionEmail = _ActionEmail_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 14, 7, 1, 2),
    _ActionEmail_Type()
)
...
sysTimeNetHostTable = _SysTimeNetHostTable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 16, 1, 4, 2)
)
if mibBuilder.loadTexts:
...
sysTimeNetHostEntry = _SysTimeNetHostEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 16, 1, 4, 2, 1)
)
sysTimeNetHostEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "sysTimeNetHostIndex"),
)
if mibBuilder.loadTexts:
...
sysTimeNetHostIndex = _SysTimeNetHostIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 16, 1, 4, 2, 1, 1),
...
sysTimeNetHost = _SysTimeNetHost_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 16, 1, 4, 2, 1, 2),
...
sysCRDBFileIDIndex = _SysCRDBFileIDIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 16, 10, 3, 1, 1),
...
sysCRDBFileID = _SysCRDBFileID_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 16, 10, 3, 1, 2),
    _SysCRDBFileID_Type()
)
...
sysCRDBFileEnforceMinEntry = _SysCRDBFileEnforceMinEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 16, 10, 4, 1)
)
sysCRDBFileEnforceMinEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "sysCRDBFileEnforceMinIndex"),
)
if mibBuilder.loadTexts:
...
sysCRDBFileEnforceMinIndex = _SysCRDBFileEnforceMinIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 16, 10, 4, 1, 1),
...
sysCRDBFileEnforceMin = _SysCRDBFileEnforceMin_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 16, 10, 4, 1, 2),
...
scrDTRCtrlPortEnableEntry = _ScrDTRCtrlPortEnableEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 2, 1)
)
scrDTRCtrlPortEnableEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "scrDTRCtrlPortEnableIndex"),
)
if mibBuilder.loadTexts:
...
scrDTRCtrlPortEnableIndex = _ScrDTRCtrlPortEnableIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 2, 1, 1),
...
scrDTRCtrlPortEnable = _ScrDTRCtrlPortEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 2, 1, 2),
...
scrIndex = _ScrIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 3, 1, 1),
    _ScrIndex_Type()
)
...
scrEnable = _ScrEnable_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 3, 1, 2),
    _ScrEnable_Type()
)
...
scrName = _ScrName_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 3, 1, 3),
    _ScrName_Type()
)
...
scrFilename = _ScrFilename_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 3, 1, 4),
    _ScrFilename_Type()
)
...
scrRunAlways = _ScrRunAlways_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 3, 1, 5),
    _ScrRunAlways_Type()
)
...
scrRunAtStartup = _ScrRunAtStartup_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 3, 1, 6),
...
scrRunScheduled = _ScrRunScheduled_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 3, 1, 7),
...
scrScheduleTime = _ScrScheduleTime_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 3, 1, 8),
...
scrArguments = _ScrArguments_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 3, 1, 9),
    _ScrArguments_Type()
)
...
scrRepeatInterval = _ScrRepeatInterval_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 3, 1, 10),
...
scrVolatileStringEntry = _ScrVolatileStringEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 4, 1)
)
scrVolatileStringEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "scrVolatileStringIndex"),
)
if mibBuilder.loadTexts:
...
scrVolatileStringIndex = _ScrVolatileStringIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 4, 1, 1),
...
scrVolatileString = _ScrVolatileString_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 4, 1, 2),
...
scrVolatileIntEntry = _ScrVolatileIntEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 5, 1)
)
scrVolatileIntEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "scrVolatileIntIndex"),
)
if mibBuilder.loadTexts:
...
scrVolatileIntIndex = _ScrVolatileIntIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 5, 1, 1),
...
scrVolatileInt = _ScrVolatileInt_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 5, 1, 2),
...
scrNonVolatileStringEntry = _ScrNonVolatileStringEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 6, 1)
)
scrNonVolatileStringEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "scrNonVolatileStringIndex"),
)
if mibBuilder.loadTexts:
...
scrNonVolatileStringIndex = _ScrNonVolatileStringIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 6, 1, 1),
...
scrNonVolatileString = _ScrNonVolatileString_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 6, 1, 2),
...
scrNonVolatileIntEntry = _ScrNonVolatileIntEntry_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 7, 1)
)
scrNonVolatileIntEntry.setIndexNames(
    (0, "SITEBOSS-572-STD-MIB", "scrNonVolatileIntIndex"),
)
if mibBuilder.loadTexts:
...
scrNonVolatileIntIndex = _ScrNonVolatileIntIndex_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 7, 1, 1),
...
scrNonVolatileInt = _ScrNonVolatileInt_Object(
    (1, 3, 6, 1, 4, 1, 3052, 20, 2, 18, 7, 1, 2),
...
s572StockContactClosureTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 110)
)
s572StockContactClosureTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockContactClosureTrap.setStatus(
        "current"
    )

s572StockTempTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 120)
)
s572StockTempTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockTempTrap.setStatus(
        "current"
    )

s572StockHumidityTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 130)
)
s572StockHumidityTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockHumidityTrap.setStatus(
        "current"
    )

s572StockAnalogTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 140)
)
s572StockAnalogTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockAnalogTrap.setStatus(
        "current"
    )

s572StockOutputTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 150)
)
s572StockOutputTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockOutputTrap.setStatus(
        "current"
    )

s572StockPDCurrentTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 180)
)
s572StockPDCurrentTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockPDCurrentTrap.setStatus(
        "current"
    )

s572StockPDVoltageTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 190)
)
s572StockPDVoltageTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockPDVoltageTrap.setStatus(
        "current"
    )

s572StockPDFuseTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 210)
)
s572StockPDFuseTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockPDFuseTrap.setStatus(
        "current"
    )

s572StockDataAlarmTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 503)
)
s572StockDataAlarmTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockDataAlarmTrap.setStatus(
        "current"
    )

s572StockNoDataAlarmTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 505)
)
s572StockNoDataAlarmTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockNoDataAlarmTrap.setStatus(
        "current"
    )

s572StockSchedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 506)
)
s572StockSchedTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockSchedTrap.setStatus(
        "current"
    )

s572StockImmediateTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 507)
)
s572StockImmediateTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockImmediateTrap.setStatus(
        "current"
    )

s572StockCTSTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 510)
)
s572StockCTSTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockCTSTrap.setStatus(
        "current"
    )

s572CPEDownTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 511)
)
s572CPEDownTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572CPEDownTrap.setStatus(
        "current"
    )

s572FuelSensorDisconnectTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 515)
)
s572FuelSensorDisconnectTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572FuelSensorDisconnectTrap.setStatus(
        "current"
    )

s572FuelSensorVolumeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 519)
)
s572FuelSensorVolumeTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572FuelSensorVolumeTrap.setStatus(
        "current"
    )

s572ACPowerMonitorAvgVoltageTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 520)
)
s572ACPowerMonitorAvgVoltageTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572ACPowerMonitorAvgVoltageTrap.setStatus(
        "current"
    )

s572ACPowerMonitorAvgCurrentTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 521)
)
s572ACPowerMonitorAvgCurrentTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572ACPowerMonitorAvgCurrentTrap.setStatus(
        "current"
    )

s572ACPowerMonitorFrequencyTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 522)
)
s572ACPowerMonitorFrequencyTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572ACPowerMonitorFrequencyTrap.setStatus(
        "current"
    )

s572ACPowerMonitorTRPTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 523)
)
s572ACPowerMonitorTRPTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572ACPowerMonitorTRPTrap.setStatus(
        "current"
    )

s572ACPowerMonitorDisconnectTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 524)
)
s572ACPowerMonitorDisconnectTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572ACPowerMonitorDisconnectTrap.setStatus(
        "current"
    )

s572StockLoadSheddingTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 525)
)
s572StockLoadSheddingTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockLoadSheddingTrap.setStatus(
        "current"
    )

s572StockScriptTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 526)
)
s572StockScriptTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572StockScriptTrap.setStatus(
        "current"
    )

s572FuelSensorVolumeSuddenChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 527)
)
s572FuelSensorVolumeSuddenChangeTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572FuelSensorVolumeSuddenChangeTrap.setStatus(
        "current"
    )

s572FuelSensorVolumeSlowChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 528)
)
s572FuelSensorVolumeSlowChangeTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572FuelSensorVolumeSlowChangeTrap.setStatus(
        "current"
    )

s572ACTotalPowerFactorTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 540)
)
s572ACTotalPowerFactorTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572ACTotalPowerFactorTrap.setStatus(
        "current"
    )

s572ResetTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 543)
)
s572ResetTrap.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "stockTrapString"),
        ("SITEBOSS-572-STD-MIB", "trapTypeString"))
)
if mibBuilder.loadTexts:
    s572ResetTrap.setStatus(
        "current"
    )

s572UserTrap1000 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1000)
)
s572UserTrap1000.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeName"),
        ("SITEBOSS-572-STD-MIB", "esIndexPoint"),
        ("SITEBOSS-572-STD-MIB", "esPointName"),
        ("SITEBOSS-572-STD-MIB", "esID"),
        ("SITEBOSS-572-STD-MIB", "clock"),
        ("SITEBOSS-572-STD-MIB", "trapIncludedValue"),
        ("SITEBOSS-572-STD-MIB", "trapIncludedString"),
        ("SITEBOSS-572-STD-MIB", "trapEventClassNumber"),
        ("SITEBOSS-572-STD-MIB", "trapEventClassName"))
)
if mibBuilder.loadTexts:
    s572UserTrap1000.setStatus(
        "current"
    )

s572UserTrap1001 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1001)
)
s572UserTrap1001.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1001.setStatus(
        "current"
    )

s572UserTrap1002 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1002)
)
s572UserTrap1002.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1002.setStatus(
        "current"
    )

s572UserTrap1003 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1003)
)
s572UserTrap1003.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1003.setStatus(
        "current"
    )

s572UserTrap1004 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1004)
)
s572UserTrap1004.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1004.setStatus(
        "current"
    )

s572UserTrap1005 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1005)
)
s572UserTrap1005.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1005.setStatus(
        "current"
    )

s572UserTrap1006 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1006)
)
s572UserTrap1006.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1006.setStatus(
        "current"
    )

s572UserTrap1007 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1007)
)
s572UserTrap1007.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1007.setStatus(
        "current"
    )

s572UserTrap1008 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1008)
)
s572UserTrap1008.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1008.setStatus(
        "current"
    )

s572UserTrap1009 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1009)
)
s572UserTrap1009.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1009.setStatus(
        "current"
    )

s572UserTrap1010 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1010)
)
s572UserTrap1010.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1010.setStatus(
        "current"
    )

s572UserTrap1011 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1011)
)
s572UserTrap1011.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1011.setStatus(
        "current"
    )

s572UserTrap1012 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1012)
)
s572UserTrap1012.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1012.setStatus(
        "current"
    )

s572UserTrap1013 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1013)
)
s572UserTrap1013.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1013.setStatus(
        "current"
    )

s572UserTrap1014 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1014)
)
s572UserTrap1014.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1014.setStatus(
        "current"
    )

s572UserTrap1015 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1015)
)
s572UserTrap1015.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1015.setStatus(
        "current"
    )

s572UserTrap1016 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1016)
)
s572UserTrap1016.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1016.setStatus(
        "current"
    )

s572UserTrap1017 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1017)
)
s572UserTrap1017.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1017.setStatus(
        "current"
    )

s572UserTrap1018 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1018)
)
s572UserTrap1018.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1018.setStatus(
        "current"
    )

s572UserTrap1019 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1019)
)
s572UserTrap1019.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1019.setStatus(
        "current"
    )

s572UserTrap1020 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1020)
)
s572UserTrap1020.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1020.setStatus(
        "current"
    )

s572UserTrap1021 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1021)
)
s572UserTrap1021.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1021.setStatus(
        "current"
    )

s572UserTrap1022 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1022)
)
s572UserTrap1022.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1022.setStatus(
        "current"
    )

s572UserTrap1023 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1023)
)
s572UserTrap1023.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1023.setStatus(
        "current"
    )

s572UserTrap1024 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1024)
)
s572UserTrap1024.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1024.setStatus(
        "current"
    )

s572UserTrap1025 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1025)
)
s572UserTrap1025.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1025.setStatus(
        "current"
    )

s572UserTrap1026 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1026)
)
s572UserTrap1026.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1026.setStatus(
        "current"
    )

s572UserTrap1027 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1027)
)
s572UserTrap1027.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1027.setStatus(
        "current"
    )

s572UserTrap1028 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1028)
)
s572UserTrap1028.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1028.setStatus(
        "current"
    )

s572UserTrap1029 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1029)
)
s572UserTrap1029.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1029.setStatus(
        "current"
    )

s572UserTrap1030 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1030)
)
s572UserTrap1030.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1030.setStatus(
        "current"
    )

s572UserTrap1031 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1031)
)
s572UserTrap1031.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1031.setStatus(
        "current"
    )

s572UserTrap1032 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1032)
)
s572UserTrap1032.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1032.setStatus(
        "current"
    )

s572UserTrap1033 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1033)
)
s572UserTrap1033.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1033.setStatus(
        "current"
    )

s572UserTrap1034 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1034)
)
s572UserTrap1034.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1034.setStatus(
        "current"
    )

s572UserTrap1035 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1035)
)
s572UserTrap1035.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1035.setStatus(
        "current"
    )

s572UserTrap1036 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1036)
)
s572UserTrap1036.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1036.setStatus(
        "current"
    )

s572UserTrap1037 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1037)
)
s572UserTrap1037.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1037.setStatus(
        "current"
    )

s572UserTrap1038 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1038)
)
s572UserTrap1038.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1038.setStatus(
        "current"
    )

s572UserTrap1039 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1039)
)
s572UserTrap1039.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1039.setStatus(
        "current"
    )

s572UserTrap1040 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1040)
)
s572UserTrap1040.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1040.setStatus(
        "current"
    )

s572UserTrap1041 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1041)
)
s572UserTrap1041.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1041.setStatus(
        "current"
    )

s572UserTrap1042 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1042)
)
s572UserTrap1042.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1042.setStatus(
        "current"
    )

s572UserTrap1043 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1043)
)
s572UserTrap1043.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1043.setStatus(
        "current"
    )

s572UserTrap1044 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1044)
)
s572UserTrap1044.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1044.setStatus(
        "current"
    )

s572UserTrap1045 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1045)
)
s572UserTrap1045.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1045.setStatus(
        "current"
    )

s572UserTrap1046 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1046)
)
s572UserTrap1046.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1046.setStatus(
        "current"
    )

s572UserTrap1047 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1047)
)
s572UserTrap1047.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1047.setStatus(
        "current"
    )

s572UserTrap1048 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1048)
)
s572UserTrap1048.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1048.setStatus(
        "current"
    )

s572UserTrap1049 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1049)
)
s572UserTrap1049.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1049.setStatus(
        "current"
    )

s572UserTrap1050 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1050)
)
s572UserTrap1050.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1050.setStatus(
        "current"
    )

s572UserTrap1051 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1051)
)
s572UserTrap1051.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1051.setStatus(
        "current"
    )

s572UserTrap1052 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1052)
)
s572UserTrap1052.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1052.setStatus(
        "current"
    )

s572UserTrap1053 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1053)
)
s572UserTrap1053.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1053.setStatus(
        "current"
    )

s572UserTrap1054 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1054)
)
s572UserTrap1054.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1054.setStatus(
        "current"
    )

s572UserTrap1055 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1055)
)
s572UserTrap1055.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1055.setStatus(
        "current"
    )

s572UserTrap1056 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1056)
)
s572UserTrap1056.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1056.setStatus(
        "current"
    )

s572UserTrap1057 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1057)
)
s572UserTrap1057.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1057.setStatus(
        "current"
    )

s572UserTrap1058 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1058)
)
s572UserTrap1058.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1058.setStatus(
        "current"
    )

s572UserTrap1059 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1059)
)
s572UserTrap1059.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1059.setStatus(
        "current"
    )

s572UserTrap1060 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1060)
)
s572UserTrap1060.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1060.setStatus(
        "current"
    )

s572UserTrap1061 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1061)
)
s572UserTrap1061.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1061.setStatus(
        "current"
    )

s572UserTrap1062 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1062)
)
s572UserTrap1062.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1062.setStatus(
        "current"
    )

s572UserTrap1063 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1063)
)
s572UserTrap1063.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1063.setStatus(
        "current"
    )

s572UserTrap1064 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1064)
)
s572UserTrap1064.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1064.setStatus(
        "current"
    )

s572UserTrap1065 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1065)
)
s572UserTrap1065.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1065.setStatus(
        "current"
    )

s572UserTrap1066 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1066)
)
s572UserTrap1066.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1066.setStatus(
        "current"
    )

s572UserTrap1067 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1067)
)
s572UserTrap1067.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1067.setStatus(
        "current"
    )

s572UserTrap1068 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1068)
)
s572UserTrap1068.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1068.setStatus(
        "current"
    )

s572UserTrap1069 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1069)
)
s572UserTrap1069.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1069.setStatus(
        "current"
    )

s572UserTrap1070 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1070)
)
s572UserTrap1070.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1070.setStatus(
        "current"
    )

s572UserTrap1071 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1071)
)
s572UserTrap1071.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1071.setStatus(
        "current"
    )

s572UserTrap1072 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1072)
)
s572UserTrap1072.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1072.setStatus(
        "current"
    )

s572UserTrap1073 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1073)
)
s572UserTrap1073.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1073.setStatus(
        "current"
    )

s572UserTrap1074 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1074)
)
s572UserTrap1074.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1074.setStatus(
        "current"
    )

s572UserTrap1075 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1075)
)
s572UserTrap1075.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1075.setStatus(
        "current"
    )

s572UserTrap1076 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1076)
)
s572UserTrap1076.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1076.setStatus(
        "current"
    )

s572UserTrap1077 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1077)
)
s572UserTrap1077.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1077.setStatus(
        "current"
    )

s572UserTrap1078 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1078)
)
s572UserTrap1078.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1078.setStatus(
        "current"
    )

s572UserTrap1079 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1079)
)
s572UserTrap1079.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1079.setStatus(
        "current"
    )

s572UserTrap1080 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1080)
)
s572UserTrap1080.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1080.setStatus(
        "current"
    )

s572UserTrap1081 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1081)
)
s572UserTrap1081.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1081.setStatus(
        "current"
    )

s572UserTrap1082 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1082)
)
s572UserTrap1082.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1082.setStatus(
        "current"
    )

s572UserTrap1083 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1083)
)
s572UserTrap1083.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1083.setStatus(
        "current"
    )

s572UserTrap1084 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1084)
)
s572UserTrap1084.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1084.setStatus(
        "current"
    )

s572UserTrap1085 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1085)
)
s572UserTrap1085.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1085.setStatus(
        "current"
    )

s572UserTrap1086 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1086)
)
s572UserTrap1086.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1086.setStatus(
        "current"
    )

s572UserTrap1087 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1087)
)
s572UserTrap1087.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1087.setStatus(
        "current"
    )

s572UserTrap1088 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1088)
)
s572UserTrap1088.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1088.setStatus(
        "current"
    )

s572UserTrap1089 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1089)
)
s572UserTrap1089.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1089.setStatus(
        "current"
    )

s572UserTrap1090 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1090)
)
s572UserTrap1090.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1090.setStatus(
        "current"
    )

s572UserTrap1091 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1091)
)
s572UserTrap1091.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1091.setStatus(
        "current"
    )

s572UserTrap1092 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1092)
)
s572UserTrap1092.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1092.setStatus(
        "current"
    )

s572UserTrap1093 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1093)
)
s572UserTrap1093.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1093.setStatus(
        "current"
    )

s572UserTrap1094 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1094)
)
s572UserTrap1094.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1094.setStatus(
        "current"
    )

s572UserTrap1095 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1095)
)
s572UserTrap1095.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1095.setStatus(
        "current"
    )

s572UserTrap1096 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1096)
)
s572UserTrap1096.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1096.setStatus(
        "current"
    )

s572UserTrap1097 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1097)
)
s572UserTrap1097.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1097.setStatus(
        "current"
    )

s572UserTrap1098 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1098)
)
s572UserTrap1098.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1098.setStatus(
        "current"
    )

s572UserTrap1099 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1099)
)
s572UserTrap1099.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1099.setStatus(
        "current"
    )

s572UserTrap1100 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1100)
)
s572UserTrap1100.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1100.setStatus(
        "current"
    )

s572UserTrap1101 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1101)
)
s572UserTrap1101.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1101.setStatus(
        "current"
    )

s572UserTrap1102 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1102)
)
s572UserTrap1102.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1102.setStatus(
        "current"
    )

s572UserTrap1103 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1103)
)
s572UserTrap1103.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1103.setStatus(
        "current"
    )

s572UserTrap1104 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1104)
)
s572UserTrap1104.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1104.setStatus(
        "current"
    )

s572UserTrap1105 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1105)
)
s572UserTrap1105.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1105.setStatus(
        "current"
    )

s572UserTrap1106 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1106)
)
s572UserTrap1106.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1106.setStatus(
        "current"
    )

s572UserTrap1107 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1107)
)
s572UserTrap1107.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1107.setStatus(
        "current"
    )

s572UserTrap1108 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1108)
)
s572UserTrap1108.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1108.setStatus(
        "current"
    )

s572UserTrap1109 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1109)
)
s572UserTrap1109.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1109.setStatus(
        "current"
    )

s572UserTrap1110 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1110)
)
s572UserTrap1110.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1110.setStatus(
        "current"
    )

s572UserTrap1111 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1111)
)
s572UserTrap1111.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1111.setStatus(
        "current"
    )

s572UserTrap1112 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1112)
)
s572UserTrap1112.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1112.setStatus(
        "current"
    )

s572UserTrap1113 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1113)
)
s572UserTrap1113.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1113.setStatus(
        "current"
    )

s572UserTrap1114 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1114)
)
s572UserTrap1114.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1114.setStatus(
        "current"
    )

s572UserTrap1115 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1115)
)
s572UserTrap1115.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1115.setStatus(
        "current"
    )

s572UserTrap1116 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1116)
)
s572UserTrap1116.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1116.setStatus(
        "current"
    )

s572UserTrap1117 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1117)
)
s572UserTrap1117.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1117.setStatus(
        "current"
    )

s572UserTrap1118 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1118)
)
s572UserTrap1118.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1118.setStatus(
        "current"
    )

s572UserTrap1119 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1119)
)
s572UserTrap1119.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1119.setStatus(
        "current"
    )

s572UserTrap1120 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1120)
)
s572UserTrap1120.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1120.setStatus(
        "current"
    )

s572UserTrap1121 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1121)
)
s572UserTrap1121.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1121.setStatus(
        "current"
    )

s572UserTrap1122 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1122)
)
s572UserTrap1122.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1122.setStatus(
        "current"
    )

s572UserTrap1123 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1123)
)
s572UserTrap1123.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1123.setStatus(
        "current"
    )

s572UserTrap1124 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1124)
)
s572UserTrap1124.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1124.setStatus(
        "current"
    )

s572UserTrap1125 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1125)
)
s572UserTrap1125.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1125.setStatus(
        "current"
    )

s572UserTrap1126 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1126)
)
s572UserTrap1126.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1126.setStatus(
        "current"
    )

s572UserTrap1127 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1127)
)
s572UserTrap1127.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1127.setStatus(
        "current"
    )

s572UserTrap1128 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1128)
)
s572UserTrap1128.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1128.setStatus(
        "current"
    )

s572UserTrap1129 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1129)
)
s572UserTrap1129.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1129.setStatus(
        "current"
    )

s572UserTrap1130 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1130)
)
s572UserTrap1130.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1130.setStatus(
        "current"
    )

s572UserTrap1131 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1131)
)
s572UserTrap1131.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1131.setStatus(
        "current"
    )

s572UserTrap1132 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1132)
)
s572UserTrap1132.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1132.setStatus(
        "current"
    )

s572UserTrap1133 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1133)
)
s572UserTrap1133.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1133.setStatus(
        "current"
    )

s572UserTrap1134 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1134)
)
s572UserTrap1134.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1134.setStatus(
        "current"
    )

s572UserTrap1135 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1135)
)
s572UserTrap1135.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1135.setStatus(
        "current"
    )

s572UserTrap1136 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1136)
)
s572UserTrap1136.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1136.setStatus(
        "current"
    )

s572UserTrap1137 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1137)
)
s572UserTrap1137.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1137.setStatus(
        "current"
    )

s572UserTrap1138 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1138)
)
s572UserTrap1138.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1138.setStatus(
        "current"
    )

s572UserTrap1139 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1139)
)
s572UserTrap1139.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1139.setStatus(
        "current"
    )

s572UserTrap1140 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1140)
)
s572UserTrap1140.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1140.setStatus(
        "current"
    )

s572UserTrap1141 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1141)
)
s572UserTrap1141.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1141.setStatus(
        "current"
    )

s572UserTrap1142 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1142)
)
s572UserTrap1142.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1142.setStatus(
        "current"
    )

s572UserTrap1143 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1143)
)
s572UserTrap1143.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1143.setStatus(
        "current"
    )

s572UserTrap1144 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1144)
)
s572UserTrap1144.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1144.setStatus(
        "current"
    )

s572UserTrap1145 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1145)
)
s572UserTrap1145.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1145.setStatus(
        "current"
    )

s572UserTrap1146 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1146)
)
s572UserTrap1146.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1146.setStatus(
        "current"
    )

s572UserTrap1147 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1147)
)
s572UserTrap1147.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1147.setStatus(
        "current"
    )

s572UserTrap1148 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1148)
)
s572UserTrap1148.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1148.setStatus(
        "current"
    )

s572UserTrap1149 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1149)
)
s572UserTrap1149.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1149.setStatus(
        "current"
    )

s572UserTrap1150 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1150)
)
s572UserTrap1150.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1150.setStatus(
        "current"
    )

s572UserTrap1151 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1151)
)
s572UserTrap1151.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1151.setStatus(
        "current"
    )

s572UserTrap1152 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1152)
)
s572UserTrap1152.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1152.setStatus(
        "current"
    )

s572UserTrap1153 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1153)
)
s572UserTrap1153.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1153.setStatus(
        "current"
    )

s572UserTrap1154 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1154)
)
s572UserTrap1154.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1154.setStatus(
        "current"
    )

s572UserTrap1155 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1155)
)
s572UserTrap1155.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1155.setStatus(
        "current"
    )

s572UserTrap1156 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1156)
)
s572UserTrap1156.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1156.setStatus(
        "current"
    )

s572UserTrap1157 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1157)
)
s572UserTrap1157.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1157.setStatus(
        "current"
    )

s572UserTrap1158 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1158)
)
s572UserTrap1158.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1158.setStatus(
        "current"
    )

s572UserTrap1159 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1159)
)
s572UserTrap1159.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1159.setStatus(
        "current"
    )

s572UserTrap1160 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1160)
)
s572UserTrap1160.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1160.setStatus(
        "current"
    )

s572UserTrap1161 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1161)
)
s572UserTrap1161.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1161.setStatus(
        "current"
    )

s572UserTrap1162 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1162)
)
s572UserTrap1162.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1162.setStatus(
        "current"
    )

s572UserTrap1163 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1163)
)
s572UserTrap1163.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1163.setStatus(
        "current"
    )

s572UserTrap1164 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1164)
)
s572UserTrap1164.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1164.setStatus(
        "current"
    )

s572UserTrap1165 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1165)
)
s572UserTrap1165.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1165.setStatus(
        "current"
    )

s572UserTrap1166 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1166)
)
s572UserTrap1166.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1166.setStatus(
        "current"
    )

s572UserTrap1167 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1167)
)
s572UserTrap1167.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1167.setStatus(
        "current"
    )

s572UserTrap1168 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1168)
)
s572UserTrap1168.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1168.setStatus(
        "current"
    )

s572UserTrap1169 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1169)
)
s572UserTrap1169.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1169.setStatus(
        "current"
    )

s572UserTrap1170 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1170)
)
s572UserTrap1170.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1170.setStatus(
        "current"
    )

s572UserTrap1171 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1171)
)
s572UserTrap1171.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1171.setStatus(
        "current"
    )

s572UserTrap1172 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1172)
)
s572UserTrap1172.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1172.setStatus(
        "current"
    )

s572UserTrap1173 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1173)
)
s572UserTrap1173.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1173.setStatus(
        "current"
    )

s572UserTrap1174 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1174)
)
s572UserTrap1174.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1174.setStatus(
        "current"
    )

s572UserTrap1175 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1175)
)
s572UserTrap1175.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1175.setStatus(
        "current"
    )

s572UserTrap1176 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1176)
)
s572UserTrap1176.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1176.setStatus(
        "current"
    )

s572UserTrap1177 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1177)
)
s572UserTrap1177.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1177.setStatus(
        "current"
    )

s572UserTrap1178 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1178)
)
s572UserTrap1178.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1178.setStatus(
        "current"
    )

s572UserTrap1179 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1179)
)
s572UserTrap1179.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1179.setStatus(
        "current"
    )

s572UserTrap1180 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1180)
)
s572UserTrap1180.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1180.setStatus(
        "current"
    )

s572UserTrap1181 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1181)
)
s572UserTrap1181.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1181.setStatus(
        "current"
    )

s572UserTrap1182 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1182)
)
s572UserTrap1182.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1182.setStatus(
        "current"
    )

s572UserTrap1183 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1183)
)
s572UserTrap1183.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1183.setStatus(
        "current"
    )

s572UserTrap1184 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1184)
)
s572UserTrap1184.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1184.setStatus(
        "current"
    )

s572UserTrap1185 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1185)
)
s572UserTrap1185.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1185.setStatus(
        "current"
    )

s572UserTrap1186 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1186)
)
s572UserTrap1186.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1186.setStatus(
        "current"
    )

s572UserTrap1187 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1187)
)
s572UserTrap1187.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1187.setStatus(
        "current"
    )

s572UserTrap1188 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1188)
)
s572UserTrap1188.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1188.setStatus(
        "current"
    )

s572UserTrap1189 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1189)
)
s572UserTrap1189.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1189.setStatus(
        "current"
    )

s572UserTrap1190 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1190)
)
s572UserTrap1190.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1190.setStatus(
        "current"
    )

s572UserTrap1191 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1191)
)
s572UserTrap1191.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1191.setStatus(
        "current"
    )

s572UserTrap1192 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1192)
)
s572UserTrap1192.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1192.setStatus(
        "current"
    )

s572UserTrap1193 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1193)
)
s572UserTrap1193.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1193.setStatus(
        "current"
    )

s572UserTrap1194 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1194)
)
s572UserTrap1194.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1194.setStatus(
        "current"
    )

s572UserTrap1195 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1195)
)
s572UserTrap1195.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1195.setStatus(
        "current"
    )

s572UserTrap1196 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1196)
)
s572UserTrap1196.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1196.setStatus(
        "current"
    )

s572UserTrap1197 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1197)
)
s572UserTrap1197.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1197.setStatus(
        "current"
    )

s572UserTrap1198 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1198)
)
s572UserTrap1198.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
if mibBuilder.loadTexts:
    s572UserTrap1198.setStatus(
        "current"
    )

s572UserTrap1199 = NotificationType(
    (1, 3, 6, 1, 4, 1, 3052, 20, 0, 1199)
)
s572UserTrap1199.setObjects(
      *(("SITEBOSS-572-STD-MIB", "siteName"),
        ("SITEBOSS-572-STD-MIB", "esIndex"),
        ("SITEBOSS-572-STD-MIB", "esName"),
        ("SITEBOSS-572-STD-MIB", "trapEventTypeNumber"),
...
mibBuilder.exportSymbols(
    ...
    **{"s572": s572,
       "s572Notifications": s572Notifications,
       "s572StockContactClosureTrap": s572StockContactClosureTrap,
       "s572StockTempTrap": s572StockTempTrap,
       "s572StockHumidityTrap": s572StockHumidityTrap,
       "s572StockAnalogTrap": s572StockAnalogTrap,
       "s572StockOutputTrap": s572StockOutputTrap,
       "s572StockPDCurrentTrap": s572StockPDCurrentTrap,
       "s572StockPDVoltageTrap": s572StockPDVoltageTrap,
       "s572StockPDFuseTrap": s572StockPDFuseTrap,
       "s572StockDataAlarmTrap": s572StockDataAlarmTrap,
       "s572StockNoDataAlarmTrap": s572StockNoDataAlarmTrap,
       "s572StockSchedTrap": s572StockSchedTrap,
       "s572StockImmediateTrap": s572StockImmediateTrap,
       "s572StockCTSTrap": s572StockCTSTrap,
       "s572CPEDownTrap": s572CPEDownTrap,
       "s572FuelSensorDisconnectTrap": s572FuelSensorDisconnectTrap,
       "s572FuelSensorVolumeTrap": s572FuelSensorVolumeTrap,
       "s572ACPowerMonitorAvgVoltageTrap": s572ACPowerMonitorAvgVoltageTrap,
       "s572ACPowerMonitorAvgCurrentTrap": s572ACPowerMonitorAvgCurrentTrap,
       "s572ACPowerMonitorFrequencyTrap": s572ACPowerMonitorFrequencyTrap,
       "s572ACPowerMonitorTRPTrap": s572ACPowerMonitorTRPTrap,
       "s572ACPowerMonitorDisconnectTrap": s572ACPowerMonitorDisconnectTrap,
       "s572StockLoadSheddingTrap": s572StockLoadSheddingTrap,
       "s572StockScriptTrap": s572StockScriptTrap,
       "s572FuelSensorVolumeSuddenChangeTrap": s572FuelSensorVolumeSuddenChangeTrap,
       "s572FuelSensorVolumeSlowChangeTrap": s572FuelSensorVolumeSlowChangeTrap,
       "s572ACTotalPowerFactorTrap": s572ACTotalPowerFactorTrap,
       "s572ResetTrap": s572ResetTrap,
       "s572UserTrap1000": s572UserTrap1000,
       "s572UserTrap1001": s572UserTrap1001,
       "s572UserTrap1002": s572UserTrap1002,
       "s572UserTrap1003": s572UserTrap1003,
       "s572UserTrap1004": s572UserTrap1004,
       "s572UserTrap1005": s572UserTrap1005,
       "s572UserTrap1006": s572UserTrap1006,
       "s572UserTrap1007": s572UserTrap1007,
       "s572UserTrap1008": s572UserTrap1008,
       "s572UserTrap1009": s572UserTrap1009,
       "s572UserTrap1010": s572UserTrap1010,
       "s572UserTrap1011": s572UserTrap1011,
       "s572UserTrap1012": s572UserTrap1012,
       "s572UserTrap1013": s572UserTrap1013,
       "s572UserTrap1014": s572UserTrap1014,
       "s572UserTrap1015": s572UserTrap1015,
       "s572UserTrap1016": s572UserTrap1016,
       "s572UserTrap1017": s572UserTrap1017,
       "s572UserTrap1018": s572UserTrap1018,
       "s572UserTrap1019": s572UserTrap1019,
       "s572UserTrap1020": s572UserTrap1020,
       "s572UserTrap1021": s572UserTrap1021,
       "s572UserTrap1022": s572UserTrap1022,
       "s572UserTrap1023": s572UserTrap1023,
       "s572UserTrap1024": s572UserTrap1024,
       "s572UserTrap1025": s572UserTrap1025,
       "s572UserTrap1026": s572UserTrap1026,
       "s572UserTrap1027": s572UserTrap1027,
       "s572UserTrap1028": s572UserTrap1028,
       "s572UserTrap1029": s572UserTrap1029,
       "s572UserTrap1030": s572UserTrap1030,
       "s572UserTrap1031": s572UserTrap1031,
       "s572UserTrap1032": s572UserTrap1032,
       "s572UserTrap1033": s572UserTrap1033,
       "s572UserTrap1034": s572UserTrap1034,
       "s572UserTrap1035": s572UserTrap1035,
       "s572UserTrap1036": s572UserTrap1036,
       "s572UserTrap1037": s572UserTrap1037,
       "s572UserTrap1038": s572UserTrap1038,
       "s572UserTrap1039": s572UserTrap1039,
       "s572UserTrap1040": s572UserTrap1040,
       "s572UserTrap1041": s572UserTrap1041,
       "s572UserTrap1042": s572UserTrap1042,
       "s572UserTrap1043": s572UserTrap1043,
       "s572UserTrap1044": s572UserTrap1044,
       "s572UserTrap1045": s572UserTrap1045,
       "s572UserTrap1046": s572UserTrap1046,
       "s572UserTrap1047": s572UserTrap1047,
       "s572UserTrap1048": s572UserTrap1048,
       "s572UserTrap1049": s572UserTrap1049,
       "s572UserTrap1050": s572UserTrap1050,
       "s572UserTrap1051": s572UserTrap1051,
       "s572UserTrap1052": s572UserTrap1052,
       "s572UserTrap1053": s572UserTrap1053,
       "s572UserTrap1054": s572UserTrap1054,
       "s572UserTrap1055": s572UserTrap1055,
       "s572UserTrap1056": s572UserTrap1056,
       "s572UserTrap1057": s572UserTrap1057,
       "s572UserTrap1058": s572UserTrap1058,
       "s572UserTrap1059": s572UserTrap1059,
       "s572UserTrap1060": s572UserTrap1060,
       "s572UserTrap1061": s572UserTrap1061,
       "s572UserTrap1062": s572UserTrap1062,
       "s572UserTrap1063": s572UserTrap1063,
       "s572UserTrap1064": s572UserTrap1064,
       "s572UserTrap1065": s572UserTrap1065,
       "s572UserTrap1066": s572UserTrap1066,
       "s572UserTrap1067": s572UserTrap1067,
       "s572UserTrap1068": s572UserTrap1068,
       "s572UserTrap1069": s572UserTrap1069,
       "s572UserTrap1070": s572UserTrap1070,
       "s572UserTrap1071": s572UserTrap1071,
       "s572UserTrap1072": s572UserTrap1072,
       "s572UserTrap1073": s572UserTrap1073,
       "s572UserTrap1074": s572UserTrap1074,
       "s572UserTrap1075": s572UserTrap1075,
       "s572UserTrap1076": s572UserTrap1076,
       "s572UserTrap1077": s572UserTrap1077,
       "s572UserTrap1078": s572UserTrap1078,
       "s572UserTrap1079": s572UserTrap1079,
       "s572UserTrap1080": s572UserTrap1080,
       "s572UserTrap1081": s572UserTrap1081,
       "s572UserTrap1082": s572UserTrap1082,
       "s572UserTrap1083": s572UserTrap1083,
       "s572UserTrap1084": s572UserTrap1084,
       "s572UserTrap1085": s572UserTrap1085,
       "s572UserTrap1086": s572UserTrap1086,
       "s572UserTrap1087": s572UserTrap1087,
       "s572UserTrap1088": s572UserTrap1088,
       "s572UserTrap1089": s572UserTrap1089,
       "s572UserTrap1090": s572UserTrap1090,
       "s572UserTrap1091": s572UserTrap1091,
       "s572UserTrap1092": s572UserTrap1092,
       "s572UserTrap1093": s572UserTrap1093,
       "s572UserTrap1094": s572UserTrap1094,
       "s572UserTrap1095": s572UserTrap1095,
       "s572UserTrap1096": s572UserTrap1096,
       "s572UserTrap1097": s572UserTrap1097,
       "s572UserTrap1098": s572UserTrap1098,
       "s572UserTrap1099": s572UserTrap1099,
       "s572UserTrap1100": s572UserTrap1100,
       "s572UserTrap1101": s572UserTrap1101,
       "s572UserTrap1102": s572UserTrap1102,
       "s572UserTrap1103": s572UserTrap1103,
       "s572UserTrap1104": s572UserTrap1104,
       "s572UserTrap1105": s572UserTrap1105,
       "s572UserTrap1106": s572UserTrap1106,
       "s572UserTrap1107": s572UserTrap1107,
       "s572UserTrap1108": s572UserTrap1108,
       "s572UserTrap1109": s572UserTrap1109,
       "s572UserTrap1110": s572UserTrap1110,
       "s572UserTrap1111": s572UserTrap1111,
       "s572UserTrap1112": s572UserTrap1112,
       "s572UserTrap1113": s572UserTrap1113,
       "s572UserTrap1114": s572UserTrap1114,
       "s572UserTrap1115": s572UserTrap1115,
       "s572UserTrap1116": s572UserTrap1116,
       "s572UserTrap1117": s572UserTrap1117,
       "s572UserTrap1118": s572UserTrap1118,
       "s572UserTrap1119": s572UserTrap1119,
       "s572UserTrap1120": s572UserTrap1120,
       "s572UserTrap1121": s572UserTrap1121,
       "s572UserTrap1122": s572UserTrap1122,
       "s572UserTrap1123": s572UserTrap1123,
       "s572UserTrap1124": s572UserTrap1124,
       "s572UserTrap1125": s572UserTrap1125,
       "s572UserTrap1126": s572UserTrap1126,
       "s572UserTrap1127": s572UserTrap1127,
       "s572UserTrap1128": s572UserTrap1128,
       "s572UserTrap1129": s572UserTrap1129,
       "s572UserTrap1130": s572UserTrap1130,
       "s572UserTrap1131": s572UserTrap1131,
       "s572UserTrap1132": s572UserTrap1132,
       "s572UserTrap1133": s572UserTrap1133,
       "s572UserTrap1134": s572UserTrap1134,
       "s572UserTrap1135": s572UserTrap1135,
       "s572UserTrap1136": s572UserTrap1136,
       "s572UserTrap1137": s572UserTrap1137,
       "s572UserTrap1138": s572UserTrap1138,
       "s572UserTrap1139": s572UserTrap1139,
       "s572UserTrap1140": s572UserTrap1140,
       "s572UserTrap1141": s572UserTrap1141,
       "s572UserTrap1142": s572UserTrap1142,
       "s572UserTrap1143": s572UserTrap1143,
       "s572UserTrap1144": s572UserTrap1144,
       "s572UserTrap1145": s572UserTrap1145,
       "s572UserTrap1146": s572UserTrap1146,
       "s572UserTrap1147": s572UserTrap1147,
       "s572UserTrap1148": s572UserTrap1148,
       "s572UserTrap1149": s572UserTrap1149,
       "s572UserTrap1150": s572UserTrap1150,
       "s572UserTrap1151": s572UserTrap1151,
       "s572UserTrap1152": s572UserTrap1152,
       "s572UserTrap1153": s572UserTrap1153,
       "s572UserTrap1154": s572UserTrap1154,
       "s572UserTrap1155": s572UserTrap1155,
       "s572UserTrap1156": s572UserTrap1156,
       "s572UserTrap1157": s572UserTrap1157,
       "s572UserTrap1158": s572UserTrap1158,
       "s572UserTrap1159": s572UserTrap1159,
       "s572UserTrap1160": s572UserTrap1160,
       "s572UserTrap1161": s572UserTrap1161,
       "s572UserTrap1162": s572UserTrap1162,
       "s572UserTrap1163": s572UserTrap1163,
       "s572UserTrap1164": s572UserTrap1164,
       "s572UserTrap1165": s572UserTrap1165,
       "s572UserTrap1166": s572UserTrap1166,
       "s572UserTrap1167": s572UserTrap1167,
       "s572UserTrap1168": s572UserTrap1168,
       "s572UserTrap1169": s572UserTrap1169,
       "s572UserTrap1170": s572UserTrap1170,
       "s572UserTrap1171": s572UserTrap1171,
       "s572UserTrap1172": s572UserTrap1172,
       "s572UserTrap1173": s572UserTrap1173,
       "s572UserTrap1174": s572UserTrap1174,
       "s572UserTrap1175": s572UserTrap1175,
       "s572UserTrap1176": s572UserTrap1176,
       "s572UserTrap1177": s572UserTrap1177,
       "s572UserTrap1178": s572UserTrap1178,
       "s572UserTrap1179": s572UserTrap1179,
       "s572UserTrap1180": s572UserTrap1180,
       "s572UserTrap1181": s572UserTrap1181,
       "s572UserTrap1182": s572UserTrap1182,
       "s572UserTrap1183": s572UserTrap1183,
       "s572UserTrap1184": s572UserTrap1184,
       "s572UserTrap1185": s572UserTrap1185,
       "s572UserTrap1186": s572UserTrap1186,
       "s572UserTrap1187": s572UserTrap1187,
       "s572UserTrap1188": s572UserTrap1188,
       "s572UserTrap1189": s572UserTrap1189,
       "s572UserTrap1190": s572UserTrap1190,
       "s572UserTrap1191": s572UserTrap1191,
       "s572UserTrap1192": s572UserTrap1192,
       "s572UserTrap1193": s572UserTrap1193,
       "s572UserTrap1194": s572UserTrap1194,
       "s572UserTrap1195": s572UserTrap1195,
       "s572UserTrap1196": s572UserTrap1196,
       "s572UserTrap1197": s572UserTrap1197,
       "s572UserTrap1198": s572UserTrap1198,
       "s572UserTrap1199": s572UserTrap1199,
       "status": status,
       ...
       "pdSystemLowVoltShutdownEnable": pdSystemLowVoltShutdownEnable,
       "pdSystemLowVoltShutdownLowValue": pdSystemLowVoltShutdownLowValue,
       "pdSystemLowVoltShutdownNormalValue": pdSystemLowVoltShutdownNormalValue,
