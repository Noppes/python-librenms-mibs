# SNMP MIB module (CISCOSB-DHCPv6-CLIENT) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\cisco\CISCOSB-DHCPv6-CLIENT
...
rlDhcpv6ClientEntry = _RlDhcpv6ClientEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1)
)
rlDhcpv6ClientEntry.setIndexNames(
    (0, "CISCOSB-DHCPv6-CLIENT", "rlDhcpv6ClientIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpv6ClientIfIndex = _RlDhcpv6ClientIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 1),
...
rlDhcpv6ClientPd = _RlDhcpv6ClientPd_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 2),
    _RlDhcpv6ClientPd_Type()
)
rlDhcpv6ClientPd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientPd.setStatus("current")
_RlDhcpv6ClientStatelessAdminStatus_Type = RlDhcpv6ClientStatelessAdminStatusType
_RlDhcpv6ClientStatelessAdminStatus_Object = MibTableColumn
rlDhcpv6ClientStatelessAdminStatus = _RlDhcpv6ClientStatelessAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 3),
    _RlDhcpv6ClientStatelessAdminStatus_Type()
)
rlDhcpv6ClientStatelessAdminStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientStatelessAdminStatus.setStatus("current")
...
rlDhcpv6ClientReconfigure = _RlDhcpv6ClientReconfigure_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 4),
...
rlDhcpv6ClientInfoRefreshMin = _RlDhcpv6ClientInfoRefreshMin_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 5),
...
rlDhcpv6ClientInfoRefreshConf = _RlDhcpv6ClientInfoRefreshConf_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 6),
...
_RlDhcpv6ClientInfoRefreshRunning_Type = Unsigned32
_RlDhcpv6ClientInfoRefreshRunning_Object = MibTableColumn
rlDhcpv6ClientInfoRefreshRunning = _RlDhcpv6ClientInfoRefreshRunning_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 7),
    _RlDhcpv6ClientInfoRefreshRunning_Type()
)
rlDhcpv6ClientInfoRefreshRunning.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientInfoRefreshRunning.setStatus("current")
...
rlDhcpv6ClientInfoRefreshRemain = _RlDhcpv6ClientInfoRefreshRemain_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 8),
...
rlDhcpv6ClientDhcpServerInetAddressType = _RlDhcpv6ClientDhcpServerInetAddressType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 9),
...
rlDhcpv6ClientDhcpServerInetAddress = _RlDhcpv6ClientDhcpServerInetAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 10),
...
rlDhcpv6ClientDhcpServerDuid = _RlDhcpv6ClientDhcpServerDuid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 11),
...
rlDhcpv6ClientDhcpServerPreference = _RlDhcpv6ClientDhcpServerPreference_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 12),
...
class _RlDhcpv6ClientStatelessState_Type(RlDhcpv6ClientStatelessStateType):
    """Custom type rlDhcpv6ClientStatelessState based on RlDhcpv6ClientStatelessStateType"""
    defaultValue = 1


_RlDhcpv6ClientStatelessState_Type.__name__ = "RlDhcpv6ClientStatelessStateType"
_RlDhcpv6ClientStatelessState_Object = MibTableColumn
rlDhcpv6ClientStatelessState = _RlDhcpv6ClientStatelessState_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 13),
    _RlDhcpv6ClientStatelessState_Type()
)
rlDhcpv6ClientStatelessState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientStatelessState.setStatus("current")
...
rlDhcpv6ClientTftpServerName = _RlDhcpv6ClientTftpServerName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 14),
...
rlDhcpv6ClientTftpFileName = _RlDhcpv6ClientTftpFileName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 15),
...
rlDhcpv6ClientTimeZone = _RlDhcpv6ClientTimeZone_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 16),
...
rlDhcpv6ClientOperStatus = _RlDhcpv6ClientOperStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 17),
...
rlDhcpv6ClientDisableReason = _RlDhcpv6ClientDisableReason_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 18),
...
rlDhcpv6ClientStatus = _RlDhcpv6ClientStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 19),
...
rlDhcpv6ClientIndirectImageFileName = _RlDhcpv6ClientIndirectImageFileName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 20),
...
class _RlDhcpv6ClientStatefulAdminStatus_Type(RlDhcpv6ClientStatefulAdminStatusType):
    """Custom type rlDhcpv6ClientStatefulAdminStatus based on RlDhcpv6ClientStatefulAdminStatusType"""
    defaultValue = 2


_RlDhcpv6ClientStatefulAdminStatus_Type.__name__ = "RlDhcpv6ClientStatefulAdminStatusType"
_RlDhcpv6ClientStatefulAdminStatus_Object = MibTableColumn
rlDhcpv6ClientStatefulAdminStatus = _RlDhcpv6ClientStatefulAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 21),
    _RlDhcpv6ClientStatefulAdminStatus_Type()
)
rlDhcpv6ClientStatefulAdminStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlDhcpv6ClientStatefulAdminStatus.setStatus("current")


class _RlDhcpv6ClientStatefulState_Type(RlDhcpv6ClientStatefulStateType):
    """Custom type rlDhcpv6ClientStatefulState based on RlDhcpv6ClientStatefulStateType"""
    defaultValue = 1


_RlDhcpv6ClientStatefulState_Type.__name__ = "RlDhcpv6ClientStatefulStateType"
_RlDhcpv6ClientStatefulState_Object = MibTableColumn
rlDhcpv6ClientStatefulState = _RlDhcpv6ClientStatefulState_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 22),
    _RlDhcpv6ClientStatefulState_Type()
)
rlDhcpv6ClientStatefulState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientStatefulState.setStatus("current")


class _RlDhcpv6ClientNDMflag_Type(TruthValue):
    """Custom type rlDhcpv6ClientNDMflag based on TruthValue"""
    defaultValue = 2


_RlDhcpv6ClientNDMflag_Type.__name__ = "TruthValue"
_RlDhcpv6ClientNDMflag_Object = MibTableColumn
rlDhcpv6ClientNDMflag = _RlDhcpv6ClientNDMflag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 23),
    _RlDhcpv6ClientNDMflag_Type()
)
rlDhcpv6ClientNDMflag.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientNDMflag.setStatus("current")


class _RlDhcpv6ClientNDOflag_Type(TruthValue):
    """Custom type rlDhcpv6ClientNDOflag based on TruthValue"""
    defaultValue = 2


_RlDhcpv6ClientNDOflag_Type.__name__ = "TruthValue"
_RlDhcpv6ClientNDOflag_Object = MibTableColumn
rlDhcpv6ClientNDOflag = _RlDhcpv6ClientNDOflag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 3, 1, 24),
    _RlDhcpv6ClientNDOflag_Type()
)
rlDhcpv6ClientNDOflag.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientNDOflag.setStatus("current")
...
rlDhcpv6ClientAuxDnsServerListEntry = _RlDhcpv6ClientAuxDnsServerListEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 4, 1)
)
rlDhcpv6ClientAuxDnsServerListEntry.setIndexNames(
    (0, "CISCOSB-DHCPv6-CLIENT", "rlDhcpv6ClientAuxDnsServerListIfIndex"),
    (0, "CISCOSB-DHCPv6-CLIENT", "rlDhcpv6ClientAuxDnsServerListPriority"),
)
if mibBuilder.loadTexts:
...
rlDhcpv6ClientAuxDnsServerListIfIndex = _RlDhcpv6ClientAuxDnsServerListIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 4, 1, 1),
...
rlDhcpv6ClientAuxDnsServerListPriority = _RlDhcpv6ClientAuxDnsServerListPriority_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 4, 1, 2),
...
rlDhcpv6ClientAuxDnsServerListAddress = _RlDhcpv6ClientAuxDnsServerListAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 4, 1, 3),
...
rlDhcpv6ClientAuxSntpServerListEntry = _RlDhcpv6ClientAuxSntpServerListEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 5, 1)
)
rlDhcpv6ClientAuxSntpServerListEntry.setIndexNames(
    (0, "CISCOSB-DHCPv6-CLIENT", "rlDhcpv6ClientAuxSntpServerListIfIndex"),
    (0, "CISCOSB-DHCPv6-CLIENT", "rlDhcpv6ClientAuxSntpServerListPriority"),
)
if mibBuilder.loadTexts:
...
rlDhcpv6ClientAuxSntpServerListIfIndex = _RlDhcpv6ClientAuxSntpServerListIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 5, 1, 1),
...
rlDhcpv6ClientAuxSntpServerListPriority = _RlDhcpv6ClientAuxSntpServerListPriority_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 5, 1, 2),
...
rlDhcpv6ClientAuxSntpServerListAddress = _RlDhcpv6ClientAuxSntpServerListAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 5, 1, 3),
...
rlDhcpv6ClientAuxDomainNameSearchListEntry = _RlDhcpv6ClientAuxDomainNameSearchListEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 6, 1)
)
rlDhcpv6ClientAuxDomainNameSearchListEntry.setIndexNames(
    (0, "CISCOSB-DHCPv6-CLIENT", "rlDhcpv6ClientAuxDomainNameSearchListIfIndex"),
    (0, "CISCOSB-DHCPv6-CLIENT", "rlDhcpv6ClientAuxDomainNameSearchListPriority"),
)
if mibBuilder.loadTexts:
...
rlDhcpv6ClientAuxDomainNameSearchListIfIndex = _RlDhcpv6ClientAuxDomainNameSearchListIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 6, 1, 1),
...
rlDhcpv6ClientAuxDomainNameSearchListPriority = _RlDhcpv6ClientAuxDomainNameSearchListPriority_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 6, 1, 2),
...
rlDhcpv6ClientAuxDomainNameSearchListName = _RlDhcpv6ClientAuxDomainNameSearchListName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 6, 1, 3),
...
rlDhcpv6ClientCommandEntry = _RlDhcpv6ClientCommandEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 7, 1)
)
rlDhcpv6ClientCommandEntry.setIndexNames(
    (0, "CISCOSB-DHCPv6-CLIENT", "rlDhcpv6ClientCommandIfIndex"),
)
if mibBuilder.loadTexts:
...
rlDhcpv6ClientCommandIfIndex = _RlDhcpv6ClientCommandIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 7, 1, 1),
...
rlDhcpv6ClientCommandAction = _RlDhcpv6ClientCommandAction_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 7, 1, 2),
...
_RlDhcpv6ClientIATable_Object = MibTable
rlDhcpv6ClientIATable = _RlDhcpv6ClientIATable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 9)
)
if mibBuilder.loadTexts:
    rlDhcpv6ClientIATable.setStatus("current")
_RlDhcpv6ClientIAEntry_Object = MibTableRow
rlDhcpv6ClientIAEntry = _RlDhcpv6ClientIAEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 9, 1)
)
rlDhcpv6ClientIAEntry.setIndexNames(
    (0, "CISCOSB-DHCPv6-CLIENT", "rlDhcpv6ClientIAIfIndex"),
)
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAEntry.setStatus("current")
_RlDhcpv6ClientIAIfIndex_Type = InterfaceIndex
_RlDhcpv6ClientIAIfIndex_Object = MibTableColumn
rlDhcpv6ClientIAIfIndex = _RlDhcpv6ClientIAIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 9, 1, 1),
    _RlDhcpv6ClientIAIfIndex_Type()
)
rlDhcpv6ClientIAIfIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAIfIndex.setStatus("current")
_RlDhcpv6ClientIANAID_Type = Integer32
_RlDhcpv6ClientIANAID_Object = MibTableColumn
rlDhcpv6ClientIANAID = _RlDhcpv6ClientIANAID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 9, 1, 2),
    _RlDhcpv6ClientIANAID_Type()
)
rlDhcpv6ClientIANAID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientIANAID.setStatus("current")
_RlDhcpv6ClientIATAID_Type = Integer32
_RlDhcpv6ClientIATAID_Object = MibTableColumn
rlDhcpv6ClientIATAID = _RlDhcpv6ClientIATAID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 9, 1, 3),
    _RlDhcpv6ClientIATAID_Type()
)
rlDhcpv6ClientIATAID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientIATAID.setStatus("current")


class _RlDhcpv6ClientIAT1_Type(Integer32):
    """Custom type rlDhcpv6ClientIAT1 based on Integer32"""
    defaultValue = 0


_RlDhcpv6ClientIAT1_Type.__name__ = "Integer32"
_RlDhcpv6ClientIAT1_Object = MibTableColumn
rlDhcpv6ClientIAT1 = _RlDhcpv6ClientIAT1_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 9, 1, 4),
    _RlDhcpv6ClientIAT1_Type()
)
rlDhcpv6ClientIAT1.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAT1.setStatus("current")


class _RlDhcpv6ClientIAT2_Type(Integer32):
    """Custom type rlDhcpv6ClientIAT2 based on Integer32"""
    defaultValue = 0


_RlDhcpv6ClientIAT2_Type.__name__ = "Integer32"
_RlDhcpv6ClientIAT2_Object = MibTableColumn
rlDhcpv6ClientIAT2 = _RlDhcpv6ClientIAT2_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 9, 1, 5),
    _RlDhcpv6ClientIAT2_Type()
)
rlDhcpv6ClientIAT2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAT2.setStatus("current")
_RlDhcpv6ClientIAT1RemainLifetime_Type = Unsigned32
_RlDhcpv6ClientIAT1RemainLifetime_Object = MibTableColumn
rlDhcpv6ClientIAT1RemainLifetime = _RlDhcpv6ClientIAT1RemainLifetime_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 9, 1, 6),
    _RlDhcpv6ClientIAT1RemainLifetime_Type()
)
rlDhcpv6ClientIAT1RemainLifetime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAT1RemainLifetime.setStatus("current")
_RlDhcpv6ClientIAAddressTable_Object = MibTable
rlDhcpv6ClientIAAddressTable = _RlDhcpv6ClientIAAddressTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 10)
)
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAAddressTable.setStatus("current")
_RlDhcpv6ClientIAAddressEntry_Object = MibTableRow
rlDhcpv6ClientIAAddressEntry = _RlDhcpv6ClientIAAddressEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 10, 1)
)
rlDhcpv6ClientIAAddressEntry.setIndexNames(
    (0, "CISCOSB-DHCPv6-CLIENT", "rlDhcpv6ClientIAAddressIfIndex"),
    (0, "CISCOSB-DHCPv6-CLIENT", "rlDhcpv6ClientIAAddress"),
)
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAAddressEntry.setStatus("current")
_RlDhcpv6ClientIAAddressIfIndex_Type = InterfaceIndex
_RlDhcpv6ClientIAAddressIfIndex_Object = MibTableColumn
rlDhcpv6ClientIAAddressIfIndex = _RlDhcpv6ClientIAAddressIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 10, 1, 1),
    _RlDhcpv6ClientIAAddressIfIndex_Type()
)
rlDhcpv6ClientIAAddressIfIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAAddressIfIndex.setStatus("current")
_RlDhcpv6ClientIAAddress_Type = InetAddressIPv6
_RlDhcpv6ClientIAAddress_Object = MibTableColumn
rlDhcpv6ClientIAAddress = _RlDhcpv6ClientIAAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 10, 1, 2),
    _RlDhcpv6ClientIAAddress_Type()
)
rlDhcpv6ClientIAAddress.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAAddress.setStatus("current")
_RlDhcpv6ClientIAAddressPreferredLifetime_Type = Unsigned32
_RlDhcpv6ClientIAAddressPreferredLifetime_Object = MibTableColumn
rlDhcpv6ClientIAAddressPreferredLifetime = _RlDhcpv6ClientIAAddressPreferredLifetime_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 10, 1, 3),
    _RlDhcpv6ClientIAAddressPreferredLifetime_Type()
)
rlDhcpv6ClientIAAddressPreferredLifetime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAAddressPreferredLifetime.setStatus("current")
_RlDhcpv6ClientIAAddressValidLifetime_Type = Unsigned32
_RlDhcpv6ClientIAAddressValidLifetime_Object = MibTableColumn
rlDhcpv6ClientIAAddressValidLifetime = _RlDhcpv6ClientIAAddressValidLifetime_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 10, 1, 4),
    _RlDhcpv6ClientIAAddressValidLifetime_Type()
)
rlDhcpv6ClientIAAddressValidLifetime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAAddressValidLifetime.setStatus("current")
_RlDhcpv6ClientIAAddressRemainLifetime_Type = Unsigned32
_RlDhcpv6ClientIAAddressRemainLifetime_Object = MibTableColumn
rlDhcpv6ClientIAAddressRemainLifetime = _RlDhcpv6ClientIAAddressRemainLifetime_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 214, 2, 10, 1, 5),
    _RlDhcpv6ClientIAAddressRemainLifetime_Type()
)
rlDhcpv6ClientIAAddressRemainLifetime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDhcpv6ClientIAAddressRemainLifetime.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"RlDhcpv6ClientStatefulAdminStatusType": RlDhcpv6ClientStatefulAdminStatusType,
       "RlDhcpv6ClientStatelessAdminStatusType": RlDhcpv6ClientStatelessAdminStatusType,
       "RlDhcpv6ClientStatefulStateType": RlDhcpv6ClientStatefulStateType,
       "RlDhcpv6ClientStatelessStateType": RlDhcpv6ClientStatelessStateType,
       ...
       "rlDhcpv6ClientStatelessAdminStatus": rlDhcpv6ClientStatelessAdminStatus,
       ...
       "rlDhcpv6ClientInfoRefreshRunning": rlDhcpv6ClientInfoRefreshRunning,
       ...
       "rlDhcpv6ClientStatelessState": rlDhcpv6ClientStatelessState,
       ...
       "rlDhcpv6ClientStatefulAdminStatus": rlDhcpv6ClientStatefulAdminStatus,
       "rlDhcpv6ClientStatefulState": rlDhcpv6ClientStatefulState,
       "rlDhcpv6ClientNDMflag": rlDhcpv6ClientNDMflag,
       "rlDhcpv6ClientNDOflag": rlDhcpv6ClientNDOflag,
       ...
       "rlDhcpv6ClientIATable": rlDhcpv6ClientIATable,
       "rlDhcpv6ClientIAEntry": rlDhcpv6ClientIAEntry,
       "rlDhcpv6ClientIAIfIndex": rlDhcpv6ClientIAIfIndex,
       "rlDhcpv6ClientIANAID": rlDhcpv6ClientIANAID,
       "rlDhcpv6ClientIATAID": rlDhcpv6ClientIATAID,
       "rlDhcpv6ClientIAT1": rlDhcpv6ClientIAT1,
       "rlDhcpv6ClientIAT2": rlDhcpv6ClientIAT2,
       "rlDhcpv6ClientIAT1RemainLifetime": rlDhcpv6ClientIAT1RemainLifetime,
       "rlDhcpv6ClientIAAddressTable": rlDhcpv6ClientIAAddressTable,
       "rlDhcpv6ClientIAAddressEntry": rlDhcpv6ClientIAAddressEntry,
       "rlDhcpv6ClientIAAddressIfIndex": rlDhcpv6ClientIAAddressIfIndex,
       "rlDhcpv6ClientIAAddress": rlDhcpv6ClientIAAddress,
       "rlDhcpv6ClientIAAddressPreferredLifetime": rlDhcpv6ClientIAAddressPreferredLifetime,
       "rlDhcpv6ClientIAAddressValidLifetime": rlDhcpv6ClientIAAddressValidLifetime,
