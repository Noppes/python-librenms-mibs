# SNMP MIB module (CISCOSB-vlan-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\cisco\CISCOSB-vlan-MIB
...
vlanNameName = _VlanNameName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 21, 1, 1),
    _VlanNameName_Type()
)
...
vlanNameTag = _VlanNameTag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 21, 1, 2),
    _VlanNameTag_Type()
)
...
vlanNameIfIndex = _VlanNameIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 21, 1, 3),
...
vlanSpecialTagVID = _VlanSpecialTagVID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 33, 1, 1),
...
vlanSpecialTagStatus = _VlanSpecialTagStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 33, 1, 2),
...
vlanSpecialTagCurrentVID = _VlanSpecialTagCurrentVID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 34, 1, 1),
...
vlanSpecialTagCurrentReserved = _VlanSpecialTagCurrentReserved_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 34, 1, 2),
...
vlanSpecialTagCurrentActive = _VlanSpecialTagCurrentActive_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 34, 1, 3),
...
vlanPrivateEdgeUplink = _VlanPrivateEdgeUplink_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 37, 1, 1),
...
vlanPrivateEdgeStatus = _VlanPrivateEdgeStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 37, 1, 2),
...
vlanDynamicVlanEntry = _VlanDynamicVlanEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 39, 1)
)
vlanDynamicVlanEntry.setIndexNames(
    (0, "CISCOSB-vlan-MIB", "vlanDynamicVlanMacAddress"),
)
if mibBuilder.loadTexts:
...
vlanDynamicVlanMacAddress = _VlanDynamicVlanMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 39, 1, 1),
...
vlanDynamicVlanTag = _VlanDynamicVlanTag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 39, 1, 2),
...
vlanDynamicVlanStatus = _VlanDynamicVlanStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 39, 1, 3),
...
vlanPortModeExtState = _VlanPortModeExtState_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 40, 1, 1),
...
vlanPortModeExtStatus = _VlanPortModeExtStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 40, 1, 2),
...
vlanPrivateOldIsolatedVlanTag = _VlanPrivateOldIsolatedVlanTag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 42, 1, 1),
...
vlanPrivateOldStatus = _VlanPrivateOldStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 42, 1, 2),
...
vlanPrivateCommunityEntry = _VlanPrivateCommunityEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 43, 1)
)
vlanPrivateCommunityEntry.setIndexNames(
    (0, "Q-BRIDGE-MIB", "dot1qVlanIndex"),
    (0, "CISCOSB-vlan-MIB", "vlanPrivateCommunityVlanTag"),
)
if mibBuilder.loadTexts:
...
vlanPrivateCommunityVlanTag = _VlanPrivateCommunityVlanTag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 43, 1, 1),
...
vlanPrivateCommunityStatus = _VlanPrivateCommunityStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 43, 1, 2),
...
vlanMulticastTvVID = _VlanMulticastTvVID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 44, 1, 1),
...
vlanMulticastTvStatus = _VlanMulticastTvStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 44, 1, 2),
...
vlanMacBaseVlanGroupEntry = _VlanMacBaseVlanGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 45, 1)
)
vlanMacBaseVlanGroupEntry.setIndexNames(
    (0, "CISCOSB-vlan-MIB", "vlanMacBaseVlanMacAddress"),
    (0, "CISCOSB-vlan-MIB", "vlanMacBaseVlanMacMask"),
)
if mibBuilder.loadTexts:
...
vlanMacBaseVlanMacAddress = _VlanMacBaseVlanMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 45, 1, 1),
...
vlanMacBaseVlanMacMask = _VlanMacBaseVlanMacMask_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 45, 1, 2),
...
vlanMacBaseVlanGroupId = _VlanMacBaseVlanGroupId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 45, 1, 3),
...
vlanMacBaseVlanGroupRowStatus = _VlanMacBaseVlanGroupRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 45, 1, 4),
...
vlanMacBaseVlanPortEntry = _VlanMacBaseVlanPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 46, 1)
)
vlanMacBaseVlanPortEntry.setIndexNames(
    (0, "BRIDGE-MIB", "dot1dBasePort"),
    (0, "CISCOSB-vlan-MIB", "vlanMacBaseVlanPortGroupId"),
)
if mibBuilder.loadTexts:
...
vlanMacBaseVlanPortGroupId = _VlanMacBaseVlanPortGroupId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 46, 1, 1),
...
vlanMacBaseVlanPortGroupVid = _VlanMacBaseVlanPortGroupVid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 46, 1, 2),
...
vlanMacBaseVlanPortRowStatus = _VlanMacBaseVlanPortRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 46, 1, 3),
...
vlanPrivateEdgeGroupEntry = _VlanPrivateEdgeGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 47, 1)
)
vlanPrivateEdgeGroupEntry.setIndexNames(
    (0, "CISCOSB-vlan-MIB", "vlanPrivateEdgeGroupSource"),
)
if mibBuilder.loadTexts:
...
vlanPrivateEdgeGroupSource = _VlanPrivateEdgeGroupSource_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 47, 1, 1),
...
vlanPrivateEdgeGroupUplink = _VlanPrivateEdgeGroupUplink_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 47, 1, 2),
...
vlanPrivateEdgeGroupStatus = _VlanPrivateEdgeGroupStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 47, 1, 3),
...
vlanPrivateEdgeGroupIfIndexID = _VlanPrivateEdgeGroupIfIndexID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 48, 1, 1),
...
vlanPrivateEdgeGroupIfIndexDomainID = _VlanPrivateEdgeGroupIfIndexDomainID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 48, 1, 2),
...
vlanSubnetRangeEntry = _VlanSubnetRangeEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 49, 1)
)
vlanSubnetRangeEntry.setIndexNames(
    (0, "CISCOSB-vlan-MIB", "vlanSubnetRangeAddr"),
    (0, "CISCOSB-vlan-MIB", "vlanSubnetRangeMask"),
)
if mibBuilder.loadTexts:
...
vlanSubnetRangeAddr = _VlanSubnetRangeAddr_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 49, 1, 1),
...
vlanSubnetRangeMask = _VlanSubnetRangeMask_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 49, 1, 2),
...
vlanSubnetRangeGroupId = _VlanSubnetRangeGroupId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 49, 1, 3),
...
vlanSubnetRangeRowStatus = _VlanSubnetRangeRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 49, 1, 4),
...
vlanSubnetPortEntry = _VlanSubnetPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 50, 1)
)
vlanSubnetPortEntry.setIndexNames(
    (0, "BRIDGE-MIB", "dot1dBasePort"),
    (0, "CISCOSB-vlan-MIB", "vlanSubnetPortGroupId"),
)
if mibBuilder.loadTexts:
...
vlanSubnetPortGroupId = _VlanSubnetPortGroupId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 50, 1, 1),
...
vlanSubnetPortGroupVid = _VlanSubnetPortGroupVid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 50, 1, 2),
...
vlanSubnetPortRowStatus = _VlanSubnetPortRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 50, 1, 3),
...
vlanTriplePlayEntry = _VlanTriplePlayEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 51, 1)
)
vlanTriplePlayEntry.setIndexNames(
    (0, "CISCOSB-vlan-MIB", "vlanTriplePlayInnerVID"),
)
if mibBuilder.loadTexts:
...
vlanTriplePlayInnerVID = _VlanTriplePlayInnerVID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 51, 1, 1),
...
vlanTriplePlayMulticastTvVID = _VlanTriplePlayMulticastTvVID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 51, 1, 2),
...
vlanTriplePlayRowStatus = _VlanTriplePlayRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 51, 1, 3),
...
vlanTriplePlayMulticatTvEntry = _VlanTriplePlayMulticatTvEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 52, 1)
)
vlanTriplePlayMulticatTvEntry.setIndexNames(
    (0, "CISCOSB-vlan-MIB", "vlanTriplePlayMulticastTvMulticastTvVID"),
)
if mibBuilder.loadTexts:
...
vlanTriplePlayMulticastTvMulticastTvVID = _VlanTriplePlayMulticastTvMulticastTvVID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 52, 1, 1),
...
vlanTriplePlayMulticastTvMulticastTvPortList = _VlanTriplePlayMulticastTvMulticastTvPortList_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 52, 1, 2),
...
vlanVoicePriority = _VlanVoicePriority_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 54, 2, 1, 1),
...
vlanVoicePriorityRemark = _VlanVoicePriorityRemark_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 54, 2, 1, 2),
...
vlanVoiceRowStatus = _VlanVoiceRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 54, 2, 1, 3),
...
vlanVoiceOUIPrefix = _VlanVoiceOUIPrefix_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 54, 3, 1, 1),
...
vlanVoiceOUIDescription = _VlanVoiceOUIDescription_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 54, 3, 1, 2),
...
vlanVoiceOUIEntryRowStatus = _VlanVoiceOUIEntryRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 54, 3, 1, 3),
...
vlanVoicePortEnable = _VlanVoicePortEnable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 54, 4, 1, 1),
...
vlanVoicePortVlanIndex = _VlanVoicePortVlanIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 54, 4, 1, 2),
...
vlanVoicePortSecure = _VlanVoicePortSecure_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 54, 4, 1, 3),
...
vlanVoicePortCurrentMembership = _VlanVoicePortCurrentMembership_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 54, 4, 1, 4),
...
vlanVoicePortQosMode = _VlanVoicePortQosMode_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 54, 4, 1, 5),
...
vlanInetTriplePlayEntry = _VlanInetTriplePlayEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 56, 1)
)
vlanInetTriplePlayEntry.setIndexNames(
    (0, "CISCOSB-vlan-MIB", "vlanInetTriplePlayInetAddressType"),
    (0, "CISCOSB-vlan-MIB", "vlanTriplePlayInnerVID"),
)
if mibBuilder.loadTexts:
...
vlanInetTriplePlayInetAddressType = _VlanInetTriplePlayInetAddressType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 56, 1, 1),
...
vlanInetTriplePlayInnerVID = _VlanInetTriplePlayInnerVID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 56, 1, 2),
...
vlanInetTriplePlayMulticastTvVID = _VlanInetTriplePlayMulticastTvVID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 56, 1, 3),
...
vlanInetTriplePlayRowStatus = _VlanInetTriplePlayRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 56, 1, 4),
...
vlanInetTriplePlayMulticastTvMulticastTvVID = _VlanInetTriplePlayMulticastTvMulticastTvVID_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 57, 1, 1),
...
vlanInetTriplePlayMulticastTvMulticastTvPortList = _VlanInetTriplePlayMulticastTvMulticastTvPortList_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 57, 1, 2),
...
vlanPrivateVid = _VlanPrivateVid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 59, 1, 1),
...
vlanPrivateType = _VlanPrivateType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 59, 1, 2),
...
vlanPrivatePrimaryVid = _VlanPrivatePrimaryVid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 59, 1, 3),
...
vlanPrivateStatus = _VlanPrivateStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 59, 1, 4),
...
vlanPrivateMapEntry = _VlanPrivateMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 60, 1)
)
vlanPrivateMapEntry.setIndexNames(
    (0, "CISCOSB-vlan-MIB", "vlanPrivateMapPrimaryVid"),
    (0, "CISCOSB-vlan-MIB", "vlanPrivateMapSecondaryVid"),
)
if mibBuilder.loadTexts:
...
vlanPrivateMapPrimaryVid = _VlanPrivateMapPrimaryVid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 60, 1, 1),
...
vlanPrivateMapSecondaryVid = _VlanPrivateMapSecondaryVid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 60, 1, 2),
...
vlanPrivateMapPrimaryPorts = _VlanPrivateMapPrimaryPorts_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 60, 1, 3),
...
vlanPrivateMapSecondaryPorts = _VlanPrivateMapSecondaryPorts_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 60, 1, 4),
...
_VlanPrivateMapPrimaryOperPorts_Type = PortList
_VlanPrivateMapPrimaryOperPorts_Object = MibTableColumn
vlanPrivateMapPrimaryOperPorts = _VlanPrivateMapPrimaryOperPorts_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 60, 1, 5),
    _VlanPrivateMapPrimaryOperPorts_Type()
)
vlanPrivateMapPrimaryOperPorts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    vlanPrivateMapPrimaryOperPorts.setStatus("current")
_VlanPrivateMapSecondaryOperPorts_Type = PortList
_VlanPrivateMapSecondaryOperPorts_Object = MibTableColumn
vlanPrivateMapSecondaryOperPorts = _VlanPrivateMapSecondaryOperPorts_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 60, 1, 6),
    _VlanPrivateMapSecondaryOperPorts_Type()
)
vlanPrivateMapSecondaryOperPorts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
vlanPrivateMapStatus = _VlanPrivateMapStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 60, 1, 7),
...
vlanTrunkModeList1025to2048 = _VlanTrunkModeList1025to2048_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 61, 1, 3),
...
vlanTrunkModeList2049to3072 = _VlanTrunkModeList2049to3072_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 61, 1, 4),
...
vlanTrunkModeList3073to4094 = _VlanTrunkModeList3073to4094_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 61, 1, 5),
...
vlanAccessPortModeMcstTvVlanId = _VlanAccessPortModeMcstTvVlanId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 62, 1, 2),
...
vlanCustomerPortModeVlanId = _VlanCustomerPortModeVlanId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 63, 1, 1),
...
vlanCustomerPortModeMtvList1to1024 = _VlanCustomerPortModeMtvList1to1024_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 63, 1, 2),
...
vlanCustomerPortModeMtvList1025to2048 = _VlanCustomerPortModeMtvList1025to2048_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 63, 1, 3),
...
vlanCustomerPortModeMtvList2049to3072 = _VlanCustomerPortModeMtvList2049to3072_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 63, 1, 4),
...
vlanCustomerPortModeMtvList3073to4094 = _VlanCustomerPortModeMtvList3073to4094_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 63, 1, 5),
...
vlanSwitchPortModeCategory = _VlanSwitchPortModeCategory_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 64, 1, 1),
...
vlanPortModeContextValue = _VlanPortModeContextValue_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 65, 1, 1),
...
vlanRsvlMapPrimaryVid = _VlanRsvlMapPrimaryVid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 67, 1, 1),
...
vlanRsvlMapSecondaryVid = _VlanRsvlMapSecondaryVid_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 67, 1, 2),
...
vlanRsvlMapStatus = _VlanRsvlMapStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 67, 1, 3),
...
rldot1qPortVlanStaticEgressList1to1024 = _Rldot1qPortVlanStaticEgressList1to1024_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 1),
...
rldot1qPortVlanStaticEgressList1025to2048 = _Rldot1qPortVlanStaticEgressList1025to2048_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 2),
...
rldot1qPortVlanStaticEgressList2049to3072 = _Rldot1qPortVlanStaticEgressList2049to3072_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 3),
...
rldot1qPortVlanStaticEgressList3073to4094 = _Rldot1qPortVlanStaticEgressList3073to4094_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 4),
...
rldot1qPortVlanStaticUntaggedEgressList1to1024 = _Rldot1qPortVlanStaticUntaggedEgressList1to1024_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 5),
...
rldot1qPortVlanStaticUntaggedEgressList1025to2048 = _Rldot1qPortVlanStaticUntaggedEgressList1025to2048_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 6),
...
rldot1qPortVlanStaticUntaggedEgressList2049to3072 = _Rldot1qPortVlanStaticUntaggedEgressList2049to3072_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 7),
...
rldot1qPortVlanStaticUntaggedEgressList3073to4094 = _Rldot1qPortVlanStaticUntaggedEgressList3073to4094_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 8),
...
rldot1qPortVlanStaticForbiddenList1to1024 = _Rldot1qPortVlanStaticForbiddenList1to1024_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 9),
...
rldot1qPortVlanStaticForbiddenList1025to2048 = _Rldot1qPortVlanStaticForbiddenList1025to2048_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 10),
...
rldot1qPortVlanStaticForbiddenList2049to3072 = _Rldot1qPortVlanStaticForbiddenList2049to3072_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 11),
...
rldot1qPortVlanStaticForbiddenList3073to4094 = _Rldot1qPortVlanStaticForbiddenList3073to4094_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 68, 1, 12),
...
rldot1qVlanStaticListEntry = _Rldot1qVlanStaticListEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 69, 1)
)
rldot1qVlanStaticListEntry.setIndexNames(
    (0, "CISCOSB-vlan-MIB", "rldot1qVlanStaticListIndex"),
)
if mibBuilder.loadTexts:
...
rldot1qVlanStaticListIndex = _Rldot1qVlanStaticListIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 69, 1, 1),
...
rldot1qVlanStaticList1to1024 = _Rldot1qVlanStaticList1to1024_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 69, 1, 2),
...
rldot1qVlanStaticList1025to2048 = _Rldot1qVlanStaticList1025to2048_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 69, 1, 3),
...
rldot1qVlanStaticList2049to3072 = _Rldot1qVlanStaticList2049to3072_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 69, 1, 4),
...
rldot1qVlanStaticList3073to4094 = _Rldot1qVlanStaticList3073to4094_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 69, 1, 5),
...
rldot1qVlanStaticName = _Rldot1qVlanStaticName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 70, 1, 1),
...
rlPortVlanTriplePlayMulticastTvList1to1024 = _RlPortVlanTriplePlayMulticastTvList1to1024_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 71, 1, 1),
...
rlPortVlanTriplePlayMulticastTvList1025to2048 = _RlPortVlanTriplePlayMulticastTvList1025to2048_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 71, 1, 2),
...
rlPortVlanTriplePlayMulticastTvList2049to3072 = _RlPortVlanTriplePlayMulticastTvList2049to3072_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 71, 1, 3),
...
rlPortVlanTriplePlayMulticastTvList3073to4094 = _RlPortVlanTriplePlayMulticastTvList3073to4094_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 71, 1, 4),
...
rldot1qVlanMembershipTypeBitmap = _Rldot1qVlanMembershipTypeBitmap_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 72, 1, 1),
...
class _RlRspanRemoteVlan_Type(Integer32):
    """Custom type rlRspanRemoteVlan based on Integer32"""
    defaultValue = 4094
...
_RlRspanRemoteVlan_Type.__name__ = "Integer32"
_RlRspanRemoteVlan_Object = MibScalar
rlRspanRemoteVlan = _RlRspanRemoteVlan_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 73),
    _RlRspanRemoteVlan_Type()
)
rlRspanRemoteVlan.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlRspanRemoteVlan.setStatus("current")


class _VlanMappingEthType_Type(Integer32):
    """Custom type vlanMappingEthType based on Integer32"""
    defaultValue = 33024


_VlanMappingEthType_Type.__name__ = "Integer32"
_VlanMappingEthType_Object = MibScalar
vlanMappingEthType = _VlanMappingEthType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 74),
    _VlanMappingEthType_Type()
)
vlanMappingEthType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingEthType.setStatus("current")
_VlanMappingTunnelEdgePortConfigTable_Object = MibTable
vlanMappingTunnelEdgePortConfigTable = _VlanMappingTunnelEdgePortConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 75)
)
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortConfigTable.setStatus("current")
_VlanMappingTunnelEdgePortConfigEntry_Object = MibTableRow
vlanMappingTunnelEdgePortConfigEntry = _VlanMappingTunnelEdgePortConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 75, 1)
)
vlanMappingTunnelEdgePortConfigEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortConfigEntry.setStatus("current")
_VlanMappingTunnelEdgePortConfigVlanId_Type = VlanIndex
_VlanMappingTunnelEdgePortConfigVlanId_Object = MibTableColumn
vlanMappingTunnelEdgePortConfigVlanId = _VlanMappingTunnelEdgePortConfigVlanId_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 75, 1, 1),
    _VlanMappingTunnelEdgePortConfigVlanId_Type()
)
vlanMappingTunnelEdgePortConfigVlanId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortConfigVlanId.setStatus("current")


class _VlanMappingTunnelEdgePortConfigCos_Type(Integer32):
    """Custom type vlanMappingTunnelEdgePortConfigCos based on Integer32"""
    defaultValue = 8
...
_VlanMappingTunnelEdgePortConfigCos_Type.__name__ = "Integer32"
_VlanMappingTunnelEdgePortConfigCos_Object = MibTableColumn
vlanMappingTunnelEdgePortConfigCos = _VlanMappingTunnelEdgePortConfigCos_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 75, 1, 2),
    _VlanMappingTunnelEdgePortConfigCos_Type()
)
vlanMappingTunnelEdgePortConfigCos.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortConfigCos.setStatus("current")


class _VlanMappingTunnelEdgePortConfigDropThreshold_Type(Integer32):
    """Custom type vlanMappingTunnelEdgePortConfigDropThreshold based on Integer32"""
    defaultValue = 32
...
_VlanMappingTunnelEdgePortConfigDropThreshold_Type.__name__ = "Integer32"
_VlanMappingTunnelEdgePortConfigDropThreshold_Object = MibTableColumn
vlanMappingTunnelEdgePortConfigDropThreshold = _VlanMappingTunnelEdgePortConfigDropThreshold_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 75, 1, 3),
    _VlanMappingTunnelEdgePortConfigDropThreshold_Type()
)
vlanMappingTunnelEdgePortConfigDropThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortConfigDropThreshold.setStatus("current")


class _VlanMappingTunnelEdgePortConfigShutdownThreshold_Type(Integer32):
    """Custom type vlanMappingTunnelEdgePortConfigShutdownThreshold based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_VlanMappingTunnelEdgePortConfigShutdownThreshold_Type.__name__ = "Integer32"
_VlanMappingTunnelEdgePortConfigShutdownThreshold_Object = MibTableColumn
vlanMappingTunnelEdgePortConfigShutdownThreshold = _VlanMappingTunnelEdgePortConfigShutdownThreshold_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 75, 1, 4),
    _VlanMappingTunnelEdgePortConfigShutdownThreshold_Type()
)
vlanMappingTunnelEdgePortConfigShutdownThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortConfigShutdownThreshold.setStatus("current")


class _VlanMappingTunnelEdgePortConfigForwardCDP_Type(TruthValue):
    """Custom type vlanMappingTunnelEdgePortConfigForwardCDP based on TruthValue"""
    defaultValue = 2


_VlanMappingTunnelEdgePortConfigForwardCDP_Type.__name__ = "TruthValue"
_VlanMappingTunnelEdgePortConfigForwardCDP_Object = MibTableColumn
vlanMappingTunnelEdgePortConfigForwardCDP = _VlanMappingTunnelEdgePortConfigForwardCDP_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 75, 1, 5),
    _VlanMappingTunnelEdgePortConfigForwardCDP_Type()
)
vlanMappingTunnelEdgePortConfigForwardCDP.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortConfigForwardCDP.setStatus("current")


class _VlanMappingTunnelEdgePortConfigForwardLLDP_Type(TruthValue):
    """Custom type vlanMappingTunnelEdgePortConfigForwardLLDP based on TruthValue"""
    defaultValue = 2


_VlanMappingTunnelEdgePortConfigForwardLLDP_Type.__name__ = "TruthValue"
_VlanMappingTunnelEdgePortConfigForwardLLDP_Object = MibTableColumn
vlanMappingTunnelEdgePortConfigForwardLLDP = _VlanMappingTunnelEdgePortConfigForwardLLDP_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 75, 1, 6),
    _VlanMappingTunnelEdgePortConfigForwardLLDP_Type()
)
vlanMappingTunnelEdgePortConfigForwardLLDP.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortConfigForwardLLDP.setStatus("current")


class _VlanMappingTunnelEdgePortConfigForwardSTP_Type(TruthValue):
    """Custom type vlanMappingTunnelEdgePortConfigForwardSTP based on TruthValue"""
    defaultValue = 2


_VlanMappingTunnelEdgePortConfigForwardSTP_Type.__name__ = "TruthValue"
_VlanMappingTunnelEdgePortConfigForwardSTP_Object = MibTableColumn
vlanMappingTunnelEdgePortConfigForwardSTP = _VlanMappingTunnelEdgePortConfigForwardSTP_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 75, 1, 7),
    _VlanMappingTunnelEdgePortConfigForwardSTP_Type()
)
vlanMappingTunnelEdgePortConfigForwardSTP.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortConfigForwardSTP.setStatus("current")


class _VlanMappingTunnelEdgePortConfigForwardVTP_Type(TruthValue):
    """Custom type vlanMappingTunnelEdgePortConfigForwardVTP based on TruthValue"""
    defaultValue = 2


_VlanMappingTunnelEdgePortConfigForwardVTP_Type.__name__ = "TruthValue"
_VlanMappingTunnelEdgePortConfigForwardVTP_Object = MibTableColumn
vlanMappingTunnelEdgePortConfigForwardVTP = _VlanMappingTunnelEdgePortConfigForwardVTP_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 75, 1, 8),
    _VlanMappingTunnelEdgePortConfigForwardVTP_Type()
)
vlanMappingTunnelEdgePortConfigForwardVTP.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortConfigForwardVTP.setStatus("current")
_VlanMappingTunnelNniPortConfigTable_Object = MibTable
vlanMappingTunnelNniPortConfigTable = _VlanMappingTunnelNniPortConfigTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 76)
)
if mibBuilder.loadTexts:
    vlanMappingTunnelNniPortConfigTable.setStatus("current")
_VlanMappingTunnelNniPortConfigEntry_Object = MibTableRow
vlanMappingTunnelNniPortConfigEntry = _VlanMappingTunnelNniPortConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 76, 1)
)
vlanMappingTunnelNniPortConfigEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    vlanMappingTunnelNniPortConfigEntry.setStatus("current")


class _VlanMappingTunnelNniPortConfigEthTypeValue_Type(Integer32):
    """Custom type vlanMappingTunnelNniPortConfigEthTypeValue based on Integer32"""
    defaultValue = 8100


_VlanMappingTunnelNniPortConfigEthTypeValue_Type.__name__ = "Integer32"
_VlanMappingTunnelNniPortConfigEthTypeValue_Object = MibTableColumn
vlanMappingTunnelNniPortConfigEthTypeValue = _VlanMappingTunnelNniPortConfigEthTypeValue_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 76, 1, 1),
    _VlanMappingTunnelNniPortConfigEthTypeValue_Type()
)
vlanMappingTunnelNniPortConfigEthTypeValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelNniPortConfigEthTypeValue.setStatus("current")
_VlanMappingTunnelNniPortConfigRowStatus_Type = RowStatus
_VlanMappingTunnelNniPortConfigRowStatus_Object = MibTableColumn
vlanMappingTunnelNniPortConfigRowStatus = _VlanMappingTunnelNniPortConfigRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 76, 1, 2),
    _VlanMappingTunnelNniPortConfigRowStatus_Type()
)
vlanMappingTunnelNniPortConfigRowStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelNniPortConfigRowStatus.setStatus("current")
_VlanMappingTunnelEdgePortTable_Object = MibTable
vlanMappingTunnelEdgePortTable = _VlanMappingTunnelEdgePortTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 77)
)
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortTable.setStatus("current")
_VlanMappingTunnelEdgePortEntry_Object = MibTableRow
vlanMappingTunnelEdgePortEntry = _VlanMappingTunnelEdgePortEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 77, 1)
)
vlanMappingTunnelEdgePortEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "CISCOSB-vlan-MIB", "vlanMappingTunnelEdgePortCVlanTag"),
)
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortEntry.setStatus("current")
_VlanMappingTunnelEdgePortCVlanTag_Type = VlanIndex
_VlanMappingTunnelEdgePortCVlanTag_Object = MibTableColumn
vlanMappingTunnelEdgePortCVlanTag = _VlanMappingTunnelEdgePortCVlanTag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 77, 1, 1),
    _VlanMappingTunnelEdgePortCVlanTag_Type()
)
vlanMappingTunnelEdgePortCVlanTag.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortCVlanTag.setStatus("current")
_VlanMappingTunnelEdgePortSVlanTag_Type = VlanIndex
_VlanMappingTunnelEdgePortSVlanTag_Object = MibTableColumn
vlanMappingTunnelEdgePortSVlanTag = _VlanMappingTunnelEdgePortSVlanTag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 77, 1, 2),
    _VlanMappingTunnelEdgePortSVlanTag_Type()
)
vlanMappingTunnelEdgePortSVlanTag.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortSVlanTag.setStatus("current")


class _VlanMappingTunnelEdgePortDefaultConfig_Type(VlanMappingDefaultConfigMode):
    """Custom type vlanMappingTunnelEdgePortDefaultConfig based on VlanMappingDefaultConfigMode"""
    defaultValue = 2


_VlanMappingTunnelEdgePortDefaultConfig_Type.__name__ = "VlanMappingDefaultConfigMode"
_VlanMappingTunnelEdgePortDefaultConfig_Object = MibTableColumn
vlanMappingTunnelEdgePortDefaultConfig = _VlanMappingTunnelEdgePortDefaultConfig_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 77, 1, 3),
    _VlanMappingTunnelEdgePortDefaultConfig_Type()
)
vlanMappingTunnelEdgePortDefaultConfig.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortDefaultConfig.setStatus("current")


class _VlanMappingTunnelEdgePortActionConfig_Type(VlanMappingActionConfigMode):
    """Custom type vlanMappingTunnelEdgePortActionConfig based on VlanMappingActionConfigMode"""
    defaultValue = 1


_VlanMappingTunnelEdgePortActionConfig_Type.__name__ = "VlanMappingActionConfigMode"
_VlanMappingTunnelEdgePortActionConfig_Object = MibTableColumn
vlanMappingTunnelEdgePortActionConfig = _VlanMappingTunnelEdgePortActionConfig_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 77, 1, 4),
    _VlanMappingTunnelEdgePortActionConfig_Type()
)
vlanMappingTunnelEdgePortActionConfig.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortActionConfig.setStatus("current")


class _VlanMappingTunnelEdgePortIsActiveEdge_Type(VlanMappingTunnelPortType):
    """Custom type vlanMappingTunnelEdgePortIsActiveEdge based on VlanMappingTunnelPortType"""
    defaultValue = 2


_VlanMappingTunnelEdgePortIsActiveEdge_Type.__name__ = "VlanMappingTunnelPortType"
_VlanMappingTunnelEdgePortIsActiveEdge_Object = MibTableColumn
vlanMappingTunnelEdgePortIsActiveEdge = _VlanMappingTunnelEdgePortIsActiveEdge_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 77, 1, 5),
    _VlanMappingTunnelEdgePortIsActiveEdge_Type()
)
vlanMappingTunnelEdgePortIsActiveEdge.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortIsActiveEdge.setStatus("current")


class _VlanMappingTunnelEdgePortMapMode_Type(VlanMappingTunnelPortMode):
    """Custom type vlanMappingTunnelEdgePortMapMode based on VlanMappingTunnelPortMode"""
    defaultValue = 2


_VlanMappingTunnelEdgePortMapMode_Type.__name__ = "VlanMappingTunnelPortMode"
_VlanMappingTunnelEdgePortMapMode_Object = MibTableColumn
vlanMappingTunnelEdgePortMapMode = _VlanMappingTunnelEdgePortMapMode_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 77, 1, 6),
    _VlanMappingTunnelEdgePortMapMode_Type()
)
vlanMappingTunnelEdgePortMapMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortMapMode.setStatus("current")
_VlanMappingTunnelEdgePortRowStatus_Type = RowStatus
_VlanMappingTunnelEdgePortRowStatus_Object = MibTableColumn
vlanMappingTunnelEdgePortRowStatus = _VlanMappingTunnelEdgePortRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 77, 1, 7),
    _VlanMappingTunnelEdgePortRowStatus_Type()
)
vlanMappingTunnelEdgePortRowStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingTunnelEdgePortRowStatus.setStatus("current")
_VlanMappingOneToOneEdgePortTable_Object = MibTable
vlanMappingOneToOneEdgePortTable = _VlanMappingOneToOneEdgePortTable_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 78)
)
if mibBuilder.loadTexts:
    vlanMappingOneToOneEdgePortTable.setStatus("current")
_VlanMappingOneToOneEdgePortEntry_Object = MibTableRow
vlanMappingOneToOneEdgePortEntry = _VlanMappingOneToOneEdgePortEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 78, 1)
)
vlanMappingOneToOneEdgePortEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "CISCOSB-vlan-MIB", "vlanMappingOneToOneEdgePortCVlanTag"),
)
if mibBuilder.loadTexts:
    vlanMappingOneToOneEdgePortEntry.setStatus("current")
_VlanMappingOneToOneEdgePortCVlanTag_Type = VlanIndex
_VlanMappingOneToOneEdgePortCVlanTag_Object = MibTableColumn
vlanMappingOneToOneEdgePortCVlanTag = _VlanMappingOneToOneEdgePortCVlanTag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 78, 1, 1),
    _VlanMappingOneToOneEdgePortCVlanTag_Type()
)
vlanMappingOneToOneEdgePortCVlanTag.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingOneToOneEdgePortCVlanTag.setStatus("current")
_VlanMappingOneToOneEdgePortSVlanTag_Type = VlanIndex
_VlanMappingOneToOneEdgePortSVlanTag_Object = MibTableColumn
vlanMappingOneToOneEdgePortSVlanTag = _VlanMappingOneToOneEdgePortSVlanTag_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 78, 1, 2),
    _VlanMappingOneToOneEdgePortSVlanTag_Type()
)
vlanMappingOneToOneEdgePortSVlanTag.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingOneToOneEdgePortSVlanTag.setStatus("current")


class _VlanMappingOneToOneEdgePortIsActiveEdge_Type(VlanMappingTunnelPortType):
    """Custom type vlanMappingOneToOneEdgePortIsActiveEdge based on VlanMappingTunnelPortType"""
    defaultValue = 2


_VlanMappingOneToOneEdgePortIsActiveEdge_Type.__name__ = "VlanMappingTunnelPortType"
_VlanMappingOneToOneEdgePortIsActiveEdge_Object = MibTableColumn
vlanMappingOneToOneEdgePortIsActiveEdge = _VlanMappingOneToOneEdgePortIsActiveEdge_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 78, 1, 3),
    _VlanMappingOneToOneEdgePortIsActiveEdge_Type()
)
vlanMappingOneToOneEdgePortIsActiveEdge.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingOneToOneEdgePortIsActiveEdge.setStatus("current")
_VlanMappingOneToOneEdgePortRowStatus_Type = RowStatus
_VlanMappingOneToOneEdgePortRowStatus_Object = MibTableColumn
vlanMappingOneToOneEdgePortRowStatus = _VlanMappingOneToOneEdgePortRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 78, 1, 4),
    _VlanMappingOneToOneEdgePortRowStatus_Type()
)
vlanMappingOneToOneEdgePortRowStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingOneToOneEdgePortRowStatus.setStatus("current")


class _VlanMappingCosValue_Type(Integer32):
    """Custom type vlanMappingCosValue based on Integer32"""
    defaultValue = 5
...
_VlanMappingCosValue_Type.__name__ = "Integer32"
_VlanMappingCosValue_Object = MibScalar
vlanMappingCosValue = _VlanMappingCosValue_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 48, 79),
    _VlanMappingCosValue_Type()
)
vlanMappingCosValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    vlanMappingCosValue.setStatus("current")
...
mibBuilder.exportSymbols(
    "CISCOSB-vlan-MIB",
    **{"VlanMappingTunnelPortType": VlanMappingTunnelPortType,
       "VlanMappingTunnelPortMode": VlanMappingTunnelPortMode,
       "VlanMappingDefaultConfigMode": VlanMappingDefaultConfigMode,
       "VlanMappingActionConfigMode": VlanMappingActionConfigMode,
       "vlan": vlan,
       ...
       "vlanPrivateMapPrimaryOperPorts": vlanPrivateMapPrimaryOperPorts,
       "vlanPrivateMapSecondaryOperPorts": vlanPrivateMapSecondaryOperPorts,
       ...
       "rlRspanRemoteVlan": rlRspanRemoteVlan,
       "vlanMappingEthType": vlanMappingEthType,
       "vlanMappingTunnelEdgePortConfigTable": vlanMappingTunnelEdgePortConfigTable,
       "vlanMappingTunnelEdgePortConfigEntry": vlanMappingTunnelEdgePortConfigEntry,
       "vlanMappingTunnelEdgePortConfigVlanId": vlanMappingTunnelEdgePortConfigVlanId,
       "vlanMappingTunnelEdgePortConfigCos": vlanMappingTunnelEdgePortConfigCos,
       "vlanMappingTunnelEdgePortConfigDropThreshold": vlanMappingTunnelEdgePortConfigDropThreshold,
       "vlanMappingTunnelEdgePortConfigShutdownThreshold": vlanMappingTunnelEdgePortConfigShutdownThreshold,
       "vlanMappingTunnelEdgePortConfigForwardCDP": vlanMappingTunnelEdgePortConfigForwardCDP,
       "vlanMappingTunnelEdgePortConfigForwardLLDP": vlanMappingTunnelEdgePortConfigForwardLLDP,
       "vlanMappingTunnelEdgePortConfigForwardSTP": vlanMappingTunnelEdgePortConfigForwardSTP,
       "vlanMappingTunnelEdgePortConfigForwardVTP": vlanMappingTunnelEdgePortConfigForwardVTP,
       "vlanMappingTunnelNniPortConfigTable": vlanMappingTunnelNniPortConfigTable,
       "vlanMappingTunnelNniPortConfigEntry": vlanMappingTunnelNniPortConfigEntry,
       "vlanMappingTunnelNniPortConfigEthTypeValue": vlanMappingTunnelNniPortConfigEthTypeValue,
       "vlanMappingTunnelNniPortConfigRowStatus": vlanMappingTunnelNniPortConfigRowStatus,
       "vlanMappingTunnelEdgePortTable": vlanMappingTunnelEdgePortTable,
       "vlanMappingTunnelEdgePortEntry": vlanMappingTunnelEdgePortEntry,
       "vlanMappingTunnelEdgePortCVlanTag": vlanMappingTunnelEdgePortCVlanTag,
       "vlanMappingTunnelEdgePortSVlanTag": vlanMappingTunnelEdgePortSVlanTag,
       "vlanMappingTunnelEdgePortDefaultConfig": vlanMappingTunnelEdgePortDefaultConfig,
       "vlanMappingTunnelEdgePortActionConfig": vlanMappingTunnelEdgePortActionConfig,
       "vlanMappingTunnelEdgePortIsActiveEdge": vlanMappingTunnelEdgePortIsActiveEdge,
       "vlanMappingTunnelEdgePortMapMode": vlanMappingTunnelEdgePortMapMode,
       "vlanMappingTunnelEdgePortRowStatus": vlanMappingTunnelEdgePortRowStatus,
       "vlanMappingOneToOneEdgePortTable": vlanMappingOneToOneEdgePortTable,
       "vlanMappingOneToOneEdgePortEntry": vlanMappingOneToOneEdgePortEntry,
       "vlanMappingOneToOneEdgePortCVlanTag": vlanMappingOneToOneEdgePortCVlanTag,
       "vlanMappingOneToOneEdgePortSVlanTag": vlanMappingOneToOneEdgePortSVlanTag,
       "vlanMappingOneToOneEdgePortIsActiveEdge": vlanMappingOneToOneEdgePortIsActiveEdge,
       "vlanMappingOneToOneEdgePortRowStatus": vlanMappingOneToOneEdgePortRowStatus,
       "vlanMappingCosValue": vlanMappingCosValue}
)
