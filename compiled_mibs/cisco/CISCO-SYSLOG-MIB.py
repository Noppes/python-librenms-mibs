...
# Notes
# -----
# ASN.1 source file://mibs\cisco\CISCO-SYSLOG-MIB
...
_ClogNotificationsEnabled_Type.__name__ = "TruthValue"
...
_ClogMaxSeverity_Type.__name__ = "SyslogSeverity"
...
class _ClogOriginID_Type(SnmpAdminString):
    """Custom type clogOriginID based on SnmpAdminString"""
    defaultValue = OctetString("")


_ClogOriginID_Type.__name__ = "SnmpAdminString"
...
ciscoSyslogMIBCompliance.setObjects(
    ("CISCO-SYSLOG-MIB", "ciscoSyslogMIBGroup")
)
if mibBuilder.loadTexts:
...
ciscoSyslogMIBComplianceRev1.setObjects(
      *(("CISCO-SYSLOG-MIB", "ciscoSyslogMIBGroup"),
        ("CISCO-SYSLOG-MIB", "clogServerGroup"),
        ("CISCO-SYSLOG-MIB", "clogOriginIDGroup"),
        ("CISCO-SYSLOG-MIB", "clogNotificationsGroup"))
)
if mibBuilder.loadTexts:
