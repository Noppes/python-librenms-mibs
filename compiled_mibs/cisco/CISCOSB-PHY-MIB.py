# SNMP MIB module (CISCOSB-PHY-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\cisco\CISCOSB-PHY-MIB
...
rlPhyTestSetType = _RlPhyTestSetType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 90, 1, 1, 1, 1),
...
rlPhyTestGetType = _RlPhyTestGetType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 90, 1, 2, 1, 1),
...
rlPhyTestGetStatus = _RlPhyTestGetStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 90, 1, 2, 1, 2),
...
rlPhyTestGetResult = _RlPhyTestGetResult_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 90, 1, 2, 1, 3),
...
rlPhyTestGetUnits = _RlPhyTestGetUnits_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 90, 1, 2, 1, 4),
...
rlPhyTestGetAlarm = _RlPhyTestGetAlarm_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 90, 1, 2, 1, 5),
...
rlPhyTestGetTimeStamp = _RlPhyTestGetTimeStamp_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 90, 1, 2, 1, 6),
