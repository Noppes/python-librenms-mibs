# SNMP MIB module (CISCOSB-MNGINF-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\cisco\CISCOSB-MNGINF-MIB
...
rlMngInfListName = _RlMngInfListName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 4, 1, 1),
...
rlMngInfListPriority = _RlMngInfListPriority_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 4, 1, 2),
...
rlMngInfListIfIndex = _RlMngInfListIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 4, 1, 3),
...
rlMngInfListIpAddr = _RlMngInfListIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 4, 1, 4),
...
rlMngInfListIpNetMask = _RlMngInfListIpNetMask_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 4, 1, 5),
...
rlMngInfListService = _RlMngInfListService_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 4, 1, 6),
...
rlMngInfListAction = _RlMngInfListAction_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 4, 1, 7),
...
rlMngInfListRowStatus = _RlMngInfListRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 4, 1, 8),
...
rlMngInfListPortIfIndex = _RlMngInfListPortIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 4, 1, 9),
    _RlMngInfListPortIfIndex_Type()
)
rlMngInfListPortIfIndex.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlMngInfListPortIfIndex.setStatus("current")
...
rlMngInfListInetEntry = _RlMngInfListInetEntry_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1)
)
rlMngInfListInetEntry.setIndexNames(
    (0, "CISCOSB-MNGINF-MIB", "rlMngInfListInetName"),
    (0, "CISCOSB-MNGINF-MIB", "rlMngInfListInetPriority"),
)
if mibBuilder.loadTexts:
...
rlMngInfListInetName = _RlMngInfListInetName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1, 1),
...
rlMngInfListInetPriority = _RlMngInfListInetPriority_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1, 2),
...
rlMngInfListInetIfIndex = _RlMngInfListInetIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1, 3),
...
rlMngInfListInetIpAddrType = _RlMngInfListInetIpAddrType_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1, 4),
...
rlMngInfListInetIpAddr = _RlMngInfListInetIpAddr_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1, 5),
...
rlMngInfListInetIpNetMask = _RlMngInfListInetIpNetMask_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1, 6),
...
rlMngInfListInetService = _RlMngInfListInetService_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1, 7),
...
rlMngInfListInetAction = _RlMngInfListInetAction_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1, 8),
...
rlMngInfListInetRowStatus = _RlMngInfListInetRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1, 9),
...
rlMngInfListInetIPv6PrefixLength = _RlMngInfListInetIPv6PrefixLength_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1, 10),
...
rlMngInfListInetPortIfIndex = _RlMngInfListInetPortIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 6, 1, 11),
    _RlMngInfListInetPortIfIndex_Type()
)
rlMngInfListInetPortIfIndex.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlMngInfListInetPortIfIndex.setStatus("current")


class _RlMngInfDefaultListName_Type(DisplayString):
    """Custom type rlMngInfDefaultListName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 32),
    )
...
_RlMngInfDefaultListName_Type.__name__ = "DisplayString"
_RlMngInfDefaultListName_Object = MibScalar
rlMngInfDefaultListName = _RlMngInfDefaultListName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 89, 7),
    _RlMngInfDefaultListName_Type()
)
rlMngInfDefaultListName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlMngInfDefaultListName.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"RlMngInfServiceType": RlMngInfServiceType,
       ...
       "rlMngInfListPortIfIndex": rlMngInfListPortIfIndex,
       ...
       "rlMngInfListInetPortIfIndex": rlMngInfListInetPortIfIndex,
       "rlMngInfDefaultListName": rlMngInfDefaultListName}
)
