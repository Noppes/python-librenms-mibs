...
# Notes
# -----
# ASN.1 source file://mibs\cisco\CISCO-IETF-DHCP-SERVER-MIB
...
_CDhcpv4ServerSharedNetFreeAddrLowThreshold_Type = Integer32
...
_CDhcpv4ServerSharedNetFreeAddrHighThreshold_Type = Integer32
...
_CDhcpv4ServerSharedNetFreeAddresses_Type = Integer32
...
_CDhcpv4ServerSharedNetReservedAddresses_Type = Integer32
...
_CDhcpv4ServerSharedNetTotalAddresses_Type = Integer32
...
cDhcpv4SrvCompliance.setObjects(
      *(("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4SrvSystemObjects"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cBootpCountersGroup"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4CounterObjects"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cBootpHCCountersGroup"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4HCCounterObjects"))
)
if mibBuilder.loadTexts:
...
cDhcpv4SrvComplianceRev1.setObjects(
      *(("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4SrvSystemObjects"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cBootpCountersGroup"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4CounterObjects"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cBootpHCCountersGroup"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4HCCounterObjects"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4ServerSharedNetObjects"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4ServerSubnetObjects"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4ServerRangeObjects"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4ServerClientObjects"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4ServerNotifyObjectsGroup"),
        ("CISCO-IETF-DHCP-SERVER-MIB", "cDhcpv4ServerNotificationsGroup"))
)
if mibBuilder.loadTexts:
