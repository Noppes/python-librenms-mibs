...
# Notes
# -----
# ASN.1 source file://mibs\cisco\CISCOSB-rndMng
...
_RlPrivateMIBroot_Type = ObjectIdentifier
_RlPrivateMIBroot_Object = MibScalar
rlPrivateMIBroot = _RlPrivateMIBroot_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 1, 12),
    _RlPrivateMIBroot_Type()
)
rlPrivateMIBroot.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlPrivateMIBroot.setStatus("current")
...
class _RlDefaultSysName_Type(DisplayString):
    """Custom type rlDefaultSysName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_RlDefaultSysName_Type.__name__ = "DisplayString"
_RlDefaultSysName_Object = MibScalar
rlDefaultSysName = _RlDefaultSysName_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 1, 21),
    _RlDefaultSysName_Type()
)
rlDefaultSysName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    rlDefaultSysName.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"rndMng": rndMng,
       ...
       "rlPrivateMIBroot": rlPrivateMIBroot,
       ...
       "rlDefaultSysName": rlDefaultSysName}
)
