# SNMP MIB module (CISCO-IMAGE-TC) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\cisco\CISCO-IMAGE-TC
...
ciscoImageTc = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 9, 9, 455)
)
if mibBuilder.loadTexts:
    ciscoImageTc.setRevisions(
        ("2005-01-12 00:00",)
    )
