...
# Notes
# -----
# ASN.1 source file://mibs\cisco\CISCOSB-IP
...
class _RlIcmpCountersClear_Type(Integer32):
    """Custom type rlIcmpCountersClear based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            0
...
_RlIcmpCountersClear_Type.__name__ = "Integer32"
_RlIcmpCountersClear_Object = MibScalar
rlIcmpCountersClear = _RlIcmpCountersClear_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 26, 40),
    _RlIcmpCountersClear_Type()
)
rlIcmpCountersClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlIcmpCountersClear.setStatus("current")


class _RlIpCountersClear_Type(Integer32):
    """Custom type rlIpCountersClear based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            0
...
_RlIpCountersClear_Type.__name__ = "Integer32"
_RlIpCountersClear_Object = MibScalar
rlIpCountersClear = _RlIpCountersClear_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 26, 41),
    _RlIpCountersClear_Type()
)
rlIpCountersClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlIpCountersClear.setStatus("current")
_RlManagementIpPortIfindex_Type = Unsigned32
_RlManagementIpPortIfindex_Object = MibScalar
rlManagementIpPortIfindex = _RlManagementIpPortIfindex_Object(
    (1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 26, 42),
    _RlManagementIpPortIfindex_Type()
)
rlManagementIpPortIfindex.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    rlManagementIpPortIfindex.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"RlIpAddressOriginTC": RlIpAddressOriginTC,
       ...
       "rlIcmpCountersClear": rlIcmpCountersClear,
       "rlIpCountersClear": rlIpCountersClear,
       "rlManagementIpPortIfindex": rlManagementIpPortIfindex}
)
