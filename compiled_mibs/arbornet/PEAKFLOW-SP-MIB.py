...
# Notes
# -----
# ASN.1 source file://mibs\arbornet\PEAKFLOW-SP-MIB
...
spInterfaceSpeedHC = _SpInterfaceSpeedHC_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 81),
    _SpInterfaceSpeedHC_Type()
)
spInterfaceSpeedHC.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spInterfaceSpeedHC.setStatus("current")
_SpInterfaceUsageHC_Type = CounterBasedGauge64
_SpInterfaceUsageHC_Object = MibScalar
spInterfaceUsageHC = _SpInterfaceUsageHC_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 82),
    _SpInterfaceUsageHC_Type()
)
spInterfaceUsageHC.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spInterfaceUsageHC.setStatus("current")


class _SpGreTunnelName_Type(DisplayString):
    """Custom type spGreTunnelName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 256),
    )
...
_SpGreTunnelName_Type.__name__ = "DisplayString"
_SpGreTunnelName_Object = MibScalar
spGreTunnelName = _SpGreTunnelName_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 83),
    _SpGreTunnelName_Type()
)
spGreTunnelName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spGreTunnelName.setStatus("current")


class _SpCloudSignalFaultDescription_Type(DisplayString):
    """Custom type spCloudSignalFaultDescription based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 256),
    )
...
_SpCloudSignalFaultDescription_Type.__name__ = "DisplayString"
_SpCloudSignalFaultDescription_Object = MibScalar
spCloudSignalFaultDescription = _SpCloudSignalFaultDescription_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 84),
    _SpCloudSignalFaultDescription_Type()
)
spCloudSignalFaultDescription.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spCloudSignalFaultDescription.setStatus("current")


class _SpTMSMultiDiversionPrefix_Type(DisplayString):
    """Custom type spTMSMultiDiversionPrefix based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_SpTMSMultiDiversionPrefix_Type.__name__ = "DisplayString"
_SpTMSMultiDiversionPrefix_Object = MibScalar
spTMSMultiDiversionPrefix = _SpTMSMultiDiversionPrefix_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 1, 85),
    _SpTMSMultiDiversionPrefix_Type()
)
spTMSMultiDiversionPrefix.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    spTMSMultiDiversionPrefix.setStatus("current")
...
if mibBuilder.loadTexts:
    deviceTotalFlows.setStatus("deprecated")
_DeviceTotalFlowsHC_Type = Counter64
_DeviceTotalFlowsHC_Object = MibScalar
deviceTotalFlowsHC = _DeviceTotalFlowsHC_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 2, 1, 12),
    _DeviceTotalFlowsHC_Type()
)
deviceTotalFlowsHC.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    deviceTotalFlowsHC.setStatus("current")
...
interfaceUsage.setObjects(
      *(("PEAKFLOW-SP-MIB", "spAlertID"),
        ...
        ("PEAKFLOW-SP-MIB", "spInterfaceSpeedHC"),
...
greDown.setObjects(
      *(("PEAKFLOW-SP-MIB", "spAlertID"),
        ...
        ("PEAKFLOW-SP-MIB", "spGreTunnelName"))
)
if mibBuilder.loadTexts:
    greDown.setStatus(
        "current"
...
cloudSignalingFault = NotificationType(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 55)
)
cloudSignalingFault.setObjects(
      *(("PEAKFLOW-SP-MIB", "spAlertId"),
        ("PEAKFLOW-SP-MIB", "spPravail"),
        ("PEAKFLOW-SP-MIB", "spCloudSignalFaultDescription"))
)
if mibBuilder.loadTexts:
    cloudSignalingFault.setStatus(
        "current"
    )

cloudSignalingFaultDone = NotificationType(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 56)
)
cloudSignalingFaultDone.setObjects(
      *(("PEAKFLOW-SP-MIB", "spAlertId"),
        ("PEAKFLOW-SP-MIB", "spPravail"),
        ("PEAKFLOW-SP-MIB", "spCloudSignalFaultDescription"))
)
if mibBuilder.loadTexts:
    cloudSignalingFaultDone.setStatus(
        "current"
    )

mitigationTMSStartV2 = NotificationType(
    (1, 3, 6, 1, 4, 1, 9694, 1, 4, 3, 0, 57)
)
mitigationTMSStartV2.setObjects(
      *(("PEAKFLOW-SP-MIB", "spMitigationID"),
        ("PEAKFLOW-SP-MIB", "spMitigationName"),
        ("PEAKFLOW-SP-MIB", "spAlertID"),
        ("PEAKFLOW-SP-MIB", "spManagedObject"),
        ...
        ("PEAKFLOW-SP-MIB", "spMitigationStart"),
        ("PEAKFLOW-SP-MIB", "spTMSMultiPrefix"),
        ("PEAKFLOW-SP-MIB", "spTMSMultiDiversionPrefix"))
)
if mibBuilder.loadTexts:
    mitigationTMSStartV2.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"peakflowSPMIB": peakflowSPMIB,
       ...
       "spInterfaceSpeedHC": spInterfaceSpeedHC,
       "spInterfaceUsageHC": spInterfaceUsageHC,
       "spGreTunnelName": spGreTunnelName,
       "spCloudSignalFaultDescription": spCloudSignalFaultDescription,
       ...
       "cloudSignalingFaultDone": cloudSignalingFaultDone,
       "mitigationTMSStartV2": mitigationTMSStartV2}
)
