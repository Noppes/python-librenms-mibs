...
# Notes
# -----
# ASN.1 source file://mibs\arbornet\PEAKFLOW-TMS-MIB
...
tmsTrapGreName = _TmsTrapGreName_Object(
    (1, 3, 6, 1, 4, 1, 9694, 1, 5, 2, 21),
    _TmsTrapGreName_Type()
)
tmsTrapGreName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tmsTrapGreName.setStatus("current")
...
tmsSpCommunicationDegraded = NotificationType(
    (1, 3, 6, 1, 4, 1, 9694, 1, 5, 3, 0, 46)
)
tmsSpCommunicationDegraded.setObjects(
      *(("SNMPv2-MIB", "sysName"),
        ("PEAKFLOW-TMS-MIB", "tmsTrapString"),
        ("PEAKFLOW-TMS-MIB", "tmsTrapDetail"),
        ("PEAKFLOW-TMS-MIB", "tmsTrapComponentName"))
...
if mibBuilder.loadTexts:
    tmsSpCommunicationDegraded.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"TmsTableIndex": TmsTableIndex,
       ...
       "tmsSpCommunicationDegraded": tmsSpCommunicationDegraded,
