# SNMP MIB module (TELTONIKA-OTD-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\teltonika\TELTONIKA-OTD-MIB
...
pVlanEntry.setIndexNames(
    (0, "TELTONIKA-OTD-MIB", "pVlanIndex"),
)
if mibBuilder.loadTexts:
...
iVlanEntry.setIndexNames(
    (0, "TELTONIKA-OTD-MIB", "iVlanIndex"),
)
if mibBuilder.loadTexts:
...
queueEntry.setIndexNames(
    (0, "TELTONIKA-OTD-MIB", "queueIndex"),
)
if mibBuilder.loadTexts:
...
pLANTable = _PLANTable_Object(
    (1, 3, 6, 1, 4, 1, 48690, 10, 3)
)
if mibBuilder.loadTexts:
    pLANTable.setStatus("current")
_PLANEntry_Object = MibTableRow
pLANEntry = _PLANEntry_Object(
    (1, 3, 6, 1, 4, 1, 48690, 10, 3, 1)
)
pLANEntry.setIndexNames(
    (0, "TELTONIKA-OTD-MIB", "pLANIndex"),
)
if mibBuilder.loadTexts:
    pLANEntry.setStatus("current")


class _PLANIndex_Type(Integer32):
    """Custom type pLANIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_PLANIndex_Type.__name__ = "Integer32"
_PLANIndex_Object = MibTableColumn
pLANIndex = _PLANIndex_Object(
    (1, 3, 6, 1, 4, 1, 48690, 10, 3, 1, 1),
    _PLANIndex_Type()
)
pLANIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pLANIndex.setStatus("current")


class _PLANMAC_Type(DisplayString):
    """Custom type pLANMAC based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_PLANMAC_Type.__name__ = "DisplayString"
_PLANMAC_Object = MibTableColumn
pLANMAC = _PLANMAC_Object(
    (1, 3, 6, 1, 4, 1, 48690, 10, 3, 1, 2),
    _PLANMAC_Type()
)
pLANMAC.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    pLANMAC.setStatus("current")
...
mwan3Entry.setIndexNames(
    (0, "TELTONIKA-OTD-MIB", "mwan3Index"),
)
if mibBuilder.loadTexts:
...
_UniversalGateway_ObjectIdentity = ObjectIdentity
universalGateway = _UniversalGateway_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 48690, 20)
)
_TagTable_Object = MibTable
tagTable = _TagTable_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 1)
)
if mibBuilder.loadTexts:
    tagTable.setStatus("current")
_TagEntry_Object = MibTableRow
tagEntry = _TagEntry_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 1, 1)
)
tagEntry.setIndexNames(
    (0, "TELTONIKA-OTD-MIB", "tagIndex"),
)
if mibBuilder.loadTexts:
    tagEntry.setStatus("current")
_TagIndex_Type = Integer32
_TagIndex_Object = MibTableColumn
tagIndex = _TagIndex_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 1, 1, 1),
    _TagIndex_Type()
)
tagIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tagIndex.setStatus("current")
_TagId_Type = DisplayString
_TagId_Object = MibTableColumn
tagId = _TagId_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 1, 1, 2),
    _TagId_Type()
)
tagId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tagId.setStatus("current")
_TagPrettyName_Type = DisplayString
_TagPrettyName_Object = MibTableColumn
tagPrettyName = _TagPrettyName_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 1, 1, 3),
    _TagPrettyName_Type()
)
tagPrettyName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tagPrettyName.setStatus("current")


class _TagSource_Type(Integer32):
    """Custom type tagSource based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_TagSource_Type.__name__ = "Integer32"
_TagSource_Object = MibTableColumn
tagSource = _TagSource_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 1, 1, 4),
    _TagSource_Type()
)
tagSource.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tagSource.setStatus("current")


class _TagPermissions_Type(Integer32):
    """Custom type tagPermissions based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TagPermissions_Type.__name__ = "Integer32"
_TagPermissions_Object = MibTableColumn
tagPermissions = _TagPermissions_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 1, 1, 5),
    _TagPermissions_Type()
)
tagPermissions.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tagPermissions.setStatus("current")


class _TagType_Type(Integer32):
    """Custom type tagType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TagType_Type.__name__ = "Integer32"
_TagType_Object = MibTableColumn
tagType = _TagType_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 1, 1, 6),
    _TagType_Type()
)
tagType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tagType.setStatus("current")


class _TagValueSize_Type(Integer32):
    """Custom type tagValueSize based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_TagValueSize_Type.__name__ = "Integer32"
_TagValueSize_Object = MibTableColumn
tagValueSize = _TagValueSize_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 1, 1, 7),
    _TagValueSize_Type()
)
tagValueSize.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tagValueSize.setStatus("current")
_TagTimestamp_Type = Unsigned32
_TagTimestamp_Object = MibTableColumn
tagTimestamp = _TagTimestamp_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 1, 1, 8),
    _TagTimestamp_Type()
)
tagTimestamp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tagTimestamp.setStatus("current")
_TagValueTable_Object = MibTable
tagValueTable = _TagValueTable_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 2)
)
if mibBuilder.loadTexts:
    tagValueTable.setStatus("current")
_TagValueEntry_Object = MibTableRow
tagValueEntry = _TagValueEntry_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 2, 1)
)
tagValueEntry.setIndexNames(
    (0, "TELTONIKA-OTD-MIB", "tagValueIndex"),
    (0, "TELTONIKA-OTD-MIB", "tagIndex"),
)
if mibBuilder.loadTexts:
    tagValueEntry.setStatus("current")
_TagValueIndex_Type = Integer32
_TagValueIndex_Object = MibTableColumn
tagValueIndex = _TagValueIndex_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 2, 1, 1),
    _TagValueIndex_Type()
)
tagValueIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tagValueIndex.setStatus("current")
_TagValue_Type = OctetString
_TagValue_Object = MibTableColumn
tagValue = _TagValue_Object(
    (1, 3, 6, 1, 4, 1, 48690, 20, 2, 1, 2),
    _TagValue_Type()
)
tagValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tagValue.setStatus("current")
...
deviceGroup.setObjects(
      *(("TELTONIKA-OTD-MIB", "serial"),
        ("TELTONIKA-OTD-MIB", "deviceName"),
        ("TELTONIKA-OTD-MIB", "productCode"),
        ("TELTONIKA-OTD-MIB", "batchNumber"),
        ("TELTONIKA-OTD-MIB", "hardwareRevision"),
        ("TELTONIKA-OTD-MIB", "fwVersion"),
        ("TELTONIKA-OTD-MIB", "deviceUptime"),
        ("TELTONIKA-OTD-MIB", "cpuUsage"))
)
if mibBuilder.loadTexts:
...
modemGroup.setObjects(
      *(("TELTONIKA-OTD-MIB", "modemNum"),
        ("TELTONIKA-OTD-MIB", "mIndex"),
        ("TELTONIKA-OTD-MIB", "mDescr"),
        ("TELTONIKA-OTD-MIB", "mImei"),
        ("TELTONIKA-OTD-MIB", "mModel"),
        ("TELTONIKA-OTD-MIB", "mManufacturer"),
        ("TELTONIKA-OTD-MIB", "mRevision"),
        ("TELTONIKA-OTD-MIB", "mSerial"),
        ("TELTONIKA-OTD-MIB", "mIMSI"),
        ("TELTONIKA-OTD-MIB", "mSimState"),
        ("TELTONIKA-OTD-MIB", "mPinState"),
        ("TELTONIKA-OTD-MIB", "mNetState"),
        ("TELTONIKA-OTD-MIB", "mSignal"),
        ("TELTONIKA-OTD-MIB", "mOperator"),
        ("TELTONIKA-OTD-MIB", "mOperatorNumber"),
        ("TELTONIKA-OTD-MIB", "mConnectionState"),
        ("TELTONIKA-OTD-MIB", "mNetworkType"),
        ("TELTONIKA-OTD-MIB", "mTemperature"),
        ("TELTONIKA-OTD-MIB", "mCellID"),
        ("TELTONIKA-OTD-MIB", "mSINR"),
        ("TELTONIKA-OTD-MIB", "mRSRP"),
        ("TELTONIKA-OTD-MIB", "mRSRQ"),
        ("TELTONIKA-OTD-MIB", "mSent"),
        ("TELTONIKA-OTD-MIB", "mReceived"),
        ("TELTONIKA-OTD-MIB", "mIP"),
        ("TELTONIKA-OTD-MIB", "mSentToday"),
        ("TELTONIKA-OTD-MIB", "mReceivedToday"),
        ("TELTONIKA-OTD-MIB", "mICCID"),
        ("TELTONIKA-OTD-MIB", "mSentCurrentWeek"),
        ("TELTONIKA-OTD-MIB", "mReceivedCurrentWeek"),
        ("TELTONIKA-OTD-MIB", "mSentCurrentMonth"),
        ("TELTONIKA-OTD-MIB", "mReceivedCurrentMonth"),
        ("TELTONIKA-OTD-MIB", "connectionUptime"))
)
if mibBuilder.loadTexts:
...
hotspotGroup.setObjects(
      *(("TELTONIKA-OTD-MIB", "hsState"),
        ("TELTONIKA-OTD-MIB", "hsIP"),
        ("TELTONIKA-OTD-MIB", "hsNet"),
        ("TELTONIKA-OTD-MIB", "hsAuth"),
        ("TELTONIKA-OTD-MIB", "hsSessionCount"),
        ("TELTONIKA-OTD-MIB", "hssIndex"),
        ("TELTONIKA-OTD-MIB", "hssMAC"),
        ("TELTONIKA-OTD-MIB", "hssIP"),
        ("TELTONIKA-OTD-MIB", "hssID"),
        ("TELTONIKA-OTD-MIB", "hssUsername"),
        ("TELTONIKA-OTD-MIB", "hssState"),
        ("TELTONIKA-OTD-MIB", "hssDwLimit"),
        ("TELTONIKA-OTD-MIB", "hssUpLimit"),
        ("TELTONIKA-OTD-MIB", "hssTimeLimit"),
        ("TELTONIKA-OTD-MIB", "hssIdleTimeout"),
        ("TELTONIKA-OTD-MIB", "hssDwBandwidth"),
        ("TELTONIKA-OTD-MIB", "hssUpBandwidth"),
        ("TELTONIKA-OTD-MIB", "hssURL"))
)
if mibBuilder.loadTexts:
...
iVlanGroup.setObjects(
      *(("TELTONIKA-OTD-MIB", "iVlanCount"),
        ("TELTONIKA-OTD-MIB", "iVlanIndex"),
        ("TELTONIKA-OTD-MIB", "iVlanName"),
        ("TELTONIKA-OTD-MIB", "iVlanType"),
        ("TELTONIKA-OTD-MIB", "iVlanIfName"),
        ("TELTONIKA-OTD-MIB", "iVlanVID"))
)
if mibBuilder.loadTexts:
...
pVlanGroup.setObjects(
      *(("TELTONIKA-OTD-MIB", "pVlanCount"),
        ("TELTONIKA-OTD-MIB", "pVlanIndex"),
        ("TELTONIKA-OTD-MIB", "pVlanNum"),
        ("TELTONIKA-OTD-MIB", "pVlanPorts"),
        ("TELTONIKA-OTD-MIB", "pVlanVID"))
)
if mibBuilder.loadTexts:
...
queueVlanGroup.setObjects(
      *(("TELTONIKA-OTD-MIB", "queueCount"),
        ("TELTONIKA-OTD-MIB", "queueIndex"),
        ("TELTONIKA-OTD-MIB", "queueName"),
        ("TELTONIKA-OTD-MIB", "queueEnabled"),
        ("TELTONIKA-OTD-MIB", "queueIface"),
        ("TELTONIKA-OTD-MIB", "queueDownLimit"),
        ("TELTONIKA-OTD-MIB", "queueUpLimit"),
        ("TELTONIKA-OTD-MIB", "queueQdisk"),
        ("TELTONIKA-OTD-MIB", "queueScript"))
)
if mibBuilder.loadTexts:
...
portGroup.setObjects(
      *(("TELTONIKA-OTD-MIB", "portCount"),
        ("TELTONIKA-OTD-MIB", "pIndex"),
        ("TELTONIKA-OTD-MIB", "pName"),
        ("TELTONIKA-OTD-MIB", "pNumber"),
        ("TELTONIKA-OTD-MIB", "pPosition"),
        ("TELTONIKA-OTD-MIB", "pState"),
        ("TELTONIKA-OTD-MIB", "pSpeed"),
        ("TELTONIKA-OTD-MIB", "pDuplex"),
        ("TELTONIKA-OTD-MIB", "pLANIndex"),
        ("TELTONIKA-OTD-MIB", "pLANMAC"))
)
if mibBuilder.loadTexts:
...
mwan3Group.setObjects(
      *(("TELTONIKA-OTD-MIB", "mwan3Count"),
        ("TELTONIKA-OTD-MIB", "mwan3Index"),
        ("TELTONIKA-OTD-MIB", "mwan3Name"),
        ("TELTONIKA-OTD-MIB", "mwan3Enabled"),
        ("TELTONIKA-OTD-MIB", "mwan3Uptime"),
        ("TELTONIKA-OTD-MIB", "mwan3Status"),
        ("TELTONIKA-OTD-MIB", "mwan3Ip"))
)
if mibBuilder.loadTexts:
...
trapGroup.setObjects(
      *(("TELTONIKA-OTD-MIB", "signalChangeNotification"),
        ("TELTONIKA-OTD-MIB", "networkTypeNotification"),
        ("TELTONIKA-OTD-MIB", "clientConnectedNotification"),
        ("TELTONIKA-OTD-MIB", "clientDisconnectedNotification"),
        ("TELTONIKA-OTD-MIB", "eventLogNotification"))
)
if mibBuilder.loadTexts:
    trapGroup.setStatus(
        "current"
