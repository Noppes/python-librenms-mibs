...
# Notes
# -----
# ASN.1 source file://mibs\alvarion\ALVARION-DOT11-WLAN-MIB
...
_BrzaccLighteAPWorkingMode_Type = Integer32
_BrzaccLighteAPWorkingMode_Object = MibScalar
brzaccLighteAPWorkingMode = _BrzaccLighteAPWorkingMode_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 1, 2, 16),
    _BrzaccLighteAPWorkingMode_Type()
)
brzaccLighteAPWorkingMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    brzaccLighteAPWorkingMode.setStatus("current")
...
_BrzaccVLApClientIpAddress_Type = IpAddress
_BrzaccVLApClientIpAddress_Object = MibScalar
brzaccVLApClientIpAddress = _BrzaccVLApClientIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 1, 3, 13),
    _BrzaccVLApClientIpAddress_Type()
)
brzaccVLApClientIpAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    brzaccVLApClientIpAddress.setStatus("current")
...
brzaccVLScanningStep.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
brzaccVLFrequencySubsetFrequencyNew.setMaxAccess("read-write")
if mibBuilder.loadTexts:
...
class _BrzaccVLFairnessFactor_Type(Integer32):
    """Custom type brzaccVLFairnessFactor based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            255
...
_BrzaccVLFairnessFactor_Type.__name__ = "Integer32"
...
_BrzaccVLSUPMirDownlink_Type = Integer32
_BrzaccVLSUPMirDownlink_Object = MibScalar
brzaccVLSUPMirDownlink = _BrzaccVLSUPMirDownlink_Object(
    (1, 3, 6, 1, 4, 1, 12394, 1, 1, 7, 13),
    _BrzaccVLSUPMirDownlink_Type()
)
brzaccVLSUPMirDownlink.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    brzaccVLSUPMirDownlink.setStatus("current")
...
brzaccVLDFSRadarDetecetedTRAP = NotificationType(
    (1, 3, 6, 1, 4, 1, 12394, 4, 1, 3, 106)
)
if mibBuilder.loadTexts:
    brzaccVLDFSRadarDetecetedTRAP.setStatus(
        "current"
    )

brzaccVLDFSFrequcnyTRAP = NotificationType(
    (1, 3, 6, 1, 4, 1, 12394, 4, 1, 3, 107)
)
brzaccVLDFSFrequcnyTRAP.setObjects(
      *(("ALVARION-DOT11-WLAN-MIB", "brzaccVLDFSMoveFreq"),
        ("ALVARION-DOT11-WLAN-MIB", "brzaccVLDFSMoveFreqNew"))
)
if mibBuilder.loadTexts:
    brzaccVLDFSFrequcnyTRAP.setStatus(
        "current"
    )
...
brzaccVLEthBroadcastMulticatLimiterTRAP = NotificationType(
    (1, 3, 6, 1, 4, 1, 12394, 4, 1, 3, 109)
)
brzaccVLEthBroadcastMulticatLimiterTRAP.setObjects(
    ("ALVARION-DOT11-WLAN-MIB", "brzaccVLEthBroadcastThresholdExceeded")
)
if mibBuilder.loadTexts:
    brzaccVLEthBroadcastMulticatLimiterTRAP.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"MacAddress": MacAddress,
       ...
       "brzaccLighteAPWorkingMode": brzaccLighteAPWorkingMode,
       ...
       "brzaccVLApClientIpAddress": brzaccVLApClientIpAddress,
       ...
       "brzaccVLSUPMirDownlink": brzaccVLSUPMirDownlink,
       ...
       "brzaccVLDFSRadarDetecetedTRAP": brzaccVLDFSRadarDetecetedTRAP,
