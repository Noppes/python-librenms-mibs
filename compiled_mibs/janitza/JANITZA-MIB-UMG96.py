# SNMP MIB module (JANITZA-MIB-UMG96) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\janitza\JANITZA-MIB-UMG96
...
_IL5_Type = Integer32
_IL5_Object = MibScalar
iL5 = _IL5_Object(
    (1, 3, 6, 1, 4, 1, 34278, 1, 11),
    _IL5_Type()
)
iL5.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    iL5.setStatus("mandatory")
_IL6_Type = Integer32
_IL6_Object = MibScalar
iL6 = _IL6_Object(
    (1, 3, 6, 1, 4, 1, 34278, 1, 12),
    _IL6_Type()
)
iL6.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    iL6.setStatus("mandatory")
_PL1_Type = Integer32
...
_RmsSum_ObjectIdentity = ObjectIdentity
rmsSum = _RmsSum_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 34278, 2)
)
_P3_Type = Integer32
...
_EnergyPhase_ObjectIdentity = ObjectIdentity
energyPhase = _EnergyPhase_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 34278, 3)
)
...
qhL3 = _QhL3_Object(
    (1, 3, 6, 1, 4, 1, 34278, 3, 6),
    _QhL3_Type()
)
qhL3.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    qhL3.setStatus("mandatory")
_EnergySum_ObjectIdentity = ObjectIdentity
energySum = _EnergySum_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 34278, 4)
)
_Wh3_Type = Integer32
...
_Frequence_Type = Integer32
_Frequence_Object = MibScalar
frequence = _Frequence_Object(
    (1, 3, 6, 1, 4, 1, 34278, 6, 1),
    _Frequence_Type()
)
frequence.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    frequence.setStatus("mandatory")
_Temp1_Type = Integer32
_Temp1_Object = MibScalar
temp1 = _Temp1_Object(
    (1, 3, 6, 1, 4, 1, 34278, 6, 2),
    _Temp1_Type()
)
temp1.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    temp1.setStatus("mandatory")
_Temp2_Type = Integer32
_Temp2_Object = MibScalar
temp2 = _Temp2_Object(
    (1, 3, 6, 1, 4, 1, 34278, 6, 3),
    _Temp2_Type()
)
temp2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    temp2.setStatus("mandatory")
