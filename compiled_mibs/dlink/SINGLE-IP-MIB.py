...
# Notes
# -----
# ASN.1 source file://mibs\dlink\SINGLE-IP-MIB
...
class _SwSingleIPCSGroupName_Type(DisplayString):
    """Custom type swSingleIPCSGroupName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 64),
    )
...
_SwSingleIPCSGroupName_Type.__name__ = "DisplayString"
_SwSingleIPCSGroupName_Object = MibScalar
swSingleIPCSGroupName = _SwSingleIPCSGroupName_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 8, 1, 2, 5),
    _SwSingleIPCSGroupName_Type()
)
swSingleIPCSGroupName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swSingleIPCSGroupName.setStatus("current")
_SwSingleIPTrapMgmt_ObjectIdentity = ObjectIdentity
swSingleIPTrapMgmt = _SwSingleIPTrapMgmt_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 171, 12, 8, 1, 2, 6)
)


class _SwSingleIPTrapStatus_Type(Integer32):
    """Custom type swSingleIPTrapStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_SwSingleIPTrapStatus_Type.__name__ = "Integer32"
_SwSingleIPTrapStatus_Object = MibScalar
swSingleIPTrapStatus = _SwSingleIPTrapStatus_Object(
    (1, 3, 6, 1, 4, 1, 171, 12, 8, 1, 2, 6, 1),
    _SwSingleIPTrapStatus_Type()
)
swSingleIPTrapStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    swSingleIPTrapStatus.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"swSingleIPMIB": swSingleIPMIB,
       ...
       "swSingleIPCSGroupName": swSingleIPCSGroupName,
       "swSingleIPTrapMgmt": swSingleIPTrapMgmt,
       "swSingleIPTrapStatus": swSingleIPTrapStatus,
