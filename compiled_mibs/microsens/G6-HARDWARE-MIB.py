...
_CableTestConfigCreateReference_Type = DisplayString
_CableTestConfigCreateReference_Object = MibTableColumn
cableTestConfigCreateReference = _CableTestConfigCreateReference_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 6, 1, 7),
    _CableTestConfigCreateReference_Type()
)
cableTestConfigCreateReference.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cableTestConfigCreateReference.setStatus("current")
_CableTestConfigReferenceData_Type = DisplayString
_CableTestConfigReferenceData_Object = MibTableColumn
cableTestConfigReferenceData = _CableTestConfigReferenceData_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 6, 1, 8),
    _CableTestConfigReferenceData_Type()
)
cableTestConfigReferenceData.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    cableTestConfigReferenceData.setStatus("current")
...
class _HardwareMaskOfExistingPorts_Type(OctetString):
    """Custom type hardwareMaskOfExistingPorts based on OctetString"""
...
_HardwareMaskOfExistingPorts_Type.__name__ = "OctetString"
...
class _HardwareMaskOfSfpPorts_Type(OctetString):
    """Custom type hardwareMaskOfSfpPorts based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 4),
    )
...
_HardwareMaskOfSfpPorts_Type.__name__ = "OctetString"
...
class _HardwareMaskOfPoePorts_Type(OctetString):
    """Custom type hardwareMaskOfPoePorts based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 4),
    )
...
_HardwareMaskOfPoePorts_Type.__name__ = "OctetString"
...
_PortNamesTable_Object = MibTable
portNamesTable = _PortNamesTable_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 112)
)
if mibBuilder.loadTexts:
    portNamesTable.setStatus("current")
_PortNamesEntry_Object = MibTableRow
portNamesEntry = _PortNamesEntry_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 112, 1)
)
portNamesEntry.setIndexNames(
    (0, "G6-HARDWARE-MIB", "portNamesPortIndex"),
)
if mibBuilder.loadTexts:
    portNamesEntry.setStatus("current")


class _PortNamesPortIndex_Type(Integer32):
    """Custom type portNamesPortIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 24),
    )
...
_PortNamesPortIndex_Type.__name__ = "Integer32"
_PortNamesPortIndex_Object = MibTableColumn
portNamesPortIndex = _PortNamesPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 112, 1, 1),
    _PortNamesPortIndex_Type()
)
portNamesPortIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    portNamesPortIndex.setStatus("current")
_PortNamesCliName_Type = DisplayString
_PortNamesCliName_Object = MibTableColumn
portNamesCliName = _PortNamesCliName_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 112, 1, 2),
    _PortNamesCliName_Type()
)
portNamesCliName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    portNamesCliName.setStatus("current")
_PortNamesPortDescription_Type = DisplayString
_PortNamesPortDescription_Object = MibTableColumn
portNamesPortDescription = _PortNamesPortDescription_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 112, 1, 3),
    _PortNamesPortDescription_Type()
)
portNamesPortDescription.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    portNamesPortDescription.setStatus("current")
...
deviceLedsRing2Blinking = _DeviceLedsRing2Blinking_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 114, 1, 13),
...
deviceLedsSignalIn1Color = _DeviceLedsSignalIn1Color_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 114, 1, 14),
...
deviceLedsSignalIn1Blinking = _DeviceLedsSignalIn1Blinking_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 114, 1, 15),
...
deviceLedsSignalIn2Color = _DeviceLedsSignalIn2Color_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 114, 1, 16),
...
deviceLedsSignalIn2Blinking = _DeviceLedsSignalIn2Blinking_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 114, 1, 17),
...
deviceLedsSignalOut1Color = _DeviceLedsSignalOut1Color_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 114, 1, 18),
...
deviceLedsSignalOut1Blinking = _DeviceLedsSignalOut1Blinking_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 114, 1, 19),
...
deviceLedsSignalOut2Color = _DeviceLedsSignalOut2Color_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 114, 1, 20),
...
deviceLedsSignalOut2Blinking = _DeviceLedsSignalOut2Blinking_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 114, 1, 21),
...
cableTestStatusPair1DistanceToFault = _CableTestStatusPair1DistanceToFault_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 115, 1, 6),
...
cableTestStatusPair2State = _CableTestStatusPair2State_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 115, 1, 7),
...
cableTestStatusPair2DistanceToFault = _CableTestStatusPair2DistanceToFault_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 115, 1, 8),
...
cableTestStatusPair3State = _CableTestStatusPair3State_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 115, 1, 9),
...
cableTestStatusPair3DistanceToFault = _CableTestStatusPair3DistanceToFault_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 115, 1, 10),
...
cableTestStatusReflectionValue = _CableTestStatusReflectionValue_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 115, 1, 11),
...
cableTestStatusCableStatus = _CableTestStatusCableStatus_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 115, 1, 12),
...
_CableTestStatusCurrentOtdrReflections_Type = DisplayString
_CableTestStatusCurrentOtdrReflections_Object = MibTableColumn
cableTestStatusCurrentOtdrReflections = _CableTestStatusCurrentOtdrReflections_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 115, 1, 13),
    _CableTestStatusCurrentOtdrReflections_Type()
)
cableTestStatusCurrentOtdrReflections.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    cableTestStatusCurrentOtdrReflections.setStatus("current")
...
ioSignalStatusOutput1RelayActive = _IoSignalStatusOutput1RelayActive_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 116, 1, 4),
...
ioSignalStatusOutput2RelayActive = _IoSignalStatusOutput2RelayActive_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 116, 1, 5),
...
tcamStatusIndex = _TcamStatusIndex_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 117, 1, 1),
...
tcamStatusControlFile = _TcamStatusControlFile_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 117, 1, 2),
...
tcamStatusDescription = _TcamStatusDescription_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 117, 1, 3),
    _TcamStatusDescription_Type()
)
tcamStatusDescription.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tcamStatusDescription.setStatus("current")
_MemoryUtilizationTable_Object = MibTable
memoryUtilizationTable = _MemoryUtilizationTable_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 118)
)
if mibBuilder.loadTexts:
    memoryUtilizationTable.setStatus("current")
_MemoryUtilizationEntry_Object = MibTableRow
memoryUtilizationEntry = _MemoryUtilizationEntry_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 118, 1)
)
memoryUtilizationEntry.setIndexNames(
    (0, "G6-HARDWARE-MIB", "memoryUtilizationIndex"),
)
if mibBuilder.loadTexts:
    memoryUtilizationEntry.setStatus("current")


class _MemoryUtilizationIndex_Type(Integer32):
    """Custom type memoryUtilizationIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 0),
    )
...
_MemoryUtilizationIndex_Type.__name__ = "Integer32"
_MemoryUtilizationIndex_Object = MibTableColumn
memoryUtilizationIndex = _MemoryUtilizationIndex_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 118, 1, 1),
    _MemoryUtilizationIndex_Type()
)
memoryUtilizationIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    memoryUtilizationIndex.setStatus("current")
_MemoryUtilizationFlashFreeMegabyte_Type = Unsigned32
_MemoryUtilizationFlashFreeMegabyte_Object = MibTableColumn
memoryUtilizationFlashFreeMegabyte = _MemoryUtilizationFlashFreeMegabyte_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 118, 1, 2),
    _MemoryUtilizationFlashFreeMegabyte_Type()
)
memoryUtilizationFlashFreeMegabyte.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUtilizationFlashFreeMegabyte.setStatus("current")
_MemoryUtilizationFlashUsedPercent_Type = Unsigned32
_MemoryUtilizationFlashUsedPercent_Object = MibTableColumn
memoryUtilizationFlashUsedPercent = _MemoryUtilizationFlashUsedPercent_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 118, 1, 3),
    _MemoryUtilizationFlashUsedPercent_Type()
)
memoryUtilizationFlashUsedPercent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUtilizationFlashUsedPercent.setStatus("current")
_MemoryUtilizationRamDiskFreeMegabyte_Type = Unsigned32
_MemoryUtilizationRamDiskFreeMegabyte_Object = MibTableColumn
memoryUtilizationRamDiskFreeMegabyte = _MemoryUtilizationRamDiskFreeMegabyte_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 118, 1, 4),
    _MemoryUtilizationRamDiskFreeMegabyte_Type()
)
memoryUtilizationRamDiskFreeMegabyte.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUtilizationRamDiskFreeMegabyte.setStatus("current")
_MemoryUtilizationRamDiskUsedPercent_Type = Unsigned32
_MemoryUtilizationRamDiskUsedPercent_Object = MibTableColumn
memoryUtilizationRamDiskUsedPercent = _MemoryUtilizationRamDiskUsedPercent_Object(
    (1, 3, 6, 1, 4, 1, 3181, 10, 6, 1, 31, 118, 1, 5),
    _MemoryUtilizationRamDiskUsedPercent_Type()
)
memoryUtilizationRamDiskUsedPercent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    memoryUtilizationRamDiskUsedPercent.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"device": device,
       ...
       "cableTestConfigCreateReference": cableTestConfigCreateReference,
       "cableTestConfigReferenceData": cableTestConfigReferenceData,
       ...
       "portNamesTable": portNamesTable,
       "portNamesEntry": portNamesEntry,
       "portNamesPortIndex": portNamesPortIndex,
       "portNamesCliName": portNamesCliName,
       "portNamesPortDescription": portNamesPortDescription,
       ...
       "cableTestStatusCurrentOtdrReflections": cableTestStatusCurrentOtdrReflections,
       ...
       "memoryUtilizationTable": memoryUtilizationTable,
       "memoryUtilizationEntry": memoryUtilizationEntry,
       "memoryUtilizationIndex": memoryUtilizationIndex,
       "memoryUtilizationFlashFreeMegabyte": memoryUtilizationFlashFreeMegabyte,
       "memoryUtilizationFlashUsedPercent": memoryUtilizationFlashUsedPercent,
       "memoryUtilizationRamDiskFreeMegabyte": memoryUtilizationRamDiskFreeMegabyte,
       "memoryUtilizationRamDiskUsedPercent": memoryUtilizationRamDiskUsedPercent}
)
