# SNMP MIB module (MOXA-PT7528V2-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\moxa\MOXA-PT7528V2-MIB
...
pt7528v2 = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85)
)
if mibBuilder.loadTexts:
    pt7528v2.setRevisions(
        ("2017-01-16 00:00",
         "2012-08-27 00:00",
         "2013-04-19 00:00",
         "2013-04-11 00:00",
...
portIndex = _PortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 9, 1, 1, 1),
    _PortIndex_Type()
)
...
portDesc = _PortDesc_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 9, 1, 1, 2),
    _PortDesc_Type()
)
...
portEnable = _PortEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 9, 1, 1, 3),
    _PortEnable_Type()
)
...
portSpeed = _PortSpeed_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 9, 1, 1, 4),
    _PortSpeed_Type()
)
...
portMDI = _PortMDI_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 9, 1, 1, 5),
    _PortMDI_Type()
)
...
portFDXFlowCtrl = _PortFDXFlowCtrl_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 9, 1, 1, 6),
...
portName = _PortName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 9, 1, 1, 7),
    _PortName_Type()
)
...
monitorLinkStatus = _MonitorLinkStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 3, 1, 2),
...
monitorSpeed = _MonitorSpeed_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 3, 1, 3),
    _MonitorSpeed_Type()
)
...
monitorAutoMDI = _MonitorAutoMDI_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 3, 1, 4),
...
monitorTraffic = _MonitorTraffic_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 3, 1, 5),
...
monitorFDXFlowCtrl = _MonitorFDXFlowCtrl_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 3, 1, 6),
...
monitorTxTraffic = _MonitorTxTraffic_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 3, 1, 7),
...
monitorRxTraffic = _MonitorRxTraffic_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 3, 1, 8),
...
monitorFiberCheckEntry = _MonitorFiberCheckEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1)
)
...
fiberPort = _FiberPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 1),
    _FiberPort_Type()
)
...
fiberModelName = _FiberModelName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 2),
...
fiberWaveLength = _FiberWaveLength_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 3),
...
fiberVoltage = _FiberVoltage_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 4),
    _FiberVoltage_Type()
)
...
fiberTemperature = _FiberTemperature_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 5),
...
fiberTempWarn = _FiberTempWarn_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 6),
    _FiberTempWarn_Type()
)
...
fiberTxPower = _FiberTxPower_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 7),
    _FiberTxPower_Type()
)
...
fiberTxPowerWarn = _FiberTxPowerWarn_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 8),
...
fiberRxPower = _FiberRxPower_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 9),
    _FiberRxPower_Type()
)
...
fiberRxPowerWarn = _FiberRxPowerWarn_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 10),
    _FiberRxPowerWarn_Type()
)
fiberRxPowerWarn.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fiberRxPowerWarn.setStatus("current")
_FiberTransciever_Type = DisplayString
_FiberTransciever_Object = MibTableColumn
fiberTransciever = _FiberTransciever_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 11),
    _FiberTransciever_Type()
)
fiberTransciever.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fiberTransciever.setStatus("current")
_FiberTxBiasCurrent_Type = DisplayString
_FiberTxBiasCurrent_Object = MibTableColumn
fiberTxBiasCurrent = _FiberTxBiasCurrent_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 10, 11, 1, 12),
    _FiberTxBiasCurrent_Type()
)
fiberTxBiasCurrent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fiberTxBiasCurrent.setStatus("current")
_EmailWarning_ObjectIdentity = ObjectIdentity
emailWarning = _EmailWarning_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11)
)
_EmailService_ObjectIdentity = ObjectIdentity
emailService = _EmailService_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 1)
)
...
emailWarningMailServer = _EmailWarningMailServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 1, 1),
...
emailWarningFirstEmailAddr = _EmailWarningFirstEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 1, 2),
...
emailWarningSecondEmailAddr = _EmailWarningSecondEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 1, 3),
...
emailWarningThirdEmailAddr = _EmailWarningThirdEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 1, 4),
...
emailWarningFourthEmailAddr = _EmailWarningFourthEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 1, 5),
...
emailWarningSMTPPort = _EmailWarningSMTPPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 1, 6),
...
emailWarningEventServerColdStart = _EmailWarningEventServerColdStart_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 2, 1),
...
emailWarningEventServerWarmStart = _EmailWarningEventServerWarmStart_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 2, 2),
...
emailWarningEventConfigChange = _EmailWarningEventConfigChange_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 2, 3),
...
emailWarningEventPowerOn2Off = _EmailWarningEventPowerOn2Off_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 2, 4),
...
emailWarningEventPowerOff2On = _EmailWarningEventPowerOff2On_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 2, 5),
...
emailWarningEventAuthFail = _EmailWarningEventAuthFail_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 2, 6),
...
class _EmailWarningEventTopologyChanged_Type(Integer32):
    """Custom type emailWarningEventTopologyChanged based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_EmailWarningEventTopologyChanged_Type.__name__ = "Integer32"
_EmailWarningEventTopologyChanged_Object = MibScalar
emailWarningEventTopologyChanged = _EmailWarningEventTopologyChanged_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 2, 7),
    _EmailWarningEventTopologyChanged_Type()
)
emailWarningEventTopologyChanged.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    emailWarningEventTopologyChanged.setStatus("current")


class _EmailWarningEventFiberWarning_Type(Integer32):
    """Custom type emailWarningEventFiberWarning based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_EmailWarningEventFiberWarning_Type.__name__ = "Integer32"
_EmailWarningEventFiberWarning_Object = MibScalar
emailWarningEventFiberWarning = _EmailWarningEventFiberWarning_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 2, 8),
    _EmailWarningEventFiberWarning_Type()
)
emailWarningEventFiberWarning.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    emailWarningEventFiberWarning.setStatus("current")
_EmailWarningEventPortTable_Object = MibTable
emailWarningEventPortTable = _EmailWarningEventPortTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 3)
)
if mibBuilder.loadTexts:
...
emailWarningEventPortEntry = _EmailWarningEventPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 3, 1)
)
...
emailWarningEventPortLinkOn = _EmailWarningEventPortLinkOn_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 3, 1, 2),
...
emailWarningEventPortLinkOff = _EmailWarningEventPortLinkOff_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 3, 1, 3),
...
emailWarningEventPortTrafficOverload = _EmailWarningEventPortTrafficOverload_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 3, 1, 4),
...
emailWarningEventPortRxTrafficThreshold = _EmailWarningEventPortRxTrafficThreshold_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 3, 1, 5),
    _EmailWarningEventPortRxTrafficThreshold_Type()
)
emailWarningEventPortRxTrafficThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    emailWarningEventPortRxTrafficThreshold.setStatus("current")
...
emailWarningEventPortTrafficDuration = _EmailWarningEventPortTrafficDuration_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 11, 3, 1, 6),
...
setDevIpIndex = _SetDevIpIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 12, 1, 1, 1),
    _SetDevIpIndex_Type()
)
...
setDevIpCurrentIpofDevice = _SetDevIpCurrentIpofDevice_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 12, 1, 1, 2),
...
setDevIpPresentBy = _SetDevIpPresentBy_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 12, 1, 1, 3),
...
setDevIpDedicatedIp = _SetDevIpDedicatedIp_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 12, 1, 1, 4),
...
mirrorTable = _MirrorTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 13, 2)
)
if mibBuilder.loadTexts:
    mirrorTable.setStatus("current")
_MirrorEntry_Object = MibTableRow
mirrorEntry = _MirrorEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 13, 2, 1)
)
mirrorEntry.setIndexNames(
    (0, "MOXA-PT7528V2-MIB", "mirrorIndex"),
)
if mibBuilder.loadTexts:
    mirrorEntry.setStatus("current")
_MirrorIndex_Type = Integer32
_MirrorIndex_Object = MibTableColumn
mirrorIndex = _MirrorIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 13, 2, 1, 1),
    _MirrorIndex_Type()
)
mirrorIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    mirrorIndex.setStatus("current")


class _TargetPortEnable_Type(Integer32):
    """Custom type targetPortEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TargetPortEnable_Type.__name__ = "Integer32"
_TargetPortEnable_Object = MibTableColumn
targetPortEnable = _TargetPortEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 13, 2, 1, 2),
    _TargetPortEnable_Type()
)
targetPortEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    targetPortEnable.setStatus("current")
...
monitorDirection = _MonitorDirection_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 13, 2, 1, 3),
...
trunkSettingIndex = _TrunkSettingIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 14, 1, 1, 1),
...
trunkType = _TrunkType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 14, 1, 1, 2),
    _TrunkType_Type()
)
...
trunkMemberPorts = _TrunkMemberPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 14, 1, 1, 3),
...
trunkTable = _TrunkTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 14, 2)
)
if mibBuilder.loadTexts:
    trunkTable.setStatus("current")
_TrunkEntry_Object = MibTableRow
trunkEntry = _TrunkEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 14, 2, 1)
)
trunkEntry.setIndexNames(
    (0, "MOXA-PT7528V2-MIB", "trunkIndex"),
    (0, "MOXA-PT7528V2-MIB", "trunkPort"),
)
if mibBuilder.loadTexts:
...
trunkIndex = _TrunkIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 14, 2, 1, 1),
    _TrunkIndex_Type()
)
...
trunkPort = _TrunkPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 14, 2, 1, 2),
    _TrunkPort_Type()
)
...
trunkStatus = _TrunkStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 14, 2, 1, 3),
    _TrunkStatus_Type()
)
...
class _TrunkHashMode_Type(Integer32):
    """Custom type trunkHashMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_TrunkHashMode_Type.__name__ = "Integer32"
_TrunkHashMode_Object = MibScalar
trunkHashMode = _TrunkHashMode_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 14, 3),
    _TrunkHashMode_Type()
)
trunkHashMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    trunkHashMode.setStatus("current")
_CommRedundancy_ObjectIdentity = ObjectIdentity
commRedundancy = _CommRedundancy_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16)
)
...
turboRingMaster = _TurboRingMaster_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 1),
...
turboRingMasterSetup = _TurboRingMasterSetup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 2),
...
turboRingPortIndex = _TurboRingPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 3, 1, 1),
...
turboRingPortStatus = _TurboRingPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 3, 1, 2),
...
turboRingPortDesignatedBridge = _TurboRingPortDesignatedBridge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 3, 1, 3),
...
turboRingPortDesignatedPort = _TurboRingPortDesignatedPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 3, 1, 4),
...
turboRingDesignatedMaster = _TurboRingDesignatedMaster_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 6),
...
turboRingRdntPort1 = _TurboRingRdntPort1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 7),
...
turboRingRdntPort2 = _TurboRingRdntPort2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 8),
...
turboRingEnableCoupling = _TurboRingEnableCoupling_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 9),
...
turboRingCouplingPort = _TurboRingCouplingPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 10),
...
turboRingCouplingPortStatus = _TurboRingCouplingPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 11),
...
turboRingControlPort = _TurboRingControlPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 12),
...
turboRingControlPortStatus = _TurboRingControlPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 13),
...
turboRingBrokenStatus = _TurboRingBrokenStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 2, 14),
...
spanningTreeRoot = _SpanningTreeRoot_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 3, 1),
...
spanningTreeBridgePriority = _SpanningTreeBridgePriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 3, 2),
...
spanningTreeHelloTime = _SpanningTreeHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 3, 3),
...
spanningTreeMaxAge = _SpanningTreeMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 3, 4),
...
spanningTreeForwardingDelay = _SpanningTreeForwardingDelay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 3, 5),
...
spanningTreeIndex = _SpanningTreeIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 3, 6, 1, 1),
...
enableSpanningTree = _EnableSpanningTree_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 3, 6, 1, 2),
...
spanningTreePortPriority = _SpanningTreePortPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 3, 6, 1, 3),
...
spanningTreePortCost = _SpanningTreePortCost_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 3, 6, 1, 4),
...
spanningTreePortStatus = _SpanningTreePortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 3, 6, 1, 5),
...
spanningTreePortEdge = _SpanningTreePortEdge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 3, 6, 1, 6),
...
ringIndexRing1 = _RingIndexRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 1, 1),
...
ringEnableRing1 = _RingEnableRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 1, 2),
...
masterSetupRing1 = _MasterSetupRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 1, 3),
...
masterStatusRing1 = _MasterStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 1, 4),
...
designatedMasterRing1 = _DesignatedMasterRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 1, 5),
...
rdnt1stPortRing1 = _Rdnt1stPortRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 1, 6),
...
rdnt1stPortStatusRing1 = _Rdnt1stPortStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 1, 7),
...
rdnt2ndPortRing1 = _Rdnt2ndPortRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 1, 8),
...
rdnt2ndPortStatusRing1 = _Rdnt2ndPortStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 1, 9),
...
brokenStatusRing1 = _BrokenStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 1, 10),
...
turboRingV2Ring2 = _TurboRingV2Ring2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 2)
)
...
ringIndexRing2 = _RingIndexRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 2, 1),
...
ringEnableRing2 = _RingEnableRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 2, 2),
...
masterSetupRing2 = _MasterSetupRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 2, 3),
...
masterStatusRing2 = _MasterStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 2, 4),
...
designatedMasterRing2 = _DesignatedMasterRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 2, 5),
...
rdnt1stPortRing2 = _Rdnt1stPortRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 2, 6),
...
rdnt1stPortStatusRing2 = _Rdnt1stPortStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 2, 7),
...
rdnt2ndPortRing2 = _Rdnt2ndPortRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 2, 8),
...
rdnt2ndPortStatusRing2 = _Rdnt2ndPortStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 2, 9),
...
brokenStatusRing2 = _BrokenStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 2, 10),
...
turboRingV2Coupling = _TurboRingV2Coupling_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 3)
)
...
couplingEnable = _CouplingEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 3, 1),
...
couplingMode = _CouplingMode_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 3, 2),
    _CouplingMode_Type()
)
...
coupling1stPort = _Coupling1stPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 3, 3),
...
coupling1stPortStatus = _Coupling1stPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 3, 4),
...
coupling2ndPort = _Coupling2ndPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 3, 5),
...
coupling2ndPortStatus = _Coupling2ndPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 5, 3, 6),
...
turboChainRole = _TurboChainRole_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 6, 1),
...
turboChainPort1 = _TurboChainPort1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 6, 2),
...
turboChainPort2 = _TurboChainPort2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 6, 3),
...
turboChainPort1Status = _TurboChainPort1Status_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 6, 4),
...
turboChainPort2Status = _TurboChainPort2Status_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 6, 5),
...
turboChainPort1PartnerBridge = _TurboChainPort1PartnerBridge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 6, 6),
...
turboChainPort2PartnerBridge = _TurboChainPort2PartnerBridge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 16, 6, 7),
...
relayAlarmIndex = _RelayAlarmIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 11, 1, 1),
...
relayWarningRelayContact = _RelayWarningRelayContact_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 11, 1, 2),
...
overrideRelayWarningSetting = _OverrideRelayWarningSetting_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 11, 1, 3),
...
relayWarningPower1Off = _RelayWarningPower1Off_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 11, 1, 4),
...
relayWarningPower1OffStatus = _RelayWarningPower1OffStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 11, 1, 5),
...
relayWarningPower2Off = _RelayWarningPower2Off_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 11, 1, 6),
...
relayWarningPower2OffStatus = _RelayWarningPower2OffStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 11, 1, 7),
...
relayWarningTurboRingBreak = _RelayWarningTurboRingBreak_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 11, 1, 8),
...
relayWarningTurboRingBreakStatus = _RelayWarningTurboRingBreakStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 11, 1, 9),
...
class _RelayWarningFiberCheck_Type(Integer32):
    """Custom type relayWarningFiberCheck based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_RelayWarningFiberCheck_Type.__name__ = "Integer32"
_RelayWarningFiberCheck_Object = MibTableColumn
relayWarningFiberCheck = _RelayWarningFiberCheck_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 11, 1, 10),
    _RelayWarningFiberCheck_Type()
)
relayWarningFiberCheck.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    relayWarningFiberCheck.setStatus("current")


class _RelayWarningFiberCheckStatus_Type(Integer32):
    """Custom type relayWarningFiberCheckStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_RelayWarningFiberCheckStatus_Type.__name__ = "Integer32"
_RelayWarningFiberCheckStatus_Object = MibTableColumn
relayWarningFiberCheckStatus = _RelayWarningFiberCheckStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 11, 1, 11),
    _RelayWarningFiberCheckStatus_Type()
)
relayWarningFiberCheckStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    relayWarningFiberCheckStatus.setStatus("current")
_PortRelayWarningTable_Object = MibTable
portRelayWarningTable = _PortRelayWarningTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 12)
)
if mibBuilder.loadTexts:
...
portRelayWarningEntry = _PortRelayWarningEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 12, 1)
)
...
relayWarningLinkChanged = _RelayWarningLinkChanged_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 12, 1, 1),
...
relayWarningLinkChangedStatus = _RelayWarningLinkChangedStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 12, 1, 2),
...
relayWarningTrafficOverload = _RelayWarningTrafficOverload_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 12, 1, 3),
...
relayWarningTrafficOverloadStatus = _RelayWarningTrafficOverloadStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 12, 1, 4),
...
relayWarningRxTrafficThreshold = _RelayWarningRxTrafficThreshold_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 12, 1, 5),
...
relayWarningTrafficDuration = _RelayWarningTrafficDuration_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 17, 12, 1, 6),
...
queuingMechanism = _QueuingMechanism_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 1, 1),
...
inspectTos = _InspectTos_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 1, 2, 1, 1),
    _InspectTos_Type()
)
...
inspectCos = _InspectCos_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 1, 2, 1, 2),
    _InspectCos_Type()
)
...
portPriority = _PortPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 1, 2, 1, 3),
    _PortPriority_Type()
)
...
cosTag = _CosTag_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 2, 1, 1, 1),
    _CosTag_Type()
)
...
cosMappedPriority = _CosMappedPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 2, 1, 1, 2),
...
tosClass = _TosClass_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 3, 1, 1, 1),
    _TosClass_Type()
)
...
tosMappedPriority = _TosMappedPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 3, 1, 1, 2),
    _TosMappedPriority_Type()
)
tosMappedPriority.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tosMappedPriority.setStatus("current")
_Iec61850Qos_ObjectIdentity = ObjectIdentity
iec61850Qos = _Iec61850Qos_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 4)
)


class _Iec61850QosEnable_Type(Integer32):
    """Custom type iec61850QosEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_Iec61850QosEnable_Type.__name__ = "Integer32"
_Iec61850QosEnable_Object = MibScalar
iec61850QosEnable = _Iec61850QosEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 4, 1),
    _Iec61850QosEnable_Type()
)
iec61850QosEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    iec61850QosEnable.setStatus("current")


class _Iec61850QosGoosePkt_Type(Integer32):
    """Custom type iec61850QosGoosePkt based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_Iec61850QosGoosePkt_Type.__name__ = "Integer32"
_Iec61850QosGoosePkt_Object = MibScalar
iec61850QosGoosePkt = _Iec61850QosGoosePkt_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 4, 2),
    _Iec61850QosGoosePkt_Type()
)
iec61850QosGoosePkt.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    iec61850QosGoosePkt.setStatus("current")


class _Iec61850QosSmvPkt_Type(Integer32):
    """Custom type iec61850QosSmvPkt based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_Iec61850QosSmvPkt_Type.__name__ = "Integer32"
_Iec61850QosSmvPkt_Object = MibScalar
iec61850QosSmvPkt = _Iec61850QosSmvPkt_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 18, 4, 3),
    _Iec61850QosSmvPkt_Type()
)
iec61850QosSmvPkt.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    iec61850QosSmvPkt.setStatus("current")
_Vlan_ObjectIdentity = ObjectIdentity
vlan = _Vlan_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19)
)
_VlanPortSettingTable_Object = MibTable
vlanPortSettingTable = _VlanPortSettingTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 1)
)
if mibBuilder.loadTexts:
...
vlanPortSettingEntry = _VlanPortSettingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 1, 1)
)
...
portVlanType = _PortVlanType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 1, 1, 1),
    _PortVlanType_Type()
)
...
portDefaultVid = _PortDefaultVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 1, 1, 2),
...
portFixedVid = _PortFixedVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 1, 1, 3),
    _PortFixedVid_Type()
)
...
portForbiddenVid = _PortForbiddenVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 1, 1, 4),
...
portFixedVidUntag = _PortFixedVidUntag_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 1, 1, 5),
...
vlanId = _VlanId_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 2, 1, 1),
    _VlanId_Type()
)
...
joinedAccessPorts = _JoinedAccessPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 2, 1, 2),
...
joinedTrunkPorts = _JoinedTrunkPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 2, 1, 3),
...
joinedHybridPorts = _JoinedHybridPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 2, 1, 4),
...
portbaseVlanSettingEntry = _PortbaseVlanSettingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 5, 1)
)
portbaseVlanSettingEntry.setIndexNames(
    (0, "MOXA-PT7528V2-MIB", "portbaseVlanSettingIndex"),
)
if mibBuilder.loadTexts:
...
portbaseVlanSettingIndex = _PortbaseVlanSettingIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 5, 1, 1),
...
portbaseVlanMemberPorts = _PortbaseVlanMemberPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 19, 5, 1, 2),
...
querierQueryInterval = _QuerierQueryInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 1, 1),
...
igmpSnoopingSettingTable = _IgmpSnoopingSettingTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 1, 2)
)
if mibBuilder.loadTexts:
...
igmpSnoopingSettingEntry = _IgmpSnoopingSettingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 1, 2, 1)
)
...
enableIgmpSnooping = _EnableIgmpSnooping_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 1, 2, 1, 1),
...
enableQuerier = _EnableQuerier_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 1, 2, 1, 2),
    _EnableQuerier_Type()
)
...
fixedMulticastQuerierPorts = _FixedMulticastQuerierPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 1, 2, 1, 3),
...
learnedMulticastQuerierPorts = _LearnedMulticastQuerierPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 1, 2, 1, 4),
...
enableGlobalIgmpSnooping = _EnableGlobalIgmpSnooping_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 1, 4),
...
staticMulticastEntry = _StaticMulticastEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 2, 1, 1)
)
staticMulticastEntry.setIndexNames(
    (0, "MOXA-PT7528V2-MIB", "staticMulticastAddress"),
)
if mibBuilder.loadTexts:
...
staticMulticastAddress = _StaticMulticastAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 2, 1, 1, 1),
...
staticMulticastPorts = _StaticMulticastPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 2, 1, 1, 2),
...
staticMulticastStatus = _StaticMulticastStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 2, 1, 1, 3),
...
enableGMRP = _EnableGMRP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 3, 1, 1, 1),
    _EnableGMRP_Type()
)
...
gmrpMulticastGroup = _GmrpMulticastGroup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 3, 2, 1, 1),
...
gmrpFixedPorts = _GmrpFixedPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 3, 2, 1, 2),
...
gmrpLearnedPorts = _GmrpLearnedPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 3, 2, 1, 3),
...
filterBehavior = _FilterBehavior_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 4, 1, 1, 1),
...
class _McastSrcPass_Type(Integer32):
    """Custom type mcastSrcPass based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_McastSrcPass_Type.__name__ = "Integer32"
_McastSrcPass_Object = MibScalar
mcastSrcPass = _McastSrcPass_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 20, 6),
    _McastSrcPass_Type()
)
mcastSrcPass.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    mcastSrcPass.setStatus("current")
_RateLimiting_ObjectIdentity = ObjectIdentity
rateLimiting = _RateLimiting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21)
)
_NormalModeRateLimitingTable_Object = MibTable
normalModeRateLimitingTable = _NormalModeRateLimitingTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 1)
)
if mibBuilder.loadTexts:
...
normalModeRateLimitingEntry = _NormalModeRateLimitingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 1, 1)
)
...
ingressLimitRate = _IngressLimitRate_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 1, 1, 1),
...
egressLimit = _EgressLimit_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 1, 1, 2),
    _EgressLimit_Type()
)
...
enableBcastStormProtection = _EnableBcastStormProtection_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 2, 1),
...
bcastStormIncludeMcast = _BcastStormIncludeMcast_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 2, 2),
...
bcastStormIncludeUnkonwnMcastUcast = _BcastStormIncludeUnkonwnMcastUcast_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 2, 3),
...
unicastFilterBehavior = _UnicastFilterBehavior_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 2, 4)
)
...
ufbIncludeUnkonwnUcast = _UfbIncludeUnkonwnUcast_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 2, 4, 1),
...
class _BcastStormProtectionRateLimit_Type(Integer32):
    """Custom type bcastStormProtectionRateLimit based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_BcastStormProtectionRateLimit_Type.__name__ = "Integer32"
_BcastStormProtectionRateLimit_Object = MibScalar
bcastStormProtectionRateLimit = _BcastStormProtectionRateLimit_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 2, 5),
    _BcastStormProtectionRateLimit_Type()
)
bcastStormProtectionRateLimit.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    bcastStormProtectionRateLimit.setStatus("current")
_PortDisableMode_ObjectIdentity = ObjectIdentity
portDisableMode = _PortDisableMode_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 3)
)
...
portDisableModePeriod = _PortDisableModePeriod_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 3, 1),
...
portDisableModeTable = _PortDisableModeTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 3, 2)
)
if mibBuilder.loadTexts:
...
portDisableModeEntry = _PortDisableModeEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 3, 2, 1)
)
...
ingressLimit = _IngressLimit_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 21, 3, 2, 1, 1),
    _IngressLimit_Type()
)
...
userLoginServer = _UserLoginServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 1),
...
tacacsServerSetting = _TacacsServerSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 2)
)
...
tacacsLoginAuthServer = _TacacsLoginAuthServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 2, 1),
...
tacacsLoginAuthPort = _TacacsLoginAuthPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 2, 2),
...
tacacsLoginAuthSharedKey = _TacacsLoginAuthSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 2, 3),
...
tacacsLoginAuthAuthType = _TacacsLoginAuthAuthType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 2, 4),
...
tacacsLoginAuthTimeout = _TacacsLoginAuthTimeout_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 2, 5),
...
radiusServerSetting = _RadiusServerSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 3)
)
...
radiusLoginAuthServer = _RadiusLoginAuthServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 3, 1),
...
radiusLoginAuthPort = _RadiusLoginAuthPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 3, 2),
...
radiusLoginAuthSharedKey = _RadiusLoginAuthSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 3, 3),
...
radiusLoginAuthAuthType = _RadiusLoginAuthAuthType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 3, 4),
...
radiusLoginAuthTimeout = _RadiusLoginAuthTimeout_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 1, 3, 5),
...
staticPortLockAddress = _StaticPortLockAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 1, 1),
...
staticPortLockPort = _StaticPortLockPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 1, 2),
...
staticPortLockStatus = _StaticPortLockStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 1, 3),
...
dot1x = _Dot1x_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2)
)
...
dataBaseOption = _DataBaseOption_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 1),
...
dot1xReauthEnable = _Dot1xReauthEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 5),
...
dot1xReauthPeriod = _Dot1xReauthPeriod_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 6),
...
enableDot1X = _EnableDot1X_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 7, 1, 1),
    _EnableDot1X_Type()
)
...
dot1xReauthPortIndex = _Dot1xReauthPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 8, 1, 1),
...
dot1xReauth = _Dot1xReauth_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 8, 1, 2),
    _Dot1xReauth_Type()
)
...
dot1xRadius = _Dot1xRadius_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 9)
)
...
dot1xSameAsAuthServer = _Dot1xSameAsAuthServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 9, 1),
...
dot1x1stRadiusServer = _Dot1x1stRadiusServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 9, 2),
...
dot1x1stRadiusPort = _Dot1x1stRadiusPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 9, 3),
...
dot1x1stRadiusSharedKey = _Dot1x1stRadiusSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 9, 4),
...
dot1x2ndRadiusServer = _Dot1x2ndRadiusServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 9, 5),
...
dot1x2ndRadiusPort = _Dot1x2ndRadiusPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 9, 6),
...
dot1x2ndRadiusSharedKey = _Dot1x2ndRadiusSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 2, 9, 7),
...
portAccessControlTable = _PortAccessControlTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 3)
)
if mibBuilder.loadTexts:
...
portAccessControlEntry = _PortAccessControlEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 3, 1)
)
portAccessControlEntry.setIndexNames(
    (0, "MOXA-PT7528V2-MIB", "portAccessControlAddress"),
)
if mibBuilder.loadTexts:
...
portAccessControlAddress = _PortAccessControlAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 3, 1, 1),
...
portAccessControlPortNo = _PortAccessControlPortNo_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 3, 1, 2),
...
portAccessControlAccessStatus = _PortAccessControlAccessStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 3, 1, 3),
...
portAccessControlStatus = _PortAccessControlStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 22, 2, 3, 1, 4),
...
accessibleIpAddress = _AccessibleIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 30, 2, 1, 1),
...
accessibleIpNetMask = _AccessibleIpNetMask_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 30, 2, 1, 2),
...
accessibleIpStatus = _AccessibleIpStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 30, 2, 1, 3),
...
startMonth = _StartMonth_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 32, 5, 1),
    _StartMonth_Type()
)
...
startWeek = _StartWeek_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 32, 5, 2),
    _StartWeek_Type()
)
...
startDay = _StartDay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 32, 5, 3),
    _StartDay_Type()
)
...
startHour = _StartHour_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 32, 5, 4),
    _StartHour_Type()
)
...
endMonth = _EndMonth_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 32, 5, 5),
    _EndMonth_Type()
)
...
endWeek = _EndWeek_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 32, 5, 6),
    _EndWeek_Type()
)
...
endDay = _EndDay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 32, 5, 7),
    _EndDay_Type()
)
...
endHour = _EndHour_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 32, 5, 8),
    _EndHour_Type()
)
...
offsetHours = _OffsetHours_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 32, 5, 9),
    _OffsetHours_Type()
)
...
class _TimeProtocolOption_Type(Integer32):
    """Custom type timeProtocolOption based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TimeProtocolOption_Type.__name__ = "Integer32"
_TimeProtocolOption_Object = MibScalar
timeProtocolOption = _TimeProtocolOption_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 32, 7),
    _TimeProtocolOption_Type()
)
timeProtocolOption.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    timeProtocolOption.setStatus("current")
_BackupMediaSetting_ObjectIdentity = ObjectIdentity
backupMediaSetting = _BackupMediaSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 35)
)


class _BackupMediaAutoLoad_Type(Integer32):
    """Custom type backupMediaAutoLoad based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_BackupMediaAutoLoad_Type.__name__ = "Integer32"
_BackupMediaAutoLoad_Object = MibScalar
backupMediaAutoLoad = _BackupMediaAutoLoad_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 35, 1),
    _BackupMediaAutoLoad_Type()
)
backupMediaAutoLoad.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    backupMediaAutoLoad.setStatus("current")
...
enableOption82 = _EnableOption82_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 39, 5, 1),
...
option82Type = _Option82Type_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 39, 5, 2),
    _Option82Type_Type()
)
...
option82Value = _Option82Value_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 39, 5, 3),
    _Option82Value_Type()
)
...
option82ValueDisplay = _Option82ValueDisplay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 39, 5, 4),
...
dhcpPortIndex = _DhcpPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 39, 6, 1, 1),
    _DhcpPortIndex_Type()
)
...
circuitID = _CircuitID_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 39, 6, 1, 2),
    _CircuitID_Type()
)
...
option82Enable = _Option82Enable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 39, 6, 1, 3),
...
enablePtpv1 = _EnablePtpv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 1, 1),
    _EnablePtpv1_Type()
)
...
clockModev1 = _ClockModev1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 1, 2),
    _ClockModev1_Type()
)
...
syncIntervalv1 = _SyncIntervalv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 1, 3),
...
subDomainNamev1 = _SubDomainNamev1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 1, 4),
...
preferMasterv1 = _PreferMasterv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 1, 5),
...
enablePtp = _EnablePtp_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 1),
    _EnablePtp_Type()
)
...
clockMode = _ClockMode_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 2),
    _ClockMode_Type()
)
...
transport = _Transport_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 3),
    _Transport_Type()
)
...
syncInterval = _SyncInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 4),
    _SyncInterval_Type()
)
...
logMinDelayReqInterval = _LogMinDelayReqInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 5),
...
logMinPdelayReqInterval = _LogMinPdelayReqInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 6),
...
logAnnounceInterval = _LogAnnounceInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 7),
...
announceReceiptTimeout = _AnnounceReceiptTimeout_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 8),
...
priority1 = _Priority1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 9),
    _Priority1_Type()
)
...
priority2 = _Priority2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 10),
    _Priority2_Type()
)
...
clockClass = _ClockClass_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 11),
    _ClockClass_Type()
)
...
domainNumber = _DomainNumber_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 12),
    _DomainNumber_Type()
)
...
localUtcOffset = _LocalUtcOffset_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 13),
...
localUtcOffsetValid = _LocalUtcOffsetValid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 14),
...
localLeap59 = _LocalLeap59_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 15),
    _LocalLeap59_Type()
)
...
localLeap61 = _LocalLeap61_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 16),
    _LocalLeap61_Type()
)
...
localPtpTimescale = _LocalPtpTimescale_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 17),
...
localArbTime = _LocalArbTime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 2, 18),
    _LocalArbTime_Type()
)
...
meanPathDelayv1 = _MeanPathDelayv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 3, 2),
...
grandMasterUuidv1 = _GrandMasterUuidv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 3, 3),
...
parentUuidv1 = _ParentUuidv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 3, 4),
    _ParentUuidv1_Type()
)
...
clockStratumv1 = _ClockStratumv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 3, 5),
...
clockIdentifierv1 = _ClockIdentifierv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 3, 6),
...
meanPathDelay = _MeanPathDelay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 2),
    _MeanPathDelay_Type()
)
...
parentIdentity = _ParentIdentity_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 3),
...
grandmasterIdentity = _GrandmasterIdentity_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 4),
...
grandmasterClockClass = _GrandmasterClockClass_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 5),
...
grandmasterClockAccuracy = _GrandmasterClockAccuracy_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 6),
...
grandmasterPriority1 = _GrandmasterPriority1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 7),
...
grandmasterPriority2 = _GrandmasterPriority2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 8),
...
stepsRemoved = _StepsRemoved_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 9),
    _StepsRemoved_Type()
)
...
currentUtcOffset = _CurrentUtcOffset_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 10),
...
currentUtcOffsetValid = _CurrentUtcOffsetValid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 11),
...
leap59 = _Leap59_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 12),
    _Leap59_Type()
)
...
leap61 = _Leap61_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 13),
    _Leap61_Type()
)
...
ptpTimescale = _PtpTimescale_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 14),
    _PtpTimescale_Type()
)
...
timesource = _Timesource_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 4, 15),
    _Timesource_Type()
)
...
ptpPortIndex = _PtpPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 5, 1, 1),
    _PtpPortIndex_Type()
)
...
ptpPortEnable = _PtpPortEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 5, 1, 2),
    _PtpPortEnable_Type()
)
...
ptpPortStatus = _PtpPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 41, 5, 1, 3),
    _PtpPortStatus_Type()
)
...
enableLLDP = _EnableLLDP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 42, 1, 1),
    _EnableLLDP_Type()
)
...
lldpMSGInterval = _LldpMSGInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 42, 1, 2),
...
eventlogIndex = _EventlogIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 46, 1, 1, 1),
    _EventlogIndex_Type()
)
...
eventlogBootup = _EventlogBootup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 46, 1, 1, 2),
...
eventlogDate = _EventlogDate_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 46, 1, 1, 3),
    _EventlogDate_Type()
)
...
eventlogTime = _EventlogTime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 46, 1, 1, 4),
    _EventlogTime_Type()
)
...
eventlogUptime = _EventlogUptime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 46, 1, 1, 5),
...
eventlogEvent = _EventlogEvent_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 46, 1, 1, 6),
    _EventlogEvent_Type()
)
...
enableEtherNetIP = _EnableEtherNetIP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 47, 1, 1),
...
enableModbusTCP = _EnableModbusTCP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 47, 2, 1),
    _EnableModbusTCP_Type()
)
enableModbusTCP.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    enableModbusTCP.setStatus("current")
_MmsDedicatedPortTable_Object = MibTable
mmsDedicatedPortTable = _MmsDedicatedPortTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 47, 4)
)
if mibBuilder.loadTexts:
    mmsDedicatedPortTable.setStatus("current")
_MmsDedicatedPortEntry_Object = MibTableRow
mmsDedicatedPortEntry = _MmsDedicatedPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 47, 4, 1)
)
mmsDedicatedPortEntry.setIndexNames(
    (0, "MOXA-PT7528V2-MIB", "portIndex"),
)
if mibBuilder.loadTexts:
    mmsDedicatedPortEntry.setStatus("current")


class _DedicatedPortEnable_Type(Integer32):
    """Custom type dedicatedPortEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_DedicatedPortEnable_Type.__name__ = "Integer32"
_DedicatedPortEnable_Object = MibTableColumn
dedicatedPortEnable = _DedicatedPortEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 47, 4, 1, 1),
    _DedicatedPortEnable_Type()
)
dedicatedPortEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    dedicatedPortEnable.setStatus("current")
...
class _JumboFrameEnable_Type(Integer32):
    """Custom type jumboFrameEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_JumboFrameEnable_Type.__name__ = "Integer32"
_JumboFrameEnable_Object = MibScalar
jumboFrameEnable = _JumboFrameEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 49),
    _JumboFrameEnable_Type()
)
jumboFrameEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    jumboFrameEnable.setStatus("current")
...
class _EnableLEDPanel_Type(Integer32):
    """Custom type enableLEDPanel based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_EnableLEDPanel_Type.__name__ = "Integer32"
_EnableLEDPanel_Object = MibScalar
enableLEDPanel = _EnableLEDPanel_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 1, 70),
    _EnableLEDPanel_Type()
)
enableLEDPanel.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    enableLEDPanel.setStatus("current")
_SwTraps_ObjectIdentity = ObjectIdentity
swTraps = _SwTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 2)
)
...
_VarFiberWarningTrap_ObjectIdentity = ObjectIdentity
varFiberWarningTrap = _VarFiberWarningTrap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 2, 28)
)


class _VarFiberWarningTypeTrap_Type(Integer32):
    """Custom type varFiberWarningTypeTrap based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_VarFiberWarningTypeTrap_Type.__name__ = "Integer32"
_VarFiberWarningTypeTrap_Object = MibScalar
varFiberWarningTypeTrap = _VarFiberWarningTypeTrap_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 2, 28, 1),
    _VarFiberWarningTypeTrap_Type()
)
varFiberWarningTypeTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    varFiberWarningTypeTrap.setStatus("current")


class _VarFiberWarningPortTrap_Type(Integer32):
    """Custom type varFiberWarningPortTrap based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_VarFiberWarningPortTrap_Type.__name__ = "Integer32"
_VarFiberWarningPortTrap_Object = MibScalar
varFiberWarningPortTrap = _VarFiberWarningPortTrap_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 2, 28, 2),
    _VarFiberWarningPortTrap_Type()
)
varFiberWarningPortTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    varFiberWarningPortTrap.setStatus("current")
...
configChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 0, 1)
)
configChangeTrap.setObjects(
    ("MOXA-PT7528V2-MIB", "varconfigChangeTrap")
)
if mibBuilder.loadTexts:
...
power1Trap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 0, 2)
)
power1Trap.setObjects(
    ("MOXA-PT7528V2-MIB", "varpower1Trap")
)
if mibBuilder.loadTexts:
...
power2Trap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 0, 3)
)
power2Trap.setObjects(
    ("MOXA-PT7528V2-MIB", "varpower2Trap")
)
if mibBuilder.loadTexts:
...
trafficOverloadTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 0, 4)
)
trafficOverloadTrap.setObjects(
    ("MOXA-PT7528V2-MIB", "vartrafficOverloadTrap")
)
if mibBuilder.loadTexts:
...
redundancyTopologyChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 0, 5)
)
redundancyTopologyChangedTrap.setObjects(
    ("MOXA-PT7528V2-MIB", "varredundancyTopologyChangedTrap")
)
if mibBuilder.loadTexts:
...
turboRingCouplingPortChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 0, 6)
)
turboRingCouplingPortChangedTrap.setObjects(
    ("MOXA-PT7528V2-MIB", "varturboRingCouplingPortChangedTrap")
)
if mibBuilder.loadTexts:
...
turboRingMasterChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 0, 7)
)
turboRingMasterChangedTrap.setObjects(
    ("MOXA-PT7528V2-MIB", "varturboRingMasterChangedTrap")
)
if mibBuilder.loadTexts:
...
fiberWarningTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 85, 0, 16)
)
fiberWarningTrap.setObjects(
      *(("MOXA-PT7528V2-MIB", "varFiberWarningTypeTrap"),
        ("MOXA-PT7528V2-MIB", "varFiberWarningPortTrap"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"PortList": PortList,
       ...
       "fiberTransciever": fiberTransciever,
       "fiberTxBiasCurrent": fiberTxBiasCurrent,
       ...
       "emailWarningEventTopologyChanged": emailWarningEventTopologyChanged,
       "emailWarningEventFiberWarning": emailWarningEventFiberWarning,
       ...
       "emailWarningEventPortRxTrafficThreshold": emailWarningEventPortRxTrafficThreshold,
       ...
       "targetPortEnable": targetPortEnable,
       ...
       "relayWarningFiberCheck": relayWarningFiberCheck,
       "relayWarningFiberCheckStatus": relayWarningFiberCheckStatus,
       ...
       "iec61850Qos": iec61850Qos,
       "iec61850QosEnable": iec61850QosEnable,
       "iec61850QosGoosePkt": iec61850QosGoosePkt,
       "iec61850QosSmvPkt": iec61850QosSmvPkt,
       "vlan": vlan,
       ...
       "bcastStormProtectionRateLimit": bcastStormProtectionRateLimit,
       ...
       "timeProtocolOption": timeProtocolOption,
       "backupMediaSetting": backupMediaSetting,
       "backupMediaAutoLoad": backupMediaAutoLoad,
       ...
       "mmsDedicatedPortTable": mmsDedicatedPortTable,
       "mmsDedicatedPortEntry": mmsDedicatedPortEntry,
       "dedicatedPortEnable": dedicatedPortEnable,
       "enableFactoryDefault": enableFactoryDefault,
       "jumboFrameEnable": jumboFrameEnable,
       ...
       "varFiberWarningTypeTrap": varFiberWarningTypeTrap,
       "varFiberWarningPortTrap": varFiberWarningPortTrap}
)
