# SNMP MIB module (MOXA-EDS510E-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\moxa\MOXA-EDS510E-MIB
...
eds510e = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84)
)
if mibBuilder.loadTexts:
    eds510e.setRevisions(
        ("2024-04-11 00:00",
         "2024-03-12 00:00",
         "2022-05-13 00:00",
         "2020-12-08 00:00",
...
portIndex = _PortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 9, 1, 1, 1),
    _PortIndex_Type()
)
...
portDesc = _PortDesc_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 9, 1, 1, 2),
    _PortDesc_Type()
)
...
portEnable = _PortEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 9, 1, 1, 3),
    _PortEnable_Type()
)
...
portSpeed = _PortSpeed_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 9, 1, 1, 4),
    _PortSpeed_Type()
)
...
portMDI = _PortMDI_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 9, 1, 1, 5),
    _PortMDI_Type()
)
...
portFDXFlowCtrl = _PortFDXFlowCtrl_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 9, 1, 1, 6),
...
portName = _PortName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 9, 1, 1, 7),
    _PortName_Type()
)
...
portSubdesc = _PortSubdesc_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 9, 1, 1, 8),
    _PortSubdesc_Type()
)
...
class _PortLinkDownDisable_Type(Integer32):
    """Custom type portLinkDownDisable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_PortLinkDownDisable_Type.__name__ = "Integer32"
_PortLinkDownDisable_Object = MibTableColumn
portLinkDownDisable = _PortLinkDownDisable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 9, 1, 1, 9),
    _PortLinkDownDisable_Type()
)
portLinkDownDisable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    portLinkDownDisable.setStatus("current")
_Monitor_ObjectIdentity = ObjectIdentity
monitor = _Monitor_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10)
)
...
monitorLinkStatus = _MonitorLinkStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 3, 1, 2),
...
monitorSpeed = _MonitorSpeed_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 3, 1, 3),
    _MonitorSpeed_Type()
)
...
monitorAutoMDI = _MonitorAutoMDI_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 3, 1, 4),
...
monitorTraffic = _MonitorTraffic_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 3, 1, 5),
...
monitorFDXFlowCtrl = _MonitorFDXFlowCtrl_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 3, 1, 6),
...
monitorTxTraffic = _MonitorTxTraffic_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 3, 1, 7),
...
monitorRxTraffic = _MonitorRxTraffic_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 3, 1, 8),
...
diIndex = _DiIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 4, 1, 1),
    _DiIndex_Type()
)
...
diInputStatus = _DiInputStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 4, 1, 2),
    _DiInputStatus_Type()
)
...
monitorFiberCheckEntry = _MonitorFiberCheckEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1)
)
...
fiberPort = _FiberPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1, 1),
    _FiberPort_Type()
)
...
fiberModelName = _FiberModelName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1, 2),
...
fiberWaveLength = _FiberWaveLength_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1, 3),
...
fiberVoltage = _FiberVoltage_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1, 4),
    _FiberVoltage_Type()
)
...
fiberTemperature = _FiberTemperature_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1, 5),
...
fiberTempWarn = _FiberTempWarn_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1, 6),
    _FiberTempWarn_Type()
)
...
fiberTxPower = _FiberTxPower_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1, 7),
    _FiberTxPower_Type()
)
...
fiberTxPowerWarn = _FiberTxPowerWarn_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1, 8),
...
fiberRxPower = _FiberRxPower_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1, 9),
    _FiberRxPower_Type()
)
...
fiberRxPowerWarn = _FiberRxPowerWarn_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1, 10),
...
fiberSN = _FiberSN_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 11, 1, 13),
    _FiberSN_Type()
)
fiberSN.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    fiberSN.setStatus("current")
_MonitorSessionMonitorTable_Object = MibTable
monitorSessionMonitorTable = _MonitorSessionMonitorTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 13)
)
if mibBuilder.loadTexts:
    monitorSessionMonitorTable.setStatus("current")
_MonitorSessionMonitorEntry_Object = MibTableRow
monitorSessionMonitorEntry = _MonitorSessionMonitorEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 13, 1)
)
monitorSessionMonitorEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "portIndex"),
)
if mibBuilder.loadTexts:
    monitorSessionMonitorEntry.setStatus("current")
_SessionID_Type = DisplayString
_SessionID_Object = MibTableColumn
sessionID = _SessionID_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 13, 1, 1),
    _SessionID_Type()
)
...
userName = _UserName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 13, 1, 2),
    _UserName_Type()
)
userName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    userName.setStatus("current")
_LoginType_Type = DisplayString
_LoginType_Object = MibTableColumn
loginType = _LoginType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 13, 1, 3),
    _LoginType_Type()
)
loginType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    loginType.setStatus("current")
_LoginDate_Type = DisplayString
_LoginDate_Object = MibTableColumn
loginDate = _LoginDate_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 13, 1, 4),
    _LoginDate_Type()
)
loginDate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    loginDate.setStatus("current")
_LoginTime_Type = DisplayString
_LoginTime_Object = MibTableColumn
loginTime = _LoginTime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 13, 1, 5),
    _LoginTime_Type()
)
loginTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    loginTime.setStatus("current")
_LoginIP_Type = DisplayString
_LoginIP_Object = MibTableColumn
loginIP = _LoginIP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 10, 13, 1, 6),
    _LoginIP_Type()
)
...
emailWarningSMTPServer = _EmailWarningSMTPServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 11, 1, 1),
...
emailWarningFirstRecipientEmailAddr = _EmailWarningFirstRecipientEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 11, 1, 2),
...
emailWarningSecondRecipientEmailAddr = _EmailWarningSecondRecipientEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 11, 1, 3),
...
emailWarningThirdRecipientEmailAddr = _EmailWarningThirdRecipientEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 11, 1, 4),
...
emailWarningFourthRecipientEmailAddr = _EmailWarningFourthRecipientEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 11, 1, 5),
...
emailWarningSMTPPort = _EmailWarningSMTPPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 11, 1, 6),
...
emailWarningSMTPUser = _EmailWarningSMTPUser_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 11, 1, 7),
...
emailWarningSMTPPassword = _EmailWarningSMTPPassword_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 11, 1, 8),
...
emailWarningSMTPTLS = _EmailWarningSMTPTLS_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 11, 1, 9),
...
emailWarningSMTPAuthMethod = _EmailWarningSMTPAuthMethod_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 11, 1, 10),
...
emailWarningSenderEmailAddr = _EmailWarningSenderEmailAddr_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 11, 1, 11),
...
setDevIpIndex = _SetDevIpIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 12, 1, 1, 1),
    _SetDevIpIndex_Type()
)
...
setDevIpCurrentIpofDevice = _SetDevIpCurrentIpofDevice_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 12, 1, 1, 2),
...
setDevIpPresentBy = _SetDevIpPresentBy_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 12, 1, 1, 3),
...
setDevIpDedicatedIp = _SetDevIpDedicatedIp_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 12, 1, 1, 4),
...
trunkSettingIndex = _TrunkSettingIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 14, 1, 1, 1),
...
trunkType = _TrunkType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 14, 1, 1, 2),
    _TrunkType_Type()
)
...
trunkMemberPorts = _TrunkMemberPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 14, 1, 1, 3),
...
trunkTable = _TrunkTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 14, 2)
)
if mibBuilder.loadTexts:
    trunkTable.setStatus("current")
_TrunkEntry_Object = MibTableRow
trunkEntry = _TrunkEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 14, 2, 1)
)
trunkEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "trunkIndex"),
    (0, "MOXA-EDS510E-MIB", "trunkPort"),
)
if mibBuilder.loadTexts:
...
trunkIndex = _TrunkIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 14, 2, 1, 1),
    _TrunkIndex_Type()
)
...
trunkPort = _TrunkPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 14, 2, 1, 2),
    _TrunkPort_Type()
)
...
trunkStatus = _TrunkStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 14, 2, 1, 3),
    _TrunkStatus_Type()
)
...
turboRingMaster = _TurboRingMaster_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 1),
...
turboRingMasterSetup = _TurboRingMasterSetup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 2),
...
turboRingPortIndex = _TurboRingPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 3, 1, 1),
...
turboRingPortStatus = _TurboRingPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 3, 1, 2),
...
turboRingPortDesignatedBridge = _TurboRingPortDesignatedBridge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 3, 1, 3),
...
turboRingPortDesignatedPort = _TurboRingPortDesignatedPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 3, 1, 4),
...
turboRingDesignatedMaster = _TurboRingDesignatedMaster_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 6),
...
turboRingRdntPort1 = _TurboRingRdntPort1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 7),
...
turboRingRdntPort2 = _TurboRingRdntPort2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 8),
...
turboRingEnableCoupling = _TurboRingEnableCoupling_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 9),
...
turboRingCouplingPort = _TurboRingCouplingPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 10),
...
turboRingCouplingPortStatus = _TurboRingCouplingPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 11),
...
turboRingControlPort = _TurboRingControlPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 12),
...
turboRingControlPortStatus = _TurboRingControlPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 13),
...
turboRingBrokenStatus = _TurboRingBrokenStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 2, 14),
...
spanningTreeRoot = _SpanningTreeRoot_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 3, 1),
...
spanningTreeBridgePriority = _SpanningTreeBridgePriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 3, 2),
...
spanningTreeHelloTime = _SpanningTreeHelloTime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 3, 3),
...
spanningTreeMaxAge = _SpanningTreeMaxAge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 3, 4),
...
spanningTreeForwardingDelay = _SpanningTreeForwardingDelay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 3, 5),
...
spanningTreeIndex = _SpanningTreeIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 3, 6, 1, 1),
...
enableSpanningTree = _EnableSpanningTree_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 3, 6, 1, 2),
...
spanningTreePortPriority = _SpanningTreePortPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 3, 6, 1, 3),
...
spanningTreePortCost = _SpanningTreePortCost_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 3, 6, 1, 4),
...
spanningTreePortStatus = _SpanningTreePortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 3, 6, 1, 5),
...
spanningTreePortEdge = _SpanningTreePortEdge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 3, 6, 1, 6),
...
ringIndexRing1 = _RingIndexRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 1, 1),
...
ringEnableRing1 = _RingEnableRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 1, 2),
...
masterSetupRing1 = _MasterSetupRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 1, 3),
...
masterStatusRing1 = _MasterStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 1, 4),
...
designatedMasterRing1 = _DesignatedMasterRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 1, 5),
...
rdnt1stPortRing1 = _Rdnt1stPortRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 1, 6),
...
rdnt1stPortStatusRing1 = _Rdnt1stPortStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 1, 7),
...
rdnt2ndPortRing1 = _Rdnt2ndPortRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 1, 8),
...
rdnt2ndPortStatusRing1 = _Rdnt2ndPortStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 1, 9),
...
brokenStatusRing1 = _BrokenStatusRing1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 1, 10),
...
turboRingV2Ring2 = _TurboRingV2Ring2_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 2)
)
...
ringIndexRing2 = _RingIndexRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 2, 1),
...
ringEnableRing2 = _RingEnableRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 2, 2),
...
masterSetupRing2 = _MasterSetupRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 2, 3),
...
masterStatusRing2 = _MasterStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 2, 4),
...
designatedMasterRing2 = _DesignatedMasterRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 2, 5),
...
rdnt1stPortRing2 = _Rdnt1stPortRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 2, 6),
...
rdnt1stPortStatusRing2 = _Rdnt1stPortStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 2, 7),
...
rdnt2ndPortRing2 = _Rdnt2ndPortRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 2, 8),
...
rdnt2ndPortStatusRing2 = _Rdnt2ndPortStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 2, 9),
...
brokenStatusRing2 = _BrokenStatusRing2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 2, 10),
...
turboRingV2Coupling = _TurboRingV2Coupling_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 3)
)
...
couplingEnable = _CouplingEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 3, 1),
...
couplingMode = _CouplingMode_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 3, 2),
    _CouplingMode_Type()
)
...
coupling1stPort = _Coupling1stPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 3, 3),
...
coupling1stPortStatus = _Coupling1stPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 3, 4),
...
coupling2ndPort = _Coupling2ndPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 3, 5),
...
coupling2ndPortStatus = _Coupling2ndPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 5, 3, 6),
...
turboChainRole = _TurboChainRole_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 6, 1),
...
turboChainPort1 = _TurboChainPort1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 6, 2),
...
turboChainPort2 = _TurboChainPort2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 6, 3),
...
turboChainPort1Status = _TurboChainPort1Status_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 6, 4),
...
turboChainPort2Status = _TurboChainPort2Status_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 6, 5),
...
turboChainPort1PartnerBridge = _TurboChainPort1PartnerBridge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 6, 6),
...
turboChainPort2PartnerBridge = _TurboChainPort2PartnerBridge_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 16, 6, 7),
...
relayAlarmIndex = _RelayAlarmIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 11, 1, 1),
...
relayWarningRelayContact = _RelayWarningRelayContact_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 11, 1, 2),
...
overrideRelayWarningSetting = _OverrideRelayWarningSetting_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 11, 1, 3),
...
relayWarningPower1Off = _RelayWarningPower1Off_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 11, 1, 4),
...
relayWarningPower1OffStatus = _RelayWarningPower1OffStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 11, 1, 5),
...
relayWarningPower2Off = _RelayWarningPower2Off_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 11, 1, 6),
...
relayWarningPower2OffStatus = _RelayWarningPower2OffStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 11, 1, 7),
...
relayWarningTurboRingBreak = _RelayWarningTurboRingBreak_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 11, 1, 8),
...
relayWarningTurboRingBreakStatus = _RelayWarningTurboRingBreakStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 11, 1, 9),
...
portRelayWarningEntry = _PortRelayWarningEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 12, 1)
)
...
relayWarningLinkChanged = _RelayWarningLinkChanged_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 12, 1, 1),
...
relayWarningLinkChangedStatus = _RelayWarningLinkChangedStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 12, 1, 2),
...
relayWarningTrafficOverload = _RelayWarningTrafficOverload_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 12, 1, 3),
...
relayWarningTrafficOverloadStatus = _RelayWarningTrafficOverloadStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 12, 1, 4),
...
relayWarningRxTrafficThreshold = _RelayWarningRxTrafficThreshold_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 12, 1, 5),
...
relayWarningTrafficDuration = _RelayWarningTrafficDuration_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 12, 1, 6),
...
diRelayWarningEntry = _DiRelayWarningEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 13, 1)
)
...
relayWarningDiInputChanged = _RelayWarningDiInputChanged_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 13, 1, 1),
...
relayWarningDiInputChangedStatus = _RelayWarningDiInputChangedStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 17, 13, 1, 2),
...
schedulingMechanism = _SchedulingMechanism_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 18, 1, 1),
...
dscpInspection = _DscpInspection_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 18, 1, 2, 1, 1),
...
cosInspection = _CosInspection_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 18, 1, 2, 1, 2),
    _CosInspection_Type()
)
...
portPriority = _PortPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 18, 1, 2, 1, 3),
    _PortPriority_Type()
)
...
priorityMappingEntry = _PriorityMappingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 18, 2, 1, 1)
)
priorityMappingEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "priorityTag"),
)
if mibBuilder.loadTexts:
...
priorityTag = _PriorityTag_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 18, 2, 1, 1, 1),
    _PriorityTag_Type()
)
...
priorityMappedQueue = _PriorityMappedQueue_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 18, 2, 1, 1, 2),
...
dscpClass = _DscpClass_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 18, 3, 1, 1, 1),
    _DscpClass_Type()
)
...
dscpMappedPriority = _DscpMappedPriority_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 18, 3, 1, 1, 2),
...
vlanPortSettingEntry = _VlanPortSettingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 1, 1)
)
...
portVlanType = _PortVlanType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 1, 1, 1),
    _PortVlanType_Type()
)
...
portDefaultVid = _PortDefaultVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 1, 1, 2),
...
portFixedVid = _PortFixedVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 1, 1, 3),
    _PortFixedVid_Type()
)
...
portForbiddenVid = _PortForbiddenVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 1, 1, 4),
...
portFixedVidUntag = _PortFixedVidUntag_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 1, 1, 5),
...
vlanId = _VlanId_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 2, 1, 1),
    _VlanId_Type()
)
...
joinedAccessPorts = _JoinedAccessPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 2, 1, 2),
...
joinedTrunkPorts = _JoinedTrunkPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 2, 1, 3),
...
joinedHybridPorts = _JoinedHybridPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 2, 1, 4),
...
vlanName = _VlanName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 2, 1, 5),
    _VlanName_Type()
)
...
portbaseVlanSettingEntry = _PortbaseVlanSettingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 5, 1)
)
portbaseVlanSettingEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "portbaseVlanSettingIndex"),
)
if mibBuilder.loadTexts:
...
portbaseVlanSettingIndex = _PortbaseVlanSettingIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 5, 1, 1),
...
portbaseVlanMemberPorts = _PortbaseVlanMemberPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 19, 5, 1, 2),
...
querierQueryInterval = _QuerierQueryInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 1, 1),
...
igmpSnoopingSettingTable = _IgmpSnoopingSettingTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 1, 2)
)
if mibBuilder.loadTexts:
...
igmpSnoopingSettingEntry = _IgmpSnoopingSettingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 1, 2, 1)
)
...
enableIgmpSnooping = _EnableIgmpSnooping_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 1, 2, 1, 1),
...
enableQuerier = _EnableQuerier_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 1, 2, 1, 2),
    _EnableQuerier_Type()
)
...
fixedMulticastQuerierPorts = _FixedMulticastQuerierPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 1, 2, 1, 3),
...
learnedMulticastQuerierPorts = _LearnedMulticastQuerierPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 1, 2, 1, 4),
...
enableGlobalIgmpSnooping = _EnableGlobalIgmpSnooping_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 1, 4),
...
multicastFastForwarding = _MulticastFastForwarding_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 1, 7),
...
staticMulticastEntry = _StaticMulticastEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 2, 1, 1)
)
staticMulticastEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "staticMulticastAddress"),
)
if mibBuilder.loadTexts:
...
staticMulticastAddress = _StaticMulticastAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 2, 1, 1, 1),
...
staticMulticastPorts = _StaticMulticastPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 2, 1, 1, 2),
...
staticMulticastStatus = _StaticMulticastStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 2, 1, 1, 3),
...
enableGMRP = _EnableGMRP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 3, 1, 1, 1),
    _EnableGMRP_Type()
)
...
gmrpMulticastGroup = _GmrpMulticastGroup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 3, 2, 1, 1),
...
gmrpFixedPorts = _GmrpFixedPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 3, 2, 1, 2),
...
gmrpLearnedPorts = _GmrpLearnedPorts_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 20, 3, 2, 1, 3),
...
droppacketModeRateLimitingIngressEntry = _DroppacketModeRateLimitingIngressEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 1, 1)
)
...
class _LimitMode_Type(Integer32):
    """Custom type limitMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LimitMode_Type.__name__ = "Integer32"
_LimitMode_Object = MibTableColumn
limitMode = _LimitMode_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 1, 1, 1),
    _LimitMode_Type()
)
limitMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    limitMode.setStatus("current")


class _LowPriLimitRate_Type(Integer32):
    """Custom type lowPriLimitRate based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LowPriLimitRate_Type.__name__ = "Integer32"
_LowPriLimitRate_Object = MibTableColumn
lowPriLimitRate = _LowPriLimitRate_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 1, 1, 2),
    _LowPriLimitRate_Type()
)
lowPriLimitRate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lowPriLimitRate.setStatus("current")


class _NormalPriLimitRate_Type(Integer32):
    """Custom type normalPriLimitRate based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_NormalPriLimitRate_Type.__name__ = "Integer32"
_NormalPriLimitRate_Object = MibTableColumn
normalPriLimitRate = _NormalPriLimitRate_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 1, 1, 3),
    _NormalPriLimitRate_Type()
)
normalPriLimitRate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    normalPriLimitRate.setStatus("current")


class _MediumPriLimitRate_Type(Integer32):
    """Custom type mediumPriLimitRate based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_MediumPriLimitRate_Type.__name__ = "Integer32"
_MediumPriLimitRate_Object = MibTableColumn
mediumPriLimitRate = _MediumPriLimitRate_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 1, 1, 4),
    _MediumPriLimitRate_Type()
)
mediumPriLimitRate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    mediumPriLimitRate.setStatus("current")


class _HighPriLimitRate_Type(Integer32):
    """Custom type highPriLimitRate based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_HighPriLimitRate_Type.__name__ = "Integer32"
_HighPriLimitRate_Object = MibTableColumn
highPriLimitRate = _HighPriLimitRate_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 1, 1, 5),
    _HighPriLimitRate_Type()
)
highPriLimitRate.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    highPriLimitRate.setStatus("current")
...
egressLimit = _EgressLimit_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 1, 1, 6),
    _EgressLimit_Type()
)
egressLimit.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    egressLimit.setStatus("current")
_PortShutdownMode_ObjectIdentity = ObjectIdentity
portShutdownMode = _PortShutdownMode_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 3)
)


class _PortShutdownModePeriod_Type(Integer32):
    """Custom type portShutdownModePeriod based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_PortShutdownModePeriod_Type.__name__ = "Integer32"
_PortShutdownModePeriod_Object = MibScalar
portShutdownModePeriod = _PortShutdownModePeriod_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 3, 1),
    _PortShutdownModePeriod_Type()
)
portShutdownModePeriod.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    portShutdownModePeriod.setStatus("current")
_PortShutdownModeTable_Object = MibTable
portShutdownModeTable = _PortShutdownModeTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 3, 2)
)
if mibBuilder.loadTexts:
    portShutdownModeTable.setStatus("current")
_PortShutdownModeEntry_Object = MibTableRow
portShutdownModeEntry = _PortShutdownModeEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 3, 2, 1)
)
portShutdownModeEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "portIndex"),
)
if mibBuilder.loadTexts:
    portShutdownModeEntry.setStatus("current")
...
ingressLimit = _IngressLimit_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 21, 3, 2, 1, 1),
    _IngressLimit_Type()
)
...
userLoginServer = _UserLoginServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 1),
...
tacacsServerSetting = _TacacsServerSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2)
)
_TacacsAuthenticationSetting_ObjectIdentity = ObjectIdentity
tacacsAuthenticationSetting = _TacacsAuthenticationSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 6)
)
_TacacsAuthenticationPrimaryServer_Type = DisplayString
_TacacsAuthenticationPrimaryServer_Object = MibScalar
tacacsAuthenticationPrimaryServer = _TacacsAuthenticationPrimaryServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 6, 1),
    _TacacsAuthenticationPrimaryServer_Type()
)
tacacsAuthenticationPrimaryServer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthenticationPrimaryServer.setStatus("current")
_TacacsAuthenticationSecondaryServer_Type = DisplayString
_TacacsAuthenticationSecondaryServer_Object = MibScalar
tacacsAuthenticationSecondaryServer = _TacacsAuthenticationSecondaryServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 6, 2),
    _TacacsAuthenticationSecondaryServer_Type()
)
tacacsAuthenticationSecondaryServer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthenticationSecondaryServer.setStatus("current")


class _TacacsAuthenticationPrimaryPort_Type(Integer32):
    """Custom type tacacsAuthenticationPrimaryPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_TacacsAuthenticationPrimaryPort_Type.__name__ = "Integer32"
_TacacsAuthenticationPrimaryPort_Object = MibScalar
tacacsAuthenticationPrimaryPort = _TacacsAuthenticationPrimaryPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 6, 3),
    _TacacsAuthenticationPrimaryPort_Type()
)
tacacsAuthenticationPrimaryPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthenticationPrimaryPort.setStatus("current")


class _TacacsAuthenticationSecondaryPort_Type(Integer32):
    """Custom type tacacsAuthenticationSecondaryPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_TacacsAuthenticationSecondaryPort_Type.__name__ = "Integer32"
_TacacsAuthenticationSecondaryPort_Object = MibScalar
tacacsAuthenticationSecondaryPort = _TacacsAuthenticationSecondaryPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 6, 4),
    _TacacsAuthenticationSecondaryPort_Type()
)
tacacsAuthenticationSecondaryPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthenticationSecondaryPort.setStatus("current")
_TacacsAuthenticationPrimaryKey_Type = DisplayString
_TacacsAuthenticationPrimaryKey_Object = MibScalar
tacacsAuthenticationPrimaryKey = _TacacsAuthenticationPrimaryKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 6, 5),
    _TacacsAuthenticationPrimaryKey_Type()
)
tacacsAuthenticationPrimaryKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthenticationPrimaryKey.setStatus("current")
_TacacsAuthenticationSecondaryKey_Type = DisplayString
_TacacsAuthenticationSecondaryKey_Object = MibScalar
tacacsAuthenticationSecondaryKey = _TacacsAuthenticationSecondaryKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 6, 6),
    _TacacsAuthenticationSecondaryKey_Type()
)
tacacsAuthenticationSecondaryKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthenticationSecondaryKey.setStatus("current")


class _TacacsAuthenticationTimeout_Type(Integer32):
    """Custom type tacacsAuthenticationTimeout based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_TacacsAuthenticationTimeout_Type.__name__ = "Integer32"
_TacacsAuthenticationTimeout_Object = MibScalar
tacacsAuthenticationTimeout = _TacacsAuthenticationTimeout_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 6, 7),
    _TacacsAuthenticationTimeout_Type()
)
tacacsAuthenticationTimeout.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthenticationTimeout.setStatus("current")


class _TacacsAuthenticationType_Type(Integer32):
    """Custom type tacacsAuthenticationType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TacacsAuthenticationType_Type.__name__ = "Integer32"
_TacacsAuthenticationType_Object = MibScalar
tacacsAuthenticationType = _TacacsAuthenticationType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 6, 8),
    _TacacsAuthenticationType_Type()
)
tacacsAuthenticationType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthenticationType.setStatus("current")
_TacacsAuthorizationSetting_ObjectIdentity = ObjectIdentity
tacacsAuthorizationSetting = _TacacsAuthorizationSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 7)
)
_TacacsAuthorizationPrimaryServer_Type = DisplayString
_TacacsAuthorizationPrimaryServer_Object = MibScalar
tacacsAuthorizationPrimaryServer = _TacacsAuthorizationPrimaryServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 7, 1),
    _TacacsAuthorizationPrimaryServer_Type()
)
tacacsAuthorizationPrimaryServer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthorizationPrimaryServer.setStatus("current")
_TacacsAuthorizationSecondaryServer_Type = DisplayString
_TacacsAuthorizationSecondaryServer_Object = MibScalar
tacacsAuthorizationSecondaryServer = _TacacsAuthorizationSecondaryServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 7, 2),
    _TacacsAuthorizationSecondaryServer_Type()
)
tacacsAuthorizationSecondaryServer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthorizationSecondaryServer.setStatus("current")


class _TacacsAuthorizationPrimaryPort_Type(Integer32):
    """Custom type tacacsAuthorizationPrimaryPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_TacacsAuthorizationPrimaryPort_Type.__name__ = "Integer32"
_TacacsAuthorizationPrimaryPort_Object = MibScalar
tacacsAuthorizationPrimaryPort = _TacacsAuthorizationPrimaryPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 7, 3),
    _TacacsAuthorizationPrimaryPort_Type()
)
tacacsAuthorizationPrimaryPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthorizationPrimaryPort.setStatus("current")


class _TacacsAuthorizationSecondaryPort_Type(Integer32):
    """Custom type tacacsAuthorizationSecondaryPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_TacacsAuthorizationSecondaryPort_Type.__name__ = "Integer32"
_TacacsAuthorizationSecondaryPort_Object = MibScalar
tacacsAuthorizationSecondaryPort = _TacacsAuthorizationSecondaryPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 7, 4),
    _TacacsAuthorizationSecondaryPort_Type()
)
tacacsAuthorizationSecondaryPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthorizationSecondaryPort.setStatus("current")
_TacacsAuthorizationPrimaryKey_Type = DisplayString
_TacacsAuthorizationPrimaryKey_Object = MibScalar
tacacsAuthorizationPrimaryKey = _TacacsAuthorizationPrimaryKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 7, 5),
    _TacacsAuthorizationPrimaryKey_Type()
)
tacacsAuthorizationPrimaryKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthorizationPrimaryKey.setStatus("current")
_TacacsAuthorizationSecondaryKey_Type = DisplayString
_TacacsAuthorizationSecondaryKey_Object = MibScalar
tacacsAuthorizationSecondaryKey = _TacacsAuthorizationSecondaryKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 7, 6),
    _TacacsAuthorizationSecondaryKey_Type()
)
tacacsAuthorizationSecondaryKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthorizationSecondaryKey.setStatus("current")


class _TacacsAuthorizationTimeout_Type(Integer32):
    """Custom type tacacsAuthorizationTimeout based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
_TacacsAuthorizationTimeout_Type.__name__ = "Integer32"
_TacacsAuthorizationTimeout_Object = MibScalar
tacacsAuthorizationTimeout = _TacacsAuthorizationTimeout_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 7, 7),
    _TacacsAuthorizationTimeout_Type()
)
tacacsAuthorizationTimeout.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAuthorizationTimeout.setStatus("current")
_TacacsAccountingSetting_ObjectIdentity = ObjectIdentity
tacacsAccountingSetting = _TacacsAccountingSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 8)
)
_TacacsAccountingPrimaryServer_Type = DisplayString
_TacacsAccountingPrimaryServer_Object = MibScalar
tacacsAccountingPrimaryServer = _TacacsAccountingPrimaryServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 8, 1),
    _TacacsAccountingPrimaryServer_Type()
)
tacacsAccountingPrimaryServer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAccountingPrimaryServer.setStatus("current")
_TacacsAccountingSecondaryServer_Type = DisplayString
_TacacsAccountingSecondaryServer_Object = MibScalar
tacacsAccountingSecondaryServer = _TacacsAccountingSecondaryServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 8, 2),
    _TacacsAccountingSecondaryServer_Type()
)
tacacsAccountingSecondaryServer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAccountingSecondaryServer.setStatus("current")


class _TacacsAccountingPrimaryPort_Type(Integer32):
    """Custom type tacacsAccountingPrimaryPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_TacacsAccountingPrimaryPort_Type.__name__ = "Integer32"
_TacacsAccountingPrimaryPort_Object = MibScalar
tacacsAccountingPrimaryPort = _TacacsAccountingPrimaryPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 8, 3),
    _TacacsAccountingPrimaryPort_Type()
)
tacacsAccountingPrimaryPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAccountingPrimaryPort.setStatus("current")


class _TacacsAccountingSecondaryPort_Type(Integer32):
    """Custom type tacacsAccountingSecondaryPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_TacacsAccountingSecondaryPort_Type.__name__ = "Integer32"
_TacacsAccountingSecondaryPort_Object = MibScalar
tacacsAccountingSecondaryPort = _TacacsAccountingSecondaryPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 8, 4),
    _TacacsAccountingSecondaryPort_Type()
)
tacacsAccountingSecondaryPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAccountingSecondaryPort.setStatus("current")
_TacacsAccountingPrimaryKey_Type = DisplayString
_TacacsAccountingPrimaryKey_Object = MibScalar
tacacsAccountingPrimaryKey = _TacacsAccountingPrimaryKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 8, 5),
    _TacacsAccountingPrimaryKey_Type()
)
tacacsAccountingPrimaryKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAccountingPrimaryKey.setStatus("current")
_TacacsAccountingSecondaryKey_Type = DisplayString
_TacacsAccountingSecondaryKey_Object = MibScalar
tacacsAccountingSecondaryKey = _TacacsAccountingSecondaryKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 8, 6),
    _TacacsAccountingSecondaryKey_Type()
)
tacacsAccountingSecondaryKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAccountingSecondaryKey.setStatus("current")


class _TacacsAccountingTimeout_Type(Integer32):
    """Custom type tacacsAccountingTimeout based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
_TacacsAccountingTimeout_Type.__name__ = "Integer32"
_TacacsAccountingTimeout_Object = MibScalar
tacacsAccountingTimeout = _TacacsAccountingTimeout_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 8, 7),
    _TacacsAccountingTimeout_Type()
)
tacacsAccountingTimeout.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAccountingTimeout.setStatus("current")


class _TacacsAccountingEnable_Type(Integer32):
    """Custom type tacacsAccountingEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TacacsAccountingEnable_Type.__name__ = "Integer32"
_TacacsAccountingEnable_Object = MibScalar
tacacsAccountingEnable = _TacacsAccountingEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 2, 8, 8),
    _TacacsAccountingEnable_Type()
)
tacacsAccountingEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    tacacsAccountingEnable.setStatus("current")
_RadiusServerSetting_ObjectIdentity = ObjectIdentity
radiusServerSetting = _RadiusServerSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 3)
)
_Login1stRadiusAuthServer_Type = DisplayString
_Login1stRadiusAuthServer_Object = MibScalar
login1stRadiusAuthServer = _Login1stRadiusAuthServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 3, 1),
    _Login1stRadiusAuthServer_Type()
)
login1stRadiusAuthServer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    login1stRadiusAuthServer.setStatus("current")


class _Login1stRadiusAuthPort_Type(Integer32):
    """Custom type login1stRadiusAuthPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_Login1stRadiusAuthPort_Type.__name__ = "Integer32"
_Login1stRadiusAuthPort_Object = MibScalar
login1stRadiusAuthPort = _Login1stRadiusAuthPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 3, 2),
    _Login1stRadiusAuthPort_Type()
)
login1stRadiusAuthPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    login1stRadiusAuthPort.setStatus("current")
_Login1stRadiusAuthSharedKey_Type = DisplayString
_Login1stRadiusAuthSharedKey_Object = MibScalar
login1stRadiusAuthSharedKey = _Login1stRadiusAuthSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 3, 3),
    _Login1stRadiusAuthSharedKey_Type()
)
login1stRadiusAuthSharedKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    login1stRadiusAuthSharedKey.setStatus("current")
_Login2ndRadiusAuthServer_Type = DisplayString
_Login2ndRadiusAuthServer_Object = MibScalar
login2ndRadiusAuthServer = _Login2ndRadiusAuthServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 3, 4),
    _Login2ndRadiusAuthServer_Type()
)
login2ndRadiusAuthServer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    login2ndRadiusAuthServer.setStatus("current")


class _Login2ndRadiusAuthPort_Type(Integer32):
    """Custom type login2ndRadiusAuthPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65535),
    )
...
_Login2ndRadiusAuthPort_Type.__name__ = "Integer32"
_Login2ndRadiusAuthPort_Object = MibScalar
login2ndRadiusAuthPort = _Login2ndRadiusAuthPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 3, 5),
    _Login2ndRadiusAuthPort_Type()
)
login2ndRadiusAuthPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    login2ndRadiusAuthPort.setStatus("current")
_Login2ndRadiusAuthSharedKey_Type = DisplayString
_Login2ndRadiusAuthSharedKey_Object = MibScalar
login2ndRadiusAuthSharedKey = _Login2ndRadiusAuthSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 3, 6),
    _Login2ndRadiusAuthSharedKey_Type()
)
login2ndRadiusAuthSharedKey.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    login2ndRadiusAuthSharedKey.setStatus("current")
...
radiusLoginAuthAuthType = _RadiusLoginAuthAuthType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 3, 7),
...
radiusLoginAuthTimeout = _RadiusLoginAuthTimeout_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 1, 3, 8),
...
staticPortLockLegacyAddress = _StaticPortLockLegacyAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 1, 1),
...
staticPortLockLegacyPort = _StaticPortLockLegacyPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 1, 2),
...
staticPortLockLegacyStatus = _StaticPortLockLegacyStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 1, 3),
...
dot1x = _Dot1x_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2)
)
...
dataBaseOption = _DataBaseOption_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 1),
...
dot1xReauthEnable = _Dot1xReauthEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 5),
...
dot1xReauthPeriod = _Dot1xReauthPeriod_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 6),
...
enableDot1X = _EnableDot1X_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 7, 1, 1),
    _EnableDot1X_Type()
)
...
dot1xReauthPortIndex = _Dot1xReauthPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 8, 1, 1),
...
dot1xReauth = _Dot1xReauth_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 8, 1, 2),
    _Dot1xReauth_Type()
)
...
dot1xRadius = _Dot1xRadius_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 9)
)
...
dot1xSameAsAuthServer = _Dot1xSameAsAuthServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 9, 1),
...
dot1x1stRadiusServer = _Dot1x1stRadiusServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 9, 2),
...
dot1x1stRadiusPort = _Dot1x1stRadiusPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 9, 3),
...
dot1x1stRadiusSharedKey = _Dot1x1stRadiusSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 9, 4),
...
dot1x2ndRadiusServer = _Dot1x2ndRadiusServer_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 9, 5),
...
dot1x2ndRadiusPort = _Dot1x2ndRadiusPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 9, 6),
...
dot1x2ndRadiusSharedKey = _Dot1x2ndRadiusSharedKey_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 2, 9, 7),
...
portAccessControlTable = _PortAccessControlTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 3)
)
if mibBuilder.loadTexts:
...
portAccessControlEntry = _PortAccessControlEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 3, 1)
)
portAccessControlEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "portAccessControlAddress"),
)
if mibBuilder.loadTexts:
...
portAccessControlAddress = _PortAccessControlAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 3, 1, 1),
...
portAccessControlPortNo = _PortAccessControlPortNo_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 3, 1, 2),
...
portAccessControlAccessStatus = _PortAccessControlAccessStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 3, 1, 3),
...
portAccessControlStatus = _PortAccessControlStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 3, 1, 4),
...
portSecurityModeEntry = _PortSecurityModeEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 1, 1)
)
portSecurityModeEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "portSecurityModePort"),
)
if mibBuilder.loadTexts:
...
portSecurityModePort = _PortSecurityModePort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 1, 1, 1),
...
portSecurityModeSelect = _PortSecurityModeSelect_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 1, 1, 2),
...
portSecurityModeLimit = _PortSecurityModeLimit_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 1, 1, 3),
...
portSecurityModeViolationPortDisable = _PortSecurityModeViolationPortDisable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 1, 1, 4),
...
portSecurityModeStatus = _PortSecurityModeStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 1, 1, 5),
...
staticPortLock = _StaticPortLock_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 2)
)
...
staticPortLockAddress = _StaticPortLockAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 2, 1),
...
staticPortLockPort = _StaticPortLockPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 2, 2),
...
staticPortLockStatus = _StaticPortLockStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 2, 3),
...
staticPortLockVid = _StaticPortLockVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 2, 4),
...
macAddressSticky = _MacAddressSticky_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 3)
)
...
macAddressStickyAddress = _MacAddressStickyAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 3, 1),
...
macAddressStickyPort = _MacAddressStickyPort_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 3, 2),
...
macAddressStickyVid = _MacAddressStickyVid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 3, 3),
...
macAddressStickyStatus = _MacAddressStickyStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 22, 2, 4, 3, 4),
...
accessibleIpAddress = _AccessibleIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 30, 2, 1, 1),
...
accessibleIpNetMask = _AccessibleIpNetMask_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 30, 2, 1, 2),
...
accessibleIpStatus = _AccessibleIpStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 30, 2, 1, 3),
...
startMonth = _StartMonth_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 5, 1),
    _StartMonth_Type()
)
...
startWeek = _StartWeek_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 5, 2),
    _StartWeek_Type()
)
...
startDay = _StartDay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 5, 3),
    _StartDay_Type()
)
...
startHour = _StartHour_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 5, 4),
    _StartHour_Type()
)
...
endMonth = _EndMonth_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 5, 5),
    _EndMonth_Type()
)
...
endWeek = _EndWeek_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 5, 6),
    _EndWeek_Type()
)
...
endDay = _EndDay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 5, 7),
    _EndDay_Type()
)
...
endHour = _EndHour_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 5, 8),
    _EndHour_Type()
)
...
offsetHours = _OffsetHours_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 5, 9),
    _OffsetHours_Type()
)
...
ntpPeerIndex = _NtpPeerIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 9, 1, 1),
    _NtpPeerIndex_Type()
)
...
ntpPeerAddress = _NtpPeerAddress_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 9, 1, 2),
...
ntpPeerAuthenticate = _NtpPeerAuthenticate_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 9, 1, 3),
...
ntpPeerAuthenticateKeyid = _NtpPeerAuthenticateKeyid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 9, 1, 4),
...
ntpAuthenticateKeyEntry = _NtpAuthenticateKeyEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 10, 1)
)
ntpAuthenticateKeyEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "ntpAuthenticateKeyIndex"),
)
if mibBuilder.loadTexts:
...
ntpAuthenticateKeyIndex = _NtpAuthenticateKeyIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 10, 1, 1),
...
ntpAuthenticateKeyID = _NtpAuthenticateKeyID_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 10, 1, 2),
...
ntpAuthenticateKeyString = _NtpAuthenticateKeyString_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 10, 1, 3),
...
ntpAuthenticateKeyTrusted = _NtpAuthenticateKeyTrusted_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 32, 10, 1, 4),
...
class _SyslogServer1Protocol_Type(Integer32):
    """Custom type syslogServer1Protocol based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_SyslogServer1Protocol_Type.__name__ = "Integer32"
_SyslogServer1Protocol_Object = MibScalar
syslogServer1Protocol = _SyslogServer1Protocol_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 37, 7),
    _SyslogServer1Protocol_Type()
)
syslogServer1Protocol.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    syslogServer1Protocol.setStatus("current")


class _SyslogServer2Protocol_Type(Integer32):
    """Custom type syslogServer2Protocol based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_SyslogServer2Protocol_Type.__name__ = "Integer32"
_SyslogServer2Protocol_Object = MibScalar
syslogServer2Protocol = _SyslogServer2Protocol_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 37, 8),
    _SyslogServer2Protocol_Type()
)
syslogServer2Protocol.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    syslogServer2Protocol.setStatus("current")


class _SyslogServer3Protocol_Type(Integer32):
    """Custom type syslogServer3Protocol based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_SyslogServer3Protocol_Type.__name__ = "Integer32"
_SyslogServer3Protocol_Object = MibScalar
syslogServer3Protocol = _SyslogServer3Protocol_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 37, 9),
    _SyslogServer3Protocol_Type()
)
syslogServer3Protocol.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    syslogServer3Protocol.setStatus("current")
_DhcpRelayAgentSetting_ObjectIdentity = ObjectIdentity
dhcpRelayAgentSetting = _DhcpRelayAgentSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 39)
)
_DhcpServer1_Type = DisplayString
_DhcpServer1_Object = MibScalar
dhcpServer1 = _DhcpServer1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 39, 1),
    _DhcpServer1_Type()
)
...
enableOption82 = _EnableOption82_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 39, 5, 1),
...
option82Type = _Option82Type_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 39, 5, 2),
    _Option82Type_Type()
)
...
option82Value = _Option82Value_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 39, 5, 3),
    _Option82Value_Type()
)
...
option82ValueDisplay = _Option82ValueDisplay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 39, 5, 4),
...
dhcpPortIndex = _DhcpPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 39, 6, 1, 1),
    _DhcpPortIndex_Type()
)
...
circuitID = _CircuitID_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 39, 6, 1, 2),
    _CircuitID_Type()
)
...
option82Enable = _Option82Enable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 39, 6, 1, 3),
...
enablePtpv1 = _EnablePtpv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 1, 1),
    _EnablePtpv1_Type()
)
...
clockModev1 = _ClockModev1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 1, 2),
    _ClockModev1_Type()
)
...
syncIntervalv1 = _SyncIntervalv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 1, 3),
...
subDomainNamev1 = _SubDomainNamev1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 1, 4),
...
preferMasterv1 = _PreferMasterv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 1, 5),
...
enablePtp = _EnablePtp_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 1),
    _EnablePtp_Type()
)
...
clockMode = _ClockMode_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 2),
    _ClockMode_Type()
)
...
transport = _Transport_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 3),
    _Transport_Type()
)
...
syncInterval = _SyncInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 4),
    _SyncInterval_Type()
)
...
logMinDelayReqInterval = _LogMinDelayReqInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 5),
...
logMinPdelayReqInterval = _LogMinPdelayReqInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 6),
...
logAnnounceInterval = _LogAnnounceInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 7),
...
announceReceiptTimeout = _AnnounceReceiptTimeout_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 8),
...
priority1 = _Priority1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 9),
    _Priority1_Type()
)
...
priority2 = _Priority2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 10),
    _Priority2_Type()
)
...
clockClass = _ClockClass_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 11),
    _ClockClass_Type()
)
...
domainNumber = _DomainNumber_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 12),
    _DomainNumber_Type()
)
...
localUtcOffset = _LocalUtcOffset_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 13),
...
localUtcOffsetValid = _LocalUtcOffsetValid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 14),
...
localLeap59 = _LocalLeap59_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 15),
    _LocalLeap59_Type()
)
...
localLeap61 = _LocalLeap61_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 16),
    _LocalLeap61_Type()
)
...
localPtpTimescale = _LocalPtpTimescale_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 17),
...
localArbTime = _LocalArbTime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 2, 18),
    _LocalArbTime_Type()
)
...
meanPathDelayv1 = _MeanPathDelayv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 3, 2),
...
grandMasterUuidv1 = _GrandMasterUuidv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 3, 3),
...
parentUuidv1 = _ParentUuidv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 3, 4),
    _ParentUuidv1_Type()
)
...
clockStratumv1 = _ClockStratumv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 3, 5),
...
clockIdentifierv1 = _ClockIdentifierv1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 3, 6),
...
meanPathDelay = _MeanPathDelay_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 2),
    _MeanPathDelay_Type()
)
...
parentIdentity = _ParentIdentity_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 3),
...
grandmasterIdentity = _GrandmasterIdentity_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 4),
...
grandmasterClockClass = _GrandmasterClockClass_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 5),
...
grandmasterClockAccuracy = _GrandmasterClockAccuracy_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 6),
...
grandmasterPriority1 = _GrandmasterPriority1_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 7),
...
grandmasterPriority2 = _GrandmasterPriority2_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 8),
...
stepsRemoved = _StepsRemoved_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 9),
    _StepsRemoved_Type()
)
...
currentUtcOffset = _CurrentUtcOffset_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 10),
...
currentUtcOffsetValid = _CurrentUtcOffsetValid_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 11),
...
leap59 = _Leap59_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 12),
    _Leap59_Type()
)
...
leap61 = _Leap61_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 13),
    _Leap61_Type()
)
...
ptpTimescale = _PtpTimescale_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 14),
    _PtpTimescale_Type()
)
...
timesource = _Timesource_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 4, 15),
    _Timesource_Type()
)
...
ptpPortIndex = _PtpPortIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 5, 1, 1),
    _PtpPortIndex_Type()
)
...
ptpPortEnable = _PtpPortEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 5, 1, 2),
    _PtpPortEnable_Type()
)
...
ptpPortStatus = _PtpPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 41, 5, 1, 3),
    _PtpPortStatus_Type()
)
...
enableLLDP = _EnableLLDP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 42, 1, 1),
    _EnableLLDP_Type()
)
...
lldpMSGInterval = _LldpMSGInterval_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 42, 1, 2),
...
eventlogIndex = _EventlogIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 46, 1, 1, 1),
    _EventlogIndex_Type()
)
...
eventlogBootup = _EventlogBootup_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 46, 1, 1, 2),
...
eventlogDate = _EventlogDate_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 46, 1, 1, 3),
    _EventlogDate_Type()
)
...
eventlogTime = _EventlogTime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 46, 1, 1, 4),
    _EventlogTime_Type()
)
...
eventlogUptime = _EventlogUptime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 46, 1, 1, 5),
...
eventlogEvent = _EventlogEvent_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 46, 1, 1, 6),
    _EventlogEvent_Type()
)
...
enableEtherNetIP = _EnableEtherNetIP_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 47, 1, 1),
...
enableModbus = _EnableModbus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 47, 2, 1),
    _EnableModbus_Type()
)
...
enableProfinetIO = _EnableProfinetIO_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 47, 3, 1),
...
systemEventSettingsEntry = _SystemEventSettingsEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 1, 1)
)
systemEventSettingsEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "systemEventIndex"),
)
if mibBuilder.loadTexts:
...
systemEventIndex = _SystemEventIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 1, 1, 1),
...
systemEventActive = _SystemEventActive_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 1, 1, 2),
...
systemEventName = _SystemEventName_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 1, 1, 3),
...
systemEventSupport = _SystemEventSupport_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 1, 1, 4),
...
systemEventModuleEnable = _SystemEventModuleEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 1, 1, 5),
...
systemEventSeverity = _SystemEventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 1, 1, 6),
...
portEventSettingsEntry = _PortEventSettingsEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 2, 1)
)
portEventSettingsEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "portEventIndex"),
)
if mibBuilder.loadTexts:
...
portEventIndex = _PortEventIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 2, 1, 1),
...
portEventLabel = _PortEventLabel_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 2, 1, 2),
...
portEventActive = _PortEventActive_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 2, 1, 3),
...
portEventEnable = _PortEventEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 2, 1, 4),
...
portEventTrafficThreshold = _PortEventTrafficThreshold_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 2, 1, 5),
...
portEventTrafficDuration = _PortEventTrafficDuration_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 2, 1, 6),
...
portEventModuleEnable = _PortEventModuleEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 2, 1, 7),
...
portEventSeverity = _PortEventSeverity_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 62, 2, 1, 8),
...
configEncryptEnable = _ConfigEncryptEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 79),
    _ConfigEncryptEnable_Type()
)
configEncryptEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    configEncryptEnable.setStatus("current")
_TrackingSetting_ObjectIdentity = ObjectIdentity
trackingSetting = _TrackingSetting_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80)
)


class _TrackingFuncEnable_Type(Integer32):
    """Custom type trackingFuncEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TrackingFuncEnable_Type.__name__ = "Integer32"
_TrackingFuncEnable_Object = MibScalar
trackingFuncEnable = _TrackingFuncEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80, 1),
    _TrackingFuncEnable_Type()
)
trackingFuncEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    trackingFuncEnable.setStatus("current")
_TrackingTable_Object = MibTable
trackingTable = _TrackingTable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80, 2)
)
if mibBuilder.loadTexts:
    trackingTable.setStatus("current")
_TrackingEntry_Object = MibTableRow
trackingEntry = _TrackingEntry_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80, 2, 1)
)
trackingEntry.setIndexNames(
    (0, "MOXA-EDS510E-MIB", "trackingIndex"),
)
if mibBuilder.loadTexts:
    trackingEntry.setStatus("current")
_TrackingIndex_Type = Integer32
_TrackingIndex_Object = MibTableColumn
trackingIndex = _TrackingIndex_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80, 2, 1, 1),
    _TrackingIndex_Type()
)
trackingIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    trackingIndex.setStatus("current")
_TrackingID_Type = Integer32
_TrackingID_Object = MibTableColumn
trackingID = _TrackingID_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80, 2, 1, 2),
    _TrackingID_Type()
)
trackingID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    trackingID.setStatus("current")


class _TrackingType_Type(Integer32):
    """Custom type trackingType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_TrackingType_Type.__name__ = "Integer32"
_TrackingType_Object = MibTableColumn
trackingType = _TrackingType_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80, 2, 1, 3),
    _TrackingType_Type()
)
trackingType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    trackingType.setStatus("current")
_TrackingTarget_Type = DisplayString
_TrackingTarget_Object = MibTableColumn
trackingTarget = _TrackingTarget_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80, 2, 1, 4),
    _TrackingTarget_Type()
)
trackingTarget.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    trackingTarget.setStatus("current")


class _TrackingStatus_Type(Integer32):
    """Custom type trackingStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TrackingStatus_Type.__name__ = "Integer32"
_TrackingStatus_Object = MibTableColumn
trackingStatus = _TrackingStatus_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80, 2, 1, 5),
    _TrackingStatus_Type()
)
trackingStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    trackingStatus.setStatus("current")
_TrackingChangeTime_Type = DisplayString
_TrackingChangeTime_Object = MibTableColumn
trackingChangeTime = _TrackingChangeTime_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80, 2, 1, 6),
    _TrackingChangeTime_Type()
)
trackingChangeTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    trackingChangeTime.setStatus("current")
_TrackingChangeCount_Type = Integer32
_TrackingChangeCount_Object = MibTableColumn
trackingChangeCount = _TrackingChangeCount_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80, 2, 1, 7),
    _TrackingChangeCount_Type()
)
trackingChangeCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    trackingChangeCount.setStatus("current")


class _TrackingEnable_Type(Integer32):
    """Custom type trackingEnable based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_TrackingEnable_Type.__name__ = "Integer32"
_TrackingEnable_Object = MibTableColumn
trackingEnable = _TrackingEnable_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 1, 80, 2, 1, 8),
    _TrackingEnable_Type()
)
trackingEnable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    trackingEnable.setStatus("current")
_SwTraps_ObjectIdentity = ObjectIdentity
swTraps = _SwTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 2)
)
...
class _VarTrackingStatusChangedTrap_Type(Integer32):
    """Custom type varTrackingStatusChangedTrap based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VarTrackingStatusChangedTrap_Type.__name__ = "Integer32"
_VarTrackingStatusChangedTrap_Object = MibScalar
varTrackingStatusChangedTrap = _VarTrackingStatusChangedTrap_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 2, 40),
    _VarTrackingStatusChangedTrap_Type()
)
varTrackingStatusChangedTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    varTrackingStatusChangedTrap.setStatus("current")


class _VarTrackingPortEnableChangedTrap_Type(Integer32):
    """Custom type varTrackingPortEnableChangedTrap based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VarTrackingPortEnableChangedTrap_Type.__name__ = "Integer32"
_VarTrackingPortEnableChangedTrap_Object = MibScalar
varTrackingPortEnableChangedTrap = _VarTrackingPortEnableChangedTrap_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 2, 43),
    _VarTrackingPortEnableChangedTrap_Type()
)
varTrackingPortEnableChangedTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    varTrackingPortEnableChangedTrap.setStatus("current")
_VarMrpMultiManagerTrap_Type = Integer32
_VarMrpMultiManagerTrap_Object = MibScalar
varMrpMultiManagerTrap = _VarMrpMultiManagerTrap_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 2, 48),
    _VarMrpMultiManagerTrap_Type()
)
varMrpMultiManagerTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    varMrpMultiManagerTrap.setStatus("current")
_VarMrpRingOpenTrap_Type = Integer32
_VarMrpRingOpenTrap_Object = MibScalar
varMrpRingOpenTrap = _VarMrpRingOpenTrap_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 2, 49),
    _VarMrpRingOpenTrap_Type()
)
varMrpRingOpenTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    varMrpRingOpenTrap.setStatus("current")


class _VarDiOfftoOnChangedTrap_Type(Integer32):
    """Custom type varDiOfftoOnChangedTrap based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VarDiOfftoOnChangedTrap_Type.__name__ = "Integer32"
_VarDiOfftoOnChangedTrap_Object = MibScalar
varDiOfftoOnChangedTrap = _VarDiOfftoOnChangedTrap_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 2, 50),
    _VarDiOfftoOnChangedTrap_Type()
)
varDiOfftoOnChangedTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    varDiOfftoOnChangedTrap.setStatus("current")


class _VarDiOntoOffChangedTrap_Type(Integer32):
    """Custom type varDiOntoOffChangedTrap based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_VarDiOntoOffChangedTrap_Type.__name__ = "Integer32"
_VarDiOntoOffChangedTrap_Object = MibScalar
varDiOntoOffChangedTrap = _VarDiOntoOffChangedTrap_Object(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 2, 51),
    _VarDiOntoOffChangedTrap_Type()
)
varDiOntoOffChangedTrap.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    varDiOntoOffChangedTrap.setStatus("current")
...
configChangeTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 1)
)
configChangeTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varconfigChangeTrap")
)
if mibBuilder.loadTexts:
...
power1Trap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 2)
)
power1Trap.setObjects(
    ("MOXA-EDS510E-MIB", "varpower1Trap")
)
if mibBuilder.loadTexts:
...
power2Trap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 3)
)
power2Trap.setObjects(
    ("MOXA-EDS510E-MIB", "varpower2Trap")
)
if mibBuilder.loadTexts:
...
trafficOverloadTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 4)
)
trafficOverloadTrap.setObjects(
    ("MOXA-EDS510E-MIB", "vartrafficOverloadTrap")
)
if mibBuilder.loadTexts:
...
redundancyTopologyChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 5)
)
redundancyTopologyChangedTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varredundancyTopologyChangedTrap")
)
if mibBuilder.loadTexts:
...
turboRingCouplingPortChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 6)
)
turboRingCouplingPortChangedTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varturboRingCouplingPortChangedTrap")
)
if mibBuilder.loadTexts:
...
turboRingMasterChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 7)
)
turboRingMasterChangedTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varturboRingMasterChangedTrap")
)
if mibBuilder.loadTexts:
...
portLoopDetectedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 17)
)
portLoopDetectedTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varPortLoopDetectedTrap")
)
if mibBuilder.loadTexts:
...
rateLimitedOnTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 18)
)
rateLimitedOnTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varRateLimitedOnTrap")
)
if mibBuilder.loadTexts:
...
lldpChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 19)
)
lldpChgTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varLLDPChgTrap")
)
if mibBuilder.loadTexts:
...
abc02WarningTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 20)
)
abc02WarningTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varABC02WarningTrap")
)
if mibBuilder.loadTexts:
...
userAuthSuccessTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 24)
)
userAuthSuccessTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varUserAuthSuccessTrap")
)
if mibBuilder.loadTexts:
...
userAuthFailTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 25)
)
userAuthFailTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varUserAuthFailTrap")
)
if mibBuilder.loadTexts:
...
macStickyPortViolationPortDisableTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 26)
)
macStickyPortViolationPortDisableTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varMacStickyPortViolationPortDisableTrap")
)
if mibBuilder.loadTexts:
...
fiberWarningTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 28)
)
fiberWarningTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varFiberWarningTrap")
)
if mibBuilder.loadTexts:
...
loggingCapacityTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 29)
)
loggingCapacityTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varLoggingCapacityTrap")
)
if mibBuilder.loadTexts:
...
userInfoChgTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 31)
)
userInfoChgTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varUserInfoChgTrap")
)
if mibBuilder.loadTexts:
...
configImportTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 32)
)
configImportTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varConfigImportTrap")
)
if mibBuilder.loadTexts:
...
remoteAuthSuccessTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 38)
)
remoteAuthSuccessTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varRemoteAuthSuccessTrap")
)
if mibBuilder.loadTexts:
...
remoteAuthFailTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 39)
)
remoteAuthFailTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varRemoteAuthFailTrap")
)
if mibBuilder.loadTexts:
...
trackingStatusChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 40)
)
trackingStatusChangedTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varTrackingStatusChangedTrap")
)
if mibBuilder.loadTexts:
    trackingStatusChangedTrap.setStatus(
        "current"
    )

trackingPortEnableChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 43)
)
trackingPortEnableChangedTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varTrackingPortEnableChangedTrap")
)
if mibBuilder.loadTexts:
    trackingPortEnableChangedTrap.setStatus(
        "current"
    )

mrpMultiManagerTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 48)
)
mrpMultiManagerTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varMrpMultiManagerTrap")
)
if mibBuilder.loadTexts:
    mrpMultiManagerTrap.setStatus(
        "current"
    )

mrpRingOpenTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 49)
)
mrpRingOpenTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varMrpRingOpenTrap")
)
if mibBuilder.loadTexts:
    mrpRingOpenTrap.setStatus(
        "current"
    )

diOfftoOnChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 50)
)
diOfftoOnChangedTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varDiOfftoOnChangedTrap")
)
if mibBuilder.loadTexts:
    diOfftoOnChangedTrap.setStatus(
        "current"
    )

diOntoOffChangedTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 8691, 7, 84, 0, 51)
)
diOntoOffChangedTrap.setObjects(
    ("MOXA-EDS510E-MIB", "varDiOntoOffChangedTrap")
)
if mibBuilder.loadTexts:
    diOntoOffChangedTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"PortList": PortList,
       ...
       "trackingStatusChangedTrap": trackingStatusChangedTrap,
       "trackingPortEnableChangedTrap": trackingPortEnableChangedTrap,
       "mrpMultiManagerTrap": mrpMultiManagerTrap,
       "mrpRingOpenTrap": mrpRingOpenTrap,
       "diOfftoOnChangedTrap": diOfftoOnChangedTrap,
       "diOntoOffChangedTrap": diOntoOffChangedTrap,
       "swMgmt": swMgmt,
       ...
       "portLinkDownDisable": portLinkDownDisable,
       "monitor": monitor,
       ...
       "fiberSN": fiberSN,
       "monitorSessionMonitorTable": monitorSessionMonitorTable,
       "monitorSessionMonitorEntry": monitorSessionMonitorEntry,
       "sessionID": sessionID,
       "userName": userName,
       "loginType": loginType,
       "loginDate": loginDate,
       ...
       "limitMode": limitMode,
       "lowPriLimitRate": lowPriLimitRate,
       "normalPriLimitRate": normalPriLimitRate,
       "mediumPriLimitRate": mediumPriLimitRate,
       "highPriLimitRate": highPriLimitRate,
       "egressLimit": egressLimit,
       "portShutdownMode": portShutdownMode,
       "portShutdownModePeriod": portShutdownModePeriod,
       "portShutdownModeTable": portShutdownModeTable,
       "portShutdownModeEntry": portShutdownModeEntry,
       ...
       "tacacsAuthenticationSetting": tacacsAuthenticationSetting,
       "tacacsAuthenticationPrimaryServer": tacacsAuthenticationPrimaryServer,
       "tacacsAuthenticationSecondaryServer": tacacsAuthenticationSecondaryServer,
       "tacacsAuthenticationPrimaryPort": tacacsAuthenticationPrimaryPort,
       "tacacsAuthenticationSecondaryPort": tacacsAuthenticationSecondaryPort,
       "tacacsAuthenticationPrimaryKey": tacacsAuthenticationPrimaryKey,
       "tacacsAuthenticationSecondaryKey": tacacsAuthenticationSecondaryKey,
       "tacacsAuthenticationTimeout": tacacsAuthenticationTimeout,
       "tacacsAuthenticationType": tacacsAuthenticationType,
       "tacacsAuthorizationSetting": tacacsAuthorizationSetting,
       "tacacsAuthorizationPrimaryServer": tacacsAuthorizationPrimaryServer,
       "tacacsAuthorizationSecondaryServer": tacacsAuthorizationSecondaryServer,
       "tacacsAuthorizationPrimaryPort": tacacsAuthorizationPrimaryPort,
       "tacacsAuthorizationSecondaryPort": tacacsAuthorizationSecondaryPort,
       "tacacsAuthorizationPrimaryKey": tacacsAuthorizationPrimaryKey,
       "tacacsAuthorizationSecondaryKey": tacacsAuthorizationSecondaryKey,
       "tacacsAuthorizationTimeout": tacacsAuthorizationTimeout,
       "tacacsAccountingSetting": tacacsAccountingSetting,
       "tacacsAccountingPrimaryServer": tacacsAccountingPrimaryServer,
       "tacacsAccountingSecondaryServer": tacacsAccountingSecondaryServer,
       "tacacsAccountingPrimaryPort": tacacsAccountingPrimaryPort,
       "tacacsAccountingSecondaryPort": tacacsAccountingSecondaryPort,
       "tacacsAccountingPrimaryKey": tacacsAccountingPrimaryKey,
       "tacacsAccountingSecondaryKey": tacacsAccountingSecondaryKey,
       "tacacsAccountingTimeout": tacacsAccountingTimeout,
       "tacacsAccountingEnable": tacacsAccountingEnable,
       "radiusServerSetting": radiusServerSetting,
       "login1stRadiusAuthServer": login1stRadiusAuthServer,
       "login1stRadiusAuthPort": login1stRadiusAuthPort,
       "login1stRadiusAuthSharedKey": login1stRadiusAuthSharedKey,
       "login2ndRadiusAuthServer": login2ndRadiusAuthServer,
       "login2ndRadiusAuthPort": login2ndRadiusAuthPort,
       "login2ndRadiusAuthSharedKey": login2ndRadiusAuthSharedKey,
       ...
       "syslogServer1Protocol": syslogServer1Protocol,
       "syslogServer2Protocol": syslogServer2Protocol,
       "syslogServer3Protocol": syslogServer3Protocol,
       ...
       "trackingFuncEnable": trackingFuncEnable,
       ...
       "trackingChangeTime": trackingChangeTime,
       "trackingChangeCount": trackingChangeCount,
       ...
       "varTrackingStatusChangedTrap": varTrackingStatusChangedTrap,
       "varTrackingPortEnableChangedTrap": varTrackingPortEnableChangedTrap,
       "varMrpMultiManagerTrap": varMrpMultiManagerTrap,
       "varMrpRingOpenTrap": varMrpRingOpenTrap,
       "varDiOfftoOnChangedTrap": varDiOfftoOnChangedTrap,
       "varDiOntoOffChangedTrap": varDiOntoOffChangedTrap}
)
