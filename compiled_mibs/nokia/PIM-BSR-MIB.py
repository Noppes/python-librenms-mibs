...
# Notes
# -----
# ASN.1 source file://mibs\fs\PIM-BSR-MIB
...
_PimBsrCandidateRPBidir_Type.__name__ = "TruthValue"
...
_PimBsrCandidateRPStorageType_Type.__name__ = "StorageType"
...
_PimBsrCandidateBSRStorageType_Type.__name__ = "StorageType"
...
pimBsrCompliance.setObjects(
      *(("PIM-BSR-MIB", "pimBsrObjectGroup"),
        ("PIM-BSR-MIB", "pimBsrDiagnosticsGroup"))
)
if mibBuilder.loadTexts:
