...
# Notes
# -----
# ASN.1 source file://mibs\nokia\aos6\ALCATEL-IND1-SSH-MIB
...
class _AlaSshPortNumber_Type(Integer32):
    """Custom type alaSshPortNumber based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_AlaSshPortNumber_Type.__name__ = "Integer32"
_AlaSshPortNumber_Object = MibScalar
alaSshPortNumber = _AlaSshPortNumber_Object(
    (1, 3, 6, 1, 4, 1, 6486, 800, 1, 2, 1, 39, 1, 1, 4),
    _AlaSshPortNumber_Type()
)
alaSshPortNumber.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    alaSshPortNumber.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"alcatelIND1SshMIB": alcatelIND1SshMIB,
       ...
       "alaSshPortNumber": alaSshPortNumber,
