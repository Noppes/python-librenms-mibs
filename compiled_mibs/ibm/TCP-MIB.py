...
# Notes
# -----
# ASN.1 source file://mibs\TCP-MIB
...
tcpMIBCompliance2.setObjects(
      *(("TCP-MIB", "tcpBaseGroup"),
        ("TCP-MIB", "tcpConnectionGroup"),
        ("TCP-MIB", "tcpListenerGroup"),
        ("TCP-MIB", "tcpHCGroup"))
)
if mibBuilder.loadTexts:
