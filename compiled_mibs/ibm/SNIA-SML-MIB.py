...
# Notes
# -----
# ASN.1 source file://mibs\ibm\SNIA-SML-MIB
...
driveAlert.setObjects(
      *(("SNIA-SML-MIB", "trapDriveAlertSummary"),
        ("SNIA-SML-MIB", "trap-Association-MediaAccessDeviceIndex"),
...
changerAlert.setObjects(
      *(("SNIA-SML-MIB", "trapChangerAlertSummary"),
        ("SNIA-SML-MIB", "trap-Association-ChangerDeviceIndex"),
        ("SNIA-SML-MIB", "trapPerceivedSeverity"))
)
if mibBuilder.loadTexts:
...
libraryAddedTrap.setObjects(
    ("SNIA-SML-MIB", "storageLibrary-Name")
)
if mibBuilder.loadTexts:
...
driveAddedTrap.setObjects(
      *(("SNIA-SML-MIB", "storageLibrary-Name"),
        ("SNIA-SML-MIB", "mediaAccessDevice-DeviceID"))
)
if mibBuilder.loadTexts:
...
changerAddedTrap.setObjects(
      *(("SNIA-SML-MIB", "storageLibrary-Name"),
        ("SNIA-SML-MIB", "changerDevice-DeviceID"))
)
if mibBuilder.loadTexts:
...
physicalMediaAddedTrap.setObjects(
    ("SNIA-SML-MIB", "storageMediaLocation-PhysicalMedia-Tag")
)
if mibBuilder.loadTexts:
