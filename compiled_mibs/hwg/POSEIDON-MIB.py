...
# Notes
# -----
# ASN.1 source file://mibs\hwg\POSEIDON-MIB
...
class LogTimeRemain(TimeTicks):
    """Custom type LogTimeRemain based on TimeTicks"""




class LogCmd(Integer32):
    """Custom type LogCmd based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
if mibBuilder.loadTexts:
    inpAlarmSetup.setStatus("mandatory")
...
_InpCounter_Type = NonNegativeInteger
_InpCounter_Object = MibTableColumn
inpCounter = _InpCounter_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 3, 1, 1, 6),
    _InpCounter_Type()
)
inpCounter.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    inpCounter.setStatus("mandatory")
_OutTable_Object = MibTable
outTable = _OutTable_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 3, 2)
)
if mibBuilder.loadTexts:
    outTable.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    outMode.setStatus("mandatory")
_OutInit_Type = OnOff
_OutInit_Object = MibTableColumn
outInit = _OutInit_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 3, 2, 1, 6),
    _OutInit_Type()
)
outInit.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    outInit.setStatus("obsolete")
...
sensIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    sensValueRaw.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    sensUnitString.setStatus("mandatory")
_SensPortID_Type = Integer32
_SensPortID_Object = MibTableColumn
sensPortID = _SensPortID_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 3, 3, 1, 11),
    _SensPortID_Type()
)
sensPortID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    sensPortID.setStatus("mandatory")
_Log_ObjectIdentity = ObjectIdentity
log = _Log_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 21796, 3, 3, 30)
)
_LogRecordCount_Type = PositiveInteger
_LogRecordCount_Object = MibScalar
logRecordCount = _LogRecordCount_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 3, 30, 1),
    _LogRecordCount_Type()
)
logRecordCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    logRecordCount.setStatus("current")
_LogTimeRemain_Type = LogTimeRemain
_LogTimeRemain_Object = MibScalar
logTimeRemain = _LogTimeRemain_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 3, 30, 2),
    _LogTimeRemain_Type()
)
logTimeRemain.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    logTimeRemain.setStatus("current")
_LogPeriod_Type = PositiveInteger
_LogPeriod_Object = MibScalar
logPeriod = _LogPeriod_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 3, 30, 3),
    _LogPeriod_Type()
)
logPeriod.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    logPeriod.setStatus("current")
_LogIOEnabled_Type = OnOff
_LogIOEnabled_Object = MibScalar
logIOEnabled = _LogIOEnabled_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 3, 30, 4),
    _LogIOEnabled_Type()
)
logIOEnabled.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    logIOEnabled.setStatus("current")
_LogCmd_Type = LogCmd
_LogCmd_Object = MibScalar
logCmd = _LogCmd_Object(
    (1, 3, 6, 1, 4, 1, 21796, 3, 3, 30, 5),
    _LogCmd_Type()
)
logCmd.setMaxAccess("write-only")
if mibBuilder.loadTexts:
    logCmd.setStatus("current")
...
if mibBuilder.loadTexts:
    tsAlarmEntry.setStatus("mandatory")
...
tsAlarmIdx.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    tsAlarmIdx.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    tsAlarmDescr.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    tsAlarmSensName.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    tsAlarmTime.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    sensSetupTable.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    sensSetupEntry.setStatus("mandatory")
...
sensSetupIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    sensSetupIndex.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    sensSetupName.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    sensLimitMin.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    sensLimitMax.setStatus("mandatory")
...
if mibBuilder.loadTexts:
    sensHysteresis.setStatus("mandatory")
...
mibBuilder.exportSymbols(
    ...
    **{"PositiveInteger": PositiveInteger,
       ...
       "sensPortID": sensPortID,
       "log": log,
       "logRecordCount": logRecordCount,
       "logTimeRemain": logTimeRemain,
       "logPeriod": logPeriod,
       "logIOEnabled": logIOEnabled,
       "logCmd": logCmd,
       "tsAlarm": tsAlarm,
