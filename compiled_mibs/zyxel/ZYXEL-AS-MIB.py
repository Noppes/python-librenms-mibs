# SNMP MIB module (ZYXEL-AS-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\zyxel\ZYXEL-AS-MIB
...
accessSwitchFanRpmEntry.setIndexNames(
    (0, "ZYXEL-AS-MIB", "accessSwitchFanRpmIndex"),
)
if mibBuilder.loadTexts:
...
accessSwitchVoltageEntry.setIndexNames(
    (0, "ZYXEL-AS-MIB", "accessSwitchVoltageIndex"),
)
if mibBuilder.loadTexts:
...
accessSwitchSysTempEntry.setIndexNames(
    (0, "ZYXEL-AS-MIB", "accessSwitchSysTempIndex"),
)
if mibBuilder.loadTexts:
...
asDhcpServerIp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
asRadiusServerEntry.setIndexNames(
    (0, "ZYXEL-AS-MIB", "asRadiusServerIndex"),
)
if mibBuilder.loadTexts:
...
accessSwitchStats = _AccessSwitchStats_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 1, 2)
)
_AsMacStats_ObjectIdentity = ObjectIdentity
asMacStats = _AsMacStats_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 1, 2, 1)
)
_AsMacDisplayTarget_Type = Integer32
_AsMacDisplayTarget_Object = MibScalar
asMacDisplayTarget = _AsMacDisplayTarget_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 1, 2, 1, 1),
    _AsMacDisplayTarget_Type()
)
asMacDisplayTarget.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    asMacDisplayTarget.setStatus("current")
_AsMacTable_Object = MibTable
asMacTable = _AsMacTable_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 1, 2, 1, 2)
)
if mibBuilder.loadTexts:
    asMacTable.setStatus("current")
_AsMacEntry_Object = MibTableRow
asMacEntry = _AsMacEntry_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 1, 2, 1, 2, 1)
)
asMacEntry.setIndexNames(
    (0, "ZYXEL-AS-MIB", "asMacAddress"),
)
if mibBuilder.loadTexts:
    asMacEntry.setStatus("current")
_AsMacAddress_Type = MacAddress
_AsMacAddress_Object = MibTableColumn
asMacAddress = _AsMacAddress_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 1, 2, 1, 2, 1, 1),
    _AsMacAddress_Type()
)
asMacAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    asMacAddress.setStatus("current")
_AsMacPort_Type = Integer32
_AsMacPort_Object = MibTableColumn
asMacPort = _AsMacPort_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 1, 2, 1, 2, 1, 2),
    _AsMacPort_Type()
)
asMacPort.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    asMacPort.setStatus("current")


class _AsMacStatus_Type(Integer32):
    """Custom type asMacStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_AsMacStatus_Type.__name__ = "Integer32"
_AsMacStatus_Object = MibTableColumn
asMacStatus = _AsMacStatus_Object(
    (1, 3, 6, 1, 4, 1, 890, 1, 5, 1, 2, 1, 2, 1, 3),
    _AsMacStatus_Type()
)
asMacStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    asMacStatus.setStatus("current")
...
reboot.setObjects(
    ("ZYXEL-AS-MIB", "accessSwitchProblemCause")
)
if mibBuilder.loadTexts:
    reboot.setStatus(
        ""
...
overheat.setObjects(
      *(("ZYXEL-AS-MIB", "accessSwitchSysTempIndex"),
        ("ZYXEL-AS-MIB", "accessSwitchSysTempCurValue"),
        ("ZYXEL-AS-MIB", "accessSwitchSystemCurrentStatus"))
)
if mibBuilder.loadTexts:
    overheat.setStatus(
        ""
...
fanRpmLow.setObjects(
      *(("ZYXEL-AS-MIB", "accessSwitchFanRpmIndex"),
        ("ZYXEL-AS-MIB", "accessSwitchFanRpmCurValue"),
        ("ZYXEL-AS-MIB", "accessSwitchSystemCurrentStatus"))
)
if mibBuilder.loadTexts:
    fanRpmLow.setStatus(
...
voltageOutOfRange.setObjects(
      *(("ZYXEL-AS-MIB", "accessSwitchVoltageIndex"),
        ("ZYXEL-AS-MIB", "accessSwitchVoltageCurValue"),
        ("ZYXEL-AS-MIB", "accessSwitchSystemCurrentStatus"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ASSlotNum": ASSlotNum,
       ...
       "accessSwitchStats": accessSwitchStats,
       "asMacStats": asMacStats,
       "asMacDisplayTarget": asMacDisplayTarget,
       "asMacTable": asMacTable,
       "asMacEntry": asMacEntry,
       "asMacAddress": asMacAddress,
       "asMacPort": asMacPort,
       "asMacStatus": asMacStatus}
)
