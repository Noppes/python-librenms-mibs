# SNMP MIB module (EMC-1) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\morningstar\EMC-1
...
serialNumber = _SerialNumber_Object(
    (1, 3, 6, 1, 4, 1, 33333, 1, 1),
    _SerialNumber_Type()
)
serialNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    serialNumber.setStatus("current")
_FirmwareVersion_Type = Integer32
...
_FirmwareBuild_Type = Integer32
_FirmwareBuild_Object = MibScalar
firmwareBuild = _FirmwareBuild_Object(
    (1, 3, 6, 1, 4, 1, 33333, 1, 3),
    _FirmwareBuild_Type()
)
firmwareBuild.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    firmwareBuild.setStatus("current")
