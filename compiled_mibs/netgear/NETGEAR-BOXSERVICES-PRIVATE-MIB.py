# SNMP MIB module (NETGEAR-BOXSERVICES-PRIVATE-MIB) expressed in pysnmp data model.
#
...
boxServicesFansEntry.setIndexNames(
    (0, "NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesFanUnitIndex"),
    (0, "NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesFansIndex"),
)
if mibBuilder.loadTexts:
...
boxServicesFansIndex = _BoxServicesFansIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 6, 1, 1),
...
boxServicesFanItemType = _BoxServicesFanItemType_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 6, 1, 2),
...
boxServicesFanItemState = _BoxServicesFanItemState_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 6, 1, 3),
...
boxServicesFanSpeed = _BoxServicesFanSpeed_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 6, 1, 4),
...
boxServicesFanDutyLevel = _BoxServicesFanDutyLevel_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 6, 1, 5),
...
boxServicesFanUnitIndex = _BoxServicesFanUnitIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 6, 1, 6),
...
boxServicesPowSuppliesEntry.setIndexNames(
    (0, "NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesPowerSuppUnitIndex"),
    (0, "NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesPowSupplyIndex"),
)
if mibBuilder.loadTexts:
...
boxServicesPowSupplyIndex = _BoxServicesPowSupplyIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 7, 1, 1),
...
boxServicesPowSupplyItemType = _BoxServicesPowSupplyItemType_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 7, 1, 2),
...
boxServicesPowSupplyItemState = _BoxServicesPowSupplyItemState_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 7, 1, 3),
...
boxServicesPowerSuppUnitIndex = _BoxServicesPowerSuppUnitIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 7, 1, 4),
...
boxServicesTempSensorsEntry.setIndexNames(
    (0, "NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesUnitIndex"),
    (0, "NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesTempSensorIndex"),
)
if mibBuilder.loadTexts:
...
boxServicesUnitIndex = _BoxServicesUnitIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 8, 1, 1),
...
boxServicesTempSensorIndex = _BoxServicesTempSensorIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 8, 1, 2),
...
boxServicesTempSensorType = _BoxServicesTempSensorType_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 8, 1, 3),
...
boxServicesTempSensorState = _BoxServicesTempSensorState_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 8, 1, 4),
...
boxServicesTempSensorTemperature = _BoxServicesTempSensorTemperature_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 8, 1, 5),
...
boxServicesTempUnitEntry = _BoxServicesTempUnitEntry_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 15, 1)
)
boxServicesTempUnitEntry.setIndexNames(
    (0, "NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesTempUnitIndex"),
)
if mibBuilder.loadTexts:
...
boxServicesTempUnitIndex = _BoxServicesTempUnitIndex_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 15, 1, 1),
...
boxServicesTempUnitState = _BoxServicesTempUnitState_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 15, 1, 2),
...
boxServicesTempUnitTemperature = _BoxServicesTempUnitTemperature_Object(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 1, 15, 1, 3),
...
boxsFanStateChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 0, 1)
)
boxsFanStateChange.setObjects(
      *(("NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesFansIndex"),
        ("NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxsItemStateChangeEvent"))
)
if mibBuilder.loadTexts:
...
boxsPowSupplyStateChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 0, 2)
)
boxsPowSupplyStateChange.setObjects(
      *(("NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesPowSupplyIndex"),
        ("NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxsItemStateChangeEvent"))
)
if mibBuilder.loadTexts:
...
boxsTemperatureChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 0, 3)
)
boxsTemperatureChange.setObjects(
      *(("NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesTempSensorIndex"),
        ("NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxsTemperatureChangeEvent"))
)
if mibBuilder.loadTexts:
...
boxsThermalShutdown = NotificationType(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 0, 4)
)
boxsThermalShutdown.setObjects(
      *(("NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesThermalShutdownSensor"),
        ("NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesThermalShutdownTemperature"))
)
if mibBuilder.loadTexts:
...
boxsTemperatureStateChange = NotificationType(
    (1, 3, 6, 1, 4, 1, 4526, 10, 43, 0, 5)
)
boxsTemperatureStateChange.setObjects(
      *(("NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxServicesTempUnitIndex"),
        ("NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxsTemperatureStatusCurrentEvent"),
        ("NETGEAR-BOXSERVICES-PRIVATE-MIB", "boxsTemperatureStatusPreviousEvent"))
)
if mibBuilder.loadTexts:
