# SNMP MIB module (TERACOM-TCW220-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\teracom\TERACOM-TCW220-MIB
...
s11MINInt = _S11MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 1, 2, 2),
    _S11MINInt_Type()
)
...
s11HYSTInt = _S11HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 1, 2, 3),
    _S11HYSTInt_Type()
)
...
s12MINInt = _S12MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 1, 3, 2),
    _S12MINInt_Type()
)
...
s12HYSTInt = _S12HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 1, 3, 3),
    _S12HYSTInt_Type()
)
...
s21MINInt = _S21MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 2, 2, 2),
    _S21MINInt_Type()
)
...
s21HYSTInt = _S21HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 2, 2, 3),
    _S21HYSTInt_Type()
)
...
s22MINInt = _S22MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 2, 3, 2),
    _S22MINInt_Type()
)
...
s22HYSTInt = _S22HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 2, 3, 3),
    _S22HYSTInt_Type()
)
...
s31MINInt = _S31MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 3, 2, 2),
    _S31MINInt_Type()
)
...
s31HYSTInt = _S31HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 3, 2, 3),
    _S31HYSTInt_Type()
)
...
s32MINInt = _S32MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 3, 3, 2),
    _S32MINInt_Type()
)
...
s32HYSTInt = _S32HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 3, 3, 3),
    _S32HYSTInt_Type()
)
...
s41MINInt = _S41MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 4, 2, 2),
    _S41MINInt_Type()
)
...
s41HYSTInt = _S41HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 4, 2, 3),
    _S41HYSTInt_Type()
)
...
s42MINInt = _S42MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 4, 3, 2),
    _S42MINInt_Type()
)
...
s42HYSTInt = _S42HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 4, 3, 3),
    _S42HYSTInt_Type()
)
...
s51MINInt = _S51MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 5, 2, 2),
    _S51MINInt_Type()
)
...
s51HYSTInt = _S51HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 5, 2, 3),
    _S51HYSTInt_Type()
)
...
s52MINInt = _S52MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 5, 3, 2),
    _S52MINInt_Type()
)
...
s52HYSTInt = _S52HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 5, 3, 3),
    _S52HYSTInt_Type()
)
...
s61MINInt = _S61MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 6, 2, 2),
    _S61MINInt_Type()
)
...
s61HYSTInt = _S61HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 6, 2, 3),
    _S61HYSTInt_Type()
)
...
s62MINInt = _S62MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 6, 3, 2),
    _S62MINInt_Type()
)
...
s62HYSTInt = _S62HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 6, 3, 3),
    _S62HYSTInt_Type()
)
...
s71MINInt = _S71MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 7, 2, 2),
    _S71MINInt_Type()
)
...
s71HYSTInt = _S71HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 7, 2, 3),
    _S71HYSTInt_Type()
)
...
s72MINInt = _S72MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 7, 3, 2),
    _S72MINInt_Type()
)
...
s72HYSTInt = _S72HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 7, 3, 3),
    _S72HYSTInt_Type()
)
...
s81MINInt = _S81MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 8, 2, 2),
    _S81MINInt_Type()
)
...
s81HYSTInt = _S81HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 8, 2, 3),
    _S81HYSTInt_Type()
)
...
s82MINInt = _S82MINInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 8, 3, 2),
    _S82MINInt_Type()
)
...
s82HYSTInt = _S82HYSTInt_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 2, 2, 1, 8, 3, 3),
    _S82HYSTInt_Type()
)
...
s1Alarm = _S1Alarm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 1, 4)
)
_S11Al_Type = ALARMSTATUS
_S11Al_Object = MibScalar
s11Al = _S11Al_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 1, 4, 1),
    _S11Al_Type()
)
...
s2Alarm = _S2Alarm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 2, 4)
)
_S21Al_Type = ALARMSTATUS
_S21Al_Object = MibScalar
s21Al = _S21Al_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 2, 4, 1),
    _S21Al_Type()
)
...
s3Alarm = _S3Alarm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 3, 4)
)
_S31Al_Type = ALARMSTATUS
_S31Al_Object = MibScalar
s31Al = _S31Al_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 3, 4, 1),
    _S31Al_Type()
)
...
s4Alarm = _S4Alarm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 4, 4)
)
_S41Al_Type = ALARMSTATUS
_S41Al_Object = MibScalar
s41Al = _S41Al_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 4, 4, 1),
    _S41Al_Type()
)
...
s5Alarm = _S5Alarm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 5, 4)
)
_S51Al_Type = ALARMSTATUS
_S51Al_Object = MibScalar
s51Al = _S51Al_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 5, 4, 1),
    _S51Al_Type()
)
...
s6Alarm = _S6Alarm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 6, 4)
)
_S61Al_Type = ALARMSTATUS
_S61Al_Object = MibScalar
s61Al = _S61Al_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 6, 4, 1),
    _S61Al_Type()
)
...
s7Alarm = _S7Alarm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 7, 4)
)
_S71Al_Type = ALARMSTATUS
_S71Al_Object = MibScalar
s71Al = _S71Al_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 7, 4, 1),
    _S71Al_Type()
)
...
s8Alarm = _S8Alarm_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 8, 4)
)
_S81Al_Type = ALARMSTATUS
_S81Al_Object = MibScalar
s81Al = _S81Al_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 1, 8, 4, 1),
    _S81Al_Type()
)
...
virt4Al = _Virt4Al_Object(
    (1, 3, 6, 1, 4, 1, 38783, 2, 3, 11, 5, 4),
    _Virt4Al_Type()
)
virt4Al.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    virt4Al.setStatus("current")
_Tcw220MIBConformance_ObjectIdentity = ObjectIdentity
tcw220MIBConformance = _Tcw220MIBConformance_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 38783, 2, 4)
)
_Tcw220MIBCompliances_ObjectIdentity = ObjectIdentity
tcw220MIBCompliances = _Tcw220MIBCompliances_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 38783, 2, 4, 1)
)
_Tcw220MIBGroups_ObjectIdentity = ObjectIdentity
tcw220MIBGroups = _Tcw220MIBGroups_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 38783, 2, 4, 2)
)

# Managed Objects groups

tcw220ProductGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 38783, 2, 4, 2, 1)
)
tcw220ProductGroup.setObjects(
      *(("TERACOM-TCW220-MIB", "name"),
        ("TERACOM-TCW220-MIB", "version"),
        ("TERACOM-TCW220-MIB", "dateTime"))
)
if mibBuilder.loadTexts:
    tcw220ProductGroup.setStatus("current")

tcw220SetupGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 38783, 2, 4, 2, 2)
)
tcw220SetupGroup.setObjects(
      *(("TERACOM-TCW220-MIB", "deviceID"),
        ("TERACOM-TCW220-MIB", "hostName"),
        ("TERACOM-TCW220-MIB", "deviceIP"),
        ("TERACOM-TCW220-MIB", "s1description"),
        ("TERACOM-TCW220-MIB", "s11MAXInt"),
        ("TERACOM-TCW220-MIB", "s11MINInt"),
        ("TERACOM-TCW220-MIB", "s11HYSTInt"),
        ("TERACOM-TCW220-MIB", "s12MAXInt"),
        ("TERACOM-TCW220-MIB", "s12MINInt"),
        ("TERACOM-TCW220-MIB", "s12HYSTInt"),
        ("TERACOM-TCW220-MIB", "s2description"),
        ("TERACOM-TCW220-MIB", "s21MAXInt"),
        ("TERACOM-TCW220-MIB", "s21MINInt"),
        ("TERACOM-TCW220-MIB", "s21HYSTInt"),
        ("TERACOM-TCW220-MIB", "s22MAXInt"),
        ("TERACOM-TCW220-MIB", "s22MINInt"),
        ("TERACOM-TCW220-MIB", "s22HYSTInt"),
        ("TERACOM-TCW220-MIB", "s3description"),
        ("TERACOM-TCW220-MIB", "s31MAXInt"),
        ("TERACOM-TCW220-MIB", "s31MINInt"),
        ("TERACOM-TCW220-MIB", "s31HYSTInt"),
        ("TERACOM-TCW220-MIB", "s32MAXInt"),
        ("TERACOM-TCW220-MIB", "s32MINInt"),
        ("TERACOM-TCW220-MIB", "s32HYSTInt"),
        ("TERACOM-TCW220-MIB", "s4description"),
        ("TERACOM-TCW220-MIB", "s41MAXInt"),
        ("TERACOM-TCW220-MIB", "s41MINInt"),
        ("TERACOM-TCW220-MIB", "s41HYSTInt"),
        ("TERACOM-TCW220-MIB", "s42MAXInt"),
        ("TERACOM-TCW220-MIB", "s42MINInt"),
        ("TERACOM-TCW220-MIB", "s42HYSTInt"),
        ("TERACOM-TCW220-MIB", "s5description"),
        ("TERACOM-TCW220-MIB", "s51MAXInt"),
        ("TERACOM-TCW220-MIB", "s51MINInt"),
        ("TERACOM-TCW220-MIB", "s51HYSTInt"),
        ("TERACOM-TCW220-MIB", "s52MAXInt"),
        ("TERACOM-TCW220-MIB", "s52MINInt"),
        ("TERACOM-TCW220-MIB", "s52HYSTInt"),
        ("TERACOM-TCW220-MIB", "s6description"),
        ("TERACOM-TCW220-MIB", "s61MAXInt"),
        ("TERACOM-TCW220-MIB", "s61MINInt"),
        ("TERACOM-TCW220-MIB", "s61HYSTInt"),
        ("TERACOM-TCW220-MIB", "s62MAXInt"),
        ("TERACOM-TCW220-MIB", "s62MINInt"),
        ("TERACOM-TCW220-MIB", "s62HYSTInt"),
        ("TERACOM-TCW220-MIB", "s7description"),
        ("TERACOM-TCW220-MIB", "s71MAXInt"),
        ("TERACOM-TCW220-MIB", "s71MINInt"),
        ("TERACOM-TCW220-MIB", "s71HYSTInt"),
        ("TERACOM-TCW220-MIB", "s72MAXInt"),
        ("TERACOM-TCW220-MIB", "s72MINInt"),
        ("TERACOM-TCW220-MIB", "s72HYSTInt"),
        ("TERACOM-TCW220-MIB", "s8description"),
        ("TERACOM-TCW220-MIB", "s81MAXInt"),
        ("TERACOM-TCW220-MIB", "s81MINInt"),
        ("TERACOM-TCW220-MIB", "s81HYSTInt"),
        ("TERACOM-TCW220-MIB", "s82MAXInt"),
        ("TERACOM-TCW220-MIB", "s82MINInt"),
        ("TERACOM-TCW220-MIB", "s82HYSTInt"),
        ("TERACOM-TCW220-MIB", "voltage1description"),
        ("TERACOM-TCW220-MIB", "voltage1max"),
        ("TERACOM-TCW220-MIB", "voltage1min"),
        ("TERACOM-TCW220-MIB", "voltage1hyst"),
        ("TERACOM-TCW220-MIB", "voltage2description"),
        ("TERACOM-TCW220-MIB", "voltage2max"),
        ("TERACOM-TCW220-MIB", "voltage2min"),
        ("TERACOM-TCW220-MIB", "voltage2hyst"),
        ("TERACOM-TCW220-MIB", "digitalInput1description"),
        ("TERACOM-TCW220-MIB", "digitalInput2description"),
        ("TERACOM-TCW220-MIB", "relay1description"),
        ("TERACOM-TCW220-MIB", "relay1pulseWidth"),
        ("TERACOM-TCW220-MIB", "relay1controlledBy"),
        ("TERACOM-TCW220-MIB", "relay1action"),
        ("TERACOM-TCW220-MIB", "relay2description"),
        ("TERACOM-TCW220-MIB", "relay2pulseWidth"),
        ("TERACOM-TCW220-MIB", "relay2controlledBy"),
        ("TERACOM-TCW220-MIB", "relay2action"),
        ("TERACOM-TCW220-MIB", "virtualInput1description"),
        ("TERACOM-TCW220-MIB", "virtualInput1max"),
        ("TERACOM-TCW220-MIB", "virtualInput1min"),
        ("TERACOM-TCW220-MIB", "virtualInput1hyst"),
        ("TERACOM-TCW220-MIB", "virtualInput1Parent"),
        ("TERACOM-TCW220-MIB", "virtualInput2description"),
        ("TERACOM-TCW220-MIB", "virtualInput2max"),
        ("TERACOM-TCW220-MIB", "virtualInput2min"),
        ("TERACOM-TCW220-MIB", "virtualInput2hyst"),
        ("TERACOM-TCW220-MIB", "virtualInput2Parent"),
        ("TERACOM-TCW220-MIB", "virtualInput3description"),
        ("TERACOM-TCW220-MIB", "virtualInput3max"),
        ("TERACOM-TCW220-MIB", "virtualInput3min"),
        ("TERACOM-TCW220-MIB", "virtualInput3hyst"),
        ("TERACOM-TCW220-MIB", "virtualInput3Parent"),
        ("TERACOM-TCW220-MIB", "virtualInput4description"),
        ("TERACOM-TCW220-MIB", "virtualInput4max"),
        ("TERACOM-TCW220-MIB", "virtualInput4min"),
        ("TERACOM-TCW220-MIB", "virtualInput4hyst"),
        ("TERACOM-TCW220-MIB", "virtualInput4Parent"))
)
if mibBuilder.loadTexts:
    tcw220SetupGroup.setStatus("current")

tcw220MonitorGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 38783, 2, 4, 2, 3)
)
tcw220MonitorGroup.setObjects(
      *(("TERACOM-TCW220-MIB", "s11Int"),
        ("TERACOM-TCW220-MIB", "s12Int"),
        ("TERACOM-TCW220-MIB", "s1ID"),
        ("TERACOM-TCW220-MIB", "s11Al"),
        ("TERACOM-TCW220-MIB", "s12Al"),
        ("TERACOM-TCW220-MIB", "s21Int"),
        ("TERACOM-TCW220-MIB", "s22Int"),
        ("TERACOM-TCW220-MIB", "s2ID"),
        ("TERACOM-TCW220-MIB", "s21Al"),
        ("TERACOM-TCW220-MIB", "s22Al"),
        ("TERACOM-TCW220-MIB", "s31Int"),
        ("TERACOM-TCW220-MIB", "s32Int"),
        ("TERACOM-TCW220-MIB", "s3ID"),
        ("TERACOM-TCW220-MIB", "s31Al"),
        ("TERACOM-TCW220-MIB", "s32Al"),
        ("TERACOM-TCW220-MIB", "s41Int"),
        ("TERACOM-TCW220-MIB", "s42Int"),
        ("TERACOM-TCW220-MIB", "s4ID"),
        ("TERACOM-TCW220-MIB", "s41Al"),
        ("TERACOM-TCW220-MIB", "s42Al"),
        ("TERACOM-TCW220-MIB", "s51Int"),
        ("TERACOM-TCW220-MIB", "s52Int"),
        ("TERACOM-TCW220-MIB", "s5ID"),
        ("TERACOM-TCW220-MIB", "s51Al"),
        ("TERACOM-TCW220-MIB", "s52Al"),
        ("TERACOM-TCW220-MIB", "s61Int"),
        ("TERACOM-TCW220-MIB", "s62Int"),
        ("TERACOM-TCW220-MIB", "s6ID"),
        ("TERACOM-TCW220-MIB", "s61Al"),
        ("TERACOM-TCW220-MIB", "s62Al"),
        ("TERACOM-TCW220-MIB", "s71Int"),
        ("TERACOM-TCW220-MIB", "s72Int"),
        ("TERACOM-TCW220-MIB", "s7ID"),
        ("TERACOM-TCW220-MIB", "s71Al"),
        ("TERACOM-TCW220-MIB", "s72Al"),
        ("TERACOM-TCW220-MIB", "s81Int"),
        ("TERACOM-TCW220-MIB", "s82Int"),
        ("TERACOM-TCW220-MIB", "s8ID"),
        ("TERACOM-TCW220-MIB", "s81Al"),
        ("TERACOM-TCW220-MIB", "s82Al"),
        ("TERACOM-TCW220-MIB", "voltage1Int"),
        ("TERACOM-TCW220-MIB", "voltage2Int"),
        ("TERACOM-TCW220-MIB", "volt1Al"),
        ("TERACOM-TCW220-MIB", "volt2Al"),
        ("TERACOM-TCW220-MIB", "digitalInput1State"),
        ("TERACOM-TCW220-MIB", "digitalInput2State"),
        ("TERACOM-TCW220-MIB", "dig1Al"),
        ("TERACOM-TCW220-MIB", "dig2Al"),
        ("TERACOM-TCW220-MIB", "relay1State"),
        ("TERACOM-TCW220-MIB", "relay1Pulse"),
        ("TERACOM-TCW220-MIB", "relay2State"),
        ("TERACOM-TCW220-MIB", "relay2Pulse"),
        ("TERACOM-TCW220-MIB", "configurationSaved"),
        ("TERACOM-TCW220-MIB", "restartDevice"),
        ("TERACOM-TCW220-MIB", "temperatureUnit"),
        ("TERACOM-TCW220-MIB", "hardwareErr"),
        ("TERACOM-TCW220-MIB", "pressureUnit"),
        ("TERACOM-TCW220-MIB", "virtualInput1Int"),
        ("TERACOM-TCW220-MIB", "virtualInput2Int"),
        ("TERACOM-TCW220-MIB", "virtualInput3Int"),
        ("TERACOM-TCW220-MIB", "virtualInput4Int"),
        ("TERACOM-TCW220-MIB", "virt1Al"),
        ("TERACOM-TCW220-MIB", "virt2Al"),
        ("TERACOM-TCW220-MIB", "virt3Al"),
        ("TERACOM-TCW220-MIB", "virt4Al"))
)
if mibBuilder.loadTexts:
    tcw220MonitorGroup.setStatus("current")


# Notification objects

snmp_trap_notification = NotificationType(
    (1, 3, 6, 1, 4, 1, 38783, 2, 0, 1)
)
...
tcw220TrapGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 38783, 2, 4, 2, 4)
)
tcw220TrapGroup.setObjects(
    ("TERACOM-TCW220-MIB", "snmp-trap-notification")
)
if mibBuilder.loadTexts:
    tcw220TrapGroup.setStatus(
        "current"
    )
...
tcw220MIBCompliances1 = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 38783, 2, 4, 1, 1)
)
tcw220MIBCompliances1.setObjects(
      *(("TERACOM-TCW220-MIB", "tcw220ProductGroup"),
        ("TERACOM-TCW220-MIB", "tcw220SetupGroup"),
        ("TERACOM-TCW220-MIB", "tcw220MonitorGroup"),
        ("TERACOM-TCW220-MIB", "tcw220TrapGroup"))
)
if mibBuilder.loadTexts:
    tcw220MIBCompliances1.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"CONTROLLED": CONTROLLED,
       ...
       "virt3Al": virt3Al,
       "virt4Al": virt4Al,
       "tcw220MIBConformance": tcw220MIBConformance,
       "tcw220MIBCompliances": tcw220MIBCompliances,
       "tcw220MIBCompliances1": tcw220MIBCompliances1,
       "tcw220MIBGroups": tcw220MIBGroups,
       "tcw220ProductGroup": tcw220ProductGroup,
       "tcw220SetupGroup": tcw220SetupGroup,
       "tcw220MonitorGroup": tcw220MonitorGroup,
       "tcw220TrapGroup": tcw220TrapGroup,
       "snmpMIB": snmpMIB}
)
