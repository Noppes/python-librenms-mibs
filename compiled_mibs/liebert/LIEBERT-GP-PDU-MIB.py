...
# Notes
# -----
# ASN.1 source file://mibs\liebert\LIEBERT-GP-PDU-MIB
...
lgpPduGlobalData = _LgpPduGlobalData_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 5)
)
if mibBuilder.loadTexts:
    lgpPduGlobalData.setStatus("current")


class _LgpPduEntrySWOverTemperatureProtectionConfig_Type(Integer32):
    """Custom type lgpPduEntrySWOverTemperatureProtectionConfig based on Integer32"""
...
_LgpPduEntrySWOverTemperatureProtectionConfig_Type.__name__ = "Integer32"
_LgpPduEntrySWOverTemperatureProtectionConfig_Object = MibScalar
lgpPduEntrySWOverTemperatureProtectionConfig = _LgpPduEntrySWOverTemperatureProtectionConfig_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 5, 5),
    _LgpPduEntrySWOverTemperatureProtectionConfig_Type()
)
lgpPduEntrySWOverTemperatureProtectionConfig.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduEntrySWOverTemperatureProtectionConfig.setStatus("current")
...
lgpPduEntrySWOverTemperatureProtectionDelay = _LgpPduEntrySWOverTemperatureProtectionDelay_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 5, 10),
    _LgpPduEntrySWOverTemperatureProtectionDelay_Type()
)
lgpPduEntrySWOverTemperatureProtectionDelay.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduEntrySWOverTemperatureProtectionDelay.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduEntrySWOverTemperatureProtectionDelay.setUnits("Seconds")
...
class _LgpPduEntrySWOverCurrentProtection_Type(Integer32):
    """Custom type lgpPduEntrySWOverCurrentProtection based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LgpPduEntrySWOverCurrentProtection_Type.__name__ = "Integer32"
_LgpPduEntrySWOverCurrentProtection_Object = MibTableColumn
lgpPduEntrySWOverCurrentProtection = _LgpPduEntrySWOverCurrentProtection_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 20, 1, 55),
    _LgpPduEntrySWOverCurrentProtection_Type()
)
lgpPduEntrySWOverCurrentProtection.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduEntrySWOverCurrentProtection.setStatus("current")
...
lgpPduPsEntryUnbalancedLoadThrshldAlarm = _LgpPduPsEntryUnbalancedLoadThrshldAlarm_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 30, 20, 1, 85),
    _LgpPduPsEntryUnbalancedLoadThrshldAlarm_Type()
)
lgpPduPsEntryUnbalancedLoadThrshldAlarm.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduPsEntryUnbalancedLoadThrshldAlarm.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduPsEntryUnbalancedLoadThrshldAlarm.setUnits("Percent")
_LgpPduPsEntryApTotal_Type = Unsigned32
_LgpPduPsEntryApTotal_Object = MibTableColumn
lgpPduPsEntryApTotal = _LgpPduPsEntryApTotal_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 30, 20, 1, 90),
    _LgpPduPsEntryApTotal_Type()
)
lgpPduPsEntryApTotal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduPsEntryApTotal.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduPsEntryApTotal.setUnits("VoltAmp")
_LgpPduPsEntryPfTotal_Type = Integer32
_LgpPduPsEntryPfTotal_Object = MibTableColumn
lgpPduPsEntryPfTotal = _LgpPduPsEntryPfTotal_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 30, 20, 1, 95),
    _LgpPduPsEntryPfTotal_Type()
)
lgpPduPsEntryPfTotal.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduPsEntryPfTotal.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduPsEntryPfTotal.setUnits("0.01 Power Factor")
_LgpPduPsEntryEcResidual_Type = Unsigned32
_LgpPduPsEntryEcResidual_Object = MibTableColumn
lgpPduPsEntryEcResidual = _LgpPduPsEntryEcResidual_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 30, 20, 1, 100),
    _LgpPduPsEntryEcResidual_Type()
)
lgpPduPsEntryEcResidual.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduPsEntryEcResidual.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduPsEntryEcResidual.setUnits("0.001 Amp-AC-RMS")
_LgpPduPsEntryEcResidualThrshldOvrAlarm_Type = Unsigned32
_LgpPduPsEntryEcResidualThrshldOvrAlarm_Object = MibTableColumn
lgpPduPsEntryEcResidualThrshldOvrAlarm = _LgpPduPsEntryEcResidualThrshldOvrAlarm_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 30, 20, 1, 105),
    _LgpPduPsEntryEcResidualThrshldOvrAlarm_Type()
)
lgpPduPsEntryEcResidualThrshldOvrAlarm.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduPsEntryEcResidualThrshldOvrAlarm.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduPsEntryEcResidualThrshldOvrAlarm.setUnits("0.001 Amp-AC-RMS")
...
lgpPduPsLineEntryPwrLN = _LgpPduPsLineEntryPwrLN_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 30, 40, 1, 63),
    _LgpPduPsLineEntryPwrLN_Type()
)
lgpPduPsLineEntryPwrLN.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryPwrLN.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryPwrLN.setUnits("Watt")
_LgpPduPsLineEntryPwrLL_Type = Unsigned32
_LgpPduPsLineEntryPwrLL_Object = MibTableColumn
lgpPduPsLineEntryPwrLL = _LgpPduPsLineEntryPwrLL_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 30, 40, 1, 64),
    _LgpPduPsLineEntryPwrLL_Type()
)
lgpPduPsLineEntryPwrLL.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryPwrLL.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryPwrLL.setUnits("Watt")
_LgpPduPsLineEntryApLN_Type = Unsigned32
_LgpPduPsLineEntryApLN_Object = MibTableColumn
lgpPduPsLineEntryApLN = _LgpPduPsLineEntryApLN_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 30, 40, 1, 65),
    _LgpPduPsLineEntryApLN_Type()
)
lgpPduPsLineEntryApLN.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryApLN.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryApLN.setUnits("VoltAmp")
_LgpPduPsLineEntryApLL_Type = Unsigned32
_LgpPduPsLineEntryApLL_Object = MibTableColumn
lgpPduPsLineEntryApLL = _LgpPduPsLineEntryApLL_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 30, 40, 1, 66),
    _LgpPduPsLineEntryApLL_Type()
)
lgpPduPsLineEntryApLL.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryApLL.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryApLL.setUnits("VoltAmp")
_LgpPduPsLineEntryPfLN_Type = Integer32
_LgpPduPsLineEntryPfLN_Object = MibTableColumn
lgpPduPsLineEntryPfLN = _LgpPduPsLineEntryPfLN_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 30, 40, 1, 67),
    _LgpPduPsLineEntryPfLN_Type()
)
lgpPduPsLineEntryPfLN.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryPfLN.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryPfLN.setUnits("0.01 Power Factor")
_LgpPduPsLineEntryPfLL_Type = Integer32
_LgpPduPsLineEntryPfLL_Object = MibTableColumn
lgpPduPsLineEntryPfLL = _LgpPduPsLineEntryPfLL_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 30, 40, 1, 68),
    _LgpPduPsLineEntryPfLL_Type()
)
lgpPduPsLineEntryPfLL.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryPfLL.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduPsLineEntryPfLL.setUnits("0.01 Power Factor")
...
class _LgpPduRbEntrySwOverCurrentProtection_Type(Integer32):
    """Custom type lgpPduRbEntrySwOverCurrentProtection based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LgpPduRbEntrySwOverCurrentProtection_Type.__name__ = "Integer32"
_LgpPduRbEntrySwOverCurrentProtection_Object = MibTableColumn
lgpPduRbEntrySwOverCurrentProtection = _LgpPduRbEntrySwOverCurrentProtection_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 40, 20, 1, 175),
    _LgpPduRbEntrySwOverCurrentProtection_Type()
)
lgpPduRbEntrySwOverCurrentProtection.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRbEntrySwOverCurrentProtection.setStatus("current")
...
class _LgpPduRcpEntryPwrUpState_Type(Integer32):
    """Custom type lgpPduRcpEntryPwrUpState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_LgpPduRcpEntryPwrUpState_Type.__name__ = "Integer32"
_LgpPduRcpEntryPwrUpState_Object = MibTableColumn
lgpPduRcpEntryPwrUpState = _LgpPduRcpEntryPwrUpState_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 20, 1, 96),
    _LgpPduRcpEntryPwrUpState_Type()
)
lgpPduRcpEntryPwrUpState.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpEntryPwrUpState.setStatus("current")
...
class _LgpPduRcpEntrySwOverTemperatureProtection_Type(Integer32):
    """Custom type lgpPduRcpEntrySwOverTemperatureProtection based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LgpPduRcpEntrySwOverTemperatureProtection_Type.__name__ = "Integer32"
_LgpPduRcpEntrySwOverTemperatureProtection_Object = MibTableColumn
lgpPduRcpEntrySwOverTemperatureProtection = _LgpPduRcpEntrySwOverTemperatureProtection_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 20, 1, 205),
    _LgpPduRcpEntrySwOverTemperatureProtection_Type()
)
lgpPduRcpEntrySwOverTemperatureProtection.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpEntrySwOverTemperatureProtection.setStatus("current")


class _LgpPduRcpEntryOperationCondition_Type(Integer32):
    """Custom type lgpPduRcpEntryOperationCondition based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_LgpPduRcpEntryOperationCondition_Type.__name__ = "Integer32"
_LgpPduRcpEntryOperationCondition_Object = MibTableColumn
lgpPduRcpEntryOperationCondition = _LgpPduRcpEntryOperationCondition_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 20, 1, 210),
    _LgpPduRcpEntryOperationCondition_Type()
)
lgpPduRcpEntryOperationCondition.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduRcpEntryOperationCondition.setStatus("current")


class _LgpPduRcpEntryCriticality_Type(Integer32):
    """Custom type lgpPduRcpEntryCriticality based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LgpPduRcpEntryCriticality_Type.__name__ = "Integer32"
_LgpPduRcpEntryCriticality_Object = MibTableColumn
lgpPduRcpEntryCriticality = _LgpPduRcpEntryCriticality_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 20, 1, 215),
    _LgpPduRcpEntryCriticality_Type()
)
lgpPduRcpEntryCriticality.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpEntryCriticality.setStatus("current")
_LgpPduRcpEntryPostOnDelay_Type = Unsigned32
_LgpPduRcpEntryPostOnDelay_Object = MibTableColumn
lgpPduRcpEntryPostOnDelay = _LgpPduRcpEntryPostOnDelay_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 20, 1, 220),
    _LgpPduRcpEntryPostOnDelay_Type()
)
lgpPduRcpEntryPostOnDelay.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpEntryPostOnDelay.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduRcpEntryPostOnDelay.setUnits("Seconds")
_LgpPduRcpEntryPostOffDelay_Type = Unsigned32
_LgpPduRcpEntryPostOffDelay_Object = MibTableColumn
lgpPduRcpEntryPostOffDelay = _LgpPduRcpEntryPostOffDelay_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 20, 1, 225),
    _LgpPduRcpEntryPostOffDelay_Type()
)
lgpPduRcpEntryPostOffDelay.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpEntryPostOffDelay.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduRcpEntryPostOffDelay.setUnits("Seconds")
_LgpPduRcpEntryAddReceptacleToGroup_Type = ObjectIdentifier
_LgpPduRcpEntryAddReceptacleToGroup_Object = MibTableColumn
lgpPduRcpEntryAddReceptacleToGroup = _LgpPduRcpEntryAddReceptacleToGroup_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 20, 1, 230),
    _LgpPduRcpEntryAddReceptacleToGroup_Type()
)
lgpPduRcpEntryAddReceptacleToGroup.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpEntryAddReceptacleToGroup.setStatus("current")
...
lgpPduRcpEntryRemoveReceptacleFromGroup = _LgpPduRcpEntryRemoveReceptacleFromGroup_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 20, 1, 235),
    _LgpPduRcpEntryRemoveReceptacleFromGroup_Type()
)
lgpPduRcpEntryRemoveReceptacleFromGroup.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpEntryRemoveReceptacleFromGroup.setStatus("current")
_LgpPduRcpGroup_ObjectIdentity = ObjectIdentity
lgpPduRcpGroup = _LgpPduRcpGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30)
)
if mibBuilder.loadTexts:
    lgpPduRcpGroup.setStatus("current")
_LgpPduRcpGroupTableCount_Type = Unsigned32
_LgpPduRcpGroupTableCount_Object = MibScalar
lgpPduRcpGroupTableCount = _LgpPduRcpGroupTableCount_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 9),
    _LgpPduRcpGroupTableCount_Type()
)
lgpPduRcpGroupTableCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduRcpGroupTableCount.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduRcpGroupTableCount.setUnits("Count")
_LgpPduRcpGroupTable_Object = MibTable
lgpPduRcpGroupTable = _LgpPduRcpGroupTable_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 10)
)
if mibBuilder.loadTexts:
    lgpPduRcpGroupTable.setStatus("current")
_LgpPduRcpGroupEntry_Object = MibTableRow
lgpPduRcpGroupEntry = _LgpPduRcpGroupEntry_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 10, 1)
)
lgpPduRcpGroupEntry.setIndexNames(
    (0, "LIEBERT-GP-PDU-MIB", "lgpPduRcpGroupIndex"),
)
if mibBuilder.loadTexts:
    lgpPduRcpGroupEntry.setStatus("current")
_LgpPduRcpGroupIndex_Type = Unsigned32
_LgpPduRcpGroupIndex_Object = MibTableColumn
lgpPduRcpGroupIndex = _LgpPduRcpGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 10, 1, 1),
    _LgpPduRcpGroupIndex_Type()
)
lgpPduRcpGroupIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    lgpPduRcpGroupIndex.setStatus("current")
_LgpPduRcpGroupUsrLabel_Type = DisplayString
_LgpPduRcpGroupUsrLabel_Object = MibTableColumn
lgpPduRcpGroupUsrLabel = _LgpPduRcpGroupUsrLabel_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 10, 1, 10),
    _LgpPduRcpGroupUsrLabel_Type()
)
lgpPduRcpGroupUsrLabel.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpGroupUsrLabel.setStatus("current")


class _LgpPduRcpGroupDeleteGroup_Type(Integer32):
    """Custom type lgpPduRcpGroupDeleteGroup based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LgpPduRcpGroupDeleteGroup_Type.__name__ = "Integer32"
_LgpPduRcpGroupDeleteGroup_Object = MibTableColumn
lgpPduRcpGroupDeleteGroup = _LgpPduRcpGroupDeleteGroup_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 10, 1, 20),
    _LgpPduRcpGroupDeleteGroup_Type()
)
lgpPduRcpGroupDeleteGroup.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpGroupDeleteGroup.setStatus("current")


class _LgpPduRcpGroupControlPower_Type(Integer32):
    """Custom type lgpPduRcpGroupControlPower based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LgpPduRcpGroupControlPower_Type.__name__ = "Integer32"
_LgpPduRcpGroupControlPower_Object = MibTableColumn
lgpPduRcpGroupControlPower = _LgpPduRcpGroupControlPower_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 10, 1, 30),
    _LgpPduRcpGroupControlPower_Type()
)
lgpPduRcpGroupControlPower.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpGroupControlPower.setStatus("current")


class _LgpPduRcpGroupControlLock_Type(Integer32):
    """Custom type lgpPduRcpGroupControlLock based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LgpPduRcpGroupControlLock_Type.__name__ = "Integer32"
_LgpPduRcpGroupControlLock_Object = MibTableColumn
lgpPduRcpGroupControlLock = _LgpPduRcpGroupControlLock_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 10, 1, 40),
    _LgpPduRcpGroupControlLock_Type()
)
lgpPduRcpGroupControlLock.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpGroupControlLock.setStatus("current")


class _LgpPduRcpGroupBlinkLED_Type(Integer32):
    """Custom type lgpPduRcpGroupBlinkLED based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LgpPduRcpGroupBlinkLED_Type.__name__ = "Integer32"
_LgpPduRcpGroupBlinkLED_Object = MibTableColumn
lgpPduRcpGroupBlinkLED = _LgpPduRcpGroupBlinkLED_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 10, 1, 50),
    _LgpPduRcpGroupBlinkLED_Type()
)
lgpPduRcpGroupBlinkLED.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduRcpGroupBlinkLED.setStatus("current")
_LgpPduRcpGroupDisplayTableCount_Type = Unsigned32
_LgpPduRcpGroupDisplayTableCount_Object = MibScalar
lgpPduRcpGroupDisplayTableCount = _LgpPduRcpGroupDisplayTableCount_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 19),
    _LgpPduRcpGroupDisplayTableCount_Type()
)
lgpPduRcpGroupDisplayTableCount.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduRcpGroupDisplayTableCount.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduRcpGroupDisplayTableCount.setUnits("Count")
_LgpPduRcpGroupDisplayTable_Object = MibTable
lgpPduRcpGroupDisplayTable = _LgpPduRcpGroupDisplayTable_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 20)
)
if mibBuilder.loadTexts:
    lgpPduRcpGroupDisplayTable.setStatus("current")
_LgpPduRcpGroupDisplayEntry_Object = MibTableRow
lgpPduRcpGroupDisplayEntry = _LgpPduRcpGroupDisplayEntry_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 20, 1)
)
lgpPduRcpGroupDisplayEntry.setIndexNames(
    (0, "LIEBERT-GP-PDU-MIB", "lgpPduRcpGroupIndex"),
    (0, "LIEBERT-GP-PDU-MIB", "lgpPduEntryIndex"),
)
if mibBuilder.loadTexts:
    lgpPduRcpGroupDisplayEntry.setStatus("current")
_LgpPduRcpGroupDisplayIndex_Type = Unsigned32
_LgpPduRcpGroupDisplayIndex_Object = MibTableColumn
lgpPduRcpGroupDisplayIndex = _LgpPduRcpGroupDisplayIndex_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 20, 1, 10),
    _LgpPduRcpGroupDisplayIndex_Type()
)
lgpPduRcpGroupDisplayIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    lgpPduRcpGroupDisplayIndex.setStatus("current")
_LgpPduRcpGroupDisplayGroup_Type = DisplayString
_LgpPduRcpGroupDisplayGroup_Object = MibTableColumn
lgpPduRcpGroupDisplayGroup = _LgpPduRcpGroupDisplayGroup_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 50, 30, 20, 1, 20),
    _LgpPduRcpGroupDisplayGroup_Type()
)
lgpPduRcpGroupDisplayGroup.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduRcpGroupDisplayGroup.setStatus("current")
...
lgpPduAuxMeasDiffPressure = _LgpPduAuxMeasDiffPressure_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 60, 15, 1, 140),
    _LgpPduAuxMeasDiffPressure_Type()
)
lgpPduAuxMeasDiffPressure.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduAuxMeasDiffPressure.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduAuxMeasDiffPressure.setUnits("0.1 Pascal")
_LgpPduAuxMeasDiffPressureThrshldUndrAlm_Type = Integer32
_LgpPduAuxMeasDiffPressureThrshldUndrAlm_Object = MibTableColumn
lgpPduAuxMeasDiffPressureThrshldUndrAlm = _LgpPduAuxMeasDiffPressureThrshldUndrAlm_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 60, 15, 1, 145),
    _LgpPduAuxMeasDiffPressureThrshldUndrAlm_Type()
)
lgpPduAuxMeasDiffPressureThrshldUndrAlm.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduAuxMeasDiffPressureThrshldUndrAlm.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduAuxMeasDiffPressureThrshldUndrAlm.setUnits("0.1 Pascal")
_LgpPduAuxMeasDiffPressureThrshldOvrAlm_Type = Integer32
_LgpPduAuxMeasDiffPressureThrshldOvrAlm_Object = MibTableColumn
lgpPduAuxMeasDiffPressureThrshldOvrAlm = _LgpPduAuxMeasDiffPressureThrshldOvrAlm_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 60, 15, 1, 150),
    _LgpPduAuxMeasDiffPressureThrshldOvrAlm_Type()
)
lgpPduAuxMeasDiffPressureThrshldOvrAlm.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduAuxMeasDiffPressureThrshldOvrAlm.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduAuxMeasDiffPressureThrshldOvrAlm.setUnits("0.1 Pascal")
_LgpPduAuxMeasDiffPressureThrshldUndrWarn_Type = Integer32
_LgpPduAuxMeasDiffPressureThrshldUndrWarn_Object = MibTableColumn
lgpPduAuxMeasDiffPressureThrshldUndrWarn = _LgpPduAuxMeasDiffPressureThrshldUndrWarn_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 60, 15, 1, 155),
    _LgpPduAuxMeasDiffPressureThrshldUndrWarn_Type()
)
lgpPduAuxMeasDiffPressureThrshldUndrWarn.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduAuxMeasDiffPressureThrshldUndrWarn.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduAuxMeasDiffPressureThrshldUndrWarn.setUnits("0.1 Pascal")
_LgpPduAuxMeasDiffPressureThrshldOvrWarn_Type = Integer32
_LgpPduAuxMeasDiffPressureThrshldOvrWarn_Object = MibTableColumn
lgpPduAuxMeasDiffPressureThrshldOvrWarn = _LgpPduAuxMeasDiffPressureThrshldOvrWarn_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 60, 15, 1, 160),
    _LgpPduAuxMeasDiffPressureThrshldOvrWarn_Type()
)
lgpPduAuxMeasDiffPressureThrshldOvrWarn.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduAuxMeasDiffPressureThrshldOvrWarn.setStatus("current")
if mibBuilder.loadTexts:
    lgpPduAuxMeasDiffPressureThrshldOvrWarn.setUnits("0.1 Pascal")


class _LgpPduAuxMeasLeakDetectState_Type(Integer32):
    """Custom type lgpPduAuxMeasLeakDetectState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_LgpPduAuxMeasLeakDetectState_Type.__name__ = "Integer32"
_LgpPduAuxMeasLeakDetectState_Object = MibTableColumn
lgpPduAuxMeasLeakDetectState = _LgpPduAuxMeasLeakDetectState_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 60, 15, 1, 165),
    _LgpPduAuxMeasLeakDetectState_Type()
)
lgpPduAuxMeasLeakDetectState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    lgpPduAuxMeasLeakDetectState.setStatus("current")
_LgpPduAuxMeasOrderTable_Object = MibTable
lgpPduAuxMeasOrderTable = _LgpPduAuxMeasOrderTable_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 60, 20)
)
if mibBuilder.loadTexts:
    lgpPduAuxMeasOrderTable.setStatus("current")
_LgpPduAuxMeasOrderEntry_Object = MibTableRow
lgpPduAuxMeasOrderEntry = _LgpPduAuxMeasOrderEntry_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 60, 20, 1)
)
lgpPduAuxMeasOrderEntry.setIndexNames(
    (0, "LIEBERT-GP-PDU-MIB", "lgpPduEntryIndex"),
    (0, "LIEBERT-GP-PDU-MIB", "lgpPduAuxSensorOrderIndex"),
)
if mibBuilder.loadTexts:
    lgpPduAuxMeasOrderEntry.setStatus("current")
_LgpPduAuxSensorOrderIndex_Type = Unsigned32
_LgpPduAuxSensorOrderIndex_Object = MibTableColumn
lgpPduAuxSensorOrderIndex = _LgpPduAuxSensorOrderIndex_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 60, 20, 1, 5),
    _LgpPduAuxSensorOrderIndex_Type()
)
lgpPduAuxSensorOrderIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    lgpPduAuxSensorOrderIndex.setStatus("current")
_LgpPduAuxMeasOrderSensorSerialNum_Type = DisplayString
_LgpPduAuxMeasOrderSensorSerialNum_Object = MibTableColumn
lgpPduAuxMeasOrderSensorSerialNum = _LgpPduAuxMeasOrderSensorSerialNum_Object(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 8, 60, 20, 1, 15),
    _LgpPduAuxMeasOrderSensorSerialNum_Type()
)
lgpPduAuxMeasOrderSensorSerialNum.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    lgpPduAuxMeasOrderSensorSerialNum.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"liebertGlobalProductsPduModule": liebertGlobalProductsPduModule,
       "lgpPduGlobalData": lgpPduGlobalData,
       "lgpPduEntrySWOverTemperatureProtectionConfig": lgpPduEntrySWOverTemperatureProtectionConfig,
       "lgpPduEntrySWOverTemperatureProtectionDelay": lgpPduEntrySWOverTemperatureProtectionDelay,
       ...
       "lgpPduEntrySWOverCurrentProtection": lgpPduEntrySWOverCurrentProtection,
       ...
       "lgpPduPsEntryUnbalancedLoadThrshldAlarm": lgpPduPsEntryUnbalancedLoadThrshldAlarm,
       "lgpPduPsEntryApTotal": lgpPduPsEntryApTotal,
       "lgpPduPsEntryPfTotal": lgpPduPsEntryPfTotal,
       "lgpPduPsEntryEcResidual": lgpPduPsEntryEcResidual,
       "lgpPduPsEntryEcResidualThrshldOvrAlarm": lgpPduPsEntryEcResidualThrshldOvrAlarm,
       ...
       "lgpPduPsLineEntryPwrLN": lgpPduPsLineEntryPwrLN,
       "lgpPduPsLineEntryPwrLL": lgpPduPsLineEntryPwrLL,
       "lgpPduPsLineEntryApLN": lgpPduPsLineEntryApLN,
       "lgpPduPsLineEntryApLL": lgpPduPsLineEntryApLL,
       "lgpPduPsLineEntryPfLN": lgpPduPsLineEntryPfLN,
       "lgpPduPsLineEntryPfLL": lgpPduPsLineEntryPfLL,
       ...
       "lgpPduRbEntrySwOverCurrentProtection": lgpPduRbEntrySwOverCurrentProtection,
       ...
       "lgpPduRcpEntryPwrUpState": lgpPduRcpEntryPwrUpState,
       ...
       "lgpPduRcpEntryCriticality": lgpPduRcpEntryCriticality,
       "lgpPduRcpEntryPostOnDelay": lgpPduRcpEntryPostOnDelay,
       "lgpPduRcpEntryPostOffDelay": lgpPduRcpEntryPostOffDelay,
       "lgpPduRcpEntryAddReceptacleToGroup": lgpPduRcpEntryAddReceptacleToGroup,
       "lgpPduRcpEntryRemoveReceptacleFromGroup": lgpPduRcpEntryRemoveReceptacleFromGroup,
       "lgpPduRcpGroup": lgpPduRcpGroup,
       "lgpPduRcpGroupTableCount": lgpPduRcpGroupTableCount,
       "lgpPduRcpGroupTable": lgpPduRcpGroupTable,
       "lgpPduRcpGroupEntry": lgpPduRcpGroupEntry,
       "lgpPduRcpGroupIndex": lgpPduRcpGroupIndex,
       "lgpPduRcpGroupUsrLabel": lgpPduRcpGroupUsrLabel,
       "lgpPduRcpGroupDeleteGroup": lgpPduRcpGroupDeleteGroup,
       "lgpPduRcpGroupControlPower": lgpPduRcpGroupControlPower,
       "lgpPduRcpGroupControlLock": lgpPduRcpGroupControlLock,
       "lgpPduRcpGroupBlinkLED": lgpPduRcpGroupBlinkLED,
       "lgpPduRcpGroupDisplayTableCount": lgpPduRcpGroupDisplayTableCount,
       "lgpPduRcpGroupDisplayTable": lgpPduRcpGroupDisplayTable,
       "lgpPduRcpGroupDisplayEntry": lgpPduRcpGroupDisplayEntry,
       "lgpPduRcpGroupDisplayIndex": lgpPduRcpGroupDisplayIndex,
       ...
       "lgpPduAuxMeasDiffPressure": lgpPduAuxMeasDiffPressure,
       "lgpPduAuxMeasDiffPressureThrshldUndrAlm": lgpPduAuxMeasDiffPressureThrshldUndrAlm,
       "lgpPduAuxMeasDiffPressureThrshldOvrAlm": lgpPduAuxMeasDiffPressureThrshldOvrAlm,
       "lgpPduAuxMeasDiffPressureThrshldUndrWarn": lgpPduAuxMeasDiffPressureThrshldUndrWarn,
       "lgpPduAuxMeasDiffPressureThrshldOvrWarn": lgpPduAuxMeasDiffPressureThrshldOvrWarn,
       "lgpPduAuxMeasLeakDetectState": lgpPduAuxMeasLeakDetectState,
       "lgpPduAuxMeasOrderTable": lgpPduAuxMeasOrderTable,
       "lgpPduAuxMeasOrderEntry": lgpPduAuxMeasOrderEntry,
