...
# Notes
# -----
# ASN.1 source file://mibs\liebert\LIEBERT-GP-AGENT-MIB
...
lgpAgentEventNotificationsLegacy = _LgpAgentEventNotificationsLegacy_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 2, 3, 0, 0)
)
if mibBuilder.loadTexts:
    lgpAgentEventNotificationsLegacy.setStatus("current")
...
lgpAgentDeviceCommunicationLostLegacy = NotificationType(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 2, 3, 0, 0, 1)
)
lgpAgentDeviceCommunicationLostLegacy.setObjects(
    ("SNMPv2-MIB", "sysUpTime")
)
if mibBuilder.loadTexts:
    lgpAgentDeviceCommunicationLostLegacy.setStatus(
        "current"
    )

lgpAgentFirmwareUpdateSuccessfulLegacy = NotificationType(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 2, 3, 0, 0, 5)
)
lgpAgentFirmwareUpdateSuccessfulLegacy.setObjects(
    ("SNMPv2-MIB", "sysUpTime")
)
if mibBuilder.loadTexts:
    lgpAgentFirmwareUpdateSuccessfulLegacy.setStatus(
        "current"
    )

lgpAgentFirmwareCorruptLegacy = NotificationType(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 2, 3, 0, 0, 6)
)
lgpAgentFirmwareCorruptLegacy.setObjects(
    ("SNMPv2-MIB", "sysUpTime")
)
if mibBuilder.loadTexts:
    lgpAgentFirmwareCorruptLegacy.setStatus(
        "current"
    )

lgpAgentHeartbeatLegacy = NotificationType(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 2, 3, 0, 0, 7)
)
lgpAgentHeartbeatLegacy.setObjects(
      *(("SNMPv2-MIB", "sysUpTime"),
        ("LIEBERT-GP-CONDITIONS-MIB", "lgpConditionsPresent"),
        ("LIEBERT-GP-AGENT-MIB", "lgpAgentConnectedDeviceCount"))
)
if mibBuilder.loadTexts:
    lgpAgentHeartbeatLegacy.setStatus(
        "current"
    )

lgpAgentDnsLookupFailureLegacy = NotificationType(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 2, 3, 0, 0, 8)
)
lgpAgentDnsLookupFailureLegacy.setObjects(
      *(("SNMPv2-MIB", "sysUpTime"),
        ("LIEBERT-GP-CONDITIONS-MIB", "lgpNetworkName"))
)
if mibBuilder.loadTexts:
    lgpAgentDnsLookupFailureLegacy.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"liebertAgentModule": liebertAgentModule,
       ...
       "lgpAgentFirmwareCorruptLegacy": lgpAgentFirmwareCorruptLegacy,
