...
# Notes
# -----
# ASN.1 source file://mibs\liebert\LIEBERT-GP-CONDITIONS-MIB
...
lgpConditionCompressor3Overload = _LgpConditionCompressor3Overload_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 2, 1, 8, 3)
)
if mibBuilder.loadTexts:
    lgpConditionCompressor3Overload.setStatus("current")
_LgpConditionCompressor4Overload_ObjectIdentity = ObjectIdentity
lgpConditionCompressor4Overload = _LgpConditionCompressor4Overload_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 2, 1, 8, 4)
)
if mibBuilder.loadTexts:
    lgpConditionCompressor4Overload.setStatus("current")
...
lgpConditionCompressor3ShortCycle = _LgpConditionCompressor3ShortCycle_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 2, 1, 9, 3)
)
if mibBuilder.loadTexts:
    lgpConditionCompressor3ShortCycle.setStatus("current")
_LgpConditionCompressor4ShortCycle_ObjectIdentity = ObjectIdentity
lgpConditionCompressor4ShortCycle = _LgpConditionCompressor4ShortCycle_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 2, 1, 9, 4)
)
if mibBuilder.loadTexts:
    lgpConditionCompressor4ShortCycle.setStatus("current")
...
lgpConditionCompressor3LowSuctionPressure = _LgpConditionCompressor3LowSuctionPressure_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 2, 1, 10, 3)
)
if mibBuilder.loadTexts:
    lgpConditionCompressor3LowSuctionPressure.setStatus("current")
_LgpConditionCompressor4LowSuctionPressure_ObjectIdentity = ObjectIdentity
lgpConditionCompressor4LowSuctionPressure = _LgpConditionCompressor4LowSuctionPressure_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 2, 1, 10, 4)
)
if mibBuilder.loadTexts:
    lgpConditionCompressor4LowSuctionPressure.setStatus("current")
...
lgpConditionCompressor2HighPressureSensorFailure = _LgpConditionCompressor2HighPressureSensorFailure_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 2, 1, 54, 27, 2)
)
if mibBuilder.loadTexts:
    lgpConditionCompressor2HighPressureSensorFailure.setStatus("current")
_LgpConditionCompressor3HighPressureSensorFailure_ObjectIdentity = ObjectIdentity
lgpConditionCompressor3HighPressureSensorFailure = _LgpConditionCompressor3HighPressureSensorFailure_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 2, 1, 54, 27, 3)
)
if mibBuilder.loadTexts:
    lgpConditionCompressor3HighPressureSensorFailure.setStatus("current")
_LgpConditionCompressor4HighPressureSensorFailure_ObjectIdentity = ObjectIdentity
lgpConditionCompressor4HighPressureSensorFailure = _LgpConditionCompressor4HighPressureSensorFailure_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 2, 1, 54, 27, 4)
)
if mibBuilder.loadTexts:
    lgpConditionCompressor4HighPressureSensorFailure.setStatus("current")
...
lgpConditionComp3PumpDownFailure = _LgpConditionComp3PumpDownFailure_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 2, 1, 130, 3)
)
if mibBuilder.loadTexts:
    lgpConditionComp3PumpDownFailure.setStatus("current")
_LgpConditionComp4PumpDownFailure_ObjectIdentity = ObjectIdentity
lgpConditionComp4PumpDownFailure = _LgpConditionComp4PumpDownFailure_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 476, 1, 42, 3, 2, 1, 130, 4)
)
if mibBuilder.loadTexts:
    lgpConditionComp4PumpDownFailure.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"liebertGlobalProductsConditionsModule": liebertGlobalProductsConditionsModule,
       ...
       "lgpConditionCompressor3Overload": lgpConditionCompressor3Overload,
       "lgpConditionCompressor4Overload": lgpConditionCompressor4Overload,
       ...
       "lgpConditionCompressor3ShortCycle": lgpConditionCompressor3ShortCycle,
       "lgpConditionCompressor4ShortCycle": lgpConditionCompressor4ShortCycle,
       ...
       "lgpConditionCompressor3LowSuctionPressure": lgpConditionCompressor3LowSuctionPressure,
       "lgpConditionCompressor4LowSuctionPressure": lgpConditionCompressor4LowSuctionPressure,
       ...
       "lgpConditionComp3PumpDownFailure": lgpConditionComp3PumpDownFailure,
       "lgpConditionComp4PumpDownFailure": lgpConditionComp4PumpDownFailure,
