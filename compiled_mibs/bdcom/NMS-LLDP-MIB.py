# SNMP MIB module (NMS-LLDP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\bdcom\NMS-LLDP-MIB
...
nmslldpMIB = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 3320, 127)
)
if mibBuilder.loadTexts:
    nmslldpMIB.setRevisions(
        ("2004-11-22 00:00",)
    )
...
lldpPortConfigEntry = _LldpPortConfigEntry_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 1, 6, 1)
)
lldpPortConfigEntry.setIndexNames(
    (0, "NMS-LLDP-MIB", "lldpPortConfigPortNum"),
)
if mibBuilder.loadTexts:
...
lldpPortConfigPortNum = _LldpPortConfigPortNum_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 1, 6, 1, 1),
...
lldpPortConfigAdminStatus = _LldpPortConfigAdminStatus_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 1, 6, 1, 2),
...
lldpPortConfigNotificationEnable = _LldpPortConfigNotificationEnable_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 1, 6, 1, 3),
...
lldpPortConfigTLVsTxEnable = _LldpPortConfigTLVsTxEnable_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 1, 6, 1, 4),
...
lldpConfigManAddrPortsTxEnable = _LldpConfigManAddrPortsTxEnable_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 1, 7, 1, 1),
...
lldpStatsTxPortEntry = _LldpStatsTxPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 2, 6, 1)
)
lldpStatsTxPortEntry.setIndexNames(
    (0, "NMS-LLDP-MIB", "lldpStatsTxPortNum"),
)
if mibBuilder.loadTexts:
...
lldpStatsTxPortNum = _LldpStatsTxPortNum_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 2, 6, 1, 1),
...
lldpStatsTxPortFramesTotal = _LldpStatsTxPortFramesTotal_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 2, 6, 1, 2),
...
lldpStatsRxPortEntry = _LldpStatsRxPortEntry_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 2, 7, 1)
)
lldpStatsRxPortEntry.setIndexNames(
    (0, "NMS-LLDP-MIB", "lldpStatsRxPortNum"),
)
if mibBuilder.loadTexts:
...
lldpStatsRxPortNum = _LldpStatsRxPortNum_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 2, 7, 1, 1),
...
lldpStatsRxPortFramesDiscardedTotal = _LldpStatsRxPortFramesDiscardedTotal_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 2, 7, 1, 2),
...
lldpStatsRxPortFramesErrors = _LldpStatsRxPortFramesErrors_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 2, 7, 1, 3),
...
lldpStatsRxPortFramesTotal = _LldpStatsRxPortFramesTotal_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 2, 7, 1, 4),
...
lldpStatsRxPortTLVsDiscardedTotal = _LldpStatsRxPortTLVsDiscardedTotal_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 2, 7, 1, 5),
...
lldpStatsRxPortTLVsUnrecognizedTotal = _LldpStatsRxPortTLVsUnrecognizedTotal_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 2, 7, 1, 6),
...
lldpStatsRxPortAgeoutsTotal = _LldpStatsRxPortAgeoutsTotal_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 2, 7, 1, 7),
...
lldpLocPortNum = _LldpLocPortNum_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 3, 7, 1, 1),
...
lldpLocPortIdSubtype = _LldpLocPortIdSubtype_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 3, 7, 1, 2),
...
lldpLocPortId = _LldpLocPortId_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 3, 7, 1, 3),
    _LldpLocPortId_Type()
)
...
lldpLocPortDesc = _LldpLocPortDesc_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 3, 7, 1, 4),
...
lldpLocManAddrEntry = _LldpLocManAddrEntry_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 3, 8, 1)
)
lldpLocManAddrEntry.setIndexNames(
    (0, "NMS-LLDP-MIB", "lldpLocManAddrSubtype"),
    (0, "NMS-LLDP-MIB", "lldpLocManAddr"),
)
if mibBuilder.loadTexts:
...
lldpLocManAddrSubtype = _LldpLocManAddrSubtype_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 3, 8, 1, 1),
...
lldpLocManAddr = _LldpLocManAddr_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 3, 8, 1, 2),
...
lldpLocManAddrLen = _LldpLocManAddrLen_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 3, 8, 1, 3),
...
lldpLocManAddrIfSubtype = _LldpLocManAddrIfSubtype_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 3, 8, 1, 4),
...
lldpLocManAddrOID = _LldpLocManAddrOID_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 3, 8, 1, 6),
...
lldpRemTimeMark = _LldpRemTimeMark_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 1, 1, 1),
...
lldpRemIndex = _LldpRemIndex_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 1, 1, 3),
    _LldpRemIndex_Type()
)
...
lldpRemChassisIdSubtype = _LldpRemChassisIdSubtype_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 1, 1, 4),
...
lldpRemChassisId = _LldpRemChassisId_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 1, 1, 5),
...
lldpRemPortIdSubtype = _LldpRemPortIdSubtype_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 1, 1, 6),
...
lldpRemPortId = _LldpRemPortId_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 1, 1, 7),
    _LldpRemPortId_Type()
)
...
lldpRemPortDesc = _LldpRemPortDesc_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 1, 1, 8),
...
lldpRemSysName = _LldpRemSysName_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 1, 1, 9),
...
lldpRemSysDesc = _LldpRemSysDesc_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 1, 1, 10),
...
lldpRemSysCapSupported = _LldpRemSysCapSupported_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 1, 1, 11),
...
lldpRemSysCapEnabled = _LldpRemSysCapEnabled_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 1, 1, 12),
...
lldpRemManAddrEntry = _LldpRemManAddrEntry_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 2, 1)
)
lldpRemManAddrEntry.setIndexNames(
    (0, "NMS-LLDP-MIB", "lldpRemTimeMark"),
    (0, "NMS-LLDP-MIB", "lldpRemLocalPortNum"),
    (0, "NMS-LLDP-MIB", "lldpRemIndex"),
    (0, "NMS-LLDP-MIB", "lldpRemManAddrSubtype"),
    (0, "NMS-LLDP-MIB", "lldpRemManAddr"),
)
if mibBuilder.loadTexts:
...
lldpRemManAddrSubtype = _LldpRemManAddrSubtype_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 2, 1, 1),
...
lldpRemManAddrIfSubtype = _LldpRemManAddrIfSubtype_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 2, 1, 3),
...
lldpRemManAddrIfId = _LldpRemManAddrIfId_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 2, 1, 4),
...
lldpRemManAddrOID = _LldpRemManAddrOID_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 2, 1, 5),
...
lldpRemUnknownTLVEntry = _LldpRemUnknownTLVEntry_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 3, 1)
)
lldpRemUnknownTLVEntry.setIndexNames(
    (0, "NMS-LLDP-MIB", "lldpRemTimeMark"),
    (0, "NMS-LLDP-MIB", "lldpRemLocalPortNum"),
    (0, "NMS-LLDP-MIB", "lldpRemIndex"),
    (0, "NMS-LLDP-MIB", "lldpRemUnknownTLVType"),
)
if mibBuilder.loadTexts:
...
lldpRemUnknownTLVType = _LldpRemUnknownTLVType_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 3, 1, 1),
...
lldpRemUnknownTLVInfo = _LldpRemUnknownTLVInfo_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 3, 1, 2),
...
lldpRemOrgDefInfoEntry = _LldpRemOrgDefInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 4, 1)
)
lldpRemOrgDefInfoEntry.setIndexNames(
    (0, "NMS-LLDP-MIB", "lldpRemTimeMark"),
    (0, "NMS-LLDP-MIB", "lldpRemLocalPortNum"),
    (0, "NMS-LLDP-MIB", "lldpRemIndex"),
    (0, "NMS-LLDP-MIB", "lldpRemOrgDefInfoOUI"),
    (0, "NMS-LLDP-MIB", "lldpRemOrgDefInfoSubtype"),
    (0, "NMS-LLDP-MIB", "lldpRemOrgDefInfoIndex"),
)
if mibBuilder.loadTexts:
...
lldpRemOrgDefInfoOUI = _LldpRemOrgDefInfoOUI_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 4, 1, 1),
...
lldpRemOrgDefInfoSubtype = _LldpRemOrgDefInfoSubtype_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 4, 1, 2),
...
lldpRemOrgDefInfoIndex = _LldpRemOrgDefInfoIndex_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 4, 1, 3),
...
lldpRemOrgDefInfo = _LldpRemOrgDefInfo_Object(
    (1, 3, 6, 1, 4, 1, 3320, 127, 1, 4, 4, 1, 4),
...
lldpConfigGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 3320, 127, 2, 2, 1)
)
lldpConfigGroup.setObjects(
    ("NMS-LLDP-MIB", "lldpPortConfigAdminStatus")
)
if mibBuilder.loadTexts:
    lldpConfigGroup.setStatus("current")

lldpConfigRxGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 3320, 127, 2, 2, 2)
)
lldpConfigRxGroup.setObjects(
      *(("NMS-LLDP-MIB", "lldpNotificationInterval"),
        ("NMS-LLDP-MIB", "lldpPortConfigNotificationEnable"))
)
if mibBuilder.loadTexts:
    lldpConfigRxGroup.setStatus("current")

lldpConfigTxGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 3320, 127, 2, 2, 3)
)
lldpConfigTxGroup.setObjects(
      *(("NMS-LLDP-MIB", "lldpMessageTxInterval"),
        ("NMS-LLDP-MIB", "lldpMessageTxHoldMultiplier"),
        ("NMS-LLDP-MIB", "lldpReinitDelay"),
        ("NMS-LLDP-MIB", "lldpTxDelay"),
        ("NMS-LLDP-MIB", "lldpPortConfigTLVsTxEnable"),
        ("NMS-LLDP-MIB", "lldpConfigManAddrPortsTxEnable"))
)
if mibBuilder.loadTexts:
    lldpConfigTxGroup.setStatus("current")

lldpStatsRxGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 3320, 127, 2, 2, 4)
)
lldpStatsRxGroup.setObjects(
      *(("NMS-LLDP-MIB", "lldpStatsRemTablesLastChangeTime"),
        ("NMS-LLDP-MIB", "lldpStatsRemTablesInserts"),
        ("NMS-LLDP-MIB", "lldpStatsRemTablesDeletes"),
        ("NMS-LLDP-MIB", "lldpStatsRemTablesDrops"),
        ("NMS-LLDP-MIB", "lldpStatsRemTablesAgeouts"),
        ("NMS-LLDP-MIB", "lldpStatsRxPortFramesDiscardedTotal"),
        ("NMS-LLDP-MIB", "lldpStatsRxPortFramesErrors"),
        ("NMS-LLDP-MIB", "lldpStatsRxPortFramesTotal"),
        ("NMS-LLDP-MIB", "lldpStatsRxPortTLVsDiscardedTotal"),
...
lldpStatsTxGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 3320, 127, 2, 2, 5)
)
lldpStatsTxGroup.setObjects(
    ("NMS-LLDP-MIB", "lldpStatsTxPortFramesTotal")
)
if mibBuilder.loadTexts:
    lldpStatsTxGroup.setStatus("current")

lldpLocSysGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 3320, 127, 2, 2, 6)
)
lldpLocSysGroup.setObjects(
      *(("NMS-LLDP-MIB", "lldpLocChassisIdSubtype"),
        ("NMS-LLDP-MIB", "lldpLocChassisId"),
        ("NMS-LLDP-MIB", "lldpLocPortIdSubtype"),
        ("NMS-LLDP-MIB", "lldpLocPortId"),
        ("NMS-LLDP-MIB", "lldpLocPortDesc"),
        ("NMS-LLDP-MIB", "lldpLocSysDesc"),
        ("NMS-LLDP-MIB", "lldpLocSysName"),
        ("NMS-LLDP-MIB", "lldpLocSysCapSupported"),
        ("NMS-LLDP-MIB", "lldpLocSysCapEnabled"),
        ("NMS-LLDP-MIB", "lldpLocManAddrLen"),
        ("NMS-LLDP-MIB", "lldpLocManAddrIfSubtype"),
        ("NMS-LLDP-MIB", "lldpLocManAddrIfId"),
        ("NMS-LLDP-MIB", "lldpLocManAddrOID"))
)
if mibBuilder.loadTexts:
    lldpLocSysGroup.setStatus("current")

lldpRemSysGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 3320, 127, 2, 2, 7)
)
lldpRemSysGroup.setObjects(
      *(("NMS-LLDP-MIB", "lldpRemChassisIdSubtype"),
        ("NMS-LLDP-MIB", "lldpRemChassisId"),
        ("NMS-LLDP-MIB", "lldpRemPortIdSubtype"),
        ("NMS-LLDP-MIB", "lldpRemPortId"),
        ("NMS-LLDP-MIB", "lldpRemPortDesc"),
        ("NMS-LLDP-MIB", "lldpRemSysName"),
        ("NMS-LLDP-MIB", "lldpRemSysDesc"),
        ("NMS-LLDP-MIB", "lldpRemSysCapSupported"),
        ("NMS-LLDP-MIB", "lldpRemSysCapEnabled"),
        ("NMS-LLDP-MIB", "lldpRemManAddrIfSubtype"),
        ("NMS-LLDP-MIB", "lldpRemManAddrIfId"),
        ("NMS-LLDP-MIB", "lldpRemManAddrOID"),
        ("NMS-LLDP-MIB", "lldpRemUnknownTLVInfo"),
        ("NMS-LLDP-MIB", "lldpRemOrgDefInfo"))
)
if mibBuilder.loadTexts:
...
lldpNotificationsGroup = NotificationGroup(
    (1, 3, 6, 1, 4, 1, 3320, 127, 2, 2, 8)
)
lldpNotificationsGroup.setObjects(
    ("NMS-LLDP-MIB", "lldpRemTablesChange")
)
if mibBuilder.loadTexts:
...
lldpCompliance = ModuleCompliance(
    (1, 3, 6, 1, 4, 1, 3320, 127, 2, 1, 1)
)
lldpCompliance.setObjects(
      *(("NMS-LLDP-MIB", "lldpConfigGroup"),
        ("NMS-LLDP-MIB", "lldpConfigRxGroup"),
        ("NMS-LLDP-MIB", "lldpConfigTxGroup"),
        ("NMS-LLDP-MIB", "lldpStatsRxGroup"),
        ("NMS-LLDP-MIB", "lldpStatsTxGroup"),
        ("NMS-LLDP-MIB", "lldpLocSysGroup"),
        ("NMS-LLDP-MIB", "lldpRemSysGroup"),
        ("NMS-LLDP-MIB", "lldpNotificationsGroup"))
)
if mibBuilder.loadTexts:
