...
class _InfoLastConfigChangeSource_Type(DisplayString):
    """Custom type infoLastConfigChangeSource based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_InfoLastConfigChangeSource_Type.__name__ = "DisplayString"
_InfoLastConfigChangeSource_Object = MibScalar
infoLastConfigChangeSource = _InfoLastConfigChangeSource_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 1, 28),
    _InfoLastConfigChangeSource_Type()
)
infoLastConfigChangeSource.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    infoLastConfigChangeSource.setStatus("current")


class _InfoLastPortStateChangeSource_Type(DisplayString):
    """Custom type infoLastPortStateChangeSource based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 50),
    )
...
_InfoLastPortStateChangeSource_Type.__name__ = "DisplayString"
_InfoLastPortStateChangeSource_Object = MibScalar
infoLastPortStateChangeSource = _InfoLastPortStateChangeSource_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 1, 29),
    _InfoLastPortStateChangeSource_Type()
)
infoLastPortStateChangeSource.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    infoLastPortStateChangeSource.setStatus("current")


class _InfoFunctionInputStateF2_Type(Integer32):
    """Custom type infoFunctionInputStateF2 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_InfoFunctionInputStateF2_Type.__name__ = "Integer32"
_InfoFunctionInputStateF2_Object = MibScalar
infoFunctionInputStateF2 = _InfoFunctionInputStateF2_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 1, 30),
    _InfoFunctionInputStateF2_Type()
)
infoFunctionInputStateF2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    infoFunctionInputStateF2.setStatus("current")


class _InfoFunctionInputStateF3_Type(Integer32):
    """Custom type infoFunctionInputStateF3 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_InfoFunctionInputStateF3_Type.__name__ = "Integer32"
_InfoFunctionInputStateF3_Object = MibScalar
infoFunctionInputStateF3 = _InfoFunctionInputStateF3_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 1, 31),
    _InfoFunctionInputStateF3_Type()
)
infoFunctionInputStateF3.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    infoFunctionInputStateF3.setStatus("current")


class _InfoFunctionInputStateF4_Type(Integer32):
    """Custom type infoFunctionInputStateF4 based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_InfoFunctionInputStateF4_Type.__name__ = "Integer32"
_InfoFunctionInputStateF4_Object = MibScalar
infoFunctionInputStateF4 = _InfoFunctionInputStateF4_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 1, 32),
    _InfoFunctionInputStateF4_Type()
)
infoFunctionInputStateF4.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    infoFunctionInputStateF4.setStatus("current")


class _InfoLastFuncInputAlarmNumber_Type(Integer32):
    """Custom type infoLastFuncInputAlarmNumber based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_InfoLastFuncInputAlarmNumber_Type.__name__ = "Integer32"
_InfoLastFuncInputAlarmNumber_Object = MibScalar
infoLastFuncInputAlarmNumber = _InfoLastFuncInputAlarmNumber_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 1, 33),
    _InfoLastFuncInputAlarmNumber_Type()
)
infoLastFuncInputAlarmNumber.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    infoLastFuncInputAlarmNumber.setStatus("current")


class _InfoLastFuncInputAlarmState_Type(Integer32):
    """Custom type infoLastFuncInputAlarmState based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_InfoLastFuncInputAlarmState_Type.__name__ = "Integer32"
_InfoLastFuncInputAlarmState_Object = MibScalar
infoLastFuncInputAlarmState = _InfoLastFuncInputAlarmState_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 1, 34),
    _InfoLastFuncInputAlarmState_Type()
)
infoLastFuncInputAlarmState.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    infoLastFuncInputAlarmState.setStatus("current")


class _InfoLastFuncInputAlarmName_Type(DisplayString):
    """Custom type infoLastFuncInputAlarmName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_InfoLastFuncInputAlarmName_Type.__name__ = "DisplayString"
_InfoLastFuncInputAlarmName_Object = MibScalar
infoLastFuncInputAlarmName = _InfoLastFuncInputAlarmName_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 1, 35),
    _InfoLastFuncInputAlarmName_Type()
)
infoLastFuncInputAlarmName.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    infoLastFuncInputAlarmName.setStatus("current")
...
class _AdminMemoryCardMode_Type(Integer32):
    ...
    namedValues = NamedValues(
        *(("notSupported", 1),
          ...
          ("mcEnabledWithAes256", 5),
          ("mcEnabledWithAes256AndFw", 6))
    )
...
class _AdminLedGlobalMode_Type(Integer32):
    ...
    namedValues = NamedValues(
        *(("ledGlobalModeNotSupported", 1),
          ...
          ("ledGlobalModeGreenBlink", 6),
          ("ledGlobalModeRedBlueBlink", 7))
    )
...
class _AdminFunctionInputNameF2_Type(DisplayString):
    """Custom type adminFunctionInputNameF2 based on DisplayString"""
    defaultValue = OctetString("not defined")
...
_AdminFunctionInputNameF2_Type.__name__ = "DisplayString"
_AdminFunctionInputNameF2_Object = MibScalar
adminFunctionInputNameF2 = _AdminFunctionInputNameF2_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 2, 26),
    _AdminFunctionInputNameF2_Type()
)
adminFunctionInputNameF2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    adminFunctionInputNameF2.setStatus("current")


class _AdminFunctionInputNameF3_Type(DisplayString):
    """Custom type adminFunctionInputNameF3 based on DisplayString"""
    defaultValue = OctetString("not defined")
...
_AdminFunctionInputNameF3_Type.__name__ = "DisplayString"
_AdminFunctionInputNameF3_Object = MibScalar
adminFunctionInputNameF3 = _AdminFunctionInputNameF3_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 2, 27),
    _AdminFunctionInputNameF3_Type()
)
adminFunctionInputNameF3.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    adminFunctionInputNameF3.setStatus("current")


class _AdminFunctionInputNameF4_Type(DisplayString):
    """Custom type adminFunctionInputNameF4 based on DisplayString"""
    defaultValue = OctetString("not defined")
...
_AdminFunctionInputNameF4_Type.__name__ = "DisplayString"
_AdminFunctionInputNameF4_Object = MibScalar
adminFunctionInputNameF4 = _AdminFunctionInputNameF4_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 2, 28),
    _AdminFunctionInputNameF4_Type()
)
adminFunctionInputNameF4.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    adminFunctionInputNameF4.setStatus("current")
...
class _PortActiveDefaultVlanId_Type(Integer32):
    """Custom type portActiveDefaultVlanId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 4095),
    )
...
_PortActiveDefaultVlanId_Type.__name__ = "Integer32"
_PortActiveDefaultVlanId_Object = MibTableColumn
portActiveDefaultVlanId = _PortActiveDefaultVlanId_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 3, 1, 1, 33),
    _PortActiveDefaultVlanId_Type()
)
portActiveDefaultVlanId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    portActiveDefaultVlanId.setStatus("current")


class _PortActiveVoiceVlanId_Type(Integer32):
    """Custom type portActiveVoiceVlanId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 4095),
    )
...
_PortActiveVoiceVlanId_Type.__name__ = "Integer32"
_PortActiveVoiceVlanId_Object = MibTableColumn
portActiveVoiceVlanId = _PortActiveVoiceVlanId_Object(
    (1, 3, 6, 1, 4, 1, 266, 20, 3, 1, 1, 34),
    _PortActiveVoiceVlanId_Type()
)
portActiveVoiceVlanId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    portActiveVoiceVlanId.setStatus("current")
...
switchFunctionInputAlarm.setObjects(
      *(("NEXANS-BM-MIB", "infoLastFuncInputAlarmState"),
        ("NEXANS-BM-MIB", "infoLastFuncInputAlarmName"),
        ("NEXANS-BM-MIB", "infoLastFuncInputAlarmNumber"))
)
if mibBuilder.loadTexts:
...
switchConfigurationChanged.setObjects(
      *(("NEXANS-BM-MIB", "infoTotalConfigChanges"),
        ("NEXANS-BM-MIB", "infoLastConfigChangeSource"))
)
if mibBuilder.loadTexts:
...
portStateChanged = NotificationType(
    (1, 3, 6, 1, 4, 1, 266, 20, 0, 24)
)
portStateChanged.setObjects(
      *(("NEXANS-BM-MIB", "portIndex"),
        ("NEXANS-BM-MIB", "portDescr"),
        ("NEXANS-BM-MIB", "portName"),
        ("BRIDGE-MIB", "dot1dStpPortState"),
        ("NEXANS-BM-MIB", "infoLastPortStateChangeSource"))
)
if mibBuilder.loadTexts:
    portStateChanged.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"bmSwitchMIB": bmSwitchMIB,
       ...
       "portStateChanged": portStateChanged,
       ...
       "infoLastConfigChangeSource": infoLastConfigChangeSource,
       "infoLastPortStateChangeSource": infoLastPortStateChangeSource,
       "infoFunctionInputStateF2": infoFunctionInputStateF2,
       "infoFunctionInputStateF3": infoFunctionInputStateF3,
       "infoFunctionInputStateF4": infoFunctionInputStateF4,
       "infoLastFuncInputAlarmNumber": infoLastFuncInputAlarmNumber,
       "infoLastFuncInputAlarmState": infoLastFuncInputAlarmState,
       "infoLastFuncInputAlarmName": infoLastFuncInputAlarmName,
       ...
       "adminFunctionInputNameF2": adminFunctionInputNameF2,
       "adminFunctionInputNameF3": adminFunctionInputNameF3,
       "adminFunctionInputNameF4": adminFunctionInputNameF4,
       ...
       "portActiveVoiceVlanId": portActiveVoiceVlanId,
