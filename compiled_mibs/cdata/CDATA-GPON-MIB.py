# SNMP MIB module (CDATA-GPON-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\cdata\CDATA-GPON-MIB
...
gponDbaProfileInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponDbaProfileId"),
)
if mibBuilder.loadTexts:
...
gponDbaProfileBindInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponDbaProfileId"),
    (0, "CDATA-GPON-MIB", "gponLineProfileId"),
)
if mibBuilder.loadTexts:
...
gponLineProfileTcontEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponLineProfileId"),
    (0, "CDATA-GPON-MIB", "gponLineProfileTcontId"),
)
if mibBuilder.loadTexts:
...
gponLineProfileGemEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponLineProfileId"),
    (0, "CDATA-GPON-MIB", "gponLineProfileGemId"),
)
if mibBuilder.loadTexts:
...
gponLineProfileGemMapEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponLineProfileId"),
    (0, "CDATA-GPON-MIB", "gponLineProfileGemId"),
    (0, "CDATA-GPON-MIB", "gponLineProfileGemMapId"),
)
if mibBuilder.loadTexts:
...
gponLineProfileBindInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponLineProfileId"),
    (0, "CDATA-GPON-MIB", "gponOltDeviceId"),
    (0, "CDATA-GPON-MIB", "gponOltCardId"),
    (0, "CDATA-GPON-MIB", "gponOltPortId"),
)
if mibBuilder.loadTexts:
...
gponSrvProfileInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponSrvProfileId"),
)
if mibBuilder.loadTexts:
...
gponSrvProfilePortVlanCfgEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponSrvProfileId"),
    (0, "CDATA-GPON-MIB", "gponSrvProfilePortType"),
    (0, "CDATA-GPON-MIB", "gponSrvProfilePortId"),
    (0, "CDATA-GPON-MIB", "gponSrvProfilePortVlanEntryId"),
)
if mibBuilder.loadTexts:
...
gponTrafficProfileInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponTrafficProfileId"),
)
if mibBuilder.loadTexts:
...
gponSipAgentProfileInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponSipAgentProfileId"),
)
if mibBuilder.loadTexts:
...
class _GponSipAgentProfileProxyServerPort_Type(Integer32):
    """Custom type gponSipAgentProfileProxyServerPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_GponSipAgentProfileProxyServerPort_Type.__name__ = "Integer32"
_GponSipAgentProfileProxyServerPort_Object = MibTableColumn
gponSipAgentProfileProxyServerPort = _GponSipAgentProfileProxyServerPort_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 1, 8, 2, 1, 16),
    _GponSipAgentProfileProxyServerPort_Type()
)
gponSipAgentProfileProxyServerPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponSipAgentProfileProxyServerPort.setStatus("current")


class _GponSipAgentProfileRegistrationServerPort_Type(Integer32):
    """Custom type gponSipAgentProfileRegistrationServerPort based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_GponSipAgentProfileRegistrationServerPort_Type.__name__ = "Integer32"
_GponSipAgentProfileRegistrationServerPort_Object = MibTableColumn
gponSipAgentProfileRegistrationServerPort = _GponSipAgentProfileRegistrationServerPort_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 1, 8, 2, 1, 17),
    _GponSipAgentProfileRegistrationServerPort_Type()
)
gponSipAgentProfileRegistrationServerPort.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponSipAgentProfileRegistrationServerPort.setStatus("current")
...
gponSipAgentProfileBindInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponSipAgentProfileId"),
    (0, "CDATA-GPON-MIB", "gponSipAgentProfileBindInfoOnuId"),
)
if mibBuilder.loadTexts:
...
gponSipAgentProfileBindInfoOnuId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    gponSipAgentProfileBindInfoOnuId.setStatus("current")
_GponSipAgentProfileBindPotsList_Type = DisplayString
...
gponSipRightFlagProfileInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponSipRightFlagProfileId"),
)
if mibBuilder.loadTexts:
...
gponSipRightFlagProfileBindInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponSipRightFlagProfileId"),
    (0, "CDATA-GPON-MIB", "gponSipRightFlagProfileBindInfoOnuId"),
)
if mibBuilder.loadTexts:
...
_GponSipRightFlagProfileBindPotsList_Type = DisplayString
...
gponDigitMapProfileInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponDigitMapProfileId"),
)
if mibBuilder.loadTexts:
...
gponDigitMapProfileDialPlanEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponDigitMapProfileId"),
    (0, "CDATA-GPON-MIB", "gponDigitMapProfileDialPlanId"),
)
if mibBuilder.loadTexts:
...
gponDigitMapProfileBindInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponDigitMapProfileId"),
    (0, "CDATA-GPON-MIB", "gponDigitMapProfileBindInfoOnuId"),
)
if mibBuilder.loadTexts:
...
_GponDigitMapProfileBindPotsList_Type = DisplayString
...
gponPotsProfileInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponPotsProfileId"),
)
if mibBuilder.loadTexts:
...
gponPotsProfileBindInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponPotsProfileId"),
    (0, "CDATA-GPON-MIB", "gponPotsProfileBindInfoOnuId"),
)
if mibBuilder.loadTexts:
...
_GponPotsProfileBindPotsList_Type = DisplayString
...
gponOltAutoAuthRuleEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponOltAutoAuthRuleId"),
)
if mibBuilder.loadTexts:
...
gponOnuAutofindInfoEntry.setIndexNames(
    ...
    (0, "CDATA-GPON-MIB", "gponOltCardId"),
    (0, "CDATA-GPON-MIB", "gponOltPortId"),
    (0, "CDATA-GPON-MIB", "gponOnuAutofindId"),
)
if mibBuilder.loadTexts:
...
gponOnuAuthenticationConfirmEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponOnuAuthenticationConfirmDeviceId"),
    (0, "CDATA-GPON-MIB", "gponOnuAuthenticationConfirmCardId"),
    (0, "CDATA-GPON-MIB", "gponOnuAuthenticationConfirmPortId"),
)
if mibBuilder.loadTexts:
...
gponOnuPolicyAuthControlEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponOnuPolicyAuthControlDeviceIndex"),
)
if mibBuilder.loadTexts:
    gponOnuPolicyAuthControlEntry.setStatus("current")
_GponOnuPolicyAuthControlDeviceIndex_Type = Integer32
_GponOnuPolicyAuthControlDeviceIndex_Object = MibTableColumn
gponOnuPolicyAuthControlDeviceIndex = _GponOnuPolicyAuthControlDeviceIndex_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 8, 3, 1, 1, 1),
    _GponOnuPolicyAuthControlDeviceIndex_Type()
)
gponOnuPolicyAuthControlDeviceIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    gponOnuPolicyAuthControlDeviceIndex.setStatus("current")
...
gponOnuPolicyAuthRuleEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponOnuPolicyAuthDeviceIndex"),
    (0, "CDATA-GPON-MIB", "gponOnuPolicyAuthRuleIndex"),
)
if mibBuilder.loadTexts:
    gponOnuPolicyAuthRuleEntry.setStatus("current")
_GponOnuPolicyAuthDeviceIndex_Type = Unsigned32
_GponOnuPolicyAuthDeviceIndex_Object = MibTableColumn
gponOnuPolicyAuthDeviceIndex = _GponOnuPolicyAuthDeviceIndex_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 8, 3, 2, 1, 1),
    _GponOnuPolicyAuthDeviceIndex_Type()
)
gponOnuPolicyAuthDeviceIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    gponOnuPolicyAuthDeviceIndex.setStatus("current")
_GponOnuPolicyAuthRuleIndex_Type = Unsigned32
_GponOnuPolicyAuthRuleIndex_Object = MibTableColumn
gponOnuPolicyAuthRuleIndex = _GponOnuPolicyAuthRuleIndex_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 8, 3, 2, 1, 2),
    _GponOnuPolicyAuthRuleIndex_Type()
)
gponOnuPolicyAuthRuleIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    gponOnuPolicyAuthRuleIndex.setStatus("current")
...
_GponOnuWanConfig_ObjectIdentity = ObjectIdentity
gponOnuWanConfig = _GponOnuWanConfig_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9)
)
_GponOnuWanConfigInfoTable_Object = MibTable
gponOnuWanConfigInfoTable = _GponOnuWanConfigInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1)
)
if mibBuilder.loadTexts:
    gponOnuWanConfigInfoTable.setStatus("current")
_GponOnuWanConfigInfoEntry_Object = MibTableRow
gponOnuWanConfigInfoEntry = _GponOnuWanConfigInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1)
)
gponOnuWanConfigInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponOltDeviceId"),
    (0, "CDATA-GPON-MIB", "gponOltPortId"),
    (0, "CDATA-GPON-MIB", "gponOnuId"),
    (0, "CDATA-GPON-MIB", "gponOnuWanInfoWanId"),
)
if mibBuilder.loadTexts:
    gponOnuWanConfigInfoEntry.setStatus("current")


class _GponOnuWanInfoWanId_Type(Integer32):
    """Custom type gponOnuWanInfoWanId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_GponOnuWanInfoWanId_Type.__name__ = "Integer32"
_GponOnuWanInfoWanId_Object = MibTableColumn
gponOnuWanInfoWanId = _GponOnuWanInfoWanId_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 1),
    _GponOnuWanInfoWanId_Type()
)
gponOnuWanInfoWanId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    gponOnuWanInfoWanId.setStatus("current")


class _GponOnuWanConfigConnectionName_Type(DisplayString):
    """Custom type gponOnuWanConfigConnectionName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_GponOnuWanConfigConnectionName_Type.__name__ = "DisplayString"
_GponOnuWanConfigConnectionName_Object = MibTableColumn
gponOnuWanConfigConnectionName = _GponOnuWanConfigConnectionName_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 2),
    _GponOnuWanConfigConnectionName_Type()
)
gponOnuWanConfigConnectionName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    gponOnuWanConfigConnectionName.setStatus("current")


class _GponOnuWanConfigConnectionStatus_Type(Integer32):
    """Custom type gponOnuWanConfigConnectionStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_GponOnuWanConfigConnectionStatus_Type.__name__ = "Integer32"
_GponOnuWanConfigConnectionStatus_Object = MibTableColumn
gponOnuWanConfigConnectionStatus = _GponOnuWanConfigConnectionStatus_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 3),
    _GponOnuWanConfigConnectionStatus_Type()
)
gponOnuWanConfigConnectionStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    gponOnuWanConfigConnectionStatus.setStatus("current")


class _GponOnuWanConfigConnectionAdmin_Type(GponSwitch):
    """Custom type gponOnuWanConfigConnectionAdmin based on GponSwitch"""
    subtypeSpec = GponSwitch.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
              1)
...
_GponOnuWanConfigConnectionAdmin_Type.__name__ = "GponSwitch"
_GponOnuWanConfigConnectionAdmin_Object = MibTableColumn
gponOnuWanConfigConnectionAdmin = _GponOnuWanConfigConnectionAdmin_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 4),
    _GponOnuWanConfigConnectionAdmin_Type()
)
gponOnuWanConfigConnectionAdmin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigConnectionAdmin.setStatus("current")


class _GponOnuWanConfigConnectType_Type(Integer32):
    """Custom type gponOnuWanConfigConnectType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_GponOnuWanConfigConnectType_Type.__name__ = "Integer32"
_GponOnuWanConfigConnectType_Object = MibTableColumn
gponOnuWanConfigConnectType = _GponOnuWanConfigConnectType_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 5),
    _GponOnuWanConfigConnectType_Type()
)
gponOnuWanConfigConnectType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigConnectType.setStatus("current")


class _GponOnuWanConfigConnectMode_Type(Integer32):
    """Custom type gponOnuWanConfigConnectMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_GponOnuWanConfigConnectMode_Type.__name__ = "Integer32"
_GponOnuWanConfigConnectMode_Object = MibTableColumn
gponOnuWanConfigConnectMode = _GponOnuWanConfigConnectMode_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 6),
    _GponOnuWanConfigConnectMode_Type()
)
gponOnuWanConfigConnectMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigConnectMode.setStatus("current")


class _GponOnuWanConfigIpVersion_Type(Integer32):
    """Custom type gponOnuWanConfigIpVersion based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_GponOnuWanConfigIpVersion_Type.__name__ = "Integer32"
_GponOnuWanConfigIpVersion_Object = MibTableColumn
gponOnuWanConfigIpVersion = _GponOnuWanConfigIpVersion_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 7),
    _GponOnuWanConfigIpVersion_Type()
)
gponOnuWanConfigIpVersion.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigIpVersion.setStatus("current")


class _GponOnuWanConfigVlanAdmin_Type(Integer32):
    """Custom type gponOnuWanConfigVlanAdmin based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_GponOnuWanConfigVlanAdmin_Type.__name__ = "Integer32"
_GponOnuWanConfigVlanAdmin_Object = MibTableColumn
gponOnuWanConfigVlanAdmin = _GponOnuWanConfigVlanAdmin_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 8),
    _GponOnuWanConfigVlanAdmin_Type()
)
gponOnuWanConfigVlanAdmin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigVlanAdmin.setStatus("current")


class _GponOnuWanConfigVlan_Type(Integer32):
    """Custom type gponOnuWanConfigVlan based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4094),
    )
...
_GponOnuWanConfigVlan_Type.__name__ = "Integer32"
_GponOnuWanConfigVlan_Object = MibTableColumn
gponOnuWanConfigVlan = _GponOnuWanConfigVlan_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 9),
    _GponOnuWanConfigVlan_Type()
)
gponOnuWanConfigVlan.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigVlan.setStatus("current")


class _GponOnuWanConfigVlanPriority_Type(Integer32):
    """Custom type gponOnuWanConfigVlanPriority based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 7),
    )
...
_GponOnuWanConfigVlanPriority_Type.__name__ = "Integer32"
_GponOnuWanConfigVlanPriority_Object = MibTableColumn
gponOnuWanConfigVlanPriority = _GponOnuWanConfigVlanPriority_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 10),
    _GponOnuWanConfigVlanPriority_Type()
)
gponOnuWanConfigVlanPriority.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigVlanPriority.setStatus("current")


class _GponOnuWanConfigServiceType_Type(Integer32):
    """Custom type gponOnuWanConfigServiceType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_GponOnuWanConfigServiceType_Type.__name__ = "Integer32"
_GponOnuWanConfigServiceType_Object = MibTableColumn
gponOnuWanConfigServiceType = _GponOnuWanConfigServiceType_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 11),
    _GponOnuWanConfigServiceType_Type()
)
gponOnuWanConfigServiceType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigServiceType.setStatus("current")


class _GponOnuWanConfigMtu_Type(Integer32):
    """Custom type gponOnuWanConfigMtu based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(64, 1540),
    )


_GponOnuWanConfigMtu_Type.__name__ = "Integer32"
_GponOnuWanConfigMtu_Object = MibTableColumn
gponOnuWanConfigMtu = _GponOnuWanConfigMtu_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 12),
    _GponOnuWanConfigMtu_Type()
)
gponOnuWanConfigMtu.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigMtu.setStatus("current")


class _GponOnuWanConfigNatAdmin_Type(GponSwitch):
    """Custom type gponOnuWanConfigNatAdmin based on GponSwitch"""
    subtypeSpec = GponSwitch.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_GponOnuWanConfigNatAdmin_Type.__name__ = "GponSwitch"
_GponOnuWanConfigNatAdmin_Object = MibTableColumn
gponOnuWanConfigNatAdmin = _GponOnuWanConfigNatAdmin_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 13),
    _GponOnuWanConfigNatAdmin_Type()
)
gponOnuWanConfigNatAdmin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigNatAdmin.setStatus("current")


class _GponOnuWanConfigLanDhcpAdmin_Type(GponSwitch):
    """Custom type gponOnuWanConfigLanDhcpAdmin based on GponSwitch"""
    subtypeSpec = GponSwitch.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_GponOnuWanConfigLanDhcpAdmin_Type.__name__ = "GponSwitch"
_GponOnuWanConfigLanDhcpAdmin_Object = MibTableColumn
gponOnuWanConfigLanDhcpAdmin = _GponOnuWanConfigLanDhcpAdmin_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 14),
    _GponOnuWanConfigLanDhcpAdmin_Type()
)
gponOnuWanConfigLanDhcpAdmin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigLanDhcpAdmin.setStatus("current")


class _GponOnuWanConfigBinding_Type(Bits):
    """Custom type gponOnuWanConfigBinding based on Bits"""
    namedValues = NamedValues(
        *(("port1", 0),
          ("port2", 1),
          ("port3", 2),
...
_GponOnuWanConfigBinding_Type.__name__ = "Bits"
_GponOnuWanConfigBinding_Object = MibTableColumn
gponOnuWanConfigBinding = _GponOnuWanConfigBinding_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 15),
    _GponOnuWanConfigBinding_Type()
)
gponOnuWanConfigBinding.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigBinding.setStatus("current")


class _GponOnuWanConfigPppoeUserName_Type(DisplayString):
    """Custom type gponOnuWanConfigPppoeUserName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 50),
    )
...
_GponOnuWanConfigPppoeUserName_Type.__name__ = "DisplayString"
_GponOnuWanConfigPppoeUserName_Object = MibTableColumn
gponOnuWanConfigPppoeUserName = _GponOnuWanConfigPppoeUserName_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 16),
    _GponOnuWanConfigPppoeUserName_Type()
)
gponOnuWanConfigPppoeUserName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigPppoeUserName.setStatus("current")


class _GponOnuWanConfigPppoePassWord_Type(DisplayString):
    """Custom type gponOnuWanConfigPppoePassWord based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 50),
    )
...
_GponOnuWanConfigPppoePassWord_Type.__name__ = "DisplayString"
_GponOnuWanConfigPppoePassWord_Object = MibTableColumn
gponOnuWanConfigPppoePassWord = _GponOnuWanConfigPppoePassWord_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 17),
    _GponOnuWanConfigPppoePassWord_Type()
)
gponOnuWanConfigPppoePassWord.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigPppoePassWord.setStatus("current")


class _GponOnuWanConfigPppoeServiceName_Type(DisplayString):
    """Custom type gponOnuWanConfigPppoeServiceName based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 50),
    )
...
_GponOnuWanConfigPppoeServiceName_Type.__name__ = "DisplayString"
_GponOnuWanConfigPppoeServiceName_Object = MibTableColumn
gponOnuWanConfigPppoeServiceName = _GponOnuWanConfigPppoeServiceName_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 18),
    _GponOnuWanConfigPppoeServiceName_Type()
)
gponOnuWanConfigPppoeServiceName.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigPppoeServiceName.setStatus("current")


class _GponOnuWanConfigPppoeDialOnDemandAdmin_Type(Integer32):
    """Custom type gponOnuWanConfigPppoeDialOnDemandAdmin based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_GponOnuWanConfigPppoeDialOnDemandAdmin_Type.__name__ = "Integer32"
_GponOnuWanConfigPppoeDialOnDemandAdmin_Object = MibTableColumn
gponOnuWanConfigPppoeDialOnDemandAdmin = _GponOnuWanConfigPppoeDialOnDemandAdmin_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 19),
    _GponOnuWanConfigPppoeDialOnDemandAdmin_Type()
)
gponOnuWanConfigPppoeDialOnDemandAdmin.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigPppoeDialOnDemandAdmin.setStatus("current")


class _GponOnuWanConfigPppoeDialOnDemandInActiveTime_Type(Integer32):
    """Custom type gponOnuWanConfigPppoeDialOnDemandInActiveTime based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_GponOnuWanConfigPppoeDialOnDemandInActiveTime_Type.__name__ = "Integer32"
_GponOnuWanConfigPppoeDialOnDemandInActiveTime_Object = MibTableColumn
gponOnuWanConfigPppoeDialOnDemandInActiveTime = _GponOnuWanConfigPppoeDialOnDemandInActiveTime_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 20),
    _GponOnuWanConfigPppoeDialOnDemandInActiveTime_Type()
)
gponOnuWanConfigPppoeDialOnDemandInActiveTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigPppoeDialOnDemandInActiveTime.setStatus("current")


class _GponOnuWanConfigRowStatus_Type(RowStatus):
    """Custom type gponOnuWanConfigRowStatus based on RowStatus"""
...
_GponOnuWanConfigRowStatus_Type.__name__ = "RowStatus"
_GponOnuWanConfigRowStatus_Object = MibTableColumn
gponOnuWanConfigRowStatus = _GponOnuWanConfigRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 1, 1, 21),
    _GponOnuWanConfigRowStatus_Type()
)
gponOnuWanConfigRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    gponOnuWanConfigRowStatus.setStatus("current")
_GponOnuWanConfigIpv4Table_Object = MibTable
gponOnuWanConfigIpv4Table = _GponOnuWanConfigIpv4Table_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 3)
)
if mibBuilder.loadTexts:
    gponOnuWanConfigIpv4Table.setStatus("current")
_GponOnuWanConfigIpv4Entry_Object = MibTableRow
gponOnuWanConfigIpv4Entry = _GponOnuWanConfigIpv4Entry_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 3, 1)
)
gponOnuWanConfigIpv4Entry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponOltDeviceId"),
    (0, "CDATA-GPON-MIB", "gponOltPortId"),
    (0, "CDATA-GPON-MIB", "gponOnuId"),
    (0, "CDATA-GPON-MIB", "gponOnuWanInfoWanId"),
...
if mibBuilder.loadTexts:
    gponOnuWanConfigIpv4Entry.setStatus("current")
_GponOnuWanConfigIpAddress_Type = IpAddress
_GponOnuWanConfigIpAddress_Object = MibTableColumn
gponOnuWanConfigIpAddress = _GponOnuWanConfigIpAddress_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 3, 1, 1),
    _GponOnuWanConfigIpAddress_Type()
)
gponOnuWanConfigIpAddress.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigIpAddress.setStatus("current")
_GponOnuWanConfigMask_Type = IpAddress
_GponOnuWanConfigMask_Object = MibTableColumn
gponOnuWanConfigMask = _GponOnuWanConfigMask_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 3, 1, 2),
    _GponOnuWanConfigMask_Type()
)
gponOnuWanConfigMask.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigMask.setStatus("current")
_GponOnuWanConfigGateWay_Type = IpAddress
_GponOnuWanConfigGateWay_Object = MibTableColumn
gponOnuWanConfigGateWay = _GponOnuWanConfigGateWay_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 3, 1, 3),
    _GponOnuWanConfigGateWay_Type()
)
gponOnuWanConfigGateWay.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigGateWay.setStatus("current")


class _GponOnuWanConfigDhcpDnsMode_Type(Integer32):
    """Custom type gponOnuWanConfigDhcpDnsMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_GponOnuWanConfigDhcpDnsMode_Type.__name__ = "Integer32"
_GponOnuWanConfigDhcpDnsMode_Object = MibTableColumn
gponOnuWanConfigDhcpDnsMode = _GponOnuWanConfigDhcpDnsMode_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 3, 1, 4),
    _GponOnuWanConfigDhcpDnsMode_Type()
)
gponOnuWanConfigDhcpDnsMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigDhcpDnsMode.setStatus("current")
_GponOnuWanConfigPrimaryDns_Type = IpAddress
_GponOnuWanConfigPrimaryDns_Object = MibTableColumn
gponOnuWanConfigPrimaryDns = _GponOnuWanConfigPrimaryDns_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 3, 1, 5),
    _GponOnuWanConfigPrimaryDns_Type()
)
gponOnuWanConfigPrimaryDns.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigPrimaryDns.setStatus("current")
_GponOnuWanConfigSecondaryDns_Type = IpAddress
_GponOnuWanConfigSecondaryDns_Object = MibTableColumn
gponOnuWanConfigSecondaryDns = _GponOnuWanConfigSecondaryDns_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 18, 9, 3, 1, 6),
    _GponOnuWanConfigSecondaryDns_Type()
)
gponOnuWanConfigSecondaryDns.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    gponOnuWanConfigSecondaryDns.setStatus("current")
...
gponOnuEthPortCfgEntry.setIndexNames(
    ...
    (0, "CDATA-GPON-MIB", "gponOltPortId"),
    (0, "CDATA-GPON-MIB", "gponOnuId"),
    (0, "CDATA-GPON-MIB", "gponOnuEthPortId"),
)
if mibBuilder.loadTexts:
...
gponOnuEthPortMacAddressEntry.setIndexNames(
    ...
    (0, "CDATA-GPON-MIB", "gponOnuId"),
    (0, "CDATA-GPON-MIB", "gponOnuEthPortId"),
    (0, "CDATA-GPON-MIB", "gponOnuEthPortMacAddressId"),
)
if mibBuilder.loadTexts:
...
_GponOnuEthPortRTInfoTable_Object = MibTable
gponOnuEthPortRTInfoTable = _GponOnuEthPortRTInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 19, 5)
)
if mibBuilder.loadTexts:
    gponOnuEthPortRTInfoTable.setStatus("current")
_GponOnuEthPortRTInfoEntry_Object = MibTableRow
gponOnuEthPortRTInfoEntry = _GponOnuEthPortRTInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 19, 5, 1)
)
gponOnuEthPortRTInfoEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponOltDeviceId"),
    (0, "CDATA-GPON-MIB", "gponOltCardId"),
    (0, "CDATA-GPON-MIB", "gponOltPortId"),
    (0, "CDATA-GPON-MIB", "gponOnuId"),
...
if mibBuilder.loadTexts:
    gponOnuEthPortRTInfoEntry.setStatus("current")
_GponOnuEthPortStatusInfo_Type = OctetString
_GponOnuEthPortStatusInfo_Object = MibTableColumn
gponOnuEthPortStatusInfo = _GponOnuEthPortStatusInfo_Object(
    (1, 3, 6, 1, 4, 1, 34592, 1, 5, 1, 1, 2, 19, 5, 1, 1),
    _GponOnuEthPortStatusInfo_Type()
)
gponOnuEthPortStatusInfo.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    gponOnuEthPortStatusInfo.setStatus("current")
...
gponOnuPotsPortCfgEntry.setIndexNames(
    ...
    (0, "CDATA-GPON-MIB", "gponOltPortId"),
    (0, "CDATA-GPON-MIB", "gponOnuId"),
    (0, "CDATA-GPON-MIB", "gponOnuPotsPortId"),
)
if mibBuilder.loadTexts:
...
gponOnuIpCfgEntry.setIndexNames(
    ...
    (0, "CDATA-GPON-MIB", "gponOltPortId"),
    (0, "CDATA-GPON-MIB", "gponOnuId"),
    (0, "CDATA-GPON-MIB", "gponOnuIpHostId"),
)
if mibBuilder.loadTexts:
...
gponOnuSipPstnUserEntry.setIndexNames(
    ...
    (0, "CDATA-GPON-MIB", "gponOltPortId"),
    (0, "CDATA-GPON-MIB", "gponOnuId"),
    (0, "CDATA-GPON-MIB", "gponOnuSipPstnUserId"),
)
if mibBuilder.loadTexts:
...
gponOnuCatvPortCfgEntry.setIndexNames(
    ...
    (0, "CDATA-GPON-MIB", "gponOltPortId"),
    (0, "CDATA-GPON-MIB", "gponOnuId"),
    (0, "CDATA-GPON-MIB", "gponOnuCatvPortId"),
)
if mibBuilder.loadTexts:
...
gponManagementAddrEntry.setIndexNames(
    (0, "CDATA-GPON-MIB", "gponManagementAddrName"),
)
if mibBuilder.loadTexts:
...
gponDbaProfileGroup.setObjects(
      *(("CDATA-GPON-MIB", "gponDbaProfileFixRate"),
        ("CDATA-GPON-MIB", "gponDbaProfileBindNum"),
        ("CDATA-GPON-MIB", "gponDbaProfileName"),
        ("CDATA-GPON-MIB", "gponDbaProfileRowStatus"),
        ("CDATA-GPON-MIB", "gponDbaProfileMaxRate"),
        ("CDATA-GPON-MIB", "gponDbaProfileType"),
        ("CDATA-GPON-MIB", "gponDbaProfileAssureRate"))
)
if mibBuilder.loadTexts:
...
gponLineProfileGroup.setObjects(
      *(("CDATA-GPON-MIB", "gponLineProfileRowStatus"),
        ("CDATA-GPON-MIB", "gponLineProfileName"),
        ("CDATA-GPON-MIB", "gponLineProfileMappingMode"),
        ("CDATA-GPON-MIB", "gponLineProfileTcontNum"),
        ("CDATA-GPON-MIB", "gponLineProfileGemNum"),
        ("CDATA-GPON-MIB", "gponLineProfileBindNum"),
        ("CDATA-GPON-MIB", "gponLineProfileTcontId"),
        ("CDATA-GPON-MIB", "gponLineProfileTcontRowStatus"),
        ("CDATA-GPON-MIB", "gponLineProfileTcontDbaProfileId"),
        ("CDATA-GPON-MIB", "gponLineProfileGemId"),
        ("CDATA-GPON-MIB", "gponLineProfileGemRowStatus"),
        ("CDATA-GPON-MIB", "gponLineProfileGemTcontId"),
        ("CDATA-GPON-MIB", "gponLineProfileGemUpCar"),
        ("CDATA-GPON-MIB", "gponLineProfileGemDownCar"),
        ("CDATA-GPON-MIB", "gponLineProfileGemMapNum"),
        ("CDATA-GPON-MIB", "gponLineProfileGemMapId"),
        ("CDATA-GPON-MIB", "gponLineProfileGemMapRowStatus"),
...
gponSrvProfileGroup.setObjects(
      *(("CDATA-GPON-MIB", "gponSrvProfileId"),
        ("CDATA-GPON-MIB", "gponSrvProfileRowStatus"),
        ("CDATA-GPON-MIB", "gponSrvProfileName"),
        ("CDATA-GPON-MIB", "gponSrvProfileBindNum"),
        ("CDATA-GPON-MIB", "gponSrvProfileMcMode"),
        ("CDATA-GPON-MIB", "gponSrvProfileUpIgmpFwdMode"),
        ("CDATA-GPON-MIB", "gponSrvProfileUpIgmpTCI"),
        ("CDATA-GPON-MIB", "gponSrvProfileDnMcMode"),
        ("CDATA-GPON-MIB", "gponSrvProfileDnMcTCI"),
        ("CDATA-GPON-MIB", "gponSrvProfileEthNum"),
        ("CDATA-GPON-MIB", "gponSrvProfilePotsNum"),
        ("CDATA-GPON-MIB", "gponSrvProfilePortType"),
        ("CDATA-GPON-MIB", "gponSrvProfilePortId"),
        ("CDATA-GPON-MIB", "gponSrvProfilePortCvlan"),
        ("CDATA-GPON-MIB", "gponSrvProfilePortVlanRowStatus"),
        ("CDATA-GPON-MIB", "gponSrvProfilePortVlanMode"),
        ("CDATA-GPON-MIB", "gponSrvProfilePortVlanSvlan"))
)
if mibBuilder.loadTexts:
...
gponTrafficProfileGroup.setObjects(
      *(("CDATA-GPON-MIB", "gponTrafficProfileId"),
        ("CDATA-GPON-MIB", "gponTrafficProfileRowStatus"),
        ("CDATA-GPON-MIB", "gponTrafficProfileName"),
        ("CDATA-GPON-MIB", "gponTrafficProfileBindNum"),
        ("CDATA-GPON-MIB", "gponTrafficProfileCfgCir"),
        ("CDATA-GPON-MIB", "gponTrafficProfileCfgPir"),
        ("CDATA-GPON-MIB", "gponTrafficProfileCfgCbs"),
        ("CDATA-GPON-MIB", "gponTrafficProfileCfgPbs"))
)
if mibBuilder.loadTexts:
...
gponSipAgentProfileGroup.setObjects(
      *(("CDATA-GPON-MIB", "gponSipAgentProfileRowStatus"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileName"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileBindNum"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileProxyServerUri"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileRtpDscp"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileRtpMinPort"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileRtpMaxPort"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileSignalDscp"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileSignalPort"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileSignalTransferMode"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileRegistrationExpiration"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileRegistrationReregHeadStartTime"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileRegistrationServerUri"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileVoiceMailServerUri"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileVoiceMailSubscriptionExpiration"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileConfFactory"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileBridgedLineAgent"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileAuthRealm"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileBindPotsList"))
)
if mibBuilder.loadTexts:
...
gponSipRightFlagProfileGroup.setObjects(
      *(("CDATA-GPON-MIB", "gponSipRightFlagProfileId"),
        ("CDATA-GPON-MIB", "gponSipRightFlagProfileRowStatus"),
        ("CDATA-GPON-MIB", "gponSipRightFlagProfileName"),
        ("CDATA-GPON-MIB", "gponSipRightFlagProfileBindNum"),
        ("CDATA-GPON-MIB", "gponSipRightFlagProfileCallWaiting"),
        ("CDATA-GPON-MIB", "gponSipRightFlagProfileCallProcess"),
        ("CDATA-GPON-MIB", "gponSipRightFlagProfileCallPresentation"),
        ("CDATA-GPON-MIB", "gponSipRightFlagProfileHotline"),
        ("CDATA-GPON-MIB", "gponSipRightFlagProfileHotlineNum"),
        ("CDATA-GPON-MIB", "gponSipRightFlagProfileBindPotsList"))
)
if mibBuilder.loadTexts:
...
gponDigitMapProfileGroup.setObjects(
      *(("CDATA-GPON-MIB", "gponDigitMapProfileId"),
        ("CDATA-GPON-MIB", "gponDigitMapProfileRowStatus"),
        ("CDATA-GPON-MIB", "gponDigitMapProfileName"),
        ("CDATA-GPON-MIB", "gponDigitMapProfileBindNum"),
        ("CDATA-GPON-MIB", "gponDigitMapProfileCriticalDialTime"),
        ("CDATA-GPON-MIB", "gponDigitMapProfileDialPlanId"),
        ("CDATA-GPON-MIB", "gponDigitMapProfileDialPlanRowStatus"),
        ("CDATA-GPON-MIB", "gponDigitMapProfileDialPlanToken"),
        ("CDATA-GPON-MIB", "gponDigitMapProfileBindPotsList"))
)
if mibBuilder.loadTexts:
...
gponPotsProfileGroup.setObjects(
      *(("CDATA-GPON-MIB", "gponPotsProfileId"),
        ("CDATA-GPON-MIB", "gponPotsProfileRowStatus"),
        ("CDATA-GPON-MIB", "gponPotsProfileName"),
        ("CDATA-GPON-MIB", "gponPotsProfileBindNum"),
        ("CDATA-GPON-MIB", "gponPotsProfileImpedance"),
        ("CDATA-GPON-MIB", "gponPotsProfileSignallingCode"),
        ("CDATA-GPON-MIB", "gponPotsProfileRxGain"),
        ("CDATA-GPON-MIB", "gponPotsProfileTxGain"),
        ("CDATA-GPON-MIB", "gponPotsProfileBindPotsList"))
)
if mibBuilder.loadTexts:
...
gponControlGroup.setObjects(
      *(("CDATA-GPON-MIB", "gponOltPortAutoFindSwitch"),
        ("CDATA-GPON-MIB", "gponOltPortSwitch"),
        ("CDATA-GPON-MIB", "gponOltPortStatus"),
        ("CDATA-GPON-MIB", "gponOltPortDdmTemperature"),
        ("CDATA-GPON-MIB", "gponOltPortDdmVoltage"),
        ("CDATA-GPON-MIB", "gponOltPortDdmTxBiasCurrent"),
        ("CDATA-GPON-MIB", "gponOltPortDdmTxPower"),
        ("CDATA-GPON-MIB", "gponOltPortDdmRxPower"),
        ("CDATA-GPON-MIB", "gponOltTransceiverVendor"),
        ("CDATA-GPON-MIB", "gponOltTransceiverProductName"),
        ("CDATA-GPON-MIB", "gponOltTransceiverVersion"),
        ("CDATA-GPON-MIB", "gponOltTransceiverSerialNumber"),
        ("CDATA-GPON-MIB", "gponOnuId"),
        ("CDATA-GPON-MIB", "gponOnuRowStatus"),
        ("CDATA-GPON-MIB", "gponOnuAuthMode"),
        ("CDATA-GPON-MIB", "gponOnuSn"),
        ("CDATA-GPON-MIB", "gponOnuPassword"),
        ("CDATA-GPON-MIB", "gponOnuLineProfileId"),
        ("CDATA-GPON-MIB", "gponOnuServiceProfileId"),
        ("CDATA-GPON-MIB", "gponOnuDescription"),
        ("CDATA-GPON-MIB", "gponOnuRunState"),
        ("CDATA-GPON-MIB", "gponOnuConfigState"),
        ("CDATA-GPON-MIB", "gponOnuMatchState"),
        ("CDATA-GPON-MIB", "gponOnuDistance"),
        ("CDATA-GPON-MIB", "gponOnuPonPortNum"),
        ("CDATA-GPON-MIB", "gponOnuEthPortNum"),
        ("CDATA-GPON-MIB", "gponOnuPotsPortNum"),
        ("CDATA-GPON-MIB", "gponOnuGemPortNum"),
        ("CDATA-GPON-MIB", "gponOnuTcontNum"),
        ("CDATA-GPON-MIB", "gponOnuFlowControlType"),
        ("CDATA-GPON-MIB", "gponOnuReset"),
        ("CDATA-GPON-MIB", "gponOnuDeactive"),
        ("CDATA-GPON-MIB", "gponOnuAutofindRowStatus"),
        ("CDATA-GPON-MIB", "gponOnuAutofindSn"),
        ("CDATA-GPON-MIB", "gponOnuAutofindPassword"),
        ("CDATA-GPON-MIB", "gponOnuAutofindVendorId"),
        ("CDATA-GPON-MIB", "gponOnuAutofindVersion"),
        ("CDATA-GPON-MIB", "gponOnuAutofindEquipmentID"),
        ("CDATA-GPON-MIB", "gponOnuAutofindSoftwareVersion"),
        ("CDATA-GPON-MIB", "gponOnuAutofindTime"),
        ("CDATA-GPON-MIB", "gponOnuOpticalVoltage"),
        ("CDATA-GPON-MIB", "gponOnuOpticalTxPower"),
        ("CDATA-GPON-MIB", "gponOnuOpticalRxPower"),
        ("CDATA-GPON-MIB", "gponOnuOpticalLaserBiasCurrent"),
        ("CDATA-GPON-MIB", "gponOnuOpticalTemperature"),
        ("CDATA-GPON-MIB", "gponOnuMainSoftwareVersion"),
        ("CDATA-GPON-MIB", "gponOnuStandbySoftwareVersion"),
        ("CDATA-GPON-MIB", "gponOnuEthPortId"),
        ("CDATA-GPON-MIB", "gponOnuEthPortNativeVlanId"),
        ("CDATA-GPON-MIB", "gponOnuEthPortNativeVlanPriority"),
        ("CDATA-GPON-MIB", "gponOnuEthPortInboundCarId"),
        ("CDATA-GPON-MIB", "gponOnuEthPortOutboundCarId"),
        ("CDATA-GPON-MIB", "gponOnuEthPortSpeedAndDuplex"),
        ("CDATA-GPON-MIB", "gponOnuEthPortFlowCtrl"),
        ("CDATA-GPON-MIB", "gponOnuEthPortOperationalState"),
        ("CDATA-GPON-MIB", "gponOnuEthPortSpeedAndDuplexInfo"),
        ("CDATA-GPON-MIB", "gponOnuEthPortState"),
        ("CDATA-GPON-MIB", "gponOnuEthPortMacAddressId"),
        ("CDATA-GPON-MIB", "gponOnuEthPortMacAddress"),
        ("CDATA-GPON-MIB", "gponOnuPotsPortId"),
        ("CDATA-GPON-MIB", "gponOnuPotsPortOperationalState"),
        ("CDATA-GPON-MIB", "gponOnuPotsPortCfgPotsProfileId"),
        ("CDATA-GPON-MIB", "gponOnuIpCfgRowStatus"),
        ("CDATA-GPON-MIB", "gponOnuIpCfgMode"),
        ("CDATA-GPON-MIB", "gponOnuIpCfgVlanId"),
        ("CDATA-GPON-MIB", "gponOnuIpCfgVlanPri"),
        ("CDATA-GPON-MIB", "gponOnuIpCfgIp"),
        ("CDATA-GPON-MIB", "gponOnuIpCfgMask"),
        ("CDATA-GPON-MIB", "gponOnuIpCfgGateway"),
        ("CDATA-GPON-MIB", "gponOnuIpCfgPriDns"),
        ("CDATA-GPON-MIB", "gponOnuIpCfgSlaveDns"),
        ("CDATA-GPON-MIB", "gponOnuIpCfgMacAddress"),
        ("CDATA-GPON-MIB", "gponOnuSipPstnUserRowStatus"),
        ("CDATA-GPON-MIB", "gponOnuSipPstnUserName"),
        ("CDATA-GPON-MIB", "gponOnuSipPstnUserPassword"),
        ("CDATA-GPON-MIB", "gponOnuSipPstnUserTelephoneNumber"),
        ("CDATA-GPON-MIB", "gponOnuSipPstnUserAgentProfileId"),
        ("CDATA-GPON-MIB", "gponOnuSipPstnUserDigitMapProfileId"),
        ("CDATA-GPON-MIB", "gponOnuSipPstnUserSipRightFlagProfileId"),
        ("CDATA-GPON-MIB", "gponOnuSipPstnUserState"),
        ("CDATA-GPON-MIB", "gponOnuSipPstnUserHookState"),
        ("CDATA-GPON-MIB", "gponOnuSipPstnUserCodec"),
        ("CDATA-GPON-MIB", "gponOnuSipPstnUserServerStatus"),
...
gponTrapGroup.setObjects(
      *(("CDATA-GPON-MIB", "gponTrapOltPortId"),
        ("CDATA-GPON-MIB", "gponTrapOnuId"),
        ("CDATA-GPON-MIB", "gponTrapOnuSn"))
)
if mibBuilder.loadTexts:
...
gponAlarmNotification.setObjects(
      *(("CDATA-GPON-MIB", "gponTrapId"),
        ("CDATA-GPON-MIB", "gponTrapState"),
        ("CDATA-GPON-MIB", "gponTrapOltPortId"),
        ("CDATA-GPON-MIB", "gponTrapOnuId"),
        ("CDATA-GPON-MIB", "gponTrapOnuSn"),
        ("CDATA-GPON-MIB", "gponTrapOnuPassword"),
        ("CDATA-GPON-MIB", "gponTrapRogueOnuSn"),
        ("CDATA-GPON-MIB", "gponTrapParameters"))
)
if mibBuilder.loadTexts:
...
gponTrapTypeGroup.setObjects(
      *(("CDATA-GPON-MIB", "gponOltAlarmLosTrap"),
        ("CDATA-GPON-MIB", "gponOltAlarmLosResumeTrap"),
        ("CDATA-GPON-MIB", "gponOnuAutofindTrap"),
        ("CDATA-GPON-MIB", "gponOnuOnlineTrap"),
        ("CDATA-GPON-MIB", "gponOnuOfflineTrap"),
        ("CDATA-GPON-MIB", "gponOnuDyingGasp"))
)
if mibBuilder.loadTexts:
...
gponCompliance.setObjects(
      *(("CDATA-GPON-MIB", "gponDbaProfileGroup"),
        ("CDATA-GPON-MIB", "gponLineProfileGroup"),
        ("CDATA-GPON-MIB", "gponSrvProfileGroup"),
        ("CDATA-GPON-MIB", "gponTrafficProfileGroup"),
        ("CDATA-GPON-MIB", "gponSipAgentProfileGroup"),
        ("CDATA-GPON-MIB", "gponSipRightFlagProfileGroup"),
        ("CDATA-GPON-MIB", "gponDigitMapProfileGroup"),
        ("CDATA-GPON-MIB", "gponPotsProfileGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"GponDbaProfileId": GponDbaProfileId,
       ...
       "gponSipAgentProfileProxyServerPort": gponSipAgentProfileProxyServerPort,
       "gponSipAgentProfileRegistrationServerPort": gponSipAgentProfileRegistrationServerPort,
       ...
       "gponOnuPolicyAuthControlDeviceIndex": gponOnuPolicyAuthControlDeviceIndex,
       ...
       "gponOnuPolicyAuthDeviceIndex": gponOnuPolicyAuthDeviceIndex,
       "gponOnuPolicyAuthRuleIndex": gponOnuPolicyAuthRuleIndex,
       ...
       "gponOnuWanConfig": gponOnuWanConfig,
       "gponOnuWanConfigInfoTable": gponOnuWanConfigInfoTable,
       "gponOnuWanConfigInfoEntry": gponOnuWanConfigInfoEntry,
       "gponOnuWanInfoWanId": gponOnuWanInfoWanId,
       "gponOnuWanConfigConnectionName": gponOnuWanConfigConnectionName,
       "gponOnuWanConfigConnectionStatus": gponOnuWanConfigConnectionStatus,
       "gponOnuWanConfigConnectionAdmin": gponOnuWanConfigConnectionAdmin,
       "gponOnuWanConfigConnectType": gponOnuWanConfigConnectType,
       "gponOnuWanConfigConnectMode": gponOnuWanConfigConnectMode,
       "gponOnuWanConfigIpVersion": gponOnuWanConfigIpVersion,
       "gponOnuWanConfigVlanAdmin": gponOnuWanConfigVlanAdmin,
       "gponOnuWanConfigVlan": gponOnuWanConfigVlan,
       "gponOnuWanConfigVlanPriority": gponOnuWanConfigVlanPriority,
       "gponOnuWanConfigServiceType": gponOnuWanConfigServiceType,
       "gponOnuWanConfigMtu": gponOnuWanConfigMtu,
       "gponOnuWanConfigNatAdmin": gponOnuWanConfigNatAdmin,
       "gponOnuWanConfigLanDhcpAdmin": gponOnuWanConfigLanDhcpAdmin,
       "gponOnuWanConfigBinding": gponOnuWanConfigBinding,
       "gponOnuWanConfigPppoeUserName": gponOnuWanConfigPppoeUserName,
       "gponOnuWanConfigPppoePassWord": gponOnuWanConfigPppoePassWord,
       "gponOnuWanConfigPppoeServiceName": gponOnuWanConfigPppoeServiceName,
       "gponOnuWanConfigPppoeDialOnDemandAdmin": gponOnuWanConfigPppoeDialOnDemandAdmin,
       "gponOnuWanConfigPppoeDialOnDemandInActiveTime": gponOnuWanConfigPppoeDialOnDemandInActiveTime,
       "gponOnuWanConfigRowStatus": gponOnuWanConfigRowStatus,
       "gponOnuWanConfigIpv4Table": gponOnuWanConfigIpv4Table,
       "gponOnuWanConfigIpv4Entry": gponOnuWanConfigIpv4Entry,
       "gponOnuWanConfigIpAddress": gponOnuWanConfigIpAddress,
       "gponOnuWanConfigMask": gponOnuWanConfigMask,
       "gponOnuWanConfigGateWay": gponOnuWanConfigGateWay,
       "gponOnuWanConfigDhcpDnsMode": gponOnuWanConfigDhcpDnsMode,
       "gponOnuWanConfigPrimaryDns": gponOnuWanConfigPrimaryDns,
       "gponOnuWanConfigSecondaryDns": gponOnuWanConfigSecondaryDns,
       ...
       "gponOnuEthPortRTInfoTable": gponOnuEthPortRTInfoTable,
       "gponOnuEthPortRTInfoEntry": gponOnuEthPortRTInfoEntry,
       "gponOnuEthPortStatusInfo": gponOnuEthPortStatusInfo,
