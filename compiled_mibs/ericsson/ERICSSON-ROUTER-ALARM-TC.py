# SNMP MIB module (ERICSSON-ROUTER-ALARM-TC) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\ericsson\ERICSSON-ROUTER-ALARM-TC
...
eriRouterAlarmTc = ModuleIdentity(
    (1, 3, 6, 1, 4, 1, 193, 218, 5, 3)
)
if mibBuilder.loadTexts:
    eriRouterAlarmTc.setRevisions(
        ("2016-05-03 00:00",
         "2016-04-13 00:00",
         "2016-04-07 00:00",
         "2015-01-14 18:00",
...
class EriRouterAlarmId(TextualConvention, Integer32):
    status = "current"
...
class EriRouterAlarmType(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class EriRouterAlarmPerceivedSeverity(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class EriRouterAlarmProbableCause(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class EriRouterAlarmServiceAffecting(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
mibBuilder.exportSymbols(
    ...
    **{"EriRouterAlarmId": EriRouterAlarmId,
       "EriRouterAlarmType": EriRouterAlarmType,
       "EriRouterAlarmPerceivedSeverity": EriRouterAlarmPerceivedSeverity,
       "EriRouterAlarmProbableCause": EriRouterAlarmProbableCause,
       "EriRouterAlarmServiceAffecting": EriRouterAlarmServiceAffecting,
       "eriRouterAlarmTc": eriRouterAlarmTc}
)
