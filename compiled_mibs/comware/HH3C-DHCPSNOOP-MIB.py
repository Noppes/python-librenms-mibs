...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-DHCPSNOOP-MIB
...
_Hh3cDhcpSnoopClientIpAddressType_Type.__name__ = "InetAddressType"
...
_Hh3cDhcpSnoopVlanEnable_Type.__name__ = "TruthValue"
...
_Hh3cDhcpSnoopBindingIP_Type = IpAddress
_Hh3cDhcpSnoopBindingIP_Object = MibScalar
hh3cDhcpSnoopBindingIP = _Hh3cDhcpSnoopBindingIP_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 36, 2, 1, 3),
    _Hh3cDhcpSnoopBindingIP_Type()
)
hh3cDhcpSnoopBindingIP.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cDhcpSnoopBindingIP.setStatus("current")
_Hh3cDhcpSnoopBindingMac_Type = MacAddress
_Hh3cDhcpSnoopBindingMac_Object = MibScalar
hh3cDhcpSnoopBindingMac = _Hh3cDhcpSnoopBindingMac_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 36, 2, 1, 4),
    _Hh3cDhcpSnoopBindingMac_Type()
)
hh3cDhcpSnoopBindingMac.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cDhcpSnoopBindingMac.setStatus("current")
...
hh3cDhcpSnoopNewBinding = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 36, 2, 0, 2)
)
hh3cDhcpSnoopNewBinding.setObjects(
      *(("HH3C-DHCPSNOOP-MIB", "hh3cDhcpSnoopBindingIP"),
        ("HH3C-DHCPSNOOP-MIB", "hh3cDhcpSnoopBindingMac"))
)
if mibBuilder.loadTexts:
    hh3cDhcpSnoopNewBinding.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cDhcpSnoop": hh3cDhcpSnoop,
       ...
       "hh3cDhcpSnoopNewBinding": hh3cDhcpSnoopNewBinding,
       ...
       "hh3cDhcpSnoopBindingIP": hh3cDhcpSnoopBindingIP,
       "hh3cDhcpSnoopBindingMac": hh3cDhcpSnoopBindingMac}
)
