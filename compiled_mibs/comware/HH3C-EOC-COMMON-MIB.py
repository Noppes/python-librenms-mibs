...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-EOC-COMMON-MIB
...
_Hh3cEOCCommonCltAutoAuthorize_Type.__name__ = "TruthValue"
...
_Hh3cEOCCommonCltMaxAllowToAccess_Type.__name__ = "Integer32"
...
_Hh3cEOCComCnuTempIndex_Type = Integer32
_Hh3cEOCComCnuTempIndex_Object = MibTableColumn
hh3cEOCComCnuTempIndex = _Hh3cEOCComCnuTempIndex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 83, 3, 3, 1, 3),
    _Hh3cEOCComCnuTempIndex_Type()
)
hh3cEOCComCnuTempIndex.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cEOCComCnuTempIndex.setStatus("current")
...
_Hh3cEOCComUniFlowControl_Type.__name__ = "TruthValue"
...
hh3cEOCLoopbackDetectTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 83, 5, 0, 23)
)
hh3cEOCLoopbackDetectTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("HH3C-EOC-COMMON-MIB", "hh3cEOCComCnuMacAddress"))
)
if mibBuilder.loadTexts:
    hh3cEOCLoopbackDetectTrap.setStatus(
        "current"
    )

hh3cEOCLoopbackRecoverTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 83, 5, 0, 24)
)
hh3cEOCLoopbackRecoverTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("HH3C-EOC-COMMON-MIB", "hh3cEOCComCnuMacAddress"))
)
if mibBuilder.loadTexts:
    hh3cEOCLoopbackRecoverTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cEOCCommon": hh3cEOCCommon,
       ...
       "hh3cEOCComCnuTempIndex": hh3cEOCComCnuTempIndex,
       ...
       "hh3cEOCLoopbackDetectTrap": hh3cEOCLoopbackDetectTrap,
       "hh3cEOCLoopbackRecoverTrap": hh3cEOCLoopbackRecoverTrap,
