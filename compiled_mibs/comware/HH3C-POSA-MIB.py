...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-POSA-MIB
...
_Hh3cPosaSrvStateChangeTrapEnable_Type.__name__ = "TruthValue"
...
_Hh3cPosaAppStateChangeTrapEnable_Type.__name__ = "TruthValue"
...
_Hh3cPosaTerminalHangUpTrapEnable_Type.__name__ = "TruthValue"
...
_Hh3cPosaFcmLnkNegoFailTrapEnable_Type.__name__ = "TruthValue"
...
_Hh3cPosaFcmPhyNegoFailTrapEnable_Type.__name__ = "TruthValue"
...
_Hh3cPosaTcpConnectionThreshold_Type.__name__ = "Integer32"
...
_Hh3cPosaFcmConnectionThreshold_Type.__name__ = "Integer32"
...
_Hh3cPosaTcpConnectionTrapEnable_Type.__name__ = "TruthValue"
...
_Hh3cPosaFcmConnectionTrapEnable_Type.__name__ = "TruthValue"
...
_Hh3cPosaTcpTradeLimit_Type.__name__ = "Integer32"
...
_Hh3cPosaTcpTradeTrapEnable_Type.__name__ = "TruthValue"
...
_Hh3cPosaTcpTradeTimeout_Type.__name__ = "Integer32"
...
class _Hh3cPosaTradeSuccessFallingTrapEnable_Type(TruthValue):
    """Custom type hh3cPosaTradeSuccessFallingTrapEnable based on TruthValue"""
    defaultValue = 1


_Hh3cPosaTradeSuccessFallingTrapEnable_Type.__name__ = "TruthValue"
_Hh3cPosaTradeSuccessFallingTrapEnable_Object = MibScalar
hh3cPosaTradeSuccessFallingTrapEnable = _Hh3cPosaTradeSuccessFallingTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 1, 19),
    _Hh3cPosaTradeSuccessFallingTrapEnable_Type()
)
hh3cPosaTradeSuccessFallingTrapEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cPosaTradeSuccessFallingTrapEnable.setStatus("current")


class _Hh3cPosaTradeSuccessFallingThreshold_Type(Integer32):
    """Custom type hh3cPosaTradeSuccessFallingThreshold based on Integer32"""
    defaultValue = 90


_Hh3cPosaTradeSuccessFallingThreshold_Type.__name__ = "Integer32"
_Hh3cPosaTradeSuccessFallingThreshold_Object = MibScalar
hh3cPosaTradeSuccessFallingThreshold = _Hh3cPosaTradeSuccessFallingThreshold_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 1, 20),
    _Hh3cPosaTradeSuccessFallingThreshold_Type()
)
hh3cPosaTradeSuccessFallingThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cPosaTradeSuccessFallingThreshold.setStatus("current")


class _Hh3cPosaE1DialFallingTrapEnable_Type(TruthValue):
    """Custom type hh3cPosaE1DialFallingTrapEnable based on TruthValue"""
    defaultValue = 1


_Hh3cPosaE1DialFallingTrapEnable_Type.__name__ = "TruthValue"
_Hh3cPosaE1DialFallingTrapEnable_Object = MibScalar
hh3cPosaE1DialFallingTrapEnable = _Hh3cPosaE1DialFallingTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 1, 21),
    _Hh3cPosaE1DialFallingTrapEnable_Type()
)
hh3cPosaE1DialFallingTrapEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cPosaE1DialFallingTrapEnable.setStatus("current")


class _Hh3cPosaE1DialFallingThreshold_Type(Integer32):
    """Custom type hh3cPosaE1DialFallingThreshold based on Integer32"""
    defaultValue = 90


_Hh3cPosaE1DialFallingThreshold_Type.__name__ = "Integer32"
_Hh3cPosaE1DialFallingThreshold_Object = MibScalar
hh3cPosaE1DialFallingThreshold = _Hh3cPosaE1DialFallingThreshold_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 1, 22),
    _Hh3cPosaE1DialFallingThreshold_Type()
)
hh3cPosaE1DialFallingThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cPosaE1DialFallingThreshold.setStatus("current")


class _Hh3cPosaFcmTradeAbnormalTrapEnable_Type(TruthValue):
    """Custom type hh3cPosaFcmTradeAbnormalTrapEnable based on TruthValue"""
    defaultValue = 1


_Hh3cPosaFcmTradeAbnormalTrapEnable_Type.__name__ = "TruthValue"
_Hh3cPosaFcmTradeAbnormalTrapEnable_Object = MibScalar
hh3cPosaFcmTradeAbnormalTrapEnable = _Hh3cPosaFcmTradeAbnormalTrapEnable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 1, 23),
    _Hh3cPosaFcmTradeAbnormalTrapEnable_Type()
)
hh3cPosaFcmTradeAbnormalTrapEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cPosaFcmTradeAbnormalTrapEnable.setStatus("current")
...
_Hh3cPosaAppServiceType_Type.__name__ = "Hh3cAppServiceType"
...
_Hh3cPosaAppMode_Type.__name__ = "Hh3cAppMode"
...
_Hh3cPosaCallerIDTransEnable_Type.__name__ = "TruthValue"
...
_Hh3cPosaTpduChangeStrategy_Type.__name__ = "Hh3cTpduChangeStrategy"
...
_Hh3cPosaAppHello_Type.__name__ = "TruthValue"
...
_Hh3cPosaTerminalAccessType_Type.__name__ = "Hh3cTerminalAccessType"
...
_Hh3cPosaFcmStatTransCntsClear_Type.__name__ = "TruthValue"
...
_Hh3cPosaTermianlTcpConnectionNumber_Type = Integer32
_Hh3cPosaTermianlTcpConnectionNumber_Object = MibTableColumn
hh3cPosaTermianlTcpConnectionNumber = _Hh3cPosaTermianlTcpConnectionNumber_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 6, 1, 7),
    _Hh3cPosaTermianlTcpConnectionNumber_Type()
)
hh3cPosaTermianlTcpConnectionNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaTermianlTcpConnectionNumber.setStatus("current")
...
hh3cPosaCallerStatCallerID.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
_Hh3cPosaNiiStatTable_Object = MibTable
hh3cPosaNiiStatTable = _Hh3cPosaNiiStatTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 11)
)
if mibBuilder.loadTexts:
    hh3cPosaNiiStatTable.setStatus("current")
_Hh3cPosaNiiStatEntry_Object = MibTableRow
hh3cPosaNiiStatEntry = _Hh3cPosaNiiStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 11, 1)
)
hh3cPosaNiiStatEntry.setIndexNames(
    (0, "HH3C-POSA-MIB", "hh3cPosaNiiStatIndex"),
)
if mibBuilder.loadTexts:
    hh3cPosaNiiStatEntry.setStatus("current")


class _Hh3cPosaNiiStatIndex_Type(OctetString):
    """Custom type hh3cPosaNiiStatIndex based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cPosaNiiStatIndex_Type.__name__ = "OctetString"
_Hh3cPosaNiiStatIndex_Object = MibTableColumn
hh3cPosaNiiStatIndex = _Hh3cPosaNiiStatIndex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 11, 1, 1),
    _Hh3cPosaNiiStatIndex_Type()
)
hh3cPosaNiiStatIndex.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cPosaNiiStatIndex.setStatus("current")
_Hh3cPosaNiiRecvPkts_Type = Counter32
_Hh3cPosaNiiRecvPkts_Object = MibTableColumn
hh3cPosaNiiRecvPkts = _Hh3cPosaNiiRecvPkts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 11, 1, 2),
    _Hh3cPosaNiiRecvPkts_Type()
)
hh3cPosaNiiRecvPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaNiiRecvPkts.setStatus("current")
_Hh3cPosaNiiSendPkts_Type = Counter32
_Hh3cPosaNiiSendPkts_Object = MibTableColumn
hh3cPosaNiiSendPkts = _Hh3cPosaNiiSendPkts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 11, 1, 3),
    _Hh3cPosaNiiSendPkts_Type()
)
hh3cPosaNiiSendPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaNiiSendPkts.setStatus("current")
_Hh3cPosaNiiSuccessTradeCnt_Type = Counter32
_Hh3cPosaNiiSuccessTradeCnt_Object = MibTableColumn
hh3cPosaNiiSuccessTradeCnt = _Hh3cPosaNiiSuccessTradeCnt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 11, 1, 4),
    _Hh3cPosaNiiSuccessTradeCnt_Type()
)
hh3cPosaNiiSuccessTradeCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaNiiSuccessTradeCnt.setStatus("current")
_Hh3cPosaNiiTradeCnt_Type = Counter32
_Hh3cPosaNiiTradeCnt_Object = MibTableColumn
hh3cPosaNiiTradeCnt = _Hh3cPosaNiiTradeCnt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 11, 1, 5),
    _Hh3cPosaNiiTradeCnt_Type()
)
hh3cPosaNiiTradeCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaNiiTradeCnt.setStatus("current")
_Hh3cPosaE1StatTable_Object = MibTable
hh3cPosaE1StatTable = _Hh3cPosaE1StatTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 12)
)
if mibBuilder.loadTexts:
    hh3cPosaE1StatTable.setStatus("current")
_Hh3cPosaE1StatEntry_Object = MibTableRow
hh3cPosaE1StatEntry = _Hh3cPosaE1StatEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 12, 1)
)
hh3cPosaE1StatEntry.setIndexNames(
    (0, "HH3C-POSA-MIB", "hh3cPosaE1StatIndex"),
)
if mibBuilder.loadTexts:
    hh3cPosaE1StatEntry.setStatus("current")


class _Hh3cPosaE1StatIndex_Type(Integer32):
    """Custom type hh3cPosaE1StatIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cPosaE1StatIndex_Type.__name__ = "Integer32"
_Hh3cPosaE1StatIndex_Object = MibTableColumn
hh3cPosaE1StatIndex = _Hh3cPosaE1StatIndex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 12, 1, 1),
    _Hh3cPosaE1StatIndex_Type()
)
hh3cPosaE1StatIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cPosaE1StatIndex.setStatus("current")
_Hh3cPosaE1DialCnt_Type = Counter32
_Hh3cPosaE1DialCnt_Object = MibTableColumn
hh3cPosaE1DialCnt = _Hh3cPosaE1DialCnt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 12, 1, 2),
    _Hh3cPosaE1DialCnt_Type()
)
hh3cPosaE1DialCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaE1DialCnt.setStatus("current")
_Hh3cPosaE1DialSuccess_Type = Counter32
_Hh3cPosaE1DialSuccess_Object = MibTableColumn
hh3cPosaE1DialSuccess = _Hh3cPosaE1DialSuccess_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 12, 1, 3),
    _Hh3cPosaE1DialSuccess_Type()
)
hh3cPosaE1DialSuccess.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaE1DialSuccess.setStatus("current")
_Hh3cPosaE1RecvPkts_Type = Counter32
_Hh3cPosaE1RecvPkts_Object = MibTableColumn
hh3cPosaE1RecvPkts = _Hh3cPosaE1RecvPkts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 12, 1, 4),
    _Hh3cPosaE1RecvPkts_Type()
)
hh3cPosaE1RecvPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaE1RecvPkts.setStatus("current")
_Hh3cPosaE1SendPkts_Type = Counter32
_Hh3cPosaE1SendPkts_Object = MibTableColumn
hh3cPosaE1SendPkts = _Hh3cPosaE1SendPkts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 12, 1, 5),
    _Hh3cPosaE1SendPkts_Type()
)
hh3cPosaE1SendPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaE1SendPkts.setStatus("current")
_Hh3cPosaE1ErrPkts_Type = Counter32
_Hh3cPosaE1ErrPkts_Object = MibTableColumn
hh3cPosaE1ErrPkts = _Hh3cPosaE1ErrPkts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 12, 1, 6),
    _Hh3cPosaE1ErrPkts_Type()
)
hh3cPosaE1ErrPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaE1ErrPkts.setStatus("current")
_Hh3cPosaE1MapErrCnts_Type = Counter32
_Hh3cPosaE1MapErrCnts_Object = MibTableColumn
hh3cPosaE1MapErrCnts = _Hh3cPosaE1MapErrCnts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 12, 1, 7),
    _Hh3cPosaE1MapErrCnts_Type()
)
hh3cPosaE1MapErrCnts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaE1MapErrCnts.setStatus("current")
_Hh3cPosaE1InDiscardedPkts_Type = Counter32
_Hh3cPosaE1InDiscardedPkts_Object = MibTableColumn
hh3cPosaE1InDiscardedPkts = _Hh3cPosaE1InDiscardedPkts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 12, 1, 8),
    _Hh3cPosaE1InDiscardedPkts_Type()
)
hh3cPosaE1InDiscardedPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaE1InDiscardedPkts.setStatus("current")
_Hh3cPosaE1OutDiscardedPkts_Type = Counter32
_Hh3cPosaE1OutDiscardedPkts_Object = MibTableColumn
hh3cPosaE1OutDiscardedPkts = _Hh3cPosaE1OutDiscardedPkts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 2, 12, 1, 9),
    _Hh3cPosaE1OutDiscardedPkts_Type()
)
hh3cPosaE1OutDiscardedPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPosaE1OutDiscardedPkts.setStatus("current")
...
hh3cPosaTerminalHangUp.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("HH3C-POSA-MIB", "hh3cPosaCallerStatCallerID"))
)
if mibBuilder.loadTexts:
...
hh3cPosaTradeSuccessFalling = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 3, 0, 9)
)
hh3cPosaTradeSuccessFalling.setObjects(
      *(("HH3C-POSA-MIB", "hh3cPosaNiiStatIndex"),
        ("HH3C-POSA-MIB", "hh3cPosaTradeSuccessFallingThreshold"))
)
if mibBuilder.loadTexts:
    hh3cPosaTradeSuccessFalling.setStatus(
        "current"
    )

hh3cPosaE1DialFalling = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 3, 0, 10)
)
hh3cPosaE1DialFalling.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("HH3C-POSA-MIB", "hh3cPosaE1DialFallingThreshold"))
)
if mibBuilder.loadTexts:
    hh3cPosaE1DialFalling.setStatus(
        "current"
    )

hh3cPosaFcmTradeAbnormal = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 92, 3, 0, 11)
)
hh3cPosaFcmTradeAbnormal.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("HH3C-POSA-MIB", "hh3cPosaCallerStatCallerID"))
)
if mibBuilder.loadTexts:
    hh3cPosaFcmTradeAbnormal.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"Hh3cAppServiceType": Hh3cAppServiceType,
       ...
       "hh3cPosaTradeSuccessFallingTrapEnable": hh3cPosaTradeSuccessFallingTrapEnable,
       "hh3cPosaTradeSuccessFallingThreshold": hh3cPosaTradeSuccessFallingThreshold,
       "hh3cPosaE1DialFallingTrapEnable": hh3cPosaE1DialFallingTrapEnable,
       "hh3cPosaE1DialFallingThreshold": hh3cPosaE1DialFallingThreshold,
       "hh3cPosaFcmTradeAbnormalTrapEnable": hh3cPosaFcmTradeAbnormalTrapEnable,
       ...
       "hh3cPosaTermianlTcpConnectionNumber": hh3cPosaTermianlTcpConnectionNumber,
       ...
       "hh3cPosaNiiStatTable": hh3cPosaNiiStatTable,
       "hh3cPosaNiiStatEntry": hh3cPosaNiiStatEntry,
       "hh3cPosaNiiStatIndex": hh3cPosaNiiStatIndex,
       "hh3cPosaNiiRecvPkts": hh3cPosaNiiRecvPkts,
       "hh3cPosaNiiSendPkts": hh3cPosaNiiSendPkts,
       "hh3cPosaNiiSuccessTradeCnt": hh3cPosaNiiSuccessTradeCnt,
       "hh3cPosaNiiTradeCnt": hh3cPosaNiiTradeCnt,
       "hh3cPosaE1StatTable": hh3cPosaE1StatTable,
       "hh3cPosaE1StatEntry": hh3cPosaE1StatEntry,
       "hh3cPosaE1StatIndex": hh3cPosaE1StatIndex,
       "hh3cPosaE1DialCnt": hh3cPosaE1DialCnt,
       "hh3cPosaE1DialSuccess": hh3cPosaE1DialSuccess,
       "hh3cPosaE1RecvPkts": hh3cPosaE1RecvPkts,
       "hh3cPosaE1SendPkts": hh3cPosaE1SendPkts,
       "hh3cPosaE1ErrPkts": hh3cPosaE1ErrPkts,
       "hh3cPosaE1MapErrCnts": hh3cPosaE1MapErrCnts,
       "hh3cPosaE1InDiscardedPkts": hh3cPosaE1InDiscardedPkts,
       "hh3cPosaE1OutDiscardedPkts": hh3cPosaE1OutDiscardedPkts,
       ...
       "hh3cPosaTradeSuccessFalling": hh3cPosaTradeSuccessFalling,
       "hh3cPosaE1DialFalling": hh3cPosaE1DialFalling,
       "hh3cPosaFcmTradeAbnormal": hh3cPosaFcmTradeAbnormal,
