...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-USER-MIB
...
class _Hh3cUserName_Type(DisplayString):
    """Custom type hh3cUserName based on DisplayString"""
...
_Hh3cUserName_Type.__name__ = "DisplayString"
...
class _Hh3cUserPassword_Type(DisplayString):
    """Custom type hh3cUserPassword based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cUserPassword_Type.__name__ = "DisplayString"
...
class _Hh3cUserIndex_Type(Integer32):
    """Custom type hh3cUserIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cUserIndex_Type.__name__ = "Integer32"
...
class _Hh3cUserGroup_Type(DisplayString):
    """Custom type hh3cUserGroup based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_Hh3cUserGroup_Type.__name__ = "DisplayString"
...
_Hh3cPPPService_Type = ServiceType
_Hh3cPPPService_Object = MibTableColumn
hh3cPPPService = _Hh3cPPPService_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 12, 1, 2, 1, 19),
    _Hh3cPPPService_Type()
)
hh3cPPPService.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cPPPService.setStatus("current")
_Hh3cHttpService_Type = ServiceType
_Hh3cHttpService_Object = MibTableColumn
hh3cHttpService = _Hh3cHttpService_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 12, 1, 2, 1, 20),
    _Hh3cHttpService_Type()
)
hh3cHttpService.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cHttpService.setStatus("current")
_Hh3cHttpsService_Type = ServiceType
_Hh3cHttpsService_Object = MibTableColumn
hh3cHttpsService = _Hh3cHttpsService_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 12, 1, 2, 1, 21),
    _Hh3cHttpsService_Type()
)
hh3cHttpsService.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cHttpsService.setStatus("current")
_Hh3cUserIfIndex_Type = Integer32
_Hh3cUserIfIndex_Object = MibTableColumn
hh3cUserIfIndex = _Hh3cUserIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 12, 1, 2, 1, 22),
    _Hh3cUserIfIndex_Type()
)
hh3cUserIfIndex.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cUserIfIndex.setStatus("current")
...
_Hh3cUserRoleTable_Object = MibTable
hh3cUserRoleTable = _Hh3cUserRoleTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 12, 1, 6)
)
if mibBuilder.loadTexts:
    hh3cUserRoleTable.setStatus("current")
_Hh3cUserRoleEntry_Object = MibTableRow
hh3cUserRoleEntry = _Hh3cUserRoleEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 12, 1, 6, 1)
)
hh3cUserRoleEntry.setIndexNames(
    (0, "HH3C-USER-MIB", "hh3cUserIndex"),
    (0, "HH3C-USER-MIB", "hh3cUserRole"),
)
if mibBuilder.loadTexts:
    hh3cUserRoleEntry.setStatus("current")


class _Hh3cUserRole_Type(DisplayString):
    """Custom type hh3cUserRole based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cUserRole_Type.__name__ = "DisplayString"
_Hh3cUserRole_Object = MibTableColumn
hh3cUserRole = _Hh3cUserRole_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 12, 1, 6, 1, 1),
    _Hh3cUserRole_Type()
)
hh3cUserRole.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cUserRole.setStatus("current")
_Hh3cUserRoleStatus_Type = RowStatus
_Hh3cUserRoleStatus_Object = MibTableColumn
hh3cUserRoleStatus = _Hh3cUserRoleStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 12, 1, 6, 1, 2),
    _Hh3cUserRoleStatus_Type()
)
hh3cUserRoleStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cUserRoleStatus.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"ServiceType": ServiceType,
       ...
       "hh3cPPPService": hh3cPPPService,
       "hh3cHttpService": hh3cHttpService,
       "hh3cHttpsService": hh3cHttpsService,
       "hh3cUserIfIndex": hh3cUserIfIndex,
       "hh3cUserMaxNum": hh3cUserMaxNum,
       "hh3cUserCurrNum": hh3cUserCurrNum,
       "hh3cUserIndexIndicator": hh3cUserIndexIndicator,
       "hh3cUserRoleTable": hh3cUserRoleTable,
       "hh3cUserRoleEntry": hh3cUserRoleEntry,
       "hh3cUserRole": hh3cUserRole,
       "hh3cUserRoleStatus": hh3cUserRoleStatus,
