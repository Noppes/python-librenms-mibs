...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-TRAP-MIB
...
_Hh3cDefaultRtDelTrapEnable_Type.__name__ = "TruthValue"
...
class _Hh3cPeriodicalTrapSwitch2_Type(Integer32):
    """Custom type hh3cPeriodicalTrapSwitch2 based on Integer32"""
    defaultValue = 1
...
_Hh3cPeriodicalTrapSwitch2_Type.__name__ = "Integer32"
_Hh3cPeriodicalTrapSwitch2_Object = MibScalar
hh3cPeriodicalTrapSwitch2 = _Hh3cPeriodicalTrapSwitch2_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 38, 1, 6, 1, 3),
    _Hh3cPeriodicalTrapSwitch2_Type()
)
hh3cPeriodicalTrapSwitch2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cPeriodicalTrapSwitch2.setStatus("current")
...
class _Hh3cTrapConfigSwitch2_Type(Integer32):
    """Custom type hh3cTrapConfigSwitch2 based on Integer32"""
    defaultValue = 1
...
_Hh3cTrapConfigSwitch2_Type.__name__ = "Integer32"
_Hh3cTrapConfigSwitch2_Object = MibTableColumn
hh3cTrapConfigSwitch2 = _Hh3cTrapConfigSwitch2_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 38, 1, 8, 1, 1, 5),
    _Hh3cTrapConfigSwitch2_Type()
)
hh3cTrapConfigSwitch2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cTrapConfigSwitch2.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cTrap": hh3cTrap,
       ...
       "hh3cPeriodicalTrapSwitch2": hh3cPeriodicalTrapSwitch2,
       ...
       "hh3cTrapConfigSwitch2": hh3cTrapConfigSwitch2}
)
