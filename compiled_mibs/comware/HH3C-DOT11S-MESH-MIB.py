...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-DOT11S-MESH-MIB
...
_Hh3cDot11sMeshPflBindIntNum_Type.__name__ = "Integer32"
...
_Hh3cDot11sMeshMkdServEnable_Type.__name__ = "TruthValue"
...
_Hh3cDot11sMeshPflEnable_Type.__name__ = "TruthValue"
...
class _Hh3cDot11sMeshAKMMode_Type(Hh3cDot11AKMType):
    """Custom type hh3cDot11sMeshAKMMode based on Hh3cDot11AKMType"""
    defaultValue = 1


_Hh3cDot11sMeshAKMMode_Type.__name__ = "Hh3cDot11AKMType"
_Hh3cDot11sMeshAKMMode_Object = MibTableColumn
hh3cDot11sMeshAKMMode = _Hh3cDot11sMeshAKMMode_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 2, 1, 9),
    _Hh3cDot11sMeshAKMMode_Type()
)
hh3cDot11sMeshAKMMode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sMeshAKMMode.setStatus("current")
_Hh3cDot11sMeshSimpleKey_Type = OctetString
_Hh3cDot11sMeshSimpleKey_Object = MibTableColumn
hh3cDot11sMeshSimpleKey = _Hh3cDot11sMeshSimpleKey_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 2, 1, 10),
    _Hh3cDot11sMeshSimpleKey_Type()
)
hh3cDot11sMeshSimpleKey.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sMeshSimpleKey.setStatus("current")
...
_Hh3cDot11sMpPlcyInitEnable_Type.__name__ = "TruthValue"
...
_Hh3cDot11sMlspEnable_Type.__name__ = "TruthValue"
...
_Hh3cDot11sRoleAuthEnable_Type.__name__ = "TruthValue"
...
class _Hh3cDot11sMlspMode_Type(Integer32):
    """Custom type hh3cDot11sMlspMode based on Integer32"""
    defaultValue = 0
...
_Hh3cDot11sMlspMode_Type.__name__ = "Integer32"
_Hh3cDot11sMlspMode_Object = MibTableColumn
hh3cDot11sMlspMode = _Hh3cDot11sMlspMode_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 14),
    _Hh3cDot11sMlspMode_Type()
)
hh3cDot11sMlspMode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sMlspMode.setStatus("current")


class _Hh3cDot11sWaveGuideHoldRSSI_Type(Integer32):
    """Custom type hh3cDot11sWaveGuideHoldRSSI based on Integer32"""
    defaultValue = 15
...
_Hh3cDot11sWaveGuideHoldRSSI_Type.__name__ = "Integer32"
_Hh3cDot11sWaveGuideHoldRSSI_Object = MibTableColumn
hh3cDot11sWaveGuideHoldRSSI = _Hh3cDot11sWaveGuideHoldRSSI_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 15),
    _Hh3cDot11sWaveGuideHoldRSSI_Type()
)
hh3cDot11sWaveGuideHoldRSSI.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sWaveGuideHoldRSSI.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDot11sWaveGuideHoldRSSI.setUnits("dBm")


class _Hh3cDot11sWaveGuideSwitch_Type(TruthValue):
    """Custom type hh3cDot11sWaveGuideSwitch based on TruthValue"""
    defaultValue = 2


_Hh3cDot11sWaveGuideSwitch_Type.__name__ = "TruthValue"
_Hh3cDot11sWaveGuideSwitch_Object = MibTableColumn
hh3cDot11sWaveGuideSwitch = _Hh3cDot11sWaveGuideSwitch_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 16),
    _Hh3cDot11sWaveGuideSwitch_Type()
)
hh3cDot11sWaveGuideSwitch.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sWaveGuideSwitch.setStatus("current")


class _Hh3cDot11sOptimizeEnable_Type(TruthValue):
    """Custom type hh3cDot11sOptimizeEnable based on TruthValue"""
    defaultValue = 2


_Hh3cDot11sOptimizeEnable_Type.__name__ = "TruthValue"
_Hh3cDot11sOptimizeEnable_Object = MibTableColumn
hh3cDot11sOptimizeEnable = _Hh3cDot11sOptimizeEnable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 17),
    _Hh3cDot11sOptimizeEnable_Type()
)
hh3cDot11sOptimizeEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sOptimizeEnable.setStatus("current")


class _Hh3cDot11sOptimizeThreshold_Type(Integer32):
    """Custom type hh3cDot11sOptimizeThreshold based on Integer32"""
    defaultValue = 30

    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(15, 80),
    )


_Hh3cDot11sOptimizeThreshold_Type.__name__ = "Integer32"
_Hh3cDot11sOptimizeThreshold_Object = MibTableColumn
hh3cDot11sOptimizeThreshold = _Hh3cDot11sOptimizeThreshold_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 18),
    _Hh3cDot11sOptimizeThreshold_Type()
)
hh3cDot11sOptimizeThreshold.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sOptimizeThreshold.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDot11sOptimizeThreshold.setUnits("dBm")


class _Hh3cDot11sMlspLogEnable_Type(TruthValue):
    """Custom type hh3cDot11sMlspLogEnable based on TruthValue"""
    defaultValue = 2


_Hh3cDot11sMlspLogEnable_Type.__name__ = "TruthValue"
_Hh3cDot11sMlspLogEnable_Object = MibTableColumn
hh3cDot11sMlspLogEnable = _Hh3cDot11sMlspLogEnable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 19),
    _Hh3cDot11sMlspLogEnable_Type()
)
hh3cDot11sMlspLogEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sMlspLogEnable.setStatus("current")


class _Hh3cDot11sMlspLogInterval_Type(Integer32):
    """Custom type hh3cDot11sMlspLogInterval based on Integer32"""
    defaultValue = 1000
...
_Hh3cDot11sMlspLogInterval_Type.__name__ = "Integer32"
_Hh3cDot11sMlspLogInterval_Object = MibTableColumn
hh3cDot11sMlspLogInterval = _Hh3cDot11sMlspLogInterval_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 20),
    _Hh3cDot11sMlspLogInterval_Type()
)
hh3cDot11sMlspLogInterval.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sMlspLogInterval.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDot11sMlspLogInterval.setUnits("millisecond")


class _Hh3cDot11sActiveKeepaliveCount_Type(Integer32):
    """Custom type hh3cDot11sActiveKeepaliveCount based on Integer32"""
    defaultValue = 6
...
_Hh3cDot11sActiveKeepaliveCount_Type.__name__ = "Integer32"
_Hh3cDot11sActiveKeepaliveCount_Object = MibTableColumn
hh3cDot11sActiveKeepaliveCount = _Hh3cDot11sActiveKeepaliveCount_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 21),
    _Hh3cDot11sActiveKeepaliveCount_Type()
)
hh3cDot11sActiveKeepaliveCount.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sActiveKeepaliveCount.setStatus("current")


class _Hh3cDot11sLinkEstaThreshold_Type(Integer32):
    """Custom type hh3cDot11sLinkEstaThreshold based on Integer32"""
    defaultValue = 5
...
_Hh3cDot11sLinkEstaThreshold_Type.__name__ = "Integer32"
_Hh3cDot11sLinkEstaThreshold_Object = MibTableColumn
hh3cDot11sLinkEstaThreshold = _Hh3cDot11sLinkEstaThreshold_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 22),
    _Hh3cDot11sLinkEstaThreshold_Type()
)
hh3cDot11sLinkEstaThreshold.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sLinkEstaThreshold.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDot11sLinkEstaThreshold.setUnits("dBm")


class _Hh3cDot11sTransmissionMethod_Type(Integer32):
    """Custom type hh3cDot11sTransmissionMethod based on Integer32"""
    defaultValue = 0
...
_Hh3cDot11sTransmissionMethod_Type.__name__ = "Integer32"
_Hh3cDot11sTransmissionMethod_Object = MibTableColumn
hh3cDot11sTransmissionMethod = _Hh3cDot11sTransmissionMethod_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 23),
    _Hh3cDot11sTransmissionMethod_Type()
)
hh3cDot11sTransmissionMethod.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sTransmissionMethod.setStatus("current")


class _Hh3cDot11sTransmitLevel_Type(Integer32):
    """Custom type hh3cDot11sTransmitLevel based on Integer32"""
    defaultValue = 0
...
_Hh3cDot11sTransmitLevel_Type.__name__ = "Integer32"
_Hh3cDot11sTransmitLevel_Object = MibTableColumn
hh3cDot11sTransmitLevel = _Hh3cDot11sTransmitLevel_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 24),
    _Hh3cDot11sTransmitLevel_Type()
)
hh3cDot11sTransmitLevel.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sTransmitLevel.setStatus("current")


class _Hh3cDot11sTempLinkEnable_Type(TruthValue):
    """Custom type hh3cDot11sTempLinkEnable based on TruthValue"""
    defaultValue = 1


_Hh3cDot11sTempLinkEnable_Type.__name__ = "TruthValue"
_Hh3cDot11sTempLinkEnable_Object = MibTableColumn
hh3cDot11sTempLinkEnable = _Hh3cDot11sTempLinkEnable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 3, 1, 25),
    _Hh3cDot11sTempLinkEnable_Type()
)
hh3cDot11sTempLinkEnable.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sTempLinkEnable.setStatus("current")
...
_Hh3cDot11sMeshPflMap_Type.__name__ = "Integer32"
...
_Hh3cDot11sMpPlcyMap_Type.__name__ = "Integer32"
...
class _Hh3cDot11sBindInterface_Type(Integer32):
    """Custom type hh3cDot11sBindInterface based on Integer32"""
    defaultValue = -1


_Hh3cDot11sBindInterface_Type.__name__ = "Integer32"
_Hh3cDot11sBindInterface_Object = MibTableColumn
hh3cDot11sBindInterface = _Hh3cDot11sBindInterface_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 5, 1, 4),
    _Hh3cDot11sBindInterface_Type()
)
hh3cDot11sBindInterface.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cDot11sBindInterface.setStatus("current")
...
_Hh3cDot11sPortalEnable_Type.__name__ = "TruthValue"
...
_Hh3cDot11sMlspExtCfgTable_Object = MibTable
hh3cDot11sMlspExtCfgTable = _Hh3cDot11sMlspExtCfgTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 7)
)
if mibBuilder.loadTexts:
    hh3cDot11sMlspExtCfgTable.setStatus("current")
_Hh3cDot11sMlspExtCfgEntry_Object = MibTableRow
hh3cDot11sMlspExtCfgEntry = _Hh3cDot11sMlspExtCfgEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 7, 1)
)
hh3cDot11sMlspExtCfgEntry.setIndexNames(
    (0, "HH3C-DOT11S-MESH-MIB", "hh3cDot11sMlspExtPolicyName"),
    (0, "HH3C-DOT11S-MESH-MIB", "hh3cDot11sMlspExtProxyMac"),
    (0, "HH3C-DOT11S-MESH-MIB", "hh3cDot11sMlspExtProxyVlanID"),
)
if mibBuilder.loadTexts:
    hh3cDot11sMlspExtCfgEntry.setStatus("current")


class _Hh3cDot11sMlspExtPolicyName_Type(OctetString):
    """Custom type hh3cDot11sMlspExtPolicyName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 31),
    )
...
_Hh3cDot11sMlspExtPolicyName_Type.__name__ = "OctetString"
_Hh3cDot11sMlspExtPolicyName_Object = MibTableColumn
hh3cDot11sMlspExtPolicyName = _Hh3cDot11sMlspExtPolicyName_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 7, 1, 1),
    _Hh3cDot11sMlspExtPolicyName_Type()
)
hh3cDot11sMlspExtPolicyName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11sMlspExtPolicyName.setStatus("current")
_Hh3cDot11sMlspExtProxyMac_Type = MacAddress
_Hh3cDot11sMlspExtProxyMac_Object = MibTableColumn
hh3cDot11sMlspExtProxyMac = _Hh3cDot11sMlspExtProxyMac_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 7, 1, 2),
    _Hh3cDot11sMlspExtProxyMac_Type()
)
hh3cDot11sMlspExtProxyMac.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11sMlspExtProxyMac.setStatus("current")


class _Hh3cDot11sMlspExtProxyVlanID_Type(Integer32):
    """Custom type hh3cDot11sMlspExtProxyVlanID based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cDot11sMlspExtProxyVlanID_Type.__name__ = "Integer32"
_Hh3cDot11sMlspExtProxyVlanID_Object = MibTableColumn
hh3cDot11sMlspExtProxyVlanID = _Hh3cDot11sMlspExtProxyVlanID_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 7, 1, 3),
    _Hh3cDot11sMlspExtProxyVlanID_Type()
)
hh3cDot11sMlspExtProxyVlanID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11sMlspExtProxyVlanID.setStatus("current")
_Hh3cDot11sMlspExtProxyIP_Type = IpAddress
_Hh3cDot11sMlspExtProxyIP_Object = MibTableColumn
hh3cDot11sMlspExtProxyIP = _Hh3cDot11sMlspExtProxyIP_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 7, 1, 4),
    _Hh3cDot11sMlspExtProxyIP_Type()
)
hh3cDot11sMlspExtProxyIP.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sMlspExtProxyIP.setStatus("current")
_Hh3cDot11sMlspExtRowStatus_Type = RowStatus
_Hh3cDot11sMlspExtRowStatus_Object = MibTableColumn
hh3cDot11sMlspExtRowStatus = _Hh3cDot11sMlspExtRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 1, 7, 1, 5),
    _Hh3cDot11sMlspExtRowStatus_Type()
)
hh3cDot11sMlspExtRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDot11sMlspExtRowStatus.setStatus("current")
...
class _Hh3cDot11sMeshLinkType_Type(Integer32):
    """Custom type hh3cDot11sMeshLinkType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hh3cDot11sMeshLinkType_Type.__name__ = "Integer32"
_Hh3cDot11sMeshLinkType_Object = MibTableColumn
hh3cDot11sMeshLinkType = _Hh3cDot11sMeshLinkType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 3, 1, 1, 6),
    _Hh3cDot11sMeshLinkType_Type()
)
hh3cDot11sMeshLinkType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkType.setStatus("current")
_Hh3cDot11sMeshLinkSNR_Type = Integer32
_Hh3cDot11sMeshLinkSNR_Object = MibTableColumn
hh3cDot11sMeshLinkSNR = _Hh3cDot11sMeshLinkSNR_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 3, 1, 1, 7),
    _Hh3cDot11sMeshLinkSNR_Type()
)
hh3cDot11sMeshLinkSNR.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkSNR.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkSNR.setUnits("percent")
_Hh3cDot11sMeshLinkNoise_Type = Integer32
_Hh3cDot11sMeshLinkNoise_Object = MibTableColumn
hh3cDot11sMeshLinkNoise = _Hh3cDot11sMeshLinkNoise_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 3, 1, 1, 8),
    _Hh3cDot11sMeshLinkNoise_Type()
)
hh3cDot11sMeshLinkNoise.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkNoise.setStatus("current")
_Hh3cDot11sMeshLinkPeerSNR_Type = Integer32
_Hh3cDot11sMeshLinkPeerSNR_Object = MibTableColumn
hh3cDot11sMeshLinkPeerSNR = _Hh3cDot11sMeshLinkPeerSNR_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 3, 1, 1, 9),
    _Hh3cDot11sMeshLinkPeerSNR_Type()
)
hh3cDot11sMeshLinkPeerSNR.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkPeerSNR.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkPeerSNR.setUnits("percent")
_Hh3cDot11sMeshLinkPeerNoise_Type = Integer32
_Hh3cDot11sMeshLinkPeerNoise_Object = MibTableColumn
hh3cDot11sMeshLinkPeerNoise = _Hh3cDot11sMeshLinkPeerNoise_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 3, 1, 1, 10),
    _Hh3cDot11sMeshLinkPeerNoise_Type()
)
hh3cDot11sMeshLinkPeerNoise.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkPeerNoise.setStatus("current")
_Hh3cDot11sMeshLinkPeerIPAddress_Type = IpAddress
_Hh3cDot11sMeshLinkPeerIPAddress_Object = MibTableColumn
hh3cDot11sMeshLinkPeerIPAddress = _Hh3cDot11sMeshLinkPeerIPAddress_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 3, 1, 1, 11),
    _Hh3cDot11sMeshLinkPeerIPAddress_Type()
)
hh3cDot11sMeshLinkPeerIPAddress.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkPeerIPAddress.setStatus("current")
_Hh3cDot11sMeshLinkPeerSystemName_Type = OctetString
_Hh3cDot11sMeshLinkPeerSystemName_Object = MibTableColumn
hh3cDot11sMeshLinkPeerSystemName = _Hh3cDot11sMeshLinkPeerSystemName_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 3, 1, 1, 12),
    _Hh3cDot11sMeshLinkPeerSystemName_Type()
)
hh3cDot11sMeshLinkPeerSystemName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkPeerSystemName.setStatus("current")
...
_Hh3cDot11sMeshLinkNotifyGroup_ObjectIdentity = ObjectIdentity
hh3cDot11sMeshLinkNotifyGroup = _Hh3cDot11sMeshLinkNotifyGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 4)
)
_Hh3cDot11sMeshLinkTraps_ObjectIdentity = ObjectIdentity
hh3cDot11sMeshLinkTraps = _Hh3cDot11sMeshLinkTraps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 4, 0)
)
_Hh3cDot11sMeshLinkTrapObjects_ObjectIdentity = ObjectIdentity
hh3cDot11sMeshLinkTrapObjects = _Hh3cDot11sMeshLinkTrapObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 4, 1)
)
_Hh3cDot11sMeshLinkBSSIDMAC_Type = MacAddress
_Hh3cDot11sMeshLinkBSSIDMAC_Object = MibScalar
hh3cDot11sMeshLinkBSSIDMAC = _Hh3cDot11sMeshLinkBSSIDMAC_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 4, 1, 1),
    _Hh3cDot11sMeshLinkBSSIDMAC_Type()
)
hh3cDot11sMeshLinkBSSIDMAC.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkBSSIDMAC.setStatus("current")
_Hh3cDot11sMeshLinkPeerMAC_Type = MacAddress
_Hh3cDot11sMeshLinkPeerMAC_Object = MibScalar
hh3cDot11sMeshLinkPeerMAC = _Hh3cDot11sMeshLinkPeerMAC_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 4, 1, 2),
    _Hh3cDot11sMeshLinkPeerMAC_Type()
)
hh3cDot11sMeshLinkPeerMAC.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkPeerMAC.setStatus("current")
...
hh3cDot11sMeshLinkSwitchTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 11, 4, 0, 1)
)
hh3cDot11sMeshLinkSwitchTrap.setObjects(
      *(("HH3C-DOT11S-MESH-MIB", "hh3cDot11sMeshLinkBSSIDMAC"),
        ("HH3C-DOT11S-MESH-MIB", "hh3cDot11sMeshLinkPeerMAC"))
)
if mibBuilder.loadTexts:
    hh3cDot11sMeshLinkSwitchTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cDot11sMesh": hh3cDot11sMesh,
       ...
       "hh3cDot11sMeshAKMMode": hh3cDot11sMeshAKMMode,
       "hh3cDot11sMeshSimpleKey": hh3cDot11sMeshSimpleKey,
       ...
       "hh3cDot11sMlspMode": hh3cDot11sMlspMode,
       "hh3cDot11sWaveGuideHoldRSSI": hh3cDot11sWaveGuideHoldRSSI,
       "hh3cDot11sWaveGuideSwitch": hh3cDot11sWaveGuideSwitch,
       "hh3cDot11sOptimizeEnable": hh3cDot11sOptimizeEnable,
       "hh3cDot11sOptimizeThreshold": hh3cDot11sOptimizeThreshold,
       "hh3cDot11sMlspLogEnable": hh3cDot11sMlspLogEnable,
       "hh3cDot11sMlspLogInterval": hh3cDot11sMlspLogInterval,
       "hh3cDot11sActiveKeepaliveCount": hh3cDot11sActiveKeepaliveCount,
       "hh3cDot11sLinkEstaThreshold": hh3cDot11sLinkEstaThreshold,
       "hh3cDot11sTransmissionMethod": hh3cDot11sTransmissionMethod,
       "hh3cDot11sTransmitLevel": hh3cDot11sTransmitLevel,
       "hh3cDot11sTempLinkEnable": hh3cDot11sTempLinkEnable,
       ...
       "hh3cDot11sBindInterface": hh3cDot11sBindInterface,
       ...
       "hh3cDot11sMlspExtCfgTable": hh3cDot11sMlspExtCfgTable,
       "hh3cDot11sMlspExtCfgEntry": hh3cDot11sMlspExtCfgEntry,
       "hh3cDot11sMlspExtPolicyName": hh3cDot11sMlspExtPolicyName,
       "hh3cDot11sMlspExtProxyMac": hh3cDot11sMlspExtProxyMac,
       "hh3cDot11sMlspExtProxyVlanID": hh3cDot11sMlspExtProxyVlanID,
       "hh3cDot11sMlspExtProxyIP": hh3cDot11sMlspExtProxyIP,
       "hh3cDot11sMlspExtRowStatus": hh3cDot11sMlspExtRowStatus,
       ...
       "hh3cDot11sMeshLinkType": hh3cDot11sMeshLinkType,
       "hh3cDot11sMeshLinkSNR": hh3cDot11sMeshLinkSNR,
       "hh3cDot11sMeshLinkNoise": hh3cDot11sMeshLinkNoise,
       "hh3cDot11sMeshLinkPeerSNR": hh3cDot11sMeshLinkPeerSNR,
       "hh3cDot11sMeshLinkPeerNoise": hh3cDot11sMeshLinkPeerNoise,
       "hh3cDot11sMeshLinkPeerIPAddress": hh3cDot11sMeshLinkPeerIPAddress,
       "hh3cDot11sMeshLinkPeerSystemName": hh3cDot11sMeshLinkPeerSystemName,
       ...
       "hh3cDot11sMeshLinkNotifyGroup": hh3cDot11sMeshLinkNotifyGroup,
       "hh3cDot11sMeshLinkTraps": hh3cDot11sMeshLinkTraps,
       "hh3cDot11sMeshLinkSwitchTrap": hh3cDot11sMeshLinkSwitchTrap,
       "hh3cDot11sMeshLinkTrapObjects": hh3cDot11sMeshLinkTrapObjects,
       "hh3cDot11sMeshLinkBSSIDMAC": hh3cDot11sMeshLinkBSSIDMAC,
       "hh3cDot11sMeshLinkPeerMAC": hh3cDot11sMeshLinkPeerMAC}
)
