...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-CONFIG-MAN-MIB
...
_Hh3cCfgLogWantBackup_Type.__name__ = "TruthValue"
...
_Hh3cCfgOperateEndNotificationSwitch_Type.__name__ = "TruthValue"
...
class _Hh3cCfgOperateFailCmd_Type(DisplayString):
    """Custom type hh3cCfgOperateFailCmd based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cCfgOperateFailCmd_Type.__name__ = "DisplayString"
_Hh3cCfgOperateFailCmd_Object = MibTableColumn
hh3cCfgOperateFailCmd = _Hh3cCfgOperateFailCmd_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 4, 1, 2, 5, 1, 8),
    _Hh3cCfgOperateFailCmd_Type()
)
hh3cCfgOperateFailCmd.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cCfgOperateFailCmd.setStatus("current")


class _Hh3cCfgOperateFailCmdView_Type(DisplayString):
    """Custom type hh3cCfgOperateFailCmdView based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 264),
    )


_Hh3cCfgOperateFailCmdView_Type.__name__ = "DisplayString"
_Hh3cCfgOperateFailCmdView_Object = MibTableColumn
hh3cCfgOperateFailCmdView = _Hh3cCfgOperateFailCmdView_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 4, 1, 2, 5, 1, 9),
    _Hh3cCfgOperateFailCmdView_Type()
)
hh3cCfgOperateFailCmdView.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cCfgOperateFailCmdView.setStatus("current")


class _Hh3cCfgOperateFailCmdReason_Type(DisplayString):
    """Custom type hh3cCfgOperateFailCmdReason based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cCfgOperateFailCmdReason_Type.__name__ = "DisplayString"
_Hh3cCfgOperateFailCmdReason_Object = MibTableColumn
hh3cCfgOperateFailCmdReason = _Hh3cCfgOperateFailCmdReason_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 4, 1, 2, 5, 1, 10),
    _Hh3cCfgOperateFailCmdReason_Type()
)
hh3cCfgOperateFailCmdReason.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cCfgOperateFailCmdReason.setStatus("current")
...
hh3cConfigManCompliance.setObjects(
      *(("HH3C-CONFIG-MAN-MIB", "hh3cCfgManLogGroup"),
        ("HH3C-CONFIG-MAN-MIB", "hh3cCfgOperateGroup"),
        ("HH3C-CONFIG-MAN-MIB", "hh3cCfgManNotificationGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ConfigOperationType": ConfigOperationType,
       ...
       "hh3cCfgOperateFailCmd": hh3cCfgOperateFailCmd,
       "hh3cCfgOperateFailCmdView": hh3cCfgOperateFailCmdView,
       "hh3cCfgOperateFailCmdReason": hh3cCfgOperateFailCmdReason,
