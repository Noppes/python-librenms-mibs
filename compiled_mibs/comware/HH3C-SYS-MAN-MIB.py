...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-SYS-MAN-MIB
...
_Hh3cSysClockProtocolGroup_ObjectIdentity = ObjectIdentity
hh3cSysClockProtocolGroup = _Hh3cSysClockProtocolGroup_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 3, 1, 1, 4)
)


class _Hh3cSysClockProtocol_Type(Integer32):
    """Custom type hh3cSysClockProtocol based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hh3cSysClockProtocol_Type.__name__ = "Integer32"
_Hh3cSysClockProtocol_Object = MibScalar
hh3cSysClockProtocol = _Hh3cSysClockProtocol_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 3, 1, 1, 4, 1),
    _Hh3cSysClockProtocol_Type()
)
hh3cSysClockProtocol.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cSysClockProtocol.setStatus("current")


class _Hh3cSysClockProtocolSrcMdc_Type(Integer32):
    """Custom type hh3cSysClockProtocolSrcMdc based on Integer32"""
    defaultValue = 1
...
_Hh3cSysClockProtocolSrcMdc_Type.__name__ = "Integer32"
_Hh3cSysClockProtocolSrcMdc_Object = MibScalar
hh3cSysClockProtocolSrcMdc = _Hh3cSysClockProtocolSrcMdc_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 3, 1, 1, 4, 2),
    _Hh3cSysClockProtocolSrcMdc_Type()
)
hh3cSysClockProtocolSrcMdc.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cSysClockProtocolSrcMdc.setStatus("current")


class _Hh3cSysClockProtocolSrcContext_Type(Integer32):
    """Custom type hh3cSysClockProtocolSrcContext based on Integer32"""
    defaultValue = 1
...
_Hh3cSysClockProtocolSrcContext_Type.__name__ = "Integer32"
_Hh3cSysClockProtocolSrcContext_Object = MibScalar
hh3cSysClockProtocolSrcContext = _Hh3cSysClockProtocolSrcContext_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 3, 1, 1, 4, 3),
    _Hh3cSysClockProtocolSrcContext_Type()
)
hh3cSysClockProtocolSrcContext.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cSysClockProtocolSrcContext.setStatus("current")


class _Hh3cSysLocalClockString2_Type(OctetString):
    """Custom type hh3cSysLocalClockString2 based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cSysLocalClockString2_Type.__name__ = "OctetString"
_Hh3cSysLocalClockString2_Object = MibScalar
hh3cSysLocalClockString2 = _Hh3cSysLocalClockString2_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 3, 1, 1, 5),
    _Hh3cSysLocalClockString2_Type()
)
hh3cSysLocalClockString2.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cSysLocalClockString2.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cSystemMan": hh3cSystemMan,
       ...
       "hh3cSysClockProtocolGroup": hh3cSysClockProtocolGroup,
       "hh3cSysClockProtocol": hh3cSysClockProtocol,
       "hh3cSysClockProtocolSrcMdc": hh3cSysClockProtocolSrcMdc,
       "hh3cSysClockProtocolSrcContext": hh3cSysClockProtocolSrcContext,
       "hh3cSysLocalClockString2": hh3cSysLocalClockString2,
