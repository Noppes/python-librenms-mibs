...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-DOT11-CFGEXT-MIB
...
class _Hh3cDot11LoadBalanceEnable_Type(Integer32):
    """Custom type hh3cDot11LoadBalanceEnable based on Integer32"""
    defaultValue = 0
...
_Hh3cDot11LoadBalanceEnable_Type.__name__ = "Integer32"
_Hh3cDot11LoadBalanceEnable_Object = MibScalar
hh3cDot11LoadBalanceEnable = _Hh3cDot11LoadBalanceEnable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 6, 1, 1, 9),
    _Hh3cDot11LoadBalanceEnable_Type()
)
hh3cDot11LoadBalanceEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cDot11LoadBalanceEnable.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cDot11CFGEXT": hh3cDot11CFGEXT,
       ...
       "hh3cDot11LoadBalanceEnable": hh3cDot11LoadBalanceEnable,
