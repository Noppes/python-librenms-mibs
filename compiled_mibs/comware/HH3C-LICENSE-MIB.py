...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-LICENSE-MIB
...
_Hh3cLicenseNotifyEnable_Type.__name__ = "TruthValue"
...
_Hh3cLicenseServerIp_Type = IpAddress
_Hh3cLicenseServerIp_Object = MibTableColumn
hh3cLicenseServerIp = _Hh3cLicenseServerIp_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 145, 2, 1, 1, 11),
    _Hh3cLicenseServerIp_Type()
)
hh3cLicenseServerIp.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cLicenseServerIp.setStatus("current")


class _Hh3cLicenseServerPort_Type(Unsigned32):
    """Custom type hh3cLicenseServerPort based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cLicenseServerPort_Type.__name__ = "Unsigned32"
_Hh3cLicenseServerPort_Object = MibTableColumn
hh3cLicenseServerPort = _Hh3cLicenseServerPort_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 145, 2, 1, 1, 12),
    _Hh3cLicenseServerPort_Type()
)
hh3cLicenseServerPort.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cLicenseServerPort.setStatus("current")
...
_Hh3cLicenseOpNotifyEnable_Type.__name__ = "TruthValue"
...
_Hh3cLicenseLowerUsageThreshold_Type = Unsigned32
_Hh3cLicenseLowerUsageThreshold_Object = MibScalar
hh3cLicenseLowerUsageThreshold = _Hh3cLicenseLowerUsageThreshold_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 145, 3, 1, 2),
    _Hh3cLicenseLowerUsageThreshold_Type()
)
hh3cLicenseLowerUsageThreshold.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cLicenseLowerUsageThreshold.setStatus("current")
_Hh3cLicenseUpperUsageThreshold_Type = Unsigned32
_Hh3cLicenseUpperUsageThreshold_Object = MibScalar
hh3cLicenseUpperUsageThreshold = _Hh3cLicenseUpperUsageThreshold_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 145, 3, 1, 3),
    _Hh3cLicenseUpperUsageThreshold_Type()
)
hh3cLicenseUpperUsageThreshold.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cLicenseUpperUsageThreshold.setStatus("current")
_Hh3cLicenseCurrentUsageRate_Type = Unsigned32
_Hh3cLicenseCurrentUsageRate_Object = MibScalar
hh3cLicenseCurrentUsageRate = _Hh3cLicenseCurrentUsageRate_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 145, 3, 1, 4),
    _Hh3cLicenseCurrentUsageRate_Type()
)
hh3cLicenseCurrentUsageRate.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cLicenseCurrentUsageRate.setStatus("current")
...
hh3cLicenseReconnectWithServer = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 145, 3, 0, 6)
)
hh3cLicenseReconnectWithServer.setObjects(
      *(("HH3C-LICENSE-MIB", "hh3cLicensePhysicalIndex"),
        ("HH3C-LICENSE-MIB", "hh3cLicenseServerIp"),
        ("HH3C-LICENSE-MIB", "hh3cLicenseServerPort"))
)
if mibBuilder.loadTexts:
    hh3cLicenseReconnectWithServer.setStatus(
        "current"
    )

hh3cLicenseDisconnectWithServer = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 145, 3, 0, 7)
)
hh3cLicenseDisconnectWithServer.setObjects(
      *(("HH3C-LICENSE-MIB", "hh3cLicensePhysicalIndex"),
        ("HH3C-LICENSE-MIB", "hh3cLicenseServerIp"),
        ("HH3C-LICENSE-MIB", "hh3cLicenseServerPort"))
)
if mibBuilder.loadTexts:
    hh3cLicenseDisconnectWithServer.setStatus(
        "current"
    )

hh3cLicenseBelowUsageThreshold = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 145, 3, 0, 8)
)
hh3cLicenseBelowUsageThreshold.setObjects(
      *(("HH3C-LICENSE-MIB", "hh3cLicenseFeatureName"),
        ("HH3C-LICENSE-MIB", "hh3cLicenseLowerUsageThreshold"),
        ("HH3C-LICENSE-MIB", "hh3cLicenseUpperUsageThreshold"),
        ("HH3C-LICENSE-MIB", "hh3cLicenseCurrentUsageRate"))
)
if mibBuilder.loadTexts:
    hh3cLicenseBelowUsageThreshold.setStatus(
        "current"
    )

hh3cLicenseOverUsageThreshold = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 145, 3, 0, 9)
)
hh3cLicenseOverUsageThreshold.setObjects(
      *(("HH3C-LICENSE-MIB", "hh3cLicenseFeatureName"),
        ("HH3C-LICENSE-MIB", "hh3cLicenseLowerUsageThreshold"),
        ("HH3C-LICENSE-MIB", "hh3cLicenseUpperUsageThreshold"),
        ("HH3C-LICENSE-MIB", "hh3cLicenseCurrentUsageRate"))
...
if mibBuilder.loadTexts:
    hh3cLicenseOverUsageThreshold.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cLicense": hh3cLicense,
       ...
       "hh3cLicenseServerIp": hh3cLicenseServerIp,
       "hh3cLicenseServerPort": hh3cLicenseServerPort,
       ...
       "hh3cLicenseReconnectWithServer": hh3cLicenseReconnectWithServer,
       "hh3cLicenseDisconnectWithServer": hh3cLicenseDisconnectWithServer,
       "hh3cLicenseBelowUsageThreshold": hh3cLicenseBelowUsageThreshold,
       "hh3cLicenseOverUsageThreshold": hh3cLicenseOverUsageThreshold,
       ...
       "hh3cLicenseLowerUsageThreshold": hh3cLicenseLowerUsageThreshold,
       "hh3cLicenseUpperUsageThreshold": hh3cLicenseUpperUsageThreshold,
       "hh3cLicenseCurrentUsageRate": hh3cLicenseCurrentUsageRate}
)
