...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-TRANSCEIVER-INFO-MIB
...
_Hh3cTransceiverFrequency_Type = Integer32
_Hh3cTransceiverFrequency_Object = MibTableColumn
hh3cTransceiverFrequency = _Hh3cTransceiverFrequency_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 41),
    _Hh3cTransceiverFrequency_Type()
)
hh3cTransceiverFrequency.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverFrequency.setStatus("current")


class _Hh3cTransceiverActiveITUChannel_Type(Unsigned32):
    """Custom type hh3cTransceiverActiveITUChannel based on Unsigned32"""
...
_Hh3cTransceiverActiveITUChannel_Type.__name__ = "Unsigned32"
_Hh3cTransceiverActiveITUChannel_Object = MibTableColumn
hh3cTransceiverActiveITUChannel = _Hh3cTransceiverActiveITUChannel_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 42),
    _Hh3cTransceiverActiveITUChannel_Type()
)
hh3cTransceiverActiveITUChannel.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cTransceiverActiveITUChannel.setStatus("current")
_Hh3cTransceiverCurWaveErr_Type = Integer32
_Hh3cTransceiverCurWaveErr_Object = MibTableColumn
hh3cTransceiverCurWaveErr = _Hh3cTransceiverCurWaveErr_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 43),
    _Hh3cTransceiverCurWaveErr_Type()
)
hh3cTransceiverCurWaveErr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverCurWaveErr.setStatus("current")
_Hh3cTransceiverWaveErrHiAlarm_Type = Integer32
_Hh3cTransceiverWaveErrHiAlarm_Object = MibTableColumn
hh3cTransceiverWaveErrHiAlarm = _Hh3cTransceiverWaveErrHiAlarm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 44),
    _Hh3cTransceiverWaveErrHiAlarm_Type()
)
hh3cTransceiverWaveErrHiAlarm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverWaveErrHiAlarm.setStatus("current")
_Hh3cTransceiverWaveErrLoAlarm_Type = Integer32
_Hh3cTransceiverWaveErrLoAlarm_Object = MibTableColumn
hh3cTransceiverWaveErrLoAlarm = _Hh3cTransceiverWaveErrLoAlarm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 45),
    _Hh3cTransceiverWaveErrLoAlarm_Type()
)
hh3cTransceiverWaveErrLoAlarm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverWaveErrLoAlarm.setStatus("current")
_Hh3cTransceiverCurFreqErr_Type = Integer32
_Hh3cTransceiverCurFreqErr_Object = MibTableColumn
hh3cTransceiverCurFreqErr = _Hh3cTransceiverCurFreqErr_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 46),
    _Hh3cTransceiverCurFreqErr_Type()
)
hh3cTransceiverCurFreqErr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverCurFreqErr.setStatus("current")
_Hh3cTransceiverFreqErrHiAlarm_Type = Integer32
_Hh3cTransceiverFreqErrHiAlarm_Object = MibTableColumn
hh3cTransceiverFreqErrHiAlarm = _Hh3cTransceiverFreqErrHiAlarm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 47),
    _Hh3cTransceiverFreqErrHiAlarm_Type()
)
hh3cTransceiverFreqErrHiAlarm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverFreqErrHiAlarm.setStatus("current")
_Hh3cTransceiverFreqErrLoAlarm_Type = Integer32
_Hh3cTransceiverFreqErrLoAlarm_Object = MibTableColumn
hh3cTransceiverFreqErrLoAlarm = _Hh3cTransceiverFreqErrLoAlarm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 48),
    _Hh3cTransceiverFreqErrLoAlarm_Type()
)
hh3cTransceiverFreqErrLoAlarm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverFreqErrLoAlarm.setStatus("current")
_Hh3cTransceiverPartNumber_Type = OctetString
_Hh3cTransceiverPartNumber_Object = MibTableColumn
hh3cTransceiverPartNumber = _Hh3cTransceiverPartNumber_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 49),
    _Hh3cTransceiverPartNumber_Type()
)
hh3cTransceiverPartNumber.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverPartNumber.setStatus("current")
_Hh3cTransceiverProductCode_Type = OctetString
_Hh3cTransceiverProductCode_Object = MibTableColumn
hh3cTransceiverProductCode = _Hh3cTransceiverProductCode_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 50),
    _Hh3cTransceiverProductCode_Type()
)
hh3cTransceiverProductCode.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverProductCode.setStatus("current")
_Hh3cTransceiverOriginalSN_Type = OctetString
_Hh3cTransceiverOriginalSN_Object = MibTableColumn
hh3cTransceiverOriginalSN = _Hh3cTransceiverOriginalSN_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 51),
    _Hh3cTransceiverOriginalSN_Type()
)
hh3cTransceiverOriginalSN.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverOriginalSN.setStatus("current")
_Hh3cTransceiverPwrOutHiAlarmDbm_Type = Integer32
_Hh3cTransceiverPwrOutHiAlarmDbm_Object = MibTableColumn
hh3cTransceiverPwrOutHiAlarmDbm = _Hh3cTransceiverPwrOutHiAlarmDbm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 52),
    _Hh3cTransceiverPwrOutHiAlarmDbm_Type()
)
hh3cTransceiverPwrOutHiAlarmDbm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverPwrOutHiAlarmDbm.setStatus("current")
_Hh3cTransceiverPwrOutLoAlarmDbm_Type = Integer32
_Hh3cTransceiverPwrOutLoAlarmDbm_Object = MibTableColumn
hh3cTransceiverPwrOutLoAlarmDbm = _Hh3cTransceiverPwrOutLoAlarmDbm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 53),
    _Hh3cTransceiverPwrOutLoAlarmDbm_Type()
)
hh3cTransceiverPwrOutLoAlarmDbm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverPwrOutLoAlarmDbm.setStatus("current")
_Hh3cTransceiverPwrOutHiWarnDbm_Type = Integer32
_Hh3cTransceiverPwrOutHiWarnDbm_Object = MibTableColumn
hh3cTransceiverPwrOutHiWarnDbm = _Hh3cTransceiverPwrOutHiWarnDbm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 54),
    _Hh3cTransceiverPwrOutHiWarnDbm_Type()
)
hh3cTransceiverPwrOutHiWarnDbm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverPwrOutHiWarnDbm.setStatus("current")
_Hh3cTransceiverPwrOutLoWarnDbm_Type = Integer32
_Hh3cTransceiverPwrOutLoWarnDbm_Object = MibTableColumn
hh3cTransceiverPwrOutLoWarnDbm = _Hh3cTransceiverPwrOutLoWarnDbm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 55),
    _Hh3cTransceiverPwrOutLoWarnDbm_Type()
)
hh3cTransceiverPwrOutLoWarnDbm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverPwrOutLoWarnDbm.setStatus("current")
_Hh3cTransceiverRcvPwrHiAlarmDbm_Type = Integer32
_Hh3cTransceiverRcvPwrHiAlarmDbm_Object = MibTableColumn
hh3cTransceiverRcvPwrHiAlarmDbm = _Hh3cTransceiverRcvPwrHiAlarmDbm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 56),
    _Hh3cTransceiverRcvPwrHiAlarmDbm_Type()
)
hh3cTransceiverRcvPwrHiAlarmDbm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverRcvPwrHiAlarmDbm.setStatus("current")
_Hh3cTransceiverRcvPwrLoAlarmDbm_Type = Integer32
_Hh3cTransceiverRcvPwrLoAlarmDbm_Object = MibTableColumn
hh3cTransceiverRcvPwrLoAlarmDbm = _Hh3cTransceiverRcvPwrLoAlarmDbm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 57),
    _Hh3cTransceiverRcvPwrLoAlarmDbm_Type()
)
hh3cTransceiverRcvPwrLoAlarmDbm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverRcvPwrLoAlarmDbm.setStatus("current")
_Hh3cTransceiverRcvPwrHiWarnDbm_Type = Integer32
_Hh3cTransceiverRcvPwrHiWarnDbm_Object = MibTableColumn
hh3cTransceiverRcvPwrHiWarnDbm = _Hh3cTransceiverRcvPwrHiWarnDbm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 58),
    _Hh3cTransceiverRcvPwrHiWarnDbm_Type()
)
hh3cTransceiverRcvPwrHiWarnDbm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverRcvPwrHiWarnDbm.setStatus("current")
_Hh3cTransceiverRcvPwrLoWarnDbm_Type = Integer32
_Hh3cTransceiverRcvPwrLoWarnDbm_Object = MibTableColumn
hh3cTransceiverRcvPwrLoWarnDbm = _Hh3cTransceiverRcvPwrLoWarnDbm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 59),
    _Hh3cTransceiverRcvPwrLoWarnDbm_Type()
)
hh3cTransceiverRcvPwrLoWarnDbm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverRcvPwrLoWarnDbm.setStatus("current")
_Hh3cTransceiverRelySlotMfgName_Type = OctetString
_Hh3cTransceiverRelySlotMfgName_Object = MibTableColumn
hh3cTransceiverRelySlotMfgName = _Hh3cTransceiverRelySlotMfgName_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 60),
    _Hh3cTransceiverRelySlotMfgName_Type()
)
hh3cTransceiverRelySlotMfgName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverRelySlotMfgName.setStatus("current")
_Hh3cTransceiverRelySlotMfgDate_Type = DateAndTime
_Hh3cTransceiverRelySlotMfgDate_Object = MibTableColumn
hh3cTransceiverRelySlotMfgDate = _Hh3cTransceiverRelySlotMfgDate_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 1, 1, 61),
    _Hh3cTransceiverRelySlotMfgDate_Type()
)
hh3cTransceiverRelySlotMfgDate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverRelySlotMfgDate.setStatus("current")
...
_Hh3cTransceiverChannelBiasHiAm_Type = Integer32
_Hh3cTransceiverChannelBiasHiAm_Object = MibTableColumn
hh3cTransceiverChannelBiasHiAm = _Hh3cTransceiverChannelBiasHiAm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 2, 1, 6),
    _Hh3cTransceiverChannelBiasHiAm_Type()
)
hh3cTransceiverChannelBiasHiAm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverChannelBiasHiAm.setStatus("current")
_Hh3cTransceiverChannelBiasLoAm_Type = Integer32
_Hh3cTransceiverChannelBiasLoAm_Object = MibTableColumn
hh3cTransceiverChannelBiasLoAm = _Hh3cTransceiverChannelBiasLoAm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 2, 1, 7),
    _Hh3cTransceiverChannelBiasLoAm_Type()
)
hh3cTransceiverChannelBiasLoAm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverChannelBiasLoAm.setStatus("current")
_Hh3cTransceiverChannelTXPwrHiAm_Type = Integer32
_Hh3cTransceiverChannelTXPwrHiAm_Object = MibTableColumn
hh3cTransceiverChannelTXPwrHiAm = _Hh3cTransceiverChannelTXPwrHiAm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 2, 1, 8),
    _Hh3cTransceiverChannelTXPwrHiAm_Type()
)
hh3cTransceiverChannelTXPwrHiAm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverChannelTXPwrHiAm.setStatus("current")
_Hh3cTransceiverChannelTXPwrLoAm_Type = Integer32
_Hh3cTransceiverChannelTXPwrLoAm_Object = MibTableColumn
hh3cTransceiverChannelTXPwrLoAm = _Hh3cTransceiverChannelTXPwrLoAm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 2, 1, 9),
    _Hh3cTransceiverChannelTXPwrLoAm_Type()
)
hh3cTransceiverChannelTXPwrLoAm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverChannelTXPwrLoAm.setStatus("current")
_Hh3cTransceiverChanTXPwrHiAmDbm_Type = Integer32
_Hh3cTransceiverChanTXPwrHiAmDbm_Object = MibTableColumn
hh3cTransceiverChanTXPwrHiAmDbm = _Hh3cTransceiverChanTXPwrHiAmDbm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 2, 1, 10),
    _Hh3cTransceiverChanTXPwrHiAmDbm_Type()
)
hh3cTransceiverChanTXPwrHiAmDbm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverChanTXPwrHiAmDbm.setStatus("current")
_Hh3cTransceiverChanTXPwrLoAmDbm_Type = Integer32
_Hh3cTransceiverChanTXPwrLoAmDbm_Object = MibTableColumn
hh3cTransceiverChanTXPwrLoAmDbm = _Hh3cTransceiverChanTXPwrLoAmDbm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 2, 1, 11),
    _Hh3cTransceiverChanTXPwrLoAmDbm_Type()
)
hh3cTransceiverChanTXPwrLoAmDbm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverChanTXPwrLoAmDbm.setStatus("current")
_Hh3cTransceiverITUChanTable_Object = MibTable
hh3cTransceiverITUChanTable = _Hh3cTransceiverITUChanTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 3)
)
if mibBuilder.loadTexts:
    hh3cTransceiverITUChanTable.setStatus("current")
_Hh3cTransceiverITUChanEntry_Object = MibTableRow
hh3cTransceiverITUChanEntry = _Hh3cTransceiverITUChanEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 3, 1)
)
hh3cTransceiverITUChanEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "HH3C-TRANSCEIVER-INFO-MIB", "hh3cTransceiverITUChanIdx"),
)
if mibBuilder.loadTexts:
    hh3cTransceiverITUChanEntry.setStatus("current")


class _Hh3cTransceiverITUChanIdx_Type(Unsigned32):
    """Custom type hh3cTransceiverITUChanIdx based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4294967295),
    )
...
_Hh3cTransceiverITUChanIdx_Type.__name__ = "Unsigned32"
_Hh3cTransceiverITUChanIdx_Object = MibTableColumn
hh3cTransceiverITUChanIdx = _Hh3cTransceiverITUChanIdx_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 3, 1, 1),
    _Hh3cTransceiverITUChanIdx_Type()
)
hh3cTransceiverITUChanIdx.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cTransceiverITUChanIdx.setStatus("current")
_Hh3cTransceiverITUChanFreq_Type = Integer32
_Hh3cTransceiverITUChanFreq_Object = MibTableColumn
hh3cTransceiverITUChanFreq = _Hh3cTransceiverITUChanFreq_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 3, 1, 2),
    _Hh3cTransceiverITUChanFreq_Type()
)
hh3cTransceiverITUChanFreq.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverITUChanFreq.setStatus("current")
_Hh3cTransceiverITUChanWaveLth_Type = Integer32
_Hh3cTransceiverITUChanWaveLth_Object = MibTableColumn
hh3cTransceiverITUChanWaveLth = _Hh3cTransceiverITUChanWaveLth_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 3, 1, 3),
    _Hh3cTransceiverITUChanWaveLth_Type()
)
hh3cTransceiverITUChanWaveLth.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverITUChanWaveLth.setStatus("current")
_Hh3cTransceiverLaneTable_Object = MibTable
hh3cTransceiverLaneTable = _Hh3cTransceiverLaneTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 4)
)
if mibBuilder.loadTexts:
    hh3cTransceiverLaneTable.setStatus("current")
_Hh3cTransceiverLaneEntry_Object = MibTableRow
hh3cTransceiverLaneEntry = _Hh3cTransceiverLaneEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 4, 1)
)
hh3cTransceiverLaneEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    hh3cTransceiverLaneEntry.setStatus("current")
_Hh3cTransceiverLaneCurTxPower_Type = OctetString
_Hh3cTransceiverLaneCurTxPower_Object = MibTableColumn
hh3cTransceiverLaneCurTxPower = _Hh3cTransceiverLaneCurTxPower_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 4, 1, 1),
    _Hh3cTransceiverLaneCurTxPower_Type()
)
hh3cTransceiverLaneCurTxPower.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverLaneCurTxPower.setStatus("current")
_Hh3cTransceiverLaneCurRxPower_Type = OctetString
_Hh3cTransceiverLaneCurRxPower_Object = MibTableColumn
hh3cTransceiverLaneCurRxPower = _Hh3cTransceiverLaneCurRxPower_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 4, 1, 2),
    _Hh3cTransceiverLaneCurRxPower_Type()
)
hh3cTransceiverLaneCurRxPower.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverLaneCurRxPower.setStatus("current")
_Hh3cTransceiverLaneBiasCurrent_Type = OctetString
_Hh3cTransceiverLaneBiasCurrent_Object = MibTableColumn
hh3cTransceiverLaneBiasCurrent = _Hh3cTransceiverLaneBiasCurrent_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 1, 4, 1, 3),
    _Hh3cTransceiverLaneBiasCurrent_Type()
)
hh3cTransceiverLaneBiasCurrent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTransceiverLaneBiasCurrent.setStatus("current")
_Hh3cTransceiverSystemPara_ObjectIdentity = ObjectIdentity
hh3cTransceiverSystemPara = _Hh3cTransceiverSystemPara_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 2)
)


class _Hh3cTransceiverExtrAlarmEnable_Type(TruthValue):
    """Custom type hh3cTransceiverExtrAlarmEnable based on TruthValue"""
    defaultValue = 1


_Hh3cTransceiverExtrAlarmEnable_Type.__name__ = "TruthValue"
_Hh3cTransceiverExtrAlarmEnable_Object = MibScalar
hh3cTransceiverExtrAlarmEnable = _Hh3cTransceiverExtrAlarmEnable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 2, 1),
    _Hh3cTransceiverExtrAlarmEnable_Type()
)
hh3cTransceiverExtrAlarmEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cTransceiverExtrAlarmEnable.setStatus("current")
_Hh3cTransceiverTrap_ObjectIdentity = ObjectIdentity
hh3cTransceiverTrap = _Hh3cTransceiverTrap_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 3)
)
_Hh3cTransceiverTrapPrefix_ObjectIdentity = ObjectIdentity
hh3cTransceiverTrapPrefix = _Hh3cTransceiverTrapPrefix_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 3, 0)
)
...
hh3cTransceiverMaybeFake = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 70, 3, 0, 1)
)
hh3cTransceiverMaybeFake.setObjects(
      *(("IF-MIB", "ifName"),
        ("HH3C-TRANSCEIVER-INFO-MIB", "hh3cTransceiverType"),
        ("HH3C-TRANSCEIVER-INFO-MIB", "hh3cTransceiverSerialNumber"))
)
if mibBuilder.loadTexts:
    hh3cTransceiverMaybeFake.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cTransceiver": hh3cTransceiver,
       ...
       "hh3cTransceiverFrequency": hh3cTransceiverFrequency,
       "hh3cTransceiverActiveITUChannel": hh3cTransceiverActiveITUChannel,
       "hh3cTransceiverCurWaveErr": hh3cTransceiverCurWaveErr,
       "hh3cTransceiverWaveErrHiAlarm": hh3cTransceiverWaveErrHiAlarm,
       "hh3cTransceiverWaveErrLoAlarm": hh3cTransceiverWaveErrLoAlarm,
       "hh3cTransceiverCurFreqErr": hh3cTransceiverCurFreqErr,
       "hh3cTransceiverFreqErrHiAlarm": hh3cTransceiverFreqErrHiAlarm,
       "hh3cTransceiverFreqErrLoAlarm": hh3cTransceiverFreqErrLoAlarm,
       "hh3cTransceiverPartNumber": hh3cTransceiverPartNumber,
       "hh3cTransceiverProductCode": hh3cTransceiverProductCode,
       "hh3cTransceiverOriginalSN": hh3cTransceiverOriginalSN,
       "hh3cTransceiverPwrOutHiAlarmDbm": hh3cTransceiverPwrOutHiAlarmDbm,
       "hh3cTransceiverPwrOutLoAlarmDbm": hh3cTransceiverPwrOutLoAlarmDbm,
       "hh3cTransceiverPwrOutHiWarnDbm": hh3cTransceiverPwrOutHiWarnDbm,
       "hh3cTransceiverPwrOutLoWarnDbm": hh3cTransceiverPwrOutLoWarnDbm,
       "hh3cTransceiverRcvPwrHiAlarmDbm": hh3cTransceiverRcvPwrHiAlarmDbm,
       "hh3cTransceiverRcvPwrLoAlarmDbm": hh3cTransceiverRcvPwrLoAlarmDbm,
       "hh3cTransceiverRcvPwrHiWarnDbm": hh3cTransceiverRcvPwrHiWarnDbm,
       "hh3cTransceiverRcvPwrLoWarnDbm": hh3cTransceiverRcvPwrLoWarnDbm,
       "hh3cTransceiverRelySlotMfgName": hh3cTransceiverRelySlotMfgName,
       "hh3cTransceiverRelySlotMfgDate": hh3cTransceiverRelySlotMfgDate,
       ...
       "hh3cTransceiverChannelBiasHiAm": hh3cTransceiverChannelBiasHiAm,
       "hh3cTransceiverChannelBiasLoAm": hh3cTransceiverChannelBiasLoAm,
       "hh3cTransceiverChannelTXPwrHiAm": hh3cTransceiverChannelTXPwrHiAm,
       "hh3cTransceiverChannelTXPwrLoAm": hh3cTransceiverChannelTXPwrLoAm,
       "hh3cTransceiverChanTXPwrHiAmDbm": hh3cTransceiverChanTXPwrHiAmDbm,
       "hh3cTransceiverChanTXPwrLoAmDbm": hh3cTransceiverChanTXPwrLoAmDbm,
       "hh3cTransceiverITUChanTable": hh3cTransceiverITUChanTable,
       "hh3cTransceiverITUChanEntry": hh3cTransceiverITUChanEntry,
       "hh3cTransceiverITUChanIdx": hh3cTransceiverITUChanIdx,
       "hh3cTransceiverITUChanFreq": hh3cTransceiverITUChanFreq,
       "hh3cTransceiverITUChanWaveLth": hh3cTransceiverITUChanWaveLth,
       "hh3cTransceiverLaneTable": hh3cTransceiverLaneTable,
       "hh3cTransceiverLaneEntry": hh3cTransceiverLaneEntry,
       "hh3cTransceiverLaneCurTxPower": hh3cTransceiverLaneCurTxPower,
       "hh3cTransceiverLaneCurRxPower": hh3cTransceiverLaneCurRxPower,
       "hh3cTransceiverLaneBiasCurrent": hh3cTransceiverLaneBiasCurrent,
       "hh3cTransceiverSystemPara": hh3cTransceiverSystemPara,
       "hh3cTransceiverExtrAlarmEnable": hh3cTransceiverExtrAlarmEnable,
       "hh3cTransceiverTrap": hh3cTransceiverTrap,
       "hh3cTransceiverTrapPrefix": hh3cTransceiverTrapPrefix,
       "hh3cTransceiverMaybeFake": hh3cTransceiverMaybeFake}
)
