...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-LswVLAN-MIB
...
_Hh3cdot1qVlanStatisticStatus_Type = TruthValue
_Hh3cdot1qVlanStatisticStatus_Object = MibTableColumn
hh3cdot1qVlanStatisticStatus = _Hh3cdot1qVlanStatisticStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 1, 1, 20),
    _Hh3cdot1qVlanStatisticStatus_Type()
)
hh3cdot1qVlanStatisticStatus.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cdot1qVlanStatisticStatus.setStatus("current")


class _Hh3cdot1qVlanStatisticClear_Type(Integer32):
    """Custom type hh3cdot1qVlanStatisticClear based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            1
...
_Hh3cdot1qVlanStatisticClear_Type.__name__ = "Integer32"
_Hh3cdot1qVlanStatisticClear_Object = MibTableColumn
hh3cdot1qVlanStatisticClear = _Hh3cdot1qVlanStatisticClear_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 1, 1, 21),
    _Hh3cdot1qVlanStatisticClear_Type()
)
hh3cdot1qVlanStatisticClear.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cdot1qVlanStatisticClear.setStatus("current")
_Hh3cdot1qVlanStatisticInTotalPkts_Type = Counter64
_Hh3cdot1qVlanStatisticInTotalPkts_Object = MibTableColumn
hh3cdot1qVlanStatisticInTotalPkts = _Hh3cdot1qVlanStatisticInTotalPkts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 1, 1, 22),
    _Hh3cdot1qVlanStatisticInTotalPkts_Type()
)
hh3cdot1qVlanStatisticInTotalPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cdot1qVlanStatisticInTotalPkts.setStatus("current")
_Hh3cdot1qVlanStatisticInTotalBytes_Type = Counter64
_Hh3cdot1qVlanStatisticInTotalBytes_Object = MibTableColumn
hh3cdot1qVlanStatisticInTotalBytes = _Hh3cdot1qVlanStatisticInTotalBytes_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 1, 1, 23),
    _Hh3cdot1qVlanStatisticInTotalBytes_Type()
)
hh3cdot1qVlanStatisticInTotalBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cdot1qVlanStatisticInTotalBytes.setStatus("current")
_Hh3cdot1qVlanStatisticInPPS_Type = Counter64
_Hh3cdot1qVlanStatisticInPPS_Object = MibTableColumn
hh3cdot1qVlanStatisticInPPS = _Hh3cdot1qVlanStatisticInPPS_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 1, 1, 24),
    _Hh3cdot1qVlanStatisticInPPS_Type()
)
hh3cdot1qVlanStatisticInPPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cdot1qVlanStatisticInPPS.setStatus("current")
_Hh3cdot1qVlanStatisticInBPS_Type = Counter64
_Hh3cdot1qVlanStatisticInBPS_Object = MibTableColumn
hh3cdot1qVlanStatisticInBPS = _Hh3cdot1qVlanStatisticInBPS_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 1, 1, 25),
    _Hh3cdot1qVlanStatisticInBPS_Type()
)
hh3cdot1qVlanStatisticInBPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cdot1qVlanStatisticInBPS.setStatus("current")
_Hh3cdot1qVlanStatisticOutTotalPkts_Type = Counter64
_Hh3cdot1qVlanStatisticOutTotalPkts_Object = MibTableColumn
hh3cdot1qVlanStatisticOutTotalPkts = _Hh3cdot1qVlanStatisticOutTotalPkts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 1, 1, 26),
    _Hh3cdot1qVlanStatisticOutTotalPkts_Type()
)
hh3cdot1qVlanStatisticOutTotalPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cdot1qVlanStatisticOutTotalPkts.setStatus("current")
_Hh3cdot1qVlanStatisticOutTotalBytes_Type = Counter64
_Hh3cdot1qVlanStatisticOutTotalBytes_Object = MibTableColumn
hh3cdot1qVlanStatisticOutTotalBytes = _Hh3cdot1qVlanStatisticOutTotalBytes_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 1, 1, 27),
    _Hh3cdot1qVlanStatisticOutTotalBytes_Type()
)
hh3cdot1qVlanStatisticOutTotalBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cdot1qVlanStatisticOutTotalBytes.setStatus("current")
_Hh3cdot1qVlanStatisticOutPPS_Type = Counter64
_Hh3cdot1qVlanStatisticOutPPS_Object = MibTableColumn
hh3cdot1qVlanStatisticOutPPS = _Hh3cdot1qVlanStatisticOutPPS_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 1, 1, 28),
    _Hh3cdot1qVlanStatisticOutPPS_Type()
)
hh3cdot1qVlanStatisticOutPPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cdot1qVlanStatisticOutPPS.setStatus("current")
_Hh3cdot1qVlanStatisticOutBPS_Type = Counter64
_Hh3cdot1qVlanStatisticOutBPS_Object = MibTableColumn
hh3cdot1qVlanStatisticOutBPS = _Hh3cdot1qVlanStatisticOutBPS_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 1, 1, 29),
    _Hh3cdot1qVlanStatisticOutBPS_Type()
)
hh3cdot1qVlanStatisticOutBPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cdot1qVlanStatisticOutBPS.setStatus("current")
...
hh3cVlanInterfaceIpAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
hh3cVlanInterfaceIpMask.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
hh3cVlanInterfaceIpType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
...
_Hh3cPrivateVlanMappingTable_Object = MibTable
hh3cPrivateVlanMappingTable = _Hh3cPrivateVlanMappingTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 8)
)
if mibBuilder.loadTexts:
    hh3cPrivateVlanMappingTable.setStatus("current")
_Hh3cPrivateVlanMappingEntry_Object = MibTableRow
hh3cPrivateVlanMappingEntry = _Hh3cPrivateVlanMappingEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 8, 1)
)
hh3cPrivateVlanMappingEntry.setIndexNames(
    (0, "HH3C-LswVLAN-MIB", "hh3cPrimaryVlanID"),
)
if mibBuilder.loadTexts:
    hh3cPrivateVlanMappingEntry.setStatus("current")
_Hh3cPrimaryVlanID_Type = Hh3cVlanIndex
_Hh3cPrimaryVlanID_Object = MibTableColumn
hh3cPrimaryVlanID = _Hh3cPrimaryVlanID_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 8, 1, 1),
    _Hh3cPrimaryVlanID_Type()
)
hh3cPrimaryVlanID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cPrimaryVlanID.setStatus("current")


class _Hh3cSecondaryVlanlistLow_Type(OctetString):
    """Custom type hh3cSecondaryVlanlistLow based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 256),
    )
...
_Hh3cSecondaryVlanlistLow_Type.__name__ = "OctetString"
_Hh3cSecondaryVlanlistLow_Object = MibTableColumn
hh3cSecondaryVlanlistLow = _Hh3cSecondaryVlanlistLow_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 8, 1, 2),
    _Hh3cSecondaryVlanlistLow_Type()
)
hh3cSecondaryVlanlistLow.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cSecondaryVlanlistLow.setStatus("current")


class _Hh3cSecondaryVlanlistHigh_Type(OctetString):
    """Custom type hh3cSecondaryVlanlistHigh based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 256),
    )
...
_Hh3cSecondaryVlanlistHigh_Type.__name__ = "OctetString"
_Hh3cSecondaryVlanlistHigh_Object = MibTableColumn
hh3cSecondaryVlanlistHigh = _Hh3cSecondaryVlanlistHigh_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 2, 1, 8, 1, 3),
    _Hh3cSecondaryVlanlistHigh_Type()
)
hh3cSecondaryVlanlistHigh.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cSecondaryVlanlistHigh.setStatus("current")
...
_Hh3cVLANMibGarpLeaveAllTime_Type.__name__ = "TimeInterval"
...
mibBuilder.exportSymbols(
    ...
    **{"Hh3cVlanIndex": Hh3cVlanIndex,
       ...
       "hh3cdot1qVlanStatisticStatus": hh3cdot1qVlanStatisticStatus,
       "hh3cdot1qVlanStatisticClear": hh3cdot1qVlanStatisticClear,
       "hh3cdot1qVlanStatisticInTotalPkts": hh3cdot1qVlanStatisticInTotalPkts,
       "hh3cdot1qVlanStatisticInTotalBytes": hh3cdot1qVlanStatisticInTotalBytes,
       "hh3cdot1qVlanStatisticInPPS": hh3cdot1qVlanStatisticInPPS,
       "hh3cdot1qVlanStatisticInBPS": hh3cdot1qVlanStatisticInBPS,
       "hh3cdot1qVlanStatisticOutTotalPkts": hh3cdot1qVlanStatisticOutTotalPkts,
       "hh3cdot1qVlanStatisticOutTotalBytes": hh3cdot1qVlanStatisticOutTotalBytes,
       "hh3cdot1qVlanStatisticOutPPS": hh3cdot1qVlanStatisticOutPPS,
       "hh3cdot1qVlanStatisticOutBPS": hh3cdot1qVlanStatisticOutBPS,
       ...
       "hh3cPrivateVlanMappingTable": hh3cPrivateVlanMappingTable,
       "hh3cPrivateVlanMappingEntry": hh3cPrivateVlanMappingEntry,
       "hh3cPrimaryVlanID": hh3cPrimaryVlanID,
       "hh3cSecondaryVlanlistLow": hh3cSecondaryVlanlistLow,
       "hh3cSecondaryVlanlistHigh": hh3cSecondaryVlanlistHigh,
