...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-LBV2-MIB
...
_Hh3cLBv2GlobalStatsTable_Object = MibTable
hh3cLBv2GlobalStatsTable = _Hh3cLBv2GlobalStatsTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 148, 1, 2)
)
if mibBuilder.loadTexts:
    hh3cLBv2GlobalStatsTable.setStatus("current")
_Hh3cLBv2GlobalStatsEntry_Object = MibTableRow
hh3cLBv2GlobalStatsEntry = _Hh3cLBv2GlobalStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 148, 1, 2, 1)
)
hh3cLBv2GlobalStatsEntry.setIndexNames(
    (0, "HH3C-LBV2-MIB", "hh3cLBv2GlobalStatChassis"),
    (0, "HH3C-LBV2-MIB", "hh3cLBv2GlobalStatSlot"),
    (0, "HH3C-LBV2-MIB", "hh3cLBv2GlobalStatCpuid"),
)
if mibBuilder.loadTexts:
    hh3cLBv2GlobalStatsEntry.setStatus("current")


class _Hh3cLBv2GlobalStatChassis_Type(Unsigned32):
    """Custom type hh3cLBv2GlobalStatChassis based on Unsigned32"""
...
_Hh3cLBv2GlobalStatChassis_Type.__name__ = "Unsigned32"
_Hh3cLBv2GlobalStatChassis_Object = MibTableColumn
hh3cLBv2GlobalStatChassis = _Hh3cLBv2GlobalStatChassis_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 148, 1, 2, 1, 1),
    _Hh3cLBv2GlobalStatChassis_Type()
)
hh3cLBv2GlobalStatChassis.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cLBv2GlobalStatChassis.setStatus("current")


class _Hh3cLBv2GlobalStatSlot_Type(Unsigned32):
    """Custom type hh3cLBv2GlobalStatSlot based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_Hh3cLBv2GlobalStatSlot_Type.__name__ = "Unsigned32"
_Hh3cLBv2GlobalStatSlot_Object = MibTableColumn
hh3cLBv2GlobalStatSlot = _Hh3cLBv2GlobalStatSlot_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 148, 1, 2, 1, 2),
    _Hh3cLBv2GlobalStatSlot_Type()
)
hh3cLBv2GlobalStatSlot.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cLBv2GlobalStatSlot.setStatus("current")


class _Hh3cLBv2GlobalStatCpuid_Type(Unsigned32):
    """Custom type hh3cLBv2GlobalStatCpuid based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 255),
    )
...
_Hh3cLBv2GlobalStatCpuid_Type.__name__ = "Unsigned32"
_Hh3cLBv2GlobalStatCpuid_Object = MibTableColumn
hh3cLBv2GlobalStatCpuid = _Hh3cLBv2GlobalStatCpuid_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 148, 1, 2, 1, 3),
    _Hh3cLBv2GlobalStatCpuid_Type()
)
hh3cLBv2GlobalStatCpuid.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cLBv2GlobalStatCpuid.setStatus("current")
_Hh3cLBv2GlobalStatTotalConnections_Type = Counter64
_Hh3cLBv2GlobalStatTotalConnections_Object = MibTableColumn
hh3cLBv2GlobalStatTotalConnections = _Hh3cLBv2GlobalStatTotalConnections_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 148, 1, 2, 1, 4),
    _Hh3cLBv2GlobalStatTotalConnections_Type()
)
hh3cLBv2GlobalStatTotalConnections.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cLBv2GlobalStatTotalConnections.setStatus("current")
_Hh3cLBv2GlobalStatActiveConnections_Type = Gauge32
_Hh3cLBv2GlobalStatActiveConnections_Object = MibTableColumn
hh3cLBv2GlobalStatActiveConnections = _Hh3cLBv2GlobalStatActiveConnections_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 148, 1, 2, 1, 5),
    _Hh3cLBv2GlobalStatActiveConnections_Type()
)
hh3cLBv2GlobalStatActiveConnections.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cLBv2GlobalStatActiveConnections.setStatus("current")
_Hh3cLBv2GlobalStatConnectionsRate_Type = Gauge32
_Hh3cLBv2GlobalStatConnectionsRate_Object = MibTableColumn
hh3cLBv2GlobalStatConnectionsRate = _Hh3cLBv2GlobalStatConnectionsRate_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 148, 1, 2, 1, 6),
    _Hh3cLBv2GlobalStatConnectionsRate_Type()
)
hh3cLBv2GlobalStatConnectionsRate.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cLBv2GlobalStatConnectionsRate.setStatus("current")
if mibBuilder.loadTexts:
    hh3cLBv2GlobalStatConnectionsRate.setUnits("cps")
...
_Hh3cLBv2VSConnectionsLimit_Type.__name__ = "Unsigned32"
...
_Hh3cLBv2VSConnectionsRateLimit_Type.__name__ = "Unsigned32"
...
_Hh3cLBv2RSConnectionsLimit_Type.__name__ = "Unsigned32"
...
_Hh3cLBv2RSConnectionsRateLimit_Type.__name__ = "Unsigned32"
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cLBv2": hh3cLBv2,
       ...
       "hh3cLBv2GlobalStatsTable": hh3cLBv2GlobalStatsTable,
       "hh3cLBv2GlobalStatsEntry": hh3cLBv2GlobalStatsEntry,
       "hh3cLBv2GlobalStatChassis": hh3cLBv2GlobalStatChassis,
       "hh3cLBv2GlobalStatSlot": hh3cLBv2GlobalStatSlot,
       "hh3cLBv2GlobalStatCpuid": hh3cLBv2GlobalStatCpuid,
       "hh3cLBv2GlobalStatTotalConnections": hh3cLBv2GlobalStatTotalConnections,
       "hh3cLBv2GlobalStatActiveConnections": hh3cLBv2GlobalStatActiveConnections,
       "hh3cLBv2GlobalStatConnectionsRate": hh3cLBv2GlobalStatConnectionsRate,
