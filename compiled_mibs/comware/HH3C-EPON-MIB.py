...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-EPON-MIB
...
if mibBuilder.loadTexts:
    hh3cEponMibObjects.setRevisions(
        ("2021-01-25 10:38",
         "2019-07-10 10:38",
         "2019-07-08 10:49",
         "2018-11-28 10:49",
...
_Hh3cEponAutoAuthorize_Type.__name__ = "TruthValue"
...
class _Hh3cEponMonitorCycle_Type(Integer32):
    """Custom type hh3cEponMonitorCycle based on Integer32"""
    defaultValue = 80
...
_Hh3cEponMonitorCycle_Type.__name__ = "Integer32"
...
_Hh3cEponMsgTimeOut_Type.__name__ = "Integer32"
...
_Hh3cEponMsgLoseNum_Type.__name__ = "Integer32"
...
_Hh3cEponMonitorCycleEnable_Type.__name__ = "TruthValue"
...
_Hh3cEponOltSoftwareErrAlmEnable_Type.__name__ = "TruthValue"
...
_Hh3cEponPortLoopBackAlmEnable_Type.__name__ = "TruthValue"
...
_Hh3cEponOamDiscoveryTimeout_Type.__name__ = "Integer32"
...
_Hh3cEponEncryptionNoReplyTimeOut_Type.__name__ = "Integer32"
...
_Hh3cEponEncryptionUpdateTime_Type.__name__ = "Integer32"
...
class _Hh3cEponAutoBindType_Type(Bits):
    """Custom type hh3cEponAutoBindType based on Bits"""
    namedValues = NamedValues(
        *(("mac", 0),
          ("loid", 1),
          ("loidPassword", 2))
...
_Hh3cEponAutoBindType_Type.__name__ = "Bits"
_Hh3cEponAutoBindType_Object = MibTableColumn
hh3cEponAutoBindType = _Hh3cEponAutoBindType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 1, 16, 1, 8),
    _Hh3cEponAutoBindType_Type()
)
hh3cEponAutoBindType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cEponAutoBindType.setStatus("current")
...
class _Hh3cEponAuthMode_Type(Bits):
    """Custom type hh3cEponAuthMode based on Bits"""
    namedValues = NamedValues(
        *(("mac", 0),
          ("loid", 1),
          ("loidPassword", 2))
...
_Hh3cEponAuthMode_Type.__name__ = "Bits"
_Hh3cEponAuthMode_Object = MibScalar
hh3cEponAuthMode = _Hh3cEponAuthMode_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 1, 21),
    _Hh3cEponAuthMode_Type()
)
hh3cEponAuthMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cEponAuthMode.setStatus("current")
_Hh3cEponOnuBindOneToOne_Type = TruthValue
_Hh3cEponOnuBindOneToOne_Object = MibScalar
hh3cEponOnuBindOneToOne = _Hh3cEponOnuBindOneToOne_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 1, 22),
    _Hh3cEponOnuBindOneToOne_Type()
)
hh3cEponOnuBindOneToOne.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cEponOnuBindOneToOne.setStatus("current")
_Hh3cEponOnuBlackListMacTable_Object = MibTable
hh3cEponOnuBlackListMacTable = _Hh3cEponOnuBlackListMacTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 1, 23)
)
if mibBuilder.loadTexts:
    hh3cEponOnuBlackListMacTable.setStatus("current")
_Hh3cEponOnuBlackListMacEntry_Object = MibTableRow
hh3cEponOnuBlackListMacEntry = _Hh3cEponOnuBlackListMacEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 1, 23, 1)
)
hh3cEponOnuBlackListMacEntry.setIndexNames(
    (0, "HH3C-EPON-MIB", "hh3cEponOnuBlackListMac"),
)
if mibBuilder.loadTexts:
    hh3cEponOnuBlackListMacEntry.setStatus("current")
_Hh3cEponOnuBlackListMac_Type = MacAddress
_Hh3cEponOnuBlackListMac_Object = MibTableColumn
hh3cEponOnuBlackListMac = _Hh3cEponOnuBlackListMac_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 1, 23, 1, 1),
    _Hh3cEponOnuBlackListMac_Type()
)
hh3cEponOnuBlackListMac.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cEponOnuBlackListMac.setStatus("current")
_Hh3cEponOnuBlackListMacRowStatus_Type = RowStatus
_Hh3cEponOnuBlackListMacRowStatus_Object = MibTableColumn
hh3cEponOnuBlackListMacRowStatus = _Hh3cEponOnuBlackListMacRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 1, 23, 1, 2),
    _Hh3cEponOnuBlackListMacRowStatus_Type()
)
hh3cEponOnuBlackListMacRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cEponOnuBlackListMacRowStatus.setStatus("current")
_Hh3cEponOnuBlackListLoidTable_Object = MibTable
hh3cEponOnuBlackListLoidTable = _Hh3cEponOnuBlackListLoidTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 1, 24)
)
if mibBuilder.loadTexts:
    hh3cEponOnuBlackListLoidTable.setStatus("current")
_Hh3cEponOnuBlackListLoidEntry_Object = MibTableRow
hh3cEponOnuBlackListLoidEntry = _Hh3cEponOnuBlackListLoidEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 1, 24, 1)
)
hh3cEponOnuBlackListLoidEntry.setIndexNames(
    (0, "HH3C-EPON-MIB", "hh3cEponOnuBlackListLoid"),
)
if mibBuilder.loadTexts:
    hh3cEponOnuBlackListLoidEntry.setStatus("current")


class _Hh3cEponOnuBlackListLoid_Type(OctetString):
    """Custom type hh3cEponOnuBlackListLoid based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cEponOnuBlackListLoid_Type.__name__ = "OctetString"
_Hh3cEponOnuBlackListLoid_Object = MibTableColumn
hh3cEponOnuBlackListLoid = _Hh3cEponOnuBlackListLoid_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 1, 24, 1, 1),
    _Hh3cEponOnuBlackListLoid_Type()
)
hh3cEponOnuBlackListLoid.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cEponOnuBlackListLoid.setStatus("current")
_Hh3cEponOnuBlackListLoidRowStatus_Type = RowStatus
_Hh3cEponOnuBlackListLoidRowStatus_Object = MibTableColumn
hh3cEponOnuBlackListLoidRowStatus = _Hh3cEponOnuBlackListLoidRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 1, 24, 1, 2),
    _Hh3cEponOnuBlackListLoidRowStatus_Type()
)
hh3cEponOnuBlackListLoidRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cEponOnuBlackListLoidRowStatus.setStatus("current")
...
_Hh3cOltLaserOnTime_Type.__name__ = "Integer32"
...
_Hh3cOltLaserOffTime_Type.__name__ = "Integer32"
...
_Hh3cOltMultiCopyBrdCast_Type.__name__ = "TruthValue"
...
_Hh3cOltEnableDiscardPacket_Type.__name__ = "TruthValue"
...
class _Hh3cOltAuthMode_Type(Bits):
    """Custom type hh3cOltAuthMode based on Bits"""
    namedValues = NamedValues(
        *(("mac", 0),
          ("loid", 1),
          ("loidPassword", 2))
...
_Hh3cOltAuthMode_Type.__name__ = "Bits"
_Hh3cOltAuthMode_Object = MibTableColumn
hh3cOltAuthMode = _Hh3cOltAuthMode_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 1, 1, 8),
    _Hh3cOltAuthMode_Type()
)
hh3cOltAuthMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOltAuthMode.setStatus("current")
_Hh3cOltOnuBindOneToOne_Type = TruthValue
_Hh3cOltOnuBindOneToOne_Object = MibTableColumn
hh3cOltOnuBindOneToOne = _Hh3cOltOnuBindOneToOne_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 1, 1, 9),
    _Hh3cOltOnuBindOneToOne_Type()
)
hh3cOltOnuBindOneToOne.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOltOnuBindOneToOne.setStatus("current")
...
_Hh3cOltDbaDiscoveryLength_Type = Integer32
...
_Hh3cOltDbaDiscovryFrequency_Type = Integer32
...
_Hh3cOltDbaCycleLength_Type.__name__ = "Integer32"
...
_Hh3cOltPortAlarmBerEnabled_Type.__name__ = "TruthValue"
...
_Hh3cOltPortAlarmBerThreshold_Type.__name__ = "Integer32"
...
_Hh3cOltPortAlarmFerEnabled_Type.__name__ = "TruthValue"
...
_Hh3cOltPortAlarmFerThreshold_Type.__name__ = "Integer32"
...
_Hh3cOltPortAlarmLlidMismatchEnabled_Type.__name__ = "TruthValue"
...
_Hh3cOltPortAlarmLlidMismatchThreshold_Type.__name__ = "Integer32"
...
_Hh3cOltPortAlarmRemoteStableEnabled_Type.__name__ = "TruthValue"
...
_Hh3cOltPortAlarmLocalStableEnabled_Type.__name__ = "TruthValue"
...
_Hh3cOltPortAlarmRegistrationEnabled_Type.__name__ = "TruthValue"
...
_Hh3cOltPortAlarmOamDisconnectionEnabled_Type.__name__ = "TruthValue"
...
_Hh3cOltPortAlarmEncryptionKeyEnabled_Type.__name__ = "TruthValue"
...
_Hh3cOltPortAlarmVendorSpecificEnabled_Type.__name__ = "TruthValue"
...
_Hh3cOltPortAlarmRegExcessEnabled_Type.__name__ = "TruthValue"
...
_Hh3cOltPortAlarmDFEEnabled_Type.__name__ = "TruthValue"
...
_Hh3cOnuSilentLoidTable_Object = MibTable
hh3cOnuSilentLoidTable = _Hh3cOnuSilentLoidTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 23)
)
if mibBuilder.loadTexts:
    hh3cOnuSilentLoidTable.setStatus("current")
_Hh3cOnuSilentLoidEntry_Object = MibTableRow
hh3cOnuSilentLoidEntry = _Hh3cOnuSilentLoidEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 23, 1)
)
hh3cOnuSilentLoidEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "HH3C-EPON-MIB", "hh3cOnuSilentLoid"),
)
if mibBuilder.loadTexts:
    hh3cOnuSilentLoidEntry.setStatus("current")


class _Hh3cOnuSilentLoid_Type(OctetString):
    """Custom type hh3cOnuSilentLoid based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 24),
    )
...
_Hh3cOnuSilentLoid_Type.__name__ = "OctetString"
_Hh3cOnuSilentLoid_Object = MibTableColumn
hh3cOnuSilentLoid = _Hh3cOnuSilentLoid_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 23, 1, 1),
    _Hh3cOnuSilentLoid_Type()
)
hh3cOnuSilentLoid.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cOnuSilentLoid.setStatus("current")
_Hh3cOnuSilentLoidTime_Type = Integer32
_Hh3cOnuSilentLoidTime_Object = MibTableColumn
hh3cOnuSilentLoidTime = _Hh3cOnuSilentLoidTime_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 23, 1, 2),
    _Hh3cOnuSilentLoidTime_Type()
)
hh3cOnuSilentLoidTime.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuSilentLoidTime.setStatus("current")
_Hh3cOltTransceiverTxPowerTable_Object = MibTable
hh3cOltTransceiverTxPowerTable = _Hh3cOltTransceiverTxPowerTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 24)
)
if mibBuilder.loadTexts:
    hh3cOltTransceiverTxPowerTable.setStatus("current")
_Hh3cOltTransceiverTxPowerEntry_Object = MibTableRow
hh3cOltTransceiverTxPowerEntry = _Hh3cOltTransceiverTxPowerEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 24, 1)
)
hh3cOltTransceiverTxPowerEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    hh3cOltTransceiverTxPowerEntry.setStatus("current")


class _Hh3cOltTransTxPwrTransId_Type(Integer32):
    """Custom type hh3cOltTransTxPwrTransId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_Hh3cOltTransTxPwrTransId_Type.__name__ = "Integer32"
_Hh3cOltTransTxPwrTransId_Object = MibTableColumn
hh3cOltTransTxPwrTransId = _Hh3cOltTransTxPwrTransId_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 24, 1, 1),
    _Hh3cOltTransTxPwrTransId_Type()
)
hh3cOltTransTxPwrTransId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOltTransTxPwrTransId.setStatus("current")
_Hh3cOltTransTxPwrOffTime_Type = Unsigned32
_Hh3cOltTransTxPwrOffTime_Object = MibTableColumn
hh3cOltTransTxPwrOffTime = _Hh3cOltTransTxPwrOffTime_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 24, 1, 2),
    _Hh3cOltTransTxPwrOffTime_Type()
)
hh3cOltTransTxPwrOffTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOltTransTxPwrOffTime.setStatus("current")
_Hh3cOltTransTxPwrIsAllOnu_Type = TruthValue
_Hh3cOltTransTxPwrIsAllOnu_Object = MibTableColumn
hh3cOltTransTxPwrIsAllOnu = _Hh3cOltTransTxPwrIsAllOnu_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 24, 1, 3),
    _Hh3cOltTransTxPwrIsAllOnu_Type()
)
hh3cOltTransTxPwrIsAllOnu.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOltTransTxPwrIsAllOnu.setStatus("current")


class _Hh3cOltTransTxPwrOnuIfList_Type(OctetString):
    """Custom type hh3cOltTransTxPwrOnuIfList based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cOltTransTxPwrOnuIfList_Type.__name__ = "OctetString"
_Hh3cOltTransTxPwrOnuIfList_Object = MibTableColumn
hh3cOltTransTxPwrOnuIfList = _Hh3cOltTransTxPwrOnuIfList_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 3, 24, 1, 4),
    _Hh3cOltTransTxPwrOnuIfList_Type()
)
hh3cOltTransTxPwrOnuIfList.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOltTransTxPwrOnuIfList.setStatus("current")
...
_Hh3cOnuMulticastFilterStatus_Type.__name__ = "TruthValue"
...
_Hh3cOnuDbaReportQueueSetNumber_Type.__name__ = "Integer32"
...
_Hh3cOnuUniUpDownTrapStatus_Type.__name__ = "TruthValue"
...
class _Hh3cOnuMacAddressTimer_Type(Unsigned32):
    """Custom type hh3cOnuMacAddressTimer based on Unsigned32"""
    defaultValue = 300


_Hh3cOnuMacAddressTimer_Type.__name__ = "Unsigned32"
_Hh3cOnuMacAddressTimer_Object = MibTableColumn
hh3cOnuMacAddressTimer = _Hh3cOnuMacAddressTimer_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 1, 1, 16),
    _Hh3cOnuMacAddressTimer_Type()
)
hh3cOnuMacAddressTimer.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuMacAddressTimer.setStatus("current")
...
_Hh3cOnuLinkTestFrameNum_Type.__name__ = "Integer32"
...
_Hh3cOnuLinkTestDelay_Type.__name__ = "TruthValue"
...
_Hh3cOnuLinkTestVlanTag_Type.__name__ = "TruthValue"
...
_Hh3cOnuDownStreamBandWidthPolicy_Type.__name__ = "TruthValue"
...
_Hh3cOnuDownStreamHighPriorityFirst_Type.__name__ = "TruthValue"
...
_Hh3cOnuDownStreamShortFrameFirst_Type.__name__ = "TruthValue"
...
_Hh3cOnuP2PBandWidthPolicy_Type.__name__ = "TruthValue"
...
_Hh3cOnuP2PHighPriorityFirst_Type.__name__ = "TruthValue"
...
_Hh3cOnuP2PShortFrameFirst_Type.__name__ = "TruthValue"
...
_Hh3cOnuSlaPriorityClass_Type.__name__ = "Integer32"
...
class _Hh3cOnuSlaWrrBandWidth_Type(Integer32):
    """Custom type hh3cOnuSlaWrrBandWidth based on Integer32"""
    defaultValue = 1


_Hh3cOnuSlaWrrBandWidth_Type.__name__ = "Integer32"
_Hh3cOnuSlaWrrBandWidth_Object = MibTableColumn
hh3cOnuSlaWrrBandWidth = _Hh3cOnuSlaWrrBandWidth_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 4, 1, 8),
    _Hh3cOnuSlaWrrBandWidth_Type()
)
hh3cOnuSlaWrrBandWidth.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuSlaWrrBandWidth.setStatus("current")
...
_Hh3cOnuInfoMac_Type = MacAddress
_Hh3cOnuInfoMac_Object = MibTableColumn
hh3cOnuInfoMac = _Hh3cOnuInfoMac_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 5, 1, 19),
    _Hh3cOnuInfoMac_Type()
)
hh3cOnuInfoMac.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuInfoMac.setStatus("current")


class _Hh3cOnuInfoLoid_Type(OctetString):
    """Custom type hh3cOnuInfoLoid based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cOnuInfoLoid_Type.__name__ = "OctetString"
_Hh3cOnuInfoLoid_Object = MibTableColumn
hh3cOnuInfoLoid = _Hh3cOnuInfoLoid_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 5, 1, 20),
    _Hh3cOnuInfoLoid_Type()
)
hh3cOnuInfoLoid.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuInfoLoid.setStatus("current")
...
class _Hh3cOnuBindLoid_Type(OctetString):
    """Custom type hh3cOnuBindLoid based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 24),
    )
...
_Hh3cOnuBindLoid_Type.__name__ = "OctetString"
_Hh3cOnuBindLoid_Object = MibTableColumn
hh3cOnuBindLoid = _Hh3cOnuBindLoid_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 7, 1, 3),
    _Hh3cOnuBindLoid_Type()
)
hh3cOnuBindLoid.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuBindLoid.setStatus("current")


class _Hh3cOnuBindPassword_Type(OctetString):
    """Custom type hh3cOnuBindPassword based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cOnuBindPassword_Type.__name__ = "OctetString"
_Hh3cOnuBindPassword_Object = MibTableColumn
hh3cOnuBindPassword = _Hh3cOnuBindPassword_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 7, 1, 4),
    _Hh3cOnuBindPassword_Type()
)
hh3cOnuBindPassword.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuBindPassword.setStatus("current")
...
class _Hh3cOnuUpdateProtType_Type(Integer32):
    """Custom type hh3cOnuUpdateProtType based on Integer32"""
    defaultValue = 0
...
_Hh3cOnuUpdateProtType_Type.__name__ = "Integer32"
_Hh3cOnuUpdateProtType_Object = MibTableColumn
hh3cOnuUpdateProtType = _Hh3cOnuUpdateProtType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 8, 1, 4),
    _Hh3cOnuUpdateProtType_Type()
)
hh3cOnuUpdateProtType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuUpdateProtType.setStatus("current")


class _Hh3cOnuUpdateStartTime_Type(OctetString):
    """Custom type hh3cOnuUpdateStartTime based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cOnuUpdateStartTime_Type.__name__ = "OctetString"
_Hh3cOnuUpdateStartTime_Object = MibTableColumn
hh3cOnuUpdateStartTime = _Hh3cOnuUpdateStartTime_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 8, 1, 5),
    _Hh3cOnuUpdateStartTime_Type()
)
hh3cOnuUpdateStartTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuUpdateStartTime.setStatus("current")


class _Hh3cOnuUpdateDuration_Type(Integer32):
    """Custom type hh3cOnuUpdateDuration based on Integer32"""
    defaultValue = 0
...
_Hh3cOnuUpdateDuration_Type.__name__ = "Integer32"
_Hh3cOnuUpdateDuration_Object = MibTableColumn
hh3cOnuUpdateDuration = _Hh3cOnuUpdateDuration_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 8, 1, 6),
    _Hh3cOnuUpdateDuration_Type()
)
hh3cOnuUpdateDuration.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuUpdateDuration.setStatus("current")
...
_Hh3cOnuStpStatus_Type.__name__ = "TruthValue"
...
_Hh3cOnuIgmpSnoopingStatus_Type.__name__ = "TruthValue"
...
_Hh3cOnuDhcpsnoopingOption82_Type.__name__ = "TruthValue"
...
_Hh3cOnuDhcpsnooping_Type.__name__ = "TruthValue"
...
_Hh3cOnuPppoe_Type.__name__ = "TruthValue"
...
_Hh3cOnuIgmpSnoopingAggReportS_Type.__name__ = "TruthValue"
...
_Hh3cOnuIgmpSnoopingAggLeaveS_Type.__name__ = "TruthValue"
...
_Hh3cOnuType_Type = Integer32
_Hh3cOnuType_Object = MibTableColumn
hh3cOnuType = _Hh3cOnuType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 25, 1, 13),
    _Hh3cOnuType_Type()
)
hh3cOnuType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuType.setStatus("current")
_Hh3cOnuMultiLLID_Type = Integer32
_Hh3cOnuMultiLLID_Object = MibTableColumn
hh3cOnuMultiLLID = _Hh3cOnuMultiLLID_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 25, 1, 14),
    _Hh3cOnuMultiLLID_Type()
)
hh3cOnuMultiLLID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuMultiLLID.setStatus("current")
_Hh3cOnuProtectionType_Type = Integer32
_Hh3cOnuProtectionType_Object = MibTableColumn
hh3cOnuProtectionType = _Hh3cOnuProtectionType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 25, 1, 15),
    _Hh3cOnuProtectionType_Type()
)
hh3cOnuProtectionType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuProtectionType.setStatus("current")
_Hh3cOnuPonIFNum_Type = Integer32
_Hh3cOnuPonIFNum_Object = MibTableColumn
hh3cOnuPonIFNum = _Hh3cOnuPonIFNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 25, 1, 16),
    _Hh3cOnuPonIFNum_Type()
)
hh3cOnuPonIFNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuPonIFNum.setStatus("current")
_Hh3cOnuSlotNum_Type = Integer32
_Hh3cOnuSlotNum_Object = MibTableColumn
hh3cOnuSlotNum = _Hh3cOnuSlotNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 25, 1, 17),
    _Hh3cOnuSlotNum_Type()
)
hh3cOnuSlotNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuSlotNum.setStatus("current")
_Hh3cOnuIPv6Supported_Type = Integer32
_Hh3cOnuIPv6Supported_Object = MibTableColumn
hh3cOnuIPv6Supported = _Hh3cOnuIPv6Supported_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 25, 1, 18),
    _Hh3cOnuIPv6Supported_Type()
)
hh3cOnuIPv6Supported.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuIPv6Supported.setStatus("current")
_Hh3cOnuPowerSupplyControl_Type = Integer32
_Hh3cOnuPowerSupplyControl_Object = MibTableColumn
hh3cOnuPowerSupplyControl = _Hh3cOnuPowerSupplyControl_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 25, 1, 19),
    _Hh3cOnuPowerSupplyControl_Type()
)
hh3cOnuPowerSupplyControl.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuPowerSupplyControl.setStatus("current")
_Hh3cOnuServiceSLA_Type = Integer32
_Hh3cOnuServiceSLA_Object = MibTableColumn
hh3cOnuServiceSLA = _Hh3cOnuServiceSLA_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 25, 1, 20),
    _Hh3cOnuServiceSLA_Type()
)
hh3cOnuServiceSLA.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuServiceSLA.setStatus("current")
...
hh3cEponStpPortDescr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
hh3cEponStpPortState.setMaxAccess("read-only")
if mibBuilder.loadTexts:
...
_Hh3cOnuDbaReport2Table_Object = MibTable
hh3cOnuDbaReport2Table = _Hh3cOnuDbaReport2Table_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 35)
)
if mibBuilder.loadTexts:
    hh3cOnuDbaReport2Table.setStatus("current")
_Hh3cOnuDbaReport2Entry_Object = MibTableRow
hh3cOnuDbaReport2Entry = _Hh3cOnuDbaReport2Entry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 35, 1)
)
hh3cOnuDbaReport2Entry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "HH3C-EPON-MIB", "hh3cOnuDbaReport2QueueSetId"),
    (0, "HH3C-EPON-MIB", "hh3cOnuDbaReport2QueueId"),
)
if mibBuilder.loadTexts:
    hh3cOnuDbaReport2Entry.setStatus("current")


class _Hh3cOnuDbaReport2QueueSetId_Type(Integer32):
    """Custom type hh3cOnuDbaReport2QueueSetId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cOnuDbaReport2QueueSetId_Type.__name__ = "Integer32"
_Hh3cOnuDbaReport2QueueSetId_Object = MibTableColumn
hh3cOnuDbaReport2QueueSetId = _Hh3cOnuDbaReport2QueueSetId_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 35, 1, 1),
    _Hh3cOnuDbaReport2QueueSetId_Type()
)
hh3cOnuDbaReport2QueueSetId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cOnuDbaReport2QueueSetId.setStatus("current")


class _Hh3cOnuDbaReport2QueueId_Type(Integer32):
    """Custom type hh3cOnuDbaReport2QueueId based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cOnuDbaReport2QueueId_Type.__name__ = "Integer32"
_Hh3cOnuDbaReport2QueueId_Object = MibTableColumn
hh3cOnuDbaReport2QueueId = _Hh3cOnuDbaReport2QueueId_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 35, 1, 2),
    _Hh3cOnuDbaReport2QueueId_Type()
)
hh3cOnuDbaReport2QueueId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cOnuDbaReport2QueueId.setStatus("current")
_Hh3cOnuDbaReport2Threshold_Type = Integer32
_Hh3cOnuDbaReport2Threshold_Object = MibTableColumn
hh3cOnuDbaReport2Threshold = _Hh3cOnuDbaReport2Threshold_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 35, 1, 3),
    _Hh3cOnuDbaReport2Threshold_Type()
)
hh3cOnuDbaReport2Threshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuDbaReport2Threshold.setStatus("current")
_Hh3cOnuDbaReport2Status_Type = TruthValue
_Hh3cOnuDbaReport2Status_Object = MibTableColumn
hh3cOnuDbaReport2Status = _Hh3cOnuDbaReport2Status_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 35, 1, 4),
    _Hh3cOnuDbaReport2Status_Type()
)
hh3cOnuDbaReport2Status.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuDbaReport2Status.setStatus("current")
_Hh3cOnuLoidInfoTable_Object = MibTable
hh3cOnuLoidInfoTable = _Hh3cOnuLoidInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 36)
)
if mibBuilder.loadTexts:
    hh3cOnuLoidInfoTable.setStatus("current")
_Hh3cOnuLoidInfoEntry_Object = MibTableRow
hh3cOnuLoidInfoEntry = _Hh3cOnuLoidInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 36, 1)
)
hh3cOnuLoidInfoEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "HH3C-EPON-MIB", "hh3cOnuLoidIndex"),
)
if mibBuilder.loadTexts:
    hh3cOnuLoidInfoEntry.setStatus("current")
_Hh3cOnuLoidIndex_Type = Integer32
_Hh3cOnuLoidIndex_Object = MibTableColumn
hh3cOnuLoidIndex = _Hh3cOnuLoidIndex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 36, 1, 1),
    _Hh3cOnuLoidIndex_Type()
)
hh3cOnuLoidIndex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cOnuLoidIndex.setStatus("current")


class _Hh3cOnuLoidFlag_Type(Integer32):
    """Custom type hh3cOnuLoidFlag based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hh3cOnuLoidFlag_Type.__name__ = "Integer32"
_Hh3cOnuLoidFlag_Object = MibTableColumn
hh3cOnuLoidFlag = _Hh3cOnuLoidFlag_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 36, 1, 2),
    _Hh3cOnuLoidFlag_Type()
)
hh3cOnuLoidFlag.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuLoidFlag.setStatus("current")


class _Hh3cOnuLoid_Type(OctetString):
    """Custom type hh3cOnuLoid based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 24),
    )
...
_Hh3cOnuLoid_Type.__name__ = "OctetString"
_Hh3cOnuLoid_Object = MibTableColumn
hh3cOnuLoid = _Hh3cOnuLoid_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 36, 1, 3),
    _Hh3cOnuLoid_Type()
)
hh3cOnuLoid.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuLoid.setStatus("current")
_Hh3cOnuStatisticsTable_Object = MibTable
hh3cOnuStatisticsTable = _Hh3cOnuStatisticsTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 37)
)
if mibBuilder.loadTexts:
    hh3cOnuStatisticsTable.setStatus("current")
_Hh3cOnuStatisticsEntry_Object = MibTableRow
hh3cOnuStatisticsEntry = _Hh3cOnuStatisticsEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 37, 1)
)
hh3cOnuStatisticsEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    hh3cOnuStatisticsEntry.setStatus("current")
_Hh3cOnuStatisticsPeriodVal_Type = Unsigned32
_Hh3cOnuStatisticsPeriodVal_Object = MibTableColumn
hh3cOnuStatisticsPeriodVal = _Hh3cOnuStatisticsPeriodVal_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 37, 1, 1),
    _Hh3cOnuStatisticsPeriodVal_Type()
)
hh3cOnuStatisticsPeriodVal.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuStatisticsPeriodVal.setStatus("current")
_Hh3cOnuStatisticsEnable_Type = TruthValue
_Hh3cOnuStatisticsEnable_Object = MibTableColumn
hh3cOnuStatisticsEnable = _Hh3cOnuStatisticsEnable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 37, 1, 2),
    _Hh3cOnuStatisticsEnable_Type()
)
hh3cOnuStatisticsEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuStatisticsEnable.setStatus("current")
_Hh3cOnuSlaMaxBandWidthMinVal10G_Type = Integer32
_Hh3cOnuSlaMaxBandWidthMinVal10G_Object = MibScalar
hh3cOnuSlaMaxBandWidthMinVal10G = _Hh3cOnuSlaMaxBandWidthMinVal10G_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 38),
    _Hh3cOnuSlaMaxBandWidthMinVal10G_Type()
)
hh3cOnuSlaMaxBandWidthMinVal10G.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuSlaMaxBandWidthMinVal10G.setStatus("current")
_Hh3cOnuSlaMaxBandWidthMaxVal10G_Type = Integer32
_Hh3cOnuSlaMaxBandWidthMaxVal10G_Object = MibScalar
hh3cOnuSlaMaxBandWidthMaxVal10G = _Hh3cOnuSlaMaxBandWidthMaxVal10G_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 39),
    _Hh3cOnuSlaMaxBandWidthMaxVal10G_Type()
)
hh3cOnuSlaMaxBandWidthMaxVal10G.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuSlaMaxBandWidthMaxVal10G.setStatus("current")
_Hh3cOnuSlaMinBandWidthMinVal10G_Type = Integer32
_Hh3cOnuSlaMinBandWidthMinVal10G_Object = MibScalar
hh3cOnuSlaMinBandWidthMinVal10G = _Hh3cOnuSlaMinBandWidthMinVal10G_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 40),
    _Hh3cOnuSlaMinBandWidthMinVal10G_Type()
)
hh3cOnuSlaMinBandWidthMinVal10G.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuSlaMinBandWidthMinVal10G.setStatus("current")
_Hh3cOnuSlaMinBandWidthMaxVal10G_Type = Integer32
_Hh3cOnuSlaMinBandWidthMaxVal10G_Object = MibScalar
hh3cOnuSlaMinBandWidthMaxVal10G = _Hh3cOnuSlaMinBandWidthMaxVal10G_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 41),
    _Hh3cOnuSlaMinBandWidthMaxVal10G_Type()
)
hh3cOnuSlaMinBandWidthMaxVal10G.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cOnuSlaMinBandWidthMaxVal10G.setStatus("current")
_Hh3cOnuServiceSlaTable_Object = MibTable
hh3cOnuServiceSlaTable = _Hh3cOnuServiceSlaTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 42)
)
if mibBuilder.loadTexts:
    hh3cOnuServiceSlaTable.setStatus("current")
_Hh3cOnuServiceSlaEntry_Object = MibTableRow
hh3cOnuServiceSlaEntry = _Hh3cOnuServiceSlaEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 42, 1)
)
hh3cOnuServiceSlaEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    hh3cOnuServiceSlaEntry.setStatus("current")


class _Hh3cSlaSchedulingMode_Type(Integer32):
    """Custom type hh3cSlaSchedulingMode based on Integer32"""
    defaultValue = 3
...
_Hh3cSlaSchedulingMode_Type.__name__ = "Integer32"
_Hh3cSlaSchedulingMode_Object = MibTableColumn
hh3cSlaSchedulingMode = _Hh3cSlaSchedulingMode_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 42, 1, 1),
    _Hh3cSlaSchedulingMode_Type()
)
hh3cSlaSchedulingMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cSlaSchedulingMode.setStatus("current")
_Hh3cSlaHighPrioBoundary_Type = Integer32
_Hh3cSlaHighPrioBoundary_Object = MibTableColumn
hh3cSlaHighPrioBoundary = _Hh3cSlaHighPrioBoundary_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 42, 1, 2),
    _Hh3cSlaHighPrioBoundary_Type()
)
hh3cSlaHighPrioBoundary.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cSlaHighPrioBoundary.setStatus("current")


class _Hh3cSlaCycleLength_Type(Integer32):
    """Custom type hh3cSlaCycleLength based on Integer32"""
    defaultValue = 62500
...
_Hh3cSlaCycleLength_Type.__name__ = "Integer32"
_Hh3cSlaCycleLength_Object = MibTableColumn
hh3cSlaCycleLength = _Hh3cSlaCycleLength_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 42, 1, 3),
    _Hh3cSlaCycleLength_Type()
)
hh3cSlaCycleLength.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cSlaCycleLength.setStatus("current")
if mibBuilder.loadTexts:
    hh3cSlaCycleLength.setUnits("time quantums")


class _Hh3cSlaApply_Type(TruthValue):
    """Custom type hh3cSlaApply based on TruthValue"""
    defaultValue = 2


_Hh3cSlaApply_Type.__name__ = "TruthValue"
_Hh3cSlaApply_Object = MibTableColumn
hh3cSlaApply = _Hh3cSlaApply_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 42, 1, 4),
    _Hh3cSlaApply_Type()
)
hh3cSlaApply.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cSlaApply.setStatus("current")
_Hh3cOnuServiceSlaQueTable_Object = MibTable
hh3cOnuServiceSlaQueTable = _Hh3cOnuServiceSlaQueTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 43)
)
if mibBuilder.loadTexts:
    hh3cOnuServiceSlaQueTable.setStatus("current")
_Hh3cOnuServiceSlaQueEntry_Object = MibTableRow
hh3cOnuServiceSlaQueEntry = _Hh3cOnuServiceSlaQueEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 43, 1)
)
hh3cOnuServiceSlaQueEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
    (0, "HH3C-EPON-MIB", "hh3cSlaQueId"),
)
if mibBuilder.loadTexts:
    hh3cOnuServiceSlaQueEntry.setStatus("current")
_Hh3cSlaQueId_Type = Integer32
_Hh3cSlaQueId_Object = MibTableColumn
hh3cSlaQueId = _Hh3cSlaQueId_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 43, 1, 1),
    _Hh3cSlaQueId_Type()
)
hh3cSlaQueId.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cSlaQueId.setStatus("current")


class _Hh3cSlaQueMode_Type(Integer32):
    """Custom type hh3cSlaQueMode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(0,
...
_Hh3cSlaQueMode_Type.__name__ = "Integer32"
_Hh3cSlaQueMode_Object = MibTableColumn
hh3cSlaQueMode = _Hh3cSlaQueMode_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 43, 1, 2),
    _Hh3cSlaQueMode_Type()
)
hh3cSlaQueMode.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cSlaQueMode.setStatus("current")


class _Hh3cSlaQueWeight_Type(Integer32):
    """Custom type hh3cSlaQueWeight based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cSlaQueWeight_Type.__name__ = "Integer32"
_Hh3cSlaQueWeight_Object = MibTableColumn
hh3cSlaQueWeight = _Hh3cSlaQueWeight_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 43, 1, 3),
    _Hh3cSlaQueWeight_Type()
)
hh3cSlaQueWeight.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cSlaQueWeight.setStatus("current")


class _Hh3cSlaQueFixPktSize_Type(Integer32):
    """Custom type hh3cSlaQueFixPktSize based on Integer32"""
    defaultValue = 0
...
_Hh3cSlaQueFixPktSize_Type.__name__ = "Integer32"
_Hh3cSlaQueFixPktSize_Object = MibTableColumn
hh3cSlaQueFixPktSize = _Hh3cSlaQueFixPktSize_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 43, 1, 4),
    _Hh3cSlaQueFixPktSize_Type()
)
hh3cSlaQueFixPktSize.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cSlaQueFixPktSize.setStatus("current")
if mibBuilder.loadTexts:
    hh3cSlaQueFixPktSize.setUnits("bytes")
_Hh3cSlaQueFixBandwidth_Type = Integer32
_Hh3cSlaQueFixBandwidth_Object = MibTableColumn
hh3cSlaQueFixBandwidth = _Hh3cSlaQueFixBandwidth_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 43, 1, 5),
    _Hh3cSlaQueFixBandwidth_Type()
)
hh3cSlaQueFixBandwidth.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cSlaQueFixBandwidth.setStatus("current")
if mibBuilder.loadTexts:
    hh3cSlaQueFixBandwidth.setUnits("kbps")
_Hh3cSlaQueGuaBandwidth_Type = Integer32
_Hh3cSlaQueGuaBandwidth_Object = MibTableColumn
hh3cSlaQueGuaBandwidth = _Hh3cSlaQueGuaBandwidth_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 43, 1, 6),
    _Hh3cSlaQueGuaBandwidth_Type()
)
hh3cSlaQueGuaBandwidth.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cSlaQueGuaBandwidth.setStatus("current")
if mibBuilder.loadTexts:
    hh3cSlaQueGuaBandwidth.setUnits("kbps")
_Hh3cSlaQueBstBandwidth_Type = Integer32
_Hh3cSlaQueBstBandwidth_Object = MibTableColumn
hh3cSlaQueBstBandwidth = _Hh3cSlaQueBstBandwidth_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 43, 1, 7),
    _Hh3cSlaQueBstBandwidth_Type()
)
hh3cSlaQueBstBandwidth.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cSlaQueBstBandwidth.setStatus("current")
if mibBuilder.loadTexts:
    hh3cSlaQueBstBandwidth.setUnits("kbps")
_Hh3cSlaQueRowStatus_Type = RowStatus
_Hh3cSlaQueRowStatus_Object = MibTableColumn
hh3cSlaQueRowStatus = _Hh3cSlaQueRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 43, 1, 8),
    _Hh3cSlaQueRowStatus_Type()
)
hh3cSlaQueRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cSlaQueRowStatus.setStatus("current")
_Hh3cOnuPoeTable_Object = MibTable
hh3cOnuPoeTable = _Hh3cOnuPoeTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 44)
)
if mibBuilder.loadTexts:
    hh3cOnuPoeTable.setStatus("current")
_Hh3cOnuPoeEntry_Object = MibTableRow
hh3cOnuPoeEntry = _Hh3cOnuPoeEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 44, 1)
)
hh3cOnuPoeEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    hh3cOnuPoeEntry.setStatus("current")


class _Hh3cOnuPoeEnable_Type(TruthValue):
    """Custom type hh3cOnuPoeEnable based on TruthValue"""
    defaultValue = 1


_Hh3cOnuPoeEnable_Type.__name__ = "TruthValue"
_Hh3cOnuPoeEnable_Object = MibTableColumn
hh3cOnuPoeEnable = _Hh3cOnuPoeEnable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 44, 1, 1),
    _Hh3cOnuPoeEnable_Type()
)
hh3cOnuPoeEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuPoeEnable.setStatus("current")


class _Hh3cOnuPoeMode_Type(Integer32):
    """Custom type hh3cOnuPoeMode based on Integer32"""
    defaultValue = 0
...
_Hh3cOnuPoeMode_Type.__name__ = "Integer32"
_Hh3cOnuPoeMode_Object = MibTableColumn
hh3cOnuPoeMode = _Hh3cOnuPoeMode_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 44, 1, 2),
    _Hh3cOnuPoeMode_Type()
)
hh3cOnuPoeMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuPoeMode.setStatus("current")


class _Hh3cOnuPoeMaxPowerClass_Type(Integer32):
    """Custom type hh3cOnuPoeMaxPowerClass based on Integer32"""
    defaultValue = 0
...
_Hh3cOnuPoeMaxPowerClass_Type.__name__ = "Integer32"
_Hh3cOnuPoeMaxPowerClass_Object = MibTableColumn
hh3cOnuPoeMaxPowerClass = _Hh3cOnuPoeMaxPowerClass_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 44, 1, 3),
    _Hh3cOnuPoeMaxPowerClass_Type()
)
hh3cOnuPoeMaxPowerClass.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuPoeMaxPowerClass.setStatus("current")


class _Hh3cOnuPoeMaxPowerValue_Type(Integer32):
    """Custom type hh3cOnuPoeMaxPowerValue based on Integer32"""
    defaultValue = 0


_Hh3cOnuPoeMaxPowerValue_Type.__name__ = "Integer32"
_Hh3cOnuPoeMaxPowerValue_Object = MibTableColumn
hh3cOnuPoeMaxPowerValue = _Hh3cOnuPoeMaxPowerValue_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 44, 1, 4),
    _Hh3cOnuPoeMaxPowerValue_Type()
)
hh3cOnuPoeMaxPowerValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuPoeMaxPowerValue.setStatus("current")
if mibBuilder.loadTexts:
    hh3cOnuPoeMaxPowerValue.setUnits("mW")
_Hh3cOnuPoeLegacyEnable_Type = TruthValue
_Hh3cOnuPoeLegacyEnable_Object = MibTableColumn
hh3cOnuPoeLegacyEnable = _Hh3cOnuPoeLegacyEnable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 5, 44, 1, 5),
    _Hh3cOnuPoeLegacyEnable_Type()
)
hh3cOnuPoeLegacyEnable.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuPoeLegacyEnable.setStatus("current")
...
class _Hh3cEponBatchOpBySlotBindType_Type(Bits):
    """Custom type hh3cEponBatchOpBySlotBindType based on Bits"""
    namedValues = NamedValues(
        *(("mac", 0),
          ("loid", 1),
          ("loidPassword", 2))
...
_Hh3cEponBatchOpBySlotBindType_Type.__name__ = "Bits"
_Hh3cEponBatchOpBySlotBindType_Object = MibTableColumn
hh3cEponBatchOpBySlotBindType = _Hh3cEponBatchOpBySlotBindType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 6, 1, 1, 5),
    _Hh3cEponBatchOpBySlotBindType_Type()
)
hh3cEponBatchOpBySlotBindType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cEponBatchOpBySlotBindType.setStatus("current")
...
class _Hh3cOnuUpdateByTypeProtType_Type(Integer32):
    """Custom type hh3cOnuUpdateByTypeProtType based on Integer32"""
    defaultValue = 0
...
_Hh3cOnuUpdateByTypeProtType_Type.__name__ = "Integer32"
_Hh3cOnuUpdateByTypeProtType_Object = MibTableColumn
hh3cOnuUpdateByTypeProtType = _Hh3cOnuUpdateByTypeProtType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 6, 3, 1, 5),
    _Hh3cOnuUpdateByTypeProtType_Type()
)
hh3cOnuUpdateByTypeProtType.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuUpdateByTypeProtType.setStatus("current")


class _Hh3cOnuUpdateByTypeStartTime_Type(OctetString):
    """Custom type hh3cOnuUpdateByTypeStartTime based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 5),
    )
...
_Hh3cOnuUpdateByTypeStartTime_Type.__name__ = "OctetString"
_Hh3cOnuUpdateByTypeStartTime_Object = MibTableColumn
hh3cOnuUpdateByTypeStartTime = _Hh3cOnuUpdateByTypeStartTime_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 6, 3, 1, 6),
    _Hh3cOnuUpdateByTypeStartTime_Type()
)
hh3cOnuUpdateByTypeStartTime.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuUpdateByTypeStartTime.setStatus("current")


class _Hh3cOnuUpdateByTypeDuration_Type(Integer32):
    """Custom type hh3cOnuUpdateByTypeDuration based on Integer32"""
    defaultValue = 0
...
_Hh3cOnuUpdateByTypeDuration_Type.__name__ = "Integer32"
_Hh3cOnuUpdateByTypeDuration_Object = MibTableColumn
hh3cOnuUpdateByTypeDuration = _Hh3cOnuUpdateByTypeDuration_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 6, 3, 1, 7),
    _Hh3cOnuUpdateByTypeDuration_Type()
)
hh3cOnuUpdateByTypeDuration.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cOnuUpdateByTypeDuration.setStatus("current")
...
class _Hh3cEponOnuRegSilentBindType_Type(Bits):
    """Custom type hh3cEponOnuRegSilentBindType based on Bits"""
    namedValues = NamedValues(
        *(("mac", 0),
          ("loid", 1),
          ("loidPassword", 2))
...
_Hh3cEponOnuRegSilentBindType_Type.__name__ = "Bits"
_Hh3cEponOnuRegSilentBindType_Object = MibScalar
hh3cEponOnuRegSilentBindType = _Hh3cEponOnuRegSilentBindType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 7, 14),
    _Hh3cEponOnuRegSilentBindType_Type()
)
hh3cEponOnuRegSilentBindType.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cEponOnuRegSilentBindType.setStatus("current")
_Hh3cEponOnuRegSilentLoid_Type = OctetString
_Hh3cEponOnuRegSilentLoid_Object = MibScalar
hh3cEponOnuRegSilentLoid = _Hh3cEponOnuRegSilentLoid_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 7, 15),
    _Hh3cEponOnuRegSilentLoid_Type()
)
hh3cEponOnuRegSilentLoid.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cEponOnuRegSilentLoid.setStatus("current")
_Hh3cEponOnuRegSilentLoidPwd_Type = OctetString
_Hh3cEponOnuRegSilentLoidPwd_Object = MibScalar
hh3cEponOnuRegSilentLoidPwd = _Hh3cEponOnuRegSilentLoidPwd_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 7, 16),
    _Hh3cEponOnuRegSilentLoidPwd_Type()
)
hh3cEponOnuRegSilentLoidPwd.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cEponOnuRegSilentLoidPwd.setStatus("current")
_Hh3cEponOnuRegErrorLoid_Type = OctetString
_Hh3cEponOnuRegErrorLoid_Object = MibScalar
hh3cEponOnuRegErrorLoid = _Hh3cEponOnuRegErrorLoid_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 7, 17),
    _Hh3cEponOnuRegErrorLoid_Type()
)
hh3cEponOnuRegErrorLoid.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cEponOnuRegErrorLoid.setStatus("current")


class _Hh3cEponOnuRegErrorLoidCode_Type(Integer32):
    """Custom type hh3cEponOnuRegErrorLoidCode based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hh3cEponOnuRegErrorLoidCode_Type.__name__ = "Integer32"
_Hh3cEponOnuRegErrorLoidCode_Object = MibScalar
hh3cEponOnuRegErrorLoidCode = _Hh3cEponOnuRegErrorLoidCode_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 7, 18),
    _Hh3cEponOnuRegErrorLoidCode_Type()
)
hh3cEponOnuRegErrorLoidCode.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cEponOnuRegErrorLoidCode.setStatus("current")
...
_Hh3cEponRoltMan_ObjectIdentity = ObjectIdentity
hh3cEponRoltMan = _Hh3cEponRoltMan_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10)
)
_Hh3cRoltInterfaceTable_Object = MibTable
hh3cRoltInterfaceTable = _Hh3cRoltInterfaceTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10, 1)
)
if mibBuilder.loadTexts:
    hh3cRoltInterfaceTable.setStatus("current")
_Hh3cRoltInterfaceEntry_Object = MibTableRow
hh3cRoltInterfaceEntry = _Hh3cRoltInterfaceEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10, 1, 1)
)
hh3cRoltInterfaceEntry.setIndexNames(
    (0, "HH3C-EPON-MIB", "hh3cRoltInterfaceNumber"),
)
if mibBuilder.loadTexts:
    hh3cRoltInterfaceEntry.setStatus("current")
_Hh3cRoltInterfaceNumber_Type = Integer32
_Hh3cRoltInterfaceNumber_Object = MibTableColumn
hh3cRoltInterfaceNumber = _Hh3cRoltInterfaceNumber_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10, 1, 1, 1),
    _Hh3cRoltInterfaceNumber_Type()
)
hh3cRoltInterfaceNumber.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cRoltInterfaceNumber.setStatus("current")
_Hh3cRoltInterfaceIfIndex_Type = Integer32
_Hh3cRoltInterfaceIfIndex_Object = MibTableColumn
hh3cRoltInterfaceIfIndex = _Hh3cRoltInterfaceIfIndex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10, 1, 1, 2),
    _Hh3cRoltInterfaceIfIndex_Type()
)
hh3cRoltInterfaceIfIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cRoltInterfaceIfIndex.setStatus("current")
_Hh3cRoltInterfaceRowStatus_Type = RowStatus
_Hh3cRoltInterfaceRowStatus_Object = MibTableColumn
hh3cRoltInterfaceRowStatus = _Hh3cRoltInterfaceRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10, 1, 1, 3),
    _Hh3cRoltInterfaceRowStatus_Type()
)
hh3cRoltInterfaceRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cRoltInterfaceRowStatus.setStatus("current")
_Hh3cRoltMemberTable_Object = MibTable
hh3cRoltMemberTable = _Hh3cRoltMemberTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10, 2)
)
if mibBuilder.loadTexts:
    hh3cRoltMemberTable.setStatus("current")
_Hh3cRoltMemberEntry_Object = MibTableRow
hh3cRoltMemberEntry = _Hh3cRoltMemberEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10, 2, 1)
)
hh3cRoltMemberEntry.setIndexNames(
    (0, "HH3C-EPON-MIB", "hh3cRoltInterfaceNumber"),
    (0, "HH3C-EPON-MIB", "hh3cRoltMemberOltIfindex"),
)
if mibBuilder.loadTexts:
    hh3cRoltMemberEntry.setStatus("current")
_Hh3cRoltMemberOltIfindex_Type = Integer32
_Hh3cRoltMemberOltIfindex_Object = MibTableColumn
hh3cRoltMemberOltIfindex = _Hh3cRoltMemberOltIfindex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10, 2, 1, 1),
    _Hh3cRoltMemberOltIfindex_Type()
)
hh3cRoltMemberOltIfindex.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cRoltMemberOltIfindex.setStatus("current")


class _Hh3cRoltMemberOltPriority_Type(Integer32):
    """Custom type hh3cRoltMemberOltPriority based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 255),
    )
...
_Hh3cRoltMemberOltPriority_Type.__name__ = "Integer32"
_Hh3cRoltMemberOltPriority_Object = MibTableColumn
hh3cRoltMemberOltPriority = _Hh3cRoltMemberOltPriority_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10, 2, 1, 2),
    _Hh3cRoltMemberOltPriority_Type()
)
hh3cRoltMemberOltPriority.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cRoltMemberOltPriority.setStatus("current")
_Hh3cRoltMemberRowStatus_Type = RowStatus
_Hh3cRoltMemberRowStatus_Object = MibTableColumn
hh3cRoltMemberRowStatus = _Hh3cRoltMemberRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10, 2, 1, 3),
    _Hh3cRoltMemberRowStatus_Type()
)
hh3cRoltMemberRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cRoltMemberRowStatus.setStatus("current")
_Hh3cRoltMemberForwardStatus_Type = TruthValue
_Hh3cRoltMemberForwardStatus_Object = MibTableColumn
hh3cRoltMemberForwardStatus = _Hh3cRoltMemberForwardStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 10, 2, 1, 4),
    _Hh3cRoltMemberForwardStatus_Type()
)
hh3cRoltMemberForwardStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cRoltMemberForwardStatus.setStatus("current")
...
hh3cEponOnuRegLoidErrTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 8, 0, 38)
)
hh3cEponOnuRegLoidErrTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("HH3C-EPON-MIB", "hh3cEponOnuRegErrorLoid"),
        ("HH3C-EPON-MIB", "hh3cEponOnuRegErrorLoidCode"))
)
if mibBuilder.loadTexts:
    hh3cEponOnuRegLoidErrTrap.setStatus(
        "current"
    )

hh3cEponOnuRegLoidErrRecTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 8, 0, 39)
)
hh3cEponOnuRegLoidErrRecTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("HH3C-EPON-MIB", "hh3cEponOnuRegErrorLoid"),
        ("HH3C-EPON-MIB", "hh3cEponOnuRegErrorLoidCode"))
...
if mibBuilder.loadTexts:
    hh3cEponOnuRegLoidErrRecTrap.setStatus(
        "current"
    )

hh3cEponOnuSilenceLoidTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 8, 0, 40)
)
hh3cEponOnuSilenceLoidTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("HH3C-EPON-MIB", "hh3cEponOnuRegSilentBindType"),
        ("HH3C-EPON-MIB", "hh3cEponOnuRegSilentMac"),
        ("HH3C-EPON-MIB", "hh3cEponOnuRegSilentLoid"),
        ("HH3C-EPON-MIB", "hh3cEponOnuRegSilentLoidPwd"))
)
if mibBuilder.loadTexts:
    hh3cEponOnuSilenceLoidTrap.setStatus(
        "current"
    )

hh3cEponOnuSilenceLoidRecTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 8, 0, 41)
)
hh3cEponOnuSilenceLoidRecTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("HH3C-EPON-MIB", "hh3cEponOnuRegSilentBindType"),
        ("HH3C-EPON-MIB", "hh3cEponOnuRegSilentMac"),
...
if mibBuilder.loadTexts:
    hh3cEponOnuSilenceLoidRecTrap.setStatus(
        "current"
    )

hh3cEponOnuUpdateLoidRetTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 8, 0, 42)
)
hh3cEponOnuUpdateLoidRetTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("HH3C-EPON-MIB", "hh3cOnuBindLoid"),
        ("HH3C-EPON-MIB", "hh3cOnuUpdateResult"),
        ("HH3C-EPON-MIB", "hh3cOnuRegType"),
        ("HH3C-EPON-MIB", "hh3cOnuUpdateFileName"))
)
if mibBuilder.loadTexts:
    hh3cEponOnuUpdateLoidRetTrap.setStatus(
        "current"
    )

hh3cEponOnuAutoBindLoidTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 8, 0, 43)
)
hh3cEponOnuAutoBindLoidTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"),
        ("HH3C-EPON-MIB", "hh3cOnuBindLoid"),
        ("HH3C-EPON-MIB", "hh3cEponOperationResult"))
...
if mibBuilder.loadTexts:
    hh3cEponOnuAutoBindLoidTrap.setStatus(
        "current"
    )

hh3cEponOnuPowerOnTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 8, 0, 44)
)
hh3cEponOnuPowerOnTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"))
)
if mibBuilder.loadTexts:
    hh3cEponOnuPowerOnTrap.setStatus(
        "current"
    )

hh3cEponOpticalSignalLosTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 8, 0, 45)
)
hh3cEponOpticalSignalLosTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"))
)
if mibBuilder.loadTexts:
    hh3cEponOpticalSignalLosTrap.setStatus(
        "current"
    )

hh3cEponOpticalSignalLosRecoverTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 8, 0, 46)
)
hh3cEponOpticalSignalLosRecoverTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"))
)
if mibBuilder.loadTexts:
    hh3cEponOpticalSignalLosRecoverTrap.setStatus(
        "current"
    )

hh3cEponOnuFiberFailTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 8, 0, 47)
)
hh3cEponOnuFiberFailTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"))
)
if mibBuilder.loadTexts:
    hh3cEponOnuFiberFailTrap.setStatus(
        "current"
    )

hh3cEponOnuFiberFailRecoverTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 42, 1, 8, 0, 48)
)
hh3cEponOnuFiberFailRecoverTrap.setObjects(
      *(("IF-MIB", "ifIndex"),
        ("IF-MIB", "ifDescr"))
)
if mibBuilder.loadTexts:
    hh3cEponOnuFiberFailRecoverTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cEponMibObjects": hh3cEponMibObjects,
       ...
       "hh3cEponAutoBindType": hh3cEponAutoBindType,
       ...
       "hh3cEponAuthMode": hh3cEponAuthMode,
       "hh3cEponOnuBindOneToOne": hh3cEponOnuBindOneToOne,
       "hh3cEponOnuBlackListMacTable": hh3cEponOnuBlackListMacTable,
       "hh3cEponOnuBlackListMacEntry": hh3cEponOnuBlackListMacEntry,
       "hh3cEponOnuBlackListMac": hh3cEponOnuBlackListMac,
       "hh3cEponOnuBlackListMacRowStatus": hh3cEponOnuBlackListMacRowStatus,
       "hh3cEponOnuBlackListLoidTable": hh3cEponOnuBlackListLoidTable,
       "hh3cEponOnuBlackListLoidEntry": hh3cEponOnuBlackListLoidEntry,
       "hh3cEponOnuBlackListLoid": hh3cEponOnuBlackListLoid,
       "hh3cEponOnuBlackListLoidRowStatus": hh3cEponOnuBlackListLoidRowStatus,
       ...
       "hh3cOltAuthMode": hh3cOltAuthMode,
       "hh3cOltOnuBindOneToOne": hh3cOltOnuBindOneToOne,
       ...
       "hh3cOnuSilentLoidTable": hh3cOnuSilentLoidTable,
       "hh3cOnuSilentLoidEntry": hh3cOnuSilentLoidEntry,
       "hh3cOnuSilentLoid": hh3cOnuSilentLoid,
       "hh3cOnuSilentLoidTime": hh3cOnuSilentLoidTime,
       "hh3cOltTransceiverTxPowerTable": hh3cOltTransceiverTxPowerTable,
       "hh3cOltTransceiverTxPowerEntry": hh3cOltTransceiverTxPowerEntry,
       "hh3cOltTransTxPwrTransId": hh3cOltTransTxPwrTransId,
       "hh3cOltTransTxPwrOffTime": hh3cOltTransTxPwrOffTime,
       "hh3cOltTransTxPwrIsAllOnu": hh3cOltTransTxPwrIsAllOnu,
       "hh3cOltTransTxPwrOnuIfList": hh3cOltTransTxPwrOnuIfList,
       ...
       "hh3cOnuMacAddressTimer": hh3cOnuMacAddressTimer,
       ...
       "hh3cOnuSlaWrrBandWidth": hh3cOnuSlaWrrBandWidth,
       ...
       "hh3cOnuInfoMac": hh3cOnuInfoMac,
       "hh3cOnuInfoLoid": hh3cOnuInfoLoid,
       ...
       "hh3cOnuBindLoid": hh3cOnuBindLoid,
       "hh3cOnuBindPassword": hh3cOnuBindPassword,
       ...
       "hh3cOnuUpdateProtType": hh3cOnuUpdateProtType,
       "hh3cOnuUpdateStartTime": hh3cOnuUpdateStartTime,
       "hh3cOnuUpdateDuration": hh3cOnuUpdateDuration,
       ...
       "hh3cOnuType": hh3cOnuType,
       "hh3cOnuMultiLLID": hh3cOnuMultiLLID,
       "hh3cOnuProtectionType": hh3cOnuProtectionType,
       "hh3cOnuPonIFNum": hh3cOnuPonIFNum,
       "hh3cOnuSlotNum": hh3cOnuSlotNum,
       "hh3cOnuIPv6Supported": hh3cOnuIPv6Supported,
       "hh3cOnuPowerSupplyControl": hh3cOnuPowerSupplyControl,
       "hh3cOnuServiceSLA": hh3cOnuServiceSLA,
       ...
       "hh3cOnuDbaReport2Table": hh3cOnuDbaReport2Table,
       "hh3cOnuDbaReport2Entry": hh3cOnuDbaReport2Entry,
       "hh3cOnuDbaReport2QueueSetId": hh3cOnuDbaReport2QueueSetId,
       "hh3cOnuDbaReport2QueueId": hh3cOnuDbaReport2QueueId,
       "hh3cOnuDbaReport2Threshold": hh3cOnuDbaReport2Threshold,
       "hh3cOnuDbaReport2Status": hh3cOnuDbaReport2Status,
       "hh3cOnuLoidInfoTable": hh3cOnuLoidInfoTable,
       "hh3cOnuLoidInfoEntry": hh3cOnuLoidInfoEntry,
       "hh3cOnuLoidIndex": hh3cOnuLoidIndex,
       "hh3cOnuLoidFlag": hh3cOnuLoidFlag,
       "hh3cOnuLoid": hh3cOnuLoid,
       "hh3cOnuStatisticsTable": hh3cOnuStatisticsTable,
       "hh3cOnuStatisticsEntry": hh3cOnuStatisticsEntry,
       "hh3cOnuStatisticsPeriodVal": hh3cOnuStatisticsPeriodVal,
       "hh3cOnuStatisticsEnable": hh3cOnuStatisticsEnable,
       "hh3cOnuSlaMaxBandWidthMinVal10G": hh3cOnuSlaMaxBandWidthMinVal10G,
       "hh3cOnuSlaMaxBandWidthMaxVal10G": hh3cOnuSlaMaxBandWidthMaxVal10G,
       "hh3cOnuSlaMinBandWidthMinVal10G": hh3cOnuSlaMinBandWidthMinVal10G,
       "hh3cOnuSlaMinBandWidthMaxVal10G": hh3cOnuSlaMinBandWidthMaxVal10G,
       "hh3cOnuServiceSlaTable": hh3cOnuServiceSlaTable,
       "hh3cOnuServiceSlaEntry": hh3cOnuServiceSlaEntry,
       "hh3cSlaSchedulingMode": hh3cSlaSchedulingMode,
       "hh3cSlaHighPrioBoundary": hh3cSlaHighPrioBoundary,
       "hh3cSlaCycleLength": hh3cSlaCycleLength,
       "hh3cSlaApply": hh3cSlaApply,
       "hh3cOnuServiceSlaQueTable": hh3cOnuServiceSlaQueTable,
       "hh3cOnuServiceSlaQueEntry": hh3cOnuServiceSlaQueEntry,
       "hh3cSlaQueId": hh3cSlaQueId,
       "hh3cSlaQueMode": hh3cSlaQueMode,
       "hh3cSlaQueWeight": hh3cSlaQueWeight,
       "hh3cSlaQueFixPktSize": hh3cSlaQueFixPktSize,
       "hh3cSlaQueFixBandwidth": hh3cSlaQueFixBandwidth,
       "hh3cSlaQueGuaBandwidth": hh3cSlaQueGuaBandwidth,
       "hh3cSlaQueBstBandwidth": hh3cSlaQueBstBandwidth,
       "hh3cSlaQueRowStatus": hh3cSlaQueRowStatus,
       "hh3cOnuPoeTable": hh3cOnuPoeTable,
       "hh3cOnuPoeEntry": hh3cOnuPoeEntry,
       "hh3cOnuPoeEnable": hh3cOnuPoeEnable,
       "hh3cOnuPoeMode": hh3cOnuPoeMode,
       "hh3cOnuPoeMaxPowerClass": hh3cOnuPoeMaxPowerClass,
       "hh3cOnuPoeMaxPowerValue": hh3cOnuPoeMaxPowerValue,
       "hh3cOnuPoeLegacyEnable": hh3cOnuPoeLegacyEnable,
       ...
       "hh3cEponBatchOpBySlotBindType": hh3cEponBatchOpBySlotBindType,
       ...
       "hh3cOnuUpdateByTypeProtType": hh3cOnuUpdateByTypeProtType,
       "hh3cOnuUpdateByTypeStartTime": hh3cOnuUpdateByTypeStartTime,
       "hh3cOnuUpdateByTypeDuration": hh3cOnuUpdateByTypeDuration,
       ...
       "hh3cEponOnuRegSilentBindType": hh3cEponOnuRegSilentBindType,
       "hh3cEponOnuRegSilentLoid": hh3cEponOnuRegSilentLoid,
       "hh3cEponOnuRegSilentLoidPwd": hh3cEponOnuRegSilentLoidPwd,
       "hh3cEponOnuRegErrorLoid": hh3cEponOnuRegErrorLoid,
       "hh3cEponOnuRegErrorLoidCode": hh3cEponOnuRegErrorLoidCode,
       ...
       "hh3cEponOnuRegLoidErrTrap": hh3cEponOnuRegLoidErrTrap,
       "hh3cEponOnuRegLoidErrRecTrap": hh3cEponOnuRegLoidErrRecTrap,
       "hh3cEponOnuSilenceLoidTrap": hh3cEponOnuSilenceLoidTrap,
       "hh3cEponOnuSilenceLoidRecTrap": hh3cEponOnuSilenceLoidRecTrap,
       "hh3cEponOnuUpdateLoidRetTrap": hh3cEponOnuUpdateLoidRetTrap,
       "hh3cEponOnuAutoBindLoidTrap": hh3cEponOnuAutoBindLoidTrap,
       "hh3cEponOnuPowerOnTrap": hh3cEponOnuPowerOnTrap,
       "hh3cEponOpticalSignalLosTrap": hh3cEponOpticalSignalLosTrap,
       "hh3cEponOpticalSignalLosRecoverTrap": hh3cEponOpticalSignalLosRecoverTrap,
       "hh3cEponOnuFiberFailTrap": hh3cEponOnuFiberFailTrap,
       "hh3cEponOnuFiberFailRecoverTrap": hh3cEponOnuFiberFailRecoverTrap,
       ...
       "hh3cEponRoltMan": hh3cEponRoltMan,
       "hh3cRoltInterfaceTable": hh3cRoltInterfaceTable,
       "hh3cRoltInterfaceEntry": hh3cRoltInterfaceEntry,
       "hh3cRoltInterfaceNumber": hh3cRoltInterfaceNumber,
       "hh3cRoltInterfaceIfIndex": hh3cRoltInterfaceIfIndex,
       "hh3cRoltInterfaceRowStatus": hh3cRoltInterfaceRowStatus,
       "hh3cRoltMemberTable": hh3cRoltMemberTable,
       "hh3cRoltMemberEntry": hh3cRoltMemberEntry,
       "hh3cRoltMemberOltIfindex": hh3cRoltMemberOltIfindex,
       "hh3cRoltMemberOltPriority": hh3cRoltMemberOltPriority,
       "hh3cRoltMemberRowStatus": hh3cRoltMemberRowStatus,
       "hh3cRoltMemberForwardStatus": hh3cRoltMemberForwardStatus}
)
