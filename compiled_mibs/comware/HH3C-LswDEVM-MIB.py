...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-LswDEVM-MIB
...
_Hh3cFlhLastDelTime_Type.__name__ = "TimeTicks"
...
_Hh3cDevMFanPosFrame_Type = Integer32
_Hh3cDevMFanPosFrame_Object = MibTableColumn
hh3cDevMFanPosFrame = _Hh3cDevMFanPosFrame_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 1, 1, 3),
    _Hh3cDevMFanPosFrame_Type()
)
hh3cDevMFanPosFrame.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDevMFanPosFrame.setStatus("current")
_Hh3cDevMFanPosSlot_Type = Integer32
_Hh3cDevMFanPosSlot_Object = MibTableColumn
hh3cDevMFanPosSlot = _Hh3cDevMFanPosSlot_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 1, 1, 4),
    _Hh3cDevMFanPosSlot_Type()
)
hh3cDevMFanPosSlot.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDevMFanPosSlot.setStatus("current")
_Hh3cDevMFanPosIndex_Type = Integer32
_Hh3cDevMFanPosIndex_Object = MibTableColumn
hh3cDevMFanPosIndex = _Hh3cDevMFanPosIndex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 1, 1, 5),
    _Hh3cDevMFanPosIndex_Type()
)
hh3cDevMFanPosIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDevMFanPosIndex.setStatus("current")
_Hh3cDevMFanMaxSpeed_Type = Integer32
_Hh3cDevMFanMaxSpeed_Object = MibTableColumn
hh3cDevMFanMaxSpeed = _Hh3cDevMFanMaxSpeed_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 1, 1, 6),
    _Hh3cDevMFanMaxSpeed_Type()
)
hh3cDevMFanMaxSpeed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDevMFanMaxSpeed.setStatus("current")
_Hh3cDevMFanCurrentSpeed_Type = Integer32
_Hh3cDevMFanCurrentSpeed_Object = MibTableColumn
hh3cDevMFanCurrentSpeed = _Hh3cDevMFanCurrentSpeed_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 1, 1, 7),
    _Hh3cDevMFanCurrentSpeed_Type()
)
hh3cDevMFanCurrentSpeed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDevMFanCurrentSpeed.setStatus("current")
...
_Hh3cDevMPowerEntIndex_Type = Integer32
_Hh3cDevMPowerEntIndex_Object = MibTableColumn
hh3cDevMPowerEntIndex = _Hh3cDevMPowerEntIndex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 2, 1, 3),
    _Hh3cDevMPowerEntIndex_Type()
)
hh3cDevMPowerEntIndex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDevMPowerEntIndex.setStatus("current")
_Hh3cDevMPowerRatedVoltage_Type = Integer32
_Hh3cDevMPowerRatedVoltage_Object = MibTableColumn
hh3cDevMPowerRatedVoltage = _Hh3cDevMPowerRatedVoltage_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 2, 1, 4),
    _Hh3cDevMPowerRatedVoltage_Type()
)
hh3cDevMPowerRatedVoltage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDevMPowerRatedVoltage.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDevMPowerRatedVoltage.setUnits("mV")
_Hh3cDevMPowerRatedCurrent_Type = Integer32
_Hh3cDevMPowerRatedCurrent_Object = MibTableColumn
hh3cDevMPowerRatedCurrent = _Hh3cDevMPowerRatedCurrent_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 2, 1, 5),
    _Hh3cDevMPowerRatedCurrent_Type()
)
hh3cDevMPowerRatedCurrent.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDevMPowerRatedCurrent.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDevMPowerRatedCurrent.setUnits("mA")
_Hh3cDevMPowerLoadFactor_Type = Integer32
_Hh3cDevMPowerLoadFactor_Object = MibTableColumn
hh3cDevMPowerLoadFactor = _Hh3cDevMPowerLoadFactor_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 2, 1, 6),
    _Hh3cDevMPowerLoadFactor_Type()
)
hh3cDevMPowerLoadFactor.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDevMPowerLoadFactor.setStatus("current")
_Hh3cDevMPowerUsedPower_Type = Integer32
_Hh3cDevMPowerUsedPower_Object = MibTableColumn
hh3cDevMPowerUsedPower = _Hh3cDevMPowerUsedPower_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 2, 1, 7),
    _Hh3cDevMPowerUsedPower_Type()
)
hh3cDevMPowerUsedPower.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDevMPowerUsedPower.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDevMPowerUsedPower.setUnits("mW")
_Hh3cDevMPowerRemainingPower_Type = Integer32
_Hh3cDevMPowerRemainingPower_Object = MibTableColumn
hh3cDevMPowerRemainingPower = _Hh3cDevMPowerRemainingPower_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 2, 1, 8),
    _Hh3cDevMPowerRemainingPower_Type()
)
hh3cDevMPowerRemainingPower.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDevMPowerRemainingPower.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDevMPowerRemainingPower.setUnits("mW")
...
_Hh3cDevMFirstTrapTime_Type = TimeTicks
_Hh3cDevMFirstTrapTime_Object = MibScalar
hh3cDevMFirstTrapTime = _Hh3cDevMFirstTrapTime_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 9, 1, 13),
    _Hh3cDevMFirstTrapTime_Type()
)
hh3cDevMFirstTrapTime.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cDevMFirstTrapTime.setStatus("current")
_Hh3cdevMExternalAlarmStatus_ObjectIdentity = ObjectIdentity
hh3cdevMExternalAlarmStatus = _Hh3cdevMExternalAlarmStatus_ObjectIdentity(
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cDevice": hh3cDevice,
       ...
       "hh3cDevMFanPosFrame": hh3cDevMFanPosFrame,
       "hh3cDevMFanPosSlot": hh3cDevMFanPosSlot,
       "hh3cDevMFanPosIndex": hh3cDevMFanPosIndex,
       "hh3cDevMFanMaxSpeed": hh3cDevMFanMaxSpeed,
       "hh3cDevMFanCurrentSpeed": hh3cDevMFanCurrentSpeed,
       ...
       "hh3cDevMPowerEntIndex": hh3cDevMPowerEntIndex,
       "hh3cDevMPowerRatedVoltage": hh3cDevMPowerRatedVoltage,
       "hh3cDevMPowerRatedCurrent": hh3cDevMPowerRatedCurrent,
       "hh3cDevMPowerLoadFactor": hh3cDevMPowerLoadFactor,
       "hh3cDevMPowerUsedPower": hh3cDevMPowerUsedPower,
       "hh3cDevMPowerRemainingPower": hh3cDevMPowerRemainingPower,
       ...
       "hh3cDevMFirstTrapTime": hh3cDevMFirstTrapTime,
       "hh3cdevMExternalAlarmStatus": hh3cdevMExternalAlarmStatus}
)
