...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-IP-ADDRESS-MIB
...
_Hh3cIpAddrFirstTrapTime_Type = TimeTicks
_Hh3cIpAddrFirstTrapTime_Object = MibScalar
hh3cIpAddrFirstTrapTime = _Hh3cIpAddrFirstTrapTime_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 67, 2, 1, 4),
    _Hh3cIpAddrFirstTrapTime_Type()
)
hh3cIpAddrFirstTrapTime.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cIpAddrFirstTrapTime.setStatus("current")
...
hh3cIpAddressChangeNotify.setObjects(
      *(("HH3C-IP-ADDRESS-MIB", "hh3cIpAddrNotifyIfIndex"),
        ...
        ("HH3C-IP-ADDRESS-MIB", "hh3cIpAddrFirstTrapTime"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cIpAddrMIB": hh3cIpAddrMIB,
       ...
       "hh3cIpAddrFirstTrapTime": hh3cIpAddrFirstTrapTime,
