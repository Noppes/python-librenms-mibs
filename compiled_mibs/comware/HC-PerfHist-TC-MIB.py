# SNMP MIB module (HC-PerfHist-TC-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\HC-PerfHist-TC-MIB
...
hcPerfHistTCMIB = ModuleIdentity(
    (1, 3, 6, 1, 2, 1, 107)
)
if mibBuilder.loadTexts:
    hcPerfHistTCMIB.setRevisions(
        ("2004-02-03 00:00",)
    )
...
mibBuilder.exportSymbols(
    ...
    **{"HCPerfValidIntervals": HCPerfValidIntervals,
       ...
       "hcPerfHistTCMIB": hcPerfHistTCMIB}
)
