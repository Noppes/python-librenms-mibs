...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-LswMSTP-MIB
...
_Hh3cdot1sStpStatus_Type.__name__ = "EnabledStatus"
...
_Hh3cdot1sMstMasterPathCost_Type.__name__ = "Integer32"
...
_Hh3cdot1sMstBpduGuard_Type.__name__ = "EnabledStatus"
...
_Hh3cdot1sMstAdminFormatSelector_Type.__name__ = "Integer32"
...
_Hh3cdot1sMstOperFormatSelector_Type.__name__ = "Integer32"
...
class _Hh3cdot1sMstiPortIndex_Type(Integer32):
    """Custom type hh3cdot1sMstiPortIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Hh3cdot1sMstiPortIndex_Type.__name__ = "Integer32"
...
_Hh3cdot1sMstiStpPortEdgeport_Type.__name__ = "EnabledStatus"
...
_Hh3cdot1sMstiStpStatus_Type.__name__ = "EnabledStatus"
...
_Hh3cdot1sMstiPortRootGuard_Type.__name__ = "EnabledStatus"
...
_Hh3cdot1sMstiPortLoopGuard_Type.__name__ = "EnabledStatus"
...
class _Hh3cdot1sMstiStpPortRoleRestriction_Type(EnabledStatus):
    """Custom type hh3cdot1sMstiStpPortRoleRestriction based on EnabledStatus"""
    defaultValue = 2


_Hh3cdot1sMstiStpPortRoleRestriction_Type.__name__ = "EnabledStatus"
_Hh3cdot1sMstiStpPortRoleRestriction_Object = MibTableColumn
hh3cdot1sMstiStpPortRoleRestriction = _Hh3cdot1sMstiStpPortRoleRestriction_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 14, 20, 1, 32),
    _Hh3cdot1sMstiStpPortRoleRestriction_Type()
)
hh3cdot1sMstiStpPortRoleRestriction.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cdot1sMstiStpPortRoleRestriction.setStatus("current")


class _Hh3cdot1sMstiStpPortTcRestriction_Type(EnabledStatus):
    """Custom type hh3cdot1sMstiStpPortTcRestriction based on EnabledStatus"""
    defaultValue = 2


_Hh3cdot1sMstiStpPortTcRestriction_Type.__name__ = "EnabledStatus"
_Hh3cdot1sMstiStpPortTcRestriction_Object = MibTableColumn
hh3cdot1sMstiStpPortTcRestriction = _Hh3cdot1sMstiStpPortTcRestriction_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 14, 20, 1, 33),
    _Hh3cdot1sMstiStpPortTcRestriction_Type()
)
hh3cdot1sMstiStpPortTcRestriction.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cdot1sMstiStpPortTcRestriction.setStatus("current")
_Hh3cdot1sMstiStpPortDisputed_Type = TruthValue
_Hh3cdot1sMstiStpPortDisputed_Object = MibTableColumn
hh3cdot1sMstiStpPortDisputed = _Hh3cdot1sMstiStpPortDisputed_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 14, 20, 1, 34),
    _Hh3cdot1sMstiStpPortDisputed_Type()
)
hh3cdot1sMstiStpPortDisputed.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cdot1sMstiStpPortDisputed.setStatus("current")


class _Hh3cdot1sMstiPortLoopbackGuard_Type(EnabledStatus):
    """Custom type hh3cdot1sMstiPortLoopbackGuard based on EnabledStatus"""
    defaultValue = 1


_Hh3cdot1sMstiPortLoopbackGuard_Type.__name__ = "EnabledStatus"
_Hh3cdot1sMstiPortLoopbackGuard_Object = MibTableColumn
hh3cdot1sMstiPortLoopbackGuard = _Hh3cdot1sMstiPortLoopbackGuard_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 14, 20, 1, 35),
    _Hh3cdot1sMstiPortLoopbackGuard_Type()
)
hh3cdot1sMstiPortLoopbackGuard.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cdot1sMstiPortLoopbackGuard.setStatus("current")
...
hh3cPortMstiBpduGuarded.setObjects(
      *(("BRIDGE-MIB", "dot1dStpPort"),
        ("HH3C-LswMSTP-MIB", "hh3cdot1sMstiDesignatedBridge"))
)
if mibBuilder.loadTexts:
...
hh3cMstiNewRoot = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 14, 0, 7)
)
hh3cMstiNewRoot.setObjects(
      *(("HH3C-LswMSTP-MIB", "hh3cdot1sInstanceID"),
        ("HH3C-LswMSTP-MIB", "hh3cdot1sMstiDesignedRoot"),
        ("HH3C-LswMSTP-MIB", "hh3cdot1sMstiDesignedRoot"))
)
if mibBuilder.loadTexts:
    hh3cMstiNewRoot.setStatus(
        "current"
    )

hh3cPortPvstBpduProtection = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 8, 35, 14, 0, 8)
)
hh3cPortPvstBpduProtection.setObjects(
      *(("BRIDGE-MIB", "dot1dStpPort"),
        ("HH3C-LswMSTP-MIB", "hh3cdot1sMstiDesignatedBridge"))
)
if mibBuilder.loadTexts:
    hh3cPortPvstBpduProtection.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"EnabledStatus": EnabledStatus,
       ...
       "hh3cMstiNewRoot": hh3cMstiNewRoot,
       "hh3cPortPvstBpduProtection": hh3cPortPvstBpduProtection,
       ...
       "hh3cdot1sMstiStpPortRoleRestriction": hh3cdot1sMstiStpPortRoleRestriction,
       "hh3cdot1sMstiStpPortTcRestriction": hh3cdot1sMstiStpPortTcRestriction,
       "hh3cdot1sMstiStpPortDisputed": hh3cdot1sMstiStpPortDisputed,
       "hh3cdot1sMstiPortLoopbackGuard": hh3cdot1sMstiPortLoopbackGuard,
