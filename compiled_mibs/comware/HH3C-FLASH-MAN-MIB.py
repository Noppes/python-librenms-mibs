...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-FLASH-MAN-MIB
...
if mibBuilder.loadTexts:
    hh3cFlhSize.setStatus("deprecated")
if mibBuilder.loadTexts:
...
_Hh3cFlhHCSize_Type = CounterBasedGauge64
_Hh3cFlhHCSize_Object = MibTableColumn
hh3cFlhHCSize = _Hh3cFlhHCSize_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 5, 1, 1, 2, 1, 16),
    _Hh3cFlhHCSize_Type()
)
hh3cFlhHCSize.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cFlhHCSize.setStatus("current")
if mibBuilder.loadTexts:
    hh3cFlhHCSize.setUnits("bytes")
...
if mibBuilder.loadTexts:
    hh3cFlhPartSpace.setStatus("deprecated")
if mibBuilder.loadTexts:
...
if mibBuilder.loadTexts:
    hh3cFlhPartSpaceFree.setStatus("deprecated")
if mibBuilder.loadTexts:
...
_Hh3cFlhPartBootable_Type = TruthValue
_Hh3cFlhPartBootable_Object = MibTableColumn
hh3cFlhPartBootable = _Hh3cFlhPartBootable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 5, 1, 1, 4, 1, 1, 13),
    _Hh3cFlhPartBootable_Type()
)
hh3cFlhPartBootable.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cFlhPartBootable.setStatus("current")
_Hh3cFlhPartPathForGlobalOpt_Type = TruthValue
_Hh3cFlhPartPathForGlobalOpt_Object = MibTableColumn
hh3cFlhPartPathForGlobalOpt = _Hh3cFlhPartPathForGlobalOpt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 5, 1, 1, 4, 1, 1, 14),
    _Hh3cFlhPartPathForGlobalOpt_Type()
)
hh3cFlhPartPathForGlobalOpt.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cFlhPartPathForGlobalOpt.setStatus("current")
_Hh3cFlhPartHCSpace_Type = CounterBasedGauge64
_Hh3cFlhPartHCSpace_Object = MibTableColumn
hh3cFlhPartHCSpace = _Hh3cFlhPartHCSpace_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 5, 1, 1, 4, 1, 1, 15),
    _Hh3cFlhPartHCSpace_Type()
)
hh3cFlhPartHCSpace.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cFlhPartHCSpace.setStatus("current")
if mibBuilder.loadTexts:
    hh3cFlhPartHCSpace.setUnits("bytes")
_Hh3cFlhPartHCSpaceFree_Type = CounterBasedGauge64
_Hh3cFlhPartHCSpaceFree_Object = MibTableColumn
hh3cFlhPartHCSpaceFree = _Hh3cFlhPartHCSpaceFree_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 5, 1, 1, 4, 1, 1, 16),
    _Hh3cFlhPartHCSpaceFree_Type()
)
hh3cFlhPartHCSpaceFree.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cFlhPartHCSpaceFree.setStatus("current")
if mibBuilder.loadTexts:
    hh3cFlhPartHCSpaceFree.setUnits("bytes")
...
if mibBuilder.loadTexts:
    hh3cFlhFileSize.setStatus("deprecated")
...
_Hh3cFlhFileHCSize_Type = CounterBasedGauge64
_Hh3cFlhFileHCSize_Object = MibTableColumn
hh3cFlhFileHCSize = _Hh3cFlhFileHCSize_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 5, 1, 1, 4, 2, 1, 1, 6),
    _Hh3cFlhFileHCSize_Type()
)
hh3cFlhFileHCSize.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cFlhFileHCSize.setStatus("current")
if mibBuilder.loadTexts:
    hh3cFlhFileHCSize.setUnits("bytes")


class _Hh3cFlhFileType_Type(Integer32):
    """Custom type hh3cFlhFileType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hh3cFlhFileType_Type.__name__ = "Integer32"
_Hh3cFlhFileType_Object = MibTableColumn
hh3cFlhFileType = _Hh3cFlhFileType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 5, 1, 1, 4, 2, 1, 1, 7),
    _Hh3cFlhFileType_Type()
)
hh3cFlhFileType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cFlhFileType.setStatus("current")
...
_Hh3cFlhOperServerAddress_Type.__name__ = "IpAddress"
...
if mibBuilder.loadTexts:
    hh3cFlhOperServerAddress.setStatus("deprecated")
...
_Hh3cFlhOperEndNotification_Type.__name__ = "TruthValue"
...
_Hh3cFlhOperSrvAddrType_Type = InetAddressType
_Hh3cFlhOperSrvAddrType_Object = MibTableColumn
hh3cFlhOperSrvAddrType = _Hh3cFlhOperSrvAddrType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 5, 1, 2, 1, 1, 15),
    _Hh3cFlhOperSrvAddrType_Type()
)
hh3cFlhOperSrvAddrType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cFlhOperSrvAddrType.setStatus("current")
_Hh3cFlhOperSrvAddrRev_Type = InetAddress
_Hh3cFlhOperSrvAddrRev_Object = MibTableColumn
hh3cFlhOperSrvAddrRev = _Hh3cFlhOperSrvAddrRev_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 5, 1, 2, 1, 1, 16),
    _Hh3cFlhOperSrvAddrRev_Type()
)
hh3cFlhOperSrvAddrRev.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cFlhOperSrvAddrRev.setStatus("current")
_Hh3cFlhOperSrvVPNName_Type = DisplayString
_Hh3cFlhOperSrvVPNName_Object = MibTableColumn
hh3cFlhOperSrvVPNName = _Hh3cFlhOperSrvVPNName_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 5, 1, 2, 1, 1, 17),
    _Hh3cFlhOperSrvVPNName_Type()
)
hh3cFlhOperSrvVPNName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cFlhOperSrvVPNName.setStatus("current")
...
hh3cFlhPartitionGroup.setObjects(
      *(("HH3C-FLASH-MAN-MIB", "hh3cFlhPartFirstChip"),
        ...
        ("HH3C-FLASH-MAN-MIB", "hh3cFlhPartBootable"),
        ("HH3C-FLASH-MAN-MIB", "hh3cFlhPartPathForGlobalOpt"))
)
if mibBuilder.loadTexts:
...
hh3cFlhMIBCompliance.setObjects(
      *(("HH3C-FLASH-MAN-MIB", "hh3cFlhGroup"),
        ("HH3C-FLASH-MAN-MIB", "hh3cFlhPartitionGroup"),
        ("HH3C-FLASH-MAN-MIB", "hh3cFlhFileGroup"),
        ("HH3C-FLASH-MAN-MIB", "hh3cFlhOperationGroup"),
        ("HH3C-FLASH-MAN-MIB", "hh3cFlhNotificationGroup"),
        ("HH3C-FLASH-MAN-MIB", "hh3cFlhChipGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"Hh3cFlashOperationStatus": Hh3cFlashOperationStatus,
       ...
       "hh3cFlhPartBootable": hh3cFlhPartBootable,
       "hh3cFlhPartPathForGlobalOpt": hh3cFlhPartPathForGlobalOpt,
       "hh3cFlhPartHCSpace": hh3cFlhPartHCSpace,
       "hh3cFlhPartHCSpaceFree": hh3cFlhPartHCSpaceFree,
       ...
       "hh3cFlhFileHCSize": hh3cFlhFileHCSize,
       "hh3cFlhFileType": hh3cFlhFileType,
       ...
       "hh3cFlhOperSrvAddrType": hh3cFlhOperSrvAddrType,
       "hh3cFlhOperSrvAddrRev": hh3cFlhOperSrvAddrRev,
       "hh3cFlhOperSrvVPNName": hh3cFlhOperSrvVPNName,
