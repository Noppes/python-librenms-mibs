...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-DOT11-RRM-MIB
...
_Hh3cDot11RRM11gProtect_Type.__name__ = "TruthValue"
...
_Hh3cDot11RRM11aPwrConstrt_Type.__name__ = "Integer32"
...
_Hh3cDot11RRM11aSpectrumManag_Type.__name__ = "TruthValue"
...
_Hh3cDot11RRMAutoChlAvoid11h_Type.__name__ = "TruthValue"
...
_Hh3cDot11APInterfNumThreshhd_Type.__name__ = "Integer32"
...
_Hh3cDot11StaInterfNumThreshhd_Type.__name__ = "Integer32"
...
class _Hh3cDot11RRM11nMultiCastMcs_Type(Unsigned32):
    """Custom type hh3cDot11RRM11nMultiCastMcs based on Unsigned32"""
...
_Hh3cDot11RRM11nMultiCastMcs_Type.__name__ = "Unsigned32"
_Hh3cDot11RRM11nMultiCastMcs_Object = MibScalar
hh3cDot11RRM11nMultiCastMcs = _Hh3cDot11RRM11nMultiCastMcs_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 1, 1, 11),
    _Hh3cDot11RRM11nMultiCastMcs_Type()
)
hh3cDot11RRM11nMultiCastMcs.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cDot11RRM11nMultiCastMcs.setStatus("current")


class _Hh3cDot11RRM11acMadtMaxNss_Type(Integer32):
    """Custom type hh3cDot11RRM11acMadtMaxNss based on Integer32"""
    defaultValue = 0
...
_Hh3cDot11RRM11acMadtMaxNss_Type.__name__ = "Integer32"
_Hh3cDot11RRM11acMadtMaxNss_Object = MibScalar
hh3cDot11RRM11acMadtMaxNss = _Hh3cDot11RRM11acMadtMaxNss_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 1, 1, 12),
    _Hh3cDot11RRM11acMadtMaxNss_Type()
)
hh3cDot11RRM11acMadtMaxNss.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cDot11RRM11acMadtMaxNss.setStatus("current")


class _Hh3cDot11RRM11acSuptMaxNss_Type(Integer32):
    """Custom type hh3cDot11RRM11acSuptMaxNss based on Integer32"""
    defaultValue = 8
...
_Hh3cDot11RRM11acSuptMaxNss_Type.__name__ = "Integer32"
_Hh3cDot11RRM11acSuptMaxNss_Object = MibScalar
hh3cDot11RRM11acSuptMaxNss = _Hh3cDot11RRM11acSuptMaxNss_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 1, 1, 13),
    _Hh3cDot11RRM11acSuptMaxNss_Type()
)
hh3cDot11RRM11acSuptMaxNss.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cDot11RRM11acSuptMaxNss.setStatus("current")


class _Hh3cDot11RRM11acMultiCastNss_Type(Integer32):
    """Custom type hh3cDot11RRM11acMultiCastNss based on Integer32"""
    defaultValue = 0
...
_Hh3cDot11RRM11acMultiCastNss_Type.__name__ = "Integer32"
_Hh3cDot11RRM11acMultiCastNss_Object = MibScalar
hh3cDot11RRM11acMultiCastNss = _Hh3cDot11RRM11acMultiCastNss_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 1, 1, 14),
    _Hh3cDot11RRM11acMultiCastNss_Type()
)
hh3cDot11RRM11acMultiCastNss.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cDot11RRM11acMultiCastNss.setStatus("current")


class _Hh3cDot11RRM11acMultiCastVhtMcs_Type(Integer32):
    """Custom type hh3cDot11RRM11acMultiCastVhtMcs based on Integer32"""
    defaultValue = 255
...
_Hh3cDot11RRM11acMultiCastVhtMcs_Type.__name__ = "Integer32"
_Hh3cDot11RRM11acMultiCastVhtMcs_Object = MibScalar
hh3cDot11RRM11acMultiCastVhtMcs = _Hh3cDot11RRM11acMultiCastVhtMcs_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 1, 1, 15),
    _Hh3cDot11RRM11acMultiCastVhtMcs_Type()
)
hh3cDot11RRM11acMultiCastVhtMcs.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cDot11RRM11acMultiCastVhtMcs.setStatus("current")
...
_Hh3cDot11RRMCfgChlState_Type.__name__ = "TruthValue"
...
_Hh3cDot11RRMChlProntoRadioElmt_Type.__name__ = "Unsigned32"
...
_Hh3cDot11RRMCfgPwrState_Type.__name__ = "TruthValue"
...
_Hh3cDot11RRMPwrProntoRadioElmt_Type.__name__ = "Unsigned32"
...
_Hh3cDot11RRMCfgIntrvl_Type.__name__ = "Integer32"
...
_Hh3cDot11RrmNbrSNR_Type = Integer32
_Hh3cDot11RrmNbrSNR_Object = MibTableColumn
hh3cDot11RrmNbrSNR = _Hh3cDot11RrmNbrSNR_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 2, 2, 1, 7),
    _Hh3cDot11RrmNbrSNR_Type()
)
hh3cDot11RrmNbrSNR.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11RrmNbrSNR.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDot11RrmNbrSNR.setUnits("dB")
_Hh3cDot11RrmNbrNF_Type = Integer32
_Hh3cDot11RrmNbrNF_Object = MibTableColumn
hh3cDot11RrmNbrNF = _Hh3cDot11RrmNbrNF_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 2, 2, 1, 8),
    _Hh3cDot11RrmNbrNF_Type()
)
hh3cDot11RrmNbrNF.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11RrmNbrNF.setStatus("current")
if mibBuilder.loadTexts:
    hh3cDot11RrmNbrNF.setUnits("dBm")
...
_Hh3cDot11RRMRadioNbrInfoTable_Object = MibTable
hh3cDot11RRMRadioNbrInfoTable = _Hh3cDot11RRMRadioNbrInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 2, 4)
)
if mibBuilder.loadTexts:
    hh3cDot11RRMRadioNbrInfoTable.setStatus("current")
_Hh3cDot11RRMRadioNbrInfoEntry_Object = MibTableRow
hh3cDot11RRMRadioNbrInfoEntry = _Hh3cDot11RRMRadioNbrInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 2, 4, 1)
)
hh3cDot11RRMRadioNbrInfoEntry.setIndexNames(
    (0, "HH3C-DOT11-RRM-MIB", "hh3cDot11RRMRadioNbrAPID"),
    (0, "HH3C-DOT11-RRM-MIB", "hh3cDot11RRMRadioNbrRadioID"),
)
if mibBuilder.loadTexts:
    hh3cDot11RRMRadioNbrInfoEntry.setStatus("current")
_Hh3cDot11RRMRadioNbrAPID_Type = Hh3cDot11ObjectIDType
_Hh3cDot11RRMRadioNbrAPID_Object = MibTableColumn
hh3cDot11RRMRadioNbrAPID = _Hh3cDot11RRMRadioNbrAPID_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 2, 4, 1, 1),
    _Hh3cDot11RRMRadioNbrAPID_Type()
)
hh3cDot11RRMRadioNbrAPID.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cDot11RRMRadioNbrAPID.setStatus("current")
_Hh3cDot11RRMRadioNbrRadioID_Type = Hh3cDot11RadioScopeType
_Hh3cDot11RRMRadioNbrRadioID_Object = MibTableColumn
hh3cDot11RRMRadioNbrRadioID = _Hh3cDot11RRMRadioNbrRadioID_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 2, 4, 1, 2),
    _Hh3cDot11RRMRadioNbrRadioID_Type()
)
hh3cDot11RRMRadioNbrRadioID.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cDot11RRMRadioNbrRadioID.setStatus("current")
_Hh3cDot11RRMRadioNbrSSID_Type = OctetString
_Hh3cDot11RRMRadioNbrSSID_Object = MibTableColumn
hh3cDot11RRMRadioNbrSSID = _Hh3cDot11RRMRadioNbrSSID_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 8, 2, 4, 1, 3),
    _Hh3cDot11RRMRadioNbrSSID_Type()
)
hh3cDot11RRMRadioNbrSSID.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11RRMRadioNbrSSID.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cDot11RRM": hh3cDot11RRM,
       ...
       "hh3cDot11RRM11nMultiCastMcs": hh3cDot11RRM11nMultiCastMcs,
       "hh3cDot11RRM11acMadtMaxNss": hh3cDot11RRM11acMadtMaxNss,
       "hh3cDot11RRM11acSuptMaxNss": hh3cDot11RRM11acSuptMaxNss,
       "hh3cDot11RRM11acMultiCastNss": hh3cDot11RRM11acMultiCastNss,
       "hh3cDot11RRM11acMultiCastVhtMcs": hh3cDot11RRM11acMultiCastVhtMcs,
       ...
       "hh3cDot11RrmNbrSNR": hh3cDot11RrmNbrSNR,
       "hh3cDot11RrmNbrNF": hh3cDot11RrmNbrNF,
       ...
       "hh3cDot11RRMRadioNbrInfoTable": hh3cDot11RRMRadioNbrInfoTable,
       "hh3cDot11RRMRadioNbrInfoEntry": hh3cDot11RRMRadioNbrInfoEntry,
       "hh3cDot11RRMRadioNbrAPID": hh3cDot11RRMRadioNbrAPID,
       "hh3cDot11RRMRadioNbrRadioID": hh3cDot11RRMRadioNbrRadioID,
       "hh3cDot11RRMRadioNbrSSID": hh3cDot11RRMRadioNbrSSID,
