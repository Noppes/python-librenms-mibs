...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-IKE-MONITOR-MIB
...
hh3cIKETunIndex.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
class _Hh3cIKETunLocalValue1_Type(DisplayString):
    """Custom type hh3cIKETunLocalValue1 based on DisplayString"""
...
_Hh3cIKETunLocalValue1_Type.__name__ = "DisplayString"
...
if mibBuilder.loadTexts:
    hh3cIKETunLocalValue1.setStatus("deprecated")


class _Hh3cIKETunLocalValue2_Type(DisplayString):
    """Custom type hh3cIKETunLocalValue2 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_Hh3cIKETunLocalValue2_Type.__name__ = "DisplayString"
...
if mibBuilder.loadTexts:
    hh3cIKETunLocalAddr.setStatus("deprecated")
...
class _Hh3cIKETunRemoteValue1_Type(DisplayString):
    """Custom type hh3cIKETunRemoteValue1 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_Hh3cIKETunRemoteValue1_Type.__name__ = "DisplayString"
...
if mibBuilder.loadTexts:
    hh3cIKETunRemoteValue1.setStatus("deprecated")


class _Hh3cIKETunRemoteValue2_Type(DisplayString):
    """Custom type hh3cIKETunRemoteValue2 based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_Hh3cIKETunRemoteValue2_Type.__name__ = "DisplayString"
...
if mibBuilder.loadTexts:
    hh3cIKETunRemoteAddr.setStatus("deprecated")
...
_Hh3cIKETunDpdIntervalTime_Type.__name__ = "Integer32"
...
_Hh3cIKETunDpdTimeOut_Type.__name__ = "Integer32"
...
_Hh3cIKETunLocalInetAddrType_Type = InetAddressType
_Hh3cIKETunLocalInetAddrType_Object = MibTableColumn
hh3cIKETunLocalInetAddrType = _Hh3cIKETunLocalInetAddrType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 30, 1, 1, 1, 23),
    _Hh3cIKETunLocalInetAddrType_Type()
)
hh3cIKETunLocalInetAddrType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIKETunLocalInetAddrType.setStatus("current")
_Hh3cIKETunLocalInetAddr_Type = InetAddress
_Hh3cIKETunLocalInetAddr_Object = MibTableColumn
hh3cIKETunLocalInetAddr = _Hh3cIKETunLocalInetAddr_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 30, 1, 1, 1, 24),
    _Hh3cIKETunLocalInetAddr_Type()
)
hh3cIKETunLocalInetAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIKETunLocalInetAddr.setStatus("current")
_Hh3cIKETunRemoteInetAddrType_Type = InetAddressType
_Hh3cIKETunRemoteInetAddrType_Object = MibTableColumn
hh3cIKETunRemoteInetAddrType = _Hh3cIKETunRemoteInetAddrType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 30, 1, 1, 1, 25),
    _Hh3cIKETunRemoteInetAddrType_Type()
)
hh3cIKETunRemoteInetAddrType.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIKETunRemoteInetAddrType.setStatus("current")
_Hh3cIKETunRemoteInetAddr_Type = InetAddress
_Hh3cIKETunRemoteInetAddr_Object = MibTableColumn
hh3cIKETunRemoteInetAddr = _Hh3cIKETunRemoteInetAddr_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 30, 1, 1, 1, 26),
    _Hh3cIKETunRemoteInetAddr_Type()
)
hh3cIKETunRemoteInetAddr.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIKETunRemoteInetAddr.setStatus("current")


class _Hh3cIKETunLocalValue3_Type(OctetString):
    """Custom type hh3cIKETunLocalValue3 based on OctetString"""
...
_Hh3cIKETunLocalValue3_Type.__name__ = "OctetString"
_Hh3cIKETunLocalValue3_Object = MibTableColumn
hh3cIKETunLocalValue3 = _Hh3cIKETunLocalValue3_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 30, 1, 1, 1, 27),
    _Hh3cIKETunLocalValue3_Type()
)
hh3cIKETunLocalValue3.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIKETunLocalValue3.setStatus("current")


class _Hh3cIKETunRemoteValue3_Type(OctetString):
    """Custom type hh3cIKETunRemoteValue3 based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 2047),
    )
...
_Hh3cIKETunRemoteValue3_Type.__name__ = "OctetString"
_Hh3cIKETunRemoteValue3_Object = MibTableColumn
hh3cIKETunRemoteValue3 = _Hh3cIKETunRemoteValue3_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 30, 1, 1, 1, 28),
    _Hh3cIKETunRemoteValue3_Type()
)
hh3cIKETunRemoteValue3.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIKETunRemoteValue3.setStatus("current")
...
class _Hh3cIKEIdInformation_Type(DisplayString):
    """Custom type hh3cIKEIdInformation based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_Hh3cIKEIdInformation_Type.__name__ = "DisplayString"
...
class _Hh3cIKECertInformation_Type(DisplayString):
    """Custom type hh3cIKECertInformation based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_Hh3cIKECertInformation_Type.__name__ = "DisplayString"
...
_Hh3cIKEScalarObjects_ObjectIdentity = ObjectIdentity
hh3cIKEScalarObjects = _Hh3cIKEScalarObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 30, 1, 7)
)


class _Hh3cIKEMIBVersion_Type(DisplayString):
    """Custom type hh3cIKEMIBVersion based on DisplayString"""
    subtypeSpec = DisplayString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(0, 255),
    )
...
_Hh3cIKEMIBVersion_Type.__name__ = "DisplayString"
_Hh3cIKEMIBVersion_Object = MibScalar
hh3cIKEMIBVersion = _Hh3cIKEMIBVersion_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 30, 1, 7, 1),
    _Hh3cIKEMIBVersion_Type()
)
hh3cIKEMIBVersion.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIKEMIBVersion.setStatus("current")
...
hh3cIKETunnelTableGroup.setObjects(
      *(("HH3C-IKE-MONITOR-MIB", "hh3cIKETunLocalType"),
        ...
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunLocalInetAddrType"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunLocalInetAddr"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunRemoteInetAddrType"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunRemoteInetAddr"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunLocalValue3"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunRemoteValue3"))
)
if mibBuilder.loadTexts:
...
hh3cIKEScalarObjectsGroup = ObjectGroup(
    (1, 3, 6, 1, 4, 1, 25506, 2, 30, 2, 2, 7)
)
hh3cIKEScalarObjectsGroup.setObjects(
    ("HH3C-IKE-MONITOR-MIB", "hh3cIKEMIBVersion")
)
if mibBuilder.loadTexts:
    hh3cIKEScalarObjectsGroup.setStatus("current")
...
hh3cIKETunnelStart.setObjects(
      *(("HH3C-IKE-MONITOR-MIB", "hh3cIKETunLocalAddr"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunRemoteAddr"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunLifeTime"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunIndex"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunLocalInetAddrType"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunLocalInetAddr"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunRemoteInetAddrType"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunRemoteInetAddr"))
...
hh3cIKECompliance.setObjects(
      *(("HH3C-IKE-MONITOR-MIB", "hh3cIKETunnelTableGroup"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKETunnelStatTableGroup"),
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKEGlobalStatsGroup"),
        ...
        ("HH3C-IKE-MONITOR-MIB", "hh3cIKEScalarObjectsGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"Hh3cIKENegoMode": Hh3cIKENegoMode,
       ...
       "hh3cIKETunLocalInetAddrType": hh3cIKETunLocalInetAddrType,
       "hh3cIKETunLocalInetAddr": hh3cIKETunLocalInetAddr,
       "hh3cIKETunRemoteInetAddrType": hh3cIKETunRemoteInetAddrType,
       "hh3cIKETunRemoteInetAddr": hh3cIKETunRemoteInetAddr,
       "hh3cIKETunLocalValue3": hh3cIKETunLocalValue3,
       "hh3cIKETunRemoteValue3": hh3cIKETunRemoteValue3,
       ...
       "hh3cIKEScalarObjects": hh3cIKEScalarObjects,
       "hh3cIKEMIBVersion": hh3cIKEMIBVersion,
       ...
       "hh3cIKEScalarObjectsGroup": hh3cIKEScalarObjectsGroup}
)
