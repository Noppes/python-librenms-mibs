...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-IPSEC-MONITOR-MIB
...
hh3cIPSecCompliance.setObjects(
      *(("HH3C-IPSEC-MONITOR-MIB", "hh3cIPSecTunnelTableGroup"),
        ("HH3C-IPSEC-MONITOR-MIB", "hh3cIPSecTunnelStatGroup"),
        ("HH3C-IPSEC-MONITOR-MIB", "hh3cIPSecSaGroup"),
        ("HH3C-IPSEC-MONITOR-MIB", "hh3cIPSecTrafficTableGroup"),
        ("HH3C-IPSEC-MONITOR-MIB", "hh3cIPSecGlobalStatsGroup"),
        ("HH3C-IPSEC-MONITOR-MIB", "hh3cIPSecTrapObjectGroup"),
        ("HH3C-IPSEC-MONITOR-MIB", "hh3cIPSecTrapCntlGroup"),
        ("HH3C-IPSEC-MONITOR-MIB", "hh3cIPSecTrapGroup"))
)
if mibBuilder.loadTexts:
