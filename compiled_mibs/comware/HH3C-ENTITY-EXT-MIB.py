...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-ENTITY-EXT-MIB
...
hh3cEntityExtSFPAlarmOnEx = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 6, 2, 0, 42)
)
hh3cEntityExtSFPAlarmOnEx.setObjects(
      *(("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtPhysicalIndex"),
        ("ENTITY-MIB", "entPhysicalName"),
        ("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtAdminStatus"),
        ("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtAlarmLight"),
...
if mibBuilder.loadTexts:
    hh3cEntityExtSFPAlarmOnEx.setStatus(
        "current"
    )

hh3cEntityExtSFPAlarmOffEx = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 6, 2, 0, 43)
)
hh3cEntityExtSFPAlarmOffEx.setObjects(
      *(("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtPhysicalIndex"),
        ("ENTITY-MIB", "entPhysicalName"),
        ("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtAdminStatus"),
        ("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtAlarmLight"),
...
if mibBuilder.loadTexts:
    hh3cEntityExtSFPAlarmOffEx.setStatus(
        "current"
    )
...
hh3cEntityExtNotificationGroup.setObjects(
      *(("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtTemperatureThresholdNotification"),
        ...
        ("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtSFPAlarmOnEx"),
        ("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtSFPAlarmOffEx"))
)
if mibBuilder.loadTexts:
...
hh3cEntityExtCompliance.setObjects(
      *(("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtGroup"),
        ("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtNotificationGroup"),
        ("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtManuGroup"),
        ("HH3C-ENTITY-EXT-MIB", "hh3cEntityExtPowerGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"Hh3cAdminState": Hh3cAdminState,
       ...
       "hh3cEntityExtSFPAlarmOnEx": hh3cEntityExtSFPAlarmOnEx,
       "hh3cEntityExtSFPAlarmOffEx": hh3cEntityExtSFPAlarmOffEx,
