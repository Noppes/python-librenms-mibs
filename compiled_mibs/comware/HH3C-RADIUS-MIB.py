...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-RADIUS-MIB
...
_Hh3cRdAcctOnSendTimes_Type.__name__ = "Integer32"
...
_Hh3cRdAcctOnSendInterval_Type.__name__ = "Integer32"
...
class _Hh3cRdAccRealTimeUnit_Type(Integer32):
    """Custom type hh3cRdAccRealTimeUnit based on Integer32"""
    defaultValue = 0
...
_Hh3cRdAccRealTimeUnit_Type.__name__ = "Integer32"
_Hh3cRdAccRealTimeUnit_Object = MibTableColumn
hh3cRdAccRealTimeUnit = _Hh3cRdAccRealTimeUnit_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 13, 1, 2, 1, 32),
    _Hh3cRdAccRealTimeUnit_Type()
)
hh3cRdAccRealTimeUnit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cRdAccRealTimeUnit.setStatus("current")
...
_Hh3cRadiusSchAuthPrimUdpPort_Type.__name__ = "Integer32"
...
_Hh3cRadiusSchAuthSecUdpPort_Type.__name__ = "Integer32"
...
_Hh3cRadiusSchAccPrimUdpPort_Type.__name__ = "Integer32"
...
_Hh3cRadiusSchAccSecUdpPort_Type.__name__ = "Integer32"
...
hh3cRadiusAuthenticationServerUpTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 13, 3, 0, 4)
)
hh3cRadiusAuthenticationServerUpTrap.setObjects(
      *(("RADIUS-AUTH-CLIENT-MIB", "radiusAuthServerAddress"),
        ("RADIUS-AUTH-CLIENT-MIB", "radiusAuthClientServerPortNumber"),
        ("HH3C-RADIUS-MIB", "hh3cRadiusServerFirstTrapTime"))
)
if mibBuilder.loadTexts:
    hh3cRadiusAuthenticationServerUpTrap.setStatus(
        "current"
    )

hh3cRadiusAccountingServerUpTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 13, 3, 0, 5)
)
hh3cRadiusAccountingServerUpTrap.setObjects(
      *(("RADIUS-ACC-CLIENT-MIB", "radiusAccServerAddress"),
        ("RADIUS-ACC-CLIENT-MIB", "radiusAccClientServerPortNumber"),
        ("HH3C-RADIUS-MIB", "hh3cRadiusServerFirstTrapTime"))
)
if mibBuilder.loadTexts:
    hh3cRadiusAccountingServerUpTrap.setStatus(
        "current"
    )

hh3cRadiusAuthenticationServerDownTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 13, 3, 0, 6)
)
hh3cRadiusAuthenticationServerDownTrap.setObjects(
      *(("RADIUS-AUTH-CLIENT-MIB", "radiusAuthServerAddress"),
        ("RADIUS-AUTH-CLIENT-MIB", "radiusAuthClientServerPortNumber"),
        ("HH3C-RADIUS-MIB", "hh3cRadiusServerFirstTrapTime"))
)
if mibBuilder.loadTexts:
    hh3cRadiusAuthenticationServerDownTrap.setStatus(
        "current"
    )

hh3cRadiusAccountingServerDownTrap = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 13, 3, 0, 7)
)
hh3cRadiusAccountingServerDownTrap.setObjects(
      *(("RADIUS-ACC-CLIENT-MIB", "radiusAccServerAddress"),
        ("RADIUS-ACC-CLIENT-MIB", "radiusAccClientServerPortNumber"),
        ("HH3C-RADIUS-MIB", "hh3cRadiusServerFirstTrapTime"))
)
if mibBuilder.loadTexts:
    hh3cRadiusAccountingServerDownTrap.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cRadius": hh3cRadius,
       ...
       "hh3cRdAccRealTimeUnit": hh3cRdAccRealTimeUnit,
       ...
       "hh3cRadiusAuthenticationServerUpTrap": hh3cRadiusAuthenticationServerUpTrap,
       "hh3cRadiusAccountingServerUpTrap": hh3cRadiusAccountingServerUpTrap,
       "hh3cRadiusAuthenticationServerDownTrap": hh3cRadiusAuthenticationServerDownTrap,
       "hh3cRadiusAccountingServerDownTrap": hh3cRadiusAccountingServerDownTrap,
