...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-PROTOCOL-VLAN-MIB
...
class _Hh3cProtocolVlanPortStatus_Type(Integer32):
    """Custom type hh3cProtocolVlanPortStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hh3cProtocolVlanPortStatus_Type.__name__ = "Integer32"
_Hh3cProtocolVlanPortStatus_Object = MibTableColumn
hh3cProtocolVlanPortStatus = _Hh3cProtocolVlanPortStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 16, 1, 6, 1, 8),
    _Hh3cProtocolVlanPortStatus_Type()
)
hh3cProtocolVlanPortStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cProtocolVlanPortStatus.setStatus("current")
...
hh3cProtocolVlanCompliance.setObjects(
      *(("HH3C-PROTOCOL-VLAN-MIB", "hh3cProtocolVlanOperateGroup"),
        ("HH3C-PROTOCOL-VLAN-MIB", "hh3cProtocolVlanProtocolGroup"),
        ("HH3C-PROTOCOL-VLAN-MIB", "hh3cProtocolVlanPortGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"Hh3cvProtocolVlanProtocolType": Hh3cvProtocolVlanProtocolType,
       ...
       "hh3cProtocolVlanPortStatus": hh3cProtocolVlanPortStatus,
