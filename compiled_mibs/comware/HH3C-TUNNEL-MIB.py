...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-TUNNEL-MIB
...
_Hh3cTunnelGreKeepaliveEnabled_Type.__name__ = "TruthValue"
...
_Hh3cTunnelDestinationTable_Object = MibTable
hh3cTunnelDestinationTable = _Hh3cTunnelDestinationTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 12)
)
if mibBuilder.loadTexts:
    hh3cTunnelDestinationTable.setStatus("current")
_Hh3cTunnelDestinationEntry_Object = MibTableRow
hh3cTunnelDestinationEntry = _Hh3cTunnelDestinationEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 12, 1)
)
hh3cTunnelDestinationEntry.setIndexNames(
    (0, "HH3C-TUNNEL-MIB", "hh3cTunnelDestinationDstAddr"),
    (0, "HH3C-TUNNEL-MIB", "hh3cTunnelDestinationDstType"),
    (0, "HH3C-TUNNEL-MIB", "hh3cTunnelDestinationTunNum"),
)
if mibBuilder.loadTexts:
    hh3cTunnelDestinationEntry.setStatus("current")
_Hh3cTunnelDestinationDstAddr_Type = InetAddress
_Hh3cTunnelDestinationDstAddr_Object = MibTableColumn
hh3cTunnelDestinationDstAddr = _Hh3cTunnelDestinationDstAddr_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 12, 1, 1),
    _Hh3cTunnelDestinationDstAddr_Type()
)
hh3cTunnelDestinationDstAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cTunnelDestinationDstAddr.setStatus("current")
_Hh3cTunnelDestinationDstType_Type = InetAddressType
_Hh3cTunnelDestinationDstType_Object = MibTableColumn
hh3cTunnelDestinationDstType = _Hh3cTunnelDestinationDstType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 12, 1, 2),
    _Hh3cTunnelDestinationDstType_Type()
)
hh3cTunnelDestinationDstType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cTunnelDestinationDstType.setStatus("current")


class _Hh3cTunnelDestinationTunNum_Type(Integer32):
    """Custom type hh3cTunnelDestinationTunNum based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Hh3cTunnelDestinationTunNum_Type.__name__ = "Integer32"
_Hh3cTunnelDestinationTunNum_Object = MibTableColumn
hh3cTunnelDestinationTunNum = _Hh3cTunnelDestinationTunNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 12, 1, 3),
    _Hh3cTunnelDestinationTunNum_Type()
)
hh3cTunnelDestinationTunNum.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cTunnelDestinationTunNum.setStatus("current")
_Hh3cTunnelDestinationTunIfindex_Type = InterfaceIndex
_Hh3cTunnelDestinationTunIfindex_Object = MibTableColumn
hh3cTunnelDestinationTunIfindex = _Hh3cTunnelDestinationTunIfindex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 12, 1, 4),
    _Hh3cTunnelDestinationTunIfindex_Type()
)
hh3cTunnelDestinationTunIfindex.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTunnelDestinationTunIfindex.setStatus("current")
_Hh3cTunnelGrep2mpStatsTable_Object = MibTable
hh3cTunnelGrep2mpStatsTable = _Hh3cTunnelGrep2mpStatsTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13)
)
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsTable.setStatus("current")
_Hh3cTunnelGrep2mpStatsEntry_Object = MibTableRow
hh3cTunnelGrep2mpStatsEntry = _Hh3cTunnelGrep2mpStatsEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1)
)
hh3cTunnelGrep2mpStatsEntry.setIndexNames(
    (0, "HH3C-TUNNEL-MIB", "hh3cTunnelGrep2mpStatsTunnelNo"),
    (0, "HH3C-TUNNEL-MIB", "hh3cTunnelGrep2mpStatsVrf"),
    (0, "HH3C-TUNNEL-MIB", "hh3cTunnelGrep2mpStatsVPCID"),
    (0, "HH3C-TUNNEL-MIB", "hh3cTunnelGrep2mpStatsBraAddr"),
    (0, "HH3C-TUNNEL-MIB", "hh3cTunnelGrep2mpStatsBraMask"),
    (0, "HH3C-TUNNEL-MIB", "hh3cTunnelGrep2mpStatsAddrType"),
    (0, "HH3C-TUNNEL-MIB", "hh3cTunnelGrep2mpStatsDestAddr"),
)
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsEntry.setStatus("current")
_Hh3cTunnelGrep2mpStatsTunnelNo_Type = Integer32
_Hh3cTunnelGrep2mpStatsTunnelNo_Object = MibTableColumn
hh3cTunnelGrep2mpStatsTunnelNo = _Hh3cTunnelGrep2mpStatsTunnelNo_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 1),
    _Hh3cTunnelGrep2mpStatsTunnelNo_Type()
)
hh3cTunnelGrep2mpStatsTunnelNo.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsTunnelNo.setStatus("current")
_Hh3cTunnelGrep2mpStatsVrf_Type = Integer32
_Hh3cTunnelGrep2mpStatsVrf_Object = MibTableColumn
hh3cTunnelGrep2mpStatsVrf = _Hh3cTunnelGrep2mpStatsVrf_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 2),
    _Hh3cTunnelGrep2mpStatsVrf_Type()
)
hh3cTunnelGrep2mpStatsVrf.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsVrf.setStatus("current")
_Hh3cTunnelGrep2mpStatsVPCID_Type = Integer32
_Hh3cTunnelGrep2mpStatsVPCID_Object = MibTableColumn
hh3cTunnelGrep2mpStatsVPCID = _Hh3cTunnelGrep2mpStatsVPCID_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 3),
    _Hh3cTunnelGrep2mpStatsVPCID_Type()
)
hh3cTunnelGrep2mpStatsVPCID.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsVPCID.setStatus("current")
_Hh3cTunnelGrep2mpStatsBraAddr_Type = InetAddress
_Hh3cTunnelGrep2mpStatsBraAddr_Object = MibTableColumn
hh3cTunnelGrep2mpStatsBraAddr = _Hh3cTunnelGrep2mpStatsBraAddr_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 4),
    _Hh3cTunnelGrep2mpStatsBraAddr_Type()
)
hh3cTunnelGrep2mpStatsBraAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsBraAddr.setStatus("current")
_Hh3cTunnelGrep2mpStatsBraMask_Type = InetAddress
_Hh3cTunnelGrep2mpStatsBraMask_Object = MibTableColumn
hh3cTunnelGrep2mpStatsBraMask = _Hh3cTunnelGrep2mpStatsBraMask_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 5),
    _Hh3cTunnelGrep2mpStatsBraMask_Type()
)
hh3cTunnelGrep2mpStatsBraMask.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsBraMask.setStatus("current")
_Hh3cTunnelGrep2mpStatsAddrType_Type = InetAddressType
_Hh3cTunnelGrep2mpStatsAddrType_Object = MibTableColumn
hh3cTunnelGrep2mpStatsAddrType = _Hh3cTunnelGrep2mpStatsAddrType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 6),
    _Hh3cTunnelGrep2mpStatsAddrType_Type()
)
hh3cTunnelGrep2mpStatsAddrType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsAddrType.setStatus("current")
_Hh3cTunnelGrep2mpStatsDestAddr_Type = InetAddressIPv4
_Hh3cTunnelGrep2mpStatsDestAddr_Object = MibTableColumn
hh3cTunnelGrep2mpStatsDestAddr = _Hh3cTunnelGrep2mpStatsDestAddr_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 7),
    _Hh3cTunnelGrep2mpStatsDestAddr_Type()
)
hh3cTunnelGrep2mpStatsDestAddr.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsDestAddr.setStatus("current")
_Hh3cTunnelGrep2mpStatsInPkts_Type = Counter64
_Hh3cTunnelGrep2mpStatsInPkts_Object = MibTableColumn
hh3cTunnelGrep2mpStatsInPkts = _Hh3cTunnelGrep2mpStatsInPkts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 8),
    _Hh3cTunnelGrep2mpStatsInPkts_Type()
)
hh3cTunnelGrep2mpStatsInPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsInPkts.setStatus("current")
_Hh3cTunnelGrep2mpStatsInOctets_Type = Counter64
_Hh3cTunnelGrep2mpStatsInOctets_Object = MibTableColumn
hh3cTunnelGrep2mpStatsInOctets = _Hh3cTunnelGrep2mpStatsInOctets_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 9),
    _Hh3cTunnelGrep2mpStatsInOctets_Type()
)
hh3cTunnelGrep2mpStatsInOctets.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsInOctets.setStatus("current")
_Hh3cTunnelGrep2mpStatsInDis_Type = Counter64
_Hh3cTunnelGrep2mpStatsInDis_Object = MibTableColumn
hh3cTunnelGrep2mpStatsInDis = _Hh3cTunnelGrep2mpStatsInDis_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 10),
    _Hh3cTunnelGrep2mpStatsInDis_Type()
)
hh3cTunnelGrep2mpStatsInDis.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsInDis.setStatus("current")
_Hh3cTunnelGrep2mpStatsOutPkts_Type = Counter64
_Hh3cTunnelGrep2mpStatsOutPkts_Object = MibTableColumn
hh3cTunnelGrep2mpStatsOutPkts = _Hh3cTunnelGrep2mpStatsOutPkts_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 11),
    _Hh3cTunnelGrep2mpStatsOutPkts_Type()
)
hh3cTunnelGrep2mpStatsOutPkts.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsOutPkts.setStatus("current")
_Hh3cTunnelGrep2mpStatsOutOctets_Type = Counter64
_Hh3cTunnelGrep2mpStatsOutOctets_Object = MibTableColumn
hh3cTunnelGrep2mpStatsOutOctets = _Hh3cTunnelGrep2mpStatsOutOctets_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 12),
    _Hh3cTunnelGrep2mpStatsOutOctets_Type()
)
hh3cTunnelGrep2mpStatsOutOctets.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsOutOctets.setStatus("current")
_Hh3cTunnelGrep2mpStatsOutDis_Type = Counter64
_Hh3cTunnelGrep2mpStatsOutDis_Object = MibTableColumn
hh3cTunnelGrep2mpStatsOutDis = _Hh3cTunnelGrep2mpStatsOutDis_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 53, 1, 1, 13, 1, 13),
    _Hh3cTunnelGrep2mpStatsOutDis_Type()
)
hh3cTunnelGrep2mpStatsOutDis.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cTunnelGrep2mpStatsOutDis.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"Hh3cTunnelType": Hh3cTunnelType,
       ...
       "hh3cTunnelDestinationTable": hh3cTunnelDestinationTable,
       "hh3cTunnelDestinationEntry": hh3cTunnelDestinationEntry,
       "hh3cTunnelDestinationDstAddr": hh3cTunnelDestinationDstAddr,
       "hh3cTunnelDestinationDstType": hh3cTunnelDestinationDstType,
       "hh3cTunnelDestinationTunNum": hh3cTunnelDestinationTunNum,
       "hh3cTunnelDestinationTunIfindex": hh3cTunnelDestinationTunIfindex,
       "hh3cTunnelGrep2mpStatsTable": hh3cTunnelGrep2mpStatsTable,
       "hh3cTunnelGrep2mpStatsEntry": hh3cTunnelGrep2mpStatsEntry,
       "hh3cTunnelGrep2mpStatsTunnelNo": hh3cTunnelGrep2mpStatsTunnelNo,
       "hh3cTunnelGrep2mpStatsVrf": hh3cTunnelGrep2mpStatsVrf,
       "hh3cTunnelGrep2mpStatsVPCID": hh3cTunnelGrep2mpStatsVPCID,
       "hh3cTunnelGrep2mpStatsBraAddr": hh3cTunnelGrep2mpStatsBraAddr,
       "hh3cTunnelGrep2mpStatsBraMask": hh3cTunnelGrep2mpStatsBraMask,
       "hh3cTunnelGrep2mpStatsAddrType": hh3cTunnelGrep2mpStatsAddrType,
       "hh3cTunnelGrep2mpStatsDestAddr": hh3cTunnelGrep2mpStatsDestAddr,
       "hh3cTunnelGrep2mpStatsInPkts": hh3cTunnelGrep2mpStatsInPkts,
       "hh3cTunnelGrep2mpStatsInOctets": hh3cTunnelGrep2mpStatsInOctets,
       "hh3cTunnelGrep2mpStatsInDis": hh3cTunnelGrep2mpStatsInDis,
       "hh3cTunnelGrep2mpStatsOutPkts": hh3cTunnelGrep2mpStatsOutPkts,
       "hh3cTunnelGrep2mpStatsOutOctets": hh3cTunnelGrep2mpStatsOutOctets,
       "hh3cTunnelGrep2mpStatsOutDis": hh3cTunnelGrep2mpStatsOutDis}
)
