...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-DHCP4-MIB
...
_Hh3cDhcpServer2Enabled_Type.__name__ = "TruthValue"
...
_Hh3cDhcpServer2AlwaysBroadcast_Type.__name__ = "TruthValue"
...
_Hh3cDhcpServer2IgnoreBootp_Type.__name__ = "TruthValue"
...
_Hh3cDhcpServer2BootpReplyRfc1048_Type.__name__ = "TruthValue"
...
_Hh3cDhcpServer2Opt82Enabled_Type.__name__ = "TruthValue"
...
class _Hh3cDhcpServer2AllocThreshold_Type(Unsigned32):
    """Custom type hh3cDhcpServer2AllocThreshold based on Unsigned32"""
    defaultValue = 0
...
_Hh3cDhcpServer2AllocThreshold_Type.__name__ = "Unsigned32"
_Hh3cDhcpServer2AllocThreshold_Object = MibScalar
hh3cDhcpServer2AllocThreshold = _Hh3cDhcpServer2AllocThreshold_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 1, 1, 8),
    _Hh3cDhcpServer2AllocThreshold_Type()
)
hh3cDhcpServer2AllocThreshold.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cDhcpServer2AllocThreshold.setStatus("current")
...
_Hh3cDhcpServer2ReqCnt_Type = Counter64
_Hh3cDhcpServer2ReqCnt_Object = MibScalar
hh3cDhcpServer2ReqCnt = _Hh3cDhcpServer2ReqCnt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 1, 2, 18),
    _Hh3cDhcpServer2ReqCnt_Type()
)
hh3cDhcpServer2ReqCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2ReqCnt.setStatus("current")
_Hh3cDhcpServer2ReqSuccCnt_Type = Counter64
_Hh3cDhcpServer2ReqSuccCnt_Object = MibScalar
hh3cDhcpServer2ReqSuccCnt = _Hh3cDhcpServer2ReqSuccCnt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 1, 2, 19),
    _Hh3cDhcpServer2ReqSuccCnt_Type()
)
hh3cDhcpServer2ReqSuccCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2ReqSuccCnt.setStatus("current")
_Hh3cDhcpServer2IPTotalNum_Type = Unsigned32
_Hh3cDhcpServer2IPTotalNum_Object = MibScalar
hh3cDhcpServer2IPTotalNum = _Hh3cDhcpServer2IPTotalNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 1, 2, 20),
    _Hh3cDhcpServer2IPTotalNum_Type()
)
hh3cDhcpServer2IPTotalNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2IPTotalNum.setStatus("current")
_Hh3cDhcpServer2IPUsedNum_Type = Unsigned32
_Hh3cDhcpServer2IPUsedNum_Object = MibScalar
hh3cDhcpServer2IPUsedNum = _Hh3cDhcpServer2IPUsedNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 1, 2, 21),
    _Hh3cDhcpServer2IPUsedNum_Type()
)
hh3cDhcpServer2IPUsedNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2IPUsedNum.setStatus("current")
_Hh3cDhcpServer2IPIdleNum_Type = Unsigned32
_Hh3cDhcpServer2IPIdleNum_Object = MibScalar
hh3cDhcpServer2IPIdleNum = _Hh3cDhcpServer2IPIdleNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 1, 2, 22),
    _Hh3cDhcpServer2IPIdleNum_Type()
)
hh3cDhcpServer2IPIdleNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2IPIdleNum.setStatus("current")
_Hh3cDhcpServer2IPExcludeTotalNum_Type = Unsigned32
_Hh3cDhcpServer2IPExcludeTotalNum_Object = MibScalar
hh3cDhcpServer2IPExcludeTotalNum = _Hh3cDhcpServer2IPExcludeTotalNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 1, 2, 23),
    _Hh3cDhcpServer2IPExcludeTotalNum_Type()
)
hh3cDhcpServer2IPExcludeTotalNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2IPExcludeTotalNum.setStatus("current")
...
hh3cDhcpServer2PoolIndex.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
...
_Hh3cDhcpServer2PoolLeaseUnlimit_Type.__name__ = "TruthValue"
...
_Hh3cDhcpServer2PoolVoiceVlanEnbl_Type.__name__ = "TruthValue"
...
_Hh3cDhcpServer2PoolVerifyClass_Type.__name__ = "TruthValue"
...
class _Hh3cDhcpServer2PoolThreshold_Type(Unsigned32):
    """Custom type hh3cDhcpServer2PoolThreshold based on Unsigned32"""
    defaultValue = 100
...
_Hh3cDhcpServer2PoolThreshold_Type.__name__ = "Unsigned32"
_Hh3cDhcpServer2PoolThreshold_Object = MibTableColumn
hh3cDhcpServer2PoolThreshold = _Hh3cDhcpServer2PoolThreshold_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 1, 1, 36),
    _Hh3cDhcpServer2PoolThreshold_Type()
)
hh3cDhcpServer2PoolThreshold.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolThreshold.setStatus("current")
...
class _Hh3cDhcpServer2IPInUseSecondVlanId_Type(Unsigned32):
    """Custom type hh3cDhcpServer2IPInUseSecondVlanId based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4094),
        ValueRangeConstraint(65535, 65535),
...
_Hh3cDhcpServer2IPInUseSecondVlanId_Type.__name__ = "Unsigned32"
_Hh3cDhcpServer2IPInUseSecondVlanId_Object = MibTableColumn
hh3cDhcpServer2IPInUseSecondVlanId = _Hh3cDhcpServer2IPInUseSecondVlanId_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 14, 1, 10),
    _Hh3cDhcpServer2IPInUseSecondVlanId_Type()
)
hh3cDhcpServer2IPInUseSecondVlanId.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2IPInUseSecondVlanId.setStatus("current")
...
_Hh3cDhcpServer2PoolStatTable_Object = MibTable
hh3cDhcpServer2PoolStatTable = _Hh3cDhcpServer2PoolStatTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20)
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolStatTable.setStatus("current")
_Hh3cDhcpServer2PoolStatEntry_Object = MibTableRow
hh3cDhcpServer2PoolStatEntry = _Hh3cDhcpServer2PoolStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1)
)
hh3cDhcpServer2PoolStatEntry.setIndexNames(
    (0, "HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolIndex"),
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolStatEntry.setStatus("current")


class _Hh3cDhcpServer2PoolUsage_Type(Unsigned32):
    """Custom type hh3cDhcpServer2PoolUsage based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_Hh3cDhcpServer2PoolUsage_Type.__name__ = "Unsigned32"
_Hh3cDhcpServer2PoolUsage_Object = MibTableColumn
hh3cDhcpServer2PoolUsage = _Hh3cDhcpServer2PoolUsage_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 1),
    _Hh3cDhcpServer2PoolUsage_Type()
)
hh3cDhcpServer2PoolUsage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolUsage.setStatus("current")
_Hh3cDhcpServer2PoolReqCnt_Type = Counter64
_Hh3cDhcpServer2PoolReqCnt_Object = MibTableColumn
hh3cDhcpServer2PoolReqCnt = _Hh3cDhcpServer2PoolReqCnt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 2),
    _Hh3cDhcpServer2PoolReqCnt_Type()
)
hh3cDhcpServer2PoolReqCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolReqCnt.setStatus("current")
_Hh3cDhcpServer2PoolReqSuccCnt_Type = Counter64
_Hh3cDhcpServer2PoolReqSuccCnt_Object = MibTableColumn
hh3cDhcpServer2PoolReqSuccCnt = _Hh3cDhcpServer2PoolReqSuccCnt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 3),
    _Hh3cDhcpServer2PoolReqSuccCnt_Type()
)
hh3cDhcpServer2PoolReqSuccCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolReqSuccCnt.setStatus("current")
_Hh3cDhcpServer2PoolDiscoverCnt_Type = Counter64
_Hh3cDhcpServer2PoolDiscoverCnt_Object = MibTableColumn
hh3cDhcpServer2PoolDiscoverCnt = _Hh3cDhcpServer2PoolDiscoverCnt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 4),
    _Hh3cDhcpServer2PoolDiscoverCnt_Type()
)
hh3cDhcpServer2PoolDiscoverCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolDiscoverCnt.setStatus("current")
_Hh3cDhcpServer2PoolOfferCnt_Type = Counter64
_Hh3cDhcpServer2PoolOfferCnt_Object = MibTableColumn
hh3cDhcpServer2PoolOfferCnt = _Hh3cDhcpServer2PoolOfferCnt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 5),
    _Hh3cDhcpServer2PoolOfferCnt_Type()
)
hh3cDhcpServer2PoolOfferCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolOfferCnt.setStatus("current")
_Hh3cDhcpServer2PoolAckCnt_Type = Counter64
_Hh3cDhcpServer2PoolAckCnt_Object = MibTableColumn
hh3cDhcpServer2PoolAckCnt = _Hh3cDhcpServer2PoolAckCnt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 6),
    _Hh3cDhcpServer2PoolAckCnt_Type()
)
hh3cDhcpServer2PoolAckCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolAckCnt.setStatus("current")
_Hh3cDhcpServer2PoolIPTotalNum_Type = Unsigned32
_Hh3cDhcpServer2PoolIPTotalNum_Object = MibTableColumn
hh3cDhcpServer2PoolIPTotalNum = _Hh3cDhcpServer2PoolIPTotalNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 7),
    _Hh3cDhcpServer2PoolIPTotalNum_Type()
)
hh3cDhcpServer2PoolIPTotalNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolIPTotalNum.setStatus("current")
_Hh3cDhcpServer2PoolIPUsedNum_Type = Unsigned32
_Hh3cDhcpServer2PoolIPUsedNum_Object = MibTableColumn
hh3cDhcpServer2PoolIPUsedNum = _Hh3cDhcpServer2PoolIPUsedNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 8),
    _Hh3cDhcpServer2PoolIPUsedNum_Type()
)
hh3cDhcpServer2PoolIPUsedNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolIPUsedNum.setStatus("current")
_Hh3cDhcpServer2PoolIPIdleNum_Type = Unsigned32
_Hh3cDhcpServer2PoolIPIdleNum_Object = MibTableColumn
hh3cDhcpServer2PoolIPIdleNum = _Hh3cDhcpServer2PoolIPIdleNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 9),
    _Hh3cDhcpServer2PoolIPIdleNum_Type()
)
hh3cDhcpServer2PoolIPIdleNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolIPIdleNum.setStatus("current")
_Hh3cDhcpServer2PoolIPExcludeNum_Type = Unsigned32
_Hh3cDhcpServer2PoolIPExcludeNum_Object = MibTableColumn
hh3cDhcpServer2PoolIPExcludeNum = _Hh3cDhcpServer2PoolIPExcludeNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 10),
    _Hh3cDhcpServer2PoolIPExcludeNum_Type()
)
hh3cDhcpServer2PoolIPExcludeNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolIPExcludeNum.setStatus("current")
_Hh3cDhcpServer2PoolConflictNum_Type = Unsigned32
_Hh3cDhcpServer2PoolConflictNum_Object = MibTableColumn
hh3cDhcpServer2PoolConflictNum = _Hh3cDhcpServer2PoolConflictNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 11),
    _Hh3cDhcpServer2PoolConflictNum_Type()
)
hh3cDhcpServer2PoolConflictNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolConflictNum.setStatus("current")
_Hh3cDhcpServer2PoolAutoBindNum_Type = Unsigned32
_Hh3cDhcpServer2PoolAutoBindNum_Object = MibTableColumn
hh3cDhcpServer2PoolAutoBindNum = _Hh3cDhcpServer2PoolAutoBindNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 12),
    _Hh3cDhcpServer2PoolAutoBindNum_Type()
)
hh3cDhcpServer2PoolAutoBindNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolAutoBindNum.setStatus("current")
_Hh3cDhcpServer2PoolManualBindNum_Type = Unsigned32
_Hh3cDhcpServer2PoolManualBindNum_Object = MibTableColumn
hh3cDhcpServer2PoolManualBindNum = _Hh3cDhcpServer2PoolManualBindNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 13),
    _Hh3cDhcpServer2PoolManualBindNum_Type()
)
hh3cDhcpServer2PoolManualBindNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolManualBindNum.setStatus("current")
_Hh3cDhcpServer2PoolExpiredBindNum_Type = Unsigned32
_Hh3cDhcpServer2PoolExpiredBindNum_Object = MibTableColumn
hh3cDhcpServer2PoolExpiredBindNum = _Hh3cDhcpServer2PoolExpiredBindNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 14),
    _Hh3cDhcpServer2PoolExpiredBindNum_Type()
)
hh3cDhcpServer2PoolExpiredBindNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolExpiredBindNum.setStatus("current")


class _Hh3cDhcpServer2PoolNameInfo_Type(OctetString):
    """Custom type hh3cDhcpServer2PoolNameInfo based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 63),
    )
...
_Hh3cDhcpServer2PoolNameInfo_Type.__name__ = "OctetString"
_Hh3cDhcpServer2PoolNameInfo_Object = MibTableColumn
hh3cDhcpServer2PoolNameInfo = _Hh3cDhcpServer2PoolNameInfo_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 15),
    _Hh3cDhcpServer2PoolNameInfo_Type()
)
hh3cDhcpServer2PoolNameInfo.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolNameInfo.setStatus("current")
_Hh3cDhcpServer2PoolReserveIpNum_Type = Unsigned32
_Hh3cDhcpServer2PoolReserveIpNum_Object = MibTableColumn
hh3cDhcpServer2PoolReserveIpNum = _Hh3cDhcpServer2PoolReserveIpNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 20, 1, 16),
    _Hh3cDhcpServer2PoolReserveIpNum_Type()
)
hh3cDhcpServer2PoolReserveIpNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolReserveIpNum.setStatus("current")
_Hh3cDhcpServer2PoolGpTable_Object = MibTable
hh3cDhcpServer2PoolGpTable = _Hh3cDhcpServer2PoolGpTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 21)
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpTable.setStatus("current")
_Hh3cDhcpServer2PoolGpEntry_Object = MibTableRow
hh3cDhcpServer2PoolGpEntry = _Hh3cDhcpServer2PoolGpEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 21, 1)
)
hh3cDhcpServer2PoolGpEntry.setIndexNames(
    (0, "HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolGpName"),
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpEntry.setStatus("current")


class _Hh3cDhcpServer2PoolGpName_Type(OctetString):
    """Custom type hh3cDhcpServer2PoolGpName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 63),
    )
...
_Hh3cDhcpServer2PoolGpName_Type.__name__ = "OctetString"
_Hh3cDhcpServer2PoolGpName_Object = MibTableColumn
hh3cDhcpServer2PoolGpName = _Hh3cDhcpServer2PoolGpName_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 21, 1, 1),
    _Hh3cDhcpServer2PoolGpName_Type()
)
hh3cDhcpServer2PoolGpName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpName.setStatus("current")


class _Hh3cDhcpServer2PoolGpVpnName_Type(OctetString):
    """Custom type hh3cDhcpServer2PoolGpVpnName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 31),
    )
...
_Hh3cDhcpServer2PoolGpVpnName_Type.__name__ = "OctetString"
_Hh3cDhcpServer2PoolGpVpnName_Object = MibTableColumn
hh3cDhcpServer2PoolGpVpnName = _Hh3cDhcpServer2PoolGpVpnName_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 21, 1, 2),
    _Hh3cDhcpServer2PoolGpVpnName_Type()
)
hh3cDhcpServer2PoolGpVpnName.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpVpnName.setStatus("current")


class _Hh3cDhcpServer2PoolGpIncUndo_Type(TruthValue):
    """Custom type hh3cDhcpServer2PoolGpIncUndo based on TruthValue"""
    defaultValue = 2


_Hh3cDhcpServer2PoolGpIncUndo_Type.__name__ = "TruthValue"
_Hh3cDhcpServer2PoolGpIncUndo_Object = MibTableColumn
hh3cDhcpServer2PoolGpIncUndo = _Hh3cDhcpServer2PoolGpIncUndo_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 21, 1, 3),
    _Hh3cDhcpServer2PoolGpIncUndo_Type()
)
hh3cDhcpServer2PoolGpIncUndo.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpIncUndo.setStatus("current")
_Hh3cDhcpServer2PoolGpRowSta_Type = RowStatus
_Hh3cDhcpServer2PoolGpRowSta_Object = MibTableColumn
hh3cDhcpServer2PoolGpRowSta = _Hh3cDhcpServer2PoolGpRowSta_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 21, 1, 4),
    _Hh3cDhcpServer2PoolGpRowSta_Type()
)
hh3cDhcpServer2PoolGpRowSta.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpRowSta.setStatus("current")
_Hh3cDhcpServer2PoolGpExtTable_Object = MibTable
hh3cDhcpServer2PoolGpExtTable = _Hh3cDhcpServer2PoolGpExtTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 22)
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpExtTable.setStatus("current")
_Hh3cDhcpServer2PoolGpExtEntry_Object = MibTableRow
hh3cDhcpServer2PoolGpExtEntry = _Hh3cDhcpServer2PoolGpExtEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 22, 1)
)
hh3cDhcpServer2PoolGpExtEntry.setIndexNames(
    (0, "HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolGpName"),
    (0, "HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolIndex"),
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpExtEntry.setStatus("current")


class _Hh3cDhcpServer2PoolGpIncPoolNm_Type(OctetString):
    """Custom type hh3cDhcpServer2PoolGpIncPoolNm based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 63),
    )
...
_Hh3cDhcpServer2PoolGpIncPoolNm_Type.__name__ = "OctetString"
_Hh3cDhcpServer2PoolGpIncPoolNm_Object = MibTableColumn
hh3cDhcpServer2PoolGpIncPoolNm = _Hh3cDhcpServer2PoolGpIncPoolNm_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 22, 1, 1),
    _Hh3cDhcpServer2PoolGpIncPoolNm_Type()
)
hh3cDhcpServer2PoolGpIncPoolNm.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpIncPoolNm.setStatus("current")
_Hh3cDhcpServer2PoolGpExtRowSta_Type = RowStatus
_Hh3cDhcpServer2PoolGpExtRowSta_Object = MibTableColumn
hh3cDhcpServer2PoolGpExtRowSta = _Hh3cDhcpServer2PoolGpExtRowSta_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 22, 1, 2),
    _Hh3cDhcpServer2PoolGpExtRowSta_Type()
)
hh3cDhcpServer2PoolGpExtRowSta.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpExtRowSta.setStatus("current")
_Hh3cDhcpServer2PoolGpStatTable_Object = MibTable
hh3cDhcpServer2PoolGpStatTable = _Hh3cDhcpServer2PoolGpStatTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23)
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpStatTable.setStatus("current")
_Hh3cDhcpServer2PoolGpStatEntry_Object = MibTableRow
hh3cDhcpServer2PoolGpStatEntry = _Hh3cDhcpServer2PoolGpStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1)
)
hh3cDhcpServer2PoolGpStatEntry.setIndexNames(
    (0, "HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolGpName"),
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpStatEntry.setStatus("current")


class _Hh3cDhcpServer2PoolGpPoolNum_Type(Unsigned32):
    """Custom type hh3cDhcpServer2PoolGpPoolNum based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cDhcpServer2PoolGpPoolNum_Type.__name__ = "Unsigned32"
_Hh3cDhcpServer2PoolGpPoolNum_Object = MibTableColumn
hh3cDhcpServer2PoolGpPoolNum = _Hh3cDhcpServer2PoolGpPoolNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 1),
    _Hh3cDhcpServer2PoolGpPoolNum_Type()
)
hh3cDhcpServer2PoolGpPoolNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpPoolNum.setStatus("current")
_Hh3cDhcpServer2PoolGpBndDomNum_Type = Unsigned32
_Hh3cDhcpServer2PoolGpBndDomNum_Object = MibTableColumn
hh3cDhcpServer2PoolGpBndDomNum = _Hh3cDhcpServer2PoolGpBndDomNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 2),
    _Hh3cDhcpServer2PoolGpBndDomNum_Type()
)
hh3cDhcpServer2PoolGpBndDomNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpBndDomNum.setStatus("current")


class _Hh3cDhcpServer2PoolGpUsage_Type(Unsigned32):
    """Custom type hh3cDhcpServer2PoolGpUsage based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 100),
    )
...
_Hh3cDhcpServer2PoolGpUsage_Type.__name__ = "Unsigned32"
_Hh3cDhcpServer2PoolGpUsage_Object = MibTableColumn
hh3cDhcpServer2PoolGpUsage = _Hh3cDhcpServer2PoolGpUsage_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 3),
    _Hh3cDhcpServer2PoolGpUsage_Type()
)
hh3cDhcpServer2PoolGpUsage.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpUsage.setStatus("current")
_Hh3cDhcpServer2PoolGpIPTotalNum_Type = Unsigned32
_Hh3cDhcpServer2PoolGpIPTotalNum_Object = MibTableColumn
hh3cDhcpServer2PoolGpIPTotalNum = _Hh3cDhcpServer2PoolGpIPTotalNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 4),
    _Hh3cDhcpServer2PoolGpIPTotalNum_Type()
)
hh3cDhcpServer2PoolGpIPTotalNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpIPTotalNum.setStatus("current")
_Hh3cDhcpServer2PoolGpIPUsedNum_Type = Unsigned32
_Hh3cDhcpServer2PoolGpIPUsedNum_Object = MibTableColumn
hh3cDhcpServer2PoolGpIPUsedNum = _Hh3cDhcpServer2PoolGpIPUsedNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 5),
    _Hh3cDhcpServer2PoolGpIPUsedNum_Type()
)
hh3cDhcpServer2PoolGpIPUsedNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpIPUsedNum.setStatus("current")
_Hh3cDhcpServer2PoolGpIPIdleNum_Type = Unsigned32
_Hh3cDhcpServer2PoolGpIPIdleNum_Object = MibTableColumn
hh3cDhcpServer2PoolGpIPIdleNum = _Hh3cDhcpServer2PoolGpIPIdleNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 6),
    _Hh3cDhcpServer2PoolGpIPIdleNum_Type()
)
hh3cDhcpServer2PoolGpIPIdleNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpIPIdleNum.setStatus("current")
_Hh3cDhcpServer2PoolGpIPExcNum_Type = Unsigned32
_Hh3cDhcpServer2PoolGpIPExcNum_Object = MibTableColumn
hh3cDhcpServer2PoolGpIPExcNum = _Hh3cDhcpServer2PoolGpIPExcNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 7),
    _Hh3cDhcpServer2PoolGpIPExcNum_Type()
)
hh3cDhcpServer2PoolGpIPExcNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpIPExcNum.setStatus("current")
_Hh3cDhcpServer2PoolGpConfNum_Type = Unsigned32
_Hh3cDhcpServer2PoolGpConfNum_Object = MibTableColumn
hh3cDhcpServer2PoolGpConfNum = _Hh3cDhcpServer2PoolGpConfNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 8),
    _Hh3cDhcpServer2PoolGpConfNum_Type()
)
hh3cDhcpServer2PoolGpConfNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpConfNum.setStatus("current")
_Hh3cDhcpServer2PoolGpAutoBndNum_Type = Unsigned32
_Hh3cDhcpServer2PoolGpAutoBndNum_Object = MibTableColumn
hh3cDhcpServer2PoolGpAutoBndNum = _Hh3cDhcpServer2PoolGpAutoBndNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 9),
    _Hh3cDhcpServer2PoolGpAutoBndNum_Type()
)
hh3cDhcpServer2PoolGpAutoBndNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpAutoBndNum.setStatus("current")
_Hh3cDhcpServer2PoolGpManuBndNum_Type = Unsigned32
_Hh3cDhcpServer2PoolGpManuBndNum_Object = MibTableColumn
hh3cDhcpServer2PoolGpManuBndNum = _Hh3cDhcpServer2PoolGpManuBndNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 10),
    _Hh3cDhcpServer2PoolGpManuBndNum_Type()
)
hh3cDhcpServer2PoolGpManuBndNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpManuBndNum.setStatus("current")
_Hh3cDhcpServer2PoolGpExpiBndNum_Type = Unsigned32
_Hh3cDhcpServer2PoolGpExpiBndNum_Object = MibTableColumn
hh3cDhcpServer2PoolGpExpiBndNum = _Hh3cDhcpServer2PoolGpExpiBndNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 11),
    _Hh3cDhcpServer2PoolGpExpiBndNum_Type()
)
hh3cDhcpServer2PoolGpExpiBndNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpExpiBndNum.setStatus("current")
_Hh3cDhcpServer2PoolGpReserverIpNum_Type = Unsigned32
_Hh3cDhcpServer2PoolGpReserverIpNum_Object = MibTableColumn
hh3cDhcpServer2PoolGpReserverIpNum = _Hh3cDhcpServer2PoolGpReserverIpNum_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 2, 23, 1, 12),
    _Hh3cDhcpServer2PoolGpReserverIpNum_Type()
)
hh3cDhcpServer2PoolGpReserverIpNum.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDhcpServer2PoolGpReserverIpNum.setStatus("current")
...
_Hh3cDhcpRelay2UserInfoRecord_Type.__name__ = "TruthValue"
...
_Hh3cDhcpRelay2UserInfoRefresh_Type.__name__ = "TruthValue"
...
_Hh3cDhcpRelay2IfSelectRelay_Type.__name__ = "TruthValue"
...
_Hh3cDhcpRelay2IfCheckMac_Type.__name__ = "TruthValue"
...
_Hh3cDhcpRelay2IfOpt82Enable_Type.__name__ = "TruthValue"
...
_Hh3cDhcpServer2Traps_ObjectIdentity = ObjectIdentity
hh3cDhcpServer2Traps = _Hh3cDhcpServer2Traps_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5)
)
_Hh3cDhcpServer2TrapNotify_ObjectIdentity = ObjectIdentity
hh3cDhcpServer2TrapNotify = _Hh3cDhcpServer2TrapNotify_ObjectIdentity(
...
hh3cDhcpServer2AddrExhaust = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5, 0, 1)
)
hh3cDhcpServer2AddrExhaust.setObjects(
      *(("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolIndex"),
        ("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolName"))
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2AddrExhaust.setStatus(
        "current"
    )

hh3cDhcpServer2AddrExhaustRecov = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5, 0, 2)
)
hh3cDhcpServer2AddrExhaustRecov.setObjects(
      *(("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolIndex"),
        ("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolName"))
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2AddrExhaustRecov.setStatus(
        "current"
    )

hh3cDhcpServer2IpUsageOverflow = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5, 0, 3)
)
hh3cDhcpServer2IpUsageOverflow.setObjects(
      *(("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolIndex"),
        ("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolName"))
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2IpUsageOverflow.setStatus(
        "current"
    )

hh3cDhcpServer2AllocOverflow = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5, 0, 4)
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2AllocOverflow.setStatus(
        "current"
    )

hh3cDhcpServer2IpUsageOverflowRecov = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5, 0, 5)
)
hh3cDhcpServer2IpUsageOverflowRecov.setObjects(
      *(("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolIndex"),
        ("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolName"))
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2IpUsageOverflowRecov.setStatus(
        "current"
    )

hh3cDhcpServer2NetUsageOverflow = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5, 0, 6)
)
hh3cDhcpServer2NetUsageOverflow.setObjects(
      *(("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolIndex"),
        ("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolName"))
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2NetUsageOverflow.setStatus(
        "current"
    )

hh3cDhcpServer2NetUsageOverflowRecov = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5, 0, 7)
)
hh3cDhcpServer2NetUsageOverflowRecov.setObjects(
      *(("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolIndex"),
        ("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolName"))
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2NetUsageOverflowRecov.setStatus(
        "current"
    )

hh3cDhcpServer2NetExhaust = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5, 0, 8)
)
hh3cDhcpServer2NetExhaust.setObjects(
      *(("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolIndex"),
        ("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolName"))
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2NetExhaust.setStatus(
        "current"
    )

hh3cDhcpServer2NetExhaustRecov = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5, 0, 9)
)
hh3cDhcpServer2NetExhaustRecov.setObjects(
      *(("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolIndex"),
        ("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolName"))
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2NetExhaustRecov.setStatus(
        "current"
    )

hh3cDhcpServer2GpNetExhaust = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5, 0, 10)
)
hh3cDhcpServer2GpNetExhaust.setObjects(
    ("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolGpName")
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2GpNetExhaust.setStatus(
        "current"
    )

hh3cDhcpServer2GpNetExhaustRecov = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 122, 5, 0, 11)
)
hh3cDhcpServer2GpNetExhaustRecov.setObjects(
    ("HH3C-DHCP4-MIB", "hh3cDhcpServer2PoolGpName")
)
if mibBuilder.loadTexts:
    hh3cDhcpServer2GpNetExhaustRecov.setStatus(
        "current"
    )
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cDhcp4": hh3cDhcp4,
       ...
       "hh3cDhcpServer2AllocThreshold": hh3cDhcpServer2AllocThreshold,
       ...
       "hh3cDhcpServer2ReqCnt": hh3cDhcpServer2ReqCnt,
       "hh3cDhcpServer2ReqSuccCnt": hh3cDhcpServer2ReqSuccCnt,
       "hh3cDhcpServer2IPTotalNum": hh3cDhcpServer2IPTotalNum,
       "hh3cDhcpServer2IPUsedNum": hh3cDhcpServer2IPUsedNum,
       "hh3cDhcpServer2IPIdleNum": hh3cDhcpServer2IPIdleNum,
       "hh3cDhcpServer2IPExcludeTotalNum": hh3cDhcpServer2IPExcludeTotalNum,
       ...
       "hh3cDhcpServer2PoolThreshold": hh3cDhcpServer2PoolThreshold,
       ...
       "hh3cDhcpServer2IPInUseSecondVlanId": hh3cDhcpServer2IPInUseSecondVlanId,
       ...
       "hh3cDhcpServer2PoolStatTable": hh3cDhcpServer2PoolStatTable,
       "hh3cDhcpServer2PoolStatEntry": hh3cDhcpServer2PoolStatEntry,
       "hh3cDhcpServer2PoolUsage": hh3cDhcpServer2PoolUsage,
       "hh3cDhcpServer2PoolReqCnt": hh3cDhcpServer2PoolReqCnt,
       "hh3cDhcpServer2PoolReqSuccCnt": hh3cDhcpServer2PoolReqSuccCnt,
       "hh3cDhcpServer2PoolDiscoverCnt": hh3cDhcpServer2PoolDiscoverCnt,
       "hh3cDhcpServer2PoolOfferCnt": hh3cDhcpServer2PoolOfferCnt,
       "hh3cDhcpServer2PoolAckCnt": hh3cDhcpServer2PoolAckCnt,
       "hh3cDhcpServer2PoolIPTotalNum": hh3cDhcpServer2PoolIPTotalNum,
       "hh3cDhcpServer2PoolIPUsedNum": hh3cDhcpServer2PoolIPUsedNum,
       "hh3cDhcpServer2PoolIPIdleNum": hh3cDhcpServer2PoolIPIdleNum,
       "hh3cDhcpServer2PoolIPExcludeNum": hh3cDhcpServer2PoolIPExcludeNum,
       "hh3cDhcpServer2PoolConflictNum": hh3cDhcpServer2PoolConflictNum,
       "hh3cDhcpServer2PoolAutoBindNum": hh3cDhcpServer2PoolAutoBindNum,
       "hh3cDhcpServer2PoolManualBindNum": hh3cDhcpServer2PoolManualBindNum,
       "hh3cDhcpServer2PoolExpiredBindNum": hh3cDhcpServer2PoolExpiredBindNum,
       "hh3cDhcpServer2PoolNameInfo": hh3cDhcpServer2PoolNameInfo,
       "hh3cDhcpServer2PoolReserveIpNum": hh3cDhcpServer2PoolReserveIpNum,
       "hh3cDhcpServer2PoolGpTable": hh3cDhcpServer2PoolGpTable,
       "hh3cDhcpServer2PoolGpEntry": hh3cDhcpServer2PoolGpEntry,
       "hh3cDhcpServer2PoolGpName": hh3cDhcpServer2PoolGpName,
       "hh3cDhcpServer2PoolGpVpnName": hh3cDhcpServer2PoolGpVpnName,
       "hh3cDhcpServer2PoolGpIncUndo": hh3cDhcpServer2PoolGpIncUndo,
       "hh3cDhcpServer2PoolGpRowSta": hh3cDhcpServer2PoolGpRowSta,
       "hh3cDhcpServer2PoolGpExtTable": hh3cDhcpServer2PoolGpExtTable,
       "hh3cDhcpServer2PoolGpExtEntry": hh3cDhcpServer2PoolGpExtEntry,
       "hh3cDhcpServer2PoolGpIncPoolNm": hh3cDhcpServer2PoolGpIncPoolNm,
       "hh3cDhcpServer2PoolGpExtRowSta": hh3cDhcpServer2PoolGpExtRowSta,
       "hh3cDhcpServer2PoolGpStatTable": hh3cDhcpServer2PoolGpStatTable,
       "hh3cDhcpServer2PoolGpStatEntry": hh3cDhcpServer2PoolGpStatEntry,
       "hh3cDhcpServer2PoolGpPoolNum": hh3cDhcpServer2PoolGpPoolNum,
       "hh3cDhcpServer2PoolGpBndDomNum": hh3cDhcpServer2PoolGpBndDomNum,
       "hh3cDhcpServer2PoolGpUsage": hh3cDhcpServer2PoolGpUsage,
       "hh3cDhcpServer2PoolGpIPTotalNum": hh3cDhcpServer2PoolGpIPTotalNum,
       "hh3cDhcpServer2PoolGpIPUsedNum": hh3cDhcpServer2PoolGpIPUsedNum,
       "hh3cDhcpServer2PoolGpIPIdleNum": hh3cDhcpServer2PoolGpIPIdleNum,
       "hh3cDhcpServer2PoolGpIPExcNum": hh3cDhcpServer2PoolGpIPExcNum,
       "hh3cDhcpServer2PoolGpConfNum": hh3cDhcpServer2PoolGpConfNum,
       "hh3cDhcpServer2PoolGpAutoBndNum": hh3cDhcpServer2PoolGpAutoBndNum,
       "hh3cDhcpServer2PoolGpManuBndNum": hh3cDhcpServer2PoolGpManuBndNum,
       "hh3cDhcpServer2PoolGpExpiBndNum": hh3cDhcpServer2PoolGpExpiBndNum,
       "hh3cDhcpServer2PoolGpReserverIpNum": hh3cDhcpServer2PoolGpReserverIpNum,
       ...
       "hh3cDhcpServer2Traps": hh3cDhcpServer2Traps,
       "hh3cDhcpServer2TrapNotify": hh3cDhcpServer2TrapNotify,
       "hh3cDhcpServer2AddrExhaust": hh3cDhcpServer2AddrExhaust,
       "hh3cDhcpServer2AddrExhaustRecov": hh3cDhcpServer2AddrExhaustRecov,
       "hh3cDhcpServer2IpUsageOverflow": hh3cDhcpServer2IpUsageOverflow,
       "hh3cDhcpServer2AllocOverflow": hh3cDhcpServer2AllocOverflow,
       "hh3cDhcpServer2IpUsageOverflowRecov": hh3cDhcpServer2IpUsageOverflowRecov,
       "hh3cDhcpServer2NetUsageOverflow": hh3cDhcpServer2NetUsageOverflow,
       "hh3cDhcpServer2NetUsageOverflowRecov": hh3cDhcpServer2NetUsageOverflowRecov,
       "hh3cDhcpServer2NetExhaust": hh3cDhcpServer2NetExhaust,
       "hh3cDhcpServer2NetExhaustRecov": hh3cDhcpServer2NetExhaustRecov,
       "hh3cDhcpServer2GpNetExhaust": hh3cDhcpServer2GpNetExhaust,
       "hh3cDhcpServer2GpNetExhaustRecov": hh3cDhcpServer2GpNetExhaustRecov}
)
