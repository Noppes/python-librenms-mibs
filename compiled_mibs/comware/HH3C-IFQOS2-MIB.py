...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-IFQOS2-MIB
...
class Hh3cIfCarAction(TextualConvention, Integer32):
    status = "current"
...
_Hh3cIfQoSQSMaxDelay_Type.__name__ = "Integer32"
...
_Hh3cIfQoSQSMinBandwidth_Type = Integer32
_Hh3cIfQoSQSMinBandwidth_Object = MibTableColumn
hh3cIfQoSQSMinBandwidth = _Hh3cIfQoSQSMinBandwidth_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 1, 1, 2, 1, 6),
    _Hh3cIfQoSQSMinBandwidth_Type()
)
hh3cIfQoSQSMinBandwidth.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cIfQoSQSMinBandwidth.setStatus("current")


class _Hh3cIfQoSQSMinBandwidthPercent_Type(Unsigned32):
    """Custom type hh3cIfQoSQSMinBandwidthPercent based on Unsigned32"""
...
_Hh3cIfQoSQSMinBandwidthPercent_Type.__name__ = "Unsigned32"
_Hh3cIfQoSQSMinBandwidthPercent_Object = MibTableColumn
hh3cIfQoSQSMinBandwidthPercent = _Hh3cIfQoSQSMinBandwidthPercent_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 1, 1, 2, 1, 7),
    _Hh3cIfQoSQSMinBandwidthPercent_Type()
)
hh3cIfQoSQSMinBandwidthPercent.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cIfQoSQSMinBandwidthPercent.setStatus("current")
...
class _Hh3cIfQoSQueueName_Type(OctetString):
    """Custom type hh3cIfQoSQueueName based on OctetString"""
...
_Hh3cIfQoSQueueName_Type.__name__ = "OctetString"
_Hh3cIfQoSQueueName_Object = MibTableColumn
hh3cIfQoSQueueName = _Hh3cIfQoSQueueName_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 1, 2, 1, 1, 21),
    _Hh3cIfQoSQueueName_Type()
)
hh3cIfQoSQueueName.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSQueueName.setStatus("current")
_Hh3cIfQoSDropPPS_Type = Unsigned32
_Hh3cIfQoSDropPPS_Object = MibTableColumn
hh3cIfQoSDropPPS = _Hh3cIfQoSDropPPS_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 1, 2, 1, 1, 22),
    _Hh3cIfQoSDropPPS_Type()
)
hh3cIfQoSDropPPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSDropPPS.setStatus("current")
_Hh3cIfQoSDropBPS_Type = Unsigned32
_Hh3cIfQoSDropBPS_Object = MibTableColumn
hh3cIfQoSDropBPS = _Hh3cIfQoSDropBPS_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 1, 2, 1, 1, 23),
    _Hh3cIfQoSDropBPS_Type()
)
hh3cIfQoSDropBPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSDropBPS.setStatus("current")
_Hh3cIfQoSPeakPassPPS_Type = Unsigned32
_Hh3cIfQoSPeakPassPPS_Object = MibTableColumn
hh3cIfQoSPeakPassPPS = _Hh3cIfQoSPeakPassPPS_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 1, 2, 1, 1, 24),
    _Hh3cIfQoSPeakPassPPS_Type()
)
hh3cIfQoSPeakPassPPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSPeakPassPPS.setStatus("current")
_Hh3cIfQoSPeakPassBPS_Type = Unsigned32
_Hh3cIfQoSPeakPassBPS_Object = MibTableColumn
hh3cIfQoSPeakPassBPS = _Hh3cIfQoSPeakPassBPS_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 1, 2, 1, 1, 25),
    _Hh3cIfQoSPeakPassBPS_Type()
)
hh3cIfQoSPeakPassBPS.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSPeakPassBPS.setStatus("current")
...
_Hh3cIfQoSHardwareQueueTotalRunInfoTable_Object = MibTable
hh3cIfQoSHardwareQueueTotalRunInfoTable = _Hh3cIfQoSHardwareQueueTotalRunInfoTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 1, 2, 3)
)
if mibBuilder.loadTexts:
    hh3cIfQoSHardwareQueueTotalRunInfoTable.setStatus("current")
_Hh3cIfQoSHardwareQueueTotalRunInfoEntry_Object = MibTableRow
hh3cIfQoSHardwareQueueTotalRunInfoEntry = _Hh3cIfQoSHardwareQueueTotalRunInfoEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 1, 2, 3, 1)
)
hh3cIfQoSHardwareQueueTotalRunInfoEntry.setIndexNames(
    (0, "IF-MIB", "ifIndex"),
)
if mibBuilder.loadTexts:
    hh3cIfQoSHardwareQueueTotalRunInfoEntry.setStatus("current")
_Hh3cIfQoSQueueLength_Type = Unsigned32
_Hh3cIfQoSQueueLength_Object = MibTableColumn
hh3cIfQoSQueueLength = _Hh3cIfQoSQueueLength_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 1, 2, 3, 1, 1),
    _Hh3cIfQoSQueueLength_Type()
)
hh3cIfQoSQueueLength.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSQueueLength.setStatus("current")
_Hh3cIfQoSPeakQueueBytes_Type = Unsigned32
_Hh3cIfQoSPeakQueueBytes_Object = MibTableColumn
hh3cIfQoSPeakQueueBytes = _Hh3cIfQoSPeakQueueBytes_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 1, 2, 3, 1, 2),
    _Hh3cIfQoSPeakQueueBytes_Type()
)
hh3cIfQoSPeakQueueBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSPeakQueueBytes.setStatus("current")
...
_Hh3cIfQoSCQQueueServing_Type.__name__ = "Integer32"
...
_Hh3cIfQoSLRPir_Type = Unsigned32
_Hh3cIfQoSLRPir_Object = MibTableColumn
hh3cIfQoSLRPir = _Hh3cIfQoSLRPir_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 3, 1, 1, 6),
    _Hh3cIfQoSLRPir_Type()
)
hh3cIfQoSLRPir.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cIfQoSLRPir.setStatus("current")


class _Hh3cIfQoSLRUnit_Type(Integer32):
    """Custom type hh3cIfQoSLRUnit based on Integer32"""
    defaultValue = 1
...
_Hh3cIfQoSLRUnit_Type.__name__ = "Integer32"
_Hh3cIfQoSLRUnit_Object = MibTableColumn
hh3cIfQoSLRUnit = _Hh3cIfQoSLRUnit_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 3, 1, 1, 7),
    _Hh3cIfQoSLRUnit_Type()
)
hh3cIfQoSLRUnit.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cIfQoSLRUnit.setStatus("current")
...
class _Hh3cIfQoSAggregativeCarPir_Type(Unsigned32):
    """Custom type hh3cIfQoSAggregativeCarPir based on Unsigned32"""
    defaultValue = 4294967295


_Hh3cIfQoSAggregativeCarPir_Type.__name__ = "Unsigned32"
...
class _Hh3cIfQoSAggregativeCarGreenActionType_Type(Hh3cIfCarAction):
    """Custom type hh3cIfQoSAggregativeCarGreenActionType based on Hh3cIfCarAction"""
    defaultValue = 1


_Hh3cIfQoSAggregativeCarGreenActionType_Type.__name__ = "Hh3cIfCarAction"
...
_Hh3cIfQoSAggregativeCarYellowActionType_Type = Hh3cIfCarAction
...
_Hh3cIfQoSAggregativeCarRedActionType_Type = Hh3cIfCarAction
...
class _Hh3cIfQoSAggregativeCarRedActionValue_Type(Integer32):
    """Custom type hh3cIfQoSAggregativeCarRedActionValue based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 63),
        ValueRangeConstraint(255, 255),
...
_Hh3cIfQoSAggregativeCarRedActionValue_Type.__name__ = "Integer32"
...
class _Hh3cIfQoSAggregativeCarApplyRuleValue_Type(Integer32):
    """Custom type hh3cIfQoSAggregativeCarApplyRuleValue based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cIfQoSAggregativeCarApplyRuleValue_Type.__name__ = "Integer32"
...
class _Hh3cIfQoSAggregativeCarApplyCarIndex_Type(Integer32):
    """Custom type hh3cIfQoSAggregativeCarApplyCarIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 65534),
    )
...
_Hh3cIfQoSAggregativeCarApplyCarIndex_Type.__name__ = "Integer32"
...
class _Hh3cIfQoSTricolorCarValue_Type(Integer32):
    """Custom type hh3cIfQoSTricolorCarValue based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 2147483647),
    )
...
_Hh3cIfQoSTricolorCarValue_Type.__name__ = "Integer32"
...
class _Hh3cIfQoSTricolorCarPir_Type(Unsigned32):
    """Custom type hh3cIfQoSTricolorCarPir based on Unsigned32"""
    defaultValue = 4294967295


_Hh3cIfQoSTricolorCarPir_Type.__name__ = "Unsigned32"
...
class _Hh3cIfQoSTricolorCarGreenActionType_Type(Hh3cIfCarAction):
    """Custom type hh3cIfQoSTricolorCarGreenActionType based on Hh3cIfCarAction"""
    defaultValue = 1


_Hh3cIfQoSTricolorCarGreenActionType_Type.__name__ = "Hh3cIfCarAction"
...
class _Hh3cIfQoSTricolorCarYellowActionType_Type(Hh3cIfCarAction):
    """Custom type hh3cIfQoSTricolorCarYellowActionType based on Hh3cIfCarAction"""
    defaultValue = 1


_Hh3cIfQoSTricolorCarYellowActionType_Type.__name__ = "Hh3cIfCarAction"
...
class _Hh3cIfQoSTricolorCarRedActionType_Type(Hh3cIfCarAction):
    """Custom type hh3cIfQoSTricolorCarRedActionType based on Hh3cIfCarAction"""
    defaultValue = 3


_Hh3cIfQoSTricolorCarRedActionType_Type.__name__ = "Hh3cIfCarAction"
...
class _Hh3cIfQoSTricolorCarUnitType_Type(Integer32):
    """Custom type hh3cIfQoSTricolorCarUnitType based on Integer32"""
    defaultValue = 1
...
_Hh3cIfQoSTricolorCarUnitType_Type.__name__ = "Integer32"
_Hh3cIfQoSTricolorCarUnitType_Object = MibTableColumn
hh3cIfQoSTricolorCarUnitType = _Hh3cIfQoSTricolorCarUnitType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 4, 2, 1, 1, 15),
    _Hh3cIfQoSTricolorCarUnitType_Type()
)
hh3cIfQoSTricolorCarUnitType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cIfQoSTricolorCarUnitType.setStatus("current")
...
class _Hh3cIfQoSGTSClassRuleValue_Type(Integer32):
    """Custom type hh3cIfQoSGTSClassRuleValue based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 2147483647),
    )
...
_Hh3cIfQoSGTSClassRuleValue_Type.__name__ = "Integer32"
...
class _Hh3cIfQoSGTSPir_Type(Unsigned32):
    """Custom type hh3cIfQoSGTSPir based on Unsigned32"""
    defaultValue = 4294967295


_Hh3cIfQoSGTSPir_Type.__name__ = "Unsigned32"
_Hh3cIfQoSGTSPir_Object = MibTableColumn
hh3cIfQoSGTSPir = _Hh3cIfQoSGTSPir_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 5, 1, 1, 8),
    _Hh3cIfQoSGTSPir_Type()
)
hh3cIfQoSGTSPir.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cIfQoSGTSPir.setStatus("current")


class _Hh3cIfQoSGTSUnitType_Type(Integer32):
    """Custom type hh3cIfQoSGTSUnitType based on Integer32"""
    defaultValue = 1
...
_Hh3cIfQoSGTSUnitType_Type.__name__ = "Integer32"
_Hh3cIfQoSGTSUnitType_Object = MibTableColumn
hh3cIfQoSGTSUnitType = _Hh3cIfQoSGTSUnitType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 5, 1, 1, 9),
    _Hh3cIfQoSGTSUnitType_Type()
)
hh3cIfQoSGTSUnitType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cIfQoSGTSUnitType.setStatus("current")
...
class _Hh3cIfQoSWredGroupIndex_Type(Integer32):
    """Custom type hh3cIfQoSWredGroupIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cIfQoSWredGroupIndex_Type.__name__ = "Integer32"
...
class _Hh3cIfQoSWredGroupApplyName_Type(OctetString):
    """Custom type hh3cIfQoSWredGroupApplyName based on OctetString"""
    subtypeSpec = OctetString.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueSizeConstraint(1, 32),
    )
...
_Hh3cIfQoSWredGroupApplyName_Type.__name__ = "OctetString"
...
_Hh3cIfQoSPrePriMapTable_Object = MibTable
hh3cIfQoSPrePriMapTable = _Hh3cIfQoSPrePriMapTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 9, 1, 4)
)
if mibBuilder.loadTexts:
    hh3cIfQoSPrePriMapTable.setStatus("current")
_Hh3cIfQoSPrePriMapEntry_Object = MibTableRow
hh3cIfQoSPrePriMapEntry = _Hh3cIfQoSPrePriMapEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 9, 1, 4, 1)
)
hh3cIfQoSPrePriMapEntry.setIndexNames(
    (0, "HH3C-IFQOS2-MIB", "hh3cIfQoSPrePriMapTableType"),
    (0, "HH3C-IFQOS2-MIB", "hh3cIfQoSPrePriMapTableColor"),
    (0, "HH3C-IFQOS2-MIB", "hh3cIfQoSPrePriMapTableDirection"),
    (0, "HH3C-IFQOS2-MIB", "hh3cIfQoSPrePriMapTableImportValue"),
)
if mibBuilder.loadTexts:
    hh3cIfQoSPrePriMapEntry.setStatus("current")


class _Hh3cIfQoSPrePriMapTableType_Type(Integer32):
    """Custom type hh3cIfQoSPrePriMapTableType based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hh3cIfQoSPrePriMapTableType_Type.__name__ = "Integer32"
_Hh3cIfQoSPrePriMapTableType_Object = MibTableColumn
hh3cIfQoSPrePriMapTableType = _Hh3cIfQoSPrePriMapTableType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 9, 1, 4, 1, 1),
    _Hh3cIfQoSPrePriMapTableType_Type()
)
hh3cIfQoSPrePriMapTableType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cIfQoSPrePriMapTableType.setStatus("current")


class _Hh3cIfQoSPrePriMapTableColor_Type(Integer32):
    """Custom type hh3cIfQoSPrePriMapTableColor based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hh3cIfQoSPrePriMapTableColor_Type.__name__ = "Integer32"
_Hh3cIfQoSPrePriMapTableColor_Object = MibTableColumn
hh3cIfQoSPrePriMapTableColor = _Hh3cIfQoSPrePriMapTableColor_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 9, 1, 4, 1, 2),
    _Hh3cIfQoSPrePriMapTableColor_Type()
)
hh3cIfQoSPrePriMapTableColor.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cIfQoSPrePriMapTableColor.setStatus("current")


class _Hh3cIfQoSPrePriMapTableDirection_Type(Integer32):
    """Custom type hh3cIfQoSPrePriMapTableDirection based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hh3cIfQoSPrePriMapTableDirection_Type.__name__ = "Integer32"
_Hh3cIfQoSPrePriMapTableDirection_Object = MibTableColumn
hh3cIfQoSPrePriMapTableDirection = _Hh3cIfQoSPrePriMapTableDirection_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 9, 1, 4, 1, 3),
    _Hh3cIfQoSPrePriMapTableDirection_Type()
)
hh3cIfQoSPrePriMapTableDirection.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cIfQoSPrePriMapTableDirection.setStatus("current")


class _Hh3cIfQoSPrePriMapTableImportValue_Type(Integer32):
    """Custom type hh3cIfQoSPrePriMapTableImportValue based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 63),
    )
...
_Hh3cIfQoSPrePriMapTableImportValue_Type.__name__ = "Integer32"
_Hh3cIfQoSPrePriMapTableImportValue_Object = MibTableColumn
hh3cIfQoSPrePriMapTableImportValue = _Hh3cIfQoSPrePriMapTableImportValue_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 9, 1, 4, 1, 4),
    _Hh3cIfQoSPrePriMapTableImportValue_Type()
)
hh3cIfQoSPrePriMapTableImportValue.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cIfQoSPrePriMapTableImportValue.setStatus("current")


class _Hh3cIfQoSPrePriMapTableExportValue_Type(Integer32):
    """Custom type hh3cIfQoSPrePriMapTableExportValue based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 63),
    )
...
_Hh3cIfQoSPrePriMapTableExportValue_Type.__name__ = "Integer32"
_Hh3cIfQoSPrePriMapTableExportValue_Object = MibTableColumn
hh3cIfQoSPrePriMapTableExportValue = _Hh3cIfQoSPrePriMapTableExportValue_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 9, 1, 4, 1, 5),
    _Hh3cIfQoSPrePriMapTableExportValue_Type()
)
hh3cIfQoSPrePriMapTableExportValue.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cIfQoSPrePriMapTableExportValue.setStatus("current")
...
_Hh3cQoSGlobalPriorityObject_ObjectIdentity = ObjectIdentity
hh3cQoSGlobalPriorityObject = _Hh3cQoSGlobalPriorityObject_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12)
)
_Hh3cQoSRemarkTcpPortPriTable_Object = MibTable
hh3cQoSRemarkTcpPortPriTable = _Hh3cQoSRemarkTcpPortPriTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 1)
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkTcpPortPriTable.setStatus("current")
_Hh3cQoSRemarkTcpPortPriEntry_Object = MibTableRow
hh3cQoSRemarkTcpPortPriEntry = _Hh3cQoSRemarkTcpPortPriEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 1, 1)
)
hh3cQoSRemarkTcpPortPriEntry.setIndexNames(
    (0, "HH3C-IFQOS2-MIB", "hh3cQoSRemarkTcpPortStart"),
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkTcpPortPriEntry.setStatus("current")


class _Hh3cQoSRemarkTcpPortStart_Type(Integer32):
    """Custom type hh3cQoSRemarkTcpPortStart based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cQoSRemarkTcpPortStart_Type.__name__ = "Integer32"
_Hh3cQoSRemarkTcpPortStart_Object = MibTableColumn
hh3cQoSRemarkTcpPortStart = _Hh3cQoSRemarkTcpPortStart_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 1, 1, 1),
    _Hh3cQoSRemarkTcpPortStart_Type()
)
hh3cQoSRemarkTcpPortStart.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cQoSRemarkTcpPortStart.setStatus("current")


class _Hh3cQoSRemarkTcpPortEnd_Type(Integer32):
    """Custom type hh3cQoSRemarkTcpPortEnd based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Hh3cQoSRemarkTcpPortEnd_Type.__name__ = "Integer32"
_Hh3cQoSRemarkTcpPortEnd_Object = MibTableColumn
hh3cQoSRemarkTcpPortEnd = _Hh3cQoSRemarkTcpPortEnd_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 1, 1, 2),
    _Hh3cQoSRemarkTcpPortEnd_Type()
)
hh3cQoSRemarkTcpPortEnd.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkTcpPortEnd.setStatus("current")


class _Hh3cQoSRemarkTcpPortType_Type(Integer32):
    """Custom type hh3cQoSRemarkTcpPortType based on Integer32"""
    defaultValue = 1
...
_Hh3cQoSRemarkTcpPortType_Type.__name__ = "Integer32"
_Hh3cQoSRemarkTcpPortType_Object = MibTableColumn
hh3cQoSRemarkTcpPortType = _Hh3cQoSRemarkTcpPortType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 1, 1, 3),
    _Hh3cQoSRemarkTcpPortType_Type()
)
hh3cQoSRemarkTcpPortType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkTcpPortType.setStatus("current")


class _Hh3cQoSRemarkTcpPortDot1p_Type(Unsigned32):
    """Custom type hh3cQoSRemarkTcpPortDot1p based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 7),
        ValueRangeConstraint(255, 255),
...
_Hh3cQoSRemarkTcpPortDot1p_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkTcpPortDot1p_Object = MibTableColumn
hh3cQoSRemarkTcpPortDot1p = _Hh3cQoSRemarkTcpPortDot1p_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 1, 1, 4),
    _Hh3cQoSRemarkTcpPortDot1p_Type()
)
hh3cQoSRemarkTcpPortDot1p.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkTcpPortDot1p.setStatus("current")


class _Hh3cQoSRemarkTcpPortDscp_Type(Unsigned32):
    """Custom type hh3cQoSRemarkTcpPortDscp based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 63),
        ValueRangeConstraint(255, 255),
...
_Hh3cQoSRemarkTcpPortDscp_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkTcpPortDscp_Object = MibTableColumn
hh3cQoSRemarkTcpPortDscp = _Hh3cQoSRemarkTcpPortDscp_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 1, 1, 5),
    _Hh3cQoSRemarkTcpPortDscp_Type()
)
hh3cQoSRemarkTcpPortDscp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkTcpPortDscp.setStatus("current")
_Hh3cQoSRemarkTcpPortRowStatus_Type = RowStatus
_Hh3cQoSRemarkTcpPortRowStatus_Object = MibTableColumn
hh3cQoSRemarkTcpPortRowStatus = _Hh3cQoSRemarkTcpPortRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 1, 1, 6),
    _Hh3cQoSRemarkTcpPortRowStatus_Type()
)
hh3cQoSRemarkTcpPortRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkTcpPortRowStatus.setStatus("current")
_Hh3cQoSRemarkUdpPortPriTable_Object = MibTable
hh3cQoSRemarkUdpPortPriTable = _Hh3cQoSRemarkUdpPortPriTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 2)
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkUdpPortPriTable.setStatus("current")
_Hh3cQoSRemarkUdpPortPriEntry_Object = MibTableRow
hh3cQoSRemarkUdpPortPriEntry = _Hh3cQoSRemarkUdpPortPriEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 2, 1)
)
hh3cQoSRemarkUdpPortPriEntry.setIndexNames(
    (0, "HH3C-IFQOS2-MIB", "hh3cQoSRemarkUdpPortStart"),
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkUdpPortPriEntry.setStatus("current")


class _Hh3cQoSRemarkUdpPortStart_Type(Integer32):
    """Custom type hh3cQoSRemarkUdpPortStart based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Hh3cQoSRemarkUdpPortStart_Type.__name__ = "Integer32"
_Hh3cQoSRemarkUdpPortStart_Object = MibTableColumn
hh3cQoSRemarkUdpPortStart = _Hh3cQoSRemarkUdpPortStart_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 2, 1, 1),
    _Hh3cQoSRemarkUdpPortStart_Type()
)
hh3cQoSRemarkUdpPortStart.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cQoSRemarkUdpPortStart.setStatus("current")


class _Hh3cQoSRemarkUdpPortEnd_Type(Integer32):
    """Custom type hh3cQoSRemarkUdpPortEnd based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 65535),
    )
...
_Hh3cQoSRemarkUdpPortEnd_Type.__name__ = "Integer32"
_Hh3cQoSRemarkUdpPortEnd_Object = MibTableColumn
hh3cQoSRemarkUdpPortEnd = _Hh3cQoSRemarkUdpPortEnd_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 2, 1, 2),
    _Hh3cQoSRemarkUdpPortEnd_Type()
)
hh3cQoSRemarkUdpPortEnd.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkUdpPortEnd.setStatus("current")


class _Hh3cQoSRemarkUdpPortType_Type(Integer32):
    """Custom type hh3cQoSRemarkUdpPortType based on Integer32"""
    defaultValue = 1
...
_Hh3cQoSRemarkUdpPortType_Type.__name__ = "Integer32"
_Hh3cQoSRemarkUdpPortType_Object = MibTableColumn
hh3cQoSRemarkUdpPortType = _Hh3cQoSRemarkUdpPortType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 2, 1, 3),
    _Hh3cQoSRemarkUdpPortType_Type()
)
hh3cQoSRemarkUdpPortType.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkUdpPortType.setStatus("current")


class _Hh3cQoSRemarkUdpPortDot1p_Type(Unsigned32):
    """Custom type hh3cQoSRemarkUdpPortDot1p based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 7),
        ValueRangeConstraint(255, 255),
...
_Hh3cQoSRemarkUdpPortDot1p_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkUdpPortDot1p_Object = MibTableColumn
hh3cQoSRemarkUdpPortDot1p = _Hh3cQoSRemarkUdpPortDot1p_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 2, 1, 4),
    _Hh3cQoSRemarkUdpPortDot1p_Type()
)
hh3cQoSRemarkUdpPortDot1p.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkUdpPortDot1p.setStatus("current")


class _Hh3cQoSRemarkUdpPortDscp_Type(Unsigned32):
    """Custom type hh3cQoSRemarkUdpPortDscp based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 63),
        ValueRangeConstraint(255, 255),
...
_Hh3cQoSRemarkUdpPortDscp_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkUdpPortDscp_Object = MibTableColumn
hh3cQoSRemarkUdpPortDscp = _Hh3cQoSRemarkUdpPortDscp_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 2, 1, 5),
    _Hh3cQoSRemarkUdpPortDscp_Type()
)
hh3cQoSRemarkUdpPortDscp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkUdpPortDscp.setStatus("current")
_Hh3cQoSRemarkUdpPortRowStatus_Type = RowStatus
_Hh3cQoSRemarkUdpPortRowStatus_Object = MibTableColumn
hh3cQoSRemarkUdpPortRowStatus = _Hh3cQoSRemarkUdpPortRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 2, 1, 6),
    _Hh3cQoSRemarkUdpPortRowStatus_Type()
)
hh3cQoSRemarkUdpPortRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkUdpPortRowStatus.setStatus("current")
_Hh3cQoSRemarkIPv4AddrPriTable_Object = MibTable
hh3cQoSRemarkIPv4AddrPriTable = _Hh3cQoSRemarkIPv4AddrPriTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 3)
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv4AddrPriTable.setStatus("current")
_Hh3cQoSRemarkIPv4AddrPriEntry_Object = MibTableRow
hh3cQoSRemarkIPv4AddrPriEntry = _Hh3cQoSRemarkIPv4AddrPriEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 3, 1)
)
hh3cQoSRemarkIPv4AddrPriEntry.setIndexNames(
    (0, "HH3C-IFQOS2-MIB", "hh3cQoSRemarkIPv4AddrValue"),
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv4AddrPriEntry.setStatus("current")
_Hh3cQoSRemarkIPv4AddrValue_Type = IpAddress
_Hh3cQoSRemarkIPv4AddrValue_Object = MibTableColumn
hh3cQoSRemarkIPv4AddrValue = _Hh3cQoSRemarkIPv4AddrValue_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 3, 1, 1),
    _Hh3cQoSRemarkIPv4AddrValue_Type()
)
hh3cQoSRemarkIPv4AddrValue.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv4AddrValue.setStatus("current")
_Hh3cQoSRemarkIPv4AddrMask_Type = IpAddress
_Hh3cQoSRemarkIPv4AddrMask_Object = MibTableColumn
hh3cQoSRemarkIPv4AddrMask = _Hh3cQoSRemarkIPv4AddrMask_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 3, 1, 2),
    _Hh3cQoSRemarkIPv4AddrMask_Type()
)
hh3cQoSRemarkIPv4AddrMask.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv4AddrMask.setStatus("current")


class _Hh3cQoSRemarkIPv4AddrMaskLength_Type(Unsigned32):
    """Custom type hh3cQoSRemarkIPv4AddrMaskLength based on Unsigned32"""
    defaultValue = 32
...
_Hh3cQoSRemarkIPv4AddrMaskLength_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkIPv4AddrMaskLength_Object = MibTableColumn
hh3cQoSRemarkIPv4AddrMaskLength = _Hh3cQoSRemarkIPv4AddrMaskLength_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 3, 1, 3),
    _Hh3cQoSRemarkIPv4AddrMaskLength_Type()
)
hh3cQoSRemarkIPv4AddrMaskLength.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv4AddrMaskLength.setStatus("current")


class _Hh3cQoSRemarkIPv4AddrDot1p_Type(Unsigned32):
    """Custom type hh3cQoSRemarkIPv4AddrDot1p based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 7),
        ValueRangeConstraint(255, 255),
...
_Hh3cQoSRemarkIPv4AddrDot1p_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkIPv4AddrDot1p_Object = MibTableColumn
hh3cQoSRemarkIPv4AddrDot1p = _Hh3cQoSRemarkIPv4AddrDot1p_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 3, 1, 4),
    _Hh3cQoSRemarkIPv4AddrDot1p_Type()
)
hh3cQoSRemarkIPv4AddrDot1p.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv4AddrDot1p.setStatus("current")


class _Hh3cQoSRemarkIPv4AddrDscp_Type(Unsigned32):
    """Custom type hh3cQoSRemarkIPv4AddrDscp based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 63),
        ValueRangeConstraint(255, 255),
...
_Hh3cQoSRemarkIPv4AddrDscp_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkIPv4AddrDscp_Object = MibTableColumn
hh3cQoSRemarkIPv4AddrDscp = _Hh3cQoSRemarkIPv4AddrDscp_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 3, 1, 5),
    _Hh3cQoSRemarkIPv4AddrDscp_Type()
)
hh3cQoSRemarkIPv4AddrDscp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv4AddrDscp.setStatus("current")
_Hh3cQoSRemarkIPv4AddrRowStatus_Type = RowStatus
_Hh3cQoSRemarkIPv4AddrRowStatus_Object = MibTableColumn
hh3cQoSRemarkIPv4AddrRowStatus = _Hh3cQoSRemarkIPv4AddrRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 3, 1, 6),
    _Hh3cQoSRemarkIPv4AddrRowStatus_Type()
)
hh3cQoSRemarkIPv4AddrRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv4AddrRowStatus.setStatus("current")
_Hh3cQoSRemarkIPv6AddrPriTable_Object = MibTable
hh3cQoSRemarkIPv6AddrPriTable = _Hh3cQoSRemarkIPv6AddrPriTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 4)
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv6AddrPriTable.setStatus("current")
_Hh3cQoSRemarkIPv6AddrPriEntry_Object = MibTableRow
hh3cQoSRemarkIPv6AddrPriEntry = _Hh3cQoSRemarkIPv6AddrPriEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 4, 1)
)
hh3cQoSRemarkIPv6AddrPriEntry.setIndexNames(
    (0, "HH3C-IFQOS2-MIB", "hh3cQoSRemarkIPv6AddrValue"),
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv6AddrPriEntry.setStatus("current")
_Hh3cQoSRemarkIPv6AddrValue_Type = InetAddressIPv6
_Hh3cQoSRemarkIPv6AddrValue_Object = MibTableColumn
hh3cQoSRemarkIPv6AddrValue = _Hh3cQoSRemarkIPv6AddrValue_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 4, 1, 1),
    _Hh3cQoSRemarkIPv6AddrValue_Type()
)
hh3cQoSRemarkIPv6AddrValue.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv6AddrValue.setStatus("current")


class _Hh3cQoSRemarkIPv6AddrPrefixLength_Type(InetAddressPrefixLength):
    """Custom type hh3cQoSRemarkIPv6AddrPrefixLength based on InetAddressPrefixLength"""
    defaultValue = 128


_Hh3cQoSRemarkIPv6AddrPrefixLength_Type.__name__ = "InetAddressPrefixLength"
_Hh3cQoSRemarkIPv6AddrPrefixLength_Object = MibTableColumn
hh3cQoSRemarkIPv6AddrPrefixLength = _Hh3cQoSRemarkIPv6AddrPrefixLength_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 4, 1, 2),
    _Hh3cQoSRemarkIPv6AddrPrefixLength_Type()
)
hh3cQoSRemarkIPv6AddrPrefixLength.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv6AddrPrefixLength.setStatus("current")


class _Hh3cQoSRemarkIPv6AddrDot1p_Type(Unsigned32):
    """Custom type hh3cQoSRemarkIPv6AddrDot1p based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 7),
        ValueRangeConstraint(255, 255),
...
_Hh3cQoSRemarkIPv6AddrDot1p_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkIPv6AddrDot1p_Object = MibTableColumn
hh3cQoSRemarkIPv6AddrDot1p = _Hh3cQoSRemarkIPv6AddrDot1p_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 4, 1, 3),
    _Hh3cQoSRemarkIPv6AddrDot1p_Type()
)
hh3cQoSRemarkIPv6AddrDot1p.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv6AddrDot1p.setStatus("current")


class _Hh3cQoSRemarkIPv6AddrDscp_Type(Unsigned32):
    """Custom type hh3cQoSRemarkIPv6AddrDscp based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 63),
        ValueRangeConstraint(255, 255),
...
_Hh3cQoSRemarkIPv6AddrDscp_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkIPv6AddrDscp_Object = MibTableColumn
hh3cQoSRemarkIPv6AddrDscp = _Hh3cQoSRemarkIPv6AddrDscp_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 4, 1, 4),
    _Hh3cQoSRemarkIPv6AddrDscp_Type()
)
hh3cQoSRemarkIPv6AddrDscp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv6AddrDscp.setStatus("current")
_Hh3cQoSRemarkIPv6AddrRowStatus_Type = RowStatus
_Hh3cQoSRemarkIPv6AddrRowStatus_Object = MibTableColumn
hh3cQoSRemarkIPv6AddrRowStatus = _Hh3cQoSRemarkIPv6AddrRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 4, 1, 5),
    _Hh3cQoSRemarkIPv6AddrRowStatus_Type()
)
hh3cQoSRemarkIPv6AddrRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkIPv6AddrRowStatus.setStatus("current")
_Hh3cQoSRemarkProtocolPriTable_Object = MibTable
hh3cQoSRemarkProtocolPriTable = _Hh3cQoSRemarkProtocolPriTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 5)
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkProtocolPriTable.setStatus("current")
_Hh3cQoSRemarkProtocolPriEntry_Object = MibTableRow
hh3cQoSRemarkProtocolPriEntry = _Hh3cQoSRemarkProtocolPriEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 5, 1)
)
hh3cQoSRemarkProtocolPriEntry.setIndexNames(
    (0, "HH3C-IFQOS2-MIB", "hh3cQoSRemarkProtocolValue"),
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkProtocolPriEntry.setStatus("current")


class _Hh3cQoSRemarkProtocolValue_Type(Integer32):
    """Custom type hh3cQoSRemarkProtocolValue based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hh3cQoSRemarkProtocolValue_Type.__name__ = "Integer32"
_Hh3cQoSRemarkProtocolValue_Object = MibTableColumn
hh3cQoSRemarkProtocolValue = _Hh3cQoSRemarkProtocolValue_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 5, 1, 1),
    _Hh3cQoSRemarkProtocolValue_Type()
)
hh3cQoSRemarkProtocolValue.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cQoSRemarkProtocolValue.setStatus("current")


class _Hh3cQoSRemarkProtocolDot1p_Type(Unsigned32):
    """Custom type hh3cQoSRemarkProtocolDot1p based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 7),
        ValueRangeConstraint(255, 255),
...
_Hh3cQoSRemarkProtocolDot1p_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkProtocolDot1p_Object = MibTableColumn
hh3cQoSRemarkProtocolDot1p = _Hh3cQoSRemarkProtocolDot1p_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 5, 1, 2),
    _Hh3cQoSRemarkProtocolDot1p_Type()
)
hh3cQoSRemarkProtocolDot1p.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkProtocolDot1p.setStatus("current")
_Hh3cQoSRemarkProtocolRowStatus_Type = RowStatus
_Hh3cQoSRemarkProtocolRowStatus_Object = MibTableColumn
hh3cQoSRemarkProtocolRowStatus = _Hh3cQoSRemarkProtocolRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 5, 1, 3),
    _Hh3cQoSRemarkProtocolRowStatus_Type()
)
hh3cQoSRemarkProtocolRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkProtocolRowStatus.setStatus("current")
_Hh3cQoSRemarkVlanPriTable_Object = MibTable
hh3cQoSRemarkVlanPriTable = _Hh3cQoSRemarkVlanPriTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 6)
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkVlanPriTable.setStatus("current")
_Hh3cQoSRemarkVlanPriEntry_Object = MibTableRow
hh3cQoSRemarkVlanPriEntry = _Hh3cQoSRemarkVlanPriEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 6, 1)
)
hh3cQoSRemarkVlanPriEntry.setIndexNames(
    (0, "HH3C-IFQOS2-MIB", "hh3cQoSRemarkVlanStart"),
)
if mibBuilder.loadTexts:
    hh3cQoSRemarkVlanPriEntry.setStatus("current")


class _Hh3cQoSRemarkVlanStart_Type(Integer32):
    """Custom type hh3cQoSRemarkVlanStart based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cQoSRemarkVlanStart_Type.__name__ = "Integer32"
_Hh3cQoSRemarkVlanStart_Object = MibTableColumn
hh3cQoSRemarkVlanStart = _Hh3cQoSRemarkVlanStart_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 6, 1, 1),
    _Hh3cQoSRemarkVlanStart_Type()
)
hh3cQoSRemarkVlanStart.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cQoSRemarkVlanStart.setStatus("current")


class _Hh3cQoSRemarkVlanEnd_Type(Integer32):
    """Custom type hh3cQoSRemarkVlanEnd based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 4094),
    )
...
_Hh3cQoSRemarkVlanEnd_Type.__name__ = "Integer32"
_Hh3cQoSRemarkVlanEnd_Object = MibTableColumn
hh3cQoSRemarkVlanEnd = _Hh3cQoSRemarkVlanEnd_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 6, 1, 2),
    _Hh3cQoSRemarkVlanEnd_Type()
)
hh3cQoSRemarkVlanEnd.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkVlanEnd.setStatus("current")


class _Hh3cQoSRemarkVlanDot1p_Type(Unsigned32):
    """Custom type hh3cQoSRemarkVlanDot1p based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 7),
        ValueRangeConstraint(255, 255),
...
_Hh3cQoSRemarkVlanDot1p_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkVlanDot1p_Object = MibTableColumn
hh3cQoSRemarkVlanDot1p = _Hh3cQoSRemarkVlanDot1p_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 6, 1, 3),
    _Hh3cQoSRemarkVlanDot1p_Type()
)
hh3cQoSRemarkVlanDot1p.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkVlanDot1p.setStatus("current")


class _Hh3cQoSRemarkVlanDscp_Type(Unsigned32):
    """Custom type hh3cQoSRemarkVlanDscp based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(0, 63),
        ValueRangeConstraint(255, 255),
...
_Hh3cQoSRemarkVlanDscp_Type.__name__ = "Unsigned32"
_Hh3cQoSRemarkVlanDscp_Object = MibTableColumn
hh3cQoSRemarkVlanDscp = _Hh3cQoSRemarkVlanDscp_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 6, 1, 4),
    _Hh3cQoSRemarkVlanDscp_Type()
)
hh3cQoSRemarkVlanDscp.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkVlanDscp.setStatus("current")
_Hh3cQoSRemarkVlanRowStatus_Type = RowStatus
_Hh3cQoSRemarkVlanRowStatus_Object = MibTableColumn
hh3cQoSRemarkVlanRowStatus = _Hh3cQoSRemarkVlanRowStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 6, 1, 5),
    _Hh3cQoSRemarkVlanRowStatus_Type()
)
hh3cQoSRemarkVlanRowStatus.setMaxAccess("read-create")
if mibBuilder.loadTexts:
    hh3cQoSRemarkVlanRowStatus.setStatus("current")
_Hh3cQoSTypeOfServiceObjects_ObjectIdentity = ObjectIdentity
hh3cQoSTypeOfServiceObjects = _Hh3cQoSTypeOfServiceObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 7)
)


class _Hh3cQoSTypeOfServiceMode_Type(Integer32):
    """Custom type hh3cQoSTypeOfServiceMode based on Integer32"""
    defaultValue = 1
...
_Hh3cQoSTypeOfServiceMode_Type.__name__ = "Integer32"
_Hh3cQoSTypeOfServiceMode_Object = MibScalar
hh3cQoSTypeOfServiceMode = _Hh3cQoSTypeOfServiceMode_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 12, 7, 1),
    _Hh3cQoSTypeOfServiceMode_Type()
)
hh3cQoSTypeOfServiceMode.setMaxAccess("read-write")
if mibBuilder.loadTexts:
    hh3cQoSTypeOfServiceMode.setStatus("current")
_Hh3cIfQoSProcessingStatusObjects_ObjectIdentity = ObjectIdentity
hh3cIfQoSProcessingStatusObjects = _Hh3cIfQoSProcessingStatusObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 13)
)


class _Hh3cIfQoSProcessingStatus_Type(Integer32):
    """Custom type hh3cIfQoSProcessingStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
_Hh3cIfQoSProcessingStatus_Type.__name__ = "Integer32"
_Hh3cIfQoSProcessingStatus_Object = MibScalar
hh3cIfQoSProcessingStatus = _Hh3cIfQoSProcessingStatus_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 13, 1),
    _Hh3cIfQoSProcessingStatus_Type()
)
hh3cIfQoSProcessingStatus.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSProcessingStatus.setStatus("current")
_Hh3cIfQoSCoppObjects_ObjectIdentity = ObjectIdentity
hh3cIfQoSCoppObjects = _Hh3cIfQoSCoppObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 14)
)
_Hh3cIfQoSCoppFlowStatTable_Object = MibTable
hh3cIfQoSCoppFlowStatTable = _Hh3cIfQoSCoppFlowStatTable_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 14, 1)
)
if mibBuilder.loadTexts:
    hh3cIfQoSCoppFlowStatTable.setStatus("current")
_Hh3cIfQoSCoppFlowStatEntry_Object = MibTableRow
hh3cIfQoSCoppFlowStatEntry = _Hh3cIfQoSCoppFlowStatEntry_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 14, 1, 1)
)
hh3cIfQoSCoppFlowStatEntry.setIndexNames(
    (0, "HH3C-IFQOS2-MIB", "hh3cIfQoSCoppFlowStatChassis"),
    (0, "HH3C-IFQOS2-MIB", "hh3cIfQoSCoppFlowStatSlot"),
    (0, "HH3C-IFQOS2-MIB", "hh3cIfQoSCoppFlowStatProType"),
)
if mibBuilder.loadTexts:
    hh3cIfQoSCoppFlowStatEntry.setStatus("current")
_Hh3cIfQoSCoppFlowStatChassis_Type = Unsigned32
_Hh3cIfQoSCoppFlowStatChassis_Object = MibTableColumn
hh3cIfQoSCoppFlowStatChassis = _Hh3cIfQoSCoppFlowStatChassis_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 14, 1, 1, 1),
    _Hh3cIfQoSCoppFlowStatChassis_Type()
)
hh3cIfQoSCoppFlowStatChassis.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cIfQoSCoppFlowStatChassis.setStatus("current")
_Hh3cIfQoSCoppFlowStatSlot_Type = Unsigned32
_Hh3cIfQoSCoppFlowStatSlot_Object = MibTableColumn
hh3cIfQoSCoppFlowStatSlot = _Hh3cIfQoSCoppFlowStatSlot_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 14, 1, 1, 2),
    _Hh3cIfQoSCoppFlowStatSlot_Type()
)
hh3cIfQoSCoppFlowStatSlot.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cIfQoSCoppFlowStatSlot.setStatus("current")


class _Hh3cIfQoSCoppFlowStatProType_Type(Unsigned32):
    """Custom type hh3cIfQoSCoppFlowStatProType based on Unsigned32"""
    subtypeSpec = Unsigned32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
...
_Hh3cIfQoSCoppFlowStatProType_Type.__name__ = "Unsigned32"
_Hh3cIfQoSCoppFlowStatProType_Object = MibTableColumn
hh3cIfQoSCoppFlowStatProType = _Hh3cIfQoSCoppFlowStatProType_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 14, 1, 1, 3),
    _Hh3cIfQoSCoppFlowStatProType_Type()
)
hh3cIfQoSCoppFlowStatProType.setMaxAccess("not-accessible")
if mibBuilder.loadTexts:
    hh3cIfQoSCoppFlowStatProType.setStatus("current")
_Hh3cIfQoSCoppFlowPassPackets_Type = Counter64
_Hh3cIfQoSCoppFlowPassPackets_Object = MibTableColumn
hh3cIfQoSCoppFlowPassPackets = _Hh3cIfQoSCoppFlowPassPackets_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 14, 1, 1, 4),
    _Hh3cIfQoSCoppFlowPassPackets_Type()
)
hh3cIfQoSCoppFlowPassPackets.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSCoppFlowPassPackets.setStatus("current")
_Hh3cIfQoSCoppFlowPassBytes_Type = Counter64
_Hh3cIfQoSCoppFlowPassBytes_Object = MibTableColumn
hh3cIfQoSCoppFlowPassBytes = _Hh3cIfQoSCoppFlowPassBytes_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 14, 1, 1, 5),
    _Hh3cIfQoSCoppFlowPassBytes_Type()
)
hh3cIfQoSCoppFlowPassBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSCoppFlowPassBytes.setStatus("current")
_Hh3cIfQoSCoppFlowDropPackets_Type = Counter64
_Hh3cIfQoSCoppFlowDropPackets_Object = MibTableColumn
hh3cIfQoSCoppFlowDropPackets = _Hh3cIfQoSCoppFlowDropPackets_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 14, 1, 1, 6),
    _Hh3cIfQoSCoppFlowDropPackets_Type()
)
hh3cIfQoSCoppFlowDropPackets.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSCoppFlowDropPackets.setStatus("current")
_Hh3cIfQoSCoppFlowDropBytes_Type = Counter64
_Hh3cIfQoSCoppFlowDropBytes_Object = MibTableColumn
hh3cIfQoSCoppFlowDropBytes = _Hh3cIfQoSCoppFlowDropBytes_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 65, 1, 14, 1, 1, 7),
    _Hh3cIfQoSCoppFlowDropBytes_Type()
)
hh3cIfQoSCoppFlowDropBytes.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cIfQoSCoppFlowDropBytes.setStatus("current")
...
mibBuilder.exportSymbols(
    "HH3C-IFQOS2-MIB",
    **{"Hh3cIfCarAction": Hh3cIfCarAction,
       ...
       "hh3cIfQoSQSMinBandwidth": hh3cIfQoSQSMinBandwidth,
       "hh3cIfQoSQSMinBandwidthPercent": hh3cIfQoSQSMinBandwidthPercent,
       ...
       "hh3cIfQoSQueueName": hh3cIfQoSQueueName,
       "hh3cIfQoSDropPPS": hh3cIfQoSDropPPS,
       "hh3cIfQoSDropBPS": hh3cIfQoSDropBPS,
       "hh3cIfQoSPeakPassPPS": hh3cIfQoSPeakPassPPS,
       "hh3cIfQoSPeakPassBPS": hh3cIfQoSPeakPassBPS,
       ...
       "hh3cIfQoSHardwareQueueTotalRunInfoTable": hh3cIfQoSHardwareQueueTotalRunInfoTable,
       "hh3cIfQoSHardwareQueueTotalRunInfoEntry": hh3cIfQoSHardwareQueueTotalRunInfoEntry,
       "hh3cIfQoSQueueLength": hh3cIfQoSQueueLength,
       "hh3cIfQoSPeakQueueBytes": hh3cIfQoSPeakQueueBytes,
       ...
       "hh3cIfQoSLRPir": hh3cIfQoSLRPir,
       "hh3cIfQoSLRUnit": hh3cIfQoSLRUnit,
       ...
       "hh3cIfQoSTricolorCarUnitType": hh3cIfQoSTricolorCarUnitType,
       ...
       "hh3cIfQoSGTSPir": hh3cIfQoSGTSPir,
       "hh3cIfQoSGTSUnitType": hh3cIfQoSGTSUnitType,
       ...
       "hh3cIfQoSPrePriMapTable": hh3cIfQoSPrePriMapTable,
       "hh3cIfQoSPrePriMapEntry": hh3cIfQoSPrePriMapEntry,
       "hh3cIfQoSPrePriMapTableType": hh3cIfQoSPrePriMapTableType,
       "hh3cIfQoSPrePriMapTableColor": hh3cIfQoSPrePriMapTableColor,
       "hh3cIfQoSPrePriMapTableDirection": hh3cIfQoSPrePriMapTableDirection,
       "hh3cIfQoSPrePriMapTableImportValue": hh3cIfQoSPrePriMapTableImportValue,
       "hh3cIfQoSPrePriMapTableExportValue": hh3cIfQoSPrePriMapTableExportValue,
       ...
       "hh3cQoSGlobalPriorityObject": hh3cQoSGlobalPriorityObject,
       "hh3cQoSRemarkTcpPortPriTable": hh3cQoSRemarkTcpPortPriTable,
       "hh3cQoSRemarkTcpPortPriEntry": hh3cQoSRemarkTcpPortPriEntry,
       "hh3cQoSRemarkTcpPortStart": hh3cQoSRemarkTcpPortStart,
       "hh3cQoSRemarkTcpPortEnd": hh3cQoSRemarkTcpPortEnd,
       "hh3cQoSRemarkTcpPortType": hh3cQoSRemarkTcpPortType,
       "hh3cQoSRemarkTcpPortDot1p": hh3cQoSRemarkTcpPortDot1p,
       "hh3cQoSRemarkTcpPortDscp": hh3cQoSRemarkTcpPortDscp,
       "hh3cQoSRemarkTcpPortRowStatus": hh3cQoSRemarkTcpPortRowStatus,
       "hh3cQoSRemarkUdpPortPriTable": hh3cQoSRemarkUdpPortPriTable,
       "hh3cQoSRemarkUdpPortPriEntry": hh3cQoSRemarkUdpPortPriEntry,
       "hh3cQoSRemarkUdpPortStart": hh3cQoSRemarkUdpPortStart,
       "hh3cQoSRemarkUdpPortEnd": hh3cQoSRemarkUdpPortEnd,
       "hh3cQoSRemarkUdpPortType": hh3cQoSRemarkUdpPortType,
       "hh3cQoSRemarkUdpPortDot1p": hh3cQoSRemarkUdpPortDot1p,
       "hh3cQoSRemarkUdpPortDscp": hh3cQoSRemarkUdpPortDscp,
       "hh3cQoSRemarkUdpPortRowStatus": hh3cQoSRemarkUdpPortRowStatus,
       "hh3cQoSRemarkIPv4AddrPriTable": hh3cQoSRemarkIPv4AddrPriTable,
       "hh3cQoSRemarkIPv4AddrPriEntry": hh3cQoSRemarkIPv4AddrPriEntry,
       "hh3cQoSRemarkIPv4AddrValue": hh3cQoSRemarkIPv4AddrValue,
       "hh3cQoSRemarkIPv4AddrMask": hh3cQoSRemarkIPv4AddrMask,
       "hh3cQoSRemarkIPv4AddrMaskLength": hh3cQoSRemarkIPv4AddrMaskLength,
       "hh3cQoSRemarkIPv4AddrDot1p": hh3cQoSRemarkIPv4AddrDot1p,
       "hh3cQoSRemarkIPv4AddrDscp": hh3cQoSRemarkIPv4AddrDscp,
       "hh3cQoSRemarkIPv4AddrRowStatus": hh3cQoSRemarkIPv4AddrRowStatus,
       "hh3cQoSRemarkIPv6AddrPriTable": hh3cQoSRemarkIPv6AddrPriTable,
       "hh3cQoSRemarkIPv6AddrPriEntry": hh3cQoSRemarkIPv6AddrPriEntry,
       "hh3cQoSRemarkIPv6AddrValue": hh3cQoSRemarkIPv6AddrValue,
       "hh3cQoSRemarkIPv6AddrPrefixLength": hh3cQoSRemarkIPv6AddrPrefixLength,
       "hh3cQoSRemarkIPv6AddrDot1p": hh3cQoSRemarkIPv6AddrDot1p,
       "hh3cQoSRemarkIPv6AddrDscp": hh3cQoSRemarkIPv6AddrDscp,
       "hh3cQoSRemarkIPv6AddrRowStatus": hh3cQoSRemarkIPv6AddrRowStatus,
       "hh3cQoSRemarkProtocolPriTable": hh3cQoSRemarkProtocolPriTable,
       "hh3cQoSRemarkProtocolPriEntry": hh3cQoSRemarkProtocolPriEntry,
       "hh3cQoSRemarkProtocolValue": hh3cQoSRemarkProtocolValue,
       "hh3cQoSRemarkProtocolDot1p": hh3cQoSRemarkProtocolDot1p,
       "hh3cQoSRemarkProtocolRowStatus": hh3cQoSRemarkProtocolRowStatus,
       "hh3cQoSRemarkVlanPriTable": hh3cQoSRemarkVlanPriTable,
       "hh3cQoSRemarkVlanPriEntry": hh3cQoSRemarkVlanPriEntry,
       "hh3cQoSRemarkVlanStart": hh3cQoSRemarkVlanStart,
       "hh3cQoSRemarkVlanEnd": hh3cQoSRemarkVlanEnd,
       "hh3cQoSRemarkVlanDot1p": hh3cQoSRemarkVlanDot1p,
       "hh3cQoSRemarkVlanDscp": hh3cQoSRemarkVlanDscp,
       "hh3cQoSRemarkVlanRowStatus": hh3cQoSRemarkVlanRowStatus,
       "hh3cQoSTypeOfServiceObjects": hh3cQoSTypeOfServiceObjects,
       "hh3cQoSTypeOfServiceMode": hh3cQoSTypeOfServiceMode,
       "hh3cIfQoSProcessingStatusObjects": hh3cIfQoSProcessingStatusObjects,
       "hh3cIfQoSProcessingStatus": hh3cIfQoSProcessingStatus,
       "hh3cIfQoSCoppObjects": hh3cIfQoSCoppObjects,
       "hh3cIfQoSCoppFlowStatTable": hh3cIfQoSCoppFlowStatTable,
       "hh3cIfQoSCoppFlowStatEntry": hh3cIfQoSCoppFlowStatEntry,
       "hh3cIfQoSCoppFlowStatChassis": hh3cIfQoSCoppFlowStatChassis,
       "hh3cIfQoSCoppFlowStatSlot": hh3cIfQoSCoppFlowStatSlot,
       "hh3cIfQoSCoppFlowStatProType": hh3cIfQoSCoppFlowStatProType,
       "hh3cIfQoSCoppFlowPassPackets": hh3cIfQoSCoppFlowPassPackets,
       "hh3cIfQoSCoppFlowPassBytes": hh3cIfQoSCoppFlowPassBytes,
       "hh3cIfQoSCoppFlowDropPackets": hh3cIfQoSCoppFlowDropPackets,
       "hh3cIfQoSCoppFlowDropBytes": hh3cIfQoSCoppFlowDropBytes}
)
