...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-NTP-MIB
...
if mibBuilder.loadTexts:
    hh3cNTPSysPeer.setStatus("obsolete")
...
class _Hh3cNTPSysSrcPeer_Type(Unsigned32):
    """Custom type hh3cNTPSysSrcPeer based on Unsigned32"""
...
_Hh3cNTPSysSrcPeer_Type.__name__ = "Unsigned32"
_Hh3cNTPSysSrcPeer_Object = MibScalar
hh3cNTPSysSrcPeer = _Hh3cNTPSysSrcPeer_Object(
    (1, 3, 6, 1, 4, 1, 25506, 8, 22, 1, 1, 20),
    _Hh3cNTPSysSrcPeer_Type()
)
hh3cNTPSysSrcPeer.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cNTPSysSrcPeer.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"hh3cNTP": hh3cNTP,
       ...
       "hh3cNTPSysSrcPeer": hh3cNTPSysSrcPeer,
