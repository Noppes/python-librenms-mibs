...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-DOT11-ROAM-MIB
...
_Hh3cdot11MobGrpTunnelType_Type.__name__ = "Hh3cDot11RoamMobileTunnelType"
...
_Hh3cDot11MobGrpAuthMode_Type.__name__ = "Hh3cDot11RoamAuthMode"
...
_Hh3cDot11MobGrpEnable_Type.__name__ = "TruthValue"
...
_Hh3cDot11InterACRoamInSuccCnt_Type = Integer32
_Hh3cDot11InterACRoamInSuccCnt_Object = MibScalar
hh3cDot11InterACRoamInSuccCnt = _Hh3cDot11InterACRoamInSuccCnt_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 10, 3, 4),
    _Hh3cDot11InterACRoamInSuccCnt_Type()
)
hh3cDot11InterACRoamInSuccCnt.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11InterACRoamInSuccCnt.setStatus("current")
...
_Hh3cDot11InterACRoamInSuccCnt2_Type = Counter32
_Hh3cDot11InterACRoamInSuccCnt2_Object = MibScalar
hh3cDot11InterACRoamInSuccCnt2 = _Hh3cDot11InterACRoamInSuccCnt2_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 75, 10, 4, 4),
    _Hh3cDot11InterACRoamInSuccCnt2_Type()
)
hh3cDot11InterACRoamInSuccCnt2.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    hh3cDot11InterACRoamInSuccCnt2.setStatus("current")
...
mibBuilder.exportSymbols(
    ...
    **{"Hh3cDot11RoamMobileTunnelType": Hh3cDot11RoamMobileTunnelType,
       ...
       "hh3cDot11InterACRoamInSuccCnt": hh3cDot11InterACRoamInSuccCnt,
       ...
       "hh3cDot11InterACRoamInSuccCnt2": hh3cDot11InterACRoamInSuccCnt2}
)
