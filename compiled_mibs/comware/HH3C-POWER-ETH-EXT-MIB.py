...
# Notes
# -----
# ASN.1 source file://mibs\comware\HH3C-POWER-ETH-EXT-MIB
...
if mibBuilder.loadTexts:
    hh3cPowerEthernetExt.setRevisions(
        ("2019-05-23 00:00",
         "2015-07-25 00:00")
    )
...
class ACAlarmState(TextualConvention, Integer32):
    status = "current"
...
class DCAlarmState(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class ModuleAlarmState(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
class Hh3cPDDisableState(TextualConvention, Integer32):
    status = "current"
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
...
_Hh3cPseProfilePowerLimit_Type = Integer32
...
_Hh3cPseNotification_ObjectIdentity = ObjectIdentity
hh3cPseNotification = _Hh3cPseNotification_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 14, 11)
)
_Hh3cPseNotificationPrefix_ObjectIdentity = ObjectIdentity
hh3cPseNotificationPrefix = _Hh3cPseNotificationPrefix_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 14, 11, 0)
)
_Hh3cPseNotificationObjects_ObjectIdentity = ObjectIdentity
hh3cPseNotificationObjects = _Hh3cPseNotificationObjects_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 25506, 2, 14, 11, 1)
)


class _Hh3cPsePortGroupIndex_Type(Integer32):
    """Custom type hh3cPsePortGroupIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_Hh3cPsePortGroupIndex_Type.__name__ = "Integer32"
_Hh3cPsePortGroupIndex_Object = MibScalar
hh3cPsePortGroupIndex = _Hh3cPsePortGroupIndex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 14, 11, 1, 1),
    _Hh3cPsePortGroupIndex_Type()
)
hh3cPsePortGroupIndex.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cPsePortGroupIndex.setStatus("current")


class _Hh3cPsePortIndex_Type(Integer32):
    """Custom type hh3cPsePortIndex based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        ValueRangeConstraint(1, 2147483647),
    )
...
_Hh3cPsePortIndex_Type.__name__ = "Integer32"
_Hh3cPsePortIndex_Object = MibScalar
hh3cPsePortIndex = _Hh3cPsePortIndex_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 14, 11, 1, 2),
    _Hh3cPsePortIndex_Type()
)
hh3cPsePortIndex.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cPsePortIndex.setStatus("current")
_Hh3cPsePortDisableInfo_Type = Hh3cPDDisableState
_Hh3cPsePortDisableInfo_Object = MibScalar
hh3cPsePortDisableInfo = _Hh3cPsePortDisableInfo_Object(
    (1, 3, 6, 1, 4, 1, 25506, 2, 14, 11, 1, 3),
    _Hh3cPsePortDisableInfo_Type()
)
hh3cPsePortDisableInfo.setMaxAccess("accessible-for-notify")
if mibBuilder.loadTexts:
    hh3cPsePortDisableInfo.setStatus("current")
...
hh3cPsePDDisableNotification = NotificationType(
    (1, 3, 6, 1, 4, 1, 25506, 2, 14, 11, 0, 1)
)
hh3cPsePDDisableNotification.setObjects(
      *(("HH3C-POWER-ETH-EXT-MIB", "hh3cPsePortGroupIndex"),
        ("HH3C-POWER-ETH-EXT-MIB", "hh3cPsePortIndex"),
        ("HH3C-POWER-ETH-EXT-MIB", "hh3cPsePortDisableInfo"))
)
if mibBuilder.loadTexts:
    hh3cPsePDDisableNotification.setStatus(
        "current"
    )
...
hh3cPsePDNotificationGroup = NotificationGroup(
...
if mibBuilder.loadTexts:
    hh3cPsePDNotificationGroup.setStatus(
        "current"
    )
...
hh3cPseCompliance.setObjects(
      *(("HH3C-POWER-ETH-EXT-MIB", "hh3cPsePortGroup"),
        ("HH3C-POWER-ETH-EXT-MIB", "hh3cMainPseGroup"),
        ("HH3C-POWER-ETH-EXT-MIB", "hh3cPseScalarGroup"),
        ("HH3C-POWER-ETH-EXT-MIB", "hh3cPsePDNotificationGroup"),
        ("HH3C-POWER-ETH-EXT-MIB", "hh3cPseProfilesGroup"))
)
if mibBuilder.loadTexts:
...
mibBuilder.exportSymbols(
    ...
    **{"ACAlarmState": ACAlarmState,
       ...
       "Hh3cPDDisableState": Hh3cPDDisableState,
       ...
       "hh3cPseNotification": hh3cPseNotification,
       "hh3cPseNotificationPrefix": hh3cPseNotificationPrefix,
       "hh3cPsePDDisableNotification": hh3cPsePDDisableNotification,
       "hh3cPseNotificationObjects": hh3cPseNotificationObjects,
       "hh3cPsePortGroupIndex": hh3cPsePortGroupIndex,
       "hh3cPsePortIndex": hh3cPsePortIndex,
       "hh3cPsePortDisableInfo": hh3cPsePortDisableInfo}
)
