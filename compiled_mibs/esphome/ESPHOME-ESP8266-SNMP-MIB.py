# SNMP MIB module (ESPHOME-ESP8266-SNMP-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\esphome\ESPHOME-ESP8266-SNMP-MIB
...
_HeapFragmentation_Type = Integer32
_HeapFragmentation_Object = MibScalar
heapFragmentation = _HeapFragmentation_Object(
    (1, 3, 9999, 8266, 2),
    _HeapFragmentation_Type()
)
heapFragmentation.setMaxAccess("read-only")
if mibBuilder.loadTexts:
    heapFragmentation.setStatus("current")
...
chipGroup.setObjects(
      *(("ESPHOME-ESP8266-SNMP-MIB", "chipType"),
        ("ESPHOME-ESP8266-SNMP-MIB", "cpuClock"),
        ("ESPHOME-ESP8266-SNMP-MIB", "chipModel"),
        ("ESPHOME-ESP8266-SNMP-MIB", "numCores"),
        ("ESPHOME-ESP8266-SNMP-MIB", "chipRevision"))
)
if mibBuilder.loadTexts:
...
wifiGroup.setObjects(
      *(("ESPHOME-ESP8266-SNMP-MIB", "rssi"),
        ("ESPHOME-ESP8266-SNMP-MIB", "bssi"),
        ("ESPHOME-ESP8266-SNMP-MIB", "ssid"),
        ("ESPHOME-ESP8266-SNMP-MIB", "ipaddress"))
)
if mibBuilder.loadTexts:
...
espHeapGroup.setObjects(
      *(("ESPHOME-ESP8266-SNMP-MIB", "freeHeap"),
        ("ESPHOME-ESP8266-SNMP-MIB", "heapFragmentation"),
        ("ESPHOME-ESP8266-SNMP-MIB", "maxFreeHeapBlock"))
)
if mibBuilder.loadTexts:
