...
# Notes
# -----
# ASN.1 source file://mibs\ciena\WWP-PRODUCTS-MIB
...
_Cn3942_ObjectIdentity = ObjectIdentity
cn3942 = _Cn3942_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6141, 1, 98)
)
_Cn3903_ObjectIdentity = ObjectIdentity
cn3903 = _Cn3903_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6141, 1, 99)
)
_Cn3904_ObjectIdentity = ObjectIdentity
cn3904 = _Cn3904_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6141, 1, 100)
)
_Cn3905_ObjectIdentity = ObjectIdentity
cn3905 = _Cn3905_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6141, 1, 101)
)
_Cn3938_ObjectIdentity = ObjectIdentity
cn3938 = _Cn3938_ObjectIdentity(
    (1, 3, 6, 1, 4, 1, 6141, 1, 102)
)
_Cn3906_ObjectIdentity = ObjectIdentity
cn3906 = _Cn3906_ObjectIdentity(
