# SNMP MIB module (RADLAN-rndApplications) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\radlan\RADLAN-rndApplications
...
rndMonitoredElementEntry.setIndexNames(
    (0, "RADLAN-rndApplications", "rndMonitoredElementAddress"),
)
if mibBuilder.loadTexts:
...
rndMonitoringEntry.setIndexNames(
    (0, "RADLAN-rndApplications", "rndMonitoredElement"),
    (1, "RADLAN-rndApplications", "rndMonitoredObjectInstanceLabel"),
)
if mibBuilder.loadTexts:
...
rndMibFileEntry.setIndexNames(
    (0, "RADLAN-rndApplications", "rndMibFileIndex"),
)
if mibBuilder.loadTexts:
...
rndDeleteValuesEntry.setIndexNames(
    (1, "RADLAN-rndApplications", "rndRowStatusVariableName"),
)
if mibBuilder.loadTexts:
...
rndSimulatedVariablesEntry = _RndSimulatedVariablesEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 35, 2, 9, 1, 1)
)
rndSimulatedVariablesEntry.setIndexNames(
    (0, "RADLAN-rndApplications", "rndSimulatedVariableEntryIndex"),
)
if mibBuilder.loadTexts:
...
rlMibTreeEntry = _RlMibTreeEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 35, 2, 10, 1, 1)
)
rlMibTreeEntry.setIndexNames(
    (0, "RADLAN-rndApplications", "rlMibTreeFather"),
    (0, "RADLAN-rndApplications", "rlMibTreeSonIndex"),
)
if mibBuilder.loadTexts:
...
class _RsPingCompletionStatus_Type(Integer32):
    """Custom type rsPingCompletionStatus based on Integer32"""
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(
        SingleValueConstraint(
            *(1,
...
rsPowerSupplyRedundacyEntry = _RsPowerSupplyRedundacyEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 35, 5, 1, 1)
)
rsPowerSupplyRedundacyEntry.setIndexNames(
    (0, "RADLAN-rndApplications", "rsPowerSupplyRedundacyReNumber"),
)
if mibBuilder.loadTexts:
