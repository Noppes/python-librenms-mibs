# SNMP MIB module (RADLAN-rlInterfaces) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\radlan\RADLAN-rlInterfaces
...
swIfEntry.setIndexNames(
    (0, "RADLAN-rlInterfaces", "swIfIndex"),
)
if mibBuilder.loadTexts:
...
class _SwIfAdminLockTrapEnable_Type(TruthValue):
    """Custom type swIfAdminLockTrapEnable based on TruthValue"""
    defaultValue = 2


_SwIfAdminLockTrapEnable_Type.__name__ = "TruthValue"
...
swIfPortLockIfRangeEntry.setIndexNames(
    (0, "RADLAN-rlInterfaces", "swIfPortLockIfRangeIndex"),
)
if mibBuilder.loadTexts:
...
class _SwIfPortLockIfRangeTrapEn_Type(TruthValue):
    """Custom type swIfPortLockIfRangeTrapEn based on TruthValue"""
    defaultValue = 2


_SwIfPortLockIfRangeTrapEn_Type.__name__ = "TruthValue"
