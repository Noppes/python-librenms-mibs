# SNMP MIB module (RADLAN-RMON) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\radlan\RADLAN-RMON
...
rlHistoryControlEntry = _RlHistoryControlEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 49, 4, 1)
)
rlHistoryControlEntry.setIndexNames(
    (0, "RADLAN-RMON", "rlHistoryControlIndex"),
)
if mibBuilder.loadTexts:
...
rlHistoryEntry = _RlHistoryEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 49, 5, 1)
)
rlHistoryEntry.setIndexNames(
    (0, "RADLAN-RMON", "rlHistoryIndex"),
    (0, "RADLAN-RMON", "rlHistorySampleIndex"),
)
if mibBuilder.loadTexts:
