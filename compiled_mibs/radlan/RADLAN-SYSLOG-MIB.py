# SNMP MIB module (RADLAN-SYSLOG-MIB) expressed in pysnmp data model.
#
...
rlSyslogLogCacheEntry = _RlSyslogLogCacheEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 82, 2, 9, 1)
)
rlSyslogLogCacheEntry.setIndexNames(
    (0, "RADLAN-SYSLOG-MIB", "rlSyslogLogCacheCounter"),
)
if mibBuilder.loadTexts:
