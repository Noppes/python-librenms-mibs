# SNMP MIB module (RADLAN-STACK-MIB) expressed in pysnmp data model.
#
...
# Notes
# -----
# ASN.1 source file://mibs\radlan\RADLAN-STACK-MIB
...
rlStackActiveUnitIdEntry = _RlStackActiveUnitIdEntry_Object(
    (1, 3, 6, 1, 4, 1, 89, 107, 1, 1)
)
rlStackActiveUnitIdEntry.setIndexNames(
    (0, "RADLAN-STACK-MIB", "rlStackCurrentUnitId"),
)
if mibBuilder.loadTexts:
...
rlStackCurrentUnitId = _RlStackCurrentUnitId_Object(
    (1, 3, 6, 1, 4, 1, 89, 107, 1, 1, 1),
    _RlStackCurrentUnitId_Type()
)
rlStackCurrentUnitId.setMaxAccess("read-write")
if mibBuilder.loadTexts:
